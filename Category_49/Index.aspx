...
<div class="colSreach">
    ...
    栏目搜索：<label><select name="nodeId'" id="nodeId" size="1"><option value=49>—中校歌</option></select></label><label><select name="fieldOption" id="fieldOption" size="1"><option value="title" selected>文章标题</option>
   ...
   <!--<input type="button" class="input_button" value="高级搜索" onclick="location.href='/Shaoxingyizhong/search.aspx?searchtype=2&ModelId=1'" />--></label>
    ...
    <a href="/Shaoxingyizhong/Category_49/Index.aspx" target="_self">—中校歌</a></div>
            ...
            <li class="first"><span class="date">2009-11-24</span><img src="/Shaoxingyizhong/images/ontop1.gif" alt="热门"><a href="/Shaoxingyizhong/Item/622.aspx" target="_self" title="标题：一中校歌&#xD;点击数：17391&#xD;发表时间：2009年11月24日">一中校歌</a></li>
