...
<li class="li3 on"><a href="/Category_40/Index.aspx">财务</a></li>
...
<div class="colSreach">
    ...
    栏目搜索：<label><select name="nodeId'" id="nodeId" size="1"><option value=40>财务</option></select></label><label><select name="fieldOption" id="fieldOption" size="1"><option value="title" selected>文章标题</option>
   ...
   <!--<input type="button" class="input_button" value="高级搜索" onclick="location.href='/search.aspx?searchtype=2&ModelId=1'" />--></label>
    ...
    <a href="/Category_40/Index.aspx" target="_self">财务</a></div>
                    <h3>财务</h3>
                </div>
                <div class="mBd">
                    <!-- 正文内容 S -->
            ...
            <li class="first"><span class="date">2020-12-12</span><img src="/images/ontop1.gif" alt="热门"><a href="/Item/12367.aspx" target="_self" title="标题：2020单位收费目录公示清单&#xD;点击数：214&#xD;发表时间：2020年12月12日">2020单位收费目录公示清单</a></li><li class="last"><span class="date">2018-09-03</span><img src="/images/ontop1.gif" alt="热门"><a href="/Item/8961.aspx" target="_self" title="标题：2018单位收费目录公示清单&#xD;点击数：820&#xD;发表时间：2018年09月03日"><font style=";">2018单位收费目录公示清单</font></a></li>
