...
<div class="colSreach">
    ...
    栏目搜索：<label><select name="nodeId'" id="nodeId" size="1"><option value=68>正高特级教师</option></select></label><label><select name="fieldOption" id="fieldOption" size="1"><option value="title" selected>文章标题</option>
   ...
   <!--<input type="button" class="input_button" value="高级搜索" onclick="location.href='/Shaoxingyizhong/search.aspx?searchtype=2&ModelId=1'" />--></label>
    ...
    <a href="/Shaoxingyizhong/Category_68/Index.aspx" target="_self">正高特级教师</a></div>
            ...
            <li class="first"><span class="date">2025-09-12</span><img src="/Shaoxingyizhong/images/ontop1.gif" alt="热门"><a href="/Shaoxingyizhong/Item/18035.aspx" target="_self" title="标题：特级教师&#xD;点击数：1576&#xD;发表时间：2025年09月12日">特级教师</a></li><li class="last"><span class="date">2009-11-24</span><img src="/Shaoxingyizhong/images/ontop1.gif" alt="热门"><a href="/Shaoxingyizhong/Item/623.aspx" target="_self" title="标题：特级教师&#xD;点击数：33878&#xD;发表时间：2009年11月24日">特级教师</a></li>
