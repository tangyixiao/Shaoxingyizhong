...
<body id="userlogin_body">
    ...
    <div class="wrapper">
        <div class="user_login_contant">
            <form name="Login" method="post" action="Login.aspx?ReturnUrl=%2fUser%2fDefault.aspx" onsubmit="javascript:return WebForm_OnSubmit();" onkeypress="javascript:return WebForm_FireDefaultButton(event, 'BtnLogin')" id="Login" autocomplete="off">
<div>
<input type="hidden" name="__REFRESH_FIELD" id="__REFRESH_FIELD" value="" />
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="6QVFfGbT/7Wh+tPCAw2SAyOQq97rmhmREHSVYGOYDdTLHkm5ds3a1wxZFzRH/zVGeLKmqjUabg2L98umIQO50FYS0qEOQ9TyUY6wQ9TUZy+1d3R8C3aq8btPKx1A02F93ZnfCSgNvIzZNsBA4FMrm90EbvjBlcru8wcCEaAFKy2RV6+Sba8I5FAAsJw=" />
</div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="xvpZ9tphzSRQYanDGGGgH+TdMiPMFqI7RX6kchflcKrwJHOsCm2k+1H3I/aJU6L7UQ2/gpqRjRb/RhCKHU4gHbiEV1f6dnRPRdU9v7R9SxdhernRtboxe76VlvuYNvCgFBqva1Y/bNhCPwAx" />
</div>
                    ...
                    <dd id="user_main">
                        <ul>
                            <li class="user_main_name">
                                <label>
                                    用户名：</label>
                                <input name="TxtUserName" type="text" maxlength="20" id="TxtUserName" tabindex="1" class="username" autocomplete="off" />
                            </li>
                            <li class="user_password">
                                <label>
                                    密 码：</label>
                                
                                <input name="TxtUserPass" type="password" id="TxtUserPass" tabindex="2" class="userpass" autocomplete="new-password" />
	...
	<option value="Year">保存一年</option>
                            ...
                            <li class="login">
                                <input type="image" name="BtnLogin" id="BtnLogin" tabindex="5" class="btn_login" src="" onclick="return BeginClick();WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;BtnLogin&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" style="border-width:0px;display: none" /></li>
                        </ul>
                    </dd>
                </dl>
            </div>
            <div class="user_login_info">
                如果您尚未在本站注册为会员，请先点此<a href="Register.aspx?ReturnUrl=http%3a%2f%2f10.176.17.2%2fUser%2fDefault.aspx">注册</a>。
            </div>
