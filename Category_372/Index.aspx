...
<li class="li4 last on"><a href="/Category_372/Index.aspx">公开招标项目</a></li>
		</ul>
	</div>
</div>
	<script type="text/javascript">
...
<div class="colSreach">
    ...
    栏目搜索：<label><select name="nodeId'" id="nodeId" size="1"><option value=372>公开招标项目</option></select></label><label><select name="fieldOption" id="fieldOption" size="1"><option value="title" selected>文章标题</option>
   ...
   <!--<input type="button" class="input_button" value="高级搜索" onclick="location.href='/search.aspx?searchtype=2&ModelId=1'" />--></label>
    ...
    <a href="/Category_372/Index.aspx" target="_self">公开招标项目</a></div>
                    <h3>公开招标项目</h3>
                </div>
                <div class="mBd">
                    <!-- 正文内容 S -->
            ...
            <li class="first"><span class="date">2022-07-09</span><img src="/images/ontop1.gif" alt="热门"><a href="/Item/16545.aspx" target="_self" title="标题：绍兴市第一中学学生校服采购项目中标公示&#xD;点击数：135&#xD;发表时间：2022年07月09日">绍兴市第一中学学生校服采购项目中标公示</a></li>
