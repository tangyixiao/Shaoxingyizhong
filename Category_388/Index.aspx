...
<div class="colSreach">
    ...
    栏目搜索：<label><select name="nodeId'" id="nodeId" size="1"><option value=388>志愿活动</option></select></label><label><select name="fieldOption" id="fieldOption" size="1"><option value="title" selected>文章标题</option>
   ...
   <!--<input type="button" class="input_button" value="高级搜索" onclick="location.href='/Shaoxingyizhong/search.aspx?searchtype=2&ModelId=1'" />--></label>
    ...
    <a href="/Shaoxingyizhong/Category_388/Index.aspx" target="_self">志愿活动</a></div>
            ...
            <li class="first"><span class="date">2025-09-22</span><img src="/Shaoxingyizhong/images/ontop1.gif" alt="热门"><a href="/Shaoxingyizhong/Item/21962.aspx" target="_self" title="标题：循往逐新，青春正行——绍兴一中2025年暑假社会实践成果展示&#xD;点击数：28&#xD;发表时间：2025年09月22日">循往逐新，青春正行——绍兴一中2025年暑假社会实践成果展示</a></li>
