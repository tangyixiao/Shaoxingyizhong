...
<head>
    ...
    <title>高一、高二有意向参加美术高考学生会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二有意向参加美术高考学生会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8946"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8946},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8946";
     ...
     <FONT size=4>请所有高一、高二有意向参加美术类高考的学生于明天（周二）中午1:20到树兰楼四楼美术教室二（4023）集中。请相互转告，准时到会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8930.aspx" target="_self" title="标题：本周六上课安排通知&#xD;点击数：449&#xD;发表时间：18年08月31日">本周六上课安排通知</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8948.aspx" target="_self" title="标题：高三精英班上课安排&#xD;点击数：489&#xD;发表时间：18年09月03日">高三精英班上课安排</a>[ 09-03 ]</div>
                        </div>
                    </div>
