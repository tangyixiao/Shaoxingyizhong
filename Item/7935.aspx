...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7935"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7935},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7935";
...
<TBODY>
<TR>
<TD><!--插入广告JS代码--></TD></TR></TBODY></TABLE>高一年段各班请注意，周三（今天）下午第四节劳动课大扫除照常进行，值周班于下课前10分钟即时检查，请大家按要求打扫
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7932.aspx" target="_self" title="标题：1.09&amp;nbsp;跑操情况反馈&#xD;点击数：301&#xD;发表时间：18年01月09日">1.09 跑操情况反馈</a>[ 01-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7938.aspx" target="_self" title="标题：高一、高二关于综合素质评价考核的补充通知（有修改）&#xD;点击数：534&#xD;发表时间：18年01月10日">高一、高二关于综合素质评价考核的补充通知（有修改）</a>[ 01-10 ]</div>
                        </div>
                    </div>
