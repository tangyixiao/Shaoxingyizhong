...
<head>
    ...
    <title>2009新生衔接教育“日常行为规范及校史知识”测试优秀奖（个人）名单--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2009新生衔接教育“日常行为规范及校史知识”测试优秀奖（个人）名单</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=114"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:114},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=114";
     ...
     <TABLE style="WIDTH: 417pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=555 border=0 x:str>
<COLGROUP>
...
<COL style="WIDTH: 74pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/113.aspx" target="_self" title="标题：班主任培训通知&#xD;点击数：664&#xD;发表时间：09年08月17日">班主任培训通知</a>[ 08-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/116.aspx" target="_self" title="标题：国旗下讲话主持人、宣讲员招聘启事&#xD;点击数：592&#xD;发表时间：09年08月18日">国旗下讲话主持人、宣讲员招聘启事</a>[ 08-18 ]</div>
                        </div>
                    </div>
