...
<head>
    ...
    <title>高三年段运动会期间工作安排--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三年段运动会期间工作安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7594"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7594},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7594";
     ...
     <P>各位高三老师，运动会期间工作安排如下：</P>
<P>1.原定于本周四的高三老师外出学习推迟到下周进行；</P>
<P>2.运动会两天学生（除运动员和做后勤服务的学生外）在教室里自修，任课老师按课表下班辅导、管理学生，走班课不上。班主任主要做好运动会的组织工作，特别是要提醒学生注意安全；</P>
<P>3.运动会期间的住校生6点45分早读照常，白天住校生不能进入寝室，通校生早上7点15分前到校先到教室集中；</P>
<P>4.本周四的晚自修照常进行，本周五晚自修暂停，周六高三停课，高三师生休息。</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7549.aspx" target="_self" title="标题：选考期间高三主要工作提示&#xD;点击数：1359&#xD;发表时间：17年10月31日">选考期间高三主要工作提示</a>[ 10-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8057.aspx" target="_self" title="标题：高三年级期末考试及以后工作提示&#xD;点击数：676&#xD;发表时间：18年02月04日">高三年级期末考试及以后工作提示</a>[ 02-04 ]</div>
                        </div>
                    </div>
