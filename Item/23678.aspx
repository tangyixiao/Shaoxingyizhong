...
<head>
    ...
    <title>9.17跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9.17跑操量化考核反馈</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23678"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23678},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23678";
     ...
     <p style="text-align: center;"><img src="/UploadFiles/xwzx/2026/9/202609171638556121.png" style="max-width: 100%; " title="202609171638556121.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23677.aspx" target="_self" title="标题：9.16班级一日考核&#xD;点击数：48&#xD;发表时间：26年09月17日">9.16班级一日考核</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Item/23686.aspx" target="_self" title="标题：9.17班级一日考核&#xD;点击数：22&#xD;发表时间：26年09月18日">9.17班级一日考核</a>[ 09-18 ]</div>
                        </div>
                    </div>
