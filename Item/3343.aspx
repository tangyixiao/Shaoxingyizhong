...
<head>
    ...
    <title>大课间操通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3343"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3343},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3343";
     ...
     <P>                                             关于大课间活动的通知</P>
<P>        明天开始的大课间操活动时间，高三年级继续进行慢跑活动，慢跑距离仍如上学期相同，请各班主任组织好自己班级善始善终跑完全程；高二、高一年级在球类场地按原站位做《全国第三套中小学生系列广播体操—舞动青春》。请各班级下课后动作迅速到达指定位置。检查班级认真进行检查。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3341.aspx" target="_self" title="标题：升旗仪式照常进行的通知&#xD;点击数：362&#xD;发表时间：11年02月21日">升旗仪式照常进行的通知</a>[ 02-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3347.aspx" target="_self" title="标题：今天下午大扫除照常进行&#xD;点击数：394&#xD;发表时间：11年02月21日">今天下午大扫除照常进行</a>[ 02-21 ]</div>
                        </div>
                    </div>
