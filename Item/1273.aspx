...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1273"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1273},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1273";
     ...
     <P>     今天下午第四节开始在行政五楼会议室召开全体教代会代表大会，请全体代表准时出席，并请相互转告。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1239.aspx" target="_self" title="标题：高二教代会代表讨论时间改变的通知&#xD;点击数：633&#xD;发表时间：10年01月19日">高二教代会代表讨论时间改变的通知</a>[ 01-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1278.aspx" target="_self" title="标题：通知&#xD;点击数：2938&#xD;发表时间：10年01月25日">通知</a>[ 01-25 ]</div>
                        </div>
                    </div>
