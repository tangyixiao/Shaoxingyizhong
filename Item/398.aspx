...
<head>
    ...
    <title>部分语文课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=398"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:398},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=398";
     ...
     <P>10月14日（星期三）下列老师参加文言文教学研讨，所任课班级课改自修。</P>
<P>余子兰 、吴巍巍、俞苗锋、陈美琴、钟慧军、叶建红、刘明玉、唐海燕、张冬蕾</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/397.aspx" target="_self" title="标题：关于对2009年新聘用教师实施上岗培训的通知&#xD;点击数：628&#xD;发表时间：09年10月13日">关于对2009年新聘用教师实施上岗培训的通知</a>[ 10-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/399.aspx" target="_self" title="标题：高三英语课做练习&#xD;点击数：389&#xD;发表时间：09年10月13日">高三英语课做练习</a>[ 10-13 ]</div>
                        </div>
                    </div>
