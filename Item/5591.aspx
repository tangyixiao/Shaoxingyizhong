...
<head>
    ...
    <title>高二、高三年级体育、体锻课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二、高三年级体育、体锻课改自修通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5591"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5591},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5591";
     ...
     <FONT size=4>下周因高一年级军训，9月26日至30日高二、高三年级下午的体育和体锻课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5590.aspx" target="_self" title="标题：高一军训期间课程安排&#xD;点击数：315&#xD;发表时间：16年09月23日">高一军训期间课程安排</a>[ 09-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5600.aspx" target="_self" title="标题：高三指纹采集时间调整通知&#xD;点击数：115&#xD;发表时间：16年09月26日">高三指纹采集时间调整通知</a>[ 09-26 ]</div>
                        </div>
                    </div>
