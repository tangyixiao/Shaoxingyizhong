...
<head>
    ...
    <title>明天高二通用技术课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">明天高二通用技术课改自修通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8166"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8166},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8166";
     ...
     <P><FONT size=4>因市高考选考适应性考试改卷须要，陈义兵、白宗刚老师外出改卷，明天（3月15日）高二相关班级通用技术课改自修，走班学生到相应上课教室自修。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8165.aspx" target="_self" title="标题：高三本周六上课安排&#xD;点击数：511&#xD;发表时间：18年03月14日">高三本周六上课安排</a>[ 03-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8168.aspx" target="_self" title="标题：韩国梨花女子大学来访及相关讲座通知&#xD;点击数：836&#xD;发表时间：18年03月15日">韩国梨花女子大学来访及相关讲座通知</a>[ 03-15 ]</div>
                        </div>
                    </div>
