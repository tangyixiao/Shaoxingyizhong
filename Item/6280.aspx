...
<head>
    ...
    <title>晚间安全检查记录1.4--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6280"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6280},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6280";
     ...
     <P>1月4日晚，高一（11）班门窗未关</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6245.aspx" target="_self" title="标题：每日晨检表未交情况通报(12.28&amp;12.29)&#xD;点击数：69&#xD;发表时间：16年12月29日">每日晨检表未交情况通报(12.28&amp;12.29)</a>[ 12-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6281.aspx" target="_self" title="标题：每日晨检表未交情况通报(1.4&amp;1.5)&#xD;点击数：55&#xD;发表时间：17年01月05日">每日晨检表未交情况通报(1.4&amp;1.5)</a>[ 01-05 ]</div>
                        </div>
                    </div>
