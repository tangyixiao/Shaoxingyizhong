...
<head>
    ...
    <title>周五体育课暂停通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15178"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15178},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15178";
     ...
     <p><span style="FONT-SIZE: 20px">因3.18-19日市直羽毛球比赛在我校进行，本周五（18日）体育课及训练暂停。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15173.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：182&#xD;发表时间：22年03月16日">化学教研活动通知</a>[ 03-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15181.aspx" target="_self" title="标题：高二第一轮限时训练安排（语文时间有修改）&#xD;点击数：1335&#xD;发表时间：22年04月01日">高二第一轮限时训练安排（语文时间有修改）</a>[ 04-01 ]</div>
                        </div>
                    </div>
