...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7694"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7694},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7694";
     ...
     <FONT size=4>11月28日物理组全体老师外出参加教研活动，相关班级物理课改自修，物理走班班级在相应上课教室自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7693.aspx" target="_self" title="标题：中学生标准学术能力测试（THUSSAT）报名通知&#xD;点击数：360&#xD;发表时间：17年11月27日">中学生标准学术能力测试（THUSSAT）报名通知</a>[ 11-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7695.aspx" target="_self" title="标题：美术选修改自修&#xD;点击数：190&#xD;发表时间：17年11月28日">美术选修改自修</a>[ 11-28 ]</div>
                        </div>
                    </div>
