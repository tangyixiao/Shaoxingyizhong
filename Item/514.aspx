...
<head>
    ...
    <title>有关高三“自选综合”会考--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">有关高三“自选综合”会考</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年11月05日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=514"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:514},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=514";
     ...
     <DIV>有关高三“自选综合”会考</DIV>
<DIV>1、  会考范围：</DIV>
<DIV>（1）人文与社会领域包括：政治---国家和国际组织常识，历史—中外历史人物评说、20世纪的战争与和平，地理—城乡规划、环境保护。</DIV>
<DIV>（2）科学领域包括：物理—选修3-2、3-4、3-5，化学—选修4（化学反应原理），化学—选修6（实验化学），生物--选修3</DIV>
<DIV>2、是否参加“自选综合”的会考完全由学生自己决定。</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/510.aspx" target="_self" title="标题：关于高一校本课程暂停上课的通知&#xD;点击数：252&#xD;发表时间：09年11月04日">关于高一校本课程暂停上课的通知</a>[ 11-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/515.aspx" target="_self" title="标题：高二、高三班主任《会考报名确认表》速上交&#xD;点击数：342&#xD;发表时间：09年11月05日">高二、高三班主任《会考报名确认表》速上交</a>[ 11-05 ]</div>
                        </div>
                    </div>
