...
<head>
    ...
    <title>关于全校各班团支部书记培训的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于全校各班团支部书记培训的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年09月03日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=200"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:200},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=200";
...
<DIV>    <FONT size=4>请全校各班团支部书记于9月4日（星期五）中午12：20分到实验楼南203室参加团支部书记培训，请相互转告，并随带记录本。勿迟到。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/175.aspx" target="_self" title="标题：关于黑板报工作会议通知&#xD;点击数：489&#xD;发表时间：09年08月31日">关于黑板报工作会议通知</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/202.aspx" target="_self" title="标题：团委学生会干部招聘办法&#xD;点击数：469&#xD;发表时间：09年09月04日">团委学生会干部招聘办法</a>[ 09-04 ]</div>
                        </div>
                    </div>
