...
<head>
    ...
    <title>心理社团会议通知（地点有修改）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">心理社团会议通知（地点有修改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18427"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18427},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18427";
     ...
     <p>请海贝·心理沙龙社高二社员于今天（9月16日）中午12:40到行政楼四楼4008心理教室开会，请互相转告，准时到达。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18425.aspx" target="_self" title="标题：失物招领&#xD;点击数：82&#xD;发表时间：23年09月15日">失物招领</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18439.aspx" target="_self" title="标题：失物招领（钥匙）&#xD;点击数：44&#xD;发表时间：23年09月18日">失物招领（钥匙）</a>[ 09-18 ]</div>
                        </div>
                    </div>
