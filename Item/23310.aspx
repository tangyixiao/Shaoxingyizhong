...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=23310"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23310},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23310";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2026/5/202605291450102666.png" style="max-width: 100%; " title="202605291450102666.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/23309.aspx" target="_self" title="标题：寻物启事三则（手表/答题卡）&#xD;点击数：102&#xD;发表时间：26年05月29日">寻物启事三则（手表/答题卡）</a>[ 05-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/23313.aspx" target="_self" title="标题：失物招领（钱包）&#xD;点击数：44&#xD;发表时间：26年05月30日">失物招领（钱包）</a>[ 05-30 ]</div>
                        </div>
                    </div>
