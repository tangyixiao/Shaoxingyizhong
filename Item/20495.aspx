...
<head>
    ...
    <title>11.5班级一日考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20495"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20495},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20495";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2024/11/202411081707348056.png" style="max-width: 100%; " title="202411081707348056.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20494.aspx" target="_self" title="标题：高三：减压赋能·逐梦高考 --秋季户外研学活动方案（一天）&#xD;点击数：301&#xD;发表时间：24年11月06日">高三：减压赋能·逐梦高考 --秋季户外研学活动方案（一天）</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20497.aspx" target="_self" title="标题：寻物启事（2张饭卡）&#xD;点击数：95&#xD;发表时间：24年11月07日">寻物启事（2张饭卡）</a>[ 11-07 ]</div>
                        </div>
                    </div>
