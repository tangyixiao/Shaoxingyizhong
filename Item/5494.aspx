...
<head>
    ...
    <title>今天下午4点文明办公室检查通知--工会-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_32/Index.aspx" target="_self">工会</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天下午4点文明办公室检查通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5494"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5494},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5494";
     ...
     <P>      干干净净迎中秋，决定下午4点进行文明办公室检查，要求做到地面清洁、墙面干净、桌面整齐、资料堆放有序、生活用品入柜。</P>
<P>                                                      工会  2016/09/11</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5472.aspx" target="_self" title="标题：工会职工住院医疗保险提醒&#xD;点击数：168&#xD;发表时间：16年09月09日">工会职工住院医疗保险提醒</a>[ 09-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5542.aspx" target="_self" title="标题：晚间体育场馆开放通知&#xD;点击数：195&#xD;发表时间：16年09月19日">晚间体育场馆开放通知</a>[ 09-19 ]</div>
                        </div>
                    </div>
