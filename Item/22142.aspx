...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22142"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22142},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22142";
     ...
     <p>  2025年10月28日（周二）上午第四节，在高一（7）班教室，由政治组郑清清老师执教汇报课，欢迎各位老师莅临指导。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22139.aspx" target="_self" title="标题：关于“基于大概念的单元整体设计”微讲座录像评比活动的通知&#xD;点击数：135&#xD;发表时间：25年10月27日">关于“基于大概念的单元整体设计”微讲座录像评比活动的通知</a>[ 10-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22143.aspx" target="_self" title="标题：英语组外出参加教研活动的通知&#xD;点击数：213&#xD;发表时间：25年10月27日">英语组外出参加教研活动的通知</a>[ 10-27 ]</div>
                        </div>
                    </div>
