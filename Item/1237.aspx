...
<head>
    ...
    <title>关于行政工会小组代表分组讨论会议更改地点的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于行政工会小组代表分组讨论会议更改地点的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1237"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1237},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1237";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
             ...
             因今天下午第四节课要在行政楼五楼会议室开设校本课,故行政工会小组代表的审议讨论会议地点临时改为实验楼南305室,请相互转告!
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1229.aspx" target="_self" title="标题：召开绍兴一中九届教代会通知&#xD;点击数：873&#xD;发表时间：10年01月18日">召开绍兴一中九届教代会通知</a>[ 01-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1238.aspx" target="_self" title="标题：关于传达室东侧非机动车停车通知&#xD;点击数：807&#xD;发表时间：10年01月19日">关于传达室东侧非机动车停车通知</a>[ 01-19 ]</div>
                        </div>
                    </div>
