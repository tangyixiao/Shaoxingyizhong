...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">值周小结</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年10月25日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=451"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:451},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=451";
     ...
     <DIV align=left><FONT size=3>第八周周一至周三上课，周三举行高一、高二的合唱比赛，周四、周五举行全校运动会，周六调休，总体情况良好，主要存在的问题如下：</FONT></DIV>
<DIV align=left><FONT size=3>1．学生在网上购物的情况依然存在，请相关班主任做好教育工作。</FONT></DIV>
<DIV align=left><FONT size=3>2．晚自修前夕，发现有些班级有学生在利用班级的电脑上网，周边还围着一些学生，希望班主任加强管理。同
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/448.aspx" target="_self" title="标题：绍兴一中高校自主招生（推荐生、保送生）推荐规程&#xD;点击数：638&#xD;发表时间：09年10月25日">绍兴一中高校自主招生（推荐生、保送生）推荐规程</a>[ 10-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/453.aspx" target="_self" title="标题：未成年人医保参保学生交费有关问题（班主任）&#xD;点击数：450&#xD;发表时间：09年10月26日">未成年人医保参保学生交费有关问题（班主任）</a>[ 10-26 ]</div>
                        </div>
                    </div>
