...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2974"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2974},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2974";
     ...
     <P>                                  文明办公室检查</P>
<P>     今天下午第四节课进行文明办公室检查,请高一、高二、高三今天白天值班的老师下午第四节课到陈副校长办公室集中。</P>
<P>                                                       校文明办公室检查小组</P>
<P>                                                               2010.12.1</P>
<P>                                                    </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2971.aspx" target="_self" title="标题：喜报&#xD;点击数：687&#xD;发表时间：10年12月01日">喜报</a>[ 12-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2993.aspx" target="_self" title="标题：关于举行教工消防（水带）演练的通知&#xD;点击数：435&#xD;发表时间：10年12月04日">关于举行教工消防（水带）演练的通知</a>[ 12-04 ]</div>
                        </div>
                    </div>
