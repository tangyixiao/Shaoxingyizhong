...
<head>
    ...
    <title>关于召开原虚拟十七班任课教师座谈会的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于召开原虚拟十七班任课教师座谈会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=536"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:536},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=536";
     ...
     <DIV align=center><FONT size=4>关于召开原虚拟十七班任课教师座谈会的通知</FONT></DIV>
<DIV align=left><FONT size=4>     </FONT></DIV>
<DIV align=left><FONT size=4>     今天（11月10日）下午第三节课在行政楼三楼会议室召开原虚拟十七班任课教师座谈会，请下列老师拨冗参加：</FONT></DIV>
<DI
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/533.aspx" target="_self" title="标题：政治课改自修&#xD;点击数：257&#xD;发表时间：09年11月09日">政治课改自修</a>[ 11-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/538.aspx" target="_self" title="标题：关于本周校本课程暂停的通知&#xD;点击数：352&#xD;发表时间：09年11月10日">关于本周校本课程暂停的通知</a>[ 11-10 ]</div>
                        </div>
                    </div>
