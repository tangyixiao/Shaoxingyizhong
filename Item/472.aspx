...
<head>
    ...
    <title>关于继续加强体温检测和病情上报工作的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于继续加强体温检测和病情上报工作的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：安全</span> <span>发布时间：2009年10月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=472"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:472},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=472";
     ...
     <DIV align=center><B><FONT size=4>关于继续加强体温检测和病情上报工作的通知</FONT></B></DIV>
<DIV> </DIV>
<DIV><FONT size=3>全校各班：</FONT></DIV>
<DIV><FONT size=3>      近来,市属学校呈现流感爆发态势,我校也有两个班出现较多学生发烧现象,为了进一步加强对甲型H1N1流感的防控工作，学校要求各班继续认真做好体温检测和病情上报工作
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/454.aspx" target="_self" title="标题：通知&#xD;点击数：262&#xD;发表时间：09年10月26日">通知</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/497.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.10.25-10.31）&#xD;点击数：337&#xD;发表时间：09年11月03日">绍兴一中校园晚间安全检查公告(2009.10.25-10.31）</a>[ 11-03 ]</div>
                        </div>
                    </div>
