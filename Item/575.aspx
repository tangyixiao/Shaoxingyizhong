...
<head>
    ...
    <title>我仰视那时的老师--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=575"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:575},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=575";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/574.aspx" target="_self" title="标题：不怕油尽烛灭　只期果硕花红&#xD;点击数：399&#xD;发表时间：09年11月13日">不怕油尽烛灭　只期果硕花红</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/576.aspx" target="_self" title="标题：国税教育基地设到绍兴一中&#xD;点击数：407&#xD;发表时间：09年11月13日">国税教育基地设到绍兴一中</a>[ 11-13 ]</div>
                        </div>
                    </div>
