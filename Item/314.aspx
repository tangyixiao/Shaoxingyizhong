...
<head>
    ...
    <title>关于转发市教育教学研究院《在教师研修网申请继续教育学分的几点说明》的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于转发市教育教学研究院《在教师研修网申请继续教育学分的几点说明》的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月22日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=314"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:314},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=314";
     ...
     <PRE>     <FONT size=4 face=黑体>关于转发市教育教学研究院《在教师研修网申请继续教育学分的几点说明》的通知</FONT></PRE><PRE><FONT size=4>各位教工：</FONT></PRE><PRE><FONT size=4>   接市教育教学研究院有关部门的通知，《在教师研修网申请继续教育</FONT></PRE><PRE><FONT size=4>学分出现的问题》有以下几点说明，</FONT><FONT size=4>请老师们抓紧时间进行自查或修正。</FON
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/310.aspx" target="_self" title="标题：关于领取《教育新视野》的通知&#xD;点击数：307&#xD;发表时间：09年09月21日">关于领取《教育新视野》的通知</a>[ 09-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/317.aspx" target="_self" title="标题：关于完善浙江省电子学籍管理系统的通知&#xD;点击数：498&#xD;发表时间：09年09月23日">关于完善浙江省电子学籍管理系统的通知</a>[ 09-23 ]</div>
                        </div>
                    </div>
