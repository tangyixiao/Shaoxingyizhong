...
<head>
    ...
    <title>第4周主要工作安排表（3.10-3.16）--工作安排-绍兴市第一中学</title>
...
<li class="li5 last"><a href="/Shaoxingyizhong/Category_24/Index.aspx">校务公开</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21051"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21051},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21051";
     ...
     <p style="font-family: 宋体;font-size: 18pt;line-height: 108%;margin-bottom: .001pt;margin-left: 0;margin-right: 0;margin-top: 0;text-align: center;">
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21015.aspx" target="_self" title="标题：第3周主要工作安排表（3.3-3.9）&#xD;点击数：5&#xD;发表时间：25年03月04日">第3周主要工作安排表（3.3-3.9）</a>[ 03-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21085.aspx" target="_self" title="标题：第5周主要工作安排表（3.17-3.23）&#xD;点击数：8&#xD;发表时间：25年03月17日">第5周主要工作安排表（3.17-3.23）</a>[ 03-17 ]</div>
                        </div>
                    </div>
