...
<head>
    ...
    <title>关于下周一正常开展值周检查的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于下周一正常开展值周检查的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8107"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8107},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8107";
     ...
     <P>自下周一起，本学期值周工作照常展开，请各班同学配合做好安全，纪律，卫生，体锻，文明等各项工作，值周班将即时检查。</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8105.aspx" target="_self" title="标题：关于做好2018年春季贫困生资助工作通知&#xD;点击数：595&#xD;发表时间：18年03月04日">关于做好2018年春季贫困生资助工作通知</a>[ 03-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8111.aspx" target="_self" title="标题：关于营造整洁优美的校园环境及进一步规范垃圾分类工作的通知&#xD;点击数：235&#xD;发表时间：18年03月05日">关于营造整洁优美的校园环境及进一步规范垃圾分类工作的通知</a>[ 03-05 ]</div>
                        </div>
                    </div>
