...
<head>
    ...
    <title>关于发放国庆放假的告家长书的几点提示--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于发放国庆放假的告家长书的几点提示</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2518"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2518},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2518";
     ...
     <P><FONT size=4>各位班主任：</FONT></P>
<P><FONT size=4>    今天下发的关于国庆放假的告家长书（五），请各位班主任查收，如数量不够，可自行打印，随附告家长书电子稿。考虑到中秋节后到国庆，住校生没有回家时间，希望各位班主任能在今天放假前及时下发，节后收齐回执。另，放假安排及注意事项，也请班主任用校讯通群发给家长。</FONT></P>
<P><FONT size=4>    谢谢</FONT></P>
<P><FONT size=4>                                                                  德育处</FONT></P>
<P><FONT size=4>                                                                       9月22日</FONT></P>
<P><A title=告家长书（五） href="/Shaoxingyizhong/UploadFiles/UploadFiles/201009/2010092210081478.doc"><FONT color=#ff0000 size=4>告家长书（五）</FONT></A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2516.aspx" target="_self" title="标题：值周检查情况汇总（9月20日星期二）&#xD;点击数：388&#xD;发表时间：10年09月22日">值周检查情况汇总（9月20日星期二）</a>[ 09-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2524.aspx" target="_self" title="标题：表扬与批评&#xD;点击数：1582&#xD;发表时间：10年09月25日">表扬与批评</a>[ 09-25 ]</div>
                        </div>
                    </div>
