...
<head>
    ...
    <title>晚间安全检查记录12.02--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录12.02</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6052"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6052},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6052";
     ...
     12月2日晚，高一（13）班门和灯未关。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6051.aspx" target="_self" title="标题：每日晨检表未交情况通报12.05&#xD;点击数：54&#xD;发表时间：16年12月05日">每日晨检表未交情况通报12.05</a>[ 12-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6064.aspx" target="_self" title="标题：晚间安全检查记录12.05&#xD;点击数：35&#xD;发表时间：16年12月06日">晚间安全检查记录12.05</a>[ 12-06 ]</div>
                        </div>
                    </div>
