...
<head>
    ...
    <title>关于明天大课间出操的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于明天大课间出操的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18353"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18353},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18353";
     ...
     <p>各班级：</p><p style="text-indent:28px">为更好地让全校各班明确大课间、升旗仪式的进场、站位，更好地帮助高一学生学习广播操，德育处、体育组研究决定：明天大课间高一学生全体学生参与，高二，高三派体育委员一人参与，其他学生待在教学楼区域。</p><p style="text-indent:28px"> </p><p style="text-indent:350px">德育处、体育组</p><p style="text-indent:350px">2023年9月7日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18352.aspx" target="_self" title="标题：关于大课间做操、升旗仪式的进场、站位及相关要求的通知&#xD;点击数：163&#xD;发表时间：23年09月07日">关于大课间做操、升旗仪式的进场、站位及相关要求的通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18354.aspx" target="_self" title="标题：关于开展全校班主任会议的通知&#xD;点击数：231&#xD;发表时间：23年09月08日">关于开展全校班主任会议的通知</a>[ 09-08 ]</div>
                        </div>
                    </div>
