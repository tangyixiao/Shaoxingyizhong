...
<head>
    ...
    <title>第17周主要工作安排表（6.9-6.15）--工作安排-绍兴市第一中学</title>
...
<li class="li5 last"><a href="/Shaoxingyizhong/Category_24/Index.aspx">校务公开</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21597"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21597},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21597";
     ...
     <p><strong><span style="font-family: 宋体;font-size: 19px">本周重点聚焦：</span></strong><span style="font-family: 楷体;font-size: 19px">1.教学：清北强基校测集训准备，高一模拟学考</span></p><p style="text-indent: 131px"><span style="font-family: 楷体;font-size: 19px">2.德育：启动学生综合素质考评，学生行为规范检查</span></p><p style="text-indent: 131px"><span style="font-family: 楷体;font-size: 19px">3.档案：高考档案，档案工作指数评价与登记备份</span></p><p style="text-indent: 131px"><span style="font-family: 楷体;font-size: 19px">4.管理：期末工作行事历梳理</span></p><p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/6/202506120812594950.png" style="max-width: 100%; " title="202506120812594950.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21595.aspx" target="_self" title="标题：第15周主要工作安排表（5.26-6.1）&#xD;点击数：193&#xD;发表时间：25年05月26日">第15周主要工作安排表（5.26-6.1）</a>[ 05-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21833.aspx" target="_self" title="标题：第1周主要工作安排表（9.1-9.7）&#xD;点击数：8&#xD;发表时间：25年09月01日">第1周主要工作安排表（9.1-9.7）</a>[ 09-01 ]</div>
                        </div>
                    </div>
