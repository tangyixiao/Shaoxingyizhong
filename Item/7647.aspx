...
<head>
    ...
    <title>大课间操、升旗仪式暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">大课间操、升旗仪式暂停通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7647"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7647},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7647";
...
<P></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7643.aspx" target="_self" title="标题：关于参加段云成老师《班主任的管理智慧》讲座的通知&#xD;点击数：207&#xD;发表时间：17年11月16日">关于参加段云成老师《班主任的管理智慧》讲座的通知</a>[ 11-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7650.aspx" target="_self" title="标题：期中考试考风考纪要求&#xD;点击数：250&#xD;发表时间：17年11月17日">期中考试考风考纪要求</a>[ 11-17 ]</div>
                        </div>
                    </div>
