...
<head>
    ...
    <title>绍兴一中工作领导小组--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中工作领导小组</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年11月02日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=319"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:319},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=319";
     ...
     <DIV align=center><B>绍兴一中工作领导小组</B></DIV>
<DIV align=left><STRONG>   经学校研究决定成立下列领导小组，现公布：</STRONG></DIV>
<DIV>1．行风建设领导小组：</DIV>
<DIV>    组 长：马德尧  </DIV>
<DIV>    副组长：王柏根  </DIV>
<DIV>    组 员
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/305.aspx" target="_self" title="标题：关于教工会议的通知&#xD;点击数：548&#xD;发表时间：09年09月21日">关于教工会议的通知</a>[ 09-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/320.aspx" target="_self" title="标题：国庆中秋放假值班安排&#xD;点击数：650&#xD;发表时间：09年09月24日">国庆中秋放假值班安排</a>[ 09-24 ]</div>
                        </div>
                    </div>
