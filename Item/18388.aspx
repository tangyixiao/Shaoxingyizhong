...
<head>
    ...
    <title>高三协作体考试分析会--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18388"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18388},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18388";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 20px; background-color: rgb(255, 255, 255);">兹定于今天下午第8节课在树兰楼三楼会议室二召开高三协作体考试分析会，请各位高三任课老师准时参加。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18387.aspx" target="_self" title="标题：9月限时训练考场布置要求&#xD;点击数：177&#xD;发表时间：23年09月12日">9月限时训练考场布置要求</a>[ 09-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18399.aspx" target="_self" title="标题：高二协作体考试分析会&#xD;点击数：157&#xD;发表时间：23年09月13日">高二协作体考试分析会</a>[ 09-13 ]</div>
                        </div>
                    </div>
