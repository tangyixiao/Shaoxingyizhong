...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=484"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:484},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=484";
     ...
     <DIV align=center><B>高一、高二期中考试场布置要求</B></DIV>
<DIV>本次期中考试，高一、高二学生合坐一个试场，<B>每个试场</B><B>60</B><B>人（高一30</B><B>人，高二30</B><B>人）</B></DIV>
<DIV>故提出以下试场布置要求：</DIV>
<DIV><B>1</B><B>、布置时间：本周六上午第四节课后进行布置</B></DIV>
<DIV><B>2</B><B>、需布置的班级：高二（1</B><B>）--</B><B>（16</
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/481.aspx" target="_self" title="标题：关于网站下载资料的通知&#xD;点击数：379&#xD;发表时间：09年10月29日">关于网站下载资料的通知</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/485.aspx" target="_self" title="标题：高一期中考试试场、监考安排&#xD;点击数：396&#xD;发表时间：09年10月30日">高一期中考试试场、监考安排</a>[ 10-30 ]</div>
                        </div>
                    </div>
