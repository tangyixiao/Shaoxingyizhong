...
<head>
    ...
    <title>第1-3周早上迟到学生统计--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">第1-3周早上迟到学生统计</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17384"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17384},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17384";
     ...
     <p style="line-height: 16px;">第1-3周早上迟到学生统计</p><p style="line-height: 16px;"><img style="vertical-align: middle; margin-right: 2px;" src="http://10.176.17.2/UEditor/dialogs/attachment/fileTypeImages/icon_xls.gif" /><a style="font-size:12px; color:#0066cc;" href="/Shaoxingyizhong/UploadFiles/xwzx/2023/3/202303021700408072.xlsx" title="202303021700408072.xlsx">202303021700408072.xlsx</a></p><p style="line-height: 16px;">
</p><p style="line-height: 16px;">
</p><p style="line-height: 16px;">         德育处</p><p style="line-height: 16px;">      2023年3月2日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17381.aspx" target="_self" title="标题：3.2跑操量化考核反馈&#xD;点击数：113&#xD;发表时间：23年03月02日">3.2跑操量化考核反馈</a>[ 03-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17388.aspx" target="_self" title="标题：3.2班级一日考核&#xD;点击数：86&#xD;发表时间：23年03月06日">3.2班级一日考核</a>[ 03-06 ]</div>
                        </div>
                    </div>
