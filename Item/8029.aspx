...
<head>
    ...
    <title>本周大课间操暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8029"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8029},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8029";
         ...
         根据绍兴市气象台1月30日发布：受北方输入性污染物影响，目前我市已经出现中度、局部中度污染，预计近三天中到重度污染仍将持续，故<STRONG>本周大课间操全部取消</STRONG>。建议各位同学尤其是呼吸道、心脑血管疾病患者等易感人群尽量留在室内，减少户外运动。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8026.aspx" target="_self" title="标题：“文明寝室”表彰公告&#xD;点击数：378&#xD;发表时间：18年01月29日">“文明寝室”表彰公告</a>[ 01-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8036.aspx" target="_self" title="标题：2017学年第一学期单项先进公示&#xD;点击数：436&#xD;发表时间：18年01月31日">2017学年第一学期单项先进公示</a>[ 01-31 ]</div>
                        </div>
                    </div>
