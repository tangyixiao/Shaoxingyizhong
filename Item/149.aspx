...
<head>
    ...
    <title>高一、高二、高三各班主任--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二、高三各班主任</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=149"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:149},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=149";
     ...
     <P><FONT size=4>高一、高二、高三各班主任：</FONT></P>
<P><FONT size=4>      还未交贫困生情况登记表的班级，请尽快到德育处领取表格（原有的贫困生也需重新填表）。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/142.aspx" target="_self" title="标题：各班值日提醒&#xD;点击数：449&#xD;发表时间：09年08月25日">各班值日提醒</a>[ 08-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/151.aspx" target="_self" title="标题：温馨提示&#xD;点击数：574&#xD;发表时间：09年08月27日">温馨提示</a>[ 08-27 ]</div>
                        </div>
                    </div>
