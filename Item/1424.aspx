...
<head>
    ...
    <title>关于学生中午错时用餐的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于学生中午错时用餐的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1424"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1424},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1424";
     ...
     <P><FONT size=4>各位老师、同学，中午错时用餐制度已经实施一段时间，取得了良好的效果。但是，还有部分学生班级没有很好的执行起来。现学校重申中午错时用餐要求，希望有关老师和学生从明天开始能自觉执行。中午第一次铃声11：40为高三年级学生中餐时间，第二次铃声11：45为高一高二年级学生中餐时间。两次铃声的中间5分钟，辛苦第四节有课的老师管理自修纪律。</FONT></P>
<P><FONT size=4>                                                                          教学处</FONT></P>
<P><FONT size=4>                                                                          2010.3.10</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1423.aspx" target="_self" title="标题：关于召开高一任课教师会议的通知&#xD;点击数：387&#xD;发表时间：10年03月10日">关于召开高一任课教师会议的通知</a>[ 03-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1425.aspx" target="_self" title="标题：高三百校联考试场布置要求&#xD;点击数：1262&#xD;发表时间：10年03月11日">高三百校联考试场布置要求</a>[ 03-11 ]</div>
                        </div>
                    </div>
