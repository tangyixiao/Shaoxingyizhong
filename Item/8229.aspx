...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8229"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8229},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8229";
     ...
     <P><FONT size=4>各教职工：</FONT></P>
<P><FONT size=4>    因行政楼西侧与操场西侧的汽车遮阳棚明天起将进行施工，故即日起停止使用。希各知照！</FONT></P>
<P align=right><FONT size=4>总务处<BR>2018.3.27</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8205.aspx" target="_self" title="标题：各班安全委员开会通知&#xD;点击数：1056&#xD;发表时间：18年03月22日">各班安全委员开会通知</a>[ 03-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8270.aspx" target="_self" title="标题：考试期间车辆停放通知&#xD;点击数：177&#xD;发表时间：18年04月04日">考试期间车辆停放通知</a>[ 04-04 ]</div>
                        </div>
                    </div>
