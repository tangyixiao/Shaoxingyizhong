...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2999"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2999},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2999";
...
<P><FONT size=4>12月5日晚，以下住校学生无故缺席，在此提出批评。</FONT></P>
<P><FONT size=4>高一（9）班王芳莹、高一（14）班鲁萍、三（3）班 卢伊湄</FONT></P>
<P><FONT size=4></FONT> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2995.aspx" target="_self" title="标题：值周检查情况汇总（12月3日星期五）&#xD;点击数：302&#xD;发表时间：10年12月04日">值周检查情况汇总（12月3日星期五）</a>[ 12-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3002.aspx" target="_self" title="标题：有关大扫除的通知&#xD;点击数：418&#xD;发表时间：10年12月06日">有关大扫除的通知</a>[ 12-06 ]</div>
                        </div>
                    </div>
