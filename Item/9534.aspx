...
<head>
    ...
    <title>树人导报（成人礼版面）领取通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">树人导报（成人礼版面）领取通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9534"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9534},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9534";
     ...
     <P>请全校各班团支书/班长至教学楼2114团委领取树人导报（12.12期巨幅成人仪式版面）。</P>
<P align=right>校团委<BR>12月18日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9518.aspx" target="_self" title="标题：第二届“金声杯”朗诵比赛初赛通知（附名单）&#xD;点击数：446&#xD;发表时间：18年12月15日">第二届“金声杯”朗诵比赛初赛通知（附名单）</a>[ 12-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9535.aspx" target="_self" title="标题：第六期团校结业考试通知&#xD;点击数：311&#xD;发表时间：18年12月18日">第六期团校结业考试通知</a>[ 12-18 ]</div>
                        </div>
                    </div>
