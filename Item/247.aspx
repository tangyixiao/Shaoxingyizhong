...
<head>
    ...
    <title>关于团委干部招聘面试的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于团委干部招聘面试的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=247"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:247},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=247";
...
<DIV align=left><FONT size=3>    请下列同学于9月14日（星期一）中午12：10到实验楼南203室参加面试，面试依照表格上的名单顺序逐个进行，其余同学在实验楼南205室等候。过时不候，请相互转告。</FONT></DIV>
...
<TD vAlign=t
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/245.aspx" target="_self" title="标题：“感恩教师”专题黑板报评比结果&#xD;点击数：546&#xD;发表时间：09年09月10日">“感恩教师”专题黑板报评比结果</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/248.aspx" target="_self" title="标题：关于学生会干部招聘面试的通知&#xD;点击数：524&#xD;发表时间：09年09月11日">关于学生会干部招聘面试的通知</a>[ 09-11 ]</div>
                        </div>
                    </div>
