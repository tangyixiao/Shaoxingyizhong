...
<head>
    ...
    <title>造就身心健康发展的教师　　培养身心健康发展的学生--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2972"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2972},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2972";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2873.aspx" target="_self" title="标题：凭良心做事，不能对不起学生&#xD;点击数：1202&#xD;发表时间：10年11月17日">凭良心做事，不能对不起学生</a>[ 11-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3013.aspx" target="_self" title="标题：绍兴一中学生再次荣获“丘成桐中学数学奖”&#xD;点击数：696&#xD;发表时间：10年12月08日">绍兴一中学生再次荣获“丘成桐中学数学奖”</a>[ 12-08 ]</div>
                        </div>
                    </div>
