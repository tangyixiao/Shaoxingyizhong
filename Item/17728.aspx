...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17728"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17728},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17728";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2023/4/202304211636076128.png" style="max-width: 100%; " title="202304211636076128.png" /></p><p style="line-height: 16px;"><img style="vertical-align: middle; margin-right: 2px;" src="http://10.176.17.2/UEditor/dialogs/attachment/fileTypeImages/icon_xls.gif" /><a style="font-size:12px; color:#0066cc;" href="/Shaoxingyizhong/UploadFiles/xwzx/2023/4/202304211636188243.xlsx" title="202304211636188243.xlsx">202304211636188243.xlsx</a></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17725.aspx" target="_self" title="标题：失物招领（钥匙）&#xD;点击数：111&#xD;发表时间：23年04月21日">失物招领（钥匙）</a>[ 04-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17732.aspx" target="_self" title="标题：关于规范活动课借用及使用器材的通知&#xD;点击数：314&#xD;发表时间：23年04月23日">关于规范活动课借用及使用器材的通知</a>[ 04-23 ]</div>
                        </div>
                    </div>
