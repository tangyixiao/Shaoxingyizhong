...
<head>
    ...
    <title>8.31日住校生考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13827"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13827},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13827";
     ...
     <p style="line-height: 16px;"><img style="vertical-align: middle; margin-right: 2px;" src="http://10.176.17.2/UEditor/dialogs/attachment/fileTypeImages/icon_xls.gif" /><a style="font-size:12px; color:#0066cc;" href="/Shaoxingyizhong/UploadFiles/xwzx/2021/9/202109011413152189.xlsx" title="202109011413152189.xlsx">202109011413152189.xlsx</a></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13823.aspx" target="_self" title="标题：高一国旗班开会通知&#xD;点击数：123&#xD;发表时间：21年09月01日">高一国旗班开会通知</a>[ 09-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13828.aspx" target="_self" title="标题：早读、晚读、晚自修放学时间提醒（夏令时）&#xD;点击数：217&#xD;发表时间：21年09月01日">早读、晚读、晚自修放学时间提醒（夏令时）</a>[ 09-01 ]</div>
                        </div>
                    </div>
