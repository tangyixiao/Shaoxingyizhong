...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12578"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12578},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12578";
     ...
     <P>现有106班匿名同学在校园里拾到现金若干，请失主尽快到德育处2114领取。特此表扬该同学拾金不昧！</P>
<P>                                                                                        德育处</P>
<P>                                                                                      2021.1.2</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12576.aspx" target="_self" title="标题：大课间跑操暂停通知&#xD;点击数：354&#xD;发表时间：21年01月02日">大课间跑操暂停通知</a>[ 01-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12588.aspx" target="_self" title="标题：12月大课间跑操评比结果&#xD;点击数：270&#xD;发表时间：21年01月04日">12月大课间跑操评比结果</a>[ 01-04 ]</div>
                        </div>
                    </div>
