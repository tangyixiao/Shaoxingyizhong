...
<head>
    ...
    <title>政治教研组外出教研通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12297"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12297},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12297";
     ...
     <FONT size=4>12月2日（周三）政治组外出参加教研活动，当天的政治课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12258.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：282&#xD;发表时间：20年11月25日">化学教研活动通知</a>[ 11-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12318.aspx" target="_self" title="标题：高二日语选修课开课通知&#xD;点击数：299&#xD;发表时间：20年12月04日">高二日语选修课开课通知</a>[ 12-04 ]</div>
                        </div>
                    </div>
