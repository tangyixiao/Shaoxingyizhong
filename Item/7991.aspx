...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7991"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7991},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7991";
...
<P>       2、除每周固定劳动课之外，负责班级平时也需及时打扫本班包干区。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7990.aspx" target="_self" title="标题：升旗仪式暂停通知&#xD;点击数：280&#xD;发表时间：18年01月22日">升旗仪式暂停通知</a>[ 01-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7992.aspx" target="_self" title="标题：上周值周小结&#xD;点击数：135&#xD;发表时间：18年01月22日">上周值周小结</a>[ 01-22 ]</div>
                        </div>
                    </div>
