...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=212"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:212},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=212";
     ...
     定于今天下午第四节课在行政楼五楼会议室召开会议,请全体教工准时参加!
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/203.aspx" target="_self" title="标题：关于中午实行错时用餐的通知&#xD;点击数：633&#xD;发表时间：09年09月04日">关于中午实行错时用餐的通知</a>[ 09-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/216.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.1-9.5）&#xD;点击数：1182&#xD;发表时间：09年09月07日">绍兴一中校园晚间安全检查公告(2009.1-9.5）</a>[ 09-07 ]</div>
                        </div>
                    </div>
