...
<head>
    ...
    <title>团委学生会干部招聘办法--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">团委学生会干部招聘办法</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年09月04日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=202"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:202},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=202";
     ...
     <P><FONT size=3>    为锻炼学生“自我教育、自我管理、自我服务”的综合能力，同时充分发挥学校与学生之间的桥梁和纽带作用，现面向高一、高二学生招聘团委、学生会干部若干，具体办法如下：</FONT></P>
<P><B><FONT size=3>    一、招聘条件</FONT></B></P>
<P><FONT size=3>    1.思想上进，觉悟较高，各方面积极要求进步。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/200.aspx" target="_self" title="标题：关于全校各班团支部书记培训的通知&#xD;点击数：453&#xD;发表时间：09年09月03日">关于全校各班团支部书记培训的通知</a>[ 09-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/210.aspx" target="_self" title="标题：高一、高二各班&#xD;点击数：541&#xD;发表时间：09年09月07日">高一、高二各班</a>[ 09-07 ]</div>
                        </div>
                    </div>
