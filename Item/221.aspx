...
<head>
    ...
    <title>9月12日英语听力高考播放组、监听组、领队组名单--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9月12日英语听力高考播放组、监听组、领队组名单</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=221"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:221},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=221";
     ...
     <DIV><B>（三）播 放 组：</B>王岚    朱玛莉（85335327）   杨大伟（85337819 ）<B></B></DIV>
<DIV><B></B> </DIV>
<DIV><B>（四）监 听 组：</B></DIV>
<DIV><B>1</B><B>、负责：</B>陈银伟 </DIV>
<DIV><B>2</B><B>、监听：</B>张宗旺(2号楼二楼85338129)  楼立青(2号楼三楼85338147)</DI
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/218.aspx" target="_self" title="标题：高一年级今天下午第三节调课通知&#xD;点击数：537&#xD;发表时间：09年09月07日">高一年级今天下午第三节调课通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/226.aspx" target="_self" title="标题：增加体育老师到高级中学监考&#xD;点击数：441&#xD;发表时间：09年09月08日">增加体育老师到高级中学监考</a>[ 09-08 ]</div>
                        </div>
                    </div>
