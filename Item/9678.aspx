...
<head>
    ...
    <title>下周一停课复习通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9678"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9678},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9678";
     ...
     <P><FONT size=4>因下周二起高一、高二期末考试，周一的课老师们可以根据本学科的实际情况进行停课复习，但任课老师必须按课表下班辅导。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9669.aspx" target="_self" title="标题：上海科技大学、香港理工大学招生宣讲&#xD;点击数：472&#xD;发表时间：19年01月16日">上海科技大学、香港理工大学招生宣讲</a>[ 01-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9693.aspx" target="_self" title="标题：高二期末考试安排&#xD;点击数：1254&#xD;发表时间：19年01月21日">高二期末考试安排</a>[ 01-21 ]</div>
                        </div>
                    </div>
