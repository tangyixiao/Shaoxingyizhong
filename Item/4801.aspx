...
<head>
    ...
    <title>爱钻研的竞赛生--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4801"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4801},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4801";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4800.aspx" target="_self" title="标题：要给学生更多选择权&#xD;点击数：572&#xD;发表时间：14年01月06日">要给学生更多选择权</a>[ 01-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4802.aspx" target="_self" title="标题：读绍兴成语典故四则&#xD;点击数：1484&#xD;发表时间：14年01月06日">读绍兴成语典故四则</a>[ 01-06 ]</div>
                        </div>
                    </div>
