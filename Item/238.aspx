...
<head>
    ...
    <title>领取三项考试准考证--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=238"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:238},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=238";
     ...
     <FONT size=3>    请高三班主任到教学处领取浙江省普通高校招生三项考试准考证。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/237.aspx" target="_self" title="标题：关于召开“师徒结对”座谈会的通知&#xD;点击数：540&#xD;发表时间：09年09月10日">关于召开“师徒结对”座谈会的通知</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/241.aspx" target="_self" title="标题：高考三项考试试场布置要求及有关事项&#xD;点击数：551&#xD;发表时间：09年09月10日">高考三项考试试场布置要求及有关事项</a>[ 09-10 ]</div>
                        </div>
                    </div>
