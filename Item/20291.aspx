...
<head>
    ...
    <title>明天（周六）高三首考动员大会及临时课表通知--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">明天（周六）高三首考动员大会及临时课表通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20291"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20291},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20291";
     ...
     <ol class=" list-paddingleft-2" style="list-style-type: decimal;"><li style="list-style-type: decimal;"><p>高三首考动员大会定于9月28日下午2点40分在图书馆三楼报告厅举行，要求全体高三学生参加，身着校服（藏青色有领短袖），下午第一节课结束后马上进场，并在指定位置就位。请各班自觉遵守会场纪律，有序入场。</p><p>
<img src="/Shaoxingyizhong/UploadFiles/xwzx/2024/9/202409270933580881.png" style="max-width: 100%; " title="202409270933580881.png" /></p></li><li style="list-style-type: decimal;"><p>明天按临时课表上课。</p><p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2024/9/202409270939512999.png" style="max-width: 100%; " title="202409270939512999.png" />
</p></li></ol>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20260.aspx" target="_self" title="标题：高三晚自修+答疑管理安排（9.22-9.27）&#xD;点击数：165&#xD;发表时间：24年09月21日">高三晚自修+答疑管理安排（9.22-9.27）</a>[ 09-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20301.aspx" target="_self" title="标题：高三晚自修+答疑管理安排（9.28-10.6）&#xD;点击数：152&#xD;发表时间：24年09月28日">高三晚自修+答疑管理安排（9.28-10.6）</a>[ 09-28 ]</div>
                        </div>
                    </div>
