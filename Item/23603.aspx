...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23603"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23603},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23603";
     ...
     <p style="text-indent: 2em; line-height: 1.75em;">举行升国旗仪式是《国旗法》赋予的神圣活动，按时、庄重地参加升国旗仪式是每个中国公民应尽的权利和义务。为规范升国旗仪式，现就相关事项通知如下：</p><p style="text-indent: 2em; line-height: 1.75em;">1．全校师生要按德育处、安全处制订实施的应急演练规定的路线、时间准时、有序地到达指定位置（教工请按下图站位），确保升旗仪式的按时举行；</p><p style="text-indent: 2em; line-height: 1.75em;">2．全校师生在举行升旗仪式和国旗下讲话时须保持肃立，不得讲话、走动和做其他不合规定的事；</p><p style="text-indent: 2em; line-height: 1.75em;">3．全校学生须统一穿校报，由德育处负责规定和通知；</p><p style="text-indent: 2em; line-height: 1.75em;">4．各班主任随班站位，负责各自班级的考勤纪律，行政队由办公室考勤，各年管会负责本年段/创新学部的考勤。</p><p style="text-indent: 2em; line-height: 1.75em;">名单如有错误、遗漏请与党政办联系。</p><p style="padding: 0px; margin-top: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background-color: rgb(255, 255, 255); text-align: right; margin-bottom: 20px !important;">
</p><p style="text-align: right; line-height: 1.75em;">党政办</p><p style="text-align: right; line-height: 1.75em;">2026.9.7</p><p style="padding: 0px; margin-top: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background-color: rgb(255, 255, 255); text-align: center; margin-bottom: 20px !important;"><img src="/UploadFiles/xwzx/2026/9/202609071002082955.png" style="max-width: 100%; " title="202609071002082955.png" /></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23585.aspx" target="_self" title="标题：新学期开学典礼通知&#xD;点击数：231&#xD;发表时间：26年09月02日">新学期开学典礼通知</a>[ 09-02 ]</div>
