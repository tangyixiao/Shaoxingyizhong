...
<head>
    ...
    <title>关于召开全校体育委员会议的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于召开全校体育委员会议的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2026年09月05日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23601"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23601},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23601";
     ...
     <p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background: rgb(255, 255, 255);"><span style="font-family: 宋体; letter-spacing: 0px; font-size: 20px;">全校各班级：</span></p><p style="text-indent: 0px; padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background: rgb(255, 255, 255);"><span style="font-family: 宋体; letter-spacing: 0px; text-indent: 43px; font-size: 20px;">  </span><span style="font-family: 宋体; font-size: 21px; letter-spacing: 0px; text-indent: 43px;">为规范升旗仪式、跑操站位秩序，明确各班站位标准、进场衔接细节及体育委员现场协调职责，现召开专项会议，具体事宜通知如下：</span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">一、</span></strong><strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">时间：</span></strong></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">高一高二：今天（周六）<span style="font-size: 20px;">下午第七节课</span><span style="font-size: 20px;">（提前 5 分钟签到）</span></span></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;"><span style="font-size: 20px;">高三：<span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 21px; background-color: rgb(255, 255, 255);">今天（周六）</span><span style="color: rgb(51, 51, 51); font-family: 宋体; background-color: rgb(255, 255, 255); font-size: 20px;">下午第八节课</span><span style="color: rgb(51, 51, 51); font-family: 宋体; background-color: rgb(255, 255, 255); font-size: 20px;">（提前 5 分钟签到）</span></span></span></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">二、</span></strong><strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">地点：</span></strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;"><span style="font-size: 20px;">德育处旁</span><span style="font-size: 20px;">4106 阶梯教室</span></span></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; text-align: justify; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">三、</span></strong><strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">参会</span></strong><strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">人员</span></strong><strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">：</span></strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;"><span style="font-size: 20px;">各班</span><span style="font-size: 20px;">2名体育委员</span></span></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; text-align: justify; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">四、参会准备：</span></strong><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">请参会体育委员携带纸笔，做好会议记录，以便会后准确向班级传达会议内容。</span></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; text-align: justify; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">
</span></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; text-align: justify; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">
</span></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; text-align: right; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">                                         体育组、德育处</span></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; text-align: right; background: rgb(255, 255, 255);"><span style="font-size: 20px;"><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">                                          2026年9月5日</span></span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; text-align: right; background: rgb(255, 255, 255);"><span style="font-family: 宋体; letter-spacing: 0px; font-size: 20px;"> </span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; text-align: right; background: rgb(255, 255, 255);"><span style="font-family: 宋体; letter-spacing: 0px; font-size: 21px;">
</span></p><p style="padding: 0px; margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; text-align: right; background: rgb(255, 255, 255);">
</p><p>
</p>
