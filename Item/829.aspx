...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=829"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:829},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=829";
     ...
     <FONT face=宋体 color=#000000 size=3>市科技馆有一批科技展板在行政楼前展出，请各班组织观看。 </FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/828.aspx" target="_self" title="标题：关于2010年元旦文艺演出的通知&#xD;点击数：402&#xD;发表时间：09年12月03日">关于2010年元旦文艺演出的通知</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/839.aspx" target="_self" title="标题：通知&#xD;点击数：213&#xD;发表时间：09年12月03日">通知</a>[ 12-03 ]</div>
                        </div>
                    </div>
