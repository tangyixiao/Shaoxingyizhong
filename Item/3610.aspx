...
<head>
    ...
    <title>3月27日寝室缺席名单--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3610"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3610},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3610";
...
<P>    C202    陈秋婷    三（2）</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3608.aspx" target="_self" title="标题：3月28日校牌检查结果公布（二十二）&#xD;点击数：554&#xD;发表时间：11年03月28日">3月28日校牌检查结果公布（二十二）</a>[ 03-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3612.aspx" target="_self" title="标题：2011年各级三好学生、优秀学生干部名单公示&#xD;点击数：770&#xD;发表时间：11年03月28日">2011年各级三好学生、优秀学生干部名单公示</a>[ 03-28 ]</div>
                        </div>
                    </div>
