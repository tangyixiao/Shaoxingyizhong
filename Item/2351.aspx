...
<head>
    ...
    <title>关于核对身份证号码通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2351"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2351},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2351";
...
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><FONT size=3><SPAN lang=EN-US><SPAN style="mso-spacerun: yes">    </SPAN></SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">因办理社保卡的需要，请各位教工尽快抽时间去医务室核对自己的身份证号码并签名，身份证号码不是“</SPAN><SPAN lang=EN-US>3306</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">”开头的教工请同时递交一份自己的身份证复印件。</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2346.aspx" target="_self" title="标题：关于召开班主任会议的通知&#xD;点击数：691&#xD;发表时间：10年09月02日">关于召开班主任会议的通知</a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2352.aspx" target="_self" title="标题：关于组织教师参加教师节庆祝会的通知&#xD;点击数：983&#xD;发表时间：10年09月03日">关于组织教师参加教师节庆祝会的通知</a>[ 09-03 ]</div>
                        </div>
                    </div>
