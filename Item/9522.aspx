...
<head>
    ...
    <title>通用技术课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9522"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9522},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9522";
     ...
     <FONT size=4>12月17日至18日（周一、周二）通用技术组白宗刚老师外出带队参加比赛，相关班级通用技术课改自修。走班班级在相应上课教室自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9517.aspx" target="_self" title="标题：高三走班地点变更及自修学生安排&#xD;点击数：339&#xD;发表时间：18年12月14日">高三走班地点变更及自修学生安排</a>[ 12-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9540.aspx" target="_self" title="标题：地理教研活动通知&#xD;点击数：294&#xD;发表时间：18年12月18日">地理教研活动通知</a>[ 12-18 ]</div>
                        </div>
                    </div>
