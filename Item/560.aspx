...
<head>
    ...
    <title>绍兴一中今天110岁了--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=560"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:560},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=560";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/559.aspx" target="_self" title="标题：省百年名校百强&amp;nbsp;绍兴喜占十四席&#xD;点击数：386&#xD;发表时间：09年11月13日">省百年名校百强 绍兴喜占十四席</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/561.aspx" target="_self" title="标题：百年名校校庆出新校友称赞&#xD;点击数：394&#xD;发表时间：09年11月13日">百年名校校庆出新校友称赞</a>[ 11-13 ]</div>
                        </div>
                    </div>
