...
<head>
    ...
    <title>大合唱比赛的纪律、卫生检查情况通报：--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">大合唱比赛的纪律、卫生检查情况通报：</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年10月23日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=443"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:443},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=443";
     ...
     <P>      <FONT size=3>经团委纪检部检查打分后，下列班级文明情况较差：</FONT></P>
<P><FONT size=3>     高一（9）、高二（5）、高二（10）、高二（13） 纪律较差。</FONT></P>
<P><FONT size=3>     高一（6）、高一（5）、高一（12）、高二（4）  卫生较差。</
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/442.aspx" target="_self" title="标题：“重温光辉历程，传唱红色经典”大合唱比赛结果&#xD;点击数：296&#xD;发表时间：09年10月22日">“重温光辉历程，传唱红色经典”大合唱比赛结果</a>[ 10-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/537.aspx" target="_self" title="标题：关于举行高一、高二主题团会的通知&#xD;点击数：550&#xD;发表时间：09年11月10日">关于举行高一、高二主题团会的通知</a>[ 11-10 ]</div>
                        </div>
                    </div>
