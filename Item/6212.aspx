...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6212"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6212},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6212";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
            ...
            请各班团支书在下午放学前到行政楼演播厅门口领取树人导报，希望大家积极配合！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6208.aspx" target="_self" title="标题：关于团代会团员代表推选的通知&#xD;点击数：166&#xD;发表时间：16年12月23日">关于团代会团员代表推选的通知</a>[ 12-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6219.aspx" target="_self" title="标题：关于提交参加团代会团员名单的通知&#xD;点击数：192&#xD;发表时间：16年12月26日">关于提交参加团代会团员名单的通知</a>[ 12-26 ]</div>
                        </div>
                    </div>
