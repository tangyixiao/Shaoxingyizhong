...
<head>
    ...
    <title>3.19班级一日考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19521"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19521},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19521";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2024/3/202403201542487240.png" style="max-width: 100%; " title="202403201542487240.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19519.aspx" target="_self" title="标题：博雅大讲堂（西湖大学）活动通知（地点有修改）&#xD;点击数：236&#xD;发表时间：24年03月20日">博雅大讲堂（西湖大学）活动通知（地点有修改）</a>[ 03-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19522.aspx" target="_self" title="标题：3.20跑操量化考核反馈&#xD;点击数：66&#xD;发表时间：24年03月20日">3.20跑操量化考核反馈</a>[ 03-20 ]</div>
                        </div>
                    </div>
