...
<head>
    ...
    <title>关于住校生安全及纪律的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于住校生安全及纪律的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3966"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3966},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3966";
...
<P><FONT size=4>为保证住校生的安全与休息时间,请通知本班住校生,并作好教育工作：</FONT></P>
<P><FONT size=4>1．寝室内一律不准使用电源接线板和其他电器，如发现有违纪使用的，一律予以没收，并作违纪记录。</FONT></P>
<P><FONT size=4>2．学校规定晚上11:00熄灯，对不按时就寝的学生要作违纪记录。</FONT></P>
<P><FONT size=4>3．对违反上述规定3次以上(含3次)的同学，学校将取消其住校资格。</FONT></P>
<P><FONT size=4>                       </FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3962.aspx" target="_self" title="标题：5月15日星期日寝室缺席人员名单&#xD;点击数：581&#xD;发表时间：11年05月16日">5月15日星期日寝室缺席人员名单</a>[ 05-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3969.aspx" target="_self" title="标题：5月16日学生校牌、迟到检查结果公布（五十一）&#xD;点击数：580&#xD;发表时间：11年05月17日">5月16日学生校牌、迟到检查结果公布（五十一）</a>[ 05-17 ]</div>
                        </div>
                    </div>
