...
<head>
    ...
    <title>高三期末先进名单公示--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17195"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17195},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17195";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2023/1/202301091532376980.png" style="max-width: 100%; " title="202301091532376980.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17185.aspx" target="_self" title="标题：高一期末先进名单公示（有修改）&#xD;点击数：524&#xD;发表时间：23年01月10日">高一期末先进名单公示（有修改）</a>[ 01-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17196.aspx" target="_self" title="标题：高二部分学生（补充）2022学年第一学期综合素质评价等第公示&#xD;点击数：268&#xD;发表时间：23年01月09日">高二部分学生（补充）2022学年第一学期综合素质评价等第公示</a>[ 01-09 ]</div>
                        </div>
                    </div>
