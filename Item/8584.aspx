...
<head>
    ...
    <title>高二英语+七选三模拟考试通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二英语+七选三模拟考试通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8584"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8584},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8584";
     ...
     <FONT size=4>为更好的迎接高二学生的英语和七选三首考。经与年段协商，决定在5月25、26日和6月15、16日举行两轮英语和七选三模拟考试。请相关备课组准备好试卷。于考试前三天交到学生发展中心胡红燕老师处。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8572.aspx" target="_self" title="标题：语文教研活动通知&#xD;点击数：412&#xD;发表时间：18年05月17日">语文教研活动通知</a>[ 05-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8592.aspx" target="_self" title="标题：高三精英班英语上课通知&#xD;点击数：236&#xD;发表时间：18年05月21日">高三精英班英语上课通知</a>[ 05-21 ]</div>
                        </div>
                    </div>
