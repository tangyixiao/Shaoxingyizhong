...
<head>
    ...
    <title>工会活动先进个人评选通知--工会-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_32/Index.aspx" target="_self">工会</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">工会活动先进个人评选通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6232"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6232},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6232";
     ...
     <P>     2016年度学校工会工作在上级工会组织与学校党委领导下，出色完成年度工作任务，在丰富教职工课余生活、凝心聚力、保障权益、服务大众等多方面取得令人满意的成绩，这一切成绩的取得，是全体教职工积极参与的结果，为表彰先进，决定评选年度<FONT color=#4822dd><STRONG>“工会活动优秀会员”</STRONG></FONT>（绍兴一中在职在编会员中评选），名额分配如下：语文4人、数学4人、英语4人、政史地4人、生化4人、行政（1）4人、行政（2）4人、物理技术3人、体育信息3人，请各工会小组长，于本星期五前把优秀会员名单报给工会办公室。</P>
<P>                                                          工会   2016/12/17</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6230.aspx" target="_self" title="标题：迎新年教职工羽毛球比赛成绩公告&#xD;点击数：360&#xD;发表时间：16年12月27日">迎新年教职工羽毛球比赛成绩公告</a>[ 12-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6256.aspx" target="_self" title="标题：晚间体育场馆开放&#xD;点击数：71&#xD;发表时间：17年01月03日">晚间体育场馆开放</a>[ 01-03 ]</div>
                        </div>
                    </div>
