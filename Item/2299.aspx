...
<head>
    ...
    <title>关于再次上传校讯通电子汇总表的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于再次上传校讯通电子汇总表的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2299"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2299},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2299";
     ...
     <P>各班主任：</P>
<P>        由于公共文件夹的清空，在今日中午前已上传过校讯通电子汇总表的班级请再上传一次。</P>
<P>         上传地址仍是公共文件夹/德育处/校讯通情况汇总表。</P>
<P>        </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2292.aspx" target="_self" title="标题：关于贫困生调查摸底的通知&#xD;点击数：379&#xD;发表时间：10年08月26日">关于贫困生调查摸底的通知</a>[ 08-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2300.aspx" target="_self" title="标题：高一各班主任注意&#xD;点击数：385&#xD;发表时间：10年08月27日">高一各班主任注意</a>[ 08-27 ]</div>
                        </div>
                    </div>
