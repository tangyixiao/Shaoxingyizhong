...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=417"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:417},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=417";
     ...
     <DIV>早上出操时，有下列班级没有关好门窗，特此通报。</DIV>
<DIV>一（3）（灯也未关）、二（11）（灯也未关）、二（14）（灯也未关）、三（2）（灯也未关）、三（7）、三（11）</DIV>
<DIV> </DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/392.aspx" target="_self" title="标题：自行车上锁情况检查记录表(9.27-10.10)&#xD;点击数：297&#xD;发表时间：09年10月13日">自行车上锁情况检查记录表(9.27-10.10)</a>[ 10-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/419.aspx" target="_self" title="标题：自行车上锁情况检查通报(10.13-10.17)&#xD;点击数：357&#xD;发表时间：09年10月19日">自行车上锁情况检查通报(10.13-10.17)</a>[ 10-19 ]</div>
                        </div>
                    </div>
