...
<head>
    ...
    <title>韩国优秀教师代表团访问绍兴一中--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">韩国优秀教师代表团访问绍兴一中</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3275"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3275},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3275";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3170.aspx" target="_self" title="标题：绍兴一中学生从丘成桐中学数学奖总决赛载誉而归&#xD;点击数：570&#xD;发表时间：10年12月29日">绍兴一中学生从丘成桐中学数学奖总决赛载誉而归</a>[ 12-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3307.aspx" target="_self" title="标题：“天翼”助学奖学金为贫困学子成才添翼&#xD;点击数：523&#xD;发表时间：11年01月29日">“天翼”助学奖学金为贫困学子成才添翼</a>[ 01-29 ]</div>
                        </div>
                    </div>
