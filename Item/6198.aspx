...
<head>
    ...
    <title>关于团学联干部（事）全员培训会的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于团学联干部（事）全员培训会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6198"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6198},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6198";
     ...
     <P> </P>
<P>      <FONT size=4>定于今天（12月23日）中午<U>12:25在行政楼五楼报告厅</U>，举行<U>团学联干部（事）全员培训会</U>。</FONT></P>
<P><FONT size=4>    培训主题：“<STRONG>学生干部工作基本规范与活动策划的创意及其他</STRONG>”    </FONT></P>
<P><FONT size=4>    请 <FONT face=仿宋_GB2312>团学联主席团、各部部长副部长、年级团总支书记、各班团支书、各社团社长、各部门全体干事，</FONT>准时参加，随带纸笔，并自觉遵守会场纪律。</FONT></P>
<P><FONT size=4>    团委组织部负责各部部长的考勤，各部负责本部门干事的考勤，社团部负责社长的考勤，年级团总支负责各班团支书的考勤。请相互转告！</FONT></P>
<P><FONT size=4>    参加培训请向班主任做好请假说明，感谢班主任的支持！</FONT></P>
<P><FONT size=4>                                                                                           校团委</FONT></P>
<P><FONT size=4>                                                                                           12月23日</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6165.aspx" target="_self" title="标题：会议通知&#xD;点击数：275&#xD;发表时间：16年12月20日">会议通知</a>[ 12-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6208.aspx" target="_self" title="标题：关于团代会团员代表推选的通知&#xD;点击数：166&#xD;发表时间：16年12月23日">关于团代会团员代表推选的通知</a>[ 12-23 ]</div>
                        </div>
                    </div>
