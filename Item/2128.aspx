...
<head>
    ...
    <title>高三老师外出活动照片--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2128"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2128},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2128";
...
<P>          外出活动照片在学校公共文件夹/教学处内。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2124.aspx" target="_self" title="标题：关于信息技术主题研修活动的通知&#xD;点击数：284&#xD;发表时间：10年06月24日">关于信息技术主题研修活动的通知</a>[ 06-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2130.aspx" target="_self" title="标题：高一、高二期末考时间&#xD;点击数：840&#xD;发表时间：10年06月25日">高一、高二期末考时间</a>[ 06-25 ]</div>
                        </div>
                    </div>
