...
<head>
    ...
    <title>关于上交贫困生申请表的通知（急）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于上交贫困生申请表的通知（急）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2347"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2347},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2347";
     ...
     <P>高一、高二、高三各班主任：</P>
<P>        贫困生申请表最迟截止至下周一上午上交，原高二、高三的贫困生也要重新申请填写表格。请各班主任抓紧落实。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2339.aspx" target="_self" title="标题：德育处通知&#xD;点击数：576&#xD;发表时间：10年09月02日">德育处通知</a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2349.aspx" target="_self" title="标题：关于高一眼保健操的通知&#xD;点击数：322&#xD;发表时间：10年09月03日">关于高一眼保健操的通知</a>[ 09-03 ]</div>
                        </div>
                    </div>
