...
<head>
    ...
    <title>部分体育课改自习通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23709"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23709},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23709";
     ...
     <article>9月23至24日，体育组郑祥霖、陈慧淼、王斌三位教师外出带队和执裁，请相关班级体育课改自习。</article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23708.aspx" target="_self" title="标题：2026年绍兴一中教育集团秋季运动会秩序册&#xD;点击数：283&#xD;发表时间：26年09月22日">2026年绍兴一中教育集团秋季运动会秩序册</a>[ 09-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Item/23711.aspx" target="_self" title="标题：美术教研活动通知&#xD;点击数：70&#xD;发表时间：26年09月23日">美术教研活动通知</a>[ 09-23 ]</div>
                        </div>
                    </div>
