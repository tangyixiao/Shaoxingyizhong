...
<head>
    ...
    <title>高一拍照安排				--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=273"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:273},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=273";
     ...
     <TABLE style="WIDTH: 491pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=655 border=0 x:str>
<COLGROUP>
...
<COL style="WIDTH: 59pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/271.aspx" target="_self" title="标题：关于学校信息管理系统完善的通知&#xD;点击数：663&#xD;发表时间：09年09月14日">关于学校信息管理系统完善的通知</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/283.aspx" target="_self" title="标题：9月16日（周三）高三化学1B学分考监考安排&#xD;点击数：654&#xD;发表时间：09年09月15日">9月16日（周三）高三化学1B学分考监考安排</a>[ 09-15 ]</div>
                        </div>
                    </div>
