...
<head>
    ...
    <title>高一、高二红十字救护知识培训的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二红十字救护知识培训的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4102"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4102},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4102";
     ...
     <P> </P>
<P><FONT size=4>     请高一、高二各班的班长、团支书、体育委员（男、女）、生活委员于今天下午3：30到行政楼五楼会议室参加“红十字救护知识”培训，请准时参加。</FONT></P>
<P><FONT size=4>主讲人：范国娟医师</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4097.aspx" target="_self" title="标题：请高一、高二班长今天下午领取“思想品德考核表”&#xD;点击数：626&#xD;发表时间：11年06月01日">请高一、高二班长今天下午领取“思想品德考核表”</a>[ 06-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4103.aspx" target="_self" title="标题：6月1日住校生未打卡名单&#xD;点击数：709&#xD;发表时间：11年06月02日">6月1日住校生未打卡名单</a>[ 06-02 ]</div>
                        </div>
                    </div>
