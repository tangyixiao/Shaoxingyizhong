...
<head>
    ...
    <title>1月11号跑操情况反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">1月11号跑操情况反馈</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2018年01月11日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7944"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7944},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7944";
     ...
     <!--StartFragment -->
<DIV>今天三个年段同时跑操，在大家的共同努力下，总体情况比预想的要好。<BR>需要关注的问题如下：<BR>1.下楼集合速度太慢,要求三分钟到四分钟之内集合完毕，各年段尽量按照方案顺序下楼，如高二东侧按照1,2,5,6,9,10,13,14顺序有序快速下楼，再慢跑到规定场地集合；<BR>2.个别班级没有及时把"班级领队马甲"穿好（今天再次提醒，明天开始马甲不穿扣0.5），很多同学不肯把手拿出来，存在安全隐患；<BR>3.跑步时一定要按照8路纵队匀速慢跑，并且始终保持班级排面整齐；<BR>4. 班级领队一定要控制好速度，并且控制好班级与班级之间的间距。班级领队两名队员要求在班级前面领跑；<BR>5.跑步中不随意打闹，以免发生意外；<BR>6. 请假的同学（实在不方便下楼的除外，请班主任把控）下楼后直接到教工停车场内部集合，把请假条交给林校长，然后在教工停车场内圈以四路纵队走路，直到跑操结束。<BR>7．请假条要用德育处统一的请假条，注明日期，班级，请假理由，字迹端正，必须有班主任的签名。<BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7943.aspx" target="_self" title="标题：失物招领&#xD;点击数：228&#xD;发表时间：18年01月11日">失物招领</a>[ 01-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7946.aspx" target="_self" title="标题：2017学年第一学期迎新长跑成绩&#xD;点击数：524&#xD;发表时间：18年01月12日">2017学年第一学期迎新长跑成绩</a>[ 01-12 ]</div>
                        </div>
                    </div>
