...
<head>
    ...
    <title>大扫除暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7540"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7540},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7540";
     ...
     <P> </P>
<P>        因学考、选考临近，今天的劳动卫生大扫除暂停。学考、选考结束以后，不论雨雪，各班每周劳动课的劳动卫生大扫除照旧进行，望相互转告，谢谢。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7539.aspx" target="_self" title="标题：高二（7）班值周小结&#xD;点击数：184&#xD;发表时间：17年10月30日">高二（7）班值周小结</a>[ 10-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7546.aspx" target="_self" title="标题：关于学考、选考考风考纪教育的通知&#xD;点击数：343&#xD;发表时间：17年10月31日">关于学考、选考考风考纪教育的通知</a>[ 10-31 ]</div>
                        </div>
                    </div>
