...
<head>
    ...
    <title>一周检查情况公布(2009.10.8-10.17)--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">一周检查情况公布(2009.10.8-10.17)</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=422"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:422},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=422";
...
<TD class=xl29 style="BORDER-RIGHT: #ece9
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/421.aspx" target="_self" title="标题：绍兴一中各班住校生就寝纪律、寝室卫生情况统计表(2009.10.7-2009.10.16)&#xD;点击数：257&#xD;发表时间：09年10月19日">绍兴一中各班住校生就寝纪律、寝室卫生情况统计表(2009.10.7-2…</a>[ 10-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/425.aspx" target="_self" title="标题：各班主任请把《校讯通》的回执交德育处&#xD;点击数：312&#xD;发表时间：09年10月20日">各班主任请把《校讯通》的回执交德育处</a>[ 10-20 ]</div>
                        </div>
                    </div>
