...
<head>
    ...
    <title>高一、高二历史老师参加教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二历史老师参加教研活动通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6577"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6577},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6577";
     ...
     因历史组老师外出参加教研活动，明天（周五）高一、高二年级历史课改自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6573.aspx" target="_self" title="标题：部分学生参加市直排球比赛通知&#xD;点击数：322&#xD;发表时间：17年03月16日">部分学生参加市直排球比赛通知</a>[ 03-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6582.aspx" target="_self" title="标题：信息学竞赛参赛通知&#xD;点击数：355&#xD;发表时间：17年03月17日">信息学竞赛参赛通知</a>[ 03-17 ]</div>
                        </div>
                    </div>
