...
<head>
    ...
    <title>高二、高三班主任《会考报名确认表》速上交--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二、高三班主任《会考报名确认表》速上交</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=515"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:515},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=515";
     ...
     <DIV>高二、高三《会考报名确认表》必须在今天4：00前交教学处章其炎处，明天是省系统关闭的时间，如果不及时上交就会影响报名，请各班主任积极配合。</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/514.aspx" target="_self" title="标题：有关高三“自选综合”会考&#xD;点击数：341&#xD;发表时间：09年11月05日">有关高三“自选综合”会考</a>[ 11-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/520.aspx" target="_self" title="标题：关于复旦大学第六届博雅杯人文知识大奖赛征文启事&#xD;点击数：383&#xD;发表时间：09年11月06日">关于复旦大学第六届博雅杯人文知识大奖赛征文启事</a>[ 11-06 ]</div>
                        </div>
                    </div>
