...
<head>
    ...
    <title>高三培优班、辅导班上课调整通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三培优班、辅导班上课调整通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6852"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6852},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6852";
     ...
     <!--StartFragment -->
<DIV>因高一、高二期中考试，今天高三物理培优班上课地点改到实南205，高三语文辅导班上课时间改到周六第四节课。请相关学生互相转告，准时上课。</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6845.aspx" target="_self" title="标题：高三自主招生、三位一体面试培训通知&#xD;点击数：382&#xD;发表时间：17年04月29日">高三自主招生、三位一体面试培训通知</a>[ 04-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6861.aspx" target="_self" title="标题：复旦、上海交大校荐报名通知&#xD;点击数：778&#xD;发表时间：17年05月04日">复旦、上海交大校荐报名通知</a>[ 05-04 ]</div>
                        </div>
                    </div>
