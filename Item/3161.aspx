...
<head>
    ...
    <title>体育等有关课程本学期上课结束的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">体育等有关课程本学期上课结束的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3161"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3161},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3161";
     ...
     <P>                            体育等有关课程本学期上课结束的通知</P>
<P>    本学期即将进入期末复习、迎考阶段。体育、美术、音乐、通用技术、心理品质、校本课程、研究性课程、地方性课程等相关学科截止到下个星期上课结束，并做好本学期相关学科的考核、考评工作。</P>
<P>                                                                                    教学处</P>
<P>                                                                                     12.28</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3160.aspx" target="_self" title="标题：高三各备课组长&#xD;点击数：430&#xD;发表时间：10年12月28日">高三各备课组长</a>[ 12-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3162.aspx" target="_self" title="标题：高二语文“学传统文化名著、背《论语》经典名句&amp;quot;活动&#xD;点击数：577&#xD;发表时间：10年12月28日">高二语文“学传统文化名著、背《论语》经典名句"活动</a>[ 12-28 ]</div>
                        </div>
                    </div>
