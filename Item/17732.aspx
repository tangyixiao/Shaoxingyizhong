...
<head>
    ...
    <title>关于规范活动课借用及使用器材的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于规范活动课借用及使用器材的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17732"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17732},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17732";
     ...
     <p>各位同学：</p><p>       近期各年段活动课发现有不规范借用和使用器材的现象，导致器材有非正常损耗。在此重申，活动课借用器材需使用有个人班级、照片信息的校园卡，无信息的卡不出借器材，使用器材如有非正常损耗或遗失需照价赔偿，活动课结束立刻归还器材室。</p><p>                                                                                               德育处  体育组</p><p>                                                                                                    4月23日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17728.aspx" target="_self" title="标题：4.20班级一日考核&#xD;点击数：42&#xD;发表时间：23年04月21日">4.20班级一日考核</a>[ 04-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17738.aspx" target="_self" title="标题：关于举行室内升旗仪式的通知&#xD;点击数：58&#xD;发表时间：23年04月24日">关于举行室内升旗仪式的通知</a>[ 04-24 ]</div>
                        </div>
                    </div>
