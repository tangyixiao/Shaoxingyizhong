...
<head>
    ...
    <title>各教研组组长、各类竞赛兴趣小组负责人请注意--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各教研组组长、各类竞赛兴趣小组负责人请注意</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年08月24日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=133"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:133},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=133";
     ...
     开学典礼需要，请各位把2008学年本组获得的省级及以上先进团体的证书（奖牌）、获奖学生名单及证书在30日之前交给德育处，谢谢！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/129.aspx" target="_self" title="标题：关于贫困生调查摸底的通知&#xD;点击数：707&#xD;发表时间：09年08月21日">关于贫困生调查摸底的通知</a>[ 08-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/140.aspx" target="_self" title="标题：请各班主任提醒住校生请注意&#xD;点击数：479&#xD;发表时间：09年08月25日">请各班主任提醒住校生请注意</a>[ 08-25 ]</div>
                        </div>
                    </div>
