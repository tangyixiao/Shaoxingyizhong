...
<head>
    ...
    <title>高三生物走班上课地点变更通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三生物走班上课地点变更通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8108"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8108},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8108";
     ...
     <FONT size=4>从明天（3月5日）起，高三赵正瑜老师生物走班1上课教室变更到3214教室，请相关学生互相转告按时上课。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8100.aspx" target="_self" title="标题：3月4日高三历史选考限时训练安排&#xD;点击数：316&#xD;发表时间：18年03月03日">3月4日高三历史选考限时训练安排</a>[ 03-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8120.aspx" target="_self" title="标题：部分同学会议通知&#xD;点击数：390&#xD;发表时间：18年03月06日">部分同学会议通知</a>[ 03-06 ]</div>
                        </div>
                    </div>
