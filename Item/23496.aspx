...
<head>
    ...
    <title>“弘毅传承”2026高考学霸经验分享会--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">“弘毅传承”2026高考学霸经验分享会</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2026年08月12日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23496"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23496},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23496";
     ...
     <p style="padding: 0px; margin-top: 7px; margin-bottom: 20px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; font-family: 等线; font-size: 14px; text-indent: 32px; text-autospace: ideograph-numeric; background: rgb(255, 255, 255);"><span style="font-family: 宋体; font-size: 16px;">为了赓续学校毕业生对学弟学妹们进行帮助与指导的传统，2026届毕业生中的高分学霸们将在校内开展高考学霸经验分享会，分享学习经验、学霸笔记，并进行线上线下的交流。</span></p><p style="padding: 0px; margin-top: 7px; margin-bottom: 20px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; font-family: 等线; font-size: 14px; text-autospace: ideograph-numeric; background: rgb(255, 255, 255);"><strong><span style="font-family: 宋体; font-size: 16px;">一、活动时间</span></strong></p><p style="padding: 0px; margin-top: 7px; margin-bottom: 20px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; font-family: 等线; font-size: 14px; text-autospace: ideograph-numeric; background: rgb(255, 255, 255);"><span style="font-family: 宋体; font-size: 16px;">8月12日（周三）中午12：15——13：35</span></p><p style="padding: 0px; margin-top: 7px; margin-bottom: 20px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; font-family: 等线; font-size: 14px; text-autospace: ideograph-numeric; background: rgb(255, 255, 255);"><strong><span style="font-family: 宋体; font-size: 16px;">二、活动地点</span></strong></p><p style="padding: 0px; margin-top: 7px; margin-bottom: 20px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; font-family: 等线; font-size: 14px; text-autospace: ideograph-numeric; background: rgb(255, 255, 255);"><span style="font-family: 宋体; font-size: 16px;">行政楼三楼会议室（四）</span></p><p style="padding: 0px; margin-top: 7px; margin-bottom: 20px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; font-family: 等线; font-size: 14px; text-autospace: ideograph-numeric; background: rgb(255, 255, 255);"><strong><span style="font-family: 宋体; font-size: 16px;">三、</span></strong><strong><span style="font-family: 宋体; font-size: 16px;">主讲人</span></strong><strong><span style="font-family: 宋体; font-size: 16px;">简介</span></strong></p><p><strong><span style="font-family: 宋体; font-size: 16px;"><img src="/UploadFiles/xwzx/2026/8/202608120810322165.png" style="max-width: 100%; " title="202608120810322165.png" /></span></strong></p><p><span style="font-size: 18px;"><strong><span style="font-family: 宋体;"></span></strong></span><span style="font-family: 宋体; font-size: 18px; background-color: rgb(255, 255, 255);">四、注意事项</span></p><p style="margin: 9px 0 27px;text-align: justify;font-family: Calibri;font-size: medium;white-space: normal;text-indent: 37px;padding: 0;text-autospace: ideograph-numeric;background: rgb(255, 255, 255)"><span style="font-family: 宋体; font-size: 18px;">欢迎同学们前往参加！场地有限，建议每班不超过<span style="font-size: 18px; font-family: Calibri;">15</span>人。</span></p><p style="margin: 9px 0 27px;text-align: justify;font-family: Calibri;font-size: medium;text-indent: 0;white-space: normal;padding: 0;text-autospace: ideograph-numeric;background: rgb(255, 255, 255)"><span style="font-size: 14px; font-family: Calibri;"> </span></p><p style="margin: 9px 0 0;text-align: right;font-family: Calibri;font-size: medium;white-space: normal;text-indent: 49px;padding: 0;text-autospace: ideograph-numeric;background: rgb(255, 255, 255)"><span style="font-family: 宋体; font-size: 18px;">校团委<span style="font-family: Calibri;"> </span></span></p><p style="margin: 9px 0 0;text-align: right;font-family: Calibri;font-size: medium;white-space: normal;text-indent: 49px;padding: 0;text-autospace: ideograph-numeric;background: rgb(255, 255, 255)"><span style="font-family: 宋体; font-size: 18px;"><span style="font-size: 18px; font-family: Calibri;">2026</span>年<span style="font-size: 18px; font-family: Calibri;">8</span>月<span style="font-size: 18px; font-family: Calibri;">12</span>日</span></p><p><strong><span style="font-family: 宋体; font-size: 16px;">
</span></strong>
</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23399.aspx" target="_self" title="标题：2025学年学生社团考核结果（星级评定）&#xD;点击数：134&#xD;发表时间：26年06月18日">2025学年学生社团考核结果（星级评定）</a>[ 06-18 ]</div>
