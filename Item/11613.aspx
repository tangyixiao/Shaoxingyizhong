...
<head>
    ...
    <title>本学期大课间操、升旗仪式结束通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">本学期大课间操、升旗仪式结束通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11613"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11613},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11613";
...
<P>                                                                                       2020年7月1日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11611.aspx" target="_self" title="标题：6月“美丽教室”评比结果通告&#xD;点击数：216&#xD;发表时间：20年06月30日">6月“美丽教室”评比结果通告</a>[ 06-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11619.aspx" target="_self" title="标题：7.1、7.2绍兴一中住校学生表现情况&#xD;点击数：83&#xD;发表时间：20年07月02日">7.1、7.2绍兴一中住校学生表现情况</a>[ 07-02 ]</div>
                        </div>
                    </div>
