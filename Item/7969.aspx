...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7969"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7969},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7969";
     ...
     高一年段各班请注意，周三（今天）下午第四节劳动课大扫除照常进行，值周班于下课前10分钟即时检查，请大家按要求打扫
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7966.aspx" target="_self" title="标题：今日跑操暂停通知&#xD;点击数：215&#xD;发表时间：18年01月17日">今日跑操暂停通知</a>[ 01-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7970.aspx" target="_self" title="标题：关于开展“优秀寝室长”评选活动的通告&#xD;点击数：320&#xD;发表时间：18年01月17日">关于开展“优秀寝室长”评选活动的通告</a>[ 01-17 ]</div>
                        </div>
                    </div>
