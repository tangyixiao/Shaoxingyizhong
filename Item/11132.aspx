...
<head>
    ...
    <title>通知：全体团学联主要干部、社团干部会议--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">通知：全体团学联主要干部、社团干部会议</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11132"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11132},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11132";
     ...
     <P> 请全体团学联主要学生干部（主席团、部长副部长、社团联主席团）及社团主要干部（全体社长）于<FONT color=#ff0000>1月15日（周三）12:30</FONT>至4110阶梯教室开会。会议主要内容包括：1.学期总结；2.团支部考核内容数据提供与核实；3.假期前实践服务工作布置。</P>
<P>    请主席团通知到各部门；请社团联通知到各社长。</P>
<P>    请准时参加，随带纸笔；请团委组织部部长负责团学联干部签到，社团联负责社长签到。</P>
<P align=right>校团委<BR>2020年1月14日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11129.aspx" target="_self" title="标题：寒假义演义卖“橙色书包计划”物品、节目征集通知&#xD;点击数：330&#xD;发表时间：20年01月12日">寒假义演义卖“橙色书包计划”物品、节目征集通知</a>[ 01-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11139.aspx" target="_self" title="标题：寒假科技馆志愿者组长开会通知&#xD;点击数：220&#xD;发表时间：20年01月14日">寒假科技馆志愿者组长开会通知</a>[ 01-14 ]</div>
                        </div>
                    </div>
