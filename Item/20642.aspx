...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20642"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20642},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20642";
     ...
     <p style="white-space: normal;">      近日，高一（15）班杨雨涵同学在去食堂的路上，拾到一块表带为蓝白相间的手表，请遗失手表的同学到德育处认领，谢谢!</p><p style="white-space: normal;">
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20641.aspx" target="_self" title="标题：寻物启事（手表）&#xD;点击数：61&#xD;发表时间：24年12月02日">寻物启事（手表）</a>[ 12-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20643.aspx" target="_self" title="标题：11.29班级一日考核&#xD;点击数：40&#xD;发表时间：24年12月02日">11.29班级一日考核</a>[ 12-02 ]</div>
                        </div>
                    </div>
