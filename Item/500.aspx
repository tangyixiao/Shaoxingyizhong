...
<head>
    ...
    <title>09高三期中考试安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=500"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:500},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=500";
     ...
     <TABLE style="WIDTH: 434pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=577 border=0 x:str>
<COLGROUP>
...
<COL style="WIDTH: 33pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/499.aspx" target="_self" title="标题：高三期中考试场布置要求&#xD;点击数：350&#xD;发表时间：09年11月03日">高三期中考试场布置要求</a>[ 11-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/501.aspx" target="_self" title="标题：关于实行冬令时间的通知&#xD;点击数：396&#xD;发表时间：09年11月03日">关于实行冬令时间的通知</a>[ 11-03 ]</div>
                        </div>
                    </div>
