...
<head>
    ...
    <title>英语组教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21881"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21881},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21881";
     ...
     <article>本周五（9.12）英语组全体老师参加市直教研，相关英语课有统一安排。</article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21873.aspx" target="_self" title="标题：生物组教研活动通知&#xD;点击数：110&#xD;发表时间：25年09月09日">生物组教研活动通知</a>[ 09-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21918.aspx" target="_self" title="标题：高一卓越联盟考试范围（11.18-20期中考）&#xD;点击数：203&#xD;发表时间：25年09月16日">高一卓越联盟考试范围（11.18-20期中考）</a>[ 09-16 ]</div>
                        </div>
                    </div>
