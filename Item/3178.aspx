...
<head>
    ...
    <title>各班主任注意（关于告家长书）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班主任注意（关于告家长书）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>班主任注意</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年12月29日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3178"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3178},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3178";
     ...
     <P>各班主任注意：</P>
<P>    现已将有关元旦放假及期末考试安排情况的“告家长书”发至各班教室或办公室，请班主任们查收，并尽快下发给学生。如若份数不够，可自行打印补足。附“告家长书”电子稿，注意下载打印认准年级（各年级不同）。<A title=告家长书（高一、二、三） href="/Shaoxingyizhong/UploadFiles/UploadFiles/201012/2010122915095346.doc">告家长书（高一、二、三）</A></P>
<P>    另：第十一期《班主任》杂志也一并下发了，请各班主任查收并学习。</P>
<P>                                                                                 德育处</P>
<P>                                                                                       12月29日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3177.aspx" target="_self" title="标题：佚名之画作招领&#xD;点击数：596&#xD;发表时间：10年12月29日">佚名之画作招领</a>[ 12-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3180.aspx" target="_self" title="标题：2010年校园文化艺术节闭幕式通知(座位有修改）&#xD;点击数：1809&#xD;发表时间：10年12月30日">2010年校园文化艺术节闭幕式通知(座位有修改）</a>[ 12-30 ]</div>
                        </div>
                    </div>
