...
<head>
    ...
    <title>高三年段4月语、数、英模拟考试相关工作提示--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三年段4月语、数、英模拟考试相关工作提示</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8456"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8456},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8456";
     ...
     <P>一、4月28日早上学生来校后在教室里复习，班主任组织学生在8点半前按37人的标准布置好试场，要求桌面上的资料都清空，学生在考试的时候书包一律放在考场外面。下午4点半考完以后学生放学，晚上晚自修正常进行，管理老师要提醒学生晚自修到10点结束，不要早退。</P>
<P>二、4月29日上午按周六的课表任课老师下班答疑并布置好五一放假的作业。下午4点考试结束以后放学，放学前要做好教室等的卫生工作。</P>
<P>三、4月30日、5月1日放假，住校生5月1日下午返校参加晚自修，任课老师在放假回来后两天之内把试卷改完，统计好成绩及时反馈给学生及家长。</P>
<P><BR> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8394.aspx" target="_self" title="标题：关于高三4月份语、数、英模拟考试的通知&#xD;点击数：458&#xD;发表时间：18年04月19日">关于高三4月份语、数、英模拟考试的通知</a>[ 04-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8663.aspx" target="_self" title="标题：高三年段高考前后工作安排&#xD;点击数：499&#xD;发表时间：18年06月01日">高三年段高考前后工作安排</a>[ 06-01 ]</div>
                        </div>
                    </div>
