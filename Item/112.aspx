...
<head>
    ...
    <title>高一备课组长会议--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一备课组长会议</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高一</span> <span>发布时间：2009年08月17日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=112"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:112},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=112";
     ...
     <P>接教学处通知:定于明天(8.18)下午第三节课在行政楼三楼会议室召开<FONT face=Verdana>高一备课组长会议</FONT>。请各备课组长安排好工作，准时到会。</P>
<P>高一年级    2009.8.17</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/107.aspx" target="_self" title="标题：高一晚自修安排（8.16---8.28）&#xD;点击数：24&#xD;发表时间：09年08月17日">高一晚自修安排（8.16---8.28）</a>[ 08-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/128.aspx" target="_self" title="标题：高一班主任关注&#xD;点击数：702&#xD;发表时间：09年08月21日">高一班主任关注</a>[ 08-21 ]</div>
                        </div>
                    </div>
