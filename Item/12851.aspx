...
<head>
    ...
    <title>高三名校协作体考试分析会--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三名校协作体考试分析会</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12851"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12851},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12851";
     ...
     <p><span style="FONT-SIZE: 20px">今天下午第9节课在树兰楼三楼会议室二召开高三名校协作体考试分析会，请各位高三任课老师准时参加。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12798.aspx" target="_self" title="标题：高一返校考和高二高三协作体联考试场布置及考试相关要求&#xD;点击数：425&#xD;发表时间：21年02月28日">高一返校考和高二高三协作体联考试场布置及考试相关要求</a>[ 02-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12879.aspx" target="_self" title="标题：高二名校协作体考试分析会&#xD;点击数：248&#xD;发表时间：21年03月10日">高二名校协作体考试分析会</a>[ 03-10 ]</div>
                        </div>
                    </div>
