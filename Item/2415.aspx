...
<head>
    ...
    <title>高三班主任请注意--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三班主任请注意</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高三班主任请注意</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年09月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2415"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2415},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2415";
     ...
     <P>高三班主任请注意：</P>
<P>1、下午可以先吃饭后布置试场（13：20前一定要整理好等待检查）</P>
<P>2、周五下午的各班自修室到高一相应班级</P>
<P>3、英语听力结束后立即把教室还原，千万不要影响下一场考试</P>
<P>4、住校生晚自修在周六晚上</P>
<P>希各知照！</P>
<P>                        高三年级组</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2333.aspx" target="_self" title="标题：原高二党支部会议通知&#xD;点击数：327&#xD;发表时间：10年09月02日">原高二党支部会议通知</a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2532.aspx" target="_self" title="标题：高三家长开放日的通知&#xD;点击数：982&#xD;发表时间：10年09月25日">高三家长开放日的通知</a>[ 09-25 ]</div>
                        </div>
                    </div>
