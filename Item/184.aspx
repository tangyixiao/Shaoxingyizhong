...
<head>
    ...
    <title>校定向队招新队员通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=184"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:184},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=184";
     ...
     <DIV>      <FONT size=4>根据 “公平、公正和公开”的原则，绍兴一中定向队将面向全校学生招收新队员。请有意向的同学于9月4日前到体育组报名（暑假已经报名的同学不必再报）。届时将由意中俱乐部组织测试并录取。测试内容为一场“百米”定向赛和4000米（女生3200米）跑。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/173.aspx" target="_self" title="标题：9月1日上午高一高二上课通知&#xD;点击数：489&#xD;发表时间：09年08月31日">9月1日上午高一高二上课通知</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/185.aspx" target="_self" title="标题：高二课外活动、校本课程时间更改&#xD;点击数：561&#xD;发表时间：09年09月01日">高二课外活动、校本课程时间更改</a>[ 09-01 ]</div>
                        </div>
                    </div>
