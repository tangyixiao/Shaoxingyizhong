...
<head>
    ...
    <title>学考、选考后早读安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6694"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6694},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6694";
     ...
     <P>4月学考、选考后早读安排有所调整，具体安排如下：</P>
<P>高一、高二年级周二、周四为语文早读时间，周一、周三、周五为英语早读时间。</P>
<P>高三年级周二、周四、周六为语文早读时间，周一、周三、周五为英语早读时间。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6690.aspx" target="_self" title="标题：期中考试时间及范围（修改）&#xD;点击数：2522&#xD;发表时间：17年04月06日">期中考试时间及范围（修改）</a>[ 04-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6695.aspx" target="_self" title="标题：高二选考走班安排&#xD;点击数：329&#xD;发表时间：17年04月11日">高二选考走班安排</a>[ 04-11 ]</div>
                        </div>
                    </div>
