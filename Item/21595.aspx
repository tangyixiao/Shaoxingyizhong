...
<head>
    ...
    <title>第15周主要工作安排表（5.26-6.1）--工作安排-绍兴市第一中学</title>
...
<li class="li5 last"><a href="/Shaoxingyizhong/Category_24/Index.aspx">校务公开</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21595"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21595},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21595";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/5/202505261638084456.png" style="max-width: 100%; " title="202505261638084456.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21566.aspx" target="_self" title="标题：第16周主要工作安排表（6.2-6.8）&#xD;点击数：4&#xD;发表时间：25年06月02日">第16周主要工作安排表（6.2-6.8）</a>[ 06-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21597.aspx" target="_self" title="标题：第17周主要工作安排表（6.9-6.15）&#xD;点击数：19&#xD;发表时间：25年06月12日">第17周主要工作安排表（6.9-6.15）</a>[ 06-12 ]</div>
                        </div>
                    </div>
