...
<head>
    ...
    <title>新概念作文大赛交稿通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7613"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7613},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7613";
     ...
     <P>请有意参加新概念作文大赛的同学将文章（打印稿）与报名表填写好基本信息，装订好后交至206班杨奕帆处。截止日期：11月20日。学校将统一进行邮寄。</P>
<P align=right>养新文学社<BR>2017年11月13日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7605.aspx" target="_self" title="标题：通知：领取11.1树人导报&#xD;点击数：115&#xD;发表时间：17年11月10日">通知：领取11.1树人导报</a>[ 11-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7614.aspx" target="_self" title="标题：关于英语沙龙社面试及社员会议的通知&#xD;点击数：114&#xD;发表时间：17年11月13日">关于英语沙龙社面试及社员会议的通知</a>[ 11-13 ]</div>
                        </div>
                    </div>
