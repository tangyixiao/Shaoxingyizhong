...
<head>
    ...
    <title>高一天文社本周六上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一天文社本周六上课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10851"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10851},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10851";
     ...
     <FONT size=4>明天（本周六）高一天文社上课，时间1天，下午4点结束，今晚如有学生要住宿请与宿管老师联系，请相互转告。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10849.aspx" target="_self" title="标题：本周日英语能力竞赛试场安排&#xD;点击数：456&#xD;发表时间：19年11月08日">本周日英语能力竞赛试场安排</a>[ 11-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10856.aspx" target="_self" title="标题：体育教研活动通知&#xD;点击数：345&#xD;发表时间：19年11月12日">体育教研活动通知</a>[ 11-12 ]</div>
                        </div>
                    </div>
