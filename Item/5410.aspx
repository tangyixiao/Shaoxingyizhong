...
<head>
    ...
    <title>“我的大学”宣讲：上海交通大学体验分享会--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">“我的大学”宣讲：上海交通大学体验分享会</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：tw</span> <span>发布时间：2016年08月11日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5410"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5410},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5410";
     ...
     <P> </P>
<P><FONT size=4>各班团支部：</FONT></P>
<P><FONT size=4>    今天中午12:30，在行政楼五楼报告厅，由我校15届、16届优秀毕业生现就读上海交通大学的学姐、学长，为大家带来“上海交通大学学习体验分享会”。欢迎感兴趣的同学参加。参加前请向班主任做好请假说明。感谢班主任的支持！</FONT></P>
<P><FONT size=4>                                                                               校团委</FONT></P>
<P><FONT size=4>                                                                               8月11日</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4290.aspx" target="_self" title="标题：新高一、新高三各班注意&#xD;点击数：828&#xD;发表时间：11年07月05日">新高一、新高三各班注意</a>[ 07-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5460.aspx" target="_self" title="标题：关于今天中午召开三年段团支书会议的通知&#xD;点击数：167&#xD;发表时间：16年09月08日">关于今天中午召开三年段团支书会议的通知</a>[ 09-08 ]</div>
                        </div>
                    </div>
