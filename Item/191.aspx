...
<head>
    ...
    <title>回头考成绩和高三IB成绩录入方法--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">回头考成绩和高三IB成绩录入方法</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月02日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=191"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:191},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=191";
     ...
     <DIV><FONT size=2>各位老师：</FONT></DIV>
<DIV><FONT size=2>回头考录入方法：</FONT></DIV>
<DIV><FONT size=2>高一、高二回头考录入方法：为了系统升级需要，高一高二回头考成绩作如下要求：请各任课老师将回头考成绩以电子文档的形式上交到备课组长处，备课组长将各班合成到一张电子表，并以年级、学科名字共同命名，放到公共文件夹教务处/吴万胜/2009学年高一高二回头考文件夹中.</FONT></DIV>
<DIV><FONT size=2
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/188.aspx" target="_self" title="标题：课题成果获奖讯&#xD;点击数：633&#xD;发表时间：09年09月07日">课题成果获奖讯</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/193.aspx" target="_self" title="标题：关于第二次申报2009学年绍兴市中小学教师学术主题报告的通知&#xD;点击数：458&#xD;发表时间：09年09月15日">关于第二次申报2009学年绍兴市中小学教师学术主题报告的通知</a>[ 09-15 ]</div>
                        </div>
                    </div>
