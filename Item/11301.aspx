...
<head>
    ...
    <title>关于专业阅读作业提交的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于专业阅读作业提交的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11301"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11301},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11301";
     ...
     <P> </P>
<P>各位老师：</P>
<P>之前已下发专业阅读书籍《深度学习——走向核心素养》，按照安排，请认真撰写读书心得，于4月24日（本周五）前打印纸质稿一份交到教研组长处，由教研组长收齐后统一交到教科室。学校将择优选送教研院参加评比。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11293.aspx" target="_self" title="标题：关于教研组长、备课组长会议的通知&#xD;点击数：197&#xD;发表时间：20年04月20日">关于教研组长、备课组长会议的通知</a>[ 04-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11336.aspx" target="_self" title="标题：高三备课组长会议通知&#xD;点击数：205&#xD;发表时间：20年04月26日">高三备课组长会议通知</a>[ 04-26 ]</div>
                        </div>
                    </div>
