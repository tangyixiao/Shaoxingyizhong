...
<head>
    ...
    <title>高三名牌工程强化班上课--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2996"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2996},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2996";
     ...
     <P>                             </P>
<P>                                     高三名牌工程强化班上课</P>
<P>        高三“名牌工程数学、化学、地理强化班”下午上课在高一教学楼一（10）、一（11）、一（12）班教室，时间1：45分开始，希望同学们相互转告。</P>
<P>                                                                         12.4</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2988.aspx" target="_self" title="标题：高三通知&#xD;点击数：1626&#xD;发表时间：10年12月03日">高三通知</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3005.aspx" target="_self" title="标题：高二语文“学传统文化名著、背《论语》经典名句”活动启事&#xD;点击数：509&#xD;发表时间：10年12月06日">高二语文“学传统文化名著、背《论语》经典名句”活动启事</a>[ 12-06 ]</div>
                        </div>
                    </div>
