...
<head>
    ...
    <title>跨年门设计稿上交通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12342"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12342},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12342";
     ...
     <P>请下列班级本周四之前将跨年门设计稿提交至公共文件夹--音美--跨年门文件夹中。<BR>高一（1）、（2）、（6）、（8）、（11）、（12）、（13）、（14）、（15）、（16）<BR>高二（2）、（3）、（4）、（9）</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12341.aspx" target="_self" title="标题：12.7高二、高三年级卫生大扫除检查情况通报&#xD;点击数：150&#xD;发表时间：20年12月08日">12.7高二、高三年级卫生大扫除检查情况通报</a>[ 12-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12343.aspx" target="_self" title="标题：高一部分同学开会通知&#xD;点击数：661&#xD;发表时间：20年12月08日">高一部分同学开会通知</a>[ 12-08 ]</div>
                        </div>
                    </div>
