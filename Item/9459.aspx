...
<head>
    ...
    <title>高三期中考试、选考质量分析会--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三期中考试、选考质量分析会</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9459"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9459},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9459";
     ...
     <FONT size=4>今天下午14:30树兰楼三楼会议室二召开高三期中考试、选考质量分析会，请高三任课老师准时与会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9457.aspx" target="_self" title="标题：高二课表调整通知&#xD;点击数：449&#xD;发表时间：18年12月04日">高二课表调整通知</a>[ 12-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9461.aspx" target="_self" title="标题：信息技术教研活动通知&#xD;点击数：246&#xD;发表时间：18年12月04日">信息技术教研活动通知</a>[ 12-04 ]</div>
                        </div>
                    </div>
