...
<head>
    ...
    <title>学考选考考务培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9281"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9281},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9281";
     ...
     定于今天（31日）下午14:00在图书馆3楼报告厅2进行2018年下半年学考选考考务培训，全体监考老师、考务人员参加，请随带笔。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9280.aspx" target="_self" title="标题：2018年下半年学考选考试场编排表&#xD;点击数：496&#xD;发表时间：18年10月31日">2018年下半年学考选考试场编排表</a>[ 10-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9285.aspx" target="_self" title="标题：全国中学&amp;#12131;基础学科创新能&amp;#12050;测评活动报名通知&#xD;点击数：298&#xD;发表时间：18年11月05日">全国中学&amp;#12131;基础学科创新能&amp;#12050;测评活动报名通知</a>[ 11-05 ]</div>
                        </div>
                    </div>
