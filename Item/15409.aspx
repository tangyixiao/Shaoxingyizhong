...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15409"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15409},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15409";
...
      为强化工作环境，愉悦心情，工会将于本周五下午第三节，进行文明办公室检查，要求地面干净、桌面整洁、物品堆放有序、生活用品与资料入柜。谢谢大家配合。
                           绍兴一中工会</p><p>                          2022／04／20         </p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15221.aspx" target="_self" title="标题：文明办公室检查通知&#xD;点击数：178&#xD;发表时间：22年03月23日">文明办公室检查通知</a>[ 03-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15534.aspx" target="_self" title="标题：职工疗休养优惠活动的通知&#xD;点击数：423&#xD;发表时间：22年05月06日">职工疗休养优惠活动的通知</a>[ 05-06 ]</div>
                        </div>
                    </div>
