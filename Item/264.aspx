...
<head>
    ...
    <title>关于开展温馨寝室评比活动的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于开展温馨寝室评比活动的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=264"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:264},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=264";
     ...
     <DIV align=center><B>关于开展温馨寝室评比活动的通知</B><B></B></DIV>
<DIV><B></B> </DIV>
<DIV>    为进一步优化校园环境，规范住校秩序，培养住校生的文明习惯，创造良好的校园环境，本学期开展温馨寝室评比活动，事项通知如下：</DIV>
<DIV><B>    一、   </B><B>组织领导</B><B></B></DIV>
<DIV>组成以德育处、生活
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/262.aspx" target="_self" title="标题：绍兴一中各班住校生就寝纪律、寝室卫生情况统计表(2009.9.6-2009.9.11)&#xD;点击数：464&#xD;发表时间：09年09月14日">绍兴一中各班住校生就寝纪律、寝室卫生情况统计表(2009.9.6-20…</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/265.aspx" target="_self" title="标题：关于举行的“尖子生培养和班风建设”座谈会&#xD;点击数：530&#xD;发表时间：09年09月14日">关于举行的“尖子生培养和班风建设”座谈会</a>[ 09-14 ]</div>
                        </div>
                    </div>
