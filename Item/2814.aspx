...
<head>
    ...
    <title>关于高一研究性学习的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一研究性学习的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2814"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2814},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2814";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="conTxt"> 
                                      ...
                                      关于高一研究性学习的通知
<P>1、高一各班学习委员请到学校公共文件夹“政治”文件夹中下载“高一课题修改及说明”</P>
<P>2、“修改说明”中的相关要求请学习委员告知各组</P>
<P>3、各班各组长按说明中的要求完善课题表格并发回到相应文件夹中</P>
<P>4、以上工作请各班在本周内完成</P>
<P>                                                                             11.9</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2807.aspx" target="_self" title="标题：关于高二研究性学习的通知&#xD;点击数：439&#xD;发表时间：10年11月08日">关于高二研究性学习的通知</a>[ 11-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2825.aspx" target="_self" title="标题：高考学习网下载教学资源&#xD;点击数：590&#xD;发表时间：10年11月10日">高考学习网下载教学资源</a>[ 11-10 ]</div>
                        </div>
                    </div>
