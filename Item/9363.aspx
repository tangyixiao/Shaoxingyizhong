...
<head>
    ...
    <title>信息技术课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9363"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9363},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9363";
     ...
     <FONT size=4>因新教师面试须要，今天信息技术课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9362.aspx" target="_self" title="标题：市篮球比赛通知&#xD;点击数：314&#xD;发表时间：18年11月19日">市篮球比赛通知</a>[ 11-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9364.aspx" target="_self" title="标题：高三第三节政治、信息技术走班课改自修通知&#xD;点击数：184&#xD;发表时间：18年11月19日">高三第三节政治、信息技术走班课改自修通知</a>[ 11-19 ]</div>
                        </div>
                    </div>
