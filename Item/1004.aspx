...
<head>
    ...
    <title>关于采用新课间操提示音乐的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于采用新课间操提示音乐的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1004"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1004},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1004";
     ...
     <P><STRONG><FONT color=#000000 size=3>全校各班主任：</FONT></STRONG></P>
<P><STRONG><FONT color=#000000 size=3>   下星期一开始采用新的课间音乐，其中新课间操提示音乐历时4分42秒，由两部分组成，第一部分音乐2分20秒，第二部分音乐2分22秒。要求在第一段音乐结束后，全校学生必须到达楼下，第二段音乐结束时，全校学生必须在操场整队完毕，接下来马上放做操音乐。请提醒本班学生注意下楼的速度。</FONT></STRONG></P>
<P><STRONG><FONT color=#000000 size=3>   备注：具体音乐下载请到公共文件夹/德育处/课间操下楼音乐。</FONT></STRONG></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/997.aspx" target="_self" title="标题：2009.12.7大扫除检查情况公布&#xD;点击数：337&#xD;发表时间：09年12月14日">2009.12.7大扫除检查情况公布</a>[ 12-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1014.aspx" target="_self" title="标题：今天下午温馨教室布置情况检查&#xD;点击数：391&#xD;发表时间：09年12月14日">今天下午温馨教室布置情况检查</a>[ 12-14 ]</div>
                        </div>
                    </div>
