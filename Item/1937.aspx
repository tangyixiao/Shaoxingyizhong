...
<head>
    ...
    <title>高三班主任：拿会考证书--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1937"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1937},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1937";
...
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3>高三学生会考证书钢印已敲好，请各班到教学处拿，班主任发给学生时要学生检查一下钢印是否漏敲，同时强调<SPAN style="COLOR: red">“妥为保管，遗失不补”</SPAN>。有差错的学生要等全市集中后到省会考办统一办理，还要等一段时间。</FONT></SPAN></P>
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN lang=EN-US><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p><FONT size=3> </FONT></o:p></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1936.aspx" target="_self" title="标题：高三高考前上课安排&#xD;点击数：505&#xD;发表时间：10年05月25日">高三高考前上课安排</a>[ 05-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1941.aspx" target="_self" title="标题：关于召开教研组长工作会议的通知&#xD;点击数：434&#xD;发表时间：10年05月25日">关于召开教研组长工作会议的通知</a>[ 05-25 ]</div>
                        </div>
                    </div>
