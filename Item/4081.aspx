...
<head>
    ...
    <title>高一（1）、（2）、（3）、（4）班历史课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一（1）、（2）、（3）、（4）班历史课改自修</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4081"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4081},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4081";
     ...
     <P>       因为陈昌勇老师请假，其所任班高一（1）（2）（3）（4）班星期三（6月1日）历史课改自修。</P>
<P>                                                                                教学处 </P>
<P>                                                                                      2011/06/01</P>
<P>                                                                                     </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4075.aspx" target="_self" title="标题：高三高考期间休息室安排&#xD;点击数：875&#xD;发表时间：11年05月31日">高三高考期间休息室安排</a>[ 05-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4099.aspx" target="_self" title="标题：高三本学期文印室文印费结算通知&#xD;点击数：484&#xD;发表时间：11年06月01日">高三本学期文印室文印费结算通知</a>[ 06-01 ]</div>
                        </div>
                    </div>
