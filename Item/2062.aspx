...
<head>
    ...
    <title>会考的年级考前休息到食堂--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">会考的年级考前休息到食堂</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2062"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2062},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2062";
     ...
     高二、高一会考期间，考前不要进入试场，休息到食堂，1-8班在一楼食堂休息，9-16班在二楼食堂休息
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2059.aspx" target="_self" title="标题：绍兴一中参加中考阅卷老师名单&#xD;点击数：545&#xD;发表时间：10年06月14日">绍兴一中参加中考阅卷老师名单</a>[ 06-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2065.aspx" target="_self" title="标题：关于高一高二会考期间考试上课讯号的通知&#xD;点击数：373&#xD;发表时间：10年06月17日">关于高一高二会考期间考试上课讯号的通知</a>[ 06-17 ]</div>
                        </div>
                    </div>
