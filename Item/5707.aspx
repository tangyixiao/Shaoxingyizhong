...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5707"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5707},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5707";
     ...
     高二（8）班有同学在1号食堂拾到饭卡一张，特此表扬，并希望失主及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5700.aspx" target="_self" title="标题：高一军训积极分子公示名单&#xD;点击数：241&#xD;发表时间：16年10月11日">高一军训积极分子公示名单</a>[ 10-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5713.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：110&#xD;发表时间：16年10月12日">表扬与失物招领</a>[ 10-12 ]</div>
                        </div>
                    </div>
