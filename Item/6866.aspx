...
<head>
    ...
    <title>可回收垃圾收集工作即日起正常进行--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">可回收垃圾收集工作即日起正常进行</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6866"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6866},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6866";
     ...
     垃圾回收工作即日起正常进行，时间为中午12:20~12:40,请各班同学积极参与
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6857.aspx" target="_self" title="标题：关于初三创新班家长会的通知&#xD;点击数：227&#xD;发表时间：17年05月03日">关于初三创新班家长会的通知</a>[ 05-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6867.aspx" target="_self" title="标题：高一各班相关同学开会通知&#xD;点击数：300&#xD;发表时间：17年05月05日">高一各班相关同学开会通知</a>[ 05-05 ]</div>
                        </div>
                    </div>
