...
<head>
    ...
    <title>高三班主任高考体检工作会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三班主任高考体检工作会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6529"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6529},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6529";
     ...
     <FONT size=4>请各位高三班主任于今天下午第8节课到行政楼三楼会议室，开关于高考体检工作及毕业生登记表填写的会议。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6528.aspx" target="_self" title="标题：有关羽毛球比赛的通知&#xD;点击数：441&#xD;发表时间：17年03月08日">有关羽毛球比赛的通知</a>[ 03-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6545.aspx" target="_self" title="标题：绍兴市2017年上半年学考（选考）、高考适应性考试安排&#xD;点击数：1732&#xD;发表时间：17年03月10日">绍兴市2017年上半年学考（选考）、高考适应性考试安排</a>[ 03-10 ]</div>
                        </div>
                    </div>
