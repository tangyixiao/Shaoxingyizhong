...
<head>
    ...
    <title>团委纪检部对放学时段排队上公交车情况进行检查--团学动态-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_99/Index.aspx" target="_self">团学动态</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">团委纪检部对放学时段排队上公交车情况进行检查</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4079"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4079},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4079";
...
<P style="MARGIN: 0cm 0cm 0pt" class=MsoNormal><FONT size=3><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">    为积极响应绍兴创建全国文明城市，本周团委纪检部对放学时段学生排队上公交车情况进行为期一周的检查。检查发现多数同学能自觉排队上车，但也有部分同学需纪检部检查的同学提醒。目前绍兴已通过省级复查，但仍需不断巩固成果，争取在全国爱卫会的暗访复审中保持优异的成绩。（记者团</SPAN><SPAN lang=EN-US><SPAN style="mso-spacerun: yes">  </SPAN></SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">报道）</SPAN></FONT></P>
<P style="MARGIN: 0cm 0cm 0pt" class=MsoNormal><FONT size=3><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><A href="/Shaoxingyizhong/UploadFiles/UploadFiles_9649/201105/2011053114151035.jpg" target=_blank> </A><A href="/Shaoxingyizhong/UploadFiles/UploadFiles_9649/201105/2011053114162560.jpg" target=_blank><IMG onmousewheel="return bbimg(this)" border=0 src="/Shaoxingyizhong/UploadFiles/UploadFiles_9649/201105/2011053114162560.jpg" width=500 onload=resizepic(this) height=441> </A></SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4068.aspx" target="_self" title="标题：创建卫生文明城市，团委、学生会在行动&#xD;点击数：11191&#xD;发表时间：11年05月30日">创建卫生文明城市，团委、学生会在行动</a>[ 05-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4222.aspx" target="_self" title="标题：学弟学妹，我们在这里!&#xD;点击数：17767&#xD;发表时间：11年06月23日">学弟学妹，我们在这里!</a>[ 06-23 ]</div>
                        </div>
                    </div>
