...
<head>
    ...
    <title>高一、高二备课组长、年段长会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二备课组长、年段长会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7007"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7007},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7007";
     ...
     <FONT size=4>请高一、高二各位备课组长、年段长于今天下午第4节课，到行政楼三楼会议室开会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7003.aspx" target="_self" title="标题：台湾树德科技大学赴台就读学士学位班招生&#xD;点击数：270&#xD;发表时间：17年05月23日">台湾树德科技大学赴台就读学士学位班招生</a>[ 05-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7011.aspx" target="_self" title="标题：高三心理讲座通知&#xD;点击数：250&#xD;发表时间：17年05月23日">高三心理讲座通知</a>[ 05-23 ]</div>
                        </div>
                    </div>
