...
<head>
    ...
    <title>关于中午实行错时用餐的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于中午实行错时用餐的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=203"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:203},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=203";
     ...
     <DIV align=center><FONT size=5>关于中午实行错时用餐的通知</FONT></DIV>
<DIV><FONT size=5></FONT> </DIV>
<DIV><FONT size=5>各位班主任、各位老师：</FONT></DIV>
<DIV><FONT size=5>    为了解决中午用餐拥挤的问题，学校决定在中午实行错时用餐制度，请班主任通知本班学生，并做好相关工作。</FONT></DIV>
<DIV><FONT size=
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/180.aspx" target="_self" title="标题：绍兴一中2009学年工作思路（初稿）&#xD;点击数：803&#xD;发表时间：09年09月01日">绍兴一中2009学年工作思路（初稿）</a>[ 09-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/212.aspx" target="_self" title="标题：会议通知&#xD;点击数：570&#xD;发表时间：09年09月07日">会议通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
