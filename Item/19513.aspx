...
<head>
    ...
    <title>3.19跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">3.19跑操量化考核反馈</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19513"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19513},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19513";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2024/3/202403191535132604.png" style="max-width: 100%; " title="202403191535132604.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19512.aspx" target="_self" title="标题：3.18班级一日考核&#xD;点击数：29&#xD;发表时间：24年03月19日">3.18班级一日考核</a>[ 03-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19518.aspx" target="_self" title="标题：博雅大讲堂（西湖大学）活动通知（地点有修改）&#xD;点击数：215&#xD;发表时间：24年03月18日">博雅大讲堂（西湖大学）活动通知（地点有修改）</a>[ 03-18 ]</div>
                        </div>
                    </div>
