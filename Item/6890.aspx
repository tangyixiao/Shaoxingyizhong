...
<head>
    ...
    <title>“U-Test优特测试”推荐报名通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">“U-Test优特测试”推荐报名通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6890"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6890},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6890";
     ...
     <P>我校获得“U-Test优特测试”名额12人，其中选考科目要求物理名额9人，历史名额3人。本次测试旨在为成绩优秀、学习潜能大的考生提供全方位的测评，进而促进学生综合素质的发展，为高水平大学人才选拔提供参考依据。请有兴趣参加测试的高二学生于周二（5月9日）中午12：40前到教学填写并提交申请表，学校将在报名学生中择优推荐。</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6883.aspx" target="_self" title="标题：复旦大学、上海交大校荐公示&#xD;点击数：740&#xD;发表时间：17年05月05日">复旦大学、上海交大校荐公示</a>[ 05-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6892.aspx" target="_self" title="标题：全国生物联赛参赛学生停课复习通知&#xD;点击数：251&#xD;发表时间：17年05月08日">全国生物联赛参赛学生停课复习通知</a>[ 05-08 ]</div>
                        </div>
                    </div>
