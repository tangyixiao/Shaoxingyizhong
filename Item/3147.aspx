...
<head>
    ...
    <title>高二、高三班主任：会考准考证补办--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二、高三班主任：会考准考证补办</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3147"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3147},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3147";
     ...
     高二、高三班主任：请统计本班需要补办会考准考证的同学名单，以班级为单位，在12月28日（星期二）16:30分前，报教学处，逾期不候。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3146.aspx" target="_self" title="标题：高三备课组长去嘉兴一中教学交流活动通知&#xD;点击数：451&#xD;发表时间：10年12月27日">高三备课组长去嘉兴一中教学交流活动通知</a>[ 12-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3149.aspx" target="_self" title="标题：有关校本课程的通知&#xD;点击数：514&#xD;发表时间：10年12月27日">有关校本课程的通知</a>[ 12-27 ]</div>
                        </div>
                    </div>
