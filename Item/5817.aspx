...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5817"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5817},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5817";
     ...
     有老师在操场上捡到雨伞一把，高一（6）邱仕豪在操场上捡到新校裤（185号）一条，望失主及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5814.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：55&#xD;发表时间：16年10月28日">表扬与失物招领</a>[ 10-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5818.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：61&#xD;发表时间：16年10月28日">表扬与失物招领</a>[ 10-28 ]</div>
                        </div>
                    </div>
