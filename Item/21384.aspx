...
<head>
    ...
    <title>周五相关班级体育课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">周五相关班级体育课改自修通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21384"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21384},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21384";
     ...
     <p style="text-indent: 37px"><span style=";font-family:宋体;font-size:19px">明天（周五）吴丽娟、王冰洁、何隽豪、陈炳炉老师外出，</span><span style=";font-family:宋体;font-size:19px">高一相关班级体育课改自修。</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21383.aspx" target="_self" title="标题：关于参加2025年全国天文知识竞赛决赛学生停课复习的通知&#xD;点击数：197&#xD;发表时间：25年05月08日">关于参加2025年全国天文知识竞赛决赛学生停课复习的通知</a>[ 05-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21389.aspx" target="_self" title="标题：体测运动会通知&#xD;点击数：499&#xD;发表时间：25年05月09日">体测运动会通知</a>[ 05-09 ]</div>
                        </div>
                    </div>
