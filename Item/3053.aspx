...
<head>
    ...
    <title>校艺术节开幕式体育馆座位安排--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">校艺术节开幕式体育馆座位安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3053"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3053},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3053";
     ...
     <P>今天下午3点整在体育馆举行校艺术节开幕式暨“校园十大歌手”比赛，请高一高二各班在第二节下课后迅速到体育馆，按指定位置就座。学生评委（各班文艺委员）自带凳子统一坐在台下中间处。</P>
<P>附：<A title=2010年艺术节开幕式座位安排 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201012/2010121508111113.xls">2010年艺术节开幕式座位安排</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3048.aspx" target="_self" title="标题：两点提醒&#xD;点击数：709&#xD;发表时间：10年12月14日">两点提醒</a>[ 12-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3055.aspx" target="_self" title="标题：值周检查情况汇总（12月14日星期二）&#xD;点击数：325&#xD;发表时间：10年12月15日">值周检查情况汇总（12月14日星期二）</a>[ 12-15 ]</div>
                        </div>
                    </div>
