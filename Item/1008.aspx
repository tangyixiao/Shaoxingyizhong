...
<head>
    ...
    <title>高一计算机课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1008"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1008},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1008";
     ...
     <FONT color=#000000 size=3>12月10日--12月11日，陈合力、邵红祥、董烨华、游光辉参加市竞赛研讨会，所任课班级计算机课改自修。 </FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1007.aspx" target="_self" title="标题：关于绍兴一中推荐高校自主招生学生的公示(第四批)&#xD;点击数：388&#xD;发表时间：09年12月14日">关于绍兴一中推荐高校自主招生学生的公示(第四批)</a>[ 12-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1009.aspx" target="_self" title="标题：关于绍兴一中第十七期课余党校学员名单公示的通知&#xD;点击数：336&#xD;发表时间：09年12月14日">关于绍兴一中第十七期课余党校学员名单公示的通知</a>[ 12-14 ]</div>
                        </div>
                    </div>
