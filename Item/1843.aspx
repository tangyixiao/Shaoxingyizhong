...
<head>
    ...
    <title>历史课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1843"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1843},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1843";
     ...
     5月12日（星期三），高一、高二、高三历史组外出教研活动，所任课班级历史课改自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1842.aspx" target="_self" title="标题：关于召开高三年级备课组长会议的通知&#xD;点击数：308&#xD;发表时间：10年05月11日">关于召开高三年级备课组长会议的通知</a>[ 05-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1844.aspx" target="_self" title="标题：高二部分选修IB上课安排&#xD;点击数：403&#xD;发表时间：10年05月11日">高二部分选修IB上课安排</a>[ 05-11 ]</div>
                        </div>
                    </div>
