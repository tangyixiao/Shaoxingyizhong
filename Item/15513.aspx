...
<head>
    ...
    <title>全校班长会议--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15513"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15513},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15513";
     ...
     <p>今天（5月4日）傍晚17：50在教学楼2112召开班长会议，请相互转告准时出席。（如班长不上晚自习请其他班干部出席）</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15503.aspx" target="_self" title="标题：第十一周早上迟到学生统计&#xD;点击数：64&#xD;发表时间：22年04月29日">第十一周早上迟到学生统计</a>[ 04-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15516.aspx" target="_self" title="标题：失物招领两则&#xD;点击数：164&#xD;发表时间：22年05月04日">失物招领两则</a>[ 05-04 ]</div>
                        </div>
                    </div>
