...
<head>
    ...
    <title>高一、高二班主任会议通知（有修改）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二班主任会议通知（有修改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11278"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11278},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11278";
     ...
     <P>高一、高二班主任：</P>
<P>           <FONT size=4>请高一、高二班主任于明天（周三）分别于上午高一任课教师会议和下午高二任课教师会议结束后在树兰楼三楼会议室一开会。请安排好工作，准时与会。</FONT></P>
<P align=right><FONT size=4>德育处</FONT></P>
<P align=right><FONT size=4>2020.4.14</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11268.aspx" target="_self" title="标题：关于高三各班处理废旧报纸书籍的通知&#xD;点击数：119&#xD;发表时间：20年04月13日">关于高三各班处理废旧报纸书籍的通知</a>[ 04-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11299.aspx" target="_self" title="标题：关于高一班主任讲座的通知&#xD;点击数：123&#xD;发表时间：20年04月20日">关于高一班主任讲座的通知</a>[ 04-20 ]</div>
                        </div>
                    </div>
