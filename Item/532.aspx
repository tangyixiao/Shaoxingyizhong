...
<head>
    ...
    <title>关于第八期《求真》校刊征稿的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于第八期《求真》校刊征稿的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年11月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=532"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:532},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=532";
     ...
     <DIV align=left><FONT size=4>全校教职员工：</FONT></DIV>
<DIV align=left><FONT size=4>    第八期《求真》校刊（2009学年）正在筹划编辑之中，现将本期主要栏目、征稿的主要内容及要求公布如下：</FONT></DIV>
<DIV><FONT size=4>1、主要栏目</FONT></DIV>
<DIV><FONT size=4>    本期拟开设《教育
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/524.aspx" target="_self" title="标题：高三招飞校内目测名单&#xD;点击数：281&#xD;发表时间：09年11月09日">高三招飞校内目测名单</a>[ 11-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/533.aspx" target="_self" title="标题：政治课改自修&#xD;点击数：257&#xD;发表时间：09年11月09日">政治课改自修</a>[ 11-09 ]</div>
                        </div>
                    </div>
