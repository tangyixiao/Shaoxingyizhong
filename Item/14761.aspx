...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14761"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14761},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14761";
     ...
     <p>今天（12月27日）进行室内升旗仪式。</p><p>                                                                                                  德育处</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14760.aspx" target="_self" title="标题：失物招领及拾金不昧表扬&#xD;点击数：172&#xD;发表时间：21年12月27日">失物招领及拾金不昧表扬</a>[ 12-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14762.aspx" target="_self" title="标题：高二、高三大扫除通知&#xD;点击数：32&#xD;发表时间：21年12月27日">高二、高三大扫除通知</a>[ 12-27 ]</div>
                        </div>
                    </div>
