...
<head>
    ...
    <title>今日大课间操暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8128"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8128},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8128";
     ...
     今日大课间操暂停。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8127.aspx" target="_self" title="标题：关于营造整洁优美的校园环境及进一步规范垃圾分类工作的通知&#xD;点击数：167&#xD;发表时间：18年03月06日">关于营造整洁优美的校园环境及进一步规范垃圾分类工作的通知</a>[ 03-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8129.aspx" target="_self" title="标题：大扫除通知&#xD;点击数：265&#xD;发表时间：18年03月07日">大扫除通知</a>[ 03-07 ]</div>
                        </div>
                    </div>
