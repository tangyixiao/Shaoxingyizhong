...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5891"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5891},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5891";
     ...
     高一（14）班吴涵于昨天（10日）下午第三节选修课后在本班教室捡到手表一只，特此表扬，望失主能及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5886.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：77&#xD;发表时间：16年11月10日">表扬与失物招领</a>[ 11-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5895.aspx" target="_self" title="标题：表扬&#xD;点击数：258&#xD;发表时间：16年11月11日">表扬</a>[ 11-11 ]</div>
                        </div>
                    </div>
