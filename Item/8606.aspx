...
<head>
    ...
    <title>高一班长开会通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8606"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8606},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8606";
     ...
     <P>    请高一各班班长于今天中午12点30分在2112教室参加有关于第二学期学生综合素质评价的会议，准时到场。若有个人原因不能到场，请自行在班级中找一位同学代替，务必保证每班都有一人到场。随带纸笔！</P>
<P align=right>德育处</P>
<P align=right>2018年5月23日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8599.aspx" target="_self" title="标题：今日大课间操通知&#xD;点击数：273&#xD;发表时间：18年05月22日">今日大课间操通知</a>[ 05-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8610.aspx" target="_self" title="标题：大扫除通知&#xD;点击数：136&#xD;发表时间：18年05月23日">大扫除通知</a>[ 05-23 ]</div>
                        </div>
                    </div>
