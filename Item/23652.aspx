...
<head>
    ...
    <title>9.11班级一日考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23652"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23652},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23652";
     ...
     <p style="text-align: center;"><img src="/UploadFiles/xwzx/2026/9/202609151441222269.png" style="max-width: 100%; " title="202609151441222269.png" /></p>
