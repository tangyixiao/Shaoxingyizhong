...
<head>
    ...
    <title>关于高二校本课程上课安排的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高二校本课程上课安排的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年10月12日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=385"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:385},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=385";
     ...
     <DIV align=center>关于高二年级校本课程上课的通知</DIV>
<DIV>高二班主任：</DIV>
<DIV>高二校本课程将于本周开始正常上课。根据学校课时安排，高二为每周二下午第四节课。具体安排如下：</DIV>
<DIV>
<TABLE style="WIDTH: 605pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=807 border=0 x:str>
<COLGROUP>
<COL style="W
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/384.aspx" target="_self" title="标题：英语组教师开设公开课信息&#xD;点击数：406&#xD;发表时间：09年10月12日">英语组教师开设公开课信息</a>[ 10-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/389.aspx" target="_self" title="标题：10月13日（周二）高三生物1B学分考监考安排&#xD;点击数：383&#xD;发表时间：09年10月13日">10月13日（周二）高三生物1B学分考监考安排</a>[ 10-13 ]</div>
                        </div>
                    </div>
