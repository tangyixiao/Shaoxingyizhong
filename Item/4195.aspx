...
<head>
    ...
    <title>关于交“品德行为考核表”及“各项先进评比结果”的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于交“品德行为考核表”及“各项先进评比结果”的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4195"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4195},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4195";
...
<P><FONT size=4>高一高二相关班主任：</FONT></P>
<P><FONT size=4>     “品德行为考核表”和“各项先进评比结果”还有部分班级没有交，请相关班级在明天（周六）中午放学前将材料交到德育处。谢谢！</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4193.aspx" target="_self" title="标题：6月16日寝室缺席名单&#xD;点击数：602&#xD;发表时间：11年06月17日">6月16日寝室缺席名单</a>[ 06-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4196.aspx" target="_self" title="标题：高一（1—8班）音乐补考安排&#xD;点击数：748&#xD;发表时间：11年06月17日">高一（1—8班）音乐补考安排</a>[ 06-17 ]</div>
                        </div>
                    </div>
