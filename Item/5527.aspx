...
<head>
    ...
    <title>晚间安全检查记录2016.9.14--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2016.9.14</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5527"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5527},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5527";
     ...
     <P>9月14日高一（3）班灯和门未关。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5508.aspx" target="_self" title="标题：晚间安全检查记录2016.9.12&#xD;点击数：85&#xD;发表时间：16年09月13日">晚间安全检查记录2016.9.12</a>[ 09-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5541.aspx" target="_self" title="标题：规范有序停车通知&#xD;点击数：166&#xD;发表时间：16年09月18日">规范有序停车通知</a>[ 09-18 ]</div>
                        </div>
                    </div>
