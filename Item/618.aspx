...
<head>
    ...
    <title>绍兴一女生进央视比才--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=618"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:618},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=618";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/617.aspx" target="_self" title="标题：“求真”文化发扬光大&#xD;点击数：458&#xD;发表时间：09年11月13日">“求真”文化发扬光大</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/619.aspx" target="_self" title="标题：舞动青春&amp;nbsp;运动场上展真我风采&#xD;点击数：465&#xD;发表时间：09年11月13日">舞动青春 运动场上展真我风采</a>[ 11-13 ]</div>
                        </div>
                    </div>
