...
<head>
    ...
    <title>《光纤传感与人工智能》讲座通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">《光纤传感与人工智能》讲座通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8391"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8391},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8391";
     ...
     <P><FONT size=4>今天下午第4节课天津大学刘琨副教授将来我校作关于光纤传感与人工智能的讲座。特邀高一（15、16、17、18）班参加，也欢迎其他感兴趣的同学参加。</FONT></P>
<P><FONT size=4>地点：树兰楼三楼会议室四</FONT></P>
<P><FONT size=4>时间：周四下午第4节课</FONT></P>
<P><FONT size=4>讲座摘要：报告将介绍传感器技术与人工智能的发展历程和对人类生活的重要意义，深刻阐述光纤传感智能网络的研究现状和应用，最后将会以盾构机管片拼接自动化为例讲述光纤传感技术在工程领域中的实际应用。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8388.aspx" target="_self" title="标题：体育教研活动通知&#xD;点击数：225&#xD;发表时间：18年04月19日">体育教研活动通知</a>[ 04-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8392.aspx" target="_self" title="标题：关于高三体检工作的提醒&#xD;点击数：241&#xD;发表时间：18年04月19日">关于高三体检工作的提醒</a>[ 04-19 ]</div>
                        </div>
                    </div>
