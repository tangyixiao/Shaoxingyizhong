...
<head>
    ...
    <title>备课组长通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3168"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3168},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3168";
     ...
     <P>高一~高三各备课组长：</P>
<P>    请各备课组长把本学期征订使用的教学资料一份于近期上交刘夏进老师处。</P>
<P>                                              教学处</P>
<P>                                                12.28</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3165.aspx" target="_self" title="标题：关于绍兴一中高校自主招生推荐学生的公示(第四批)&#xD;点击数：942&#xD;发表时间：10年12月28日">关于绍兴一中高校自主招生推荐学生的公示(第四批)</a>[ 12-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3179.aspx" target="_self" title="标题：高三会考模拟考监考安排&#xD;点击数：532&#xD;发表时间：10年12月29日">高三会考模拟考监考安排</a>[ 12-29 ]</div>
                        </div>
                    </div>
