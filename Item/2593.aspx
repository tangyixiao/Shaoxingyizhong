...
<head>
    ...
    <title>教工爱国主义通用卡领取通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">教工爱国主义通用卡领取通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2593"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2593},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2593";
     ...
     <P>教工爱国主义通用卡已做好，请各位到德育处认领。</P>
<P>另未领取的班级还有：</P>
<P>一（4）、一（5）、一（10）、一（13）、一（15）、</P>
<P>二（5）、二（6）、二（11）、三（1）</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2591.aspx" target="_self" title="标题：2010年高二“感恩报国”诗歌朗诵比赛结果&#xD;点击数：1175&#xD;发表时间：10年09月30日">2010年高二“感恩报国”诗歌朗诵比赛结果</a>[ 09-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2601.aspx" target="_self" title="标题：德育处建议二则&#xD;点击数：510&#xD;发表时间：10年10月09日">德育处建议二则</a>[ 10-09 ]</div>
                        </div>
                    </div>
