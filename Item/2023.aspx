...
<head>
    ...
    <title>高三各班主任--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2023"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2023},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2023";
...
<P><FONT size=4>   1、请将有关班级考核的材料准备好，本周交到德育处，以便考核；</FONT></P>
<P><FONT size=4>   2、提醒来校的高三毕业生，在高一、高二上课期间不要在校园内来回走动；</FONT></P>
<P><FONT size=4>   3、提醒骑车来校的高三毕业生，自行车仍要规范停放。</FONT></P>
<P> </P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2019.aspx" target="_self" title="标题：高三班主任通知请有关学生&#xD;点击数：364&#xD;发表时间：10年06月09日">高三班主任通知请有关学生</a>[ 06-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2026.aspx" target="_self" title="标题：新生集会座位安排&#xD;点击数：482&#xD;发表时间：10年06月10日">新生集会座位安排</a>[ 06-10 ]</div>
                        </div>
                    </div>
