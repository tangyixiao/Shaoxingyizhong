...
<head>
    ...
    <title>元旦文艺会演有关通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3158"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3158},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3158";
     ...
     <P>       <FONT size=4> 元旦文艺会演定于12月31日下午举行，为确保演出高质量地顺利进行，请各班参加演出的同学抓紧时间排练，并于本周三、四(高一周三，高二周四）下午第三、第四节课到体育馆走台彩排一下。还没有上交音响资料的班级赶紧上传到校园网公共文件夹/德育处/元旦文艺会演音乐。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3157.aspx" target="_self" title="标题：“我型我秀”环保服饰设计比赛结果&#xD;点击数：516&#xD;发表时间：10年12月28日">“我型我秀”环保服饰设计比赛结果</a>[ 12-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3159.aspx" target="_self" title="标题：12月27日值周和大扫除检查情况汇总&#xD;点击数：356&#xD;发表时间：10年12月28日">12月27日值周和大扫除检查情况汇总</a>[ 12-28 ]</div>
                        </div>
                    </div>
