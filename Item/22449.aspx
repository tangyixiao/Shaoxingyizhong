...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22449"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22449},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22449";
     ...
     <article>12月11日（周四）全体美术组教师外出参加教研活动，相关班级美术课改自修。</article>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22400.aspx" target="_self" title="标题：12.04高三校模拟考试监考安排和学生考场安排&#xD;点击数：336&#xD;发表时间：25年12月03日">12.04高三校模拟考试监考安排和学生考场安排</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22455.aspx" target="_self" title="标题：数学组外出教研活动通知&#xD;点击数：165&#xD;发表时间：25年12月11日">数学组外出教研活动通知</a>[ 12-11 ]</div>
                        </div>
                    </div>
