    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>信息组汇报课通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2021年05月04日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13307"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13307},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13307";
     ...
     <p><span style="color: rgb(17, 31, 44); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI SymbolMyanmar Text", 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);"> 5月5日（周三）下午第8节，在高一（2）班教室，由信息组翁天冬老师执教汇报课。欢迎老师们莅临指导。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13253.aspx" target="_self" title="标题：深度学习课堂录像课评比和微讲座的通知（教师专业阅读第二、三阶段活动）&#xD;点击数：262&#xD;发表时间：21年04月25日">深度学习课堂录像课评比和微讲座的通知（教师专业阅读第二、三…</a>[ 04-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13323.aspx" target="_self" title="标题：2021年省教坛新秀评选通知&#xD;点击数：328&#xD;发表时间：21年05月06日">2021年省教坛新秀评选通知</a>[ 05-06 ]</div>
                        </div>
                    </div>
