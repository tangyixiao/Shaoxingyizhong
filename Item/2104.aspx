...
<head>
    ...
    <title>关于高一文理分班的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2104"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2104},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2104";
     ...
     <P>高一班主任：各班报名文理申请表已经汇总，请班主任在教室张贴确认汇总表，如有更改，请6月23日下午5点前，到教学处更改，过期一律不再更改。</P>
<P>                                                                                        教学处</P>
<P>                                                                                           6.22</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2103.aspx" target="_self" title="标题：校本课程和高二年级IB上课通知&#xD;点击数：439&#xD;发表时间：10年06月22日">校本课程和高二年级IB上课通知</a>[ 06-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2109.aspx" target="_self" title="标题：高考成绩查分&#xD;点击数：582&#xD;发表时间：10年06月23日">高考成绩查分</a>[ 06-23 ]</div>
                        </div>
                    </div>
