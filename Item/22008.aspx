...
<head>
    ...
    <title>关于迎国庆大扫除时间调整的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于迎国庆大扫除时间调整的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22008"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22008},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22008";
     ...
     <article><p>各年段、各班级：
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22004.aspx" target="_self" title="标题：9.28班级一日考核&#xD;点击数：44&#xD;发表时间：25年09月29日">9.28班级一日考核</a>[ 09-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22009.aspx" target="_self" title="标题：9.29班级一日考核&#xD;点击数：32&#xD;发表时间：25年09月30日">9.29班级一日考核</a>[ 09-30 ]</div>
                        </div>
                    </div>
