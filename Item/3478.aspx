...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3478"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3478},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3478";
     ...
     <P>                                      文明办公室检查</P>
<P>      今天下午第三节课进行文明办公室检查,请各年级今天白天值班的老师下午第三节到校办宣方军老师处集中.</P>
<P> </P>
<P>                                                    校文明办公室检查小组</P>
<P>                                                       2011.3.9</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3441.aspx" target="_self" title="标题：工会”三八”节活动通知&#xD;点击数：590&#xD;发表时间：11年03月04日">工会”三八”节活动通知</a>[ 03-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3494.aspx" target="_self" title="标题：教代会公告&#xD;点击数：670&#xD;发表时间：11年03月11日">教代会公告</a>[ 03-11 ]</div>
                        </div>
                    </div>
