...
<head>
    ...
    <title>学时登记：2024冬衣志愿者--实践学分-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_368/Index.aspx" target="_self">实践学分</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">学时登记：2024冬衣志愿者</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20399"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20399},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20399";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12pt; text-align: justify; text-wrap-mode: wrap; margin: 0px; padding: 0px;">请相关班级的团支书及时登记、更新下列同学的学分登记表，</span><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12pt; text-align: justify; text-wrap-mode: wrap; margin: 0px; padding: 0px;">登记在“志愿服务”栏内。</span></p><p>208毛一涵 0.25学分</p><p>202俞晨旭 0.25学分</p><p>202陈欣雨 0.25学分</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20385.aspx" target="_self" title="标题：学时登记：2024运动会志愿者&#xD;点击数：60&#xD;发表时间：24年10月15日">学时登记：2024运动会志愿者</a>[ 10-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20422.aspx" target="_self" title="标题：学时登记：书香校园宣传片拍摄志愿者&#xD;点击数：68&#xD;发表时间：24年10月23日">学时登记：书香校园宣传片拍摄志愿者</a>[ 10-23 ]</div>
                        </div>
                    </div>
