...
<head>
    ...
    <title>高三自修教室安排通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7611"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7611},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7611";
     ...
     <P><FONT size=4>鉴于部分学生七选三选考科目已完成两次考试，为便于这些学生的自修，特安排自修教室如下：</FONT></P>
<P><FONT size=4>一、非走班时间自修教室为4112阶梯教室。</FONT></P>
<P><FONT size=4>二、走班时间：技术1班、2班自修教室为4112阶梯教室，技术3班自修教室为3112，其他选考学科的学生在3110教室自修。</FONT></P>
<P><FONT size=4>请自修学生在规定场所自修，年段和教学处将安排老师进行管理。自修期间请同学们注意自修纪律并作好自修教室的卫生保洁工作。自修结束后将个人物品如数带回。</FONT></P>
<P><FONT size=4>附件：</FONT><A title=各班自修学生名单 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201711/2017111312495016.xls">各班自修学生名单</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7609.aspx" target="_self" title="标题：期中考试时间及范围&#xD;点击数：758&#xD;发表时间：17年11月13日">期中考试时间及范围</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7617.aspx" target="_self" title="标题：高一天文竞赛暂停通知&#xD;点击数：125&#xD;发表时间：17年11月13日">高一天文竞赛暂停通知</a>[ 11-13 ]</div>
                        </div>
                    </div>
