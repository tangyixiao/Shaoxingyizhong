...
<head>
    ...
    <title>【日研社】社团大会通知--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20004"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20004},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20004";
     ...
     <p>时间：6月18日（周二）中午12：40</p><p>地点：阶梯教室4104</p><p>内容：社团年度总结和换届安排</p><p>人员：全体社员</p><p>注意：请务必向班主任请好假，携带纸笔准时到场。</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19965.aspx" target="_self" title="标题：【考古社】社员大会通知&#xD;点击数：30&#xD;发表时间：24年06月11日">【考古社】社员大会通知</a>[ 06-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20046.aspx" target="_self" title="标题：2023学年学生社团考核结果（星级评定）&#xD;点击数：98&#xD;发表时间：24年06月27日">2023学年学生社团考核结果（星级评定）</a>[ 06-27 ]</div>
                        </div>
                    </div>
