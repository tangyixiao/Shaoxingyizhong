...
<head>
    ...
    <title>关于远足活动的通知--工会-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3900"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3900},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3900";
     ...
     <P>                                      关于远足活动的通知</P>
<P>      上周未参加远足活动的教职工,请于本周二--四，三天时间内到校田径场累计步行22圈，参加者请先到体育组阮国华老师处登记，请相互告知。</P>
<P>                                                绍兴一中工会</P>
<P>                                                     2011.5.9</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3719.aspx" target="_self" title="标题：文明办公室检查&#xD;点击数：476&#xD;发表时间：11年04月14日">文明办公室检查</a>[ 04-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3901.aspx" target="_self" title="标题：工会会议通知&#xD;点击数：512&#xD;发表时间：11年05月09日">工会会议通知</a>[ 05-09 ]</div>
                        </div>
                    </div>
