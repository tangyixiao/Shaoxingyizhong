...
<head>
    ...
    <title>晚间安全检查记录1.10--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录1.10</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6311"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6311},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6311";
     ...
     <P align=center>1月10日晚，高一（10）班灯、后门未关；高一（11）班前后门未关。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6303.aspx" target="_self" title="标题：2016学年第一学期校园巡视检查记录统计汇总(2016.9~2016.11)&#xD;点击数：152&#xD;发表时间：17年01月09日">2016学年第一学期校园巡视检查记录统计汇总(2016.9~2016.11)</a>[ 01-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6312.aspx" target="_self" title="标题：每日晨检表未交情况通报1.11&#xD;点击数：48&#xD;发表时间：17年01月11日">每日晨检表未交情况通报1.11</a>[ 01-11 ]</div>
                        </div>
                    </div>
