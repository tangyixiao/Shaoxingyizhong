...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2339"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2339},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2339";
...
<P><FONT size=4>   1.请各班主任组织好今天下午的班会课，上好开学第一课；</FONT></P>
<P><FONT size=4>   2.温馨教室评比将在9月中旬进行，请各班早作准备。</FONT></P>
<P><FONT size=4></FONT> </P>
<P><FONT size=4>谢谢合作！</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2338.aspx" target="_self" title="标题：教室卫生和课间操检查情况反馈&#xD;点击数：440&#xD;发表时间：10年09月02日">教室卫生和课间操检查情况反馈</a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2347.aspx" target="_self" title="标题：关于上交贫困生申请表的通知（急）&#xD;点击数：274&#xD;发表时间：10年09月03日">关于上交贫困生申请表的通知（急）</a>[ 09-03 ]</div>
                        </div>
                    </div>
