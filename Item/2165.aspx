...
<head>
    ...
    <title>关于高一、高二各班文印费结帐的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一、高二各班文印费结帐的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2165"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2165},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2165";
     ...
     <P>高一、高二各班班主任:</P>
<P>        因学期即将结束,请各班班主任通知本班生活委员于近期到学校文印室结清文印费用,请相互转告!</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2164.aspx" target="_self" title="标题：绍兴一中德育处副主任任前公示&#xD;点击数：800&#xD;发表时间：10年06月30日">绍兴一中德育处副主任任前公示</a>[ 06-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2167.aspx" target="_self" title="标题：关于中层班子组建工作的通知（11）&#xD;点击数：1095&#xD;发表时间：10年06月30日">关于中层班子组建工作的通知（11）</a>[ 06-30 ]</div>
                        </div>
                    </div>
