...
<head>
    ...
    <title>周四生物教研活动通知（有修改）--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">周四生物教研活动通知（有修改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7474"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7474},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7474";
     ...
     <FONT size=4>本周四市直生物教研活动在我校举行，生物组全体老师参加活动，活动地点为<FONT color=#ff0000>4110阶梯教室</FONT>，相关班级生物课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7473.aspx" target="_self" title="标题：橡皮网试用通知&#xD;点击数：439&#xD;发表时间：17年10月18日">橡皮网试用通知</a>[ 10-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7475.aspx" target="_self" title="标题：美术教研活动通知&#xD;点击数：209&#xD;发表时间：17年10月18日">美术教研活动通知</a>[ 10-18 ]</div>
                        </div>
                    </div>
