...
<head>
    ...
    <title>教研组长通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2517"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2517},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2517";
     ...
     <P>       请各教研组预算本学年度需要添置的教学设备和外出培训、学习、考察等活动经费，教研组长在9月25日上报教学处。</P>
<P>                                                                           9.22</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2503.aspx" target="_self" title="标题：高一研究性课程上课通知&#xD;点击数：337&#xD;发表时间：10年09月21日">高一研究性课程上课通知</a>[ 09-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2523.aspx" target="_self" title="标题：关于家长开放日的通知&#xD;点击数：1256&#xD;发表时间：10年09月25日">关于家长开放日的通知</a>[ 09-25 ]</div>
                        </div>
                    </div>
