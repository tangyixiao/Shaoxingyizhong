...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6771"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6771},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6771";
     ...
     本周五通用技术组全体老师外出参加教研活动，高一、高二年级通用技术课改自修，高二通用技术走班学生在相应上课教室自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6767.aspx" target="_self" title="标题：“中学生标准学术能力测试”报名通知&#xD;点击数：281&#xD;发表时间：17年04月19日">“中学生标准学术能力测试”报名通知</a>[ 04-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6772.aspx" target="_self" title="标题：地理教研活动通知&#xD;点击数：128&#xD;发表时间：17年04月20日">地理教研活动通知</a>[ 04-20 ]</div>
                        </div>
                    </div>
