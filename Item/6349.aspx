...
<head>
    ...
    <title>关于参加希望杯决赛的同学的开会通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于参加希望杯决赛的同学的开会通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：tw</span> <span>发布时间：2017年01月17日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6349"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6349},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6349";
     ...
     <P> </P>
<P>   <FONT size=4>请参加希望杯决赛的同学，明天（18日）中午12：00在教3-105集中开个短会，请到范玲玲老师处签到，随带纸笔，相互转告，务必到会！</FONT></P>
<P><FONT size=4>                                                                               校团委</FONT></P>
<P><FONT size=4>                                                                               1月17日   </FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6345.aspx" target="_self" title="标题：信奥冬令营志愿者名单、岗位及培训通知(修改)&#xD;点击数：1066&#xD;发表时间：17年01月17日">信奥冬令营志愿者名单、岗位及培训通知(修改)</a>[ 01-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6352.aspx" target="_self" title="标题：冬令营礼仪队人员名单&#xD;点击数：285&#xD;发表时间：17年01月18日">冬令营礼仪队人员名单</a>[ 01-18 ]</div>
                        </div>
                    </div>
