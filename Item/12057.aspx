...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12057"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12057},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12057";
     ...
     <FONT size=4>因体育老师带队外出参加市直运动会，明天（周五）所有体育课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12055.aspx" target="_self" title="标题：高一部分选修课改自修通知&#xD;点击数：372&#xD;发表时间：20年10月29日">高一部分选修课改自修通知</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12058.aspx" target="_self" title="标题：参加市运动会出征动员提醒&#xD;点击数：461&#xD;发表时间：20年10月29日">参加市运动会出征动员提醒</a>[ 10-29 ]</div>
                        </div>
                    </div>
