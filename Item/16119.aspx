...
<head>
    ...
    <title>高二名校协作体考试分析会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16119"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16119},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16119";
     ...
     <p>兹定于今天（9月8日）下午第四节课召开高二年级名校协作体成绩分析会，会议地点在树兰楼三楼会议室二，请高二高考科目教师准时参加。</p><p></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16112.aspx" target="_self" title="标题：高三名校协作体考试分析会通知&#xD;点击数：253&#xD;发表时间：22年09月07日">高三名校协作体考试分析会通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16127.aspx" target="_self" title="标题：本周五错时放学通知&#xD;点击数：227&#xD;发表时间：22年09月08日">本周五错时放学通知</a>[ 09-08 ]</div>
                        </div>
                    </div>
