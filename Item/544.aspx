...
<head>
    ...
    <title>高三化学课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=544"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:544},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=544";
     ...
     <FONT size=3>    11月12日（星期四）上午，高三化学老师参加市属教研活动，各班化学课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/543.aspx" target="_self" title="标题：关于公布第六批绍兴市普通中小学“学术主题报告”备讲目录的通知&#xD;点击数：368&#xD;发表时间：09年11月11日">关于公布第六批绍兴市普通中小学“学术主题报告”备讲目录的通知</a>[ 11-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/545.aspx" target="_self" title="标题：关于5年内青年教师上交教案、听课记录本的通知&#xD;点击数：489&#xD;发表时间：09年11月11日">关于5年内青年教师上交教案、听课记录本的通知</a>[ 11-11 ]</div>
                        </div>
                    </div>
