...
<head>
    ...
    <title>关于学校信息管理系统完善的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于学校信息管理系统完善的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月14日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=271"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:271},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=271";
...
<DIV><FONT size=3>学校信息管理系统已经升级，请班主任督促本班学生进入管理系统中完善自己信息，其中包括：学生基本信息和家长基本信息，班主任必须提醒学生：这是学生一生中第一次建立档案，今后将跟随学生一生，所有信息请认真、准确、完整填写，绝不容许漏填、隐瞒、伪造，否则，后果自负。在本周五前完成（9月18日），由班主任负责核查、校对。具体如下：</FONT></DIV>
<DIV><FONT size=3></FONT>&
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/263.aspx" target="_self" title="标题：关于参加全国中学生物理竞赛复赛的同学停课复习的通知&#xD;点击数：446&#xD;发表时间：09年09月14日">关于参加全国中学生物理竞赛复赛的同学停课复习的通知</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/273.aspx" target="_self" title="标题：高一拍照安排				&#xD;点击数：431&#xD;发表时间：09年09月14日">高一拍照安排				</a>[ 09-14 ]</div>
                        </div>
                    </div>
