...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2093"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2093},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2093";
           ...
           定于今天下午第四节课在行政楼五楼会议室召开教工会议,请全体教工准时参加!
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2087.aspx" target="_self" title="标题：赛事信息(学生有关）&#xD;点击数：724&#xD;发表时间：10年06月18日">赛事信息(学生有关）</a>[ 06-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2099.aspx" target="_self" title="标题：关于中层班子组建工作的通知（1）&#xD;点击数：752&#xD;发表时间：10年06月21日">关于中层班子组建工作的通知（1）</a>[ 06-21 ]</div>
                        </div>
                    </div>
