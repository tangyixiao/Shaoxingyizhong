...
<head>
    ...
    <title>10月5日高三上课安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7393"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7393},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7393";
     ...
     <FONT size=4>10月5日高三年级按周四课表上课，上午按课表上四节课，答疑课取消。上午作息时间按临时作息时间，具体作息时间安排如下：第一节  8:10—8:50，第二节  9:00—9:40，第三节  9:50—10:30，第四节  10:40—11:20。下午按正常作息时间上课。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7388.aspx" target="_self" title="标题：美术教研活动通知&#xD;点击数：132&#xD;发表时间：17年09月28日">美术教研活动通知</a>[ 09-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7394.aspx" target="_self" title="标题：高一学生参加讲座调课安排&#xD;点击数：142&#xD;发表时间：17年09月29日">高一学生参加讲座调课安排</a>[ 09-29 ]</div>
                        </div>
                    </div>
