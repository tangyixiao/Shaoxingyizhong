...
<head>
    ...
    <title>失物招领（红色水杯）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20714"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20714},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20714";
     ...
     <p style="white-space: normal;">       12月14日 上周六，高二（5）班同学在文艺汇演报告厅看台上拾到一个红色adidas水杯，请失主到德育处认领，谢谢!</p><p style="white-space: normal;">
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20712.aspx" target="_self" title="标题：寻物启事（U盘）&#xD;点击数：61&#xD;发表时间：24年12月13日">寻物启事（U盘）</a>[ 12-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20715.aspx" target="_self" title="标题：高一、高二大扫除通知&#xD;点击数：49&#xD;发表时间：24年12月16日">高一、高二大扫除通知</a>[ 12-16 ]</div>
                        </div>
                    </div>
