...
<head>
    ...
    <title>语文组教研活动通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">语文组教研活动通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：关于语文组教研活动的通知</span> <span>发布时间：2024年11月08日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20499"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20499},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20499";
     ...
     <p><span style=";font-family:'Times New Roman';font-size:21px"><span style="font-family:仿宋_GB2312"><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: large; text-wrap-mode: wrap; background-color: rgb(255, 255, 255);">      下周一（11.11)，语文组全体老师外出参加教研活动，相关班级语文课改自修。</span></span></span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20496.aspx" target="_self" title="标题：绍兴市学科带头人校内评审推荐结果公示&#xD;点击数：257&#xD;发表时间：24年11月06日">绍兴市学科带头人校内评审推荐结果公示</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20505.aspx" target="_self" title="标题：关于高三数学教研活动的通知&#xD;点击数：114&#xD;发表时间：24年11月11日">关于高三数学教研活动的通知</a>[ 11-11 ]</div>
                        </div>
                    </div>
