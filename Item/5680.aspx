...
<head>
    ...
    <title>关于黑板报检查延期的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于黑板报检查延期的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5680"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5680},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5680";
     ...
     <P>因为学考、选考考场布置的要求，班级十月份的黑板报安排暂缓，考后再出，检查推迟到10月24日。</P>
<P> </P>
<P>                                                                                                    校团委</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5667.aspx" target="_self" title="标题：2016暑期社会实践先进个人名单公布&#xD;点击数：428&#xD;发表时间：16年10月05日">2016暑期社会实践先进个人名单公布</a>[ 10-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5711.aspx" target="_self" title="标题：公示及通知&#xD;点击数：419&#xD;发表时间：16年10月12日">公示及通知</a>[ 10-12 ]</div>
                        </div>
                    </div>
