...
<head>
    ...
    <title>高三第三节政治、信息技术走班课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三第三节政治、信息技术走班课改自修通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9364"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9364},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9364";
     ...
     <FONT size=4>因新教师面试须要，今天上午高三第三节政治、信息技术走班课改自修，</FONT>相关同学在相应走班教室自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9363.aspx" target="_self" title="标题：信息技术课改自修通知&#xD;点击数：164&#xD;发表时间：18年11月19日">信息技术课改自修通知</a>[ 11-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9366.aspx" target="_self" title="标题：召开高一高二期中质量分析会的通知&#xD;点击数：463&#xD;发表时间：18年11月19日">召开高一高二期中质量分析会的通知</a>[ 11-19 ]</div>
                        </div>
                    </div>
