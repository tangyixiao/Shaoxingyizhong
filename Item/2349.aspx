...
<head>
    ...
    <title>关于高一眼保健操的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2349"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2349},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2349";
...
<P><FONT size=4>   新版眼保健操视频放在校公共文件夹德育处内，请各班主任下载并组织班级学生学习。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2347.aspx" target="_self" title="标题：关于上交贫困生申请表的通知（急）&#xD;点击数：274&#xD;发表时间：10年09月03日">关于上交贫困生申请表的通知（急）</a>[ 09-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2350.aspx" target="_self" title="标题：高一衔接教育补考地点有变动&#xD;点击数：340&#xD;发表时间：10年09月03日">高一衔接教育补考地点有变动</a>[ 09-03 ]</div>
                        </div>
                    </div>
