...
<head>
    ...
    <title>高二化学教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8514"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8514},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8514";
     ...
     <FONT size=4>5月10日下午～11日（周四下午～周五），高二化学老师外出教研活动，化学课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8510.aspx" target="_self" title="标题：高三五校联考工作安排&#xD;点击数：1055&#xD;发表时间：18年05月09日">高三五校联考工作安排</a>[ 05-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8515.aspx" target="_self" title="标题：数学教研活动通知&#xD;点击数：284&#xD;发表时间：18年05月09日">数学教研活动通知</a>[ 05-09 ]</div>
                        </div>
                    </div>
