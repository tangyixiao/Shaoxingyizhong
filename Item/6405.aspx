...
<head>
    ...
    <title>晨检表报送恢复正常通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6405"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6405},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6405";
     ...
     从本周开始，晨检表报送恢复正常。计入班级安全考核。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6374.aspx" target="_self" title="标题：校园有序停车通知&#xD;点击数：191&#xD;发表时间：17年02月08日">校园有序停车通知</a>[ 02-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6406.aspx" target="_self" title="标题：晚间安全检查记录2017.2.13&#xD;点击数：55&#xD;发表时间：17年02月14日">晚间安全检查记录2017.2.13</a>[ 02-14 ]</div>
                        </div>
                    </div>
