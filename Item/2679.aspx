...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2679"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2679},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2679";
...
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><FONT size=3><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">    请高一高二各班班长于今天(星期三)中午</SPAN><SPAN lang=EN-US>12:20</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">到实南</SPAN><SPAN lang=EN-US>205</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">开会，布置运动会期间有关纪律检查方面的事宜。请相互转告，勿迟到。</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2672.aspx" target="_self" title="标题：第二期黑板报检查成绩公布：&#xD;点击数：454&#xD;发表时间：10年10月19日">第二期黑板报检查成绩公布：</a>[ 10-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2760.aspx" target="_self" title="标题：第十七期课余党校开课通知（上课地点有变动&amp;nbsp;）&#xD;点击数：719&#xD;发表时间：10年11月01日">第十七期课余党校开课通知（上课地点有变动 ）</a>[ 11-01 ]</div>
                        </div>
                    </div>
