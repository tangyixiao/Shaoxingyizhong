...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9390"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9390},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9390";
     ...
     <FONT size=4> 今天王冰洁阮国华带队参加乒乓球比赛，相关班级体育课暂停。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9389.aspx" target="_self" title="标题：音乐教研活动通知&#xD;点击数：214&#xD;发表时间：18年11月23日">音乐教研活动通知</a>[ 11-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9398.aspx" target="_self" title="标题：高三期中考试安排（有修改）&#xD;点击数：1281&#xD;发表时间：18年11月24日">高三期中考试安排（有修改）</a>[ 11-24 ]</div>
                        </div>
                    </div>
