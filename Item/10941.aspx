...
<head>
    ...
    <title>本周六高三物理历史限时训练时间和座位安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">本周六高三物理历史限时训练时间和座位安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10941"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10941},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10941";
     ...
     <P>物理限时训练时间13:30-15:00</P>
<P><A title=物理座位表 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201911/2019112915120291.xls">物理座位表</A></P>
<P>历史限时训练时间15:15-16:45</P>
<P><A title=历史座位表 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201911/2019112915130845.xls">历史座位表</A></P>
<P>未安排到座位的考生，请坐在尾数试场。物理为3106，历史为2110。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10936.aspx" target="_self" title="标题：数学教研活动通知&#xD;点击数：320&#xD;发表时间：19年11月28日">数学教研活动通知</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10943.aspx" target="_self" title="标题：高三学生参加物理讲座通知&#xD;点击数：357&#xD;发表时间：19年11月30日">高三学生参加物理讲座通知</a>[ 11-30 ]</div>
                        </div>
                    </div>
