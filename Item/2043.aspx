...
<head>
    ...
    <title>今天下午第三节课进行会考考务培训--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天下午第三节课进行会考考务培训</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2043"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2043},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2043";
     ...
     今天（13日）下午第三节课在行政5 楼会议室进行会考考务培训，希有关工作人员、高一、高二班主任和监考老师准时参加。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2040.aspx" target="_self" title="标题：关于高一年级校本课程停上的通知&#xD;点击数：310&#xD;发表时间：10年06月12日">关于高一年级校本课程停上的通知</a>[ 06-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2044.aspx" target="_self" title="标题：关于全市2010年教师自制多媒体教育软件评比活动的通知&#xD;点击数：309&#xD;发表时间：10年06月13日">关于全市2010年教师自制多媒体教育软件评比活动的通知</a>[ 06-13 ]</div>
                        </div>
                    </div>
