...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3575"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3575},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3575";
     ...
     <P>                                 文明办公室检查</P>
<P>    为迎接全国文明城市检查和参加学校信息学大会的老师和同学(明天开始报到),今天下午第三节课进行文明办公室检查,请各处室认真打扫,资料堆放整齐.</P>
<P>    请各年级今天白天值班的老师下午第三节课到德育处集中.</P>
<P>                                                        校文明办公室检查小组</P>
<P>                                                             2011.3.22</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3516.aspx" target="_self" title="标题：工会锻炼通知&#xD;点击数：600&#xD;发表时间：11年03月15日">工会锻炼通知</a>[ 03-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3601.aspx" target="_self" title="标题：工会公告&#xD;点击数：551&#xD;发表时间：11年03月26日">工会公告</a>[ 03-26 ]</div>
                        </div>
                    </div>
