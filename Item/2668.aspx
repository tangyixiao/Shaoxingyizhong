...
<head>
    ...
    <title>关于高一高二大扫除的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一高二大扫除的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2668"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2668},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2668";
...
<P> </P>
<P>高一高二各班：</P>
<P>    今天下午第四节课大扫除正常进行，重点是包干区卫生和教室内学生课桌下个人物品的整理（个别学生课桌下书本凌乱、杂物较多）。</P></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2667.aspx" target="_self" title="标题：提醒&#xD;点击数：613&#xD;发表时间：10年10月18日">提醒</a>[ 10-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2673.aspx" target="_self" title="标题：值周检查及大扫除情况汇总&#xD;点击数：367&#xD;发表时间：10年10月19日">值周检查及大扫除情况汇总</a>[ 10-19 ]</div>
                        </div>
                    </div>
