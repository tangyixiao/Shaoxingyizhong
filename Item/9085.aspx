...
<head>
    ...
    <title>关于我校“自动体外除颤器（AED）”使用说明--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于我校“自动体外除颤器（AED）”使用说明</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9085"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9085},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9085";
     ...
     <P>2018年9月18日，绍兴市红十字会在我校成功安装“自动体外除颤器（AED）”。<STRONG>安装地点在体育馆一楼，医务室对面</STRONG>。AED是用于抢救快速性心律失常所致心源性猝死的常用设备，是心源性猝死现场救生的“救命神器”。心脏骤停4分钟内是挽救生命的黄金时间。在公共场所配置除颤仪器，可以极大地提升心源性猝死复活的几率，为学校师生提供更好的生命安全保障。</P>
<P> </P>
<P><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201809/2018091909094416.jpg" target=_blank><IMG onload=resizepic(this) style="HEIGHT: 649px; WIDTH: 585px" onmousewheel="return bbimg(this)" border=0 src="/Shaoxingyizhong/UploadFiles/UploadFiles/201809/2018091909094416.jpg" width=2329 height=1767> </A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9043.aspx" target="_self" title="标题：2019年度越城区在校学生城乡居民基本医疗保险参保缴费通知&#xD;点击数：194&#xD;发表时间：18年09月13日">2019年度越城区在校学生城乡居民基本医疗保险参保缴费通知</a>[ 09-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9162.aspx" target="_self" title="标题：请高三同学明天（30号）中午12:30分到实验楼机房完成安全平台作业&#xD;点击数：471&#xD;发表时间：18年09月29日">请高三同学明天（30号）中午12:30分到实验楼机房完成安全平台…</a>[ 09-29 ]</div>
                        </div>
                    </div>
