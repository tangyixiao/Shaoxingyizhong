...
<head>
    ...
    <title>关于上传职称证书的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9264"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9264},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9264";
     ...
     <!--StartFragment -->
<DIV>各位教工：<BR>     根据2018年教育事业统计工作的要求，学校需要全体在编教工提供当前职务资格的电子证书作为数据佐证材料。请教工于本周三前，将本人的职称证书电子版上传到 校办-“职称证书”相应的学科组下面，纸质证书扫描或者翻拍成彩色JPG文件，注意保证证书图片完整清晰，并命名为“职称级别-姓名”（如：高级-张三）。<BR></DIV>
<DIV>                                                                                       党政办                  </DIV>
<DIV>                                                                                2018年10月29日</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9250.aspx" target="_self" title="标题：教工大会通知（有修改）&#xD;点击数：2583&#xD;发表时间：18年10月24日">教工大会通知（有修改）</a>[ 10-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9277.aspx" target="_self" title="标题：2018年正高级教师职称评审推荐工作通知&#xD;点击数：233&#xD;发表时间：18年10月30日">2018年正高级教师职称评审推荐工作通知</a>[ 10-30 ]</div>
                        </div>
                    </div>
