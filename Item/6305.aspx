...
<head>
    ...
    <title>关于“主任助理”组长开会的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于“主任助理”组长开会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6305"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6305},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6305";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 28pt; mso-char-indent-count: 2.0"><SPAN style="FONT-SIZE: 14pt; FONT-FAMILY: 宋体">请下列同学于今天下午第<SPAN lang=EN-US>4</SPAN>节课（<SPAN lang=EN-US>16</SPAN>：<SPAN lang=EN-US>15</SPAN>）到德育处开会：</SPAN></P>
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 28pt; mso-char-indent-count: 2.0"><SPAN style="FONT-SIZE: 14pt; FONT-FAMILY: 宋体">二（8）夏杉杉、二（1）宋惠琳、二（3）吕逸天、一（15）宋芷盈。</SPAN><SPAN style="FONT-SIZE: 14pt; FONT-FAMILY: 宋体">请随带纸笔！</SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6296.aspx" target="_self" title="标题：信息学冬令营文艺节目成员开会通知&#xD;点击数：397&#xD;发表时间：17年01月09日">信息学冬令营文艺节目成员开会通知</a>[ 01-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6307.aspx" target="_self" title="标题：关于期末考试考风考纪要求&#xD;点击数：312&#xD;发表时间：17年01月10日">关于期末考试考风考纪要求</a>[ 01-10 ]</div>
                        </div>
                    </div>
