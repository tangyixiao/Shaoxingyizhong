...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=380"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:380},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=380";
...
<P class=MsoNormal><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: ''Times New Roman''; mso-hansi-font-family: ''Times New Roman''"><FONT size=3>     在升旗仪式期间，检查发现下列班级门窗未关，存在安全隐患，特此通报！</FONT></SPAN></P>
<P class=MsoNormal><
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/355.aspx" target="_self" title="标题：关于国庆放假期间做好信息上报工作的通知&#xD;点击数：349&#xD;发表时间：09年09月30日">关于国庆放假期间做好信息上报工作的通知</a>[ 09-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/391.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.9.27-10.10）&#xD;点击数：271&#xD;发表时间：09年10月13日">绍兴一中校园晚间安全检查公告(2009.9.27-10.10）</a>[ 10-13 ]</div>
                        </div>
                    </div>
