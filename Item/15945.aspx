...
<head>
    ...
    <title>心理研讨通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">心理研讨通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2019年04月17日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15945"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15945},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15945";
     ...
     <p style="white-space: normal;">明天（4月18日）下午第九节课在行政楼三楼会议室三进行高二年级应对压力主题心理课程研讨，请心理b证教师准时参加，欢迎高二年段班主任莅临指导。</p><p>
</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15944.aspx" target="_self" title="标题：心理课研讨通知&#xD;点击数：308&#xD;发表时间：19年03月18日">心理课研讨通知</a>[ 03-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15946.aspx" target="_self" title="标题：心理课研讨通知&#xD;点击数：303&#xD;发表时间：19年05月16日">心理课研讨通知</a>[ 05-16 ]</div>
                        </div>
                    </div>
