...
<head>
    ...
    <title>全校班长会议通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11549"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11549},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11549";
     ...
     <P>高一、高二、高三、素养班各班班长：</P>
<P>定于今天中午12:25到图书馆一楼教工阅览室开个短会，请准时参加。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11523.aspx" target="_self" title="标题：职初教师参加专业测试的通知&#xD;点击数：321&#xD;发表时间：20年06月10日">职初教师参加专业测试的通知</a>[ 06-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11606.aspx" target="_self" title="标题：关于教师积极利用之江汇教育广场的通知&#xD;点击数：398&#xD;发表时间：20年06月30日">关于教师积极利用之江汇教育广场的通知</a>[ 06-30 ]</div>
                        </div>
                    </div>
