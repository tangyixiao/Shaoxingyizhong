...
<head>
    ...
    <title>关于英语沙龙开会通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6039"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6039},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6039";
     ...
     <P>请各位新录取的高一英语沙龙成员于本周五12:30至实南205参加新人会议，带上纸笔，请准时参加。希相互转告。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6038.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：85&#xD;发表时间：16年12月01日">表扬与失物招领</a>[ 12-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6042.aspx" target="_self" title="标题：表扬&#xD;点击数：134&#xD;发表时间：16年12月02日">表扬</a>[ 12-02 ]</div>
                        </div>
                    </div>
