...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=23049"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23049},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23049";
     ...
     <article><span style="font-size: 18px;">本周五政治组外出参加教研活动，相关班级政治课改自修。</span></article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/23047.aspx" target="_self" title="标题：数学教研活动通知&#xD;点击数：145&#xD;发表时间：26年04月15日">数学教研活动通知</a>[ 04-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/23055.aspx" target="_self" title="标题：高三图书停借及还书通知&#xD;点击数：95&#xD;发表时间：26年04月16日">高三图书停借及还书通知</a>[ 04-16 ]</div>
                        </div>
                    </div>
