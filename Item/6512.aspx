...
<head>
    ...
    <title>关于上交学科特色课程群各门课程框架的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于上交学科特色课程群各门课程框架的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>关于上交学科特色课程群各门课程框架的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年03月06日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6512"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6512},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6512";
     ...
     <P>根据学校特色课程群建设相关安排，请各位课程负责人于3月10日前填好本课程的课程框架（见附件），以负责人姓名+课程名称命名，并上传学校公共文件夹“课程处—2017学科特色课程群建设”按照学科放入相应文件夹下。</P>
<P>附件：<A title=课程框架模板 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201703/2017030614593417.doc">课程框架模板</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6498.aspx" target="_self" title="标题：绍兴市教育教学研究院2017年3月份市直活动安排&#xD;点击数：311&#xD;发表时间：17年03月02日">绍兴市教育教学研究院2017年3月份市直活动安排</a>[ 03-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6541.aspx" target="_self" title="标题：转发绍兴市2017年中小学生研究性学习活动成果评比的通知&#xD;点击数：178&#xD;发表时间：17年03月10日">转发绍兴市2017年中小学生研究性学习活动成果评比的通知</a>[ 03-10 ]</div>
                        </div>
                    </div>
