...
<head>
    ...
    <title>晚间安全检查记录2016.9.24--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2016.9.24</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5598"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5598},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5598";
     ...
     <P>高二（1）班教室门，窗户,灯和吊扇都未关;</P>
<P>高二（2）班和高二（4）班教室门，窗户和灯都未关;</P>
<P>高二（3）班窗户未关;</P>
<P>实南301室门未关;</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5546.aspx" target="_self" title="标题：2016学年第一学期安全教育平台工作启动&#xD;点击数：338&#xD;发表时间：16年09月19日">2016学年第一学期安全教育平台工作启动</a>[ 09-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5599.aspx" target="_self" title="标题：全校安全委员开会通知&#xD;点击数：126&#xD;发表时间：16年09月26日">全校安全委员开会通知</a>[ 09-26 ]</div>
                        </div>
                    </div>
