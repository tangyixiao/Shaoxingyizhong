...
<head>
    ...
    <title>周三、周五体育课暂停相关通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">周三、周五体育课暂停相关通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12966"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12966},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12966";
     ...
     <p>1、周三因视力检测须要，高一体育课暂停。</p><p>2、周五因市直羽毛球比赛在我校举行，高一、高三体育课暂停，改自修。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12952.aspx" target="_self" title="标题：市直羽毛球比赛通知&#xD;点击数：269&#xD;发表时间：21年03月23日">市直羽毛球比赛通知</a>[ 03-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12969.aspx" target="_self" title="标题：物理教研活动通知&#xD;点击数：212&#xD;发表时间：21年03月24日">物理教研活动通知</a>[ 03-24 ]</div>
                        </div>
                    </div>
