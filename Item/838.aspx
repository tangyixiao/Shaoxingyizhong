...
<head>
    ...
    <title>关于接种麻疹疫苗的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=838"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:838},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=838";
     ...
     <FONT color=#000000><FONT size=4>       今天下午13：00开始接种麻疹疫苗，按照班级序号顺序进行，请各班主任组织好。因此可能会占用到部分班级课堂时间，请各任课老师自行安排。</FONT> </FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/836.aspx" target="_self" title="标题：麻疹疫苗接种注意事项&#xD;点击数：249&#xD;发表时间：09年12月03日">麻疹疫苗接种注意事项</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/843.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.11.22-11.28）&#xD;点击数：247&#xD;发表时间：09年12月03日">绍兴一中校园晚间安全检查公告(2009.11.22-11.28）</a>[ 12-03 ]</div>
                        </div>
                    </div>
