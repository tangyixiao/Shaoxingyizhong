...
<head>
    ...
    <title>欢迎老师办中国农业银行喜洋洋卡--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">欢迎老师办中国农业银行喜洋洋卡</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月11日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=257"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:257},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=257";
     ...
     <DIV align=center><B>通</B><B>   </B><B>知</B><B></B></DIV>
<DIV><B>各位老师：</B><B></B></DIV>
<DIV><B>现有来自中国农业银行绍兴市城西支行的工作人员于</B><B>9</B><B>月</B><B>18</B><B>日（星期五）中午</B><B>11</B><B>点至</B><B>13</B><B>点在我校食堂门口办理农行喜洋洋卡和农行公务卡，欢迎各位老师前来办理。</B><B></B></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/236.aspx" target="_self" title="标题：9月10日教师节晚餐安排&#xD;点击数：514&#xD;发表时间：09年09月10日">9月10日教师节晚餐安排</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/267.aspx" target="_self" title="标题：关于《教育中的心理效应》考试的通知&#xD;点击数：553&#xD;发表时间：09年09月14日">关于《教育中的心理效应》考试的通知</a>[ 09-14 ]</div>
                        </div>
                    </div>
