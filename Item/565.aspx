...
<head>
    ...
    <title>自信带来从容--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=565"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:565},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=565";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/564.aspx" target="_self" title="标题：斐然的成绩非偶然,教学的理念很关键&#xD;点击数：437&#xD;发表时间：09年11月13日">斐然的成绩非偶然,教学的理念很关键</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/566.aspx" target="_self" title="标题：高中女生捡包后　烈日下苦等失主&#xD;点击数：393&#xD;发表时间：09年11月13日">高中女生捡包后　烈日下苦等失主</a>[ 11-13 ]</div>
                        </div>
                    </div>
