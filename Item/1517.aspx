...
<head>
    ...
    <title>高三班主任会议（地址&amp;nbsp;改在实南楼203）--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三班主任会议（地址&amp;nbsp;改在实南楼203）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1517"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1517},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1517";
     ...
     <P><FONT size=3>    定于今天(3月23日)下午第四节课在教学楼Ⅱ 209室改在<FONT color=#ff0000>实南楼203</FONT>召开高三班主任会议。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1509.aspx" target="_self" title="标题：高三自选综合成绩登录&#xD;点击数：771&#xD;发表时间：10年03月22日">高三自选综合成绩登录</a>[ 03-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1524.aspx" target="_self" title="标题：《冲刺高考决胜未来》励志演讲会安排&#xD;点击数：1338&#xD;发表时间：10年03月24日">《冲刺高考决胜未来》励志演讲会安排</a>[ 03-24 ]</div>
                        </div>
                    </div>
