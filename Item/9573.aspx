...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9573"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9573},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9573";
     ...
     <FONT size=4>12月26日（周三）下午地理组全体教师外出参加教研活动，相关班级地理课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9558.aspx" target="_self" title="标题：高三语文复习讲座&#xD;点击数：312&#xD;发表时间：18年12月22日">高三语文复习讲座</a>[ 12-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9579.aspx" target="_self" title="标题：部分课程改自修的通知&#xD;点击数：445&#xD;发表时间：18年12月26日">部分课程改自修的通知</a>[ 12-26 ]</div>
                        </div>
                    </div>
