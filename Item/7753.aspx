...
<head>
    ...
    <title>教工宿舍安全提醒--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">教工宿舍安全提醒</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：安全处</span> <span>发布时间：2017年12月06日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7753"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7753},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7753";
     ...
     <P><FONT size=4>全校教工：</FONT></P>
<P><FONT size=4>    近期发现因部分教工宿舍门没有锁，导致经常有外来人员随意进出房间，随意使用宿舍内设施设备，存在重大的安全隐患。在此，我们提醒广大教工，人不在宿舍时，宿舍门务必锁住，并且房间内不要存放贵重物品。今天，总务处将派人把所有教工宿舍门都锁起来，请大家知晓。</FONT></P>
<P><FONT size=4>    谢谢大家配合！</FONT></P>
<P><FONT size=4>安全处<BR></FONT><FONT size=4>2017.12.6</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7736.aspx" target="_self" title="标题：转发：关于组织开展绍兴市中小学生（幼儿）2017年“122交通安全教育”专题活动的通知&#xD;点击数：173&#xD;发表时间：17年12月04日">转发：关于组织开展绍兴市中小学生（幼儿）2017年“122交通安…</a>[ 12-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7786.aspx" target="_self" title="标题：高一各班安全委员通知&#xD;点击数：129&#xD;发表时间：17年12月13日">高一各班安全委员通知</a>[ 12-13 ]</div>
                        </div>
                    </div>
