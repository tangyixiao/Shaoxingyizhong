...
<head>
    ...
    <title>叶军，成功“顺时针”--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5147"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5147},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5147";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5145.aspx" target="_self" title="标题：名家书画进校园翰墨飘香润心田&#xD;点击数：256&#xD;发表时间：15年10月09日">名家书画进校园翰墨飘香润心田</a>[ 10-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5148.aspx" target="_self" title="标题：名家书画进校园翰墨飘香润心田&#xD;点击数：311&#xD;发表时间：15年10月10日">名家书画进校园翰墨飘香润心田</a>[ 10-10 ]</div>
                        </div>
                    </div>
