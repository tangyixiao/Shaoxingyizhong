...
<head>
    ...
    <title>“国庆瞬间 永恒中国”摄影比赛评选结果--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">“国庆瞬间 永恒中国”摄影比赛评选结果</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年10月19日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=416"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:416},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=416";
     ...
     <DIV>     <FONT size=3>本次摄影比赛在高一、高二各团支部的积极响应与参与下，共收到作品119件。经过专业老师的评审，下列同学的作品分获一、二、三等奖，近日将在宣传窗中展出。另有四个团支部荣获优秀组织奖，在此给予表扬。</FONT></DIV>
<TABLE cellSpacing=0 cellPadding=0 width=472 border=1>
<TBODY>
<TR>
...
<DIV align
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/401.aspx" target="_self" title="标题：关于高一、高二文艺委员会议通知&#xD;点击数：408&#xD;发表时间：09年10月14日">关于高一、高二文艺委员会议通知</a>[ 10-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/424.aspx" target="_self" title="标题：第三期黑板报成绩公布&#xD;点击数：276&#xD;发表时间：09年10月19日">第三期黑板报成绩公布</a>[ 10-19 ]</div>
                        </div>
                    </div>
