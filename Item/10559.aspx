...
<head>
    ...
    <title>关于召开部分高一、高二、高三学生召开座谈会的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于召开部分高一、高二、高三学生召开座谈会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10559"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10559},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10559";
     ...
     <P>             关于召开部分高一、高二、高三学生召开座谈会的通知</P>
<P>    今天市教育教学研究院来我校开展教学调研工作，请各班学号为7号和24号的同学今天中午12:30到亚泉楼四楼计算机房（随带笔）召开座谈交流，同学间相互转告，也请各班班主任老师通知到学生，按时参加，请勿迟到</P>
<P>                                                                            9.17</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10557.aspx" target="_self" title="标题：今天下午教师座谈会的通知&#xD;点击数：398&#xD;发表时间：19年09月17日">今天下午教师座谈会的通知</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10562.aspx" target="_self" title="标题：相关老师开会的通知&#xD;点击数：240&#xD;发表时间：19年09月17日">相关老师开会的通知</a>[ 09-17 ]</div>
                        </div>
                    </div>
