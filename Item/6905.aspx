...
<head>
    ...
    <title>晚间安全检查记录2017.5.4---8--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2017.5.4---8</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6905"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6905},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6905";
     ...
     5月4日高一（13）班和高一（16）班门未关。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6900.aspx" target="_self" title="标题：4月门窗不关情况统计&#xD;点击数：119&#xD;发表时间：17年05月08日">4月门窗不关情况统计</a>[ 05-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6908.aspx" target="_self" title="标题：每日晨检表未交情况通报5.9&#xD;点击数：57&#xD;发表时间：17年05月09日">每日晨检表未交情况通报5.9</a>[ 05-09 ]</div>
                        </div>
                    </div>
