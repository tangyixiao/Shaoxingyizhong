...
<head>
    ...
    <title>高考未开锣，一中传捷报--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3821"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3821},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3821";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3760.aspx" target="_self" title="标题：刘建杨“绍兴大话”走进绍兴一中&#xD;点击数：685&#xD;发表时间：11年04月20日">刘建杨“绍兴大话”走进绍兴一中</a>[ 04-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3880.aspx" target="_self" title="标题：大运会火炬点燃仪式上发言的学生代表是个绍兴人&#xD;点击数：663&#xD;发表时间：11年05月05日">大运会火炬点燃仪式上发言的学生代表是个绍兴人</a>[ 05-05 ]</div>
                        </div>
                    </div>
