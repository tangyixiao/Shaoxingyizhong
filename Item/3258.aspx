...
<head>
    ...
    <title>关于在严重冰冻天气下打扫卫生的提醒--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于在严重冰冻天气下打扫卫生的提醒</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3258"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3258},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3258";
...
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 28pt; mso-char-indent-count: 2.0"><FONT size=4><STRONG><SPAN style="FONT-SIZE: 14pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">如果气温较低出现严重冰冻，请各班主任提醒值日学生在打扫地面卫生时只需要用扫把清扫，不要用湿的拖把拖地面，以免地面结冰。</SPAN></STRONG></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3256.aspx" target="_self" title="标题：关于升旗仪式暂停的通知&#xD;点击数：388&#xD;发表时间：11年01月17日">关于升旗仪式暂停的通知</a>[ 01-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3262.aspx" target="_self" title="标题：通知&#xD;点击数：623&#xD;发表时间：11年01月18日">通知</a>[ 01-18 ]</div>
                        </div>
                    </div>
