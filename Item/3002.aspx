...
<head>
    ...
    <title>有关大扫除的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3002"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3002},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3002";
     ...
     <FONT size=4>
<P> </P>
<P>由于天气原因，室外包干区大扫除暂停，教室内要认真打扫。</P></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2999.aspx" target="_self" title="标题：批评&#xD;点击数：746&#xD;发表时间：10年12月06日">批评</a>[ 12-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3010.aspx" target="_self" title="标题：值周检查情况汇总（12月6日星期一）&#xD;点击数：368&#xD;发表时间：10年12月07日">值周检查情况汇总（12月6日星期一）</a>[ 12-07 ]</div>
                        </div>
                    </div>
