...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12258"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12258},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12258";
     ...
     <FONT size=4>本周四下午，化学组全体老师外出教研活动，化学课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12256.aspx" target="_self" title="标题：高二化学学考复习安排&#xD;点击数：321&#xD;发表时间：20年11月25日">高二化学学考复习安排</a>[ 11-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12297.aspx" target="_self" title="标题：政治教研组外出教研通知&#xD;点击数：237&#xD;发表时间：20年12月01日">政治教研组外出教研通知</a>[ 12-01 ]</div>
                        </div>
                    </div>
