...
<head>
    ...
    <title>高一、高二美术生上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二美术生上课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9801"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9801},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9801";
     ...
     <FONT size=4>所有高一、高二有意向参加美术专业考试的学生，于下周一晚6:00~8:00到行政楼四楼美术教室2集中上课。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9794.aspx" target="_self" title="标题：高一、高二美术生会议通知&#xD;点击数：251&#xD;发表时间：19年02月28日">高一、高二美术生会议通知</a>[ 02-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9819.aspx" target="_self" title="标题：高二通用技术走班开始及相关调整通知&#xD;点击数：224&#xD;发表时间：19年03月05日">高二通用技术走班开始及相关调整通知</a>[ 03-05 ]</div>
                        </div>
                    </div>
