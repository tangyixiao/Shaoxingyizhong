...
<head>
    ...
    <title>关于温馨教室评比的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2434"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2434},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2434";
...
<P><FONT size=4>    德育处将于9月16日（周四）中午对各班进行温馨教室评比检查，请各班早作准备。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2433.aspx" target="_self" title="标题：师徒结对&#xD;点击数：539&#xD;发表时间：10年09月12日">师徒结对</a>[ 09-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2436.aspx" target="_self" title="标题：重发关于高一高二高三学生信息录入的通知（急）&#xD;点击数：358&#xD;发表时间：10年09月08日">重发关于高一高二高三学生信息录入的通知（急）</a>[ 09-08 ]</div>
                        </div>
                    </div>
