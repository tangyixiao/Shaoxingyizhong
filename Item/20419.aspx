...
<head>
    ...
    <title>关于部分学科组及后勤教师外出培训的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于部分学科组及后勤教师外出培训的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2024年10月22日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20419"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20419},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20419";
     ...
     <p>        <span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 18.6667px; text-wrap-mode: wrap; background-color: rgb(255, 255, 255);">本周四（10.24）中午至周六（10.26）下午，政治组、地理组、艺术组、实验室、图书馆、医务室的大部分教师将外出参加培训。相应班级的课改自修，请相关班主任予以关注。具体请外出的老师与相关班主任沟通、对接好，谢谢。</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20406.aspx" target="_self" title="标题：心理老师教研活动通知&#xD;点击数：118&#xD;发表时间：24年10月21日">心理老师教研活动通知</a>[ 10-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20448.aspx" target="_self" title="标题：关于2024年下半年心理C证新证申报工作&#xD;点击数：132&#xD;发表时间：24年10月29日">关于2024年下半年心理C证新证申报工作</a>[ 10-29 ]</div>
                        </div>
                    </div>
