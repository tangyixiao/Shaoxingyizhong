...
<head>
    ...
    <title>关于大合唱比赛延期举行的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于大合唱比赛延期举行的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年09月21日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=303"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:303},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=303";
     ...
     <DIV><FONT size=4>    近期H1N1流感多发，根据绍兴市疾病控制中心的有关要求，我校大合唱比赛延期举行，具体时间请关注校园网通知。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/293.aspx" target="_self" title="标题：关于学生会主席竞选的通知（高一、高二各班班长请注意）&#xD;点击数：380&#xD;发表时间：09年09月17日">关于学生会主席竞选的通知（高一、高二各班班长请注意）</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/316.aspx" target="_self" title="标题：高一、高二班长注意&#xD;点击数：441&#xD;发表时间：09年09月23日">高一、高二班长注意</a>[ 09-23 ]</div>
                        </div>
                    </div>
