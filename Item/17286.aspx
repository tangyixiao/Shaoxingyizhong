...
<head>
    ...
    <title>寻物启事（现金若干）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17286"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17286},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17286";
     ...
     <p>2.13风雨走廊有同学丢失钱财若干，请遗失者来德育处领取</p><p>
</p><p>表扬高二（1）班何芊同学拾金不昧！</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17284.aspx" target="_self" title="标题：2.13班级一日考核&#xD;点击数：64&#xD;发表时间：23年02月14日">2.13班级一日考核</a>[ 02-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17291.aspx" target="_self" title="标题：高一大扫除通知&#xD;点击数：31&#xD;发表时间：23年02月14日">高一大扫除通知</a>[ 02-14 ]</div>
                        </div>
                    </div>
