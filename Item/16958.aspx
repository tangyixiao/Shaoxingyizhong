...
<head>
    ...
    <title>音乐、美术、生物教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">音乐、美术、生物教研活动通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16958"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16958},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16958";
     ...
     <p>12月2日（周五）音乐组、美术组、生物组老师外出参加教研活动，相关课程改自修，生物走班学生在上课教室自修。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16932.aspx" target="_self" title="标题：语文组参加教研活动通知&#xD;点击数：235&#xD;发表时间：22年11月28日">语文组参加教研活动通知</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16987.aspx" target="_self" title="标题：高一年级调课通知&#xD;点击数：290&#xD;发表时间：22年12月07日">高一年级调课通知</a>[ 12-07 ]</div>
                        </div>
                    </div>
