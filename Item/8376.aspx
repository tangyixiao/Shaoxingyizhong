...
<head>
    ...
    <title>高三语文教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8376"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8376},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8376";
     ...
     <FONT size=4>明天（周三）高三语文组全体老师外出参加教研活动，相关班级语文课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8375.aspx" target="_self" title="标题：英语教研活动通知&#xD;点击数：346&#xD;发表时间：18年04月17日">英语教研活动通知</a>[ 04-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8377.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：209&#xD;发表时间：18年04月17日">化学教研活动通知</a>[ 04-17 ]</div>
                        </div>
                    </div>
