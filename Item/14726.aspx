...
<head>
    ...
    <title>大课间改做室内操通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14726"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14726},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14726";
     ...
     <p>因疫情防控需要本周起大课间跑操改做室内操，请各班在第二节下课后播放并认真做本班相应的大课间室内操，值周班将对各班室内操情况进行检查和反馈。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14725.aspx" target="_self" title="标题：寻物启事和失物招领各一则&#xD;点击数：150&#xD;发表时间：21年12月21日">寻物启事和失物招领各一则</a>[ 12-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14727.aspx" target="_self" title="标题：12.20班级一日考核&#xD;点击数：50&#xD;发表时间：21年12月21日">12.20班级一日考核</a>[ 12-21 ]</div>
                        </div>
                    </div>
