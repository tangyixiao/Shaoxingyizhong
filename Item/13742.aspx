...
<head>
    ...
    <title>地点更改：学霸学习方法论讲座地点更改通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">地点更改：学霸学习方法论讲座地点更改通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13742"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13742},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13742";
     ...
     <p>由于场地冲突，今天中午的造神计划学霸学习方法论分享讲座地点更改至行政楼三楼会议室四。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13725.aspx" target="_self" title="标题：2021暑期社会实践&#xD;点击数：253&#xD;发表时间：21年07月04日">2021暑期社会实践</a>[ 07-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13816.aspx" target="_self" title="标题：暑期社会实践学分认定、交流评比通知&#xD;点击数：315&#xD;发表时间：21年08月31日">暑期社会实践学分认定、交流评比通知</a>[ 08-31 ]</div>
                        </div>
                    </div>
