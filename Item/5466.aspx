...
<head>
    ...
    <title>汽车进出校门温馨提醒--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5466"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5466},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5466";
     ...
     <P>各位教职员工，学校智能门禁系统(汽车道闸)已安装完毕，现试运行。早先已登记过车牌的汽车，只要按进、出车道缓慢行驶，道闸会自动打开，打开一次只能通过一辆车，注意不要跟车很近，以防道闸自动下降时伤及车辆。自行车电动车行人通行从旁边小门走。</P>
<P>汽车进校后请缓慢行驶，停放到规定停车区域，不要随意停放，也不要进入教学区域。</P>
<P>良好的环境需要你我一同创造和维护，谢谢大家的配合和支持!</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5457.aspx" target="_self" title="标题：安全教育平台暑假专项作业未完成名单(最新)&#xD;点击数：248&#xD;发表时间：16年09月06日">安全教育平台暑假专项作业未完成名单(最新)</a>[ 09-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5484.aspx" target="_self" title="标题：晚间安全检查记录2016.9.6---8&#xD;点击数：90&#xD;发表时间：16年09月10日">晚间安全检查记录2016.9.6---8</a>[ 09-10 ]</div>
                        </div>
                    </div>
