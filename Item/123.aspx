...
<head>
    ...
    <title>各班主任请注意（关于安全等问题）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班主任请注意（关于安全等问题）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年08月20日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=123"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:123},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=123";
     ...
     <P>各班主任：</P>
<P>请提醒本班学生注意：1、家长接送车不要停在正门口，一律停在西大门，以免影响交通；2、做好安全防患工作，自行车及时上锁，人走关好门窗；3、讲究节约用电，及时关闭电源。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/121.aspx" target="_self" title="标题：中华赞诗词歌赋创作大赛&#xD;点击数：692&#xD;发表时间：09年08月19日">中华赞诗词歌赋创作大赛</a>[ 08-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/127.aspx" target="_self" title="标题：高一、高三各班班长会议&#xD;点击数：539&#xD;发表时间：09年08月21日">高一、高三各班班长会议</a>[ 08-21 ]</div>
                        </div>
                    </div>
