...
<head>
    ...
    <title>高水平大学“三位一体”综合评价招生确认通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高水平大学“三位一体”综合评价招生确认通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7030"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7030},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7030";
     ...
     根据《2017年浙江省普通高校招生工作实施意见》，<SPAN style="FONT-FAMILY: 宋体"><FONT size=3>北京大学、清华大学、复旦大学、上海交通大学、浙江大学、中国科学技术大学、中国科学院大学“三位一体”综合评价招生在<SPAN lang=EN-US>6</SPAN>月<SPAN lang=EN-US>25</SPAN>日前完成录取工作，被录取的考生不再参加后续的志愿填报和录取。报考上述高校的考生，须在<SPAN lang=EN-US>5</SPAN>月<SPAN lang=EN-US>27</SPAN>日登陆浙江省教育考试院<SPAN lang=EN-US>“</SPAN>浙江省高校招生考试信息管理系统<SPAN lang=EN-US>”</SPAN>，网上确认参加测试资格。其中，获得多所院校测试资格的考生，同时还须自主确定优先录取顺序，高考成绩揭晓后，同时被多所院校拟录取的，按此顺序确定正式录取院校。</FONT><SPAN lang=EN-US><?xml:namespace prefix = "o" ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7023.aspx" target="_self" title="标题：高二部分走班课上课地点调整通知&#xD;点击数：216&#xD;发表时间：17年05月25日">高二部分走班课上课地点调整通知</a>[ 05-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7031.aspx" target="_self" title="标题：2017年推荐生招生考试监考和阅卷安排&#xD;点击数：808&#xD;发表时间：17年05月26日">2017年推荐生招生考试监考和阅卷安排</a>[ 05-26 ]</div>
                        </div>
                    </div>
