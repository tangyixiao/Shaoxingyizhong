...
<head>
    ...
    <title>学生证注册及补办通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6436"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6436},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6436";
     ...
     <P>1、学生证注册：</P>
<P>高二（1）～（8）班请于本周二课间或自修课时间以班级为单位到教学处盖章注册。高二（9）～（16）班请于本周三课间或自修课时间以班级为单位到教学处盖章注册。</P>
<P>高三（1）～（8）班请于本周四课间或自修课时间以班级为单位到教学处盖章注册。高三（9）～（16）班请于本周五课间或自修课时间以班级为单位到教学处盖章注册。</P>
<P>高一各班请于下周一课间或自修课时间以班级为单位到教学处盖章注册。。</P>
<P>2、学生证补办：</P>
<P>高一、高二、高三各班须要补办学生证的同学以班级为单位于今天（周一）下午第4节课到教学处领取空白学生证，领取学生证时上交本班须补办学生证同学纸质名单。新学生证贴好照片并填写好本人信息，由班级统一到教学处注册。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6434.aspx" target="_self" title="标题：高三年级部分学生会议通知&#xD;点击数：295&#xD;发表时间：17年02月20日">高三年级部分学生会议通知</a>[ 02-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6437.aspx" target="_self" title="标题：竞赛老师及创新班班主任会议通知（有修改）&#xD;点击数：438&#xD;发表时间：17年02月20日">竞赛老师及创新班班主任会议通知（有修改）</a>[ 02-20 ]</div>
                        </div>
                    </div>
