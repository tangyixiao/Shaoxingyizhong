...
<head>
    ...
    <title>通知：高一、高二团支书会议--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">通知：高一、高二团支书会议</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9155"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9155},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9155";
     ...
     <P>  请高一、高二各班团支书于今天<STRONG>中午12:30至教学楼2110</STRONG>开个短会，随带纸笔。若无法参加，请副团支书/组织委员代为参加。</P>
<P>    请团委组织部提前到场考勤。</P>
<P align=right>校团委<BR>2018年9月29日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9154.aspx" target="_self" title="标题：关于创意设计社、红学社成立及招新的通知&#xD;点击数：322&#xD;发表时间：18年09月28日">关于创意设计社、红学社成立及招新的通知</a>[ 09-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9161.aspx" target="_self" title="标题：绍兴市第一中学学生社团章程&#xD;点击数：291&#xD;发表时间：18年09月29日">绍兴市第一中学学生社团章程</a>[ 09-29 ]</div>
                        </div>
                    </div>
