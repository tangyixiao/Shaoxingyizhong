...
<head>
    ...
    <title>高一天文竞赛上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8983"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8983},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8983";
     ...
     <FONT size=4>请高一年级参加天文竞赛的学生，原定于今天下午第8、9节的课改到明天下午第8、9节上课。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8977.aspx" target="_self" title="标题：高三学考选考报名机房安排&#xD;点击数：222&#xD;发表时间：18年09月04日">高三学考选考报名机房安排</a>[ 09-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9001.aspx" target="_self" title="标题：本周六高一停课通知&#xD;点击数：395&#xD;发表时间：18年09月06日">本周六高一停课通知</a>[ 09-06 ]</div>
                        </div>
                    </div>
