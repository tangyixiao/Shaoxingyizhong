...
<head>
    ...
    <title>关于高中历史会考复习交流暨主题研修的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高中历史会考复习交流暨主题研修的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1596"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1596},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1596";
...
<P align=center>历  史
<P></P></TD>
<TD width=132>7日上午8:30前报到
<P></P>（时间半天）
<P></P></TD>
<TD width=118>
<P align=center>高级中学
<P></P></TD>
<TD width=254>高中历史会考复习交流暨主题研修：良性学习场的建构与历史学习的有效性（二）
<P></P>（各校确定一位老师参加主题交流并随带书面交流材料一式30份，参加对象：高一历史教师、参加继续教师的历史教师）
<P></P></TD></TR></TBODY></TABLE>
<P> </P>       请相关老师安排好学校的教育教学工作，按时参加。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1595.aspx" target="_self" title="标题：4月份市属优质课评比预告&#xD;点击数：744&#xD;发表时间：10年04月02日">4月份市属优质课评比预告</a>[ 04-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1600.aspx" target="_self" title="标题：催交上学期研究性记录表&#xD;点击数：363&#xD;发表时间：10年04月03日">催交上学期研究性记录表</a>[ 04-03 ]</div>
                        </div>
                    </div>
