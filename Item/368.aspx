...
<head>
    ...
    <title>有关绍兴文理学院学生来我校教育实习的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">有关绍兴文理学院学生来我校教育实习的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=368"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:368},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=368";
     ...
     <DIV align=center><FONT size=4><B>有关绍兴文理学院学生来我校教育实习的通知</B><B></B></FONT></DIV>
<DIV align=left>     </DIV>
<DIV align=left>     <FONT size=4><B>绍兴文理学院</B>汉语言文学、数理信息学院、外语学院、化学学院、体育学院等院系的40位实习生，从明天开始将在我校进行为期一个多月的
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/367.aspx" target="_self" title="标题：关于高一、高二校本课程补报的通知&#xD;点击数：405&#xD;发表时间：09年10月08日">关于高一、高二校本课程补报的通知</a>[ 10-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/379.aspx" target="_self" title="标题：运动会入场式方法及评比条件&#xD;点击数：414&#xD;发表时间：09年10月10日">运动会入场式方法及评比条件</a>[ 10-10 ]</div>
                        </div>
                    </div>
