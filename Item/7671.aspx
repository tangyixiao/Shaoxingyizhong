...
<head>
    ...
    <title>技术教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7671"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7671},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7671";
     ...
     <FONT size=4>11月23日技术组全体老师外出参加教研活动，高二相关班级技术课改自修。技术走班班级在相应上课教室自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7666.aspx" target="_self" title="标题：历史90学时教研活动通知&#xD;点击数：149&#xD;发表时间：17年11月22日">历史90学时教研活动通知</a>[ 11-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7677.aspx" target="_self" title="标题：北京大学2018年生命科学冬令营报名通知&#xD;点击数：261&#xD;发表时间：17年11月24日">北京大学2018年生命科学冬令营报名通知</a>[ 11-24 ]</div>
                        </div>
                    </div>
