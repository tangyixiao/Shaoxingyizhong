...
<head>
    ...
    <title>信息技术组教研活动及换课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">信息技术组教研活动及换课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21872"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21872},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21872";
     ...
     <p><span style="font-size: 18px;">本周四（9.11）全体信息技术老师参加市直教研活动，相关信息技术课改自修。</span></p><p><span style="font-size: 18px;">高二（13）班上午第二节改为信息技术课，下午第八节改为数学课。</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21857.aspx" target="_self" title="标题：通用技术组外出教研通知&#xD;点击数：110&#xD;发表时间：25年09月08日">通用技术组外出教研通知</a>[ 09-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21873.aspx" target="_self" title="标题：生物组教研活动通知&#xD;点击数：110&#xD;发表时间：25年09月09日">生物组教研活动通知</a>[ 09-09 ]</div>
                        </div>
                    </div>
