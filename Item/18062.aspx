...
<head>
    ...
    <title>体育组教师评议课安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18062"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18062},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18062";
     ...
     <p><span style="font-size: 20px;">体育组教师评议课安排:</span></p><p><span style="font-size: 20px;">1、郑祥霖  6.2  周五第七节  高一6、12班</span></p><p><span style="font-size: 20px;">2、<span style="font-size: 20px;">王斌  </span>6.11  周五第八节  高一7.8班男生</span></p><p><span style="font-size: 20px;">欢迎各位领导和同事莅临指导。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18043.aspx" target="_self" title="标题：高一高二期末考前教学安排&#xD;点击数：976&#xD;发表时间：23年05月29日">高一高二期末考前教学安排</a>[ 05-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18071.aspx" target="_self" title="标题：关于北斗班参赛通知&#xD;点击数：283&#xD;发表时间：23年06月02日">关于北斗班参赛通知</a>[ 06-02 ]</div>
                        </div>
                    </div>
