...
<head>
    ...
    <title>关于检查仪容仪表的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于检查仪容仪表的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年08月19日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=122"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:122},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=122";
     ...
     <DIV> </DIV>
<DIV><FONT size=4>高一、高三各班：</FONT></DIV>
<DIV><FONT size=4>    本星期四、五中午将进行仪容仪表检查，请佩带校徽，配合检查。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/119.aspx" target="_self" title="标题：关于高一班长会议的通知&#xD;点击数：661&#xD;发表时间：09年08月18日">关于高一班长会议的通知</a>[ 08-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/124.aspx" target="_self" title="标题：仪容仪表检查的结果（8月20日）&#xD;点击数：566&#xD;发表时间：09年08月20日">仪容仪表检查的结果（8月20日）</a>[ 08-20 ]</div>
                        </div>
                    </div>
