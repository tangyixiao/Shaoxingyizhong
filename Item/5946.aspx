...
<head>
    ...
    <title>高二选考走班地点变更通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二选考走班地点变更通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高二选考走班地点变更通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2016年11月16日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5946"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5946},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5946";
     ...
     <!--StartFragment -->
<DIV><FONT size=4>各高二学生，因高三期中考试，周四、周五两天选考走班课时，在实南203自修的学生暂时改到图书馆自修，周五平建树老师的历史走班选修课地点改到实南305。<BR></FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5942.aspx" target="_self" title="标题：口语竞赛培训上课地点更改通知&#xD;点击数：101&#xD;发表时间：16年11月16日">口语竞赛培训上课地点更改通知</a>[ 11-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5953.aspx" target="_self" title="标题：今天高一部分选修课上课地点变更通知&#xD;点击数：95&#xD;发表时间：16年11月17日">今天高一部分选修课上课地点变更通知</a>[ 11-17 ]</div>
                        </div>
                    </div>
