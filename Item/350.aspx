...
<head>
    ...
    <title>高二、高三部分学生相片重拍通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二、高三部分学生相片重拍通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月29日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=350"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:350},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=350";
...
<TR>
<TD width="5%"> </TD>
<TD width="90%"><FONT size=3>     高二、高三学生相片校对工作已经结束，需要重拍的学生，请于明天（9月30日）12：10到行政楼拍照。</FONT> </TD></TR></TBODY></TABLE>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/342.aspx" target="_self" title="标题：通知二则&#xD;点击数：412&#xD;发表时间：09年09月28日">通知二则</a>[ 09-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/358.aspx" target="_self" title="标题：关于参加全国中学生数学联赛的同学停课复习的通知&#xD;点击数：406&#xD;发表时间：09年10月06日">关于参加全国中学生数学联赛的同学停课复习的通知</a>[ 10-06 ]</div>
                        </div>
                    </div>
