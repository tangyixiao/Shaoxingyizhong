...
<head>
    ...
    <title>关于高三4月份语、数、英模拟考试的通知--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高三4月份语、数、英模拟考试的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8394"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8394},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8394";
     ...
     <P>全体高三师生：</P>
<P>           为进一步提高学生高考的应试能力，检测前一阶段复习的效果，学校决定下周五下午到下周六进行高三语文、数学、英语模拟考试，试题由各备课组自行命题，务必要保证质量。希望高三学生认真准备，无故不能缺席考试。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8266.aspx" target="_self" title="标题：高三年段4月选考期间工作安排&#xD;点击数：425&#xD;发表时间：18年04月03日">高三年段4月选考期间工作安排</a>[ 04-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8456.aspx" target="_self" title="标题：高三年段4月语、数、英模拟考试相关工作提示&#xD;点击数：440&#xD;发表时间：18年04月27日">高三年段4月语、数、英模拟考试相关工作提示</a>[ 04-27 ]</div>
                        </div>
                    </div>
