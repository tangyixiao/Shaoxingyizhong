...
<head>
    ...
    <title>高三“高考百日冲刺动员大会”通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三“高考百日冲刺动员大会”通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3378"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3378},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3378";
     ...
     <P>高三各班：</P>
<P>        定于本周六上午10：00在报告厅举行高三年级“高考百日冲刺动员大会”，请各班在9：50分入场，按指定位置就座。高三（4）班带凳、高三（3）班15人带凳。</P>
<P>附：<A title=高考百日冲刺动员大会座位安排 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201102/2011022511160926.xls">高考百日冲刺动员大会座位安排</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3377.aspx" target="_self" title="标题：值周班校牌检查结果公布（二）&#xD;点击数：579&#xD;发表时间：11年02月25日">值周班校牌检查结果公布（二）</a>[ 02-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3381.aspx" target="_self" title="标题：关于交“寒假社区(社会)实践活动”信息表的通知&#xD;点击数：393&#xD;发表时间：11年02月25日">关于交“寒假社区(社会)实践活动”信息表的通知</a>[ 02-25 ]</div>
                        </div>
                    </div>
