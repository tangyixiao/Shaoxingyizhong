...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12524"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12524},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12524";
     ...
     今天（12月23日）因空气质量轻度污染，跑操暂停一次。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12523.aspx" target="_self" title="标题：寻物启事两则（有修改）&#xD;点击数：402&#xD;发表时间：20年12月23日">寻物启事两则（有修改）</a>[ 12-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12525.aspx" target="_self" title="标题：高一部分学生参加市迎新汇演相关通知（朗诵节目）&#xD;点击数：690&#xD;发表时间：20年12月23日">高一部分学生参加市迎新汇演相关通知（朗诵节目）</a>[ 12-23 ]</div>
                        </div>
                    </div>
