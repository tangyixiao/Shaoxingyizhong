...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3414"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3414},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3414";
     ...
     <P>                               文明办公室检查</P>
<P>    今天下午第三节课进行文明办公室检查,请各办公室认真打扫、整理，新学期有新形象。</P>
<P>   请各年级今天白天值班的老师在下午第三节课到陈副校长办公室集中。</P>
<P>                                                       校文明办公室检查小组</P>
<P>                                                             2011.3.2</P>
<P>                                                                  </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3409.aspx" target="_self" title="标题：工会公告&#xD;点击数：543&#xD;发表时间：11年03月01日">工会公告</a>[ 03-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3441.aspx" target="_self" title="标题：工会”三八”节活动通知&#xD;点击数：590&#xD;发表时间：11年03月04日">工会”三八”节活动通知</a>[ 03-04 ]</div>
                        </div>
                    </div>
