...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=640"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:640},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=640";
     ...
     <SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA"><FONT color=#000000>    以“书画会友”为宗旨，通过开展书画交流、观摩名家作品、举办校内作品展等方式，陶冶学生情操，提高审美鉴赏能力。</FONT></SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/639.aspx" target="_self" title="标题：朗诵社&#xD;点击数：1636&#xD;发表时间：09年11月28日">朗诵社</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/641.aspx" target="_self" title="标题：合唱团&#xD;点击数：1373&#xD;发表时间：09年11月28日">合唱团</a>[ 11-28 ]</div>
                        </div>
                    </div>
