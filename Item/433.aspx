    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高三</span> <span>发布时间：2009年10月21日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=433"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:433},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=433";
     ...
     <DIV align=center>高三近期安排</DIV>
<DIV> </DIV>
<DIV>    <FONT size=4>1．教学工作</FONT></DIV>
<DIV><FONT size=4>    任课老师按原课程表下班管理。自修课由班主任管理。作息时间不变；早自修照旧，卫生要求照旧。</FONT></DIV>
...
<DIV><FONT size=
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/407.aspx" target="_self" title="标题：高三(有改动)&#xD;点击数：385&#xD;发表时间：09年10月15日">高三(有改动)</a>[ 10-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/505.aspx" target="_self" title="标题：高三期中考试期间安排&#xD;点击数：448&#xD;发表时间：09年11月04日">高三期中考试期间安排</a>[ 11-04 ]</div>
                        </div>
                    </div>
