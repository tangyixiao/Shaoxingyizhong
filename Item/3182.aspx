...
<head>
    ...
    <title>高一、高二调课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3182"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3182},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3182";
     ...
     <P>         由于明天（12月31日）下午高一、高二学生将参加学校举行的“2010年校园文化艺术节闭幕式暨2011元旦文艺会演”，被冲掉的课任课老师自行补上，高三正常上课。</P>
<P>                                                               教学处  2010/12/30</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3179.aspx" target="_self" title="标题：高三会考模拟考监考安排&#xD;点击数：532&#xD;发表时间：10年12月29日">高三会考模拟考监考安排</a>[ 12-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3195.aspx" target="_self" title="标题：领取补办的会考准考证&#xD;点击数：376&#xD;发表时间：11年01月04日">领取补办的会考准考证</a>[ 01-04 ]</div>
                        </div>
                    </div>
