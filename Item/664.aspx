...
<head>
    ...
    <title>2009年校学生会主席竞选大会落下帷幕--团学动态-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=664"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:664},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=664";
...
<P><BR></P></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/663.aspx" target="_self" title="标题：绍兴一中团委2009学年工作计划&#xD;点击数：1560&#xD;发表时间：09年11月28日">绍兴一中团委2009学年工作计划</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/665.aspx" target="_self" title="标题：新一届团委、学生会主要干部名单&#xD;点击数：1563&#xD;发表时间：09年11月28日">新一届团委、学生会主要干部名单</a>[ 11-28 ]</div>
                        </div>
                    </div>
