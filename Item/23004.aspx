...
<head>
    ...
    <title>4.7班级一日考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=23004"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23004},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23004";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2026/4/202604091429546304.png" style="max-width: 100%; " title="202604091429546304.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/23002.aspx" target="_self" title="标题：寻物启事（春装校服和饭卡）&#xD;点击数：65&#xD;发表时间：26年04月09日">寻物启事（春装校服和饭卡）</a>[ 04-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/23005.aspx" target="_self" title="标题：4.8班级一日考核&#xD;点击数：53&#xD;发表时间：26年04月09日">4.8班级一日考核</a>[ 04-09 ]</div>
                        </div>
                    </div>
