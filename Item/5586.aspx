...
<head>
    ...
    <title>高三本周六上课提醒--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5586"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5586},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5586";
     ...
     <P>高三本周六先按课表安排上三节课，再进行限时训练，没有考试的学生到相应的高一教室自修。</P>
<P>由于限时训练安排时间比较紧，请第三节课的上课老师不要拖堂。</P>
<P>下课后请学生迅速到考场坐好，监考老师也请按时到考务组领取试卷。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5584.aspx" target="_self" title="标题：本周六高三限时训练安排&#xD;点击数：474&#xD;发表时间：16年09月23日">本周六高三限时训练安排</a>[ 09-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5590.aspx" target="_self" title="标题：高一军训期间课程安排&#xD;点击数：315&#xD;发表时间：16年09月23日">高一军训期间课程安排</a>[ 09-23 ]</div>
                        </div>
                    </div>
