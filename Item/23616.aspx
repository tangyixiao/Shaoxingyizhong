...
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23616},success:function(s) {
     ...
     <p style="text-align: center;"><img src="/UploadFiles/xwzx/2026/9/202609091456482665.png" style="max-width: 100%; " title="202609091456482665.png" /></p>
                        ...
                        <div class="others">
                            ...
                            <div class="next"><span>下一篇：</span><a href="/Item/23618.aspx" target="_self" title="标题：大课间跑操考核员招募通知&#xD;点击数：86&#xD;发表时间：26年03月06日">大课间跑操考核员招募通知</a>[ 03-06 ]</div>
                        </div>
                    </div>
