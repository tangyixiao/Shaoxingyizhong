...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5971"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5971},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5971";
     ...
     11月21日至22日，王佩金老师外出参加教研活动，相关班级心理课改自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5958.aspx" target="_self" title="标题：本周六省高考数学科目模拟测试工作安排&#xD;点击数：213&#xD;发表时间：16年11月17日">本周六省高考数学科目模拟测试工作安排</a>[ 11-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5977.aspx" target="_self" title="标题：高三部分学生会议通知&#xD;点击数：564&#xD;发表时间：16年11月22日">高三部分学生会议通知</a>[ 11-22 ]</div>
                        </div>
                    </div>
