...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7849"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7849},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7849";
...
<P>       2、除每周固定劳动课之外，负责班级平时也需及时打扫本班包干区。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7846.aspx" target="_self" title="标题：艺术节闭幕式节目串词上交通知&#xD;点击数：936&#xD;发表时间：17年12月22日">艺术节闭幕式节目串词上交通知</a>[ 12-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7856.aspx" target="_self" title="标题：艺术节走台通知&#xD;点击数：422&#xD;发表时间：17年12月25日">艺术节走台通知</a>[ 12-25 ]</div>
                        </div>
                    </div>
