...
<head>
    ...
    <title>部分社团、部门参加团代会筹备会的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">部分社团、部门参加团代会筹备会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13466"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13466},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13466";
     ...
     <p>请团委组织部、宣传部、纪检部，学生会秘书部的部长、副部长，以及摄影社负责人，于今天（5月21日）第九节课至2112教室参加团代会筹备会议，随带纸笔。</p><p>
...
2021年5月21日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13462.aspx" target="_self" title="标题：学生权益相关会议通知&#xD;点击数：268&#xD;发表时间：21年05月21日">学生权益相关会议通知</a>[ 05-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13506.aspx" target="_self" title="标题：关于召开共青团绍兴市第一中学第十三次代表大会的通知&#xD;点击数：450&#xD;发表时间：21年05月26日">关于召开共青团绍兴市第一中学第十三次代表大会的通知</a>[ 05-26 ]</div>
                        </div>
                    </div>
