...
<head>
    ...
    <title>高三音乐课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6844"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6844},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6844";
     ...
     <FONT size=4>因下周高一、高二期中考试，高三年级周二至周四（5月2日至4日）音乐课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6843.aspx" target="_self" title="标题：高一高二期中考试场布置要求&#xD;点击数：273&#xD;发表时间：17年04月28日">高一高二期中考试场布置要求</a>[ 04-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6845.aspx" target="_self" title="标题：高三自主招生、三位一体面试培训通知&#xD;点击数：382&#xD;发表时间：17年04月29日">高三自主招生、三位一体面试培训通知</a>[ 04-29 ]</div>
                        </div>
                    </div>
