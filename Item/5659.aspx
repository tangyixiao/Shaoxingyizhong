...
<head>
    ...
    <title>晚间安全检查记录2016.10.4--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2016.10.4</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5659"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5659},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5659";
     ...
     10月4日晚，高二（7）班后门，灯，电扇未关；教2-103室后门未关。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5656.aspx" target="_self" title="标题：晚间安全检查记录2016.9.30&#xD;点击数：126&#xD;发表时间：16年10月04日">晚间安全检查记录2016.9.30</a>[ 10-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5670.aspx" target="_self" title="标题：校园巡视检查记录统计表（2016年9月）&#xD;点击数：187&#xD;发表时间：16年10月06日">校园巡视检查记录统计表（2016年9月）</a>[ 10-06 ]</div>
                        </div>
                    </div>
