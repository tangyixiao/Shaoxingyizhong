...
<head>
    ...
    <title>6.4跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21586"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21586},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21586";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/6/202506041553057012.png" style="max-width: 100%; " title="202506041553057012.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21582.aspx" target="_self" title="标题：6.3班级一日考核&#xD;点击数：32&#xD;发表时间：25年06月04日">6.3班级一日考核</a>[ 06-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21588.aspx" target="_self" title="标题：寻物启事二则（手串/手表）&#xD;点击数：142&#xD;发表时间：25年06月05日">寻物启事二则（手串/手表）</a>[ 06-05 ]</div>
                        </div>
                    </div>
