...
<head>
    ...
    <title>英语组公开课通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9951"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9951},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9951";
     ...
     <P> </P><!--StartFragment -->
<DIV>明天有英语组开设两节公开课，欢迎组内外老师莅临指导。具体信息如下：</DIV>
<DIV>周三下午第二节，高一（14）班，陈伊伊；</DIV>
<DIV>第三节，高二（4）班，钱虹燕。</DIV>
<DIV>地点:录播教室。 </DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9948.aspx" target="_self" title="标题：绍兴市第九批精品（推荐）选修课程评比的通知&#xD;点击数：331&#xD;发表时间：19年04月03日">绍兴市第九批精品（推荐）选修课程评比的通知</a>[ 04-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9984.aspx" target="_self" title="标题：（修改）2018学年绍兴一中教师课堂教学能力比武活动方案&#xD;点击数：937&#xD;发表时间：19年04月15日">（修改）2018学年绍兴一中教师课堂教学能力比武活动方案</a>[ 04-15 ]</div>
                        </div>
                    </div>
