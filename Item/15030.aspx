...
<head>
    ...
    <title>高二名校协作体成绩分析会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15030"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15030},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15030";
     ...
     <p>兹定于本周二下午第四节课召开高二年级名校协作体成绩分析会，会议地点在树兰楼三楼会议室二，请高二高考科目教师准时参加。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15023.aspx" target="_self" title="标题：高一学生领取学生证通知&#xD;点击数：130&#xD;发表时间：22年02月25日">高一学生领取学生证通知</a>[ 02-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15053.aspx" target="_self" title="标题：高一、高二美术生开会通知&#xD;点击数：168&#xD;发表时间：22年02月28日">高一、高二美术生开会通知</a>[ 02-28 ]</div>
                        </div>
                    </div>
