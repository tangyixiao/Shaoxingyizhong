...
<head>
    ...
    <title>“求真”文化发扬光大--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=617"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:617},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=617";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/616.aspx" target="_self" title="标题：重温光辉历程&amp;nbsp;传唱红色经典&#xD;点击数：1183&#xD;发表时间：09年11月13日">重温光辉历程 传唱红色经典</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/618.aspx" target="_self" title="标题：绍兴一女生进央视比才&#xD;点击数：513&#xD;发表时间：09年11月13日">绍兴一女生进央视比才</a>[ 11-13 ]</div>
                        </div>
                    </div>
