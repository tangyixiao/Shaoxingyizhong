...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20842"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20842},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20842";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/1/202501041638214783.png" style="max-width: 100%; " title="202501041638214783.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20834.aspx" target="_self" title="标题：失物招领（U盘）&#xD;点击数：56&#xD;发表时间：25年01月03日">失物招领（U盘）</a>[ 01-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20843.aspx" target="_self" title="标题：1.4跑操量化考核反馈&#xD;点击数：44&#xD;发表时间：25年01月04日">1.4跑操量化考核反馈</a>[ 01-04 ]</div>
                        </div>
                    </div>
