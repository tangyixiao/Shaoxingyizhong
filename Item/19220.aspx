...
<head>
    ...
    <title>1.4班级一日考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19220"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19220},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19220";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2024/1/202401050955440188.png" style="max-width: 100%; " title="202401050955440188.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19218.aspx" target="_self" title="标题：1.3班级一日考核&#xD;点击数：39&#xD;发表时间：24年01月04日">1.3班级一日考核</a>[ 01-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19222.aspx" target="_self" title="标题：关于首考后各年段走班教室的使用规定的通知&#xD;点击数：288&#xD;发表时间：24年01月05日">关于首考后各年段走班教室的使用规定的通知</a>[ 01-05 ]</div>
                        </div>
                    </div>
