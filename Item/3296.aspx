...
<head>
    ...
    <title>关于卫生与住校生收费的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于卫生与住校生收费的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3296"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3296},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3296";
     ...
     <P> </P>
<P><FONT size=4>1、高三班主任请提醒学生在考试期间还是要做好值日卫生工作；</FONT></P>
<P><FONT size=4>2、“住校生收费通知单”已下发，请在放假前下发给住校生。</FONT></P>
<P><FONT color=#f70968 size=4>附：<A title=住校生收费的通知单 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201101/2011012414382099.doc"><FONT color=#ee1169>住校生收费通知单</FONT></A></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3295.aspx" target="_self" title="标题：关于大学生回访母校活动的通知（地点有变）&#xD;点击数：605&#xD;发表时间：11年01月24日">关于大学生回访母校活动的通知（地点有变）</a>[ 01-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3297.aspx" target="_self" title="标题：失物招领&#xD;点击数：396&#xD;发表时间：11年01月24日">失物招领</a>[ 01-24 ]</div>
                        </div>
                    </div>
