...
<head>
    ...
    <title>关于高一、高二文艺委员会议通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一、高二文艺委员会议通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年10月14日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=401"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:401},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=401";
     ...
     <DIV align=left>   <FONT size=3> 10月15日(星期四)中午12：30，请高一、高二各班文艺委员到实南203室开会，布置有关大合唱比赛事项。届时请各班文艺委员务必<FONT face=宋体>上报本班合唱曲目的精确用时</FONT><SPAN style="FONT-SIZE: 14pt; COLOR: black; FONT-FAMILY: 宋体; mso-bidi-font-family: 宋体; mso-ansi-language: EN-
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/400.aspx" target="_self" title="标题：第十六期课余党校开课通知&#xD;点击数：306&#xD;发表时间：09年10月14日">第十六期课余党校开课通知</a>[ 10-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/416.aspx" target="_self" title="标题：“国庆瞬间 永恒中国”摄影比赛评选结果&#xD;点击数：262&#xD;发表时间：09年10月19日">“国庆瞬间 永恒中国”摄影比赛评选结果</a>[ 10-19 ]</div>
                        </div>
                    </div>
