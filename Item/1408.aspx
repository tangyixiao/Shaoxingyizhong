...
<head>
    ...
    <title>关于校团委、学生会干部培训的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于校团委、学生会干部培训的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1408"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1408},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1408";
     ...
     <P> </P>
<P>     <FONT size=4>请全体团委、学生会干部于3月10日（星期三）中午12：20到实验楼南－203室参加团学干部培训，随带笔记本，勿迟到。<BR></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1391.aspx" target="_self" title="标题：关于举办辩论比赛的通知&#xD;点击数：544&#xD;发表时间：10年03月05日">关于举办辩论比赛的通知</a>[ 03-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1413.aspx" target="_self" title="标题：关于开展主题团活动的通知&#xD;点击数：560&#xD;发表时间：10年03月10日">关于开展主题团活动的通知</a>[ 03-10 ]</div>
                        </div>
                    </div>
