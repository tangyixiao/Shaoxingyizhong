...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三(有改动)</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高三</span> <span>发布时间：2009年10月15日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=407"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:407},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=407";
     ...
     <P>      请班主任通知教学楼黑板上榜上有名的学生今天下午第四节课（因与校本课程场地冲突，第三节课改为第四节课）到行政楼五楼会议室开会。</P>
<P>      高三周六下午安排文综理综测试。关于试场已经协商好，各班如有需要可以借用高二教室或者食堂。使用前请再与相应班级班主任打声招呼。</P>
<P>      </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/374.aspx" target="_self" title="标题：高三党支部会议&#xD;点击数：451&#xD;发表时间：09年10月09日">高三党支部会议</a>[ 10-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/433.aspx" target="_self" title="标题：高三近期安排&#xD;点击数：459&#xD;发表时间：09年10月21日">高三近期安排</a>[ 10-21 ]</div>
                        </div>
                    </div>
