...
<head>
    ...
    <title>关于召开高一学考模拟考成绩分析会的通知--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于召开高一学考模拟考成绩分析会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21637"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21637},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21637";
     ...
     <p>       兹定于今天（6月19日）下午第8节课在高一教学楼1楼阶梯教室4112召开高一学考模拟考成绩分析会，参会人员为高一班主任及学考科目（化学、生物、历史、地理）任课老师，请大家准时参加。
                                                                                                                                                                                             高一年管会
                                                                                                                                                         2025年6月19日    </p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21630.aspx" target="_self" title="标题：6月18日高一创新班数学、物理考试监考安排和学生考场安排&#xD;点击数：177&#xD;发表时间：25年06月18日">6月18日高一创新班数学、物理考试监考安排和学生考场安排</a>[ 06-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21641.aspx" target="_self" title="标题：高一晚自修值班安排（6.22-6.27）&#xD;点击数：199&#xD;发表时间：25年06月20日">高一晚自修值班安排（6.22-6.27）</a>[ 06-20 ]</div>
                        </div>
                    </div>
