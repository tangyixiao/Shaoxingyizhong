...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7945"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7945},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7945";
     ...
     <P>请全校各班团支书于今天放学前至团委2114领取新一期树人导报，并在表格内签字确认。</P>
<P align=right>校团委<BR>1月12日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7923.aspx" target="_self" title="标题：通知：团学联工作例会&#xD;点击数：242&#xD;发表时间：18年01月08日">通知：团学联工作例会</a>[ 01-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7958.aspx" target="_self" title="标题：团校开课通知&#xD;点击数：241&#xD;发表时间：18年01月16日">团校开课通知</a>[ 01-16 ]</div>
                        </div>
                    </div>
