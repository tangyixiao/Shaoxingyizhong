...
<head>
    ...
    <title>关于“高考征文”和“优秀经验总结报告评选”的补充通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于“高考征文”和“优秀经验总结报告评选”的补充通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月25日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=324"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:324},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=324";
     ...
     <DIV><FONT size=4>各位老师：</FONT></DIV>
<DIV><FONT size=4>    本次高考征文和优秀经验总结报告的征集到9月28日截止，请有参评意向的老师抓紧时间按指定要求上交论文（并<SPAN style="FONT-SIZE: 14pt; COLOR: black; FONT-FAMILY: 宋体; mso-bidi-font-family: 宋体; mso-ansi-language: EN-US; mso-fareast-langu
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/317.aspx" target="_self" title="标题：关于完善浙江省电子学籍管理系统的通知&#xD;点击数：498&#xD;发表时间：09年09月23日">关于完善浙江省电子学籍管理系统的通知</a>[ 09-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/325.aspx" target="_self" title="标题：关于2009年度绍兴市教育学会优秀教科研论文评比的通知&#xD;点击数：351&#xD;发表时间：09年09月25日">关于2009年度绍兴市教育学会优秀教科研论文评比的通知</a>[ 09-25 ]</div>
                        </div>
                    </div>
