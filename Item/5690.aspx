...
<head>
    ...
    <title>关于征求学校章程修改意见建议的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于征求学校章程修改意见建议的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5690"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5690},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5690";
     ...
     <SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3><!--StartFragment -->
<DIV>全校教工：<BR>    根据学校章程修订程序，为充分发挥民主权利，确保高质量完成章程修订工作，推进学校的治理能力和治理水平，完善“依法治校”的制度体系，保障学校的高质量优质发展，请每位教工认真阅读《绍兴市第一中学章程（初稿）》，提出宝贵的修改意见与建议，供学校参考、完善。<BR>    大家可以将意见建议书面反馈给所在学科的教研组长或工会小组长，由组长统一汇总后上交校办；也可以直接向校办或通过<A href="mailto:sxyzac@163.com">sxyzac@163.com</A>邮箱递交个人的意见建议。截止时间：2016年10月20日。<BR>    感谢大家的积极参与。<BR><BR>                                                    校办<BR>                                               2016年10月10日<BR></DIV></FONT></SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5683.aspx" target="_self" title="标题：关于公布升国旗仪式全校教工站位的通知&#xD;点击数：337&#xD;发表时间：16年10月08日">关于公布升国旗仪式全校教工站位的通知</a>[ 10-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5699.aspx" target="_self" title="标题：会议通知&#xD;点击数：322&#xD;发表时间：16年10月11日">会议通知</a>[ 10-11 ]</div>
                        </div>
                    </div>
