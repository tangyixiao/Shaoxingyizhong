...
<head>
    ...
    <title>数学组教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10861"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10861},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10861";
     ...
     <FONT size=4>根据研究院安排，本周四数学组全体老师参加教研活动一天，数学课改自习。<BR>地点：高级中学<BR>时间：7：30分前报到<BR>请各位备课组长负责落实相应课堂作业！</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10856.aspx" target="_self" title="标题：体育教研活动通知&#xD;点击数：345&#xD;发表时间：19年11月12日">体育教研活动通知</a>[ 11-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10865.aspx" target="_self" title="标题：关于灵溪中学来访开课调课的通知&#xD;点击数：371&#xD;发表时间：19年11月14日">关于灵溪中学来访开课调课的通知</a>[ 11-14 ]</div>
                        </div>
                    </div>
