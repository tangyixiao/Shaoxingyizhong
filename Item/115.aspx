...
<head>
    ...
    <title>教研组（备课）组长会议的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">教研组（备课）组长会议的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=115"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:115},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=115";
     ...
     <P>       <FONT size=4>为迎接市教育教学研究院对于市属普通高中教研组长及教研团队的考评，教学处定于今天（8月18日）下午4点30分在行政楼三楼会议室召开教研组（备课）组长会议。请下列组长准时出席：</FONT></P>
<P><FONT size=4>语文：宋建伟、郑小平、朱水军</FONT></P>
<P><FONT size=4>数学：俞渭鑫、俞建种、陈连原、孟伟强</FONT></P>
<P><FONT size=4>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/110.aspx" target="_self" title="标题：高三选修IB上课安排&#xD;点击数：606&#xD;发表时间：09年08月17日">高三选修IB上课安排</a>[ 08-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/118.aspx" target="_self" title="标题：关于组织2009年9月份普通高校招生英语听力等三项考试补报名的通知&#xD;点击数：662&#xD;发表时间：09年08月18日">关于组织2009年9月份普通高校招生英语听力等三项考试补报名的…</a>[ 08-18 ]</div>
                        </div>
                    </div>
