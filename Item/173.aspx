...
<head>
    ...
    <title>9月1日上午高一高二上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9月1日上午高一高二上课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=173"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:173},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=173";
     ...
     <DIV>      <FONT size=4>9月1日上午开学典礼结束后，学生马上回教室，老师按课表上课。被挤掉的课，相关任课老师在自修课补上。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/168.aspx" target="_self" title="标题：9月1日下午高三综合回头考时间调整&#xD;点击数：1099&#xD;发表时间：09年08月31日">9月1日下午高三综合回头考时间调整</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/184.aspx" target="_self" title="标题：校定向队招新队员通知&#xD;点击数：556&#xD;发表时间：09年09月01日">校定向队招新队员通知</a>[ 09-01 ]</div>
                        </div>
                    </div>
