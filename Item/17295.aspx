...
<head>
    ...
    <title>高二名校协作体分析会--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17295"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17295},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17295";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 20px; background-color: rgb(255, 255, 255);">今天（2月15日）下午第9节课在树兰楼三楼会议室二召开高二名校协作体考试分析会，请各位高二相关任课老师准时参加。</span><span style="font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 20px; background-color: rgb(255, 255, 255); color: rgb(255, 0, 0);">第9节课有课老师请上完课后赴会。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17283.aspx" target="_self" title="标题：高三首考及名校协作体分析会&#xD;点击数：336&#xD;发表时间：23年02月14日">高三首考及名校协作体分析会</a>[ 02-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17310.aspx" target="_self" title="标题：高三2-3月第一轮限时训练时间安排&#xD;点击数：443&#xD;发表时间：23年02月17日">高三2-3月第一轮限时训练时间安排</a>[ 02-17 ]</div>
                        </div>
                    </div>
