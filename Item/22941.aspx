...
<head>
    ...
    <title>【博雅·模拟联合国】社团课通知--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">【博雅·模拟联合国】社团课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22941"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22941},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22941";
     ...
     <p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; margin-bottom: 20px !important;">时间:周六（3月28号）中午12:30—1:30   </p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; margin-bottom: 20px !important;">地点:阶梯教室 4106</p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; margin-bottom: 20px !important;">内容:国际法概要</p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; margin-bottom: 20px !important;">注意:请准时到场，务必向班主任做好请假工作！</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22940.aspx" target="_self" title="标题：【校电】社团课通知&#xD;点击数：13&#xD;发表时间：26年03月27日">【校电】社团课通知</a>[ 03-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22942.aspx" target="_self" title="标题：【汉韵社】社团课通知&#xD;点击数：13&#xD;发表时间：26年03月27日">【汉韵社】社团课通知</a>[ 03-27 ]</div>
                        </div>
                    </div>
