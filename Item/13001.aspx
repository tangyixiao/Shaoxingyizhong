...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13001"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13001},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13001";
     ...
     <p style="TEXT-INDENT: 28px"><span style="FONT-SIZE: 18px; FONT-FAMILY: 宋体; LINE-HEIGHT: 150%">近来学校食堂出现了这样一种场景：中午就餐期间，有一部分同学用书本、雨伞、手表等各式各样的物品先占桌位，再去排队买菜。有些同学见座位已被占，并不予理睬，就把占位物品拿开，于是那位早前放占位物品的同学见到此情形就想要与他们争执。虽然还没有过极端的行为，但这是一个隐患，容易引起不必要的矛盾和纠纷，而且占位是一个不文明的行为。</span></p><p style="LINE-HEIGHT: 150%; TEXT-INDENT: 29px"><span style="FONT-SIZE: 18px; FONT-FAMILY: 宋体; LINE-HEIGHT: 150%">为此，学校规定学生就餐时不能先占位置，大家按先来后到有序就餐、文明就餐。明天（3月30日）起值周班将进行检查，如果再有占位现象发生，德育处将酌情处理。</span></p><p style="TEXT-INDENT: 28px"><span style="FONT-SIZE: 14px; FONT-FAMILY: 宋体FONT-FAMILY: 宋体"></span> </p><p>                                                                                                    德育处</p><p>                                                                                            2021年3月29日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13000.aspx" target="_self" title="标题：高二、高三劳动课打扫通知&#xD;点击数：39&#xD;发表时间：21年03月29日">高二、高三劳动课打扫通知</a>[ 03-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13002.aspx" target="_self" title="标题：关于严禁学生在校时间擅自出校门的通知&#xD;点击数：252&#xD;发表时间：21年03月29日">关于严禁学生在校时间擅自出校门的通知</a>[ 03-29 ]</div>
                        </div>
                    </div>
