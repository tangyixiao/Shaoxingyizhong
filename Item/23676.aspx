...
<head>
    ...
    <title>高三晚自修（9.19-9.29）--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三晚自修（9.19-9.29）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23676"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23676},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23676";
     ...
     <p><img src="/UploadFiles/xwzx/2026/9/202609171540577566.png" style="max-width: 100%; " title="202609171540577566.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23599.aspx" target="_self" title="标题：高三晚自修（9.7-9.23）&#xD;点击数：147&#xD;发表时间：26年09月04日">高三晚自修（9.7-9.23）</a>[ 09-04 ]</div>
