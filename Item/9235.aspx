...
<head>
    ...
    <title>北门丰巢箱房清理通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9235"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9235},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9235";
     ...
     <P>各位教工、同学：</P>
<P>     根据教育局对学校快递、包裹收发的相关要求，今天北门丰巢快递箱房将进行一次清理行动，请相关教工、同学今天中午12:00之前及时将快递箱房内的物品取走（主要是摆放在地面上的快递以及传达室内的物品）。没有及时取走的，学校安全处将统一移至仓库，如有丢失，概不负责。望各位知悉！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9191.aspx" target="_self" title="标题：请各班安全委员到医务室领取《健康教育资料》&#xD;点击数：186&#xD;发表时间：18年10月11日">请各班安全委员到医务室领取《健康教育资料》</a>[ 10-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9251.aspx" target="_self" title="标题：关于学校紧急疏散时教工工作安排的通知&#xD;点击数：340&#xD;发表时间：18年10月24日">关于学校紧急疏散时教工工作安排的通知</a>[ 10-24 ]</div>
                        </div>
                    </div>
