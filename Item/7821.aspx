...
<head>
    ...
    <title>数码广播设备使用规定--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7821"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7821},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7821";
     ...
     <P><FONT size=4>运用现代教学手段是提高素质教育的有效途径，为了保证数码广播设备能正常服务于学校教育教学，特作如下规定：</FONT></P>
<P><FONT size=4>1、各班指定至少一名责任心强的同学为班级电教委员；电教委员负责管理使用数码广播设备，若出现故障，要及时通知学校进行维修；</FONT></P>
<P><FONT size=4>2、任何学生不能擅自使用设备，更不能改变设备之间的连接线缆；因违章操作造成损坏者要照价赔偿；</FONT></P>
<P><FONT size=4>3、检查与处罚:</FONT></P>
<P><FONT size=4>1）教学处、德育处随机检查，违纪情况直接记入学生综合素质考评档案。</FONT></P>
<P><FONT size=4>2）情节严重者，除赔偿外，还将按相关规定给予处分。</FONT><BR></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7811.aspx" target="_self" title="标题：12.18早学早读抽检情况&#xD;点击数：169&#xD;发表时间：17年12月18日">12.18早学早读抽检情况</a>[ 12-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7827.aspx" target="_self" title="标题：高一部分选修课改自修通知&#xD;点击数：228&#xD;发表时间：17年12月19日">高一部分选修课改自修通知</a>[ 12-19 ]</div>
                        </div>
                    </div>
