...
<head>
    ...
    <title>关于高一高二学生信息录入的通知（急）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一高二学生信息录入的通知（急）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年09月15日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=272"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:272},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=272";
     ...
     <DIV>    由于学校工作需要，请高一高二各班主任尽快通知学生按要求录入信息，在本周三前以班级为文件名把学生信息上传至“公共文件夹”——“德育处”——“学生信息录入”文件夹。</DIV>
<DIV>要求：</DIV>
<DIV>   1． 按例子格式录入（出生年月格式为1990/08/01，学生类别为城镇或农村，户籍所在地填至*省*市*区）。</DIV>
<DIV>   2． 只需录入例子中填写的项目。</DIV>
<DI
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/266.aspx" target="_self" title="标题：一周检查情况公布 (2009.9.7-9.11) &#xD;点击数：553&#xD;发表时间：09年09月14日">一周检查情况公布 (2009.9.7-9.11) </a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/277.aspx" target="_self" title="标题：关于学生办理爱国主义教育卡的通知&#xD;点击数：529&#xD;发表时间：09年09月15日">关于学生办理爱国主义教育卡的通知</a>[ 09-15 ]</div>
                        </div>
                    </div>
