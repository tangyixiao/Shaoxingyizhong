...
<head>
    ...
    <title>原高三班主任：体育和竞赛加分的原件可领回--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">原高三班主任：体育和竞赛加分的原件可领回</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2194"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2194},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2194";
     ...
     原高三班主任：请通知学生，今年体育加分认定、测试的原件和学科竞赛加分的原件，到教学处章老师处领回。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2193.aspx" target="_self" title="标题：新高一班主任&#xD;点击数：446&#xD;发表时间：10年07月03日">新高一班主任</a>[ 07-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2196.aspx" target="_self" title="标题：关于领取校级教学论文获奖证书的通知&#xD;点击数：254&#xD;发表时间：10年07月03日">关于领取校级教学论文获奖证书的通知</a>[ 07-03 ]</div>
                        </div>
                    </div>
