...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8387"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8387},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8387";
     ...
     <FONT size=4>明天（周四）物理组全体老师外出参加教研活动，相关班级物理课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8384.aspx" target="_self" title="标题：生物教研活动通知&#xD;点击数：287&#xD;发表时间：18年04月18日">生物教研活动通知</a>[ 04-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8388.aspx" target="_self" title="标题：体育教研活动通知&#xD;点击数：225&#xD;发表时间：18年04月19日">体育教研活动通知</a>[ 04-19 ]</div>
                        </div>
                    </div>
