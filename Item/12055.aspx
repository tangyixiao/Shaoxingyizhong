...
<head>
    ...
    <title>高一部分选修课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一部分选修课改自修通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12055"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12055},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12055";
     ...
     <P>1、因数学、历史老师外出教研活动，<FONT size=3 face=等线>国学社<SPAN lang=EN-US>+</SPAN>青云汉社、考古社<SPAN lang=EN-US>+</SPAN>史学研究社、第一读本选读、高中数学必修知识拓展与引申四门选修课在上课教室自修。</FONT></P>
<P><FONT size=3 face=等线>2、因体育老师组织运动会培训，力量社、乒乓球社、羽毛球社、航模社四门选修课在阶梯教室4106自修。<SPAN lang=EN-US><?xml:namespace prefix = "o" ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></P></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12052.aspx" target="_self" title="标题：高一选修课开始上课通知&#xD;点击数：490&#xD;发表时间：20年10月28日">高一选修课开始上课通知</a>[ 10-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12057.aspx" target="_self" title="标题：体育课改自修通知&#xD;点击数：331&#xD;发表时间：20年10月29日">体育课改自修通知</a>[ 10-29 ]</div>
                        </div>
                    </div>
