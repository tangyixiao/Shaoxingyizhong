...
<head>
    ...
    <title>关于选修课通知两则--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7968"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7968},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7968";
...
<P>                                        关于选修课通知两则</P>
<P>                                                     通知一</P>
<P>    为保证期末复习时间，高一选修课本周上完结束，请各选修课任课教师整理好本学期教案或讲义，做好学生成绩评定工作，有关材料于期末结束前交课程处，下周（1月22日）起，高一选修课时间统一改自修，请班主任加强管理。</P>
<P>                                                      通知二</P>
<P>      为提高选修课程开发能力，积极参加市级各学科特色课程群评比和省网络选修课程评比活动，请各学科组利用寒假时间，积极动员组内教师开发选修课程（也可在学科组原有选修课程的基础上进行整理与补充），下学期课程处在评比校级各学科特色课程群的基础上，择优上报参评。</P>
<P> </P>
<P> </P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7967.aspx" target="_self" title="标题：高一高二高三班长中午开会通知&#xD;点击数：296&#xD;发表时间：18年01月17日">高一高二高三班长中午开会通知</a>[ 01-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7971.aspx" target="_self" title="标题：英语组汇报课通知&#xD;点击数：285&#xD;发表时间：18年01月17日">英语组汇报课通知</a>[ 01-17 ]</div>
                        </div>
                    </div>
