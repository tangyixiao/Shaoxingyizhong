...
<head>
    ...
    <title>高二年级班长会议--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=181"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:181},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=181";
     ...
     <P><FONT size=4>   今天你中午12：30在行政楼三楼会议室召开高二年级各班班长会议，请高二各班班主任及时转告。</FONT></P>
<P><FONT size=4>                         &nb
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/172.aspx" target="_self" title="标题：一周检查情况公布&#xD;点击数：488&#xD;发表时间：09年08月31日">一周检查情况公布</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/182.aspx" target="_self" title="标题：各班主任请注意（关于住校生）&#xD;点击数：435&#xD;发表时间：09年09月01日">各班主任请注意（关于住校生）</a>[ 09-01 ]</div>
                        </div>
                    </div>
