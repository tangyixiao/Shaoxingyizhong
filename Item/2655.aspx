...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2655"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2655},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2655";
     ...
     <P> </P>
<P><STRONG><FONT size=4>今天下午高一年级运动会入场式训练正常进行。</FONT></STRONG></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2654.aspx" target="_self" title="标题：高一高二主题班团会开设情况的通报&#xD;点击数：418&#xD;发表时间：10年10月15日">高一高二主题班团会开设情况的通报</a>[ 10-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2659.aspx" target="_self" title="标题：值周检查情况汇总（10月15日星期五）&#xD;点击数：598&#xD;发表时间：10年10月16日">值周检查情况汇总（10月15日星期五）</a>[ 10-16 ]</div>
                        </div>
                    </div>
