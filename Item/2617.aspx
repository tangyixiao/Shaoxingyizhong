...
<head>
    ...
    <title>升旗仪式疏散演练因雨暂停--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">升旗仪式疏散演练因雨暂停</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2617"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2617},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2617";
...
<P><FONT size=4>因天气原因，原定今天早上的升旗仪式<FONT color=#333333>暨应急疏散演练暂停。</FONT></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2615.aspx" target="_self" title="标题：关于回收统计班主任家访情况的通知&#xD;点击数：319&#xD;发表时间：10年09月30日">关于回收统计班主任家访情况的通知</a>[ 09-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2620.aspx" target="_self" title="标题：值周检查情况汇总（10月9日、10日）&#xD;点击数：347&#xD;发表时间：10年10月11日">值周检查情况汇总（10月9日、10日）</a>[ 10-11 ]</div>
                        </div>
                    </div>
