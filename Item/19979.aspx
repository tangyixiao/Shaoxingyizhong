...
<head>
    ...
    <title>周五体育课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19979"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19979},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19979";
     ...
     <p style="text-indent: 37px"><span style=";font-family:宋体;font-size:19px">因体育组老师外出培训，</span><span style=";font-family:宋体;font-size:19px">明天（周五）下午高一体育课改自修。</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19972.aspx" target="_self" title="标题：6.15高一学考模拟考试学生考场安排和监考安排&#xD;点击数：491&#xD;发表时间：24年06月12日">6.15高一学考模拟考试学生考场安排和监考安排</a>[ 06-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19986.aspx" target="_self" title="标题：6.15学考模拟考考场布置及相关要求&#xD;点击数：334&#xD;发表时间：24年06月14日">6.15学考模拟考考场布置及相关要求</a>[ 06-14 ]</div>
                        </div>
                    </div>
