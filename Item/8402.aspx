...
<head>
    ...
    <title>关于今天跑操比赛的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8402"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8402},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8402";
...
<P>高一、高二跑操比赛照常进行！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8395.aspx" target="_self" title="标题：失物招领&#xD;点击数：213&#xD;发表时间：18年04月19日">失物招领</a>[ 04-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8407.aspx" target="_self" title="标题：今日跑操比赛结果公布&#xD;点击数：441&#xD;发表时间：18年04月20日">今日跑操比赛结果公布</a>[ 04-20 ]</div>
                        </div>
                    </div>
