    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高三</span> <span>发布时间：2009年08月21日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=130"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:130},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=130";
     ...
     <DIV align=left>一、高三回头考命题范围</DIV>
<DIV> </DIV>
<DIV>语文：</DIV>
<DIV>语言文字应用，阅读（包括现代文阅读和古代诗文阅读），作文。</DIV>
<DIV> </DIV>
<DIV>数学：</DIV>
<DIV>1、集合与基本初等函数；2、三角函数；3、导数及其应用；4、选修4-4极坐标与参数方程。</DIV>
<DIV> </DIV>
<DIV>英语：</DIV>
<DIV>单选20题，10分，以暑假作业为基础，灵
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/111.aspx" target="_self" title="标题：高三备课组长会议&#xD;点击数：1246&#xD;发表时间：09年08月17日">高三备课组长会议</a>[ 08-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/163.aspx" target="_self" title="标题：高三班主任请注意 &#xD;点击数：569&#xD;发表时间：09年08月28日">高三班主任请注意 </a>[ 08-28 ]</div>
                        </div>
                    </div>
