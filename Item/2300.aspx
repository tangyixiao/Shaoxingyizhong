...
<head>
    ...
    <title>高一各班主任注意--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2300"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2300},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2300";
     ...
     <P>1.高一军训会操第一阶段比赛明天早上七点准时开始，第二阶段的比赛下午四点半正式开始。请各班务必提前在指定地点集合。</P>
<P>2.参加下午军训会操观礼的学生家长的私家车尽可能停放在学校外,家长就坐于主席台的两侧看台。</P>
<P>                                                                         谢谢!</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2299.aspx" target="_self" title="标题：关于再次上传校讯通电子汇总表的通知&#xD;点击数：356&#xD;发表时间：10年08月27日">关于再次上传校讯通电子汇总表的通知</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2316.aspx" target="_self" title="标题：开学典礼颁奖彩排通知&#xD;点击数：500&#xD;发表时间：10年08月31日">开学典礼颁奖彩排通知</a>[ 08-31 ]</div>
                        </div>
                    </div>
