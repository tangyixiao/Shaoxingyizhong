...
<head>
    ...
    <title>本周地方性课程继续上课--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2978"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2978},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2978";
     ...
     <P>                               本周地方性课程继续上课</P>
<P>        星期四下午高一第四节和星期五下午高二第四节课时间，继续在报告厅上地方性课程，请同学们准时上课，不准迟到、缺席。</P>
<P>                                                                                      12.1</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2976.aspx" target="_self" title="标题：仙居中学高三语文教师来校教学交流、听课与活动安排&#xD;点击数：441&#xD;发表时间：10年12月01日">仙居中学高三语文教师来校教学交流、听课与活动安排</a>[ 12-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2980.aspx" target="_self" title="标题：2010学年校课堂教学大比武活动安排（一）&#xD;点击数：612&#xD;发表时间：10年12月02日">2010学年校课堂教学大比武活动安排（一）</a>[ 12-02 ]</div>
                        </div>
                    </div>
