...
<head>
    ...
    <title>用餐时间通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7599"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7599},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7599";
     ...
     运动会期间，用餐时间照常。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7597.aspx" target="_self" title="标题：运动会期间卫生工作要求&#xD;点击数：195&#xD;发表时间：17年11月09日">运动会期间卫生工作要求</a>[ 11-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7602.aspx" target="_self" title="标题：寻物启事&#xD;点击数：160&#xD;发表时间：17年11月09日">寻物启事</a>[ 11-09 ]</div>
                        </div>
                    </div>
