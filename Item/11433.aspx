...
<head>
    ...
    <title>5.18、5.19绍兴一中住校学生表现情况--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">5.18、5.19绍兴一中住校学生表现情况</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11433"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11433},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11433";
     ...
     <P><A title=5.18绍兴一中住校学生表现情况 href="/Shaoxingyizhong/UploadFiles/UploadFiles/202005/2020051911585591.xls">5.18绍兴一中住校学生表现情况</A></P>
<P><A title=5.19绍兴一中住校学生表现情况 href="/Shaoxingyizhong/UploadFiles/UploadFiles/202005/2020051911591154.xls">5.19绍兴一中住校学生表现情况</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11431.aspx" target="_self" title="标题：高一年级包干区划分（有修改）&#xD;点击数：117&#xD;发表时间：20年05月19日">高一年级包干区划分（有修改）</a>[ 05-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11436.aspx" target="_self" title="标题：关于开展大课间室内操活动的通知&#xD;点击数：196&#xD;发表时间：20年05月19日">关于开展大课间室内操活动的通知</a>[ 05-19 ]</div>
                        </div>
                    </div>
