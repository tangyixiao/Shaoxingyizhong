...
<head>
    ...
    <title>9月10日教师节晚餐安排--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9月10日教师节晚餐安排</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月10日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=236"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:236},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=236";
     ...
     <P><FONT face=Verdana size=5>     9月10日教师节晚餐安排，地点佳诚大酒店（学校斜对面），时间5：45，各桌排列如下：</FONT></P>
<P> </P>
<P>
<TABLE style="WIDTH: 882pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=1176 border=0 x:str>
<COLGROUP>
<COL sty
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/235.aspx" target="_self" title="标题：通知&#xD;点击数：526&#xD;发表时间：09年09月09日">通知</a>[ 09-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/257.aspx" target="_self" title="标题：欢迎老师办中国农业银行喜洋洋卡&#xD;点击数：656&#xD;发表时间：09年09月11日">欢迎老师办中国农业银行喜洋洋卡</a>[ 09-11 ]</div>
                        </div>
                    </div>
