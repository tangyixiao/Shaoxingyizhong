...
<head>
    ...
    <title>还未登记汽车号牌的老师速报给蒋抗力老师--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">还未登记汽车号牌的老师速报给蒋抗力老师</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5416"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5416},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5416";
     ...
     请还未登记汽车号牌的老师速报给蒋抗力老师。最好用QQ发送。登记工作将在今天完成。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4229.aspx" target="_self" title="标题：防台通知&#xD;点击数：991&#xD;发表时间：11年06月25日">防台通知</a>[ 06-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5419.aspx" target="_self" title="标题：全校各班主任请注意（关于信息录入&amp;nbsp;）&#xD;点击数：261&#xD;发表时间：16年08月15日">全校各班主任请注意（关于信息录入 ）</a>[ 08-15 ]</div>
                        </div>
                    </div>
