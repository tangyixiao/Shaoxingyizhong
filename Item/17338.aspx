...
<head>
    ...
    <title>通用技术教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17338"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17338},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17338";
     ...
     <p><span style="font-size: 18px;">通用技术组白宗刚老师22-25号外出参加教研活动，请高一相关班级通技课改自修（可预习必修一第一章第一二节内容）。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17310.aspx" target="_self" title="标题：高三2-3月第一轮限时训练时间安排&#xD;点击数：443&#xD;发表时间：23年02月17日">高三2-3月第一轮限时训练时间安排</a>[ 02-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17340.aspx" target="_self" title="标题：高三2-3月限时训练安排&#xD;点击数：839&#xD;发表时间：23年02月22日">高三2-3月限时训练安排</a>[ 02-22 ]</div>
                        </div>
                    </div>
