...
<head>
    ...
    <title>9月12日高考三项考试安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9月12日高考三项考试安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=242"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:242},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=242";
     ...
     <DIV align=left><B>一、考点组织机构：</B></DIV>
<DIV><B>（一）主    考：</B>马德尧</DIV>
<DIV>副 主 考：封幸力  卓铭阳</DIV>
<DIV> </DIV>
<DIV><B>（二）考 务 组：</B><B>（在实南203）</B></DIV>
<DIV>俞自强   陈合力   王月琴    宣方军   金建
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/241.aspx" target="_self" title="标题：高考三项考试试场布置要求及有关事项&#xD;点击数：551&#xD;发表时间：09年09月10日">高考三项考试试场布置要求及有关事项</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/249.aspx" target="_self" title="标题：2009年9月绍兴一中考点英语听力试场编排表&#xD;点击数：578&#xD;发表时间：09年09月11日">2009年9月绍兴一中考点英语听力试场编排表</a>[ 09-11 ]</div>
                        </div>
                    </div>
