...
<head>
    ...
    <title>学习委员开会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3965"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3965},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3965";
     ...
     <P> 各班学习委员：</P>
<P>    请高一、高二、高三各班学习委员于明天（星期二）中午12：15到行政楼五楼会议室开会，学生会学习部成员同时参加，并随带笔。请同学们相互转告，务必准时出席。</P>
<P>                                                                                         教学处</P>
<P>                                                                                           5.16</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3949.aspx" target="_self" title="标题：高三三项考试成绩校对&#xD;点击数：608&#xD;发表时间：11年05月13日">高三三项考试成绩校对</a>[ 05-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3967.aspx" target="_self" title="标题：高三班主任领取会考证书&#xD;点击数：439&#xD;发表时间：11年05月16日">高三班主任领取会考证书</a>[ 05-16 ]</div>
                        </div>
                    </div>
