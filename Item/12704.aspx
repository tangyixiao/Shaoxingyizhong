...
<head>
    ...
    <title>化学汇报课通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12704"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12704},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12704";
     ...
     <p><span style="color: rgb(17, 31, 44); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI SymbolMyanmar Text", 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);"> 1月27日（周三）下午第8节，在高三（7）班教室，由谢君樑老师执教汇报课。欢迎老师们莅临指导。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12676.aspx" target="_self" title="标题：物理组汇报课两则&#xD;点击数：265&#xD;发表时间：21年01月21日">物理组汇报课两则</a>[ 01-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12734.aspx" target="_self" title="标题：心理健康教育B证培训报名通知&#xD;点击数：215&#xD;发表时间：21年01月29日">心理健康教育B证培训报名通知</a>[ 01-29 ]</div>
                        </div>
                    </div>
