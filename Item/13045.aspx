...
<head>
    ...
    <title>第五周早上迟到学生统计--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">第五周早上迟到学生统计</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>第五周早上迟到学生统计</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2021年04月02日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13045"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13045},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13045";
     ...
     <p>第五周早上迟到学生统计</p><p style="line-height: 16px;"><img style="vertical-align: middle; margin-right: 2px;" src="http://10.176.17.2/UEditor/dialogs/attachment/fileTypeImages/icon_xls.gif" /><a style="font-size:12px; color:#0066cc;" href="/Shaoxingyizhong/UploadFiles/xwzx/2021/4/202104020839243393.xlsx" title="202104020839243393.xlsx">202104020839243393.xlsx</a></p><p>
</p><p>德育处</p><p>2021年4月2日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13042.aspx" target="_self" title="标题：大课间跑操暂停通知&#xD;点击数：52&#xD;发表时间：21年04月02日">大课间跑操暂停通知</a>[ 04-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13056.aspx" target="_self" title="标题：校民乐团成员训练通知&#xD;点击数：121&#xD;发表时间：21年04月06日">校民乐团成员训练通知</a>[ 04-06 ]</div>
                        </div>
                    </div>
