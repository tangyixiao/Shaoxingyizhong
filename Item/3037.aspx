...
<head>
    ...
    <title>今天早上升旗仪式取消--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3037"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3037},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3037";
...
<P>    因天雨，今天早上的升旗仪式取消。特此通知。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3034.aspx" target="_self" title="标题：值周检查情况汇总（12月10日星期五）&#xD;点击数：327&#xD;发表时间：10年12月11日">值周检查情况汇总（12月10日星期五）</a>[ 12-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3047.aspx" target="_self" title="标题：值周检查情况汇总（12月13日星期一）&#xD;点击数：372&#xD;发表时间：10年12月14日">值周检查情况汇总（12月13日星期一）</a>[ 12-14 ]</div>
                        </div>
                    </div>
