...
<head>
    ...
    <title>高三生物1B学分考延期通知（急）--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三生物1B学分考延期通知（急）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=309"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:309},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=309";
     ...
     <P>    <FONT size=5>   原定今天（9月21日）下午举行的<FONT face=Verdana>高三生物1B学分考因故延期。具体考试时间到时看通知。</FONT></FONT></P>
<P><FONT size=5>                 &nbs
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/307.aspx" target="_self" title="标题：9月21日（周一）高三生物1B学分考监考安排&#xD;点击数：464&#xD;发表时间：09年09月21日">9月21日（周一）高三生物1B学分考监考安排</a>[ 09-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/310.aspx" target="_self" title="标题：关于领取《教育新视野》的通知&#xD;点击数：307&#xD;发表时间：09年09月21日">关于领取《教育新视野》的通知</a>[ 09-21 ]</div>
                        </div>
                    </div>
