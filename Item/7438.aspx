...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7438"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7438},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7438";
     ...
     <FONT size=4>今天上午美术组全体老师外出教研活动，相关班级美术课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7435.aspx" target="_self" title="标题：关于高三周六上课调整通知&#xD;点击数：522&#xD;发表时间：17年10月11日">关于高三周六上课调整通知</a>[ 10-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7439.aspx" target="_self" title="标题：历史教研活动通知&#xD;点击数：206&#xD;发表时间：17年10月12日">历史教研活动通知</a>[ 10-12 ]</div>
                        </div>
                    </div>
