...
<head>
    ...
    <title>班长开会通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15067"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15067},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15067";
     ...
     <p>定于今天（3月1日）傍晚17：40在2112教室召开各班班长会议，请大家准时参加不要迟到。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15063.aspx" target="_self" title="标题：2.28班级一日考核&#xD;点击数：45&#xD;发表时间：22年03月01日">2.28班级一日考核</a>[ 03-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15068.aspx" target="_self" title="标题：3.01跑操量化考核反馈&#xD;点击数：119&#xD;发表时间：22年03月01日">3.01跑操量化考核反馈</a>[ 03-01 ]</div>
                        </div>
                    </div>
