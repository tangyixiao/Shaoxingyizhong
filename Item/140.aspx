...
<head>
    ...
    <title>请各班主任提醒住校生请注意--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">请各班主任提醒住校生请注意</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=140"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:140},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=140";
     ...
     高一、高三各班主任：请提醒本班住校生尽快按照自己的住宿标准缴纳住宿费，然后以寝室为单位把缴费回执交给住管处李老师。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/133.aspx" target="_self" title="标题：各教研组组长、各类竞赛兴趣小组负责人请注意&#xD;点击数：591&#xD;发表时间：09年08月24日">各教研组组长、各类竞赛兴趣小组负责人请注意</a>[ 08-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/142.aspx" target="_self" title="标题：各班值日提醒&#xD;点击数：449&#xD;发表时间：09年08月25日">各班值日提醒</a>[ 08-25 ]</div>
                        </div>
                    </div>
