...
<head>
    ...
    <title>完善信息管理系统通知（急）--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">完善信息管理系统通知（急）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>完善信息管理系统通知（急）</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年09月20日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2495"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2495},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2495";
     ...
     <P>       </P>
<P>        经过检查，高一部分班级的信息管理系统内容还未完全录入。请各班主任进行自查，督促学生，在今、明两天抓紧时间录入、完善。过期相关的学生基本信息不能导入到浙江省信息管理系统，后果自负。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2492.aspx" target="_self" title="标题：重申早自修纪律&#xD;点击数：503&#xD;发表时间：10年09月18日">重申早自修纪律</a>[ 09-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2503.aspx" target="_self" title="标题：高一研究性课程上课通知&#xD;点击数：337&#xD;发表时间：10年09月21日">高一研究性课程上课通知</a>[ 09-21 ]</div>
                        </div>
                    </div>
