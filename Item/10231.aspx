...
<head>
    ...
    <title>2019年高考考务培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2019年高考考务培训通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10231"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10231},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10231";
     ...
     <SPAN lang=EN-US>6</SPAN>月<SPAN lang=EN-US>6</SPAN>日（周四）下午<SPAN lang=EN-US>1</SPAN>：<SPAN lang=EN-US>30</SPAN>—<SPAN lang=EN-US>3</SPAN>：<SPAN lang=EN-US>00</SPAN>进行2019年高考监考培训。地点：图书馆<SPAN lang=EN-US>3</SPAN>楼报告厅<SPAN lang=EN-US>2</SPAN>，全体监考老师（包括在本校和去稽山中学的场内、预备、视频、流动监考）、考务工作人会员参加。<STRONG>请随带笔。</STRONG>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10228.aspx" target="_self" title="标题：2019年高考绍兴一中考点试场编排表&#xD;点击数：500&#xD;发表时间：19年06月05日">2019年高考绍兴一中考点试场编排表</a>[ 06-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10243.aspx" target="_self" title="标题：绍兴市高一期末调测（第一阶段）考试安排&#xD;点击数：798&#xD;发表时间：19年06月12日">绍兴市高一期末调测（第一阶段）考试安排</a>[ 06-12 ]</div>
                        </div>
                    </div>
