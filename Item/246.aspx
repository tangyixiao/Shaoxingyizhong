...
<head>
    ...
    <title>班主任请注意（关于食堂就餐等问题）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">班主任请注意（关于食堂就餐等问题）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年09月11日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=246"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:246},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=246";
...
<P><FONT size=5><STRONG>   新学期采取了一系列措施，学生的各方面习惯有所改变，但是还有一些不尽如人意的地方，请各位再关照学生，希望他们能不折不扣地做到：</STRONG></FONT></P>
<P><FONT size=5><STRONG>   1.在食堂就餐完毕以后，请自觉把餐具放到餐具回收处。高一、高二学生做得比较好，请继续保持，高三年
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/240.aspx" target="_self" title="标题：2009年高一军训会操结果&#xD;点击数：471&#xD;发表时间：09年09月10日">2009年高一军训会操结果</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/252.aspx" target="_self" title="标题：关于“中华赞诗词歌赋创作大赛”有关事项&#xD;点击数：554&#xD;发表时间：09年09月11日">关于“中华赞诗词歌赋创作大赛”有关事项</a>[ 09-11 ]</div>
                        </div>
                    </div>
