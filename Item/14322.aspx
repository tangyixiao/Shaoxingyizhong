...
<head>
    ...
    <title>全校安全委员会议通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14322"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14322},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14322";
     ...
     <p>全校安全委员：</p><p>     明天（周三）中午12：20分，在4112阶梯教室召开近期安全与预防呼吸道传染病的工作会议，请准时出席。</p><p>                                                                         安全处、医务室</p><p>                                                                        2021年11月2日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14290.aspx" target="_self" title="标题：关于体质测试封闭部分场地、道路的通知&#xD;点击数：290&#xD;发表时间：21年10月29日">关于体质测试封闭部分场地、道路的通知</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14389.aspx" target="_self" title="标题：关于全体教工完成两项反诈应用注册工作的通知&#xD;点击数：138&#xD;发表时间：21年11月11日">关于全体教工完成两项反诈应用注册工作的通知</a>[ 11-11 ]</div>
                        </div>
                    </div>
