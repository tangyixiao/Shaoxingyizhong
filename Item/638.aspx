...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=638"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:638},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=638";
     ...
     <SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA"><FONT color=#000000>    以开展艺术实践和展现个人才华为宗旨，通过参与学校文艺演出，与外校联谊演出等活动，促进校园文化发展，反映学生精神面貌。</FONT></SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/637.aspx" target="_self" title="标题：辩论社&#xD;点击数：1892&#xD;发表时间：09年11月28日">辩论社</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/639.aspx" target="_self" title="标题：朗诵社&#xD;点击数：1636&#xD;发表时间：09年11月28日">朗诵社</a>[ 11-28 ]</div>
                        </div>
                    </div>
