    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年08月27日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=151"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:151},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=151";
     ...
     <P>    <FONT size=4>  经<FONT face=Verdana>检查，</FONT>今日早上军训期间，高一（6）、高一（9）、高一（12）门未关。请各班注意，做好安全防患工作。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/149.aspx" target="_self" title="标题：高一、高二、高三各班主任&#xD;点击数：553&#xD;发表时间：09年08月27日">高一、高二、高三各班主任</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/167.aspx" target="_self" title="标题：各班主任、各竞赛辅导教师请注意（关于开学典礼）&#xD;点击数：449&#xD;发表时间：09年08月31日">各班主任、各竞赛辅导教师请注意（关于开学典礼）</a>[ 08-31 ]</div>
                        </div>
                    </div>
