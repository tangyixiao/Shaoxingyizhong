...
<head>
    ...
    <title>高三自选综合成绩登录--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1571"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1571},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1571";
       ...
       请各班主任将本班3月29日自选综合成绩放在公共文件夹/朱国强/2010高三自选综合内。文件夹内有上几次成绩的分析。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1540.aspx" target="_self" title="标题：高三班主任上午到教学楼Ⅱ领取本班学生体检表格&#xD;点击数：396&#xD;发表时间：10年03月27日">高三班主任上午到教学楼Ⅱ领取本班学生体检表格</a>[ 03-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1624.aspx" target="_self" title="标题：高三市教学质量调测期间安排&#xD;点击数：1459&#xD;发表时间：10年04月06日">高三市教学质量调测期间安排</a>[ 04-06 ]</div>
                        </div>
                    </div>
