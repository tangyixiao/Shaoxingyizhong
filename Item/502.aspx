...
<head>
    ...
    <title>2009学年第一学期高三期中考试场安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2009学年第一学期高三期中考试场安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=502"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:502},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=502";
     ...
     <p style="display:none;">三年级理科#各班级排号.xls</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/501.aspx" target="_self" title="标题：关于实行冬令时间的通知&#xD;点击数：396&#xD;发表时间：09年11月03日">关于实行冬令时间的通知</a>[ 11-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/504.aspx" target="_self" title="标题：高二、高三班主任(有关会考报名）：&#xD;点击数：386&#xD;发表时间：09年11月04日">高二、高三班主任(有关会考报名）：</a>[ 11-04 ]</div>
                        </div>
                    </div>
