...
<head>
    ...
    <title>信息学冬令营文艺节目排练通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">信息学冬令营文艺节目排练通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6347"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6347},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6347";
         ...
         参加信息学冬令营节目表演的全体成员，请于19号（周四）上午8点30分到校（形体房集中）参加节目排练。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6343.aspx" target="_self" title="标题：高一高二休业式暨法制教育通知&#xD;点击数：462&#xD;发表时间：17年01月16日">高一高二休业式暨法制教育通知</a>[ 01-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6348.aspx" target="_self" title="标题：高三住校生离校通知&#xD;点击数：182&#xD;发表时间：17年01月17日">高三住校生离校通知</a>[ 01-17 ]</div>
                        </div>
                    </div>
