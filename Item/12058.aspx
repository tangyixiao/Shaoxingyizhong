...
<head>
    ...
    <title>参加市运动会出征动员提醒--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">参加市运动会出征动员提醒</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12058"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12058},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12058";
     ...
     <FONT size=4>参加运动会出征会议的同学务必到会，如有选修课请假。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12057.aspx" target="_self" title="标题：体育课改自修通知&#xD;点击数：331&#xD;发表时间：20年10月29日">体育课改自修通知</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12072.aspx" target="_self" title="标题：班主任会议通知&#xD;点击数：334&#xD;发表时间：20年11月02日">班主任会议通知</a>[ 11-02 ]</div>
                        </div>
                    </div>
