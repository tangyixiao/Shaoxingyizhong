...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3682"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3682},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3682";
     ...
     <P>                                      文明办公室检查</P>
<P>     今天下午第三节课进行文明办公室检查,请各办公室认真整理,打扫.天气转热,希望能保持环境良好状态.</P>
<P>    请今天白天值班的高一、高二和高三的老师在下午第三节课到教学处（2）集中。</P>
<P>                                                             校文明办公室检查小组</P>
<P>                                                                    2011.4.8</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3601.aspx" target="_self" title="标题：工会公告&#xD;点击数：551&#xD;发表时间：11年03月26日">工会公告</a>[ 03-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3719.aspx" target="_self" title="标题：文明办公室检查&#xD;点击数：476&#xD;发表时间：11年04月14日">文明办公室检查</a>[ 04-14 ]</div>
                        </div>
                    </div>
