...
<head>
    ...
    <title>新生集会座位安排--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2026"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2026},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2026";
     ...
     <P><FONT size=4>下午3:00-5:00高一新生在报告厅集会，请各班按指定位置就坐。座位安排如下：</FONT></P>
<P><FONT size=4> 附件</FONT>    <A title=新生集会座位安排 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201006/2010061013490071.xls"><STRONG><FONT size=4>新生集会座位安排</FONT></STRONG></A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2023.aspx" target="_self" title="标题：高三各班主任&#xD;点击数：361&#xD;发表时间：10年06月10日">高三各班主任</a>[ 06-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2029.aspx" target="_self" title="标题：高一、高二各班主任（关于期末考核）&#xD;点击数：571&#xD;发表时间：10年06月11日">高一、高二各班主任（关于期末考核）</a>[ 06-11 ]</div>
                        </div>
                    </div>
