...
<head>
    ...
    <title>假期注意事项提醒--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5442"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5442},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5442";
     ...
     <P><FONT size=4>后天起将继续暑期放假，请各位班主任和任课老师根据学生实际情况做好以下工作：</FONT></P>
<P><FONT size=4>1、请各备课组适当布置假期作业。</FONT></P>
<P><FONT size=4>2、请高二、高三各班主任提醒学生认真复习准备回头考。</FONT></P>
<P><FONT size=4>3、请高二、高三各班主任及相关任课老师做好即将到来的选考、学考复习迎考动员。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5440.aspx" target="_self" title="标题：2015学年奖学金获得者名单公示&#xD;点击数：289&#xD;发表时间：16年08月18日">2015学年奖学金获得者名单公示</a>[ 08-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5446.aspx" target="_self" title="标题：高二回头考试场编排和监考安排(有修改）&#xD;点击数：859&#xD;发表时间：16年08月19日">高二回头考试场编排和监考安排(有修改）</a>[ 08-19 ]</div>
                        </div>
                    </div>
