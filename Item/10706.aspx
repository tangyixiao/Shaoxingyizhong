...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10706"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10706},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10706";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                      ...
                      由于天气原因，今天升旗仪式暂停。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10702.aspx" target="_self" title="标题：民乐队集训通知&#xD;点击数：288&#xD;发表时间：19年10月12日">民乐队集训通知</a>[ 10-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10707.aspx" target="_self" title="标题：各班体育委员会议通知&#xD;点击数：242&#xD;发表时间：19年10月14日">各班体育委员会议通知</a>[ 10-14 ]</div>
                        </div>
                    </div>
