...
<head>
    ...
    <title>周四晚专题报告工作人员安排--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">周四晚专题报告工作人员安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3641"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3641},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3641";
     ...
     <P><FONT size=4>        本周四晚上7：00在报告厅举行关于《2011高考家长该做些什么》专题报告，请以下有关工作人员在晚上6：20分之前到位：</FONT></P>
<P><FONT size=4>        组织工作：俞建种、张小娟</FONT></P>
<P><FONT size=4>        音响：朱玛莉、张木红</FONT></P>
<P><FONT size=4>        摄影：焦大伟</FONT></P>
<P><FONT size=4>        电脑屏幕：祝建强</FONT></P>
<P><FONT size=4>        校门口车辆引导：陈龙珠、刘明玉、童莉芳、王海燕</FONT></P>
<P><FONT size=4>        报告厅座位引导：梁边、蔡继芳、李峰红</FONT></P>
<P><FONT size=4>        另：高三全体班主任也一起参加。</FONT></P>
...
<P><FONT size=4>        </FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3640.aspx" target="_self" title="标题：关于主题班团课的通知（有改动）&#xD;点击数：525&#xD;发表时间：11年03月30日">关于主题班团课的通知（有改动）</a>[ 03-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3643.aspx" target="_self" title="标题：3月31日校牌检查结果公布（二十五）&#xD;点击数：535&#xD;发表时间：11年03月31日">3月31日校牌检查结果公布（二十五）</a>[ 03-31 ]</div>
                        </div>
                    </div>
