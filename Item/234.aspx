...
<head>
    ...
    <title>我最喜欢的校服式样推荐--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">我最喜欢的校服式样推荐</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年09月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=234"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:234},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=234";
     ...
     <DIV align=center><FONT size=6><B>我最喜欢的校服式样推荐</B><B></B></FONT></DIV>
<DIV><FONT size=5><STRONG>全校老师和同学：</STRONG></FONT></DIV>
<DIV><FONT size=5><STRONG>    为了让我们的校服更加青春时尚，赢得更多同学的喜欢，打造好校园“亮丽的风景线”，学校决定在全校范围内征集“我最喜欢的校服”式样图片，然后由民主投票来决定“最时
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/222.aspx" target="_self" title="标题：大扫除通知&#xD;点击数：530&#xD;发表时间：09年09月07日">大扫除通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/239.aspx" target="_self" title="标题：感谢原高一（7）班、（10）班、（11）班三个团支部&#xD;点击数：574&#xD;发表时间：09年09月10日">感谢原高一（7）班、（10）班、（11）班三个团支部</a>[ 09-10 ]</div>
                        </div>
                    </div>
