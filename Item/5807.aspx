...
<head>
    ...
    <title>明天运动会通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5807"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5807},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5807";
     ...
     <P>全校师生：</P>
<P>     根据天气预报，明天上午一二节课时间可能下雨，请每位师生做好正常上课准备（如遇90学时的老师外出，请班主任协调处理）。天晴则正常运动会，按秩序册上的项目比赛。</P>
<P>       请各知晓。</P>
<P>                                                                   校办</P>
<P>                                                                 10月27日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5804.aspx" target="_self" title="标题：关于2017年教工报刊杂志征订的通知&#xD;点击数：1108&#xD;发表时间：16年10月27日">关于2017年教工报刊杂志征订的通知</a>[ 10-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5823.aspx" target="_self" title="标题：关于2016年教工体检的通知&#xD;点击数：328&#xD;发表时间：16年10月31日">关于2016年教工体检的通知</a>[ 10-31 ]</div>
                        </div>
                    </div>
