...
<head>
    ...
    <title>高三体育课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6823"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6823},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6823";
     ...
     因体育组全体老师外出参加市中考培训，今天下午高三相关班级体育课改自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6819.aspx" target="_self" title="标题：2017年创新班期中考试安排（有修改）&#xD;点击数：485&#xD;发表时间：17年04月25日">2017年创新班期中考试安排（有修改）</a>[ 04-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6827.aspx" target="_self" title="标题：高一部分选修课改自修通知&#xD;点击数：187&#xD;发表时间：17年04月27日">高一部分选修课改自修通知</a>[ 04-27 ]</div>
                        </div>
                    </div>
