...
<head>
    ...
    <title>本周六（10月26日）高一学生大会通知--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">本周六（10月26日）高一学生大会通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20432"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20432},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20432";
     ...
     <p>高一学生大会定于10月26日（周六）上午10:15在图书馆三楼报告厅举行，要求全体高一学生参加，上午第三节课结束后马上进场，并在<span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; background-color: rgb(255, 255, 255);">指定位置就位。请各班有序入场，<span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; background-color: rgb(255, 255, 255);">自觉遵守会场纪律</span>。</span></p><p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2024/10/202410251017078006.jpg" style="max-width: 100%; " title="202410251017078006.jpg" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20427.aspx" target="_self" title="标题：高一晚自修值班安排（10.27-11.8）&#xD;点击数：359&#xD;发表时间：24年11月05日">高一晚自修值班安排（10.27-11.8）</a>[ 11-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20485.aspx" target="_self" title="标题：高一晚自修值班安排（11.10-11.22）&#xD;点击数：320&#xD;发表时间：24年11月19日">高一晚自修值班安排（11.10-11.22）</a>[ 11-19 ]</div>
                        </div>
                    </div>
