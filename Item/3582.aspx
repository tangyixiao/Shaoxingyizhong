...
<head>
    ...
    <title>高一三好学生、优秀学生干部初评通知--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一三好学生、优秀学生干部初评通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3582"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3582},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3582";
     ...
     <P>    各位评委，2011年高一市属级及以上三好学生、优秀学生干部参评学生材料在公共文件夹/物理/朱国强/高一市属三好优干评选中 ，请拔冗审阅，按学校要求推荐，今天完成。</P>
<P align=right>高一年级</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3506.aspx" target="_self" title="标题：高一支部会议&#xD;点击数：317&#xD;发表时间：11年03月10日">高一支部会议</a>[ 03-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3638.aspx" target="_self" title="标题：高一白天值班安排(4月6日~4月30日)&#xD;点击数：458&#xD;发表时间：11年03月30日">高一白天值班安排(4月6日~4月30日)</a>[ 03-30 ]</div>
                        </div>
                    </div>
