...
<head>
    ...
    <title>晚间安全检查记录2016.9.30--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2016.9.30</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：晚间安全检查记录2016.9.30</span> <span>发布时间：2016年10月04日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5656"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5656},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5656";
     ...
     9月30日晚，高二（14）班教室门和窗未关。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5648.aspx" target="_self" title="标题：每日晨检表未交情况通报9.30&#xD;点击数：91&#xD;发表时间：16年09月30日">每日晨检表未交情况通报9.30</a>[ 09-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5659.aspx" target="_self" title="标题：晚间安全检查记录2016.10.4&#xD;点击数：100&#xD;发表时间：16年10月05日">晚间安全检查记录2016.10.4</a>[ 10-05 ]</div>
                        </div>
                    </div>
