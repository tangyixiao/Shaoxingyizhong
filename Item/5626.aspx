...
<head>
    ...
    <title>关于一师一优课网上报名和晒课的提醒--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于一师一优课网上报名和晒课的提醒</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>关于一师一优课网上报名和晒课的提醒</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2016年09月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5626"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5626},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5626";
     ...
     <P> </P>
<P>各位老师：</P>
<P>2016年度一师一优课网上报名和晒课工作即将截止，因此项工作与教室个人培训考核相关，请尚未报名的老师抓紧完成报名工作，尚未晒课的老师尽快上传相关文档。</P>
<P>温馨提醒：</P>
<P>（1）用与师训平台相同的账号和密码登陆。忘记密码的老师请登陆师训平台，使用“忘记密码”，重置密码后再登陆教育云网站。</P>
<P>（2）去年已经报名的老师今年仍须报名。进入活动报名界面，无须填写个人信息，点击保存即可。第一次报名的老师需先填写个人信息，再点击保存。</P>
<P>（3）因网站出于访问人数高峰期，可能出现网页卡的情况，可采取两种方式解决：一是使用手机报名，最好使用数据流量，打开速度更快（加载网页消耗的流量很少）。二是点击活动报名界面，等待网页加载10分钟以上，或可完成报名。然后与信息处邓倬霖或课程处王佩金联系，确认是否报名成功。</P>
<P>（4）需要晒课的老师建议在网页加载良好时，优先上传教学设计等三个文档。教学视频可后续上传。</P>
<P> </P>
<P>课程处</P>
<P>2016.9.28</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5605.aspx" target="_self" title="标题：关于学科组教研计划与备课计划上交的通知&#xD;点击数：119&#xD;发表时间：16年09月26日">关于学科组教研计划与备课计划上交的通知</a>[ 09-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5635.aspx" target="_self" title="标题：关于本学期选修课课程安排的通知&#xD;点击数：638&#xD;发表时间：16年09月29日">关于本学期选修课课程安排的通知</a>[ 09-29 ]</div>
                        </div>
                    </div>
