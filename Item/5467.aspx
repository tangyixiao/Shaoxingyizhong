...
<head>
    ...
    <title>关于贫困生调查摸底的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于贫困生调查摸底的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5467"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5467},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5467";
     ...
     <P>各位班主任：</P>
<P>       2016秋季<FONT size=4><STRONG>贫困生资助工作已经开始。</STRONG>请在最近几天做好班级内贫困生调查摸底工作，申请表到各段长处领取，一式二份。请学生认真填写家庭困难申请理由等详细情况，有困难证的（低保户、低保边缘户、因病致贫困户、就学困难户、烈士子女）提供相应困难家庭证明复印件，并到街道或村委盖好章，在中秋节后交给德育处童莉芳老师。</FONT></P>
<P><FONT size=4>注：</FONT></P>
<P><FONT size=4>资助类型栏填：1类（低保户、低保边缘户子女），2类（孤儿），3类（经济特别困难的单亲家庭子女），4类（因受灾、疾病等原因造成家庭经济特别困难的子女），5类（革命烈士子女）。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5464.aspx" target="_self" title="标题：绍兴一中2015学年各项获奖名单&#xD;点击数：263&#xD;发表时间：16年09月08日">绍兴一中2015学年各项获奖名单</a>[ 09-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5471.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：63&#xD;发表时间：16年09月09日">大课间操暂停通知</a>[ 09-09 ]</div>
                        </div>
                    </div>
