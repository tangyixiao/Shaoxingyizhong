...
<head>
    ...
    <title>关于德、工、安、团、总分组交流的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于德、工、安、团、总分组交流的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11019"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11019},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11019";
     ...
     <P>       请德、工、安、团、总相关成员于今天下午第三节课在树兰楼支部活动室六进行教工年度考核分组交流，请大家提前安排好各自工作准时参加，并随带笔和考核登记表（未交）。</P>
<P align=right>德育处</P>
...
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11018.aspx" target="_self" title="标题：2019学年第一学期学生先进评比办法&#xD;点击数：385&#xD;发表时间：19年12月16日">2019学年第一学期学生先进评比办法</a>[ 12-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11021.aspx" target="_self" title="标题：第四期主题班会通知&#xD;点击数：168&#xD;发表时间：19年12月16日">第四期主题班会通知</a>[ 12-16 ]</div>
                        </div>
                    </div>
