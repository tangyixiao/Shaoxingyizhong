...
<head>
    ...
    <title>检查情况通报--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8232"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8232},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8232";
     ...
     <DIV>  根据上级部门要求和学校的工作部署，昨天（3月27日）下午第四节课，学校纪委组织相关领导对全校教工的工作纪律进行了一次检查。从检查情况来看，绝大部分教工都在岗在位，工作纪律良好，但也有个别教工缺岗，不在办公室。希望这些老师能及时向党政办舒凤老师说明一下情况。感谢大家的理解和支持！<BR></DIV>
<DIV>                                      党政办<BR>                                     3月28日<BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8211.aspx" target="_self" title="标题：关于学校无线网络认证暂停服务的通知&#xD;点击数：426&#xD;发表时间：18年03月23日">关于学校无线网络认证暂停服务的通知</a>[ 03-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8253.aspx" target="_self" title="标题：关于党员教师加强政治学习的通知&#xD;点击数：601&#xD;发表时间：18年03月31日">关于党员教师加强政治学习的通知</a>[ 03-31 ]</div>
                        </div>
                    </div>
