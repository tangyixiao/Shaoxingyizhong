...
<head>
    ...
    <title>银杏文学社--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=632"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:632},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=632";
     ...
     <FONT color=#000000><FONT size=2><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">    银杏文学社是校级文学类社团，成立于上个世纪，因老校区（今一中初中部）的一棵历经沧桑却依然枝繁叶茂的银杏树而得名。社团以提升学生文学素养，提高学生写作水平，丰富校园文化生活为宗旨，为广大文学爱好者搭建了一个燃烧青春幻梦，碰撞灵感激情，谱写豪迈人生的平台。社团主要通过讲座交流、采风调查、征文比赛等方式开展活动，并设有自己文学刊物《银杏芃芃》。社团自创办以来，已有数百位成员获得全国、省、市各级各类文学大奖。</SPAN><FONT face=宋体><SPAN lang=EN-US style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-fareast-font-family: 宋体">2006</SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">年，社团在市“电信宽带杯”网络夏令营活动中荣获“绍兴市最具实力社团”称号。</SPAN></FONT></FONT></FONT>
                        ...
                        <div class="others">
                            ...
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/633.aspx" target="_self" title="标题：记者团&#xD;点击数：1285&#xD;发表时间：09年11月28日">记者团</a>[ 11-28 ]</div>
                        </div>
                    </div>
