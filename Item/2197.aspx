...
<head>
    ...
    <title>结算文印费通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2197"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2197},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2197";
     ...
     <P>高一、高二各班班主任:</P>
<P>        因学期即将结束,请各班班主任通知本班生活委员于今、明两天到校文印室及时结清文印费,请相互转告!</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2189.aspx" target="_self" title="标题：绍兴一中德育处副主任兼高三年级长任前公示&#xD;点击数：657&#xD;发表时间：10年07月02日">绍兴一中德育处副主任兼高三年级长任前公示</a>[ 07-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2202.aspx" target="_self" title="标题：关于先进候选人上传个人书面总结的通知&#xD;点击数：1340&#xD;发表时间：10年07月03日">关于先进候选人上传个人书面总结的通知</a>[ 07-03 ]</div>
                        </div>
                    </div>
