...
<head>
    ...
    <title>高三任课老师会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9167"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9167},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9167";
     ...
     <FONT size=4>请高三年级任课老师于明天（6日）下午3:30到树兰楼三楼会议室二召开市高三诊断性测试分析会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9166.aspx" target="_self" title="标题：高三物理精英班上课通知&#xD;点击数：223&#xD;发表时间：18年10月05日">高三物理精英班上课通知</a>[ 10-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9180.aspx" target="_self" title="标题：英语教研活动通知&#xD;点击数：209&#xD;发表时间：18年10月09日">英语教研活动通知</a>[ 10-09 ]</div>
                        </div>
                    </div>
