...
<head>
    ...
    <title>相关教师交照片的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">相关教师交照片的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>相关教师交照片的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年08月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2295"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2295},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2295";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3>    今年从分校回到本校及新分配来校的教师，请近两天内交一寸照片到卓副校长处，办卡要用！</FONT></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2289.aspx" target="_self" title="标题：绍兴一中校园电子显示屏使用规程（暂行）&#xD;点击数：609&#xD;发表时间：10年08月25日">绍兴一中校园电子显示屏使用规程（暂行）</a>[ 08-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2296.aspx" target="_self" title="标题：马校长《在2010级新生军训开营式上的讲话》&#xD;点击数：686&#xD;发表时间：10年08月26日">马校长《在2010级新生军训开营式上的讲话》</a>[ 08-26 ]</div>
                        </div>
                    </div>
