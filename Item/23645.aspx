...
<head>
    ...
    <title>关于各班提交2026学生代表名单的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于各班提交2026学生代表名单的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23645"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23645},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23645";
     ...
     <p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: center; font-family: Calibri; font-size: 14px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;">关于各班提交202</span><span style="font-family: 宋体; font-size: 16px;">6</span><span style="font-family: 宋体; font-size: 16px;">学生代表名单的通知</span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: justify; font-family: Calibri; font-size: 14px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;">高一、高二各班：</span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: justify; font-family: Calibri; font-size: 14px; text-indent: 32px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;">我校第二十七</span><span style="font-family: 宋体; font-size: 16px;">次学生代表大会暨第二十七</span><span style="font-family: 宋体; font-size: 16px;">届团学联主席团选举大会即将举行。第二十六</span><span style="font-family: 宋体; font-size: 16px;">届主席团将做工作报告，由学生代表审议；第二十七</span><span style="font-family: 宋体; font-size: 16px;">届主席团成员将由学生代表民主选举产生</span><span style="font-family: 宋体; font-size: 16px;">。</span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: justify; font-family: Calibri; font-size: 14px; text-indent: 32px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;">请高一、高二各班选举产生学生代表提交至校团委，每班</span><span style="font-family: 宋体; font-size: 16px;">5</span><span style="font-family: 宋体; font-size: 16px;">人，其中包括班长/团支书至少1名。（主席团候选人不能作为学生代表进行投票。）</span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: justify; font-family: Calibri; font-size: 14px; text-indent: 32px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;">提交时间：</span><strong><span style="font-family: 宋体; color: rgb(255, 0, 0); font-size: 16px;">9月</span></strong><strong><span style="font-family: 宋体; color: rgb(255, 0, 0); font-size: 16px;">15</span></strong><strong><span style="font-family: 宋体; color: rgb(255, 0, 0); font-size: 16px;">日（周二</span></strong><strong><span style="font-family: 宋体; color: rgb(255, 0, 0); font-size: 16px;">）1</span></strong><strong><span style="font-family: 宋体; color: rgb(255, 0, 0); font-size: 16px;">7：00</span></strong><strong><span style="font-family: 宋体; color: rgb(255, 0, 0); font-size: 16px;">前</span></strong><span style="font-family: 宋体; font-size: 16px;">。请下载附件excel表格，填写本班学生代表名单，命名为班级序号（如101、201等），上传至公共文件夹“团委–0</span><span style="font-family: 宋体; font-size: 16px;">王青</span><span style="font-family: 宋体; font-size: 16px;">–团学联 - 202</span><span style="font-family: 宋体; font-size: 16px;">6</span><span style="font-family: 宋体; font-size: 16px;">学代会 - 学生代表名单”</span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: justify; font-family: Calibri; font-size: 14px; text-indent: 32px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;"></span></p><p style="line-height: 16px;"><img style="vertical-align: middle; margin-right: 2px;" src="http://10.176.17.2/UEditor/dialogs/attachment/fileTypeImages/icon_txt.gif" /><a style="font-size:12px; color:#0066cc;" href="/downloads/xwzx/2026/9/202609140841044978.xlsx" title="202609140841044978.xlsx">202609140841044978.xlsx</a></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: justify; font-family: Calibri; font-size: 14px; text-indent: 32px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;"></span>
</p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: justify; font-family: Calibri; font-size: 14px; text-indent: 32px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;"></span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: justify; font-family: Calibri; font-size: 14px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;"> </span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: justify; font-family: Calibri; font-size: 14px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;"> </span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: right; font-family: Calibri; font-size: 14px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;">校团委</span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); white-space: normal; text-align: right; font-family: Calibri; font-size: 14px; text-autospace: ideograph-numeric; line-height: 29px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 16px;">2026年9月14日</span></p><p>
</p>
