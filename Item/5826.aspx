...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5826"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5826},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5826";
     ...
     由于天气原因，今天大扫除暂停，希相互转告！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5820.aspx" target="_self" title="标题：升旗仪式改为广播讲话通知&#xD;点击数：110&#xD;发表时间：16年10月31日">升旗仪式改为广播讲话通知</a>[ 10-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5833.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：172&#xD;发表时间：16年11月01日">大课间操暂停通知</a>[ 11-01 ]</div>
                        </div>
                    </div>
