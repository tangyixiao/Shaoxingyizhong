    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年11月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=523"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:523},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=523";
     ...
     <DIV>   <FONT size=5>    定于11月9日下午4：10时，在行政五楼会议室召开绍兴一中第八届教代会第三次会议。请各位教代会代表准时出席。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/519.aspx" target="_self" title="标题：麻疹疫苗强化免疫摸底(班主任）&#xD;点击数：538&#xD;发表时间：09年11月06日">麻疹疫苗强化免疫摸底(班主任）</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/525.aspx" target="_self" title="标题：关于教代会的通知&#xD;点击数：540&#xD;发表时间：09年11月09日">关于教代会的通知</a>[ 11-09 ]</div>
                        </div>
                    </div>
