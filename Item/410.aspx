    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年10月15日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=410"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:410},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=410";
     ...
     <DIV align=center><FONT size=4>关于召开教研组长会议的通知</FONT></DIV>
<DIV align=left><FONT size=4></FONT> </DIV>
<DIV align=left><FONT size=4>    明天（星期五）下午第三节课，在行政楼三楼会议室召开教研组长会议，会议主要内容：1、各教研组有关教学教研工作交流；2、商议有关期中考试事宜。请各位组长安排好工作，拨冗参加。</FONT></DIV>
<
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/406.aspx" target="_self" title="标题：关于开展2009年教学案例征文活动的通知&#xD;点击数：381&#xD;发表时间：09年10月16日">关于开展2009年教学案例征文活动的通知</a>[ 10-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/411.aspx" target="_self" title="标题：语文教师外出教研活动课改自修&#xD;点击数：389&#xD;发表时间：09年10月16日">语文教师外出教研活动课改自修</a>[ 10-16 ]</div>
                        </div>
                    </div>
