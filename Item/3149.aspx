...
<head>
    ...
    <title>有关校本课程的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3149"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3149},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3149";
     ...
     <P>1、本周高一、高二校本课程暂停。</P>
<P>2、下周校本课程最后一次课，请相关老师完成考核，并将考核成绩上报教学处。</P>
<P>3、请各任课老师在1月10前，将校本课程教案放到教学处公共文件夹/2010学年第一学期校本课程/教案/高一（高二）中，统计课时必须要有教案。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3147.aspx" target="_self" title="标题：高二、高三班主任：会考准考证补办&#xD;点击数：335&#xD;发表时间：10年12月27日">高二、高三班主任：会考准考证补办</a>[ 12-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3154.aspx" target="_self" title="标题：高二会考模拟考监考安排&#xD;点击数：880&#xD;发表时间：10年12月28日">高二会考模拟考监考安排</a>[ 12-28 ]</div>
                        </div>
                    </div>
