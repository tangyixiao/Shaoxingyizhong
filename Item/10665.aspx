...
<head>
    ...
    <title>冬衣捐赠：关于统一收集冬衣的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">冬衣捐赠：关于统一收集冬衣的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10665"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10665},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10665";
     ...
     <P>统一收集时间：<BR><FONT color=#ff0000>    10月8日12:30-13:10<BR>    10月9日12:30-13:10</FONT></P>
<P>    请高一各班将收集的冬衣于该时间段内交至<FONT color=#ff0000>阶梯教室4104</FONT>，并以班级为单位登记衣物种类和数量。预先领取的袋子和卡片若数量不够，可至2114德育处团委办公室领取，或现场装袋。</P>
<P>    如有高二、高三的同学有意向捐赠，请直接将衣物于该时间段内拿到4104现场装袋、写祝福卡片，并登记班级、衣物种类和数量。</P>
<P>    如有老师有意向捐赠，可直接联系团委金笛（9296815）。</P>
<P>    本次活动由志愿者之家负责，请做好衣物收集、清点、登记、秩序维护等工作。</P>
<P align=right>校团委<BR>2019年10月7日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10663.aspx" target="_self" title="标题：社长沙龙：关于今天中午各学生社团负责人开会的通知&#xD;点击数：228&#xD;发表时间：19年10月07日">社长沙龙：关于今天中午各学生社团负责人开会的通知</a>[ 10-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10671.aspx" target="_self" title="标题：关于举行英语趣配音活动通知&#xD;点击数：1469&#xD;发表时间：19年10月08日">关于举行英语趣配音活动通知</a>[ 10-08 ]</div>
                        </div>
                    </div>
