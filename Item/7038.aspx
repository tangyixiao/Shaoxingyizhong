...
<head>
    ...
    <title>关于大课间操及升旗仪式的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于大课间操及升旗仪式的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7038"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7038},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7038";
     ...
     <P>   1.今天大课间操照常进行；</P>
<P>   2.5月31日（下周三）上周一的课，升旗仪式暂停，上课作息时间按照周三时间（第一节课7：45-8：25，依次类推）。</P>
<P>   3.5月31日、6月1日初三、高一、高二创新班进行阶段性考试，大课间操暂停。</P>
<P>     请相互告知，谢谢！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7032.aspx" target="_self" title="标题：表扬&#xD;点击数：252&#xD;发表时间：17年05月26日">表扬</a>[ 05-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7040.aspx" target="_self" title="标题：失物招领&#xD;点击数：205&#xD;发表时间：17年05月27日">失物招领</a>[ 05-27 ]</div>
                        </div>
                    </div>
