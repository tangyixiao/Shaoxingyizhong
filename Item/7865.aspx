...
<head>
    ...
    <title>自然摄影选修课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">自然摄影选修课改自修通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7865"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7865},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7865";
     ...
     <P> </P><!--StartFragment -->
<DIV>因老师工作冲突，今天下午自然摄影选修课改自修，请同学们在上课班级教室认真自修，遵守纪律。</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7863.aspx" target="_self" title="标题：数学90学时活动通知&#xD;点击数：186&#xD;发表时间：17年12月26日">数学90学时活动通知</a>[ 12-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7866.aspx" target="_self" title="标题：南开大学2018年物理科学营报名通知&#xD;点击数：194&#xD;发表时间：17年12月26日">南开大学2018年物理科学营报名通知</a>[ 12-26 ]</div>
                        </div>
                    </div>
