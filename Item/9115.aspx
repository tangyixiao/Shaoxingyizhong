...
<head>
    ...
    <title>德国友好学校来访相关课程调整通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">德国友好学校来访相关课程调整通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9115"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9115},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9115";
     ...
     <P><FONT size=4>下周因德国友好学校来我校交流访问，相关班级部分课程调整，具体安排如下：</FONT></P>
<P><FONT size=4>高一（05）班9月26日物理课调整到上午第2节，数学课调整到上午第1节。</FONT></P>
<P><FONT size=4>高三（10）班9月27日美术课改自修。</FONT></P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9113.aspx" target="_self" title="标题：绍兴市选考诊断性考试试场布置及考试相关要求&#xD;点击数：365&#xD;发表时间：18年09月22日">绍兴市选考诊断性考试试场布置及考试相关要求</a>[ 09-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9119.aspx" target="_self" title="标题：高一生涯规划课改自修通知&#xD;点击数：146&#xD;发表时间：18年09月25日">高一生涯规划课改自修通知</a>[ 09-25 ]</div>
                        </div>
                    </div>
