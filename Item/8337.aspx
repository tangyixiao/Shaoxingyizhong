...
<head>
    ...
    <title>关于2018年中国化学奥林匹克竞赛浙江省预赛的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于2018年中国化学奥林匹克竞赛浙江省预赛的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2018年04月11日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8337"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8337},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8337";
     ...
     <P><FONT size=4> 2018年中国化学奥林匹克竞赛浙江省预赛定于4月14日（星期六）上午9:00-11:00在绍兴市高级中学举行，请报名参加的同学于本周六上午8点30分之前到达考点【考生除了带考试用的笔、不能编程的计算器等以外，还需带有照片的有效证件（如学生证、身份证），以便监考老师和巡考人员核对考生的身份信息。】，并向班主任请好假，来回注意交通安全。<BR></FONT></P>
<P><FONT size=4>试场安排见附件。</FONT></P>
<P><FONT size=4>附件：</FONT><A title=试场安排表 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201804/2018041113512074.xls"><FONT size=4>试场安排表</FONT></A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8336.aspx" target="_self" title="标题：关于高三学生停止借书的通知&#xD;点击数：308&#xD;发表时间：18年04月11日">关于高三学生停止借书的通知</a>[ 04-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8339.aspx" target="_self" title="标题：高三部分学生会议通知&#xD;点击数：268&#xD;发表时间：18年04月12日">高三部分学生会议通知</a>[ 04-12 ]</div>
                        </div>
                    </div>
