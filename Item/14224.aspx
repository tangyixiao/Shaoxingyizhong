...
<head>
    ...
    <title>关于周五高一体育课和运动员办理身份证的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于周五高一体育课和运动员办理身份证的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14224"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14224},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14224";
     ...
     <p><span style="FONT-SIZE: 20px; FONT-FAMILY: 宋体,SimSun">1.因体检场地冲突和部分老师党史教育学习，周五下午高一体育课改自修。
2.参加市直比赛的运动员下周交身份证，如没办理过的周末抓紧办理。
3.因体检器材在体育馆，周五周六体育馆不开放。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14217.aspx" target="_self" title="标题：通用技术课自修通知&#xD;点击数：184&#xD;发表时间：21年10月20日">通用技术课自修通知</a>[ 10-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14251.aspx" target="_self" title="标题：通知&#xD;点击数：321&#xD;发表时间：21年10月25日">通知</a>[ 10-25 ]</div>
                        </div>
                    </div>
