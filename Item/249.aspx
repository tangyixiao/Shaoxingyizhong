...
<head>
    ...
    <title>2009年9月绍兴一中考点英语听力试场编排表--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2009年9月绍兴一中考点英语听力试场编排表</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=249"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:249},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=249";
     ...
     <TABLE style="WIDTH: 271pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=360 border=0 x:str>
<COLGROUP>
...
<COL style="WIDTH: 44pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/242.aspx" target="_self" title="标题：9月12日高考三项考试安排&#xD;点击数：521&#xD;发表时间：09年09月10日">9月12日高考三项考试安排</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/251.aspx" target="_self" title="标题：通知二则&#xD;点击数：467&#xD;发表时间：09年09月11日">通知二则</a>[ 09-11 ]</div>
                        </div>
                    </div>
