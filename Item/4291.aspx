...
<head>
    ...
    <title>新高一衔接教育报告厅活动时间--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">新高一衔接教育报告厅活动时间</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4291"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4291},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4291";
...
<P><FONT size=4>下午高一衔接教育报告厅活动开始时间:2:45,请提前15分钟开始进场.</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4281.aspx" target="_self" title="标题：关于上交新高二、新高三住校生申请表的通知&#xD;点击数：668&#xD;发表时间：11年07月03日">关于上交新高二、新高三住校生申请表的通知</a>[ 07-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4292.aspx" target="_self" title="标题：高一新生校讯通申请的通知&#xD;点击数：751&#xD;发表时间：11年07月05日">高一新生校讯通申请的通知</a>[ 07-05 ]</div>
                        </div>
                    </div>
