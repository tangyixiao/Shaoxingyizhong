...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9540"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9540},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9540";
     ...
     <FONT size=4>12月19日至21日地理组张豪、张伟丰、张超、郭志威、黄先辉、王月、胡唯亚、丁嫣然、王燕老师外出参加教研活动，相关班级地理课改自修。地理走班在相应上课教室自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9522.aspx" target="_self" title="标题：通用技术课改自修通知&#xD;点击数：249&#xD;发表时间：18年12月17日">通用技术课改自修通知</a>[ 12-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9551.aspx" target="_self" title="标题：本周六高二学考模拟考安排&#xD;点击数：1088&#xD;发表时间：18年12月21日">本周六高二学考模拟考安排</a>[ 12-21 ]</div>
                        </div>
                    </div>
