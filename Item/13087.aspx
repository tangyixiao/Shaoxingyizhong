...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13087"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13087},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13087";
     ...
     <p><span style="FONT-SIZE: 20px">因新教师招聘需要，4月8日（周四）高二年级体育课改自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13071.aspx" target="_self" title="标题：高三适应性考试后教学调整通知&#xD;点击数：432&#xD;发表时间：21年04月07日">高三适应性考试后教学调整通知</a>[ 04-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13111.aspx" target="_self" title="标题：关于排球比赛请假通知&#xD;点击数：350&#xD;发表时间：21年04月08日">关于排球比赛请假通知</a>[ 04-08 ]</div>
                        </div>
                    </div>
