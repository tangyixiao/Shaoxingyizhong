...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12617"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12617},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12617";
...
<P></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12615.aspx" target="_self" title="标题：关于召开全校年段长、班主任会议的通知&#xD;点击数：358&#xD;发表时间：21年01月11日">关于召开全校年段长、班主任会议的通知</a>[ 01-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12619.aspx" target="_self" title="标题：寻物启事两则&#xD;点击数：4339&#xD;发表时间：21年01月11日">寻物启事两则</a>[ 01-11 ]</div>
                        </div>
                    </div>
