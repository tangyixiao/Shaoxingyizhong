...
<head>
    ...
    <title>晚间安全检查记录2017.4.12--13--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2017.4.12--13</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6730"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6730},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6730";
     ...
     <P>1.高一（1）班窗未关，高一（11）前后门未关。</P>
<P>2.高一（3）班门未关，实验室5楼10.20有学生滞留。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6719.aspx" target="_self" title="标题：传达室不代收学生快件的通知&#xD;点击数：575&#xD;发表时间：17年04月13日">传达室不代收学生快件的通知</a>[ 04-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6738.aspx" target="_self" title="标题：安全教育平台教师授课完成情况(4月17)&#xD;点击数：295&#xD;发表时间：17年04月17日">安全教育平台教师授课完成情况(4月17)</a>[ 04-17 ]</div>
                        </div>
                    </div>
