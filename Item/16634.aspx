...
<head>
    ...
    <title>关于各班级安全委员来医务室领取《健康教育资料》的通知--校园安全-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_105/Index.aspx" target="_self">校园安全</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于各班级安全委员来医务室领取《健康教育资料》的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16634"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16634},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16634";
     ...
     <p><span style="color: rgb(23, 26, 29); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI Symbol", "Myanmar Text", 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">  请各班级安全委员来医务室领取《健康教育资料》。</span></p><p><span style="color: rgb(23, 26, 29); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI Symbol", "Myanmar Text", 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">                                                                                                          安全处</span></p><p><span style="color: rgb(23, 26, 29); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI Symbol", "Myanmar Text", 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">                                                                                                       2022.10.18</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16633.aspx" target="_self" title="标题：转发：绍兴市教育局关于切实做好国庆期间全市校园安全工作的通知&#xD;点击数：51&#xD;发表时间：22年09月27日">转发：绍兴市教育局关于切实做好国庆期间全市校园安全工作的通知</a>[ 09-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17059.aspx" target="_self" title="标题：创建平安校园|我校举行住校生消防知识培训暨应急疏散演练活动&#xD;点击数：172&#xD;发表时间：22年11月18日">创建平安校园|我校举行住校生消防知识培训暨应急疏散演练活动</a>[ 11-18 ]</div>
                        </div>
                    </div>
