...
<head>
    ...
    <title>重申流感预防措施--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">重申流感预防措施</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：安全</span> <span>发布时间：2009年11月06日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=518"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:518},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=518";
     ...
     <DIV><FONT size=4><B>预防流感，请牢记以下</B><B>7</B><B>招:</B></FONT></DIV>
<DIV><FONT size=3>1．注意卫生，勤洗手；</FONT></DIV>
<DIV><FONT size=3>2．勤换衣服，避免细菌繁殖；</FONT></DIV>
<DIV><FONT size=3>3．远离咳嗽的人，避免飞沫传播(1米之内，病毒就能通过飞沫进行传播)；</FONT></DIV>
<DIV><FONT size=3>4．加强营养，加强锻炼，增强自
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/513.aspx" target="_self" title="标题：通知&#xD;点击数：238&#xD;发表时间：09年11月05日">通知</a>[ 11-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/526.aspx" target="_self" title="标题：重申流感隔离要求&#xD;点击数：266&#xD;发表时间：09年11月09日">重申流感隔离要求</a>[ 11-09 ]</div>
                        </div>
                    </div>
