...
<head>
    ...
    <title>关于做好贫困学生工作--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于做好贫困学生工作</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>关于做好贫困学生工作</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年03月02日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1379"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1379},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1379";
     ...
     <P><FONT size=4><STRONG>各班主任：</STRONG></FONT></P>
<P><FONT size=4><STRONG>    请迅速上报新增贫困学生名单，并到德育处领取相关表格。</STRONG></FONT></P>
<P align=right><FONT size=4><STRONG>德育处</STRONG></FONT></P>
<P align=right><FONT size=4><STRONG>2010.3.2</STRONG></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1376.aspx" target="_self" title="标题：关于自行车问题&#xD;点击数：391&#xD;发表时间：10年03月02日">关于自行车问题</a>[ 03-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1393.aspx" target="_self" title="标题：今天升旗仪式暂停&#xD;点击数：320&#xD;发表时间：10年03月08日">今天升旗仪式暂停</a>[ 03-08 ]</div>
                        </div>
                    </div>
