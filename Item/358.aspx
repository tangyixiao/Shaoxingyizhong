...
<head>
    ...
    <title>关于参加全国中学生数学联赛的同学停课复习的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于参加全国中学生数学联赛的同学停课复习的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年10月06日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=358"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:358},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=358";
     ...
     <DIV align=left><FONT size=4>      10月11日将举行全国中学生数学联赛，我校下列同学将参赛。按照学校相关规定，这些同学本周可以停课准备竞赛。望班主任和各位任课老师给予支持。</FONT></DIV>
<DIV align=left><FONT size=4>附参赛学生名单。</FONT></DIV>
<DIV align=left>
<DIV><FONT size=4>    &n
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/350.aspx" target="_self" title="标题：高二、高三部分学生相片重拍通知&#xD;点击数：450&#xD;发表时间：09年09月29日">高二、高三部分学生相片重拍通知</a>[ 09-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/364.aspx" target="_self" title="标题：通知二则&#xD;点击数：278&#xD;发表时间：09年10月08日">通知二则</a>[ 10-08 ]</div>
                        </div>
                    </div>
