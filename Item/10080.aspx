...
<head>
    ...
    <title>关于高二通用2班和信息2班本学期永久调课的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高二通用2班和信息2班本学期永久调课的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10080"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10080},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10080";
     ...
     <FONT size=4>由于周三下午定为全市通用技术教师培训时间，为避免冲课和换课的麻烦，经商议，决定对高二技术走2班的上课安排作如下调整，即：将每周三下午第一节高二通用2班走班课与每周二上午第五节高二信息2班走班课时间永久调换；上课地点不变，换课从本周开始。请高二5班、13班、14班、15班、16班的同学互相转告，同时烦请相关班主任特别提醒本班技术选考学生。<BR></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10068.aspx" target="_self" title="标题：2019港澳高校在浙招生说明会&#xD;点击数：506&#xD;发表时间：19年05月05日">2019港澳高校在浙招生说明会</a>[ 05-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10090.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：306&#xD;发表时间：19年05月08日">化学教研活动通知</a>[ 05-08 ]</div>
                        </div>
                    </div>
