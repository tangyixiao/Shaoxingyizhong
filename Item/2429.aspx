...
<head>
    ...
    <title>关于催交家长委会名单的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于催交家长委会名单的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2429"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2429},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2429";
     ...
     <P><STRONG></STRONG> </P>
<P><FONT size=4>各班班主任：</FONT></P>
<P><FONT size=4>    截至目前，仍有部分班级的家长委员会名单还没有提交，请相关班级尽快提交，截止时间下周一（9月13日）。</FONT></P>
<P><FONT size=4><STRONG></STRONG></FONT> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2421.aspx" target="_self" title="标题：值周检查情况汇总（9月8日星期四）&#xD;点击数：211&#xD;发表时间：10年09月10日">值周检查情况汇总（9月8日星期四）</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2433.aspx" target="_self" title="标题：师徒结对&#xD;点击数：539&#xD;发表时间：10年09月12日">师徒结对</a>[ 09-12 ]</div>
                        </div>
                    </div>
