...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4010"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4010},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4010";
...
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 21pt; mso-char-indent-count: 2.0"><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3>今天下午的教工政治学习不再集中，要求大家继续做好自己办公室的内务工作，要做精、做细、做实，做到精益求精，以最出色的表现来迎接有关方面的检查。</FONT></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3998.aspx" target="_self" title="标题：迎接&amp;nbsp;“一创双查”省预检工作布置&#xD;点击数：1575&#xD;发表时间：11年05月20日">迎接 “一创双查”省预检工作布置</a>[ 05-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4011.aspx" target="_self" title="标题：文明检查反馈&#xD;点击数：1688&#xD;发表时间：11年05月23日">文明检查反馈</a>[ 05-23 ]</div>
                        </div>
                    </div>
