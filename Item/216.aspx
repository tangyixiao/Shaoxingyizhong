...
<head>
    ...
    <title>绍兴一中校园晚间安全检查公告(2009.1-9.5）--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中校园晚间安全检查公告(2009.1-9.5）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=216"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:216},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=216";
...
<TD vAl
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/212.aspx" target="_self" title="标题：会议通知&#xD;点击数：570&#xD;发表时间：09年09月07日">会议通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/217.aspx" target="_self" title="标题：自行车未上锁情况通报&#xD;点击数：710&#xD;发表时间：09年09月07日">自行车未上锁情况通报</a>[ 09-07 ]</div>
                        </div>
                    </div>
