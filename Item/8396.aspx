...
<head>
    ...
    <title>生规课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8396"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8396},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8396";
     ...
     <FONT size=4>因心理老师有事外出，今天下午高一生规课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8392.aspx" target="_self" title="标题：关于高三体检工作的提醒&#xD;点击数：241&#xD;发表时间：18年04月19日">关于高三体检工作的提醒</a>[ 04-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8400.aspx" target="_self" title="标题：高三英语读写系列讲座之二&#xD;点击数：293&#xD;发表时间：18年04月19日">高三英语读写系列讲座之二</a>[ 04-19 ]</div>
                        </div>
                    </div>
