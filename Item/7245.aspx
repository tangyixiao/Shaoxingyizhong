...
<head>
    ...
    <title>高一上课提醒--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一上课提醒</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年08月27日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7245"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7245},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7245";
     ...
     <P><FONT size=4>8月29日至31日，高一年级按周二、周三、周四正式课表上课。</FONT></P>
<P><FONT size=4>音乐、体育课从9月3日后开始上课，29日至31日暂停。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7242.aspx" target="_self" title="标题：高二、高三28日停课复习安排&#xD;点击数：421&#xD;发表时间：17年08月25日">高二、高三28日停课复习安排</a>[ 08-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7246.aspx" target="_self" title="标题：高三全体老师会议通知&#xD;点击数：213&#xD;发表时间：17年08月28日">高三全体老师会议通知</a>[ 08-28 ]</div>
                        </div>
                    </div>
