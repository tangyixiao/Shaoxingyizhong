...
<head>
    ...
    <title>校电第二期节目10.9--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">校电第二期节目10.9</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：admin</span> <span>发布时间：2020年12月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12330"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12330},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12330";
     ...
     <p style="font-family: 宋体; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);">
</p><p style="font-family: 宋体; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);">3、周六30日<span style="color:#ff9900">下午</span><span style="color:#0099ff">回家剪辑的，到电视台copy素材吧</span>(详见留言板)；</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12293.aspx" target="_self" title="标题：【书画社】会议通知&#xD;点击数：72&#xD;发表时间：20年12月01日">【书画社】会议通知</a>[ 12-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12358.aspx" target="_self" title="标题：【记者团】社员会议通知&#xD;点击数：76&#xD;发表时间：20年12月10日">【记者团】社员会议通知</a>[ 12-10 ]</div>
                        </div>
                    </div>
