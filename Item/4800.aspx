...
<head>
    ...
    <title>要给学生更多选择权--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4800"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4800},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4800";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4790.aspx" target="_self" title="标题：浙江省第五届中小学生乒乓球联赛（高中组晋级赛）在绍兴一中举行&#xD;点击数：530&#xD;发表时间：13年12月30日">浙江省第五届中小学生乒乓球联赛（高中组晋级赛）在绍兴一中举行</a>[ 12-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4801.aspx" target="_self" title="标题：爱钻研的竞赛生&#xD;点击数：1763&#xD;发表时间：14年01月06日">爱钻研的竞赛生</a>[ 01-06 ]</div>
                        </div>
                    </div>
