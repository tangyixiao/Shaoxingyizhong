...
<head>
    ...
    <title>5.30跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">5.30跑操量化考核反馈</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21549"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21549},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21549";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/5/202505301535168886.png" style="max-width: 100%; " title="202505301535168886.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21548.aspx" target="_self" title="标题：5.29班级一日考核&#xD;点击数：24&#xD;发表时间：25年05月30日">5.29班级一日考核</a>[ 05-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21553.aspx" target="_self" title="标题：寻物启事（篮球）&#xD;点击数：44&#xD;发表时间：25年05月30日">寻物启事（篮球）</a>[ 05-30 ]</div>
                        </div>
                    </div>
