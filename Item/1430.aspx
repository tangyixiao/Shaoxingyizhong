...
<head>
    ...
    <title>关于省学籍管理系统综合实践活动登记培训的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于省学籍管理系统综合实践活动登记培训的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1430"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1430},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1430";
     ...
     <P><FONT size=5> </FONT><FONT size=4>       针对目前部分老师在综合社会实践活动（研究性学习、社区服务、社会实践）登记的操作中遇到困难，教学处决定在明天（周五）中午12：10在行政楼5楼会议室，进行一次操作培训，时间约10分钟。欢迎老师前来参加。</FONT></P>
<P><FONT size=5>                                                                教学处</FONT></P>
<P><FONT size=5>                                                                2010.3.11</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1428.aspx" target="_self" title="标题：关于选修IB上课地点修改的通知&#xD;点击数：482&#xD;发表时间：10年03月11日">关于选修IB上课地点修改的通知</a>[ 03-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1433.aspx" target="_self" title="标题：重申高三试场布置要求&#xD;点击数：412&#xD;发表时间：10年03月12日">重申高三试场布置要求</a>[ 03-12 ]</div>
                        </div>
                    </div>
