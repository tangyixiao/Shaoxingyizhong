...
<head>
    ...
    <title>教研组长会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13948"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13948},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13948";
     ...
     <p><span style="FONT-SIZE: 20px">请各学科教研组长于今天下午第9节课在树兰楼会议室三开会。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13947.aspx" target="_self" title="标题：9月19日CCFCSP竞赛监考安排&#xD;点击数：412&#xD;发表时间：21年09月18日">9月19日CCFCSP竞赛监考安排</a>[ 09-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13950.aspx" target="_self" title="标题：9月19日高一试场布置要求和自修安排&#xD;点击数：262&#xD;发表时间：21年09月18日">9月19日高一试场布置要求和自修安排</a>[ 09-18 ]</div>
                        </div>
                    </div>
