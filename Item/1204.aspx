...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1204"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1204},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1204";
     ...
     因天雨，今日大扫除停做。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1203.aspx" target="_self" title="标题：各班主任请注意（关于会考期间注意事项）&#xD;点击数：546&#xD;发表时间：10年01月11日">各班主任请注意（关于会考期间注意事项）</a>[ 01-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1214.aspx" target="_self" title="标题：各班住校生就寝纪律、寝室卫生情况统计表(第18-19周）&#xD;点击数：352&#xD;发表时间：10年01月12日">各班住校生就寝纪律、寝室卫生情况统计表(第18-19周）</a>[ 01-12 ]</div>
                        </div>
                    </div>
