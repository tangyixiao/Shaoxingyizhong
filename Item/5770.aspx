...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5770"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5770},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5770";
     ...
     由于下午第四节课要进行运动会的跑步比赛，所以大扫除暂停。希相互转告！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5769.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：32&#xD;发表时间：16年10月24日">表扬与失物招领</a>[ 10-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5771.aspx" target="_self" title="标题：失物招领&#xD;点击数：53&#xD;发表时间：16年10月24日">失物招领</a>[ 10-24 ]</div>
                        </div>
                    </div>
