...
<head>
    ...
    <title>高一部分学生相片重拍通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一部分学生相片重拍通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=332"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:332},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=332";
     ...
     <FONT size=3>     高一学生相片校对工作已经结束，需要重拍的学生，请于明天（9月27日）12：10到行政楼拍照。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/331.aspx" target="_self" title="标题：关于申报2010年省级规划课题的通知&#xD;点击数：403&#xD;发表时间：09年09月26日">关于申报2010年省级规划课题的通知</a>[ 09-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/335.aspx" target="_self" title="标题：关于高一、高二校本课程选报的通知&#xD;点击数：296&#xD;发表时间：09年09月28日">关于高一、高二校本课程选报的通知</a>[ 09-28 ]</div>
                        </div>
                    </div>
