...
<head>
    ...
    <title>教师援疆意向摸排通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22412"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22412},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22412";
     ...
     <p>
...
</p><p style="text-align: justify; text-indent: 2em;">接上级通知，新一轮援疆教师选派工作即将启动。本轮援疆时间为3年，高中段首轮摸排不限学科，如有援疆意向的教师请在12月5日（周五）下午16：00之前向党政办朱垭烨老师报名。</p><p>
</p><p style="text-align: right;">                                                                                              党政办</p><p style="text-align: right;">                                                                                             12月4日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22406.aspx" target="_self" title="标题：第13周主要工作安排表（11.24-11.30)&#xD;点击数：7&#xD;发表时间：25年11月24日">第13周主要工作安排表（11.24-11.30)</a>[ 11-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22438.aspx" target="_self" title="标题：第15周主要工作安排表（12.8-12.14）&#xD;点击数：210&#xD;发表时间：25年12月08日">第15周主要工作安排表（12.8-12.14）</a>[ 12-08 ]</div>
                        </div>
                    </div>
