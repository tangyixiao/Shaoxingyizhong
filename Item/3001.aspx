...
<head>
    ...
    <title>关于教工消防演练延期的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于教工消防演练延期的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3001"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3001},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3001";
     ...
     <P>各位教工:</P>
<P>         本定于今天下午举行的教工消防演练活动因下雨顺延,特此通知.</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2998.aspx" target="_self" title="标题：通知&#xD;点击数：976&#xD;发表时间：10年12月06日">通知</a>[ 12-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3040.aspx" target="_self" title="标题：教工会议通知&#xD;点击数：780&#xD;发表时间：10年12月13日">教工会议通知</a>[ 12-13 ]</div>
                        </div>
                    </div>
