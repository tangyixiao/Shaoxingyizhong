...
<head>
    ...
    <title>上交暑假专业阅读读后感材料的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">上交暑假专业阅读读后感材料的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9144"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9144},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9144";
     ...
     <!--StartFragment -->
<DIV>各教研组长：</DIV>
<DIV>暑假专业阅读---《学校的挑战》读后感各组老师尽快上交。具体要求如下：</DIV>
<DIV>每位教师结合自己的教学实践与认识，撰写不少于1000字的读书笔记。格式如下：一式三份，A4页面，标题宋体三号，正文仿宋四号，行距固定值18，其中一份文章末页注明学校、姓名。</DIV>
<DIV> </DIV>
<DIV><FONT color=#f73809>上交时间：9月30日前</FONT><BR><FONT color=#ff3300>希望各位教研组长抓紧在组内落实布置，作为每位教师校本研修学分材料。</FONT></DIV>
<DIV> </DIV>
<DIV>                                                                               2018.9.27</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9107.aspx" target="_self" title="标题：青年教师参加下周选考一模的通知&#xD;点击数：327&#xD;发表时间：18年09月21日">青年教师参加下周选考一模的通知</a>[ 09-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9165.aspx" target="_self" title="标题：绍兴市直普通高中教师基本功比武活动的通知&#xD;点击数：734&#xD;发表时间：18年09月30日">绍兴市直普通高中教师基本功比武活动的通知</a>[ 09-30 ]</div>
                        </div>
                    </div>
