...
<head>
    ...
    <title>高二物理课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1953"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1953},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1953";
     ...
     5月27日（星期四）高二物理老师参加教研活动，所任课班级物理课改自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1951.aspx" target="_self" title="标题：高一校本课程上课安排&#xD;点击数：604&#xD;发表时间：10年05月26日">高一校本课程上课安排</a>[ 05-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1954.aspx" target="_self" title="标题：高三毕业证书校对&#xD;点击数：406&#xD;发表时间：10年05月27日">高三毕业证书校对</a>[ 05-27 ]</div>
                        </div>
                    </div>
