...
<head>
    ...
    <title>关于高一、高二26日活动的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一、高二26日活动的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3294"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3294},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3294";
     ...
     <P> </P>
<P><FONT size=4>高一、高二班主任：</FONT></P>
<P><FONT size=4>26日活动安排如下：</FONT></P>
<P><FONT size=4>1.上午9：00组织学生观看“感动中国2009年度颁奖会”的部分视频，视频请到：德育处文件夹内下载；</FONT></P>
<P><FONT size=4>2.10：00发成绩单、假期作业、社会实践表、告家长书等；</FONT></P>
<P><FONT size=4>3.班主任对学生作一次关于假期要求的讲话、个别谈话等；</FONT></P>
<P><FONT size=4>4.组织学生进行大扫除，关好门窗。</FONT></P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3293.aspx" target="_self" title="标题：关于高一高二休业式的通知&#xD;点击数：515&#xD;发表时间：11年01月24日">关于高一高二休业式的通知</a>[ 01-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3295.aspx" target="_self" title="标题：关于大学生回访母校活动的通知（地点有变）&#xD;点击数：605&#xD;发表时间：11年01月24日">关于大学生回访母校活动的通知（地点有变）</a>[ 01-24 ]</div>
                        </div>
                    </div>
