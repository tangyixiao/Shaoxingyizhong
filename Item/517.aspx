...
<head>
    ...
    <title>今天是订报的最后半天--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天是订报的最后半天</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年11月06日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=517"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:517},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=517";
...
<DIV><FONT size=4>   2010年报纸开始订阅，希望大家在下周五（今天<FONT style="BACKGROUND-COLOR: #f70909">上午最后半天</FONT>）之前做好以下工作。</FONT></DIV>
<DIV><FONT size=4>   1、去年订阅钱江晚报的
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/496.aspx" target="_self" title="标题：祝教工生日快乐&#xD;点击数：519&#xD;发表时间：09年11月03日">祝教工生日快乐</a>[ 11-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/519.aspx" target="_self" title="标题：麻疹疫苗强化免疫摸底(班主任）&#xD;点击数：538&#xD;发表时间：09年11月06日">麻疹疫苗强化免疫摸底(班主任）</a>[ 11-06 ]</div>
                        </div>
                    </div>
