...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14066"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14066},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14066";
     ...
     <p>（一）有同学丢失手持风扇一只，白色框架，黄色扇叶，有特步标志，请拾到者尽快还到210班。</p><p>
</p><p>（二）有同学丢失黑色书包一只，内有蓝色单筒望远镜，101班班服，化学必修二，化学单元检测卷，白色手表。请拾到者尽快归还101班赵天奕。</p><p>
</p><p>
</p><p>
</p><p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14058.aspx" target="_self" title="标题：失物招领及拾金不昧表扬三则&#xD;点击数：188&#xD;发表时间：21年09月29日">失物招领及拾金不昧表扬三则</a>[ 09-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14067.aspx" target="_self" title="标题：寻物启事&#xD;点击数：192&#xD;发表时间：21年09月30日">寻物启事</a>[ 09-30 ]</div>
                        </div>
                    </div>
