...
<head>
    ...
    <title>教室卫生和课间操检查情况反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">教室卫生和课间操检查情况反馈</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2338"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2338},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2338";
...
<P><FONT size=4>今天德育处教室卫生和课间操进行检查发现以下问题：</FONT></P>
<P><FONT size=4>   1.个别教室外走廊上天花板有蛛网；</FONT></P>
<P><FONT size=4>   2.部分班级教室内地板、讲桌、讲台等处，暑假粉刷时残留的油漆未清理干净；</FONT></P>
<P><FONT size=4>   3.部分班级教室后面储物柜台上杂物较多；</FONT></P>
<P><FONT size=4>   4.空调后面、讲桌与讲台间的缝隙处卫生较差；</FONT></P>
<P><FONT size=4>   5.高一各班下楼速度较慢（建议下楼后跑步到达指定位置）；</FONT></P>
<P><FONT size=4>   请各班级积极自查并及时处理。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2328.aspx" target="_self" title="标题：有关通知三则（紧急）&#xD;点击数：629&#xD;发表时间：10年09月01日">有关通知三则（紧急）</a>[ 09-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2339.aspx" target="_self" title="标题：德育处通知&#xD;点击数：576&#xD;发表时间：10年09月02日">德育处通知</a>[ 09-02 ]</div>
                        </div>
                    </div>
