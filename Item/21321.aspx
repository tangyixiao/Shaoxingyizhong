...
<head>
    ...
    <title>高一晚自修值班安排（4.27-4.29）--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一晚自修值班安排（4.27-4.29）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21321"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21321},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21321";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/4/202504241441598220.png" style="max-width: 100%; " title="202504241441598220.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21298.aspx" target="_self" title="标题：关于召开高一第二学期期中考试成绩分析会的通知&#xD;点击数：155&#xD;发表时间：25年04月22日">关于召开高一第二学期期中考试成绩分析会的通知</a>[ 04-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21330.aspx" target="_self" title="标题：高一晚自修值班安排（5.5-5.16）&#xD;点击数：163&#xD;发表时间：25年04月27日">高一晚自修值班安排（5.5-5.16）</a>[ 04-27 ]</div>
                        </div>
                    </div>
