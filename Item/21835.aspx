...
<head>
    ...
    <title>市属合唱比赛排练通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21835"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21835},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21835";
     ...
     <p>高一（14）班将代表学校参加市属合唱比赛，以下时间段用于合唱比赛排练：</p><p>周一第8节（音乐）、<span style="text-wrap-mode: wrap;">第</span>9<span style="text-wrap-mode: wrap;">节</span>（体锻）；</p><p>周二<span style="text-wrap-mode: wrap;">第</span><span style="text-wrap-mode: wrap;">9</span><span style="text-wrap-mode: wrap;">节</span>（劳动课）；</p><p>周四<span style="text-wrap-mode: wrap;">第8节</span>（体锻）、<span style="text-wrap-mode: wrap;">第9节</span>（班会）；</p><p>周五<span style="text-wrap-mode: wrap;">第8节</span>（体育）、<span style="text-wrap-mode: wrap;">第9节</span>（自修）。</p><p>排练地点：音乐教室。</p><p>预祝他们取得好成绩！</p><p>
</p><p>
</p><p>                                                                                                                            教学处
</p><p>                                                                                                                         2025.9.3
</p><p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21831.aspx" target="_self" title="标题：物理教研活动通知&#xD;点击数：120&#xD;发表时间：25年09月03日">物理教研活动通知</a>[ 09-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21842.aspx" target="_self" title="标题：校乒乓球队会议通知&#xD;点击数：91&#xD;发表时间：25年09月04日">校乒乓球队会议通知</a>[ 09-04 ]</div>
                        </div>
                    </div>
