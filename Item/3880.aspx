...
<head>
    ...
    <title>大运会火炬点燃仪式上发言的学生代表是个绍兴人--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">大运会火炬点燃仪式上发言的学生代表是个绍兴人</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3880"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3880},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3880";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3821.aspx" target="_self" title="标题：高考未开锣，一中传捷报&#xD;点击数：917&#xD;发表时间：11年04月27日">高考未开锣，一中传捷报</a>[ 04-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3934.aspx" target="_self" title="标题：春季远足&amp;nbsp;徒步九公里&#xD;点击数：750&#xD;发表时间：11年05月11日">春季远足 徒步九公里</a>[ 05-11 ]</div>
                        </div>
                    </div>
