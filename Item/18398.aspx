...
<head>
    ...
    <title>班长会议的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18398"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18398},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18398";
     ...
     <p style="text-indent:196px">
</p><p>全校各班：</p><p style="text-indent:28px">今天中午12：30举行班长会议，地点：德育处旁4106阶梯教室，请大家随带纸，笔准时出席。</p><p style="text-indent:28px"> </p><p style="text-indent:28px"> </p><p style="text-indent:364px">德育处</p><p style="text-indent:364px">2023年9月13日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18397.aspx" target="_self" title="标题：关于绍兴市第六届中学生军体运动会我校参加同学的名单及其它情况的通知&#xD;点击数：329&#xD;发表时间：23年09月14日">关于绍兴市第六届中学生军体运动会我校参加同学的名单及其它情…</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18401.aspx" target="_self" title="标题：9.12班级一日考核&#xD;点击数：87&#xD;发表时间：23年09月13日">9.12班级一日考核</a>[ 09-13 ]</div>
                        </div>
                    </div>
