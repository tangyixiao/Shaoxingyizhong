...
<head>
    ...
    <title>爱在一中 |严亮校友设计、施工和赞助的“校友之家”项目开始装修--校友动态-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Category_391/Index.aspx">校友动态</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23530"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23530},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23530";
     ...
     <p style="font-family: 宋体;font-size: 12pt;line-height: 108%;margin-bottom: .001pt;margin-left: 0;margin-right: 0;margin-top: 0;text-align: left;">
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23529.aspx" target="_self" title="标题：薪火传嘉誉，赤心报桑梓｜我校杰出校友陈为民组织公益文化活动，并受聘校友会金融界专业委员会副会长&#xD;点击数：2&#xD;发表时间：26年08月20日">薪火传嘉誉，赤心报桑梓｜我校杰出校友陈为民组织公益文化活动…</a>[ 08-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Item/23532.aspx" target="_self" title="标题：第三篇：大爱与归心——校友与母校的双向奔赴（下）&#xD;点击数：1&#xD;发表时间：26年08月20日">第三篇：大爱与归心——校友与母校的双向奔赴（下）</a>[ 08-20 ]</div>
                        </div>
                    </div>
