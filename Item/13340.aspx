...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13340"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13340},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13340";
     ...
     <p><span style="FONT-SIZE: 20px">本周二生物组全体老师外出参加教研活动，相关班级生物课改自修。高二、高三生物走班学生在相应上课教室自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13327.aspx" target="_self" title="标题：高一部分科目期中考试时间调整通知&#xD;点击数：314&#xD;发表时间：21年05月07日">高一部分科目期中考试时间调整通知</a>[ 05-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13341.aspx" target="_self" title="标题：高一语文教研活动通知&#xD;点击数：123&#xD;发表时间：21年05月10日">高一语文教研活动通知</a>[ 05-10 ]</div>
                        </div>
                    </div>
