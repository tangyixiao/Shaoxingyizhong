...
<head>
    ...
    <title>高三晚自修+答疑管理安排（2.23-3.7）--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三晚自修+答疑管理安排（2.23-3.7）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20975"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20975},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20975";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/3/202503031007090178.png" style="max-width: 100%; " title="202503031007090178.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20943.aspx" target="_self" title="标题：高三名校协作体成绩分析会通知&#xD;点击数：184&#xD;发表时间：25年02月19日">高三名校协作体成绩分析会通知</a>[ 02-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21001.aspx" target="_self" title="标题：高三晚自修+答疑管理安排（3.9-3.21）&#xD;点击数：107&#xD;发表时间：25年03月03日">高三晚自修+答疑管理安排（3.9-3.21）</a>[ 03-03 ]</div>
                        </div>
                    </div>
