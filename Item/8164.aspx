...
<head>
    ...
    <title>高三高考体检工作会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三高考体检工作会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8164"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8164},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8164";
     ...
     <FONT size=4>请高三班主任及年段长于今天下午2点到图书馆一楼教工阅览室开会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8160.aspx" target="_self" title="标题：高考选考适应性考试试场布置及考试相关要求&#xD;点击数：917&#xD;发表时间：18年03月13日">高考选考适应性考试试场布置及考试相关要求</a>[ 03-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8165.aspx" target="_self" title="标题：高三本周六上课安排&#xD;点击数：511&#xD;发表时间：18年03月14日">高三本周六上课安排</a>[ 03-14 ]</div>
                        </div>
                    </div>
