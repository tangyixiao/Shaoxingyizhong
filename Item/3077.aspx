...
<head>
    ...
    <title>关于住校生安全的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3077"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3077},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3077";
...
<P><FONT size=4>由于天气寒冷，近几天发现个别住校生在寝室内使用充电的暖手宝等电器，为保障用电安全，请各班主任务必再次提醒住校学生在寝室内禁止使用取暖电器。谢谢！</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3075.aspx" target="_self" title="标题：清雪有关通知&#xD;点击数：482&#xD;发表时间：10年12月17日">清雪有关通知</a>[ 12-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3078.aspx" target="_self" title="标题：值周检查情况汇总（12月16日星期四）&#xD;点击数：294&#xD;发表时间：10年12月17日">值周检查情况汇总（12月16日星期四）</a>[ 12-17 ]</div>
                        </div>
                    </div>
