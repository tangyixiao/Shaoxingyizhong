...
<head>
    ...
    <title>关于周三举行高一、高二各班文艺委员会议的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于周三举行高一、高二各班文艺委员会议的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20523"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20523},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20523";
     ...
     <p style="text-indent:182px"> </p><p style="text-indent:28px"> 本周三下午第九节课，请高一、高二各班文艺委员到亚泉楼5011（音乐教室1）集中开会，有意向参与本次艺术节的各社团负责人也请列席参加，并随带纸笔。望相互转告并准时出席！</p><p style="text-indent:28px"> </p><p style="text-indent: 28px; text-align: right;">                                                                                           德育处、音乐组</p><p style="text-indent: 28px; text-align: right;">                                                                                           2024年11月12日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20522.aspx" target="_self" title="标题：寻物启事二则（饭卡/钥匙）&#xD;点击数：27&#xD;发表时间：24年11月12日">寻物启事二则（饭卡/钥匙）</a>[ 11-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20527.aspx" target="_self" title="标题：高一家长会注意事项及晚自习安排&#xD;点击数：192&#xD;发表时间：24年11月12日">高一家长会注意事项及晚自习安排</a>[ 11-12 ]</div>
                        </div>
                    </div>
