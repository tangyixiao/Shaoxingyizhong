...
<head>
    ...
    <title>关于召开支部书记会议的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于召开支部书记会议的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=359"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:359},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=359";
     ...
     <P>     定于今天下午第四节课在行政楼四楼会议室召开支部书记会议,请各支部书记准时参加!</P>
<P>                              
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/357.aspx" target="_self" title="标题：转发《2009年浙江省田径等级赛竞赛》通知&#xD;点击数：552&#xD;发表时间：09年09月30日">转发《2009年浙江省田径等级赛竞赛》通知</a>[ 09-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/360.aspx" target="_self" title="标题：关于清理传达室信箱的通知&#xD;点击数：538&#xD;发表时间：09年10月08日">关于清理传达室信箱的通知</a>[ 10-08 ]</div>
                        </div>
                    </div>
