...
<head>
    ...
    <title>关于国庆放假期间做好信息上报工作的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于国庆放假期间做好信息上报工作的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：安全</span> <span>发布时间：2009年09月30日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=355"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:355},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=355";
     ...
     <DIV><FONT size=4>各位班主任：</FONT></DIV>
<DIV><FONT size=4>      为了切实保障学生的身体健康，进一步做好我校对甲型流感的防控工作，学校要求每位班主任在国庆放假期间按要求一如既往地关心本班学生的身体健康，如发现有学生发烧的现象，请积极配合家长做好治疗工作，同时，把相关情况用短信的形式及时告知宣方军老师，短信中务请写明班级、学生姓名、简单病情等。</FONT></DIV>
<DIV><FONT size
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/340.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.20-9.27）&#xD;点击数：486&#xD;发表时间：09年09月28日">绍兴一中校园晚间安全检查公告(2009.20-9.27）</a>[ 09-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/380.aspx" target="_self" title="标题：检查通报&#xD;点击数：293&#xD;发表时间：09年10月13日">检查通报</a>[ 10-13 ]</div>
                        </div>
                    </div>
