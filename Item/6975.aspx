...
<head>
    ...
    <title>高一各班班长领取七选三调查材料的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一各班班长领取七选三调查材料的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6975"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6975},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6975";
     ...
     <P> </P>
<P>为了解同学们的七选三情况，作为编班分班的依据，现进行选考科目的调查，请高一各班班长今天下午2：30到4：50期间到课程处领取调查材料。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6968.aspx" target="_self" title="标题：关于教坛新秀报名的通知&#xD;点击数：261&#xD;发表时间：17年05月18日">关于教坛新秀报名的通知</a>[ 05-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7015.aspx" target="_self" title="标题：2017学年教师任课任职意向表上交的通知&#xD;点击数：280&#xD;发表时间：17年05月24日">2017学年教师任课任职意向表上交的通知</a>[ 05-24 ]</div>
                        </div>
                    </div>
