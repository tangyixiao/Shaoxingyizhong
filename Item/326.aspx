...
<head>
    ...
    <title>关于举办国庆摄影比赛的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于举办国庆摄影比赛的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年09月25日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=326"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:326},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=326";
     ...
     <DIV>    <FONT size=3>“国庆瞬间  永恒中国”，为热烈庆祝祖国六十华诞，进一步丰富学生校园文化生活，校团委决定举办国庆摄影比赛，现将有关事宜通知如下：</FONT></DIV>
<DIV><FONT size=3>    ⒈活动对象：高一、高二年段。请各班以团支部为单位，组织学生参加“国庆瞬间  永恒中国”主题摄影比赛。</FONT></DIV>
<DIV><FONT size=3> &nbsp
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/316.aspx" target="_self" title="标题：高一、高二班长注意&#xD;点击数：441&#xD;发表时间：09年09月23日">高一、高二班长注意</a>[ 09-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/327.aspx" target="_self" title="标题：第二期黑板报检查成绩公布&#xD;点击数：472&#xD;发表时间：09年09月28日">第二期黑板报检查成绩公布</a>[ 09-28 ]</div>
                        </div>
                    </div>
