...
<head>
    ...
    <title>物理组汇报课--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19230"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19230},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19230";
     ...
     <p><span style="font-family: Arial; font-size: 13px;">        </span><span style="font-size: 16px;"><span style="font-family: Arial;">1月11日有物理组蔡赵杰老师执教汇报课</span><span style="font-family: Arial;">，欢迎组内老师及其他老师现场观摩指导，具体信息如下：授课班级为高一（7）班，授课时间为上午第四节， 教学内容为生活中的圆周运动。</span></span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19197.aspx" target="_self" title="标题：关于2023年下半年师训平台课程评价的通知&#xD;点击数：271&#xD;发表时间：24年01月02日">关于2023年下半年师训平台课程评价的通知</a>[ 01-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19258.aspx" target="_self" title="标题：（地点有修改）关于“学习教育家精神 培养教育名师”校本培训活动的通知&#xD;点击数：452&#xD;发表时间：24年01月17日">（地点有修改）关于“学习教育家精神 培养教育名师”校本培训…</a>[ 01-17 ]</div>
                        </div>
                    </div>
