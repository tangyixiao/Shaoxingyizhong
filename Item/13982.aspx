...
<head>
    ...
    <title>9月24日视力普查相关教学安排调整--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9月24日视力普查相关教学安排调整</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13982"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13982},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13982";
     ...
     <p>9月24日各班级按德育处通知进行视力普查，如检查时间与体育课时间冲突的，先进行视力检查，检查完成后可在剩余时间进行运动会项目训练和彩排。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13980.aspx" target="_self" title="标题：国庆前教学安排通知&#xD;点击数：658&#xD;发表时间：21年09月22日">国庆前教学安排通知</a>[ 09-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13991.aspx" target="_self" title="标题：关于运动会彩排的通知两则&#xD;点击数：595&#xD;发表时间：21年09月24日">关于运动会彩排的通知两则</a>[ 09-24 ]</div>
                        </div>
                    </div>
