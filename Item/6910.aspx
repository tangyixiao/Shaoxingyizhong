...
<head>
    ...
    <title>大课间操暂停通知（10日—12日）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">大课间操暂停通知（10日—12日）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6910"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6910},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6910";
     ...
     由于体育老师集体出差，10日----12日大课间操暂停，望相互转告！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6907.aspx" target="_self" title="标题：第四期主题班会和道德讲堂活动通知&#xD;点击数：201&#xD;发表时间：17年05月09日">第四期主题班会和道德讲堂活动通知</a>[ 05-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6921.aspx" target="_self" title="标题：关于高一师生远足活动的再通知（有修改）&#xD;点击数：525&#xD;发表时间：17年05月11日">关于高一师生远足活动的再通知（有修改）</a>[ 05-11 ]</div>
                        </div>
                    </div>
