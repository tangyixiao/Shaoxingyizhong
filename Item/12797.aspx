...
<head>
    ...
    <title>北斗科技班通知两则--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12797"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12797},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12797";
     ...
     <p>1、请于今日放学前将项目报告交教学处周老师（word和PDF两个版本）。</p><p>2、请在今日傍晚17:30开始到北斗科技班教室（建功楼2106）领取传感器。各组依此前来，一组领完通知下一组。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12795.aspx" target="_self" title="标题：高三协作体联考安排&#xD;点击数：599&#xD;发表时间：21年02月28日">高三协作体联考安排</a>[ 02-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12798.aspx" target="_self" title="标题：高一返校考和高二高三协作体联考试场布置及考试相关要求&#xD;点击数：425&#xD;发表时间：21年02月28日">高一返校考和高二高三协作体联考试场布置及考试相关要求</a>[ 02-28 ]</div>
                        </div>
                    </div>
