...
<head>
    ...
    <title>特异体质登记表领取通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16060"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16060},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16060";
     ...
     <p>请高二各班班长明天（周四）中午到医务室领取特殊体质登记表，并于下周一（9月5号）交到医务室，望各班班长互相通知，及时领取。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16054.aspx" target="_self" title="标题：关于组织学校师生员工核酸检测的通知&#xD;点击数：176&#xD;发表时间：22年08月31日">关于组织学校师生员工核酸检测的通知</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16070.aspx" target="_self" title="标题：关于组织学校师生员工参加核酸检测的通知&#xD;点击数：164&#xD;发表时间：22年09月01日">关于组织学校师生员工参加核酸检测的通知</a>[ 09-01 ]</div>
                        </div>
                    </div>
