...
<head>
    ...
    <title>关于大课间操上交请假条的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于大课间操上交请假条的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5489"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5489},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5489";
     ...
     <P> 各位班主任和相关同学注意：       </P>
<P>        因身体原因而不能参加大课间操的同学，请于9月12日前把医院或学校医务室病假条复印件送到安全处余真老师处，德育处将进行登记，谢谢!</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5485.aspx" target="_self" title="标题：关于加强全校卫生检查通知&#xD;点击数：97&#xD;发表时间：16年09月10日">关于加强全校卫生检查通知</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5498.aspx" target="_self" title="标题：升旗仪式暂停通知&#xD;点击数：161&#xD;发表时间：16年09月11日">升旗仪式暂停通知</a>[ 09-11 ]</div>
                        </div>
                    </div>
