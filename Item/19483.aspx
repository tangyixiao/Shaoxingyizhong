...
<head>
    ...
    <title>3.14跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">3.14跑操量化考核反馈</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19483"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19483},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19483";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2024/3/202403141545550032.png" style="max-width: 100%; " title="202403141545550032.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19479.aspx" target="_self" title="标题：3.13跑操量化考核反馈&#xD;点击数：91&#xD;发表时间：24年03月14日">3.13跑操量化考核反馈</a>[ 03-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19484.aspx" target="_self" title="标题：3.13班级一日考核&#xD;点击数：33&#xD;发表时间：24年03月14日">3.13班级一日考核</a>[ 03-14 ]</div>
                        </div>
                    </div>
