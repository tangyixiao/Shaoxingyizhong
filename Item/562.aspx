...
<head>
    ...
    <title>院士细讲科学魅力--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=562"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:562},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=562";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/561.aspx" target="_self" title="标题：百年名校校庆出新校友称赞&#xD;点击数：394&#xD;发表时间：09年11月13日">百年名校校庆出新校友称赞</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/563.aspx" target="_self" title="标题：绍兴女孩应宇捷成为省党代会最年轻的代表&#xD;点击数：427&#xD;发表时间：09年11月13日">绍兴女孩应宇捷成为省党代会最年轻的代表</a>[ 11-13 ]</div>
                        </div>
                    </div>
