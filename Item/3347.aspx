...
<head>
    ...
    <title>今天下午大扫除照常进行--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天下午大扫除照常进行</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>今天下午大扫除照常进行</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年02月21日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3347"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3347},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3347";
...
<P><FONT size=4>今天下午大扫除照常进行，时间：第八节课后半节。以后没有特殊情况不再通知。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3343.aspx" target="_self" title="标题：大课间操通知&#xD;点击数：505&#xD;发表时间：11年02月21日">大课间操通知</a>[ 02-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3349.aspx" target="_self" title="标题：通知三则&#xD;点击数：655&#xD;发表时间：11年02月22日">通知三则</a>[ 02-22 ]</div>
                        </div>
                    </div>
