...
<head>
    ...
    <title>寻物启事：寻找一个黑色手提袋--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">寻物启事：寻找一个黑色手提袋</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16335"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16335},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16335";
     ...
     <p>今天下午闭幕式前，主席台桌子附近，遗失黑色手提袋一个，内有数学作业本，英语试卷答案，白色透明笔袋一只，以及若干零食。请拾到者送到高一（14）班陈毅阳同学处。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16333.aspx" target="_self" title="标题：寻物启事：一件棒球衫&#xD;点击数：104&#xD;发表时间：22年10月11日">寻物启事：一件棒球衫</a>[ 10-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16336.aspx" target="_self" title="标题：寻物启事&#xD;点击数：132&#xD;发表时间：22年10月12日">寻物启事</a>[ 10-12 ]</div>
                        </div>
                    </div>
