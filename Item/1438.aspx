...
<head>
    ...
    <title>关于综合实践活动登记的再通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于综合实践活动登记的再通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1438"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1438},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1438";
     ...
     <P>接上级有关部门通知，省学籍管理系统将对上学期应该录入信息在本月19日封网，务必请相关老师把上学期结束时布置的研究性学习、社区服务、社会实践等内容填入到省学籍管理系统中，下周三前必须完成。批量导入操作在本周五中午已经培训，不会操作的老师可向已经参加培训的老师请教。</P>
<P>                                                    教学处</P>
<P>                                                    2010.3.13</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1436.aspx" target="_self" title="标题：关于公布2010年绍兴一中校级立项课题的通知&#xD;点击数：361&#xD;发表时间：10年03月12日">关于公布2010年绍兴一中校级立项课题的通知</a>[ 03-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1439.aspx" target="_self" title="标题：关于参加浙江省2010年新课程高考信息报告会通知&#xD;点击数：14051&#xD;发表时间：10年03月13日">关于参加浙江省2010年新课程高考信息报告会通知</a>[ 03-13 ]</div>
                        </div>
                    </div>
