...
<head>
    ...
    <title>北京大学2018年生命科学冬令营报名通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">北京大学2018年生命科学冬令营报名通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7677"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7677},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7677";
     ...
     <P><FONT size=4>北京大学2018年生命科学冬令营报名开始，有兴趣参加并符合条件的学生可登录北大本科生招生网报名，具体信息请查看北大生命科学冬令营官网通知（网址：</FONT><A href="http://www.zizzs.com/c/201711/20526.html"><FONT size=4>http://www.zizzs.com/c/201711/20526.html</FONT></A><FONT size=4>）。</FONT></P>
<P><FONT size=4>报名条件：</FONT></P>
<P style="TEXT-INDENT: 2em"><FONT size=4>1、2017年进入全国中学生学科奥林匹克竞赛省代表队（含数学、物理、化学、生物），且对生命科学极其热爱的学生。</FONT></P>
<P style="TEXT-INDENT: 2em"><FONT size=4>2、高中阶段获得两项以上不同学科（含两项）全国中学生学科奥林匹克竞赛省级一等奖（含数学、物理、化学、生物、信息），且对生命科学极其热爱的学生。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7671.aspx" target="_self" title="标题：技术教研活动通知&#xD;点击数：291&#xD;发表时间：17年11月22日">技术教研活动通知</a>[ 11-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7685.aspx" target="_self" title="标题：高三班主任：高考报名统计&#xD;点击数：174&#xD;发表时间：17年11月27日">高三班主任：高考报名统计</a>[ 11-27 ]</div>
                        </div>
                    </div>
