...
<head>
    ...
    <title>今明两天大课间安排--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14814"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14814},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14814";
     ...
     <p>       今天（1月4日）高一、高二因空气质量为中度污染大课间做室内操，高三年级停课复习大课间暂停；明天（1月5日）全校取消大课间，第三节9：20开始上课。</p><p>                                                                                                            德育处</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14813.aspx" target="_self" title="标题：高一大扫除通知&#xD;点击数：39&#xD;发表时间：22年01月04日">高一大扫除通知</a>[ 01-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14815.aspx" target="_self" title="标题：高一心理委员会议通知&#xD;点击数：91&#xD;发表时间：22年01月04日">高一心理委员会议通知</a>[ 01-04 ]</div>
                        </div>
                    </div>
