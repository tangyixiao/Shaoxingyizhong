...
<head>
    ...
    <title>关于教工制作校牌拍照的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于教工制作校牌拍照的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=274"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:274},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=274";
     ...
     因制作校牌需要,请各位教工(包括临时工作人员)在本周内到教学处小吴处拍照,请相互转告!
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/267.aspx" target="_self" title="标题：关于《教育中的心理效应》考试的通知&#xD;点击数：553&#xD;发表时间：09年09月14日">关于《教育中的心理效应》考试的通知</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/275.aspx" target="_self" title="标题：关于党员大会的通知&#xD;点击数：594&#xD;发表时间：09年09月15日">关于党员大会的通知</a>[ 09-15 ]</div>
                        </div>
                    </div>
