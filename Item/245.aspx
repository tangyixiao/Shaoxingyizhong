...
<head>
    ...
    <title>“感恩教师”专题黑板报评比结果--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">“感恩教师”专题黑板报评比结果</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年09月10日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=245"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:245},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=245";
     ...
     <DIV>一等奖：高一（1）、（11）、（16） 高二（5）、（14）  高三（2）、（8）</DIV>
<DIV>二等奖：高一（7）、（2）、（10）   高二（4）、（11）、（15）、（13） </DIV>
<DIV>        高三（12）、（10）、（9）  走廊黑板报高二（1）班</DIV>
<DIV>三等奖：高一（12）、（13）、（6）、（14）、（5）、（9）</D
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/231.aspx" target="_self" title="标题：关于参加《三星智力快车》节目的补充说明&#xD;点击数：497&#xD;发表时间：09年09月09日">关于参加《三星智力快车》节目的补充说明</a>[ 09-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/247.aspx" target="_self" title="标题：关于团委干部招聘面试的通知&#xD;点击数：457&#xD;发表时间：09年09月11日">关于团委干部招聘面试的通知</a>[ 09-11 ]</div>
                        </div>
                    </div>
