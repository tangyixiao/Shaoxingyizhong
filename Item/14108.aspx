...
<head>
    ...
    <title>关于校园网教师风采栏目内容调整充实优化的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于校园网教师风采栏目内容调整充实优化的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>关于校园网教师风采栏目内容调整充实优化的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2021年10月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14108"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14108},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14108";
     ...
     <p style="text-indent: 2em; line-height: 2em;">全体教师：</p><p style="text-indent: 2em; line-height: 2em;">为优化校园网建设，更好面向家长社会展示一中形象，需对“教师风采”栏目进行充实和调整，请老师们对照检查栏目现有个人内容，若个人内容有缺失或要修改、优化，请按要求提供个人照片和个人简介信息（原则上全体学科组全体教师都要展示），并上传至学校公共文件夹“教科室——教师个人简介”文件夹内，请于10月15日（周五）前上交。照片要求及简介模板如下：</p><p style="text-indent: 2em; line-height: 2em;">1、照片请提供近期生活照，横幅照片，中近景，人物主体相对突出，姿态自然大方（尽量正面照或微侧身照），分辨率清晰，人与景和谐，清爽而美好。</p><p style="text-indent: 2em; line-height: 2em;">2、个人简介信息：总字数控制在200-250字之间（不可过于简略，也不用过多，如荣誉成果较多，建议精简，突出主要成果），并按以下顺序组织信息（1）姓名（2）政治面貌。党员必须注明（亮身份）（3）学历及毕业院校（4）所获荣誉：现有综合荣誉或评优评先情况（5）教学成绩、班级管理成绩、教科研成果等（6）其他个人成果（7）教育信条（备选，可写可不写）</p><p style="text-indent: 2em; line-height: 2em;">                                                                                                      教科室</p><p style="text-indent: 2em; line-height: 2em;">                                                                                                 2021.10.7</p><p style="text-indent:2em;">
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14037.aspx" target="_self" title="标题：关于新教师拜师仪式暨青年教师工作会议的通知&#xD;点击数：377&#xD;发表时间：21年09月27日">关于新教师拜师仪式暨青年教师工作会议的通知</a>[ 09-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14122.aspx" target="_self" title="标题：2021年部分教师资格注册通知&#xD;点击数：215&#xD;发表时间：21年10月09日">2021年部分教师资格注册通知</a>[ 10-09 ]</div>
                        </div>
                    </div>
