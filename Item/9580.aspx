...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9580"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9580},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9580";
     ...
     <P> </P>
<P>2018年度教师资格注册工作现已完成，参加首次教师资格注册的老师请于今天下班前到教科室取回教师资格证原件。</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9499.aspx" target="_self" title="标题：我校2018年市直教师基本功比武成绩优秀名单&#xD;点击数：860&#xD;发表时间：18年12月12日">我校2018年市直教师基本功比武成绩优秀名单</a>[ 12-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9616.aspx" target="_self" title="标题：2018年7月-12月教科研成果统计&#xD;点击数：407&#xD;发表时间：19年01月02日">2018年7月-12月教科研成果统计</a>[ 01-02 ]</div>
                        </div>
                    </div>
