...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6501"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6501},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6501";
     ...
     有同学捡到一把钥匙，望失主及时到德育处来认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6496.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：140&#xD;发表时间：17年03月02日">表扬与失物招领</a>[ 03-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6508.aspx" target="_self" title="标题：升旗仪式改为广播讲话通知&#xD;点击数：77&#xD;发表时间：17年03月06日">升旗仪式改为广播讲话通知</a>[ 03-06 ]</div>
                        </div>
                    </div>
