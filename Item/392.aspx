...
<head>
    ...
    <title>自行车上锁情况检查记录表(9.27-10.10)--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">自行车上锁情况检查记录表(9.27-10.10)</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=392"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:392},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=392";
...
<DIV align=center>        第五、六周        9月27日至10月10日</DIV>
...
<DIV>&n
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/391.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.9.27-10.10）&#xD;点击数：271&#xD;发表时间：09年10月13日">绍兴一中校园晚间安全检查公告(2009.9.27-10.10）</a>[ 10-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/417.aspx" target="_self" title="标题：检查通报&#xD;点击数：356&#xD;发表时间：09年10月19日">检查通报</a>[ 10-19 ]</div>
                        </div>
                    </div>
