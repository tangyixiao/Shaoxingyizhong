...
<head>
    ...
    <title>关于新一卡通使用的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于新一卡通使用的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年08月18日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7226"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7226},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7226";
     ...
     <P>高二高三同学：</P>
<P>        新一卡通已经开通，可以刷卡打电话了，上学和放学刷卡后家长应该可以收到短信。新卡开通，老卡就不能打电话了。如果有什么问题，请联系德育处或直接联系校讯通客服。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7218.aspx" target="_self" title="标题：假期补课期间大课间操暂停通知&#xD;点击数：68&#xD;发表时间：17年08月14日">假期补课期间大课间操暂停通知</a>[ 08-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7227.aspx" target="_self" title="标题：2017年高一军训开营式通知&#xD;点击数：201&#xD;发表时间：17年08月19日">2017年高一军训开营式通知</a>[ 08-19 ]</div>
                        </div>
                    </div>
