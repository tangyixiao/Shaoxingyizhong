...
<head>
    ...
    <title>关于教工会议改期的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4063"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4063},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4063";
...
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 21pt; mso-char-indent-count: 2.0"><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3>原定于今天下午的教工会议因故改到明天下午第四节课，请各知照！</FONT></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4011.aspx" target="_self" title="标题：文明检查反馈&#xD;点击数：1688&#xD;发表时间：11年05月23日">文明检查反馈</a>[ 05-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4093.aspx" target="_self" title="标题：关于切实做好防范中小学生溺水事故的紧急通知&#xD;点击数：1185&#xD;发表时间：11年06月01日">关于切实做好防范中小学生溺水事故的紧急通知</a>[ 06-01 ]</div>
                        </div>
                    </div>
