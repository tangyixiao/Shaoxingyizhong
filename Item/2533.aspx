...
<head>
    ...
    <title>关于回收家长满意度评测表的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于回收家长满意度评测表的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2533"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2533},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2533";
     ...
     <P> </P>
<P><FONT size=4>    请各位班主任将本班学生家长手中的“绍兴一中家长开放日家长满意度测评表”收齐，统一交给各年段长。</FONT></P>
<P><FONT size=4>    谢谢！</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2527.aspx" target="_self" title="标题：关于领取爱国主义通用卡的通知&#xD;点击数：448&#xD;发表时间：10年09月25日">关于领取爱国主义通用卡的通知</a>[ 09-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2535.aspx" target="_self" title="标题：值周检查情况汇总（9月25日星期六）&#xD;点击数：398&#xD;发表时间：10年09月26日">值周检查情况汇总（9月25日星期六）</a>[ 09-26 ]</div>
                        </div>
                    </div>
