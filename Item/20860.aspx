...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20860"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20860},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20860";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/1/202501101626520546.png" style="max-width: 100%; " title="202501101626520546.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20856.aspx" target="_self" title="标题：寻物启事（手表）&#xD;点击数：37&#xD;发表时间：25年01月10日">寻物启事（手表）</a>[ 01-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20861.aspx" target="_self" title="标题：1.9跑操量化考核反馈&#xD;点击数：24&#xD;发表时间：25年01月10日">1.9跑操量化考核反馈</a>[ 01-10 ]</div>
                        </div>
                    </div>
