...
<head>
    ...
    <title>关于社团新社员名单登记的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于社团新社员名单登记的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10604"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10604},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10604";
     ...
     <P>各学生社团：</P>
<P>    请将报名情况以社团为单位登记至附件表格中，命名为社团名称，上传至公共文件夹“团委 - 0金笛 - 社团联社团 - 2019社员名单”。截止时间：<FONT color=#ff0000>9月25日周三17:00</FONT>。</P>
<P>    附件：<A title=社团社员登记表 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201909/2019092318081521.xls">社团社员登记表</A></P>
<P>    有特殊性质需要面试的请于<U>本周五9月27日放学前</U>完成（此前请先将报名者均填入登记表）。</P>
<P>    社团联合会将对名单进行核对，确保每人至多参加一个社团。同时，校团委将审核名单，征求班主任意见。</P>
<P>    完成以上流程后，校团委将公布社团社员最终名单，请各社团根据名单，<U>将正式社员的《绍兴一中学生社团报名表》汇总交至2114团委</U>。</P>
<P align=right>校团委 社团联合会<BR>2019年9月23日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10602.aspx" target="_self" title="标题：关于学代会选举结果及第二十届主席团成员产生的公示&#xD;点击数：268&#xD;发表时间：19年09月23日">关于学代会选举结果及第二十届主席团成员产生的公示</a>[ 09-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10605.aspx" target="_self" title="标题：第20届团学联部长级面试通知&#xD;点击数：203&#xD;发表时间：19年09月23日">第20届团学联部长级面试通知</a>[ 09-23 ]</div>
                        </div>
                    </div>
