...
<head>
    ...
    <title>关于物理、化学教研活动的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于物理、化学教研活动的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10607"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10607},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10607";
     ...
     <FONT size=4>9月25日（周三）上午市直物理、化学教研活动在阳明中学举行，周三上午的物理、化学课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10606.aspx" target="_self" title="标题：关于高一（4）班任课老师会议的通知&#xD;点击数：501&#xD;发表时间：19年09月24日">关于高一（4）班任课老师会议的通知</a>[ 09-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10608.aspx" target="_self" title="标题：关于信息技术教研活动的通知&#xD;点击数：4543&#xD;发表时间：19年09月24日">关于信息技术教研活动的通知</a>[ 09-24 ]</div>
                        </div>
                    </div>
