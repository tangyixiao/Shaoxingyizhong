...
<head>
    ...
    <title>在办公室中不用热器的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">在办公室中不用热器的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1396"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1396},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1396";
       ...
       供开水的问题已解决，请老师们不要再在办公室中用电热器烧水等。以防备用电引起的隐患。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1392.aspx" target="_self" title="标题：关于启用保温壶的通知&#xD;点击数：782&#xD;发表时间：10年03月06日">关于启用保温壶的通知</a>[ 03-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1397.aspx" target="_self" title="标题：关于教工会议的通知&#xD;点击数：653&#xD;发表时间：10年03月08日">关于教工会议的通知</a>[ 03-08 ]</div>
                        </div>
                    </div>
