...
<head>
    ...
    <title>第2周主要工作安排表（9.8-9.14）--工作安排-绍兴市第一中学</title>
...
<li class="li5 last"><a href="/Shaoxingyizhong/Category_24/Index.aspx">校务公开</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21851"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21851},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21851";
     ...
     <p style="font-family: 宋体;font-size: 18pt;line-height: 108%;margin-bottom: .001pt;margin-left: 0;margin-right: 0;margin-top: 0;text-align: center;">
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21833.aspx" target="_self" title="标题：第1周主要工作安排表（9.1-9.7）&#xD;点击数：8&#xD;发表时间：25年09月01日">第1周主要工作安排表（9.1-9.7）</a>[ 09-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21895.aspx" target="_self" title="标题：第3周主要工作安排表（9.15-9.21）&#xD;点击数：12&#xD;发表时间：25年09月15日">第3周主要工作安排表（9.15-9.21）</a>[ 09-15 ]</div>
                        </div>
                    </div>
