...
<head>
    ...
    <title>化学课自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13193"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13193},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13193";
     ...
     <p>今天（4月16日）由于化学组教研活动，故化学课改自修</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13185.aspx" target="_self" title="标题：高三适应性考试分析会&#xD;点击数：259&#xD;发表时间：21年04月15日">高三适应性考试分析会</a>[ 04-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13204.aspx" target="_self" title="标题：高三物理教研活动通知&#xD;点击数：168&#xD;发表时间：21年04月19日">高三物理教研活动通知</a>[ 04-19 ]</div>
                        </div>
                    </div>
