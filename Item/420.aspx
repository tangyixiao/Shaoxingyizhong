...
<head>
    ...
    <title>绍兴一中校园晚间安全检查公告(2009.10.11-10.17）--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中校园晚间安全检查公告(2009.10.11-10.17）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：安全</span> <span>发布时间：2009年10月19日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=420"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:420},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=420";
...
<TD vAl
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/419.aspx" target="_self" title="标题：自行车上锁情况检查通报(10.13-10.17)&#xD;点击数：357&#xD;发表时间：09年10月19日">自行车上锁情况检查通报(10.13-10.17)</a>[ 10-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/449.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.10.18-10.24）&#xD;点击数：361&#xD;发表时间：09年10月25日">绍兴一中校园晚间安全检查公告(2009.10.18-10.24）</a>[ 10-25 ]</div>
                        </div>
                    </div>
