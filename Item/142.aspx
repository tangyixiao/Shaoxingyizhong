...
<head>
    ...
    <title>各班值日提醒--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班值日提醒</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年08月25日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=142"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:142},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=142";
     ...
     <DIV><FONT size=4>    据周一、周二各值周班检查及德育处巡查发现，有以下几个方面问题，仍需各班班主任在班级内强调。</FONT></DIV>
<DIV><FONT size=4>   1、部分教室的门窗在无人时，仍未关牢，上锁；</FONT></DIV>
<DIV><FONT size=4>   2、部分班级教室卫生做的不够好，部分区域明显没有打扫，前后门张贴物未清理；</FONT></DIV>
<DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/140.aspx" target="_self" title="标题：请各班主任提醒住校生请注意&#xD;点击数：479&#xD;发表时间：09年08月25日">请各班主任提醒住校生请注意</a>[ 08-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/149.aspx" target="_self" title="标题：高一、高二、高三各班主任&#xD;点击数：553&#xD;发表时间：09年08月27日">高一、高二、高三各班主任</a>[ 08-27 ]</div>
                        </div>
                    </div>
