...
<head>
    ...
    <title>高一选修课改期通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12075"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12075},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12075";
     ...
     高一选修课除天文社和器乐演奏外，均改为周一第8节上课，请周知。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12072.aspx" target="_self" title="标题：班主任会议通知&#xD;点击数：334&#xD;发表时间：20年11月02日">班主任会议通知</a>[ 11-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12077.aspx" target="_self" title="标题：高三学生参加市第三届军体运动会动员会议的通知（有修改））&#xD;点击数：527&#xD;发表时间：20年11月03日">高三学生参加市第三届军体运动会动员会议的通知（有修改））</a>[ 11-03 ]</div>
                        </div>
                    </div>
