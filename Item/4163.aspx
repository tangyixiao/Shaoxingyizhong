...
<head>
    ...
    <title>北大、南开夏令营通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4163"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4163},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4163";
     ...
     <P>        有意参加“相约北大，走进地学”夏令营、“南开大学医学”夏令营的高二学生，现在开始报名，明天（6月15日）上午8：00截止，名单直接报给教学处（2）吴老师。优秀营员可获高校自主招生资格。</P>
<P>                                                                           教学处</P>
<P>                                                                              2011/06/14</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4162.aspx" target="_self" title="标题：期末教学工作安排&#xD;点击数：719&#xD;发表时间：11年06月13日">期末教学工作安排</a>[ 06-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4166.aspx" target="_self" title="标题：省会考考点试场分布&#xD;点击数：714&#xD;发表时间：11年06月14日">省会考考点试场分布</a>[ 06-14 ]</div>
                        </div>
                    </div>
