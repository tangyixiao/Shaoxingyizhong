...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23715"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23715},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23715";
     ...
     <p style="text-align: center;"><img src="/UploadFiles/xwzx/2026/9/202609231551277554.png" style="max-width: 100%; " title="202609231551277554.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23714.aspx" target="_self" title="标题：9.23跑操量化考核反馈&#xD;点击数：50&#xD;发表时间：26年09月23日">9.23跑操量化考核反馈</a>[ 09-23 ]</div>
