...
<head>
    ...
    <title>高二天文竞赛上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7368"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7368},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7368";
     ...
     <P><FONT size=4>高二天文竞赛从本周三开始上课，时间为每周三晚上7:00至9:30，地点在教学楼3106教室。相关学生请互相告知。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7366.aspx" target="_self" title="标题：物理教研活动通知&#xD;点击数：259&#xD;发表时间：17年09月25日">物理教研活动通知</a>[ 09-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7370.aspx" target="_self" title="标题：历史教研活动通知&#xD;点击数：181&#xD;发表时间：17年09月25日">历史教研活动通知</a>[ 09-25 ]</div>
                        </div>
                    </div>
