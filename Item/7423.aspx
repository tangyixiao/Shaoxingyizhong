...
<head>
    ...
    <title>模拟联合国社团招新面试通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">模拟联合国社团招新面试通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7423"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7423},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7423";
     ...
     <P>    模联社定于<STRONG>本周四（10月12日）中午12点30分</STRONG>在<STRONG>教学楼一楼4106阶梯教室</STRONG>举行招新面试。请所有有入社意向的同学在周三之前把纸质申请表交到216班的钱书仰或张于晨同学处，或把电子版本的表格在网上发给205班的江子焕同学。所有交了表格的同学均可参加面试，请互相转告。</P>
<P>    另，如果在社团联合招新当天由于种种原因未能领取表格，也想了解、加入模联的同学，也可一并到场，我们同样会提供机会。</P>
<P>    面试的内容大致包括时政热点，国际关系常识，世界史常识，以及对一些社会性的问题发表看法。评判标准有一套客观严谨的方案，确保公平公正，同时并不会拘泥于答案，更多会侧重于思路，所以不必特别准备。如有疑问可联系社长205江子焕。</P>
<P align=right>绍兴一中模拟联合国社团<BR></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7415.aspx" target="_self" title="标题：通知两则&#xD;点击数：445&#xD;发表时间：17年10月08日">通知两则</a>[ 10-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7433.aspx" target="_self" title="标题：通知：领取树人导报&#xD;点击数：184&#xD;发表时间：17年10月11日">通知：领取树人导报</a>[ 10-11 ]</div>
                        </div>
                    </div>
