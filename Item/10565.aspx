...
<head>
    ...
    <title>关于暑期专业阅读作业提交的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于暑期专业阅读作业提交的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10565"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10565},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10565";
     ...
     <P> </P>
<P>各位老师：</P>
<P>目前还有部分老师的暑期专业阅读作业没有交，请尽快完成，于明天之前将<FONT color=#191f25 size=3 face=微软雅黑>电子稿交到“公共文件夹——课程处——专业阅读笔记——相应学科”文件夹下。</FONT><SPAN style='FONT-SIZE: 14px; FONT-FAMILY: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI Symbol"; WHITE-SPACE: pre-wrap; WORD-SPACING: 0px; TEXT-TRANSFORM: none; FLOAT: none; FONT-WEIGHT: 400; COLOR: rgb(25,31,37); FONT-STYLE: normal; TEXT-ALIGN: left; ORPHANS: 2; WIDOWS: 2; DISPLAY: inline !important; LETTER-SPACING: normal; BACKGROUND-COLOR: rgb(255,255,255); TEXT-INDENT: 0px; font-variant-ligatures: normal; font-variant-caps: normal; -webkit-text-stroke-width: 0px; text-decoration-style: initial; text-decoration-color: initial'>格式如下：A4页面，标题宋体三号，正文仿宋四号，行距固定值18，注明学校、姓名。</SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10562.aspx" target="_self" title="标题：相关老师开会的通知&#xD;点击数：240&#xD;发表时间：19年09月17日">相关老师开会的通知</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10587.aspx" target="_self" title="标题：关于2019年浙江省教师发展学校教师满意度调查的通知&#xD;点击数：292&#xD;发表时间：19年09月20日">关于2019年浙江省教师发展学校教师满意度调查的通知</a>[ 09-20 ]</div>
                        </div>
                    </div>
