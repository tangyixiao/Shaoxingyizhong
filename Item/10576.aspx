...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10576"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10576},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10576";
     ...
     <P><FONT size=4>因高三部分老师外出参加联考磨题，相关课程改自修。走班班级在相应上课教室自修。</FONT></P>
<P><FONT size=4>外出老师名单如下：孔祥新、许敏、顾向晖、张叠、王月、张叶、胡勇、陶佳卉、陈微微、陈义兵</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10563.aspx" target="_self" title="标题：体育教研活动通知&#xD;点击数：214&#xD;发表时间：19年09月18日">体育教研活动通知</a>[ 09-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10578.aspx" target="_self" title="标题：关于高二召开名校协作体考试分析会议的通知&#xD;点击数：388&#xD;发表时间：19年09月19日">关于高二召开名校协作体考试分析会议的通知</a>[ 09-19 ]</div>
                        </div>
                    </div>
