...
<head>
    ...
    <title>课题成果获奖讯--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=188"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:188},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=188";
     ...
     <P><FONT size=4>    据绍市教科规组〔2009〕3号文件获悉，在2008年绍兴市属级课题优秀成果评比中，我校参评的三项课题有两项获一等奖，一项获二等奖。 <BR>一等奖： <BR>《通过写作档案袋评价提升高中生英语学习反思能力的行动研究》 负责人 邢秀英 <BR>《Moodle支持下的信息技术教学实践研究》</FONT><FONT size=4>负责人 陈合力 <BR>二等奖： <BR>《新形势下数学教学集体备课模式的探索》负责人&nbs
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/186.aspx" target="_self" title="标题：高三部分选修IB上课安排&#xD;点击数：644&#xD;发表时间：09年09月01日">高三部分选修IB上课安排</a>[ 09-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/191.aspx" target="_self" title="标题：回头考成绩和高三IB成绩录入方法&#xD;点击数：555&#xD;发表时间：09年09月02日">回头考成绩和高三IB成绩录入方法</a>[ 09-02 ]</div>
                        </div>
                    </div>
