...
<head>
    ...
    <title>高三班主任会议通知--高三-绍兴市第一中学</title>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高三班主任会议通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年03月08日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1398"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1398},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1398";
     ...
     <P><FONT size=3>  定于今天(3月8日)下午3：25在教学楼Ⅱ 209室召开高三班主任会议，有事相商。</FONT></P>
<P><FONT size=3>    请各位班主任先做好诚信考试教育，把班级考试座位安排好（学生座位适度拉开），发好十八选六的独立练习试卷，准时出席。</FONT></P>
<P align=right><FONT size=3>教学处  高三年级</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1369.aspx" target="_self" title="标题：高三师生集会通知&#xD;点击数：1262&#xD;发表时间：10年03月01日">高三师生集会通知</a>[ 03-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1407.aspx" target="_self" title="标题：高三&#xD;点击数：556&#xD;发表时间：10年03月09日">高三</a>[ 03-09 ]</div>
                        </div>
                    </div>
