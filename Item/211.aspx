...
<head>
    ...
    <title>高二体育选项课选班--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=211"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:211},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=211";
     ...
     <DIV><FONT size=2>今天进行高二体育选项课选班，具体选班如下：</FONT></DIV>
<DIV><FONT size=2>                   篮球、网球        （一个行政班最多只能报24人）</FONT></DIV
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/209.aspx" target="_self" title="标题：9月7日高三政治1B学分考监考安排&#xD;点击数：571&#xD;发表时间：09年09月07日">9月7日高三政治1B学分考监考安排</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/214.aspx" target="_self" title="标题：关于召开教研组长会议的通知&#xD;点击数：517&#xD;发表时间：09年09月07日">关于召开教研组长会议的通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
