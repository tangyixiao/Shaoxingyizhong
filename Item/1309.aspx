...
<head>
    ...
    <title>关于研究性学习课题报告书写的几点说明--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于研究性学习课题报告书写的几点说明</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1309"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1309},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1309";
           ...
           <FONT size=4><STRONG>按照新课程要求，学生在高中三年，必须要有15学分的研究性学习，每一学分修习时间不少于12学时。目前开设的课程中，除了高三第二学期外，其它5个学期，均有研究性课程。具体安排是每个年级每学期有3门学科开设研究性课程。本学期的研究性课程在开学初以增加课时的形式分配到部分学科，希望这些学科的老师能在学期结束前，指导本班学生写好研究性学习课题报告。下学期开学第一周由指导老师以班级为单位收齐，签好名，上交教学处。课题报告书写内容可以是教材中某一个问题进行研究，研究方式可以有实验、查阅资料、走访、相互讨论等形式。<FONT color=#ff0000>本学期有研究性课程的学科是，高一年级：语文、物理、化学，高二年级：语文、英语、化学，高三年级：语文、数学、英语</FONT> </STRONG></FONT>
<P></P><FONT size=4><STRONG>                                  教学处 </STRONG></FONT>
<P></P><FONT size=4><STRONG>                                  2010.1.30</STRONG></FONT> 
<P></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1308.aspx" target="_self" title="标题：高三备课组长&#xD;点击数：507&#xD;发表时间：10年01月29日">高三备课组长</a>[ 01-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1315.aspx" target="_self" title="标题：高三期末考试场布置要求&#xD;点击数：662&#xD;发表时间：10年02月01日">高三期末考试场布置要求</a>[ 02-01 ]</div>
                        </div>
                    </div>
