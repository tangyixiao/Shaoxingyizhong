...
<head>
    ...
    <title>高三党支部会议因故取消--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2308"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2308},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2308";
     ...
     高三党支部会议因故取消。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2306.aspx" target="_self" title="标题：高三党支部会议&#xD;点击数：249&#xD;发表时间：10年08月28日">高三党支部会议</a>[ 08-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2333.aspx" target="_self" title="标题：原高二党支部会议通知&#xD;点击数：327&#xD;发表时间：10年09月02日">原高二党支部会议通知</a>[ 09-02 ]</div>
                        </div>
                    </div>
