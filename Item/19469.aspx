...
<head>
    ...
    <title>高三体检课务调整通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19469"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19469},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19469";
     ...
     <p>因高三年级6、7、10、11、12、14班参加高考体检，3月14日上午高三年级平行走班课与政治、技术合班课改自修。
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19458.aspx" target="_self" title="标题：本周三（3月13日）地理课改自修的通知&#xD;点击数：165&#xD;发表时间：24年03月11日">本周三（3月13日）地理课改自修的通知</a>[ 03-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19482.aspx" target="_self" title="标题：高三3月限时训练考试安排&#xD;点击数：364&#xD;发表时间：24年03月14日">高三3月限时训练考试安排</a>[ 03-14 ]</div>
                        </div>
                    </div>
