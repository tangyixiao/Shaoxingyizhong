...
<head>
    ...
    <title>校本课程暂停--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=754"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:754},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=754";
     ...
     <FONT face=宋体 color=#000000 size=4>    由于甲流原因，从本周开始校本课程暂停。以后若要上课，教学处再发通知。</FONT>
<P align=right><FONT face=宋体 color=#000000 size=4>                                       教学处</FONT></P>
<P align=right><FONT face=宋体 color=#000000 size=4>                                            11.24</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/545.aspx" target="_self" title="标题：关于5年内青年教师上交教案、听课记录本的通知&#xD;点击数：489&#xD;发表时间：09年11月11日">关于5年内青年教师上交教案、听课记录本的通知</a>[ 11-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/755.aspx" target="_self" title="标题：高三班主任：有关艺术类考试报名&#xD;点击数：396&#xD;发表时间：09年12月02日">高三班主任：有关艺术类考试报名</a>[ 12-02 ]</div>
                        </div>
                    </div>
