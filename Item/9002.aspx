...
<head>
    ...
    <title>关于全校团员填写信息登记表的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于全校团员填写信息登记表的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9002"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9002},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9002";
     ...
     <P>全校各班团支部：</P>
<P>    附件为团员基本情况登记表，较《团支部工作手册》内容有增加，请以本附件为准。</P>
<P>    请各班团支书组织全班团员填写表格，于<STRONG><FONT color=#ff0000>9月21日（周五）13:50前</FONT></STRONG>完成，并以班级团支部为单位，命名为班级序号（如：101、208、316等）上传至公共文件夹“团委 - 0金笛 - 团员信息登记”。</P>
<P>附件：<A title=团员基本情况登记表2018 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201809/2018090617193884.xls">团员基本情况登记表2018</A></P>
<P align=right>校团委<BR>2018年9月6日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8985.aspx" target="_self" title="标题：关于开展“我与亚运”主题征文和演讲活动的通知&#xD;点击数：310&#xD;发表时间：18年09月05日">关于开展“我与亚运”主题征文和演讲活动的通知</a>[ 09-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9007.aspx" target="_self" title="标题：关于高二学生团员团籍档案整理的通知&#xD;点击数：171&#xD;发表时间：18年09月07日">关于高二学生团员团籍档案整理的通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
