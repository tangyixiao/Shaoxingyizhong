...
<head>
    ...
    <title>通知各年级值日老师--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1822"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1822},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1822";
           ...
           各年级值日老师请注意，每日,学生上学与放学时间，请到校门口值勤。时间分别是，上午：7：00---7：30时，下午：5：10---5：30时。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1807.aspx" target="_self" title="标题：2010年5月更换高级职称证书名单公布&amp;nbsp;&amp;nbsp;&amp;nbsp;&#xD;点击数：757&#xD;发表时间：10年04月30日">2010年5月更换高级职称证书名单公布   </a>[ 04-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1826.aspx" target="_self" title="标题：今天早上刷卡提示&#xD;点击数：948&#xD;发表时间：10年05月10日">今天早上刷卡提示</a>[ 05-10 ]</div>
                        </div>
                    </div>
