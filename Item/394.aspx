...
<head>
    ...
    <title>关于举行“深入开展走进经典读书活动”座谈会的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于举行“深入开展走进经典读书活动”座谈会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=394"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:394},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=394";
     ...
     <DIV><FONT size=4>    明天下午（星期三）第四节课在行政楼三楼会议室举行关于“深入开展走进经典读书活动”座谈会，请下列同志拨冗参加。</FONT></DIV>
<DIV><FONT size=4>    陈银伟、王月琴、赵寅芬、蒋卫江、张小娟、朱国强、宋建伟、</FONT></DIV>
<DIV><FONT size=4>    谢澹、张蕾、王新东、傅雅飞、王法新、蒋明、杨大为、胡勇。</FONT
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/390.aspx" target="_self" title="标题：推荐给班主任和全体学生的两篇文章&#xD;点击数：407&#xD;发表时间：09年10月13日">推荐给班主任和全体学生的两篇文章</a>[ 10-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/413.aspx" target="_self" title="标题：关于运动会入场式彩排时间的通知&#xD;点击数：402&#xD;发表时间：09年10月16日">关于运动会入场式彩排时间的通知</a>[ 10-16 ]</div>
                        </div>
                    </div>
