...
<head>
    ...
    <title>运动会训练注意事项--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14013"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14013},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14013";
     ...
     <p>      近期发现有同学训练各运动项目结束后没有及时收回和整理器材，主要是实心球、起跑器、跳高场地设备等。请训练同学注意，训练完成后及时回收并整理器材和场地。另外，夜间不允许练习投掷项目。如再发现以上现象德育处将批评教育。</p><p>                                                                                                  德育处   体育组</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14012.aspx" target="_self" title="标题：9.23班级一日考核&#xD;点击数：69&#xD;发表时间：21年09月24日">9.23班级一日考核</a>[ 09-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14016.aspx" target="_self" title="标题：9.24班级一日考核&#xD;点击数：59&#xD;发表时间：21年09月26日">9.24班级一日考核</a>[ 09-26 ]</div>
                        </div>
                    </div>
