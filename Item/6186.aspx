...
<head>
    ...
    <title>市区英语口语竞赛参加学生--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">市区英语口语竞赛参加学生</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6186"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6186},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6186";
     ...
     <P>以下学生为参加市区英语口语竞赛的同学</P>
<P>具体名单如下：宋芷盈 傅雷 戚逸文 严钊 冯冕 王亮捷<BR></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6184.aspx" target="_self" title="标题：国科大冬令营报名通知（急）&#xD;点击数：281&#xD;发表时间：16年12月22日">国科大冬令营报名通知（急）</a>[ 12-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6191.aspx" target="_self" title="标题：高三培优班上课提醒&#xD;点击数：199&#xD;发表时间：16年12月22日">高三培优班上课提醒</a>[ 12-22 ]</div>
                        </div>
                    </div>
