...
<head>
    ...
    <title>新高一明天(7月4日)下午参观及拍照安排--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">新高一明天(7月4日)下午参观及拍照安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4276"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4276},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4276";
     ...
     <P> </P>
<P>新高一班主任:</P>
<P>明天下午第二节课开始各班参观校史陈列室与拍照,顺序安排如下:</P>
<P>1.参观顺序:高一(16)----(1)班,两个班为单位进行参观,前一批参观结束通知下一批。</P>
<P>2.拍照顺序:高一(1)----(16)班,以班为单位进行，注意仪容仪表，地点行政楼1、2楼。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4268.aspx" target="_self" title="标题：7月3日新高一报告厅座位安排(有修改)&#xD;点击数：666&#xD;发表时间：11年07月02日">7月3日新高一报告厅座位安排(有修改)</a>[ 07-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4278.aspx" target="_self" title="标题：新高二休业式座位安排&#xD;点击数：729&#xD;发表时间：11年07月03日">新高二休业式座位安排</a>[ 07-03 ]</div>
                        </div>
                    </div>
