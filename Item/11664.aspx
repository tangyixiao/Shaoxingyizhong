...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11664"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11664},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11664";
     ...
     定于<STRONG><SPAN lang=EN-US>7</SPAN>月<SPAN lang=EN-US>16</SPAN>日（周四）下午<SPAN lang=EN-US>15:00</SPAN>开始2020年7月学考考务培训</STRONG><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">。地点图书馆<SPAN lang=EN-US>3</SPAN>楼报告厅<SPAN lang=EN-US>2</SPAN>，参加对象全体监考老师（包括本校的监考、预备、流动、视频监考和验卷，到外校的监考、预备、保密）。请老师们相互转告，不要迟到。</SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11662.aspx" target="_self" title="标题：2020年7月学考绍兴一中考点组织机构&#xD;点击数：299&#xD;发表时间：20年07月15日">2020年7月学考绍兴一中考点组织机构</a>[ 07-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11677.aspx" target="_self" title="标题：7月26日公务员招考试场布置要求&#xD;点击数：231&#xD;发表时间：20年07月20日">7月26日公务员招考试场布置要求</a>[ 07-20 ]</div>
                        </div>
                    </div>
