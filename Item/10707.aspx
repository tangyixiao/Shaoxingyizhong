...
<head>
    ...
    <title>各班体育委员会议通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10707"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10707},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10707";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
             ...
             定于今天中午12:30在4106阶梯教室（人文图书旁边）召开各班体育委员会议，请随带纸笔，务必准时参加。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10706.aspx" target="_self" title="标题：升旗仪式暂停通知&#xD;点击数：135&#xD;发表时间：19年10月14日">升旗仪式暂停通知</a>[ 10-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10714.aspx" target="_self" title="标题：各班劳动（卫生）委员会议通知&#xD;点击数：221&#xD;发表时间：19年10月14日">各班劳动（卫生）委员会议通知</a>[ 10-14 ]</div>
                        </div>
                    </div>
