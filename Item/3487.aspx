...
<head>
    ...
    <title>失物招领(公交IC卡)--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3487"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3487},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3487";
...
<P>失物招领</P>
<P> </P>
<P>今拾到公交IC卡一张，有遗失者请尽快到高三物理组张小娟老师处认领。同时烦请各位班主任能在班级提醒一下此事。</P>
<P> </P>
<P>二○一一年三月十日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3314.aspx" target="_self" title="标题：高三几则通知&#xD;点击数：794&#xD;发表时间：11年02月12日">高三几则通知</a>[ 02-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3522.aspx" target="_self" title="标题：高三党员会议通知&#xD;点击数：426&#xD;发表时间：11年03月15日">高三党员会议通知</a>[ 03-15 ]</div>
                        </div>
                    </div>
