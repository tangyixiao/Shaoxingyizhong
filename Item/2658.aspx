...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2658"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2658},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2658";
     ...
     <P><SPAN style="FONT-SIZE: 14pt; FONT-FAMILY: 宋体; mso-bidi-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-font-kerning: 1.0pt; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">  </SPAN></P>
<P><SPAN style="FONT-SIZE: 14pt; FONT-FAMILY: 宋体; mso-bidi-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-font-kerning: 1.0pt; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">    学生会膳管会将针对学生就餐时的不文明现象，携同团委纪检部、团委宣传部在下星期进行为期一周的专项检查。检查内容包括学生就餐时有无插队、乱放餐盘、乱扔垃圾等不文明行为。以上行为一经发现，查实后扣有关学生所在班级考核分，行为严重、态度恶劣及屡教不改者予以曝光。请同学们文明就餐,共同营造良好就餐环境。</SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2657.aspx" target="_self" title="标题：关于公布校牌检查结果的通知（二）&#xD;点击数：843&#xD;发表时间：10年10月15日">关于公布校牌检查结果的通知（二）</a>[ 10-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2672.aspx" target="_self" title="标题：第二期黑板报检查成绩公布：&#xD;点击数：454&#xD;发表时间：10年10月19日">第二期黑板报检查成绩公布：</a>[ 10-19 ]</div>
                        </div>
                    </div>
