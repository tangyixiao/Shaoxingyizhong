...
<head>
    ...
    <title>高一、高二劳动暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6217"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6217},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6217";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
             ...
             因天下雨，今天下午高一、高二劳动课暂停，请相互告知，谢谢！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6211.aspx" target="_self" title="标题：升旗仪式暂停通知&#xD;点击数：62&#xD;发表时间：16年12月26日">升旗仪式暂停通知</a>[ 12-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6225.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：50&#xD;发表时间：16年12月27日">大课间操暂停通知</a>[ 12-27 ]</div>
                        </div>
                    </div>
