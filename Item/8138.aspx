...
<head>
    ...
    <title>工作照拍摄通知（有修改）--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">工作照拍摄通知（有修改）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：总务处</span> <span>发布时间：2018年03月08日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8138"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8138},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8138";
     ...
     <P align=left><FONT size=4>各位教工：</FONT></P>
<P align=left><FONT size=4>    因制作办公室门牌及党员亮牌等工作的需要，学校将统一安排给每位教工拍摄工作照，时间定在3月12日（下周一）12：00-16：00，地点在行政楼一楼考古社。要求穿学校统一工作服（白色或浅色衬衫、西装、男领带或女丝巾），<FONT color=#ff0000><STRONG>党员教师佩戴党徽</STRONG></FONT>。请下周一下午有课的老师，尽量选择中午去拍摄，其他老师选择13：30后去以减少等待时间。</FONT></P>
<P align=left><FONT size=4>    谢谢大家！</FONT></P>
<P align=right><FONT size=4>总务处<BR>2018.3.8</FONT></P>
<P align=left> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8123.aspx" target="_self" title="标题：开学安全提示&#xD;点击数：209&#xD;发表时间：18年03月06日">开学安全提示</a>[ 03-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8152.aspx" target="_self" title="标题：请以下同学抓紧时间激活安全教育平台移动版&#xD;点击数：324&#xD;发表时间：18年03月12日">请以下同学抓紧时间激活安全教育平台移动版</a>[ 03-12 ]</div>
                        </div>
                    </div>
