...
<head>
    ...
    <title>大课间操迟到学生请注意--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6966"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6966},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6966";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
             ...
             近期，部分班级学生大课间操迟到现象严重（规定进场时间5分钟），经与体育组协商，明天开始，迟到的学生一律在篮球场做操，不再计入班出操人数中。烦请班主任和体育委员督促本班学生抓紧出操，谢谢！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6963.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：73&#xD;发表时间：17年05月17日">表扬与失物招领</a>[ 05-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6969.aspx" target="_self" title="标题：关于学生领取市民卡的通知&#xD;点击数：411&#xD;发表时间：17年05月18日">关于学生领取市民卡的通知</a>[ 05-18 ]</div>
                        </div>
                    </div>
