...
<head>
    ...
    <title>高一、高二、高三各班班长会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二、高三各班班长会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6279"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6279},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6279";
     ...
     <P>今天中午12：30高一、高二、高三各班班长请到行政楼五楼会议室开会，随带纸笔，请相互转告不要迟到。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6276.aspx" target="_self" title="标题：高一部分选修课改自修通知&#xD;点击数：186&#xD;发表时间：17年01月05日">高一部分选修课改自修通知</a>[ 01-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6286.aspx" target="_self" title="标题：1月8日物理特长生招生考试考场布置要求&#xD;点击数：378&#xD;发表时间：17年01月06日">1月8日物理特长生招生考试考场布置要求</a>[ 01-06 ]</div>
                        </div>
                    </div>
