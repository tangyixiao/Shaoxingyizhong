...
<head>
    ...
    <title>大扫除停做通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1889"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1889},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1889";
...
<P>        今日大扫除停做，请各知照。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1883.aspx" target="_self" title="标题：一周检查情况公布(2010.5.7-5.15)&#xD;点击数：298&#xD;发表时间：10年05月17日">一周检查情况公布(2010.5.7-5.15)</a>[ 05-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1893.aspx" target="_self" title="标题：绍兴一中各班住校生就寝纪律、寝室卫生情况统计表&#xD;点击数：252&#xD;发表时间：10年05月18日">绍兴一中各班住校生就寝纪律、寝室卫生情况统计表</a>[ 05-18 ]</div>
                        </div>
                    </div>
