...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8215"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8215},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8215";
     ...
     由于天气原因，今天升旗仪式暂停！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8194.aspx" target="_self" title="标题：寻物启事&#xD;点击数：1047&#xD;发表时间：18年03月21日">寻物启事</a>[ 03-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8216.aspx" target="_self" title="标题：大扫除改期通知&#xD;点击数：152&#xD;发表时间：18年03月26日">大扫除改期通知</a>[ 03-26 ]</div>
                        </div>
                    </div>
