...
<head>
    ...
    <title>关于教职员工主动“亮码”的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于教职员工主动“亮码”的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：安全处</span> <span>发布时间：2020年05月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11465"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11465},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11465";
     ...
     <P><FONT size=4>全体教职员工： </FONT></P>
<P><FONT size=4>    根据上级要求，经学校研究决定，即日起教职员工查验健康码按以下方式进行：<BR>    1.每日进校门口时，主动向测温志愿者老师或保安出示当天的健康码；<BR>    2.每周星期天晚上8点前截图当日的健康码发至网格长，由网格长查验健康码情况；<BR>    3.教工若发现自己的健康码变为非“绿码”时，请暂时不要来校，并由本人或网格长第一时间向学校安监处汇报，等待学校进一步指令。</FONT></P>
<P align=right><FONT size=4>绍兴一中疫情防控工作领导小组<BR>2020.5.26</FONT></P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11406.aspx" target="_self" title="标题：心理普查补测通知&#xD;点击数：393&#xD;发表时间：20年05月13日">心理普查补测通知</a>[ 05-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11469.aspx" target="_self" title="标题：请各班安全委员到医务室领取《健康教育资料》&#xD;点击数：181&#xD;发表时间：20年05月27日">请各班安全委员到医务室领取《健康教育资料》</a>[ 05-27 ]</div>
                        </div>
                    </div>
