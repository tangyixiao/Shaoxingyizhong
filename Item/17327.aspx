...
<head>
    ...
    <title>2.17跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2.17跑操量化考核反馈</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17327"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17327},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17327";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2023/2/202302211433221594.png" style="max-width: 100%; " title="202302211433221594.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17324.aspx" target="_self" title="标题：2.17-2.21班级一日考核&#xD;点击数：69&#xD;发表时间：23年02月21日">2.17-2.21班级一日考核</a>[ 02-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17337.aspx" target="_self" title="标题：2.22跑操量化考核反馈表&#xD;点击数：178&#xD;发表时间：23年02月22日">2.22跑操量化考核反馈表</a>[ 02-22 ]</div>
                        </div>
                    </div>
