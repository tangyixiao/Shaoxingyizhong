...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10883"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10883},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10883";
     ...
     <FONT size=4>明天（周二）上午物理组全体老师外出参加教研活动，相关班级物理课改自修，走班学生在相应上课教室自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10877.aspx" target="_self" title="标题：高三调测暨期中考试试场布置及考试要求&#xD;点击数：269&#xD;发表时间：19年11月18日">高三调测暨期中考试试场布置及考试要求</a>[ 11-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10886.aspx" target="_self" title="标题：语文教研活动通知&#xD;点击数：294&#xD;发表时间：19年11月19日">语文教研活动通知</a>[ 11-19 ]</div>
                        </div>
                    </div>
