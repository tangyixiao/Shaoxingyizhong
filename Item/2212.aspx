...
<head>
    ...
    <title>关于交住校申请表的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2212"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2212},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2212";
     ...
     <P><FONT size=4>新高一、新高三各班:</FONT></P>
<P><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=4>   请把《住校生申请表》统计好，今天下午放学前交到德育处，以便及时安排住宿。</FONT></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2209.aspx" target="_self" title="标题：关于新高二交住校申请表的通知&#xD;点击数：295&#xD;发表时间：10年07月04日">关于新高二交住校申请表的通知</a>[ 07-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2219.aspx" target="_self" title="标题：温馨提醒&#xD;点击数：506&#xD;发表时间：10年07月06日">温馨提醒</a>[ 07-06 ]</div>
                        </div>
                    </div>
