...
<head>
    ...
    <title>师生共庆入学30周年--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5127"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5127},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5127";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5126.aspx" target="_self" title="标题：一封家书，记录了抗战时期绍兴的一段校史&#xD;点击数：377&#xD;发表时间：15年09月10日">一封家书，记录了抗战时期绍兴的一段校史</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5131.aspx" target="_self" title="标题：教育：选择并抵达&#xD;点击数：452&#xD;发表时间：15年09月18日">教育：选择并抵达</a>[ 09-18 ]</div>
                        </div>
                    </div>
