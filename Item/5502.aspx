...
<head>
    ...
    <title>今天下午劳动通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5502"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5502},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5502";
           ...
           今天是正式开学后第一次劳动课，请各班劳动委员组织好本班同学，认真、仔细的做好教室、每日包干区和每周包干区卫生工作，以干净的校园环境迎接中秋佳节。德育处将进行检查考核。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5500.aspx" target="_self" title="标题：表扬&#xD;点击数：282&#xD;发表时间：16年09月11日">表扬</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5503.aspx" target="_self" title="标题：大课间活动通知（附：要求与路线）&#xD;点击数：210&#xD;发表时间：16年09月12日">大课间活动通知（附：要求与路线）</a>[ 09-12 ]</div>
                        </div>
                    </div>
