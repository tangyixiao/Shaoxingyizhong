...
<head>
    ...
    <title>明天下午第三节高三体育课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">明天下午第三节高三体育课改自修</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3062"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3062},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3062";
     ...
     因明天下午体育馆进高一、高二的艺术节活动，明天下午第三节高三有体育课的班级改自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3058.aspx" target="_self" title="标题：班主任请注意&#xD;点击数：1186&#xD;发表时间：10年12月15日">班主任请注意</a>[ 12-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3064.aspx" target="_self" title="标题：通知三则(修改)&#xD;点击数：1902&#xD;发表时间：10年12月15日">通知三则(修改)</a>[ 12-15 ]</div>
                        </div>
                    </div>
