...
<head>
    ...
    <title>关于大课间跑操的几点强调--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于大课间跑操的几点强调</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18685"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18685},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18685";
     ...
     <p>      为进一步规范有序地进行大课间跑操，更好地达到锻炼效果，现对全校大课间跑操的进场、跑步、退场等再进行几点强调：
1.	下课铃响（9：10），体育委员立即组织同学门口排队，两路纵队，体育委员穿好班号服马甲，一前一后，带领队伍按路线下楼。
2.	到达指定场地后，以班级为单位，高二、高三成八路纵队站立，高一成六路纵队站立，穿马甲服的同学一名站班级方阵前面，一名站在方阵旁边。
3.	班与班之间的距离为10米左右，各班排头务必控制好间距，跑步口令开始时，各年段才能开始跑步，且不能提前跑。
4.	跑步时需整齐、合拍、口号响亮。</p><p>       望班主任能下楼指导，第二节有课的老师能及时停课，谢谢大家！</p><p>
</p><p>                                                                                       德育处、体育组</p><p>                                                                                     2023年10月25日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18684.aspx" target="_self" title="标题：10.24班级一日考核&#xD;点击数：47&#xD;发表时间：23年10月25日">10.24班级一日考核</a>[ 10-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18686.aspx" target="_self" title="标题：第五届校级家委会会议方案&#xD;点击数：216&#xD;发表时间：23年10月25日">第五届校级家委会会议方案</a>[ 10-25 ]</div>
                        </div>
                    </div>
