...
<head>
    ...
    <title>3.21跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">3.21跑操量化考核反馈</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21119"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21119},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21119";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/3/202503211554523640.png" style="max-width: 100%; " title="202503211554523640.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21118.aspx" target="_self" title="标题：3.20班级一日考核&#xD;点击数：32&#xD;发表时间：25年03月21日">3.20班级一日考核</a>[ 03-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21122.aspx" target="_self" title="标题：关于组织开展2025年第一次视力普查的通知（修改）&#xD;点击数：112&#xD;发表时间：25年03月21日">关于组织开展2025年第一次视力普查的通知（修改）</a>[ 03-21 ]</div>
                        </div>
                    </div>
