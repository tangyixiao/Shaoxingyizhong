...
<head>
    ...
    <title>高三班主任（艺术类是否有漏报）--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三班主任（艺术类是否有漏报）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2983"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2983},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2983";
     ...
     <P>已经领取艺术类报名号的有：</P>
<P>高三（01）班    张烈恒 </P>
<P>高三（02）班    陈肖西     金怡隽    冯阳</P>
<P>高三（03）班    张天       刘天宇</P>
<P>高三（04）班    罗贝      </P>
<P>高三（13）班    丁蒙成</P>
<P>请班主任核对一下，有没有漏掉的学生，如有漏掉，及时通知学生，网上报名截止时间12月2日22:00，已领取报名号的学生，请班主任通知学生12月6日上午来教学处确认、缴费。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2982.aspx" target="_self" title="标题：高三“重点工程强化班”继续上课&#xD;点击数：466&#xD;发表时间：10年12月02日">高三“重点工程强化班”继续上课</a>[ 12-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2986.aspx" target="_self" title="标题：强调下午放学时间&#xD;点击数：583&#xD;发表时间：10年12月03日">强调下午放学时间</a>[ 12-03 ]</div>
                        </div>
                    </div>
