...
<head>
    ...
    <title>今天早晨下列车子违章--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天早晨下列车子违章</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年11月12日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=547"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:547},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=547";
     ...
     <P><FONT size=5><STRONG>    据值周老师反映，今天早晨下列车辆存在违规现象。希有关同学告知家长。</STRONG></FONT></P>
<P><FONT size=5><STRONG>   任意调头：</STRONG></FONT></P>
<P><FONT size=5><STRONG>   浙D6886X、浙D2283X、浙D3318X、8658X、浙D9362X</STRONG></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/542.aspx" target="_self" title="标题：通知&#xD;点击数：245&#xD;发表时间：09年11月11日">通知</a>[ 11-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/828.aspx" target="_self" title="标题：关于2010年元旦文艺演出的通知&#xD;点击数：402&#xD;发表时间：09年12月03日">关于2010年元旦文艺演出的通知</a>[ 12-03 ]</div>
                        </div>
                    </div>
