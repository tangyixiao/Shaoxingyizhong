...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6227"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6227},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6227";
     ...
     高一（6）郦高庭于12月23日在高一教学楼拾到眼镜一副，特此表扬，望失主及时到德育处来认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6225.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：50&#xD;发表时间：16年12月27日">大课间操暂停通知</a>[ 12-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6228.aspx" target="_self" title="标题：艺术节闭幕式歌舞类入选节目开会通知&#xD;点击数：1114&#xD;发表时间：16年12月27日">艺术节闭幕式歌舞类入选节目开会通知</a>[ 12-27 ]</div>
                        </div>
                    </div>
