...
<head>
    ...
    <title>关于高三毕业生转接团组织关系的通知(补充)--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高三毕业生转接团组织关系的通知(补充)</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年08月04日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=95"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:95},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=95";
     ...
     <P>    <FONT size=5>  由于部分大学开学较早，相应高三毕业生转接团组织关系的时间提前为：<FONT color=#ff0000>8月13日-14日</FONT>上午8：30-11：00，请携带团员证，<SPAN style="FONT-SIZE: 18pt; COLOR: black; FONT-FAMILY: 宋体; mso-ascii-font-family: ''&#718;&#805;,Verdana,Arial'';
                        ...
                        <div class="others">
                            ...
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/119.aspx" target="_self" title="标题：关于高一班长会议的通知&#xD;点击数：661&#xD;发表时间：09年08月18日">关于高一班长会议的通知</a>[ 08-18 ]</div>
                        </div>
                    </div>
