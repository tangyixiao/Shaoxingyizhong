...
<head>
    ...
    <title>买书改期通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">买书改期通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>买书改期通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年10月21日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2698"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2698},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2698";
     ...
     <P> </P>
<P><FONT size=4>各班注意：</FONT></P>
<P><FONT size=4>原定明天中午新华书店工作人员来校门口售书，由于开运动会，所以改期到下周四（10月28日）中午12：20进行，请相互转告。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2697.aspx" target="_self" title="标题：9月1日至10月20日各班使用校讯通情况统计：&#xD;点击数：583&#xD;发表时间：10年10月21日">9月1日至10月20日各班使用校讯通情况统计：</a>[ 10-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2704.aspx" target="_self" title="标题：值周检查情况汇总（10月21日星期四）&#xD;点击数：372&#xD;发表时间：10年10月23日">值周检查情况汇总（10月21日星期四）</a>[ 10-23 ]</div>
                        </div>
                    </div>
