...
<head>
    ...
    <title>本周六、周日上课安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8041"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8041},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8041";
     ...
     <!--StartFragment -->
<DIV><FONT size=4>高一、高二周六按周四的课表上课；高三周六按周四课表上课，周日按周五的课表上课，下周一在校停课复习，任课老师按课表下班辅导，停课复习期间选考科目走班暂停 。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8035.aspx" target="_self" title="标题：期末教学安排&#xD;点击数：1156&#xD;发表时间：18年01月31日">期末教学安排</a>[ 01-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8044.aspx" target="_self" title="标题：高一期末考试安排&#xD;点击数：860&#xD;发表时间：18年02月03日">高一期末考试安排</a>[ 02-03 ]</div>
                        </div>
                    </div>
