...
<head>
    ...
    <title>未成年人医保参保学生交费有关问题（班主任）--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">未成年人医保参保学生交费有关问题（班主任）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=453"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:453},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=453";
     ...
     <DIV>各位班主任：</DIV>
<DIV>     09年度未成年人医保参保学生信息核对已结束，请关注以下三点：</DIV>
<DIV>1、  请至校内文件夹--教学处--医务室下载各班参保学生信息，核对缴费人数。（社保局数据库中学生身份证信息以初中首次参保时为准，存在大批学生身份证号码有误的情况，因社保局不再做更正处理，故今后参保只能以社保局库存的错误身份证信息为准，请高一高二班主任保留相关参保信息，以备明年之用。）</DIV>
<DIV>2、&nb
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/451.aspx" target="_self" title="标题：值周小结&#xD;点击数：539&#xD;发表时间：09年10月25日">值周小结</a>[ 10-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/456.aspx" target="_self" title="标题：党员大会通知&#xD;点击数：535&#xD;发表时间：09年10月26日">党员大会通知</a>[ 10-26 ]</div>
                        </div>
                    </div>
