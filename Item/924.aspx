...
<head>
    ...
    <title>关于教职工持卡刷卡的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于教职工持卡刷卡的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=924"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:924},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=924";
     ...
     <FONT face=宋体 color=#000000 size=3>    刷卡机已安装好，并能使用。卡机分别在传达室内、医务室北侧、每幢教学楼，一层与二层楼的楼道口、科学馆的二层楼道口。</FONT>
<DIV><FONT face=宋体 color=#000000 size=3>    教职工同志请在今天去办卡（办卡在行政三楼会议室），自下周一开始挂卡刷卡。</FONT></DIV>
<DIV><FONT face=宋体 color=#000000 size=3>    刷卡要求：上班、下班、中途进出校门（包括公出与私事进出）。</FONT></DIV>
<DIV><FONT face=宋体 color=#000000 size=3>    请自觉刷卡。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/922.aspx" target="_self" title="标题：有关校讯通教师卡升级的通知&#xD;点击数：747&#xD;发表时间：09年12月05日">有关校讯通教师卡升级的通知</a>[ 12-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/976.aspx" target="_self" title="标题：关于教工会议的通知&#xD;点击数：384&#xD;发表时间：09年12月07日">关于教工会议的通知</a>[ 12-07 ]</div>
                        </div>
                    </div>
