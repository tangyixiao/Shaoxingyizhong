...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2667"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2667},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2667";
...
<P><STRONG><FONT size=4>    18日、19日、20日下午运动会入场式训练各年级按原计划正常进行。</FONT></STRONG></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2662.aspx" target="_self" title="标题：德育处三点提醒&#xD;点击数：486&#xD;发表时间：10年10月18日">德育处三点提醒</a>[ 10-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2668.aspx" target="_self" title="标题：关于高一高二大扫除的通知&#xD;点击数：414&#xD;发表时间：10年10月18日">关于高一高二大扫除的通知</a>[ 10-18 ]</div>
                        </div>
                    </div>
