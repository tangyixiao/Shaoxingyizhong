...
<head>
    ...
    <title>2020学年团三项先进评选通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2020学年团三项先进评选通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13633"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13633},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13633";
     ...
     <p><strong>1.2020学年第2学期校级团先进</strong></p><p>①先进团支部：将根据团支部量化分数进行考核，完成考核后公示；
②优秀团干部、优秀团员：高一、高二每班<span style="color: rgb(0, 176, 240);">按比例</span>民主推选产生，计算公式：班级<span style="color: rgb(0, 176, 240);">团员人数*20%</span>（四舍五入），其中，<span style="color: rgb(0, 176, 240);">优秀团干部0~1人</span>；
③学期校级优秀团干部、优秀团员名单，请以<span style="color: rgb(255, 0, 0);">txt文档</span>格式，<span style="color: rgb(255, 0, 0);">命名为班级序号</span>，于<span style="color: rgb(255, 0, 0);">6月21日（周一）13:40前</span>交至公共文件夹“团委 - 团三项先进 - 2020学年第2学期校级优团优干”。</p><p>
</p><p><strong>2.2020学年市直团先进</strong></p><p>①先进团支部：将在两个学期中考核前3的团支部中综合考量产生；
②优秀团干部：两个学期考核均为一等奖的团支部，可推荐1名，同时，在学校团委、班级团支部担任团干部的团员均可自荐；
③优秀团员：两个学期考核均在二等奖及以上的团支部，可推荐1名，同时，有突出表现的团员均可自荐；
④学年市直团先进将根据教育局团工委届时下发的文件进行推选，另行通知。</p><p>
...
2021年6月15日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13613.aspx" target="_self" title="标题：团支部考核时间调整通知&#xD;点击数：170&#xD;发表时间：21年06月12日">团支部考核时间调整通知</a>[ 06-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13644.aspx" target="_self" title="标题：树人导报领取通知&#xD;点击数：58&#xD;发表时间：21年06月17日">树人导报领取通知</a>[ 06-17 ]</div>
                        </div>
                    </div>
