...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6593"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6593},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6593";
     ...
     3月21日（周二）物理组全体老师外出参加市高中物理学考、选考复习研讨会，相关班级物理课改自修。高二物理走班课学生到相应上课教室自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6592.aspx" target="_self" title="标题：关于组织高二、高三学生模拟验证的通知&#xD;点击数：360&#xD;发表时间：17年03月20日">关于组织高二、高三学生模拟验证的通知</a>[ 03-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6598.aspx" target="_self" title="标题：高三部分学生会议通知&#xD;点击数：339&#xD;发表时间：17年03月21日">高三部分学生会议通知</a>[ 03-21 ]</div>
                        </div>
                    </div>
