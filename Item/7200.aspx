...
<head>
    ...
    <title>物品搬运通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7200"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7200},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7200";
     ...
     <!--StartFragment -->
<DIV><BR>全校教工：<BR>    根据安排，学校的搬迁工作现已启动，所有需要搬运至新一中的物品已开始陆续搬运。为保证搬迁工作的有序、顺利完成，请各处室、年级和老师将需要学校搬运的大件难运物品及时打包，并填写、张贴好《物品信息标签》（见附件），于7月1日前联系陈锋老师落实搬运。<BR>    因教工宿舍目前还不能安排确定，所有个人物品只能暂时统一存放在教师办公室，请老师们填写好存放地点，在规定时间内打包待运，学校将从7月2日起开始统一集中搬运。<BR>    谢谢大家的支持配合！<BR>                                                                                     <BR>                                                                                     校办、总务处<BR>                                                                                   2017年6月27日</DIV>
<DIV>附：<A title=物品标签(1) href="/Shaoxingyizhong/UploadFiles/UploadFiles/201706/2017062709552351.doc">物品标签(1)</A></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7190.aspx" target="_self" title="标题：行政组（支部）会议通知&#xD;点击数：210&#xD;发表时间：17年06月26日">行政组（支部）会议通知</a>[ 06-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7209.aspx" target="_self" title="标题：学校办公设备回收通知&#xD;点击数：154&#xD;发表时间：17年06月28日">学校办公设备回收通知</a>[ 06-28 ]</div>
                        </div>
                    </div>
