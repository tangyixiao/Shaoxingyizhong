...
<head>
    ...
    <title>高三及高一部分班级停课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三及高一部分班级停课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17875"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17875},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17875";
     ...
     <p>因明天许敏、杨国仁、邢秀英、翁鹏飞、胡勇、陈依、王淑会、金华元、张超、孟玲燕、白宗刚等老师前往杭州参加磨卷工作，相关班级的课改自修。
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17869.aspx" target="_self" title="标题：政治教研活动通知&#xD;点击数：237&#xD;发表时间：23年05月09日">政治教研活动通知</a>[ 05-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17901.aspx" target="_self" title="标题：高三四校仿真考时间安排&#xD;点击数：440&#xD;发表时间：23年05月15日">高三四校仿真考时间安排</a>[ 05-15 ]</div>
                        </div>
                    </div>
