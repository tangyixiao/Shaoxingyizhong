...
<head>
    ...
    <title>关于跨年门按照规划展示的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于跨年门按照规划展示的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12506"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12506},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12506";
     ...
     <P>请各班统一按规划展示跨年门， 不可自行随意放置影响图书馆正常工作。具体放置时间和地点美术组会联系各班宣传委员。谢谢！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12505.aspx" target="_self" title="标题：失物招领&#xD;点击数：205&#xD;发表时间：20年12月21日">失物招领</a>[ 12-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12507.aspx" target="_self" title="标题：大课间跑操暂停通知&#xD;点击数：267&#xD;发表时间：20年12月22日">大课间跑操暂停通知</a>[ 12-22 ]</div>
                        </div>
                    </div>
