...
<head>
    ...
    <title>就团支部考核事宜的开会通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">就团支部考核事宜的开会通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18201"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18201},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18201";
     ...
     <p>      请以下同学明天大课间9:25分在2414参加关于团支部考核的短会，请不要迟到。</p><p>       团学联各部门部长</p><p><span style="color: rgb(23, 26, 29); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI Symbol", "Myanmar Text", 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255); font-size: 16px;">       高一高二各班团支书</span></p><p style="text-align: right;">2023.6.28</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18169.aspx" target="_self" title="标题：2022学年团三项先进评选通知&#xD;点击数：258&#xD;发表时间：23年06月25日">2022学年团三项先进评选通知</a>[ 06-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18202.aspx" target="_self" title="标题：树人导报领取通知&#xD;点击数：61&#xD;发表时间：23年06月28日">树人导报领取通知</a>[ 06-28 ]</div>
                        </div>
                    </div>
