...
<head>
    ...
    <title>请同学们关注校门口的校服展示--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">请同学们关注校门口的校服展示</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=479"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:479},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=479";
     ...
     <FONT size=5><STRONG>    近日会在校门口展示大家比较喜欢的校服式样，请广大同学关注。</STRONG></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/478.aspx" target="_self" title="标题：班主任会议通知&#xD;点击数：322&#xD;发表时间：09年10月29日">班主任会议通知</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/490.aspx" target="_self" title="标题：一周检查情况公布(2009.10.26-10.31)&#xD;点击数：335&#xD;发表时间：09年11月02日">一周检查情况公布(2009.10.26-10.31)</a>[ 11-02 ]</div>
                        </div>
                    </div>
