...
<head>
    ...
    <title>第17周主要工作安排表（12.22-12.28）--工作安排-绍兴市第一中学</title>
...
<li class="li5 last"><a href="/Shaoxingyizhong/Category_24/Index.aspx">校务公开</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22534"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22534},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22534";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/12/202512221647469753.png" style="max-width: 100%; " title="202512221647469753.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22479.aspx" target="_self" title="标题：第16周主要工作安排表（12.15-12.21)&#xD;点击数：4&#xD;发表时间：25年12月15日">第16周主要工作安排表（12.15-12.21)</a>[ 12-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22580.aspx" target="_self" title="标题：第18周主要工作安排表（12.29-1.4）&#xD;点击数：8&#xD;发表时间：25年12月29日">第18周主要工作安排表（12.29-1.4）</a>[ 12-29 ]</div>
                        </div>
                    </div>
