...
<head>
    ...
    <title>高三数学、物理培优课暂停通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三数学、物理培优课暂停通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6216"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6216},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6216";
     ...
     <P>因高三超级全能生考试，本周一、周三高三高三数学、物理培优课暂停一次。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6215.aspx" target="_self" title="标题：高三班主任会议通知&#xD;点击数：142&#xD;发表时间：16年12月26日">高三班主任会议通知</a>[ 12-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6226.aspx" target="_self" title="标题：高二历史走班课上课地点变更通知&#xD;点击数：95&#xD;发表时间：16年12月27日">高二历史走班课上课地点变更通知</a>[ 12-27 ]</div>
                        </div>
                    </div>
