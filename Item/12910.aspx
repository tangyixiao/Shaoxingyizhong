...
<head>
    ...
    <title>校电Prime榜--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">校电Prime榜</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2021年10月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12910"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12910},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12910";
     ...
     <p style="line-height: 16px;">为了视频资料存档及电子班牌正常播放，烦请各位制作负责人把最终视频文件放入FTP 成片 文件夹；
</p><p style="line-height: 16px;">
<img src="/Shaoxingyizhong/UploadFiles/ssxz/2021/10/202110090826240769.png" style="max-width: 100%; " title="202110090826240769.png" /></p><p style="line-height: 16px;">
</p><p style="padding: 0px; margin-top: 0px; margin-bottom: 0.001pt; color: rgb(51, 51, 51); white-space: normal; background-color: rgb(255, 255, 255); font-family: 等线; font-size: 10.5pt; line-height: 15.12px; text-align: justify;"><span style="font-size: 10.5pt;">欢迎同学们加入 校电董事QQ群 782403364；</span>
</p><p style="padding: 0px; margin-top: 0px; margin-bottom: 0.001pt; color: rgb(51, 51, 51); white-space: normal; background-color: rgb(255, 255, 255); font-family: 等线; font-size: 10.5pt; line-height: 15.12px; text-align: justify;">
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12896.aspx" target="_self" title="标题：【模联】上课通知&#xD;点击数：56&#xD;发表时间：21年03月15日">【模联】上课通知</a>[ 03-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12917.aspx" target="_self" title="标题：【求真实验室】社团活动&#xD;点击数：76&#xD;发表时间：21年03月17日">【求真实验室】社团活动</a>[ 03-17 ]</div>
                        </div>
                    </div>
