...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一近期安排</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高一</span> <span>发布时间：2009年10月21日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=435"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:435},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=435";
     ...
     星期三（今晚晚自修照常），星期四和星期五晚自修取消（老师不用来校管理了），周六住校生的晚自修正常。请晚自修管理老师互相提醒(具体时间请查阅值班表）。 
<P><FONT size=3>2、运动会期间要加强安全教育，注意安全第一！中午好好在教室休息。请班主任和值班老师加强</FONT><FONT size=3>管理。</FONT></P>
<P><FONT size=3>3、全体人员参加入场式和闭幕式。</FONT></P>
<P><FONT size=3>4、周日上星期四的课；</FONT></P>
<P
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/372.aspx" target="_self" title="标题：高一支部会议&#xD;点击数：376&#xD;发表时间：09年10月09日">高一支部会议</a>[ 10-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/487.aspx" target="_self" title="标题：高一期中考试期间安排&#xD;点击数：275&#xD;发表时间：09年10月30日">高一期中考试期间安排</a>[ 10-30 ]</div>
                        </div>
                    </div>
