...
<head>
    ...
    <title>行政工会小组会议通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=428"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:428},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=428";
     ...
     <P>全体行政工会会员:</P>
<P>       定于今天下午第四节课在行政楼三楼会议室开个短会,请准时参加,并随带笔!</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/418.aspx" target="_self" title="标题：教工会议通知&#xD;点击数：540&#xD;发表时间：09年10月19日">教工会议通知</a>[ 10-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/431.aspx" target="_self" title="标题：关于2009年市直中学高级教师申报对象课堂教学能力考核的通知&#xD;点击数：618&#xD;发表时间：09年10月20日">关于2009年市直中学高级教师申报对象课堂教学能力考核的通知</a>[ 10-20 ]</div>
                        </div>
                    </div>
