...
<head>
    ...
    <title>重申：考试时不能使用计算器--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">重申：考试时不能使用计算器</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2176"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2176},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2176";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3>会考、高考均不能使用计算器，学校一直来强调考试时不能使用计算器，昨天发现高一年级考试时有个别试场使用计算器，请监考老师提醒学生不能使用计算器。也请全体老师和学生明确，学校组织的任何考试都不能使用计算器。</FONT></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2170.aspx" target="_self" title="标题：有关省学籍管理系统数据录入通知&#xD;点击数：400&#xD;发表时间：10年06月30日">有关省学籍管理系统数据录入通知</a>[ 06-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2177.aspx" target="_self" title="标题：温馨提示：关于2009学年第二学期教科研成果奖金发放的通知&#xD;点击数：334&#xD;发表时间：10年07月01日">温馨提示：关于2009学年第二学期教科研成果奖金发放的通知</a>[ 07-01 ]</div>
                        </div>
                    </div>
