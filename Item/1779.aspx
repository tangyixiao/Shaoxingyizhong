...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1779"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1779},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1779";
     ...
     <P>                                                工会提示</P>
<P>      上周日工会组织的爬山活动，因公务外出人员较多，经研究决定，于5月2日上午7：30——9：00组织一次爬山机会，请上次未参加的工会会员带好年卡，按时参加，过时不侯。2路车的终点，凭卡可乘坐观光车进入，自驾车请注意安全。</P>
<P>                                                                          工会</P>
<P>                                                                   2010年4月27日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1769.aspx" target="_self" title="标题：工会提醒&#xD;点击数：802&#xD;发表时间：10年04月24日">工会提醒</a>[ 04-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1872.aspx" target="_self" title="标题：文明办公室检查&#xD;点击数：561&#xD;发表时间：10年05月14日">文明办公室检查</a>[ 05-14 ]</div>
                        </div>
                    </div>
