...
<head>
    ...
    <title>名师解读省高考《考试说明》--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">名师解读省高考《考试说明》</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=584"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:584},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=584";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/583.aspx" target="_self" title="标题：绍兴市高级专家风采⑤陈合力&#xD;点击数：452&#xD;发表时间：09年11月13日">绍兴市高级专家风采⑤陈合力</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/585.aspx" target="_self" title="标题：谁愿去四川灾区支教&amp;nbsp;三分之二老师举了手&#xD;点击数：391&#xD;发表时间：09年11月13日">谁愿去四川灾区支教 三分之二老师举了手</a>[ 11-13 ]</div>
                        </div>
                    </div>
