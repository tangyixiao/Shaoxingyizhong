...
<head>
    ...
    <title>高一计算机课在教室上--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2607"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2607},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2607";
     ...
     由于明天供电容量有限，高一计算机课在教室上课，请班主任通知学生，并请班主任监督学生关掉教室日光灯<FONT size=3>，电脑、投影仪可正常使用。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2588.aspx" target="_self" title="标题：国庆后上课安排&#xD;点击数：781&#xD;发表时间：10年09月30日">国庆后上课安排</a>[ 09-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2621.aspx" target="_self" title="标题：研究性课程继续上课通知&#xD;点击数：448&#xD;发表时间：10年10月11日">研究性课程继续上课通知</a>[ 10-11 ]</div>
                        </div>
                    </div>
