...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7966"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7966},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7966";
     ...
     今天空气质量中度污染，跑操暂停！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7959.aspx" target="_self" title="标题：表扬及失物招领&#xD;点击数：189&#xD;发表时间：18年01月16日">表扬及失物招领</a>[ 01-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7969.aspx" target="_self" title="标题：大扫除通知&#xD;点击数：145&#xD;发表时间：18年01月17日">大扫除通知</a>[ 01-17 ]</div>
                        </div>
                    </div>
