...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2890"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2890},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2890";
     ...
     <P>                                        文明办公室检查</P>
<P>    今天下午第4节课进行文明办公室检查。鉴于近日各办公室资料较多，故请各办公室尤其要整理好资料的摆放。</P>
<P>    请今天白天值班的高一、高二、高三的老师下午第4节课到总务处（2）集中。</P>
<P> </P>
<P>                                                     校文明办公室检查小组</P>
<P>                                                            2010.11.19</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2841.aspx" target="_self" title="标题：工会登山活动与参加比赛名单&#xD;点击数：954&#xD;发表时间：10年11月11日">工会登山活动与参加比赛名单</a>[ 11-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2971.aspx" target="_self" title="标题：喜报&#xD;点击数：687&#xD;发表时间：10年12月01日">喜报</a>[ 12-01 ]</div>
                        </div>
                    </div>
