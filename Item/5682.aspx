...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5682"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5682},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5682";
     ...
     高一（6）鲁一晨在2号食堂楼梯口捡到校牌一张，特此表扬，望失主及时来德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5679.aspx" target="_self" title="标题：表扬&#xD;点击数：187&#xD;发表时间：16年10月07日">表扬</a>[ 10-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5688.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：56&#xD;发表时间：16年10月08日">表扬与失物招领</a>[ 10-08 ]</div>
                        </div>
                    </div>
