...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10370"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10370},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10370";
     ...
     <P>全体教代会代表：</P>
<P>       兹定于明天（7月7日）上午九点，在图书馆报告厅二召开十一届教代会全体代表会议，请您提前五分钟入场，在指定位置就座。随带笔。谢谢！</P>
<P>                                                                               工会</P>
<P>                                                                              7月6日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10346.aspx" target="_self" title="标题：市直级先进工作者候选人公示&#xD;点击数：291&#xD;发表时间：19年07月03日">市直级先进工作者候选人公示</a>[ 07-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10371.aspx" target="_self" title="标题：公示&#xD;点击数：264&#xD;发表时间：19年07月07日">公示</a>[ 07-07 ]</div>
                        </div>
                    </div>
