...
<head>
    ...
    <title>参加兴趣小组，兴趣第一还得学有余力--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">参加兴趣小组，兴趣第一还得学有余力</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=749"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:749},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=749";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/748.aspx" target="_self" title="标题：符合条件的学生，都有机会成为推荐生！&#xD;点击数：520&#xD;发表时间：09年12月01日">符合条件的学生，都有机会成为推荐生！</a>[ 12-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/750.aspx" target="_self" title="标题：绍兴一中学生获“丘成桐数学奖”&#xD;点击数：512&#xD;发表时间：09年12月01日">绍兴一中学生获“丘成桐数学奖”</a>[ 12-01 ]</div>
                        </div>
                    </div>
