...
<head>
    ...
    <title>高三自修教室安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7734"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7734},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7734";
     ...
     <P><FONT size=4>11月份选考结束后，部分学生选考学科将改自修。学校将安排教室用于高三学生自修，自修学生到规定教室自修，不得随意使用其他教室。具体安排如下：</FONT></P>
<P><FONT size=4>1.走班时间：高三（1-8）班在3110教室自修、高三（15、16）班在3112教室自修、高三（9-14）班在4112阶梯教室自修。</FONT></P>
<P><FONT size=4>通用技术1班上课时间为周四第4节，通用技术2班上课时间为周五第6节，周一、周二走班时间在相应上课教室自修。</FONT></P>
<P><FONT size=4>2.行政班上课时间：3110、3112教室放开做为自修教室。</FONT></P>
<P><FONT size=4>3.班级自修课时间学生在本班教室自修。</FONT></P>
<P>附件：<A title=自修学生名单 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201712/2017120409461117.xls">自修学生名单</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7733.aspx" target="_self" title="标题：体质健康测试通知&#xD;点击数：301&#xD;发表时间：17年12月04日">体质健康测试通知</a>[ 12-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7735.aspx" target="_self" title="标题：关于召开高一高二教学质量分析会的通知（有修改）&#xD;点击数：334&#xD;发表时间：17年12月04日">关于召开高一高二教学质量分析会的通知（有修改）</a>[ 12-04 ]</div>
                        </div>
                    </div>
