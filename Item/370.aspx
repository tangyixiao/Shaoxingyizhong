...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=370"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:370},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=370";
     ...
     定于今天下午第三节课在多功能厅召开行政支部会议,请行政支部党员准时出席!
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/360.aspx" target="_self" title="标题：关于清理传达室信箱的通知&#xD;点击数：538&#xD;发表时间：09年10月08日">关于清理传达室信箱的通知</a>[ 10-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/371.aspx" target="_self" title="标题：年度预算会议通知&#xD;点击数：754&#xD;发表时间：09年10月09日">年度预算会议通知</a>[ 10-09 ]</div>
                        </div>
                    </div>
