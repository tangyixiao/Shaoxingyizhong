...
<head>
    ...
    <title>高三期中考试期间安排--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三期中考试期间安排</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高三</span> <span>发布时间：2009年11月04日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=505"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:505},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=505";
     ...
     <DIV>    1、本周三下午第四节课进行布置试场。落实好期中考试期间的班级卫生保洁工作。做好安全教育、诚信教育。</DIV>
<DIV> </DIV>
<DIV>    2、周四、周五期中考试，早上8：00到校，考完后自行安排复习。</DIV>
<DIV> </DIV>
<DIV>    3、夜自修照常。学生夜自修请假严格执行一人一假条，没有班主任签字视为无效。</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/433.aspx" target="_self" title="标题：高三近期安排&#xD;点击数：459&#xD;发表时间：09年10月21日">高三近期安排</a>[ 10-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/825.aspx" target="_self" title="标题：高三虚拟17班上课通知&#xD;点击数：362&#xD;发表时间：09年12月03日">高三虚拟17班上课通知</a>[ 12-03 ]</div>
                        </div>
                    </div>
