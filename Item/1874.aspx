...
<head>
    ...
    <title>高二选修IB本周暂停--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1874"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1874},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1874";
     ...
     高二选修IB本周暂停，下周正常上课。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1871.aspx" target="_self" title="标题：高三需填报高校志愿的自主选拔考生、艺术特长生名单&#xD;点击数：420&#xD;发表时间：10年05月13日">高三需填报高校志愿的自主选拔考生、艺术特长生名单</a>[ 05-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1875.aspx" target="_self" title="标题：关于学分成绩录入要求的通知&#xD;点击数：531&#xD;发表时间：10年05月14日">关于学分成绩录入要求的通知</a>[ 05-14 ]</div>
                        </div>
                    </div>
