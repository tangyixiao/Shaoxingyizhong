...
<head>
    ...
    <title>晚间安全检查记录2017.2.13--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2017.2.13</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6406"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6406},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6406";
     ...
     实南403室（机房）、实西401室各有一扇窗未关。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6405.aspx" target="_self" title="标题：晨检表报送恢复正常通知&#xD;点击数：77&#xD;发表时间：17年02月14日">晨检表报送恢复正常通知</a>[ 02-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6408.aspx" target="_self" title="标题：每日晨检表未交情况通报2.13&amp;2.14&#xD;点击数：73&#xD;发表时间：17年02月14日">每日晨检表未交情况通报2.13&amp;2.14</a>[ 02-14 ]</div>
                        </div>
                    </div>
