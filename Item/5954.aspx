...
<head>
    ...
    <title>通知：各班团支书请注意--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5954"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5954},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5954";
     ...
     <P>    请大家及时树人导报和校报的领取，上周未领取报纸的班级，请今天中午<FONT color=#ff0000><STRONG>12:30</STRONG></FONT>到行政楼对外交流中心门口领取。未签到的班级有：</P>
<P>高一（3）、（5）、（12）、（13）、（14）、（15）、（16）班</P>
<P>高二（2）、（4）、（5）、（8）、（10）、（14）、（16）班</P>
<P>高三（1）、（4）、（11）、（12）、（13）班</P>
<P>请以上还未领取的班级中午准时领取。</P>
<P><FONT face=楷体_GB2312>有的班级当时只领了树人导报，没领校报的班级也及时过来领取。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5937.aspx" target="_self" title="标题：2016绍兴一中高二足球超级联赛活动方案&#xD;点击数：337&#xD;发表时间：16年11月16日">2016绍兴一中高二足球超级联赛活动方案</a>[ 11-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5964.aspx" target="_self" title="标题：通知：领取树人导报&#xD;点击数：155&#xD;发表时间：16年11月21日">通知：领取树人导报</a>[ 11-21 ]</div>
                        </div>
                    </div>
