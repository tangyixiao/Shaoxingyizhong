...
<head>
    ...
    <title>高一领取学生证及高二高三学生证注册通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一领取学生证及高二高三学生证注册通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7413"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7413},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7413";
     ...
     <!--StartFragment -->
<DIV>1、高一各班派代表<STRONG>今天</STRONG>到教学处领取学生证，填好个人信息贴好照片后，<STRONG>下周</STRONG>到教学处盖章。</DIV>
<DIV>学生证个人信息中“证号”为本人学籍辅号，发证日期统一填写为2017年9月1日。<BR><BR>2、高二、高三各班<STRONG>本周内</STRONG>将本班学生证收齐后，统一到教学处注册。<BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7412.aspx" target="_self" title="标题：10.8早学早读抽检情况（第1次）&#xD;点击数：412&#xD;发表时间：17年10月08日">10.8早学早读抽检情况（第1次）</a>[ 10-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7417.aspx" target="_self" title="标题：关于进行美术基础课训练的通知&#xD;点击数：238&#xD;发表时间：17年10月08日">关于进行美术基础课训练的通知</a>[ 10-08 ]</div>
                        </div>
                    </div>
