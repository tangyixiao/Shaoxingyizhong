...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=448"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:448},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=448";
     ...
     <DIV align=left><B>一、推荐原则</B></DIV>
<DIV align=left>      我校高校自主招生推荐工作严格按照“公平、公正、公开”原则，坚持标准，推荐出综合素质优秀、特长突出、品学兼优的高三学生。</DIV>
<DIV align=left><B>二、报名要求</B></DIV>
<DIV align=left>1.思想品德要求</DIV>
<DIV align=left>   &nbsp
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/447.aspx" target="_self" title="标题：绍兴市教育局关于进一步公正公平做好有关招生工作的若干意见&#xD;点击数：573&#xD;发表时间：09年10月25日">绍兴市教育局关于进一步公正公平做好有关招生工作的若干意见</a>[ 10-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/451.aspx" target="_self" title="标题：值周小结&#xD;点击数：539&#xD;发表时间：09年10月25日">值周小结</a>[ 10-25 ]</div>
                        </div>
                    </div>
