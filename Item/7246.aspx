...
<head>
    ...
    <title>高三全体老师会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7246"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7246},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7246";
     ...
     <FONT size=4>请高三全体老师于今天下午2:30到行政楼三楼会议室（2）开会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7245.aspx" target="_self" title="标题：高一上课提醒&#xD;点击数：114&#xD;发表时间：17年08月27日">高一上课提醒</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7247.aspx" target="_self" title="标题：高二回头考试场编排和监考安排&#xD;点击数：717&#xD;发表时间：17年08月28日">高二回头考试场编排和监考安排</a>[ 08-28 ]</div>
                        </div>
                    </div>
