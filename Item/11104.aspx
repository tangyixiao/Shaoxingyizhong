...
<head>
    ...
    <title>2020年1月学考选考考务培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2020年1月学考选考考务培训通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11104"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11104},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11104";
     ...
     <SPAN lang=EN-US style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体"><STRONG>今天（5日）</STRONG></SPAN><B style="mso-bidi-font-weight: normal"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">下午<SPAN lang=EN-US>13:30</SPAN>开始学考选考考务培训 </SPAN></B><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">。地点图书馆<SPAN lang=EN-US>3</SPAN>楼报告厅<SPAN lang=EN-US>2</SPAN>，参加对象全体监考老师（包括本校的监考、预备、流动、视频监考和验卷，到外校的监考、预备）、考务工作人员、高三班主任。请随带笔。</SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11103.aspx" target="_self" title="标题：2020年1月学考选考试场布置要求&#xD;点击数：413&#xD;发表时间：20年01月05日">2020年1月学考选考试场布置要求</a>[ 01-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11112.aspx" target="_self" title="标题：高一期末考试安排&#xD;点击数：735&#xD;发表时间：20年01月09日">高一期末考试安排</a>[ 01-09 ]</div>
                        </div>
                    </div>
