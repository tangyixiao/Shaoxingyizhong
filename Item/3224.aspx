...
<head>
    ...
    <title>会考考务培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3224"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3224},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3224";
     ...
     <P><FONT size=4>今天下午第四节课在行政楼五楼，进行会考考务培训，请高二、<SPAN style="FONT-FAMILY: 宋体; mso-bidi-font-size: 10.5pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">高三班主任、监考老师和工作人员准时参加。</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3221.aspx" target="_self" title="标题：班主任、任课老师：品德评语、学分成绩等录入省系统&#xD;点击数：1546&#xD;发表时间：11年01月07日">班主任、任课老师：品德评语、学分成绩等录入省系统</a>[ 01-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3237.aspx" target="_self" title="标题：部分课程改自修的通知&#xD;点击数：574&#xD;发表时间：11年01月08日">部分课程改自修的通知</a>[ 01-08 ]</div>
                        </div>
                    </div>
