...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2032"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2032},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2032";
     ...
     <FONT size=3>    定于明天(6月12日)上午8：30在教学楼Ⅱ 高三（3)班教室召开高三支部会议。请高三支部全体党员准时出席。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2021.aspx" target="_self" title="标题：高三班主任&#xD;点击数：387&#xD;发表时间：10年06月09日">高三班主任</a>[ 06-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2306.aspx" target="_self" title="标题：高三党支部会议&#xD;点击数：249&#xD;发表时间：10年08月28日">高三党支部会议</a>[ 08-28 ]</div>
                        </div>
                    </div>
