...
<head>
    ...
    <title>音乐教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13257"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13257},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13257";
     ...
     <p><span style="FONT-SIZE: 20px">本周四市音乐教研活动在我校举行，高一部分班级开课，具体安排如下：</span></p><p><span style="FONT-SIZE: 20px">高一（7）班周四第5节</span></p><p><span style="FONT-SIZE: 20px">高一（8）班周四第4节</span></p><p><span style="FONT-SIZE: 20px">其他相关调课：</span></p><p><span style="FONT-SIZE: 20px">高一（7）班翁鹏飞老师物理课改到周四第6节</span></p><p><span style="FONT-SIZE: 20px">高一（8）班张叠老师历史课改到周四第5节</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13250.aspx" target="_self" title="标题：关于高三学生催还图书的通知&#xD;点击数：820&#xD;发表时间：21年04月25日">关于高三学生催还图书的通知</a>[ 04-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13258.aspx" target="_self" title="标题：2020学年第二学期期中考试工作安排&#xD;点击数：586&#xD;发表时间：21年04月25日">2020学年第二学期期中考试工作安排</a>[ 04-25 ]</div>
                        </div>
                    </div>
