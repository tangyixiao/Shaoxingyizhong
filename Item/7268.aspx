...
<head>
    ...
    <title>体育、音乐课上课说明--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7268"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7268},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7268";
     ...
     <P><FONT size=4>1.因场地原因体育课从9月4日（明天）开始上课。</FONT></P>
<P><FONT size=4>2.音乐课从9月3日（今天）开始上课，上课地点在本班教室。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7267.aspx" target="_self" title="标题：高三答疑课说明&#xD;点击数：219&#xD;发表时间：17年09月03日">高三答疑课说明</a>[ 09-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7269.aspx" target="_self" title="标题：参加数学联赛学生停课复习通知&#xD;点击数：191&#xD;发表时间：17年09月03日">参加数学联赛学生停课复习通知</a>[ 09-03 ]</div>
                        </div>
                    </div>
