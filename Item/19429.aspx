...
<head>
    ...
    <title>高一、高二美术生（意向）会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二美术生（意向）会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19429"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19429},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19429";
     ...
     <p><span style="font-family: 宋体, SimSun; font-size: 18px;">请有意向参加美术高考的高一、高二学生，今天（周二）晚上6点到行政楼4022画室集中。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19425.aspx" target="_self" title="标题：高三名校协作体考试质量分析会通知&#xD;点击数：215&#xD;发表时间：24年03月05日">高三名校协作体考试质量分析会通知</a>[ 03-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19434.aspx" target="_self" title="标题：高三各班级任课老师会议安排&#xD;点击数：186&#xD;发表时间：24年03月06日">高三各班级任课老师会议安排</a>[ 03-06 ]</div>
                        </div>
                    </div>
