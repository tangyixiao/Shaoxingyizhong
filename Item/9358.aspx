...
<head>
    ...
    <title>绍兴一中参加省天文奥赛的学生上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中参加省天文奥赛的学生上课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9358"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9358},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9358";
     ...
     定于本周六（明天）对于参加18日浙江省天文奥赛的学生进行集中准备，时间1天，上午8:00-下午4:00，凡报名参加省赛的高一、高二、高三同学都要来参加，地点校天文教室。请相互转告。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9357.aspx" target="_self" title="标题：高考综合改革宣讲与培训会具体参会名单&#xD;点击数：359&#xD;发表时间：18年11月16日">高考综合改革宣讲与培训会具体参会名单</a>[ 11-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9362.aspx" target="_self" title="标题：市篮球比赛通知&#xD;点击数：314&#xD;发表时间：18年11月19日">市篮球比赛通知</a>[ 11-19 ]</div>
                        </div>
                    </div>
