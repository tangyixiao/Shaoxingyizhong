...
<head>
    ...
    <title>第5周主要工作安排表（3.17-3.23）--工作安排-绍兴市第一中学</title>
...
<li class="li5 last"><a href="/Shaoxingyizhong/Category_24/Index.aspx">校务公开</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21085"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21085},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21085";
     ...
     <p style="font-family: 宋体;font-size: 18pt;line-height: 108%;margin-bottom: .001pt;margin-left: 0;margin-right: 0;margin-top: 0;text-align: center;">
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21051.aspx" target="_self" title="标题：第4周主要工作安排表（3.10-3.16）&#xD;点击数：11&#xD;发表时间：25年03月10日">第4周主要工作安排表（3.10-3.16）</a>[ 03-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21126.aspx" target="_self" title="标题：第6周主要工作安排表（3.24-3.30）&#xD;点击数：6&#xD;发表时间：25年03月24日">第6周主要工作安排表（3.24-3.30）</a>[ 03-24 ]</div>
                        </div>
                    </div>
