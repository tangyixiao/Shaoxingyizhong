...
<head>
    ...
    <title>求真实验室社团换届大会通知--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">求真实验室社团换届大会通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18032"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18032},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18032";
     ...
     <p><span style="color: rgb(23, 26, 29); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI Symbol", "Myanmar Text", 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">重要！求真实验室社团换届大会通知！请高一、高二社员于5月29日（周一）中午12:30到实验楼1012参与社团换届大会！本次会议涉及到社团社长、副社长的换届选举投票，请高一同学务必到场！有意参选社长、副社长的同学请做好准备。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17998.aspx" target="_self" title="标题：求真实验室社员大会&#xD;点击数：61&#xD;发表时间：23年05月25日">求真实验室社员大会</a>[ 05-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18064.aspx" target="_self" title="标题：日研社开会通知&#xD;点击数：232&#xD;发表时间：23年06月01日">日研社开会通知</a>[ 06-01 ]</div>
                        </div>
                    </div>
