...
<head>
    ...
    <title>周二音乐课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1608"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1608},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1608";
     ...
     <FONT size=5>4月6日（星期二），高一音乐课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1607.aspx" target="_self" title="标题：关于2010年高校自主选拔录取入围考生的公示（3）&#xD;点击数：540&#xD;发表时间：10年04月03日">关于2010年高校自主选拔录取入围考生的公示（3）</a>[ 04-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1609.aspx" target="_self" title="标题：高三4月市统测试场布置要求&#xD;点击数：395&#xD;发表时间：10年04月06日">高三4月市统测试场布置要求</a>[ 04-06 ]</div>
                        </div>
                    </div>
