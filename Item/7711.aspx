...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7711"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7711},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7711";
     ...
     <FONT size=4>请高三年级语、数、英及选考学科任课老师于今天下午第4节课到树兰楼会议室二开会，请各位老师准时与会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7704.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：143&#xD;发表时间：17年11月28日">化学教研活动通知</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7713.aspx" target="_self" title="标题：体锻课暂停通知&#xD;点击数：234&#xD;发表时间：17年11月29日">体锻课暂停通知</a>[ 11-29 ]</div>
                        </div>
                    </div>
