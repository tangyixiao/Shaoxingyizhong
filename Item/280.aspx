...
<head>
    ...
    <title>关于学生体检延期的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=280"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:280},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=280";
     ...
     <DIV>       <FONT size=4>接上级卫生部门通知,由于流感防控形势日益严峻,原定于16日进行的高一学生肝功能检查及19日、20日进行的全校学生普检将延期进行，具体体检时间等待上级通知，请各知照！</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/278.aspx" target="_self" title="标题：关于进一步加强甲型H1N1流感预防工作的通知&#xD;点击数：560&#xD;发表时间：09年09月15日">关于进一步加强甲型H1N1流感预防工作的通知</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/282.aspx" target="_self" title="标题：重申《学校甲型H1N1流感预防工作分工与措施要求》&#xD;点击数：443&#xD;发表时间：09年09月15日">重申《学校甲型H1N1流感预防工作分工与措施要求》</a>[ 09-15 ]</div>
                        </div>
                    </div>
