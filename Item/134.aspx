...
<head>
    ...
    <title>关于2008学年获奖论文纸质稿及荣誉证书复印件的征集通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于2008学年获奖论文纸质稿及荣誉证书复印件的征集通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=134"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:134},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=134";
     ...
     <DIV><FONT size=4>    为了编辑我校2008学年发表、获奖论说文集的需要，让更多的优秀文章汇集于此，请相关老师在9月1日前把获奖论文纸质稿及荣誉证书复印件（各一份）交到教学处。谢谢合作！</FONT></DIV>
<DIV><FONT size=4>附：<IMG src="/Shaoxingyizhong/UploadFiles/UploadFiles/news/editor/sysimage/file/xls.gif" border=0><A href="/Shaoxingyizhong/news/uploadimg/200982575859588.xl
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/131.aspx" target="_self" title="标题：关于开学初教学检查和高三IB模块考试的通知&#xD;点击数：576&#xD;发表时间：09年08月24日">关于开学初教学检查和高三IB模块考试的通知</a>[ 08-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/138.aspx" target="_self" title="标题：原高三班主任注意&#xD;点击数：588&#xD;发表时间：09年08月25日">原高三班主任注意</a>[ 08-25 ]</div>
                        </div>
                    </div>
