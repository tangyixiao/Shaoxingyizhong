...
<head>
    ...
    <title>关于高一、高二家长会的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一、高二家长会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3838"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3838},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3838";
     ...
     <P> </P>
<P><FONT size=4>各高一、高二班主任：</FONT></P>
<P><FONT size=4>定于下周召开高一、高二家长会，具体时间、要求、安排如下：</FONT></P>
<P><FONT size=4>1．5月4日（周三）晚上七点高二家长会，5月5日（周四）晚上七点高一家长会，（家长会《邀请书》由各年级负责发放）。</FONT></P>
<P><FONT size=4>2．高一年级家长先在报告厅集中听卢副校长报告然后分班进行，高二年级不再集中。</FONT></P>
<P><FONT size=4>3．班主任要多向学生介绍学校工作、家庭教育的方法，各班至少要安排3名家长进行发言，内容可以是谈谈家庭教育的经验或对学校工作的意见和建议(要请家长事先做好准备）。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3837.aspx" target="_self" title="标题：关于举行高一红歌合唱比赛的通知：&#xD;点击数：1476&#xD;发表时间：11年04月29日">关于举行高一红歌合唱比赛的通知：</a>[ 04-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3841.aspx" target="_self" title="标题：值周检查情况汇总（4月29日星期五）&#xD;点击数：693&#xD;发表时间：11年04月30日">值周检查情况汇总（4月29日星期五）</a>[ 04-30 ]</div>
                        </div>
                    </div>
