...
<head>
    ...
    <title>失物招领、寻物启事几则--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9261"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9261},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9261";
     ...
     <P>寻物启事一则：有同学丢失蓝色Casio g-shock 手表一只，请拾到者交至德育处2114.</P>
<P>失物招领两则：有同学捡到饭卡两张，请失主到德育处认领。</P>
<P><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201810/2018102612421889.jpg" target=_blank><IMG onload=resizepic(this) style="HEIGHT: 246px; WIDTH: 341px" onmousewheel="return bbimg(this)" border=0 src="/Shaoxingyizhong/UploadFiles/UploadFiles/201810/2018102612421889.jpg" width=126 height=88> </A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9256.aspx" target="_self" title="标题：今明两天跑操暂停通知&#xD;点击数：169&#xD;发表时间：18年10月25日">今明两天跑操暂停通知</a>[ 10-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9265.aspx" target="_self" title="标题：“文明寝室”表彰公告&#xD;点击数：219&#xD;发表时间：18年10月29日">“文明寝室”表彰公告</a>[ 10-29 ]</div>
                        </div>
                    </div>
