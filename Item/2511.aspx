...
<head>
    ...
    <title>白色、红色车去停好车--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2511"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2511},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2511";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
            ...
            没有停在停车位上的白色车33115和红色车0509D请去有车位的停车处停车。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2507.aspx" target="_self" title="标题：晚间安全记录9月13---19日&#xD;点击数：801&#xD;发表时间：10年09月21日">晚间安全记录9月13---19日</a>[ 09-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2538.aspx" target="_self" title="标题：校园晚间安全检查记录9.20--9.24&#xD;点击数：458&#xD;发表时间：10年09月26日">校园晚间安全检查记录9.20--9.24</a>[ 09-26 ]</div>
                        </div>
                    </div>
