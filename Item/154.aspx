...
<head>
    ...
    <title>高三生物课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=154"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:154},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=154";
     ...
     <P> <FONT size=3>      今天下午（8月27日），生物固定班和走班，课改自修。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/150.aspx" target="_self" title="标题：高三1B学分考监考安排&#xD;点击数：544&#xD;发表时间：09年08月27日">高三1B学分考监考安排</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/155.aspx" target="_self" title="标题：高三1B现代诗歌考试时间、地点变动&#xD;点击数：544&#xD;发表时间：09年08月27日">高三1B现代诗歌考试时间、地点变动</a>[ 08-27 ]</div>
                        </div>
                    </div>
