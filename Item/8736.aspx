...
<head>
    ...
    <title>高三班主任、年段长和任教高三的中层会议--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三班主任、年段长和任教高三的中层会议</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8736"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8736},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8736";
         ...
         请高三班主任、年段长和任教高三的中层，于明天（6月21日）上午10点在行政楼三楼会议室3参加会议，商议有关中考招生等事项。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8692.aspx" target="_self" title="标题：关于部分老师参加会议的通知&#xD;点击数：468&#xD;发表时间：18年06月05日">关于部分老师参加会议的通知</a>[ 06-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9111.aspx" target="_self" title="标题：高三市模拟考期间注意事项&#xD;点击数：390&#xD;发表时间：18年09月22日">高三市模拟考期间注意事项</a>[ 09-22 ]</div>
                        </div>
                    </div>
