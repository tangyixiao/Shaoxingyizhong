...
<head>
    ...
    <title>高三部分选修IB上课安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三部分选修IB上课安排</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年08月20日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=125"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:125},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=125";
     ...
     <P>从8月21日（星期五）下午开始，高三部分选修IB开始走班上课，请相关老师做好准备，具体安排如下：</P>
<P>
<TABLE style="WIDTH: 489pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=652 border=0 x:str>
<COLGROUP>
<COL style="WIDTH: 187pt; mso-width-source: userset; mso-width-alt: 7968" w
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/118.aspx" target="_self" title="标题：关于组织2009年9月份普通高校招生英语听力等三项考试补报名的通知&#xD;点击数：662&#xD;发表时间：09年08月18日">关于组织2009年9月份普通高校招生英语听力等三项考试补报名的…</a>[ 08-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/131.aspx" target="_self" title="标题：关于开学初教学检查和高三IB模块考试的通知&#xD;点击数：576&#xD;发表时间：09年08月24日">关于开学初教学检查和高三IB模块考试的通知</a>[ 08-24 ]</div>
                        </div>
                    </div>
