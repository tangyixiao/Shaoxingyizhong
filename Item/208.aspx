...
<head>
    ...
    <title>9月8日张叠、 刘伟、 焦大伟参加会考补考阅卷--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9月8日张叠、 刘伟、 焦大伟参加会考补考阅卷</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=208"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:208},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=208";
     ...
     <DIV>9月8日张叠、 刘伟、 焦大伟参加会考补考阅卷,有关班级的课改自修。 
<DIV>报到时间9月8日上午8：30，地点：市教育教学研究院（萧山街斜桥弄9号）</DIV></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/206.aspx" target="_self" title="标题：关于参加全国化学竞赛的同学停课复习的通知&#xD;点击数：573&#xD;发表时间：09年09月07日">关于参加全国化学竞赛的同学停课复习的通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/209.aspx" target="_self" title="标题：9月7日高三政治1B学分考监考安排&#xD;点击数：571&#xD;发表时间：09年09月07日">9月7日高三政治1B学分考监考安排</a>[ 09-07 ]</div>
                        </div>
                    </div>
