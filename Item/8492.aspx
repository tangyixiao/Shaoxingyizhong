...
<head>
    ...
    <title>年轻班主任会议通知（有修改）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">年轻班主任会议通知（有修改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8492"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8492},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8492";
     ...
     <P>  <FONT size=4>  本周五（5月11日）下午<FONT color=#ff0000>15:40</FONT>在行政楼会议室三进行年轻班主任会议，会议主题为“如何开好家长会”，参加对象为班主任经验五年内的高一高二班主任、本学年新入职教师和有意向成为班主任的教师，请随带纸笔！如有特殊情况，请提前告知德育处。</FONT></P>
<P align=right><FONT size=4>德育处</FONT></P>
<P align=right><FONT size=4>2018年5月7日<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋体; mso-spacerun: 'yes'; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0000pt"><?xml:namespace prefix = "o" ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8490.aspx" target="_self" title="标题：期中考试期间卫生打扫工作照常&#xD;点击数：120&#xD;发表时间：18年05月07日">期中考试期间卫生打扫工作照常</a>[ 05-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8493.aspx" target="_self" title="标题：本周大扫除暂停通知&#xD;点击数：68&#xD;发表时间：18年05月07日">本周大扫除暂停通知</a>[ 05-07 ]</div>
                        </div>
                    </div>
