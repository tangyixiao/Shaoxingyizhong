...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10715"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10715},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10715";
     ...
     <P><FONT size=4>明天（周二）历史组全体老师外出参加教研活动，相关班级历史课改自修，高二、高三历史走班学生在相应上课教室自修。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10696.aspx" target="_self" title="标题：关于参加市直篮球比赛的通知&#xD;点击数：373&#xD;发表时间：19年10月11日">关于参加市直篮球比赛的通知</a>[ 10-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10722.aspx" target="_self" title="标题：地理教研活动通知&#xD;点击数：270&#xD;发表时间：19年10月16日">地理教研活动通知</a>[ 10-16 ]</div>
                        </div>
                    </div>
