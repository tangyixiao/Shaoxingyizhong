...
<head>
    ...
    <title>极智少年强第二次模拟测试通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">极智少年强第二次模拟测试通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11497"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11497},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11497";
     ...
     <P>请七位选手于本周四下午第三节课至2112教室参加集中培训与测试，本次进行文学内容二次测试及城市名片题培训。</P>
<P>    请互相转告。</P>
<P align=right>校团委<BR>2020年6月3日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11494.aspx" target="_self" title="标题：关于高三领取团籍档案的通知&#xD;点击数：223&#xD;发表时间：20年06月02日">关于高三领取团籍档案的通知</a>[ 06-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11502.aspx" target="_self" title="标题：通知：实践部、秘书部今天下午参与校园服务&#xD;点击数：272&#xD;发表时间：20年06月05日">通知：实践部、秘书部今天下午参与校园服务</a>[ 06-05 ]</div>
                        </div>
                    </div>
