...
<head>
    ...
    <title>关于增设绍兴一中德育建议邮箱的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于增设绍兴一中德育建议邮箱的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19510"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19510},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19510";
     ...
     <p style="text-indent:140px">
</p><p style="text-indent:28px">为了更好的把握德育方向，更加合理的推进学校德育工作，进一步加强生、师、校之间的沟通协同，新学期我们增设了绍兴一中德育建议邮箱（sxyzdyjyx@163.com）,我们真诚的欢迎广大师生来稿。</p><p style="text-indent:28px">您既可以反映发生在您身边的优秀人，高尚事，也可合理的提出学校德育管理中存在的问题及建议。来件可以以纸质的形式投放到德育处门口的建议箱，也可以以电子邮件的形式发送到该邮箱，我们将会在一周以内给予回复，若事情紧急，也欢迎您直接来德育处办公室反映。</p><p style="text-indent:28px">期待大家的参与，让我们温暖前行！</p><p style="text-indent:28px"> </p><p style="text-indent:28px"> </p><p style="text-indent: 322px; text-align: right;">绍兴一中德育处</p><p style="text-indent: 322px; text-align: right;">2024年3月19日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19508.aspx" target="_self" title="标题：3.16班级一日考核&#xD;点击数：43&#xD;发表时间：24年03月19日">3.16班级一日考核</a>[ 03-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19512.aspx" target="_self" title="标题：3.18班级一日考核&#xD;点击数：29&#xD;发表时间：24年03月19日">3.18班级一日考核</a>[ 03-19 ]</div>
                        </div>
                    </div>
