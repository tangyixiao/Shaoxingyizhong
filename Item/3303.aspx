...
<head>
    ...
    <title>关于帮困助学的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3303"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3303},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3303";
...
<P><FONT size=4>1.期末有已有两项助学金下发,一项是来自教育局关工委的资助（受助学生8人），还有一项是来自学校爱心基金的资助（受助学生30人），请班主任与任课教师按走访“三困”学生的要求将资助金送到学生家中。还有一项是来自中国电信（绍兴分公司）的“天翼”奖学金，发放仪式<FONT color=#f70968>在明天下午三点在行政楼三楼会议室</FONT>进行，获奖名单已确定，共30人（各年级困难学生中成绩前十名）,以上助学项目每个困难学生原则上不重复；</FONT></P>
<P><FONT size=4>2.提醒发到“教育券抵用券”的学生，学费要先缴，开学后等财政拔款下来再凭抵用券到财务信领取退款。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3300.aspx" target="_self" title="标题：关于高一、高二26日活动的通知&#xD;点击数：357&#xD;发表时间：11年01月24日">关于高一、高二26日活动的通知</a>[ 01-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3308.aspx" target="_self" title="标题：请高三住校生注意&#xD;点击数：409&#xD;发表时间：11年02月11日">请高三住校生注意</a>[ 02-11 ]</div>
                        </div>
                    </div>
