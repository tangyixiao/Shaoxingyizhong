...
<head>
    ...
    <title>（有修改）第二十七期课余党校第二课通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">（有修改）第二十七期课余党校第二课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11574"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11574},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11574";
     ...
     <P align=center><STRONG>第二十七期课余党校第二课通知</STRONG></P>
<P>主讲：党委副书记、纪委书记孙洪亮老师<BR>时间：6月24日周三<SPAN style="BACKGROUND-COLOR: #ffff00">12:40</SPAN>-13:20<BR>地点：阶梯教室4106</P>
<P>    请全体学员提前五分钟到场签到。请组织部做好准备。</P>
<P align=right>校团委<BR>2020年6月23日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11573.aspx" target="_self" title="标题：2019学年团支部考核结果、市直团先进推优公示、校级团先进推选通知&#xD;点击数：512&#xD;发表时间：20年06月22日">2019学年团支部考核结果、市直团先进推优公示、校级团先进推选…</a>[ 06-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11583.aspx" target="_self" title="标题：关于进行2019学年学生社团考核的通知&#xD;点击数：325&#xD;发表时间：20年06月24日">关于进行2019学年学生社团考核的通知</a>[ 06-24 ]</div>
                        </div>
                    </div>
