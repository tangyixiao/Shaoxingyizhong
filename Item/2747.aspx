...
<head>
    ...
    <title>关于考试期间值周的说明--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2747"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2747},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2747";
...
<P><FONT size=4>高一高二高三各班：</FONT></P>
<P><FONT size=4>    期中考试期间，各年级值周卫生检查工作照常进行。考试结束后其它项目检查恢复正常。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2741.aspx" target="_self" title="标题：值周检查情况汇总（10月27日星期三）&#xD;点击数：274&#xD;发表时间：10年10月28日">值周检查情况汇总（10月27日星期三）</a>[ 10-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2751.aspx" target="_self" title="标题：值周检查情况汇总（10月28日星期四）&#xD;点击数：243&#xD;发表时间：10年10月29日">值周检查情况汇总（10月28日星期四）</a>[ 10-29 ]</div>
                        </div>
                    </div>
