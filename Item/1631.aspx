...
<head>
    ...
    <title>高三试场布置--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1631"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1631},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1631";
     ...
     <P><FONT size=5>高三各班主任：</FONT></P>
<P><FONT size=5>              请在今天早上8：00前再次检查一下本班教室的试场布置，重点是桌子摆放的整齐、教室卫生、桌子上的书籍资料清理、桌贴门贴有否缺损。</FONT></P>
<P><FONT size=5>                                                                           教学处</FONT></P>
<P><FONT size=5>                                                                            2010.4.7</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1630.aspx" target="_self" title="标题：与高三班主任、任课老师有关的几件事&#xD;点击数：493&#xD;发表时间：10年04月06日">与高三班主任、任课老师有关的几件事</a>[ 04-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1632.aspx" target="_self" title="标题：星期三上午历史课改自修&#xD;点击数：361&#xD;发表时间：10年04月07日">星期三上午历史课改自修</a>[ 04-07 ]</div>
                        </div>
                    </div>
