...
<head>
    ...
    <title>关于大扫除的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2930"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2930},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2930";
...
<P><FONT size=4>    下午大扫除，教室内重点清理课桌抽屉内的杂物，确保各项物品摆放整齐有序。包干区重点清理所分管区域内的垃圾。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2929.aspx" target="_self" title="标题：值周检查情况汇总（11月26日星期五）&#xD;点击数：256&#xD;发表时间：10年11月27日">值周检查情况汇总（11月26日星期五）</a>[ 11-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2933.aspx" target="_self" title="标题：表扬&#xD;点击数：618&#xD;发表时间：10年11月29日">表扬</a>[ 11-29 ]</div>
                        </div>
                    </div>
