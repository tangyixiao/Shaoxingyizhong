...
<head>
    ...
    <title>考古社通知（有修改）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6923"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6923},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6923";
     ...
     请已报名参加考古社活动的同学于5月14日（星期天）上午8点在绍兴一中门口准时上车，活动时间一天，干粮自带。望相互转告！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6922.aspx" target="_self" title="标题：关于校服穿着检查反馈情况&#xD;点击数：397&#xD;发表时间：17年05月11日">关于校服穿着检查反馈情况</a>[ 05-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6927.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：88&#xD;发表时间：17年05月12日">表扬与失物招领</a>[ 05-12 ]</div>
                        </div>
                    </div>
