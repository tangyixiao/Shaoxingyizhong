...
<head>
    ...
    <title>关于开展2017年高考问卷调查的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于开展2017年高考问卷调查的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7332"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7332},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7332";
     ...
     <P><FONT size=4>各位老师：</FONT></P>
<P><FONT size=4>根据教育部考试中心要求，请于9月30日前就高考语数外科目和7个学考、选考科目进行问卷填答。</FONT></P>
<P><FONT size=4>具体作答方式为：通过教育部考试中心官网（登录</FONT><A href="http://www.neea.edu.cn"><FONT size=4>http://www.neea.edu.cn</FONT></A><FONT size=4>）,进入“高考问卷调查”栏目，选择“教师入口”，在验证页面输入“201709”，进行问卷填答。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7321.aspx" target="_self" title="标题：全市选考（学考）及高考诊断性考试时间安排&#xD;点击数：546&#xD;发表时间：17年09月15日">全市选考（学考）及高考诊断性考试时间安排</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7333.aspx" target="_self" title="标题：教研组长、备课组长会议&#xD;点击数：260&#xD;发表时间：17年09月19日">教研组长、备课组长会议</a>[ 09-19 ]</div>
                        </div>
                    </div>
