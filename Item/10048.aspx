...
<head>
    ...
    <title>2019年4月学考选考成绩复核通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2019年4月学考选考成绩复核通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10048"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10048},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10048";
     ...
     <P>各位高三考生：</P>
<P>    2019年4月学考选考成绩已经发布，如对本人成绩有疑问，需要申请成绩复核，请持本人身份证和准考证于2019年4月30日11:00前到教学处一汪老师处登记，逾期不再办理。</P>
<P>成绩复核原则、内容：</P>
<P>（一）成绩复核内容：考生基本信息、是否考生本人答卷（答题卡）、是否有漏评、小题得分是否漏统、各小题得分合成后是否与提供给考生的成绩一致。</P>
<P>（二）每考生限查一科（一科有误，续查其余各科）。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10042.aspx" target="_self" title="标题：体育课改自修通知&#xD;点击数：442&#xD;发表时间：19年04月27日">体育课改自修通知</a>[ 04-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10051.aspx" target="_self" title="标题：北京航空航天大学招生宣讲通知&#xD;点击数：349&#xD;发表时间：19年04月28日">北京航空航天大学招生宣讲通知</a>[ 04-28 ]</div>
                        </div>
                    </div>
