...
<head>
    ...
    <title>高三培优班上课提醒--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三培优班上课提醒</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年01月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6291"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6291},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6291";
     ...
     <FONT size=4>各位高三同学，今天上午英语培优班照常进行，请参加的同学们相互提醒，准时上课。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6290.aspx" target="_self" title="标题：1月8日物理特长生招生考试监考安排&#xD;点击数：285&#xD;发表时间：17年01月06日">1月8日物理特长生招生考试监考安排</a>[ 01-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6295.aspx" target="_self" title="标题：高三学生高考模拟成绩查询和高考志愿模拟填报通知&#xD;点击数：509&#xD;发表时间：17年01月09日">高三学生高考模拟成绩查询和高考志愿模拟填报通知</a>[ 01-09 ]</div>
                        </div>
                    </div>
