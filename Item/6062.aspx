...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6062"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6062},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6062";
     ...
     有老师捡到编号：150241校卡，请失主及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6059.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：79&#xD;发表时间：16年12月06日">表扬与失物招领</a>[ 12-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6065.aspx" target="_self" title="标题：寻物启事&#xD;点击数：57&#xD;发表时间：16年12月06日">寻物启事</a>[ 12-06 ]</div>
                        </div>
                    </div>
