...
<head>
    ...
    <title>全校安全委员开会通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5599"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5599},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5599";
     ...
     今天中午12点45分，全校各班安全委员到实南205开会，时间不长，务必准时到会。如安全委员不能出席，请班长出席。会议出席记录将计入班级考核。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5598.aspx" target="_self" title="标题：晚间安全检查记录2016.9.24&#xD;点击数：64&#xD;发表时间：16年09月26日">晚间安全检查记录2016.9.24</a>[ 09-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5609.aspx" target="_self" title="标题：晚间安全检查记录2016.9.26&#xD;点击数：77&#xD;发表时间：16年09月27日">晚间安全检查记录2016.9.26</a>[ 09-27 ]</div>
                        </div>
                    </div>
