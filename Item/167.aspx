...
<head>
    ...
    <title>各班主任、各竞赛辅导教师请注意（关于开学典礼）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班主任、各竞赛辅导教师请注意（关于开学典礼）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=167"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:167},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=167";
     ...
     <P>各班主任、各竞赛辅导教师：</P>
<P>     为了使开学典礼顺利、高效进行，请通知本班下列学生在今天中午12点到体育馆集中。具体人员如下。</P>
<P>     1、各班班长；</P>
<P>      2、2008学年市级市属级三好学生、优秀学生干部。</P>
<P>      3、省级及以上各类竞赛前三名获得者
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/151.aspx" target="_self" title="标题：温馨提示&#xD;点击数：574&#xD;发表时间：09年08月27日">温馨提示</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/170.aspx" target="_self" title="标题：2009学年第一学期开学典礼&#xD;点击数：561&#xD;发表时间：09年08月31日">2009学年第一学期开学典礼</a>[ 08-31 ]</div>
                        </div>
                    </div>
