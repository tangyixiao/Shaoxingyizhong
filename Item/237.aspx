...
<head>
    ...
    <title>关于召开“师徒结对”座谈会的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于召开“师徒结对”座谈会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=237"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:237},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=237";
     ...
     <DIV align=center><STRONG><FONT size=4>关于召开“师徒结对”座谈会的通知</FONT></STRONG></DIV>
<DIV>     </DIV>
<DIV>      <FONT size=4>为进一步推进学校“青蓝工程”的实施，加快青年教师的培养，年轻教师需要老教师给予个体的传、帮、带。学校定于今天（9月10日）下午第三节课在行政楼三楼会议室召开“师徒结对”<B
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/233.aspx" target="_self" title="标题：关于今晚高三英语高考听力模拟测试的通知&#xD;点击数：568&#xD;发表时间：09年09月09日">关于今晚高三英语高考听力模拟测试的通知</a>[ 09-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/238.aspx" target="_self" title="标题：领取三项考试准考证&#xD;点击数：578&#xD;发表时间：09年09月10日">领取三项考试准考证</a>[ 09-10 ]</div>
                        </div>
                    </div>
