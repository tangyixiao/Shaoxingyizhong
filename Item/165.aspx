...
<head>
    ...
    <title>高三回头考安排调整--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三回头考安排调整</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年08月30日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=165"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:165},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=165";
     ...
     <P>1、因教工大会，星期一下午高三回头考提前到2点开始；</P>
<P>2、个别老师监考场次有所调整（红色）；</P>
<P>3、高二星期二下午高二（3）班、（4）班、（11）班、（12）班体育课改自修。</P>
<P>
<TABLE style="WIDTH: 426pt; BORDER-COLLAPSE: collapse" border=0 cellSpacing=0 cellPadding=0 width=568 x:str>
<COLGROUP>
<COL style="WIDTH: 20pt
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/161.aspx" target="_self" title="标题：高三回头考监考安排&#xD;点击数：603&#xD;发表时间：09年08月28日">高三回头考监考安排</a>[ 08-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/168.aspx" target="_self" title="标题：9月1日下午高三综合回头考时间调整&#xD;点击数：1099&#xD;发表时间：09年08月31日">9月1日下午高三综合回头考时间调整</a>[ 08-31 ]</div>
                        </div>
                    </div>
