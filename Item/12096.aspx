...
<head>
    ...
    <title>校园电视台通知6.75--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">校园电视台通知6.75</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：admin</span> <span>发布时间：2020年11月06日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12096"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12096},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12096";
     ...
     <P>1、下周一（16日）下午第三节下课后，校电视台集合，拍摄少年强第一条素材（陈th汪dl来1114搬器材哦）。</P>
<P>2、周六远足视频素材要求1080p 25fps起，画面一定要稳定（做好预览、筛选和标记）。</P>
<P>如 DJI_0191.MP4是一个2分23秒的视频素材，摄像师预览、筛选后发现31秒到96秒可用，把原文件名标记为DJI_0191_31-96.MP4。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12095.aspx" target="_self" title="标题：【求真实验室】社团活动通知&#xD;点击数：126&#xD;发表时间：20年11月05日">【求真实验室】社团活动通知</a>[ 11-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12133.aspx" target="_self" title="标题：【心理沙龙】社员活动通知&#xD;点击数：110&#xD;发表时间：20年11月12日">【心理沙龙】社员活动通知</a>[ 11-12 ]</div>
                        </div>
                    </div>
