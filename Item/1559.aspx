...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1559"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1559},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1559";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
              ...
              每周二、四、六晨读为英语学科，一、三、五为语文学科。晨读时，请任课老师能按时到所任班级进行辅导。辛苦！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1552.aspx" target="_self" title="标题：高三周一下午自选模块测试通知&#xD;点击数：411&#xD;发表时间：10年03月29日">高三周一下午自选模块测试通知</a>[ 03-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1560.aspx" target="_self" title="标题：通用技术课改自修&#xD;点击数：558&#xD;发表时间：10年03月30日">通用技术课改自修</a>[ 03-30 ]</div>
                        </div>
                    </div>
