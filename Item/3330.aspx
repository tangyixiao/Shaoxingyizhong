...
<head>
    ...
    <title>关于教工参加始业式的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于教工参加始业式的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3330"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3330},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3330";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
            ...
            今天早上始业式暨升旗仪式提前到7：40在篮球场举行，请全体教工准时参加。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3326.aspx" target="_self" title="标题：绍兴一中2010学年第二学期工作思路(征求意见稿)&#xD;点击数：1031&#xD;发表时间：11年02月17日">绍兴一中2010学年第二学期工作思路(征求意见稿)</a>[ 02-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3345.aspx" target="_self" title="标题：教工会议通知&#xD;点击数：790&#xD;发表时间：11年02月21日">教工会议通知</a>[ 02-21 ]</div>
                        </div>
                    </div>
