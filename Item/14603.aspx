...
<head>
    ...
    <title>体锻课器材借用提醒--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14603"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14603},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14603";
     ...
     <p>各位同学：</p><p>       校园卡已经两卡合一，正元卡已停止使用，体锻课借用器材须用有照片的智安校园卡，其他种类的卡不再作为外借体育器材的凭证，请各位同学知晓。</p><p>  </p><p>                                                                                                   德育处  体育组</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14601.aspx" target="_self" title="标题：12.07跑操量化考核反馈&#xD;点击数：210&#xD;发表时间：21年12月07日">12.07跑操量化考核反馈</a>[ 12-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14608.aspx" target="_self" title="标题：12.07班级一日考核&#xD;点击数：48&#xD;发表时间：21年12月08日">12.07班级一日考核</a>[ 12-08 ]</div>
                        </div>
                    </div>
