...
<head>
    ...
    <title>全校各班班长开会通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14319"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14319},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14319";
     ...
     <p>今天（11月2日）傍晚17：40在教学楼2112教室召开班长会议，请各班班长相互转告，准时出席，如迟到或缺席将按班级量化常规扣分。（如班长不上晚自习则团支书或其他1名班干部参加会议）。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14316.aspx" target="_self" title="标题：关于召开第三期主题班会的通知&#xD;点击数：233&#xD;发表时间：21年11月01日">关于召开第三期主题班会的通知</a>[ 11-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14320.aspx" target="_self" title="标题：11.01班级一日考核&#xD;点击数：61&#xD;发表时间：21年11月02日">11.01班级一日考核</a>[ 11-02 ]</div>
                        </div>
                    </div>
