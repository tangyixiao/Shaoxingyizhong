...
<head>
    ...
    <title>高三培优班暂停通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6252"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6252},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6252";
     ...
     <P>今天下午高三语文培优班暂停一次，请相关同学互相转告。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6244.aspx" target="_self" title="标题：高一、高二本周五下午安排&#xD;点击数：513&#xD;发表时间：16年12月29日">高一、高二本周五下午安排</a>[ 12-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6254.aspx" target="_self" title="标题：高三培优班上课提醒&#xD;点击数：202&#xD;发表时间：17年01月02日">高三培优班上课提醒</a>[ 01-02 ]</div>
                        </div>
                    </div>
