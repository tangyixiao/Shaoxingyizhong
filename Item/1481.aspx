...
<head>
    ...
    <title>关于百校联考改分通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1481"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1481},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1481";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
             ...
             百校联考成绩因加分错误的同学，在下午第三节课前，上报各任课老师处，各备课组长统计后，在下午第三节课后马上交教学处，自选综合加分错误的同学直接携带试卷到教学处更改。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1480.aspx" target="_self" title="标题：今天（周四）中午高二、高三班主任领队会议&#xD;点击数：1627&#xD;发表时间：10年03月18日">今天（周四）中午高二、高三班主任领队会议</a>[ 03-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1486.aspx" target="_self" title="标题：三项考试试场布置要求&#xD;点击数：480&#xD;发表时间：10年03月19日">三项考试试场布置要求</a>[ 03-19 ]</div>
                        </div>
                    </div>
