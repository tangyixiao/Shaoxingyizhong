...
<head>
    ...
    <title>高三IB选修走班课程通知：--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三IB选修走班课程通知：</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3313"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3313},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3313";
     ...
     <P>高三IB选修走班课程通知：</P>
<P>1、生物：<FONT size=3>选修2《生物科学与社会》模块今天暂停，明天开始上课。</FONT></P>
<P><FONT size=3>2、物理：由于物理1-2模块和物理3-3模块大部分内容相同，现取消物理1-2模块的走班上课。</FONT></P>
<P><FONT size=3>                                                                                            2.12</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3309.aspx" target="_self" title="标题：高三选修IB走班上课安排（有修改）&#xD;点击数：823&#xD;发表时间：11年02月12日">高三选修IB走班上课安排（有修改）</a>[ 02-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3316.aspx" target="_self" title="标题：高三回头考试要求与日程安排&#xD;点击数：822&#xD;发表时间：11年02月14日">高三回头考试要求与日程安排</a>[ 02-14 ]</div>
                        </div>
                    </div>
