...
<head>
    ...
    <title>高三学生通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3304"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3304},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3304";
     ...
     <P>                                                  高三学生通知</P>
<P>     高三学生定于2月12日（正月初十）到2月16日（正月十四）进行IB模块的复习，IB模块复习课程如下：</P>
<P>语文：（古代诗歌散文）；数学；英语；物理；化学（化学与生活）；政治（生活中的法律常识和经济学常识）；历史（历史上重大改革回眸和文化遗产）；地理（自然灾害与防止）；生物（生物技术和生物科学）</P>
<P>请同学们相互转告。</P>
<P>                                                                                      1.26</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3299.aspx" target="_self" title="标题：班主任&#xD;点击数：471&#xD;发表时间：11年01月25日">班主任</a>[ 01-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3309.aspx" target="_self" title="标题：高三选修IB走班上课安排（有修改）&#xD;点击数：823&#xD;发表时间：11年02月12日">高三选修IB走班上课安排（有修改）</a>[ 02-12 ]</div>
                        </div>
                    </div>
