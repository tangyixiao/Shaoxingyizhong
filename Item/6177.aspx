...
<head>
    ...
    <title>今天下午课外活动暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天下午课外活动暂停通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6177"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6177},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6177";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
              ...
              因体育馆要进行绍兴书画名家进校园活动及学生现场书画大赛，下午的课外活动暂停，请相关班级相互告知，谢谢！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6176.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：63&#xD;发表时间：16年12月21日">大课间操暂停通知</a>[ 12-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6180.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：101&#xD;发表时间：16年12月22日">大课间操暂停通知</a>[ 12-22 ]</div>
                        </div>
                    </div>
