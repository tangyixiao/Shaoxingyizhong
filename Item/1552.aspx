...
<head>
    ...
    <title>高三周一下午自选模块测试通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三周一下午自选模块测试通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1552"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1552},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1552";
     ...
     <P><FONT size=5>今天下午第3、4节课为高三自选模块测试时间，请班主任组织实施考试和阅卷工作。也请班主任把答案分发给本班任课老师。没有特殊情况，以后周一下午的第3、4节课为学生的自选模块测试时间,学校不再通知。</FONT></P>
<P><FONT size=5>                                                             教学处</FONT></P>
<P><FONT size=5>                                                                2010.3.29</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1546.aspx" target="_self" title="标题：有关涉及高三学生政策加分的指导老师中午开会&#xD;点击数：431&#xD;发表时间：10年03月29日">有关涉及高三学生政策加分的指导老师中午开会</a>[ 03-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1559.aspx" target="_self" title="标题：温馨提示&#xD;点击数：675&#xD;发表时间：10年03月30日">温馨提示</a>[ 03-30 ]</div>
                        </div>
                    </div>
