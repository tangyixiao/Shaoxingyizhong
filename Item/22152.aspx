...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22152"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22152},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22152";
     ...
     <article>本周四数学组外出90学时培训，全校数学课改自修。</article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22151.aspx" target="_self" title="标题：高二、高三班主任会议通知（会议重要请勿请假）&#xD;点击数：249&#xD;发表时间：25年10月29日">高二、高三班主任会议通知（会议重要请勿请假）</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22182.aspx" target="_self" title="标题：棒球体验选拔活动通知&#xD;点击数：94&#xD;发表时间：25年11月03日">棒球体验选拔活动通知</a>[ 11-03 ]</div>
                        </div>
                    </div>
