...
<head>
    ...
    <title>高三周三上午第3、4节课安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三周三上午第3、4节课安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6121"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6121},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6121";
     ...
     <P><FONT size=4>明天上午第3、4节课高三培优班同学和选修走班的同学照常上课，其余同学到行政楼5楼会议室听关于“金融学专业”的报告。</FONT></P>
<P><FONT size=4>题目：《经济学——选择与格局》</FONT></P>
<P><FONT size=4>主讲人：张丹丹博士</FONT></P>
<P><FONT size=4>地点：行政楼5楼会议室</FONT></P>
<P><FONT size=4>时间：周三第3、4节课</FONT></P>
<P><FONT size=4>简介：介绍金融专业的学习内容、择业走向。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6120.aspx" target="_self" title="标题：历史教研活动通知&#xD;点击数：139&#xD;发表时间：16年12月13日">历史教研活动通知</a>[ 12-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6125.aspx" target="_self" title="标题：生物教研活动通知&#xD;点击数：245&#xD;发表时间：16年12月14日">生物教研活动通知</a>[ 12-14 ]</div>
                        </div>
                    </div>
