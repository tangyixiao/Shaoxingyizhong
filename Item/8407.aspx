...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8407"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8407},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8407";
     ...
     <P>今日跑操优胜班级公布如下：</P>
<P>高一：102,109,111,112,114,115,117,118</P>
<P>高二：204,205,209,213,214,215,216</P>
<P> </P>
<P align=right>德育处</P>
<P align=right>4.20</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8402.aspx" target="_self" title="标题：关于今天跑操比赛的通知&#xD;点击数：167&#xD;发表时间：18年04月20日">关于今天跑操比赛的通知</a>[ 04-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8410.aspx" target="_self" title="标题：升旗仪式暂停通知&#xD;点击数：143&#xD;发表时间：18年04月23日">升旗仪式暂停通知</a>[ 04-23 ]</div>
                        </div>
                    </div>
