...
<head>
    ...
    <title>工会医疗保险报销提醒--工会-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15180"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15180},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15180";
     ...
     <p>各位老师:</p><p>      接总工会通知,有22.2.19前，在有效参保期间内产生医疗费用，尚未报销的，请抓紧在公众号提交申请补助。一站式报销实施后，市内医院，省内医院，省外能直接刷卡结算医疗费用的医院，工会补助的费用已在职工出院时自动结算，相关款项已抵扣个人应付给医院的费用。除个别特殊情况外，职工不用再提交补助申请，请各知照.</p><p> </p><p>                                                                    2022年3月17日</p><p style="LINE-HEIGHT: 16px"><img style="VERTICAL-ALIGN: middle; MARGIN-RIGHT: 2px" src="http://10.176.17.2/UEditor/dialogs/attachment/fileTypeImages/icon_doc.gif" /><a title="报销附件" href="/Shaoxingyizhong/UploadFiles/xwzx/2022/3/202203171007296098.docx" target="_self" textvalue="报销附件">报销附件</a></p><p></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15081.aspx" target="_self" title="标题：女教工＂3.8＂节春游通知&#xD;点击数：484&#xD;发表时间：22年03月03日">女教工＂3.8＂节春游通知</a>[ 03-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15221.aspx" target="_self" title="标题：文明办公室检查通知&#xD;点击数：178&#xD;发表时间：22年03月23日">文明办公室检查通知</a>[ 03-23 ]</div>
                        </div>
                    </div>
