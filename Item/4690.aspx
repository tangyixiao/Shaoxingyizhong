...
<head>
    ...
    <title>志愿者在行动--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4690"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4690},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4690";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4682.aspx" target="_self" title="标题：绍兴一中6位学生签约清华&#xD;点击数：2629&#xD;发表时间：13年06月26日">绍兴一中6位学生签约清华</a>[ 06-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4703.aspx" target="_self" title="标题：夏日温情陪护，你我爱心同行&#xD;点击数：319&#xD;发表时间：13年09月03日">夏日温情陪护，你我爱心同行</a>[ 09-03 ]</div>
                        </div>
                    </div>
