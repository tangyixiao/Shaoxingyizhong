...
<head>
    ...
    <title>高三听力考试休息室安排--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1485"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1485},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1485";
       ...
       经过商量，听力考试期间（周五下午和周六上午），高三（1）班至（12）班到高一相应教室自修休息，高三（12）至（16）到实北301、303、305、实南301室自修休息。<BR>    请各班级要十分注意所借用教室的清洁卫生，用完后，请务必派人保洁。<BR>    感谢高一年级和实验室的支持。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1431.aspx" target="_self" title="标题：高三自选综合&#xD;点击数：1321&#xD;发表时间：10年03月11日">高三自选综合</a>[ 03-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1509.aspx" target="_self" title="标题：高三自选综合成绩登录&#xD;点击数：771&#xD;发表时间：10年03月22日">高三自选综合成绩登录</a>[ 03-22 ]</div>
                        </div>
                    </div>
