...
<head>
    ...
    <title>考勤检查情况通报--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1642"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1642},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1642";
     ...
     <P>     经电脑检查4月6日、7日、8日老师考勤情况，每天有20多人忘了考勤，请没有考勤的老师，不要忘了进校门的第一件事。</P>
<P>      献血报名（电话报名）还在进行中。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1634.aspx" target="_self" title="标题：关于选拔总务处副主任的通知（三）&#xD;点击数：765&#xD;发表时间：10年04月07日">关于选拔总务处副主任的通知（三）</a>[ 04-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1652.aspx" target="_self" title="标题：绍兴一中总务处副主任任前公示&#xD;点击数：821&#xD;发表时间：10年04月10日">绍兴一中总务处副主任任前公示</a>[ 04-10 ]</div>
                        </div>
                    </div>
