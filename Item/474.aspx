...
<head>
    ...
    <title>高一校本课程《唐宋词鉴赏 》上课地点更改--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一校本课程《唐宋词鉴赏 》上课地点更改</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年10月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=474"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:474},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=474";
     ...
     <P><FONT size=2>     由于教室实西-201要另作它用，<FONT face=Verdana>高一校本课程《<FONT face=宋体>唐宋词鉴赏<SPAN style="mso-spacerun: yes"> 》</SPAN></FONT>上课地点更改为实北-201，请班主任及时通知选修《<FONT face=宋体>唐宋词鉴赏<SPAN style="mso-spacerun: yes"> 》的学生。</SPAN></FONT
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/471.aspx" target="_self" title="标题：校对期中试卷&#xD;点击数：423&#xD;发表时间：09年10月28日">校对期中试卷</a>[ 10-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/481.aspx" target="_self" title="标题：关于网站下载资料的通知&#xD;点击数：379&#xD;发表时间：09年10月29日">关于网站下载资料的通知</a>[ 10-29 ]</div>
                        </div>
                    </div>
