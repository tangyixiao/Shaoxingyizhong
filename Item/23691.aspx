...
<head>
    ...
    <title>9.18班级一日考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23691"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23691},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23691";
     ...
     <p style="text-align: center;"><img src="/UploadFiles/xwzx/2026/9/202609201516561142.png" style="max-width: 100%; " title="202609201516561142.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23687.aspx" target="_self" title="标题：9.18跑操量化考核反馈&#xD;点击数：74&#xD;发表时间：26年09月18日">9.18跑操量化考核反馈</a>[ 09-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Item/23692.aspx" target="_self" title="标题：寻物启事（校服）&#xD;点击数：37&#xD;发表时间：26年09月20日">寻物启事（校服）</a>[ 09-20 ]</div>
                        </div>
                    </div>
