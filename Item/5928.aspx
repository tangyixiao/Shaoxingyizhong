...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5928"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5928},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5928";
         ...
         <FONT size=4>11月16日-18日，通用技术组陈义兵、许婷、白宗刚老师外出参加90课时第二阶段培训，相关班级通用技术课改自修。<BR></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5924.aspx" target="_self" title="标题：高三期中考试场布置要求&#xD;点击数：203&#xD;发表时间：16年11月15日">高三期中考试场布置要求</a>[ 11-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5940.aspx" target="_self" title="标题：关于组织参加“2017年高考数学科目模拟测试”的通知&#xD;点击数：739&#xD;发表时间：16年11月16日">关于组织参加“2017年高考数学科目模拟测试”的通知</a>[ 11-16 ]</div>
                        </div>
                    </div>
