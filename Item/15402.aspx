...
<head>
    ...
    <title>4.19跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">4.19跑操量化考核反馈</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15402"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15402},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15402";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2022/4/202204191200003310.png" style="max-width: 100%; " title="202204191200003310.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15400.aspx" target="_self" title="标题：寻物启事和失物招领各一则&#xD;点击数：173&#xD;发表时间：22年04月19日">寻物启事和失物招领各一则</a>[ 04-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15407.aspx" target="_self" title="标题：失物招领及拾金不昧表扬&#xD;点击数：138&#xD;发表时间：22年04月19日">失物招领及拾金不昧表扬</a>[ 04-19 ]</div>
                        </div>
                    </div>
