...
<head>
    ...
    <title>语文组参加教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16932"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16932},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16932";
     ...
     <p><span style="FONT-SIZE: 20px">11月29日（周二），全体语文教师参加市直16学时教研活动，全校语文课改自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16908.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：274&#xD;发表时间：22年11月23日">化学教研活动通知</a>[ 11-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16958.aspx" target="_self" title="标题：音乐、美术、生物教研活动通知&#xD;点击数：200&#xD;发表时间：22年12月01日">音乐、美术、生物教研活动通知</a>[ 12-01 ]</div>
                        </div>
                    </div>
