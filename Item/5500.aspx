...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5500"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5500},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5500";
     ...
     表扬高一（11）部分同学帮助总务处搬运装修的废弃物！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5498.aspx" target="_self" title="标题：升旗仪式暂停通知&#xD;点击数：161&#xD;发表时间：16年09月11日">升旗仪式暂停通知</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5502.aspx" target="_self" title="标题：今天下午劳动通知&#xD;点击数：291&#xD;发表时间：16年09月12日">今天下午劳动通知</a>[ 09-12 ]</div>
                        </div>
                    </div>
