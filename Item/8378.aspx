...
<head>
    ...
    <title>菁优网试用通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8378"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8378},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8378";
     ...
     <!--StartFragment -->
<DIV><FONT size=4>菁优网开通了一个公共体验账号，各科都可以免费体验半个月，体验账号支持老师们自主组卷、智能组卷、平行组卷，可免费下载组卷、试题（体验期间无权限下载试卷）<BR>菁优网：www.jyeoo.com<BR>公共体验号：sxyz@xyh.com   密码：112233</FONT><BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8377.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：209&#xD;发表时间：18年04月17日">化学教研活动通知</a>[ 04-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8379.aspx" target="_self" title="标题：高三年级参加竞赛学生名单公示&#xD;点击数：447&#xD;发表时间：18年04月17日">高三年级参加竞赛学生名单公示</a>[ 04-17 ]</div>
                        </div>
                    </div>
