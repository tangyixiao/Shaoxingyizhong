...
<head>
    ...
    <title>高三备课组长会议通知--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12591"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12591},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12591";
     ...
     <P>        请高三备课组长于今天下午3点20分在阶梯教室4104集中，商讨首考后续教学安排。</P>
<P>                                                                                 2021年1月4日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12589.aspx" target="_self" title="标题：高三晚自修安排（1.10-1.22）&#xD;点击数：413&#xD;发表时间：21年01月04日">高三晚自修安排（1.10-1.22）</a>[ 01-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12618.aspx" target="_self" title="标题：高三1月限时训练安排(一)&#xD;点击数：719&#xD;发表时间：21年01月11日">高三1月限时训练安排(一)</a>[ 01-11 ]</div>
                        </div>
                    </div>
