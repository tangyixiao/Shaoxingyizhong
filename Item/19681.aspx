...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19681"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19681},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19681";
     ...
     <p><span style="font-size: 18px;">明天下午（周二）、后天（周三）政治组教师全组外出参加16学时教研活动，相关政治课改自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19672.aspx" target="_self" title="标题：高三历史选考讲座通知&#xD;点击数：108&#xD;发表时间：24年04月22日">高三历史选考讲座通知</a>[ 04-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19682.aspx" target="_self" title="标题：通用技术教研活动通知&#xD;点击数：125&#xD;发表时间：24年04月22日">通用技术教研活动通知</a>[ 04-22 ]</div>
                        </div>
                    </div>
