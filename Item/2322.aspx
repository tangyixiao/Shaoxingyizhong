...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2322"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2322},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2322";
     ...
     <P>今日第一节课后（原第二节课下课时间），全校课间操照常进行。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2318.aspx" target="_self" title="标题：关于开学典礼的几点提示&#xD;点击数：444&#xD;发表时间：10年08月31日">关于开学典礼的几点提示</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2326.aspx" target="_self" title="标题：德育处通知&#xD;点击数：681&#xD;发表时间：10年09月01日">德育处通知</a>[ 09-01 ]</div>
                        </div>
                    </div>
