...
<head>
    ...
    <title>戴过帽子我长大了--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4576"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4576},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4576";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4575.aspx" target="_self" title="标题：陈诵洛与城南诗社学术讨论会在天津举行&#xD;点击数：1235&#xD;发表时间：12年12月10日">陈诵洛与城南诗社学术讨论会在天津举行</a>[ 12-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4581.aspx" target="_self" title="标题：孩子们一黑板的生日祝福&#xD;点击数：980&#xD;发表时间：12年12月20日">孩子们一黑板的生日祝福</a>[ 12-20 ]</div>
                        </div>
                    </div>
