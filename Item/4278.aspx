...
<head>
    ...
    <title>新高二休业式座位安排--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4278"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4278},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4278";
     ...
     <P>新高二休业式定于明日（7月4日）上午8：00正式开始，请各班于7：45分准时入场，按指定位置就座。新高三休业式延期进行，另行通知。</P>
<P>附：<A title=新高二休业式报告厅座位安排 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201107/2011070315421824.xls">新高二休业式报告厅座位安排</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4276.aspx" target="_self" title="标题：新高一明天(7月4日)下午参观及拍照安排&#xD;点击数：867&#xD;发表时间：11年07月03日">新高一明天(7月4日)下午参观及拍照安排</a>[ 07-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4281.aspx" target="_self" title="标题：关于上交新高二、新高三住校生申请表的通知&#xD;点击数：668&#xD;发表时间：11年07月03日">关于上交新高二、新高三住校生申请表的通知</a>[ 07-03 ]</div>
                        </div>
                    </div>
