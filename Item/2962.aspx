...
<head>
    ...
    <title>高一、高二各班（有改动）--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2962"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2962},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2962";
...
<P><FONT size=4>        今天中午（11月30日）12：30在实验楼南203室，召开高一、高二各班文娱委员、宣传委员会议，布置校艺术节相关事宜，请相互转告，准时参加。</FONT></P>
<P><FONT size=4>                                                                           德育处、团委</FONT></P>
<P><FONT size=4>                                                                                11月30日</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2960.aspx" target="_self" title="标题：绍兴一中新发展团员名单公示&#xD;点击数：454&#xD;发表时间：10年11月30日">绍兴一中新发展团员名单公示</a>[ 11-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3003.aspx" target="_self" title="标题：向各班团支部推荐订阅《中国青年报》&#xD;点击数：1004&#xD;发表时间：10年12月06日">向各班团支部推荐订阅《中国青年报》</a>[ 12-06 ]</div>
                        </div>
                    </div>
