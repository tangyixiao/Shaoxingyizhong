...
<head>
    ...
    <title>全校各班主任请注意（关于贫困学生）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">全校各班主任请注意（关于贫困学生）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=919"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:919},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=919";
...
<P><FONT size=5><STRONG>    接绍兴市关工委的通知，要求各校对贫困学生再进行一下摸底，然后在拿教育券的贫困学生中挑选部分情况尤其特殊的学生，上报市关工委。请各位抓紧时间做好这项工作，并在明天放学前（最迟到下星期一中午12：00点）把名单交德育处。不要因为你的因素影响了接下来的工作的开展。</STRONG></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/856.aspx" target="_self" title="标题：关于住校生应急疏散演练的通知&#xD;点击数：417&#xD;发表时间：09年12月03日">关于住校生应急疏散演练的通知</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/923.aspx" target="_self" title="标题：关于下周一升旗仪式的通知&#xD;点击数：314&#xD;发表时间：09年12月05日">关于下周一升旗仪式的通知</a>[ 12-05 ]</div>
                        </div>
                    </div>
