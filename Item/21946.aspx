...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21946"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21946},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21946";
     ...
     <article><span style="font-size: 20px;">9月22日（周一），地理组外出教研，地理课改自修。</span></article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21937.aspx" target="_self" title="标题：2025CSP考场布置及相关要求&#xD;点击数：216&#xD;发表时间：25年09月18日">2025CSP考场布置及相关要求</a>[ 09-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21947.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：118&#xD;发表时间：25年09月22日">化学教研活动通知</a>[ 09-22 ]</div>
                        </div>
                    </div>
