...
<head>
    ...
    <title>关于延期举行绍兴市首届中学生田径运动会的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于延期举行绍兴市首届中学生田径运动会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14444"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14444},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14444";
     ...
     <p><span style="FONT-SIZE: 20px; FONT-FAMILY: 宋体,SimSun">各班主任及运动员：
    鉴于当前疫情防控形势，结合属地防控部门要求，原定于周五举行的绍兴市首届中学生田径运动会延期举行，恢复时间另行通知。 请大家知晓！</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14441.aspx" target="_self" title="标题：高三历史教研活动通知&#xD;点击数：143&#xD;发表时间：21年11月18日">高三历史教研活动通知</a>[ 11-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14469.aspx" target="_self" title="标题：高一期中考试分析会通知&#xD;点击数：233&#xD;发表时间：21年11月22日">高一期中考试分析会通知</a>[ 11-22 ]</div>
                        </div>
                    </div>
