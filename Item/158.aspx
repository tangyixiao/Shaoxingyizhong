...
<head>
    ...
    <title>备课纸领取通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=158"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:158},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=158";
           ...
           根据备课实际需要，请各年级以学科备课组为单位派老师到倪军老师处统一领取本学期备课纸。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/156.aspx" target="_self" title="标题：各竞赛指导老师&#xD;点击数：558&#xD;发表时间：09年08月27日">各竞赛指导老师</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/159.aspx" target="_self" title="标题：高一回头考监考安排（8月31日）&#xD;点击数：462&#xD;发表时间：09年08月28日">高一回头考监考安排（8月31日）</a>[ 08-28 ]</div>
                        </div>
                    </div>
