...
<head>
    ...
    <title>高二期中考试分析会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14495"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14495},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14495";
     ...
     <p><span style="FONT-SIZE: 20px; FONT-FAMILY: 宋体,SimSun">请高二任课老师于今天下午第9节课到树兰楼三楼会议室二参加期中考试分析会，务必准时参加。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14490.aspx" target="_self" title="标题：关于市运动会比赛期间体育课停课通知&#xD;点击数：215&#xD;发表时间：21年11月23日">关于市运动会比赛期间体育课停课通知</a>[ 11-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14496.aspx" target="_self" title="标题：高三早自修调整通知&#xD;点击数：242&#xD;发表时间：21年11月24日">高三早自修调整通知</a>[ 11-24 ]</div>
                        </div>
                    </div>
