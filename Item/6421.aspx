...
<head>
    ...
    <title>高一年级长、班主任和备课组长会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一年级长、班主任和备课组长会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6421"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6421},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6421";
     ...
     <FONT size=4>请高一年级长、班主任和备课组长于今天下午第7节课（14：30）到行政楼三楼会议室开会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6419.aspx" target="_self" title="标题：高二部分走班自修教室调换通知&#xD;点击数：124&#xD;发表时间：17年02月16日">高二部分走班自修教室调换通知</a>[ 02-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6426.aspx" target="_self" title="标题：高一（1）～（10）班试场布置要求&#xD;点击数：207&#xD;发表时间：17年02月17日">高一（1）～（10）班试场布置要求</a>[ 02-17 ]</div>
                        </div>
                    </div>
