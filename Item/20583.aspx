...
<head>
    ...
    <title>通用技术组外出教研通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20583"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20583},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20583";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 18px; text-wrap-mode: wrap; background-color: rgb(255, 255, 255);">明天（11月21日），通用技术组全体老师外出参加教研活动，相关班级通用技术课改自修。通用技术走班学生在相应上课教室自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20559.aspx" target="_self" title="标题：生物教研活动通知&#xD;点击数：100&#xD;发表时间：24年11月18日">生物教研活动通知</a>[ 11-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20600.aspx" target="_self" title="标题：2024年新教师招聘面试教室布置要求（有修改）&#xD;点击数：278&#xD;发表时间：24年11月23日">2024年新教师招聘面试教室布置要求（有修改）</a>[ 11-23 ]</div>
                        </div>
                    </div>
