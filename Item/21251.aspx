...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21251"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21251},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21251";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: 宋体, SimSun; font-size: 18px; text-wrap-mode: wrap; background-color: rgb(255, 255, 255);">  本周二（4.15)至周三（4.16）两天，全体语文老师外出参加市直90学分培训，语文课全部改自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21246.aspx" target="_self" title="标题：关于历史教研活动的通知&#xD;点击数：162&#xD;发表时间：25年04月14日">关于历史教研活动的通知</a>[ 04-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21263.aspx" target="_self" title="标题：关于生物教研活动的通知&#xD;点击数：144&#xD;发表时间：25年04月16日">关于生物教研活动的通知</a>[ 04-16 ]</div>
                        </div>
                    </div>
