...
<head>
    ...
    <title>高一年级体育课暂停通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15109"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15109},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15109";
     ...
     <p>因视力普查工作需要，明天（3月9日）高一年级体育课暂停。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15106.aspx" target="_self" title="标题：关于参加市直运动会学生开会通知&#xD;点击数：294&#xD;发表时间：22年03月08日">关于参加市直运动会学生开会通知</a>[ 03-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15118.aspx" target="_self" title="标题：物理教研活动通知&#xD;点击数：229&#xD;发表时间：22年03月09日">物理教研活动通知</a>[ 03-09 ]</div>
                        </div>
                    </div>
