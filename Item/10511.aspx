...
<head>
    ...
    <title>新教师师徒结对会议通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10511"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10511},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10511";
     ...
     <P> </P>
<P>定于明天（9月10日）下午15：40分在行政楼三楼会议室二举行2019年新教师师徒结对仪式，请以下老师准时出席。如有课程冲突请自行调整。</P>
<P>参会<A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201909/2019090915392975.png" target=_blank> </A>老师名单：</P>
<P><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201909/2019090915392975.png" target=_blank><IMG onload=resizepic(this) onmousewheel="return bbimg(this)" border=0 src="/Shaoxingyizhong/UploadFiles/UploadFiles/201909/2019090915392975.png" width=277 height=133></A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10506.aspx" target="_self" title="标题：关于心理健康教育C证培训安排的通知&#xD;点击数：204&#xD;发表时间：19年09月07日">关于心理健康教育C证培训安排的通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10523.aspx" target="_self" title="标题：关于参加浙师大、杭师大实习生会议的通知&#xD;点击数：429&#xD;发表时间：19年09月10日">关于参加浙师大、杭师大实习生会议的通知</a>[ 09-10 ]</div>
                        </div>
                    </div>
