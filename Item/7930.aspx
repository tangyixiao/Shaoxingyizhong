...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7930"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7930},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7930";
     ...
     <!--StartFragment -->
<DIV>因系统原因，今日安排的学生综合素质评价获奖信息录入工作暂时取消，时间另行通知。请各班班主任及时通知！ </DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7927.aspx" target="_self" title="标题：2017学年第一学期学生单项先进评比办法&#xD;点击数：508&#xD;发表时间：18年01月09日">2017学年第一学期学生单项先进评比办法</a>[ 01-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7932.aspx" target="_self" title="标题：1.09&amp;nbsp;跑操情况反馈&#xD;点击数：301&#xD;发表时间：18年01月09日">1.09 跑操情况反馈</a>[ 01-09 ]</div>
                        </div>
                    </div>
