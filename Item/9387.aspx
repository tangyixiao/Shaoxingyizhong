...
<head>
    ...
    <title>今天下午上课提前通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9387"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9387},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9387";
     ...
     <FONT size=4>因今天下午15:00开始将举行绍兴一中教师模拟基本功比武测试，下午第一节上课时间提前至13:20。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9378.aspx" target="_self" title="标题：数学教研活动通知&#xD;点击数：303&#xD;发表时间：18年11月21日">数学教研活动通知</a>[ 11-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9388.aspx" target="_self" title="标题：绍兴市级乒乓球比赛通知&#xD;点击数：456&#xD;发表时间：18年11月22日">绍兴市级乒乓球比赛通知</a>[ 11-22 ]</div>
                        </div>
                    </div>
