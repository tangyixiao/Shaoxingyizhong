...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=839"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:839},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=839";
     ...
     <FONT color=#000000 size=4>因故，新眼保健操推迟至明天（星期二）开始做。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/829.aspx" target="_self" title="标题：通知&#xD;点击数：247&#xD;发表时间：09年12月03日">通知</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/840.aspx" target="_self" title="标题：绍兴一中各班住校生就寝纪律、寝室卫生情况统计表（&amp;nbsp;2009.11.22-2009.11.27）&#xD;点击数：219&#xD;发表时间：09年12月03日">绍兴一中各班住校生就寝纪律、寝室卫生情况统计表（ 2009.11.2…</a>[ 12-03 ]</div>
                        </div>
                    </div>
