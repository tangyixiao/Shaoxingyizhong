...
<head>
    ...
    <title>第二届“学生校长助理”人选公示--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">第二届“学生校长助理”人选公示</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7983"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7983},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7983";
     ...
     <P align=center><STRONG><FONT size=5>第二届“学生校长助理”人选公示</FONT></STRONG></P>
<P><FONT size=4>    经校团委初选及决选面试、答辩考核，现将产生的第二届“学生校长助理”人选予以公示（按名次从高到低排列）。</FONT></P>
<P align=center><FONT size=4>高二（ 5）班 汪书楠<BR>高一（18）班 张泽宇<BR>高一（14）班 陈  亮</FONT></P>
<P><FONT size=4>    公示期：1月18日-1月24日</FONT></P>
<P><FONT size=4>    公示期间，如有任何问题，请及时与校团委联系。</FONT></P>
<P align=right><FONT size=4>共青团绍兴市第一中学委员会<BR>2018年1月18日</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7978.aspx" target="_self" title="标题：文学社“阅读之星”推荐名单公示&#xD;点击数：463&#xD;发表时间：18年01月18日">文学社“阅读之星”推荐名单公示</a>[ 01-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7986.aspx" target="_self" title="标题：关于今天中午进行团校结业考试的通知&#xD;点击数：220&#xD;发表时间：18年01月19日">关于今天中午进行团校结业考试的通知</a>[ 01-19 ]</div>
                        </div>
                    </div>
