...
<head>
    ...
    <title>高一、高二地方性课程--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2735"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2735},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2735";
     ...
     本周高一（周四下午第四节）、高二（周五下午第四节）地方性课程继续在报告厅上课。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2732.aspx" target="_self" title="标题：高一、高二期中考试时间与科目&#xD;点击数：852&#xD;发表时间：10年10月27日">高一、高二期中考试时间与科目</a>[ 10-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2745.aspx" target="_self" title="标题：高一、高二期中考试学生试场安排&#xD;点击数：511&#xD;发表时间：10年10月28日">高一、高二期中考试学生试场安排</a>[ 10-28 ]</div>
                        </div>
                    </div>
