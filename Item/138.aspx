...
<head>
    ...
    <title>原高三班主任注意--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">原高三班主任注意</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年08月25日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=138"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:138},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=138";
     ...
     <DIV>根据市招办要求，被高校录取考生的纸质档案由市招办统一送省考试院，考生不能自带。录取后不准备去报到的或未被录取准备复读的考生，要到教学处提出留档申请（9月30日前），不提出留档申请，教学处将把档案按时送出，到时不能退档或档案遗失，由考生自己负责。希望原高三班主任及时通知有关考生。</DIV>
<DIV>                &nb
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/134.aspx" target="_self" title="标题：关于2008学年获奖论文纸质稿及荣誉证书复印件的征集通知&#xD;点击数：659&#xD;发表时间：09年09月07日">关于2008学年获奖论文纸质稿及荣誉证书复印件的征集通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/139.aspx" target="_self" title="标题：关于开展2009年高考征文活动的通知&#xD;点击数：551&#xD;发表时间：09年09月15日">关于开展2009年高考征文活动的通知</a>[ 09-15 ]</div>
                        </div>
                    </div>
