...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8377"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8377},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8377";
     ...
     <FONT size=4>明天（周三）化学组全体老师外出参加教研活动，相关班级化学课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8376.aspx" target="_self" title="标题：高三语文教研活动通知&#xD;点击数：221&#xD;发表时间：18年04月17日">高三语文教研活动通知</a>[ 04-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8378.aspx" target="_self" title="标题：菁优网试用通知&#xD;点击数：383&#xD;发表时间：18年04月17日">菁优网试用通知</a>[ 04-17 ]</div>
                        </div>
                    </div>
