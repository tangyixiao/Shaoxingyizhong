...
<head>
    ...
    <title>绍兴一中再次蝉联信息学奥赛全省第一--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中再次蝉联信息学奥赛全省第一</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3107"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3107},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3107";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3013.aspx" target="_self" title="标题：绍兴一中学生再次荣获“丘成桐中学数学奖”&#xD;点击数：696&#xD;发表时间：10年12月08日">绍兴一中学生再次荣获“丘成桐中学数学奖”</a>[ 12-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3148.aspx" target="_self" title="标题：两年，两次辅导学生获得“丘成桐中学数学奖”大奖&#xD;点击数：660&#xD;发表时间：10年12月27日">两年，两次辅导学生获得“丘成桐中学数学奖”大奖</a>[ 12-27 ]</div>
                        </div>
                    </div>
