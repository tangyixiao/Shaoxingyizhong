...
<head>
    ...
    <title>颂国庆丹青美术展结果--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3245"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3245},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3245";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><B style="mso-bidi-font-weight: normal"><SPAN lang=EN-US style="COLOR: red"><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p><FONT size=3><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201101/2011011210390798.jpg" target=_blank><IMG onmousewheel="return bbimg(this)" height=661 src="/Shaoxingyizhong/UploadFiles/UploadFiles/201101/2011011210390798.jpg" width=562 onload=resizepic(this) border=0> </A> </FONT></o:p></SPAN></B></P>
...
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3240.aspx" target="_self" title="标题：批评&#xD;点击数：799&#xD;发表时间：11年01月10日">批评</a>[ 01-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3248.aspx" target="_self" title="标题：值周检查情况汇总（1月12日星期三）&#xD;点击数：368&#xD;发表时间：11年01月13日">值周检查情况汇总（1月12日星期三）</a>[ 01-13 ]</div>
                        </div>
                    </div>
