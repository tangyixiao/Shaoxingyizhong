...
<head>
    ...
    <title>高二课外活动、校本课程时间更改--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二课外活动、校本课程时间更改</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=185"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:185},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=185";
     ...
     <P><FONT size=3>高二课外活动时间：星期三下午第三节、星期四下午第四节</FONT></P>
<P><FONT size=3>     校本课程时间：星期二下午第四节</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/184.aspx" target="_self" title="标题：校定向队招新队员通知&#xD;点击数：556&#xD;发表时间：09年09月01日">校定向队招新队员通知</a>[ 09-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/186.aspx" target="_self" title="标题：高三部分选修IB上课安排&#xD;点击数：644&#xD;发表时间：09年09月01日">高三部分选修IB上课安排</a>[ 09-01 ]</div>
                        </div>
                    </div>
