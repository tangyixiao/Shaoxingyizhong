...
<head>
    ...
    <title>美术生上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10601"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10601},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10601";
     ...
     <FONT size=4>请美术特长生及高一、高二有意向参加美术高考的学生，于明天（周二）晚上6:00到树兰楼四楼美术教室（二）上课，工具自带（除画板、画架外）。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10585.aspx" target="_self" title="标题：关于高三召开名校协作体考试分析会议的通知&#xD;点击数：303&#xD;发表时间：19年09月20日">关于高三召开名校协作体考试分析会议的通知</a>[ 09-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10606.aspx" target="_self" title="标题：关于高一（4）班任课老师会议的通知&#xD;点击数：501&#xD;发表时间：19年09月24日">关于高一（4）班任课老师会议的通知</a>[ 09-24 ]</div>
                        </div>
                    </div>
