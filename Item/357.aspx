...
<head>
    ...
    <title>转发《2009年浙江省田径等级赛竞赛》通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">转发《2009年浙江省田径等级赛竞赛》通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月30日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=357"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:357},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=357";
...
<P class=MsoNormal style="LINE-HEIGHT: 150%; TEXT-ALIGN: center" align=center><SPAN lang=EN-US style="FONT-SIZE: 10.5pt; COLOR: black; LINE-HEIGHT: 150%; FONT-FAMILY: 宋体"><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" />
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/356.aspx" target="_self" title="标题：关于2009年绍兴市直中学教师中评委评审结果的公示&#xD;点击数：579&#xD;发表时间：09年09月30日">关于2009年绍兴市直中学教师中评委评审结果的公示</a>[ 09-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/359.aspx" target="_self" title="标题：关于召开支部书记会议的通知&#xD;点击数：472&#xD;发表时间：09年10月08日">关于召开支部书记会议的通知</a>[ 10-08 ]</div>
                        </div>
                    </div>
