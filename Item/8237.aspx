...
<head>
    ...
    <title>明后两天跑操比赛通知（有修改）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">明后两天跑操比赛通知（有修改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8237"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8237},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8237";
     ...
     <P>    明后两天（3月30日、31日），全校将进行大课间跑操比赛<FONT color=#ff0000>（其中，高三因课程时间冲突，仅参加明天跑操比赛）</FONT>，届时将进行评比并公布成绩。</P>
<P align=right>德育处</P>
<P align=right>2017年3月29日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8228.aspx" target="_self" title="标题：失物招领&#xD;点击数：203&#xD;发表时间：18年03月27日">失物招领</a>[ 03-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8242.aspx" target="_self" title="标题：寻物启事&#xD;点击数：184&#xD;发表时间：18年03月29日">寻物启事</a>[ 03-29 ]</div>
                        </div>
                    </div>
