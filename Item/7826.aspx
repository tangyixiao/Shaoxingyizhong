...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7826"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7826},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7826";
           ...
           因场地原因，大课间操暂停。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7820.aspx" target="_self" title="标题：高三关于综合素质评价的补充通知&#xD;点击数：669&#xD;发表时间：17年12月18日">高三关于综合素质评价的补充通知</a>[ 12-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7830.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：225&#xD;发表时间：17年12月19日">表扬与失物招领</a>[ 12-19 ]</div>
                        </div>
                    </div>
