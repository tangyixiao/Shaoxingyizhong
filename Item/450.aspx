...
<head>
    ...
    <title>自行车上锁情况检查记录表(10.18-10.24)--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">自行车上锁情况检查记录表(10.18-10.24)</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=450"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:450},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=450";
...
<DIV align=center>        第八周        10月18日至10月24日</DIV>
...
<DIV>&nb
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/449.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.10.18-10.24）&#xD;点击数：361&#xD;发表时间：09年10月25日">绍兴一中校园晚间安全检查公告(2009.10.18-10.24）</a>[ 10-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/452.aspx" target="_self" title="标题：检查通报&#xD;点击数：339&#xD;发表时间：09年10月26日">检查通报</a>[ 10-26 ]</div>
                        </div>
                    </div>
