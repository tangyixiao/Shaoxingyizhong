...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2568"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2568},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2568";
     ...
     <P>                            文明办公室检查</P>
<P>     为干干净净迎接国庆,今天下午第四节课进行文明办公室检查,请各年级今天白天值班的老师在下午第四节课到总务处(2)办公室集中.</P>
<P> </P>
<P>                                                           校文明办公室检查小组</P>
<P>                                                                 2010.9.29</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2536.aspx" target="_self" title="标题：工会通知&#xD;点击数：911&#xD;发表时间：10年09月26日">工会通知</a>[ 09-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2632.aspx" target="_self" title="标题：工会公告&#xD;点击数：734&#xD;发表时间：10年10月13日">工会公告</a>[ 10-13 ]</div>
                        </div>
                    </div>
