...
<head>
    ...
    <title>寻物启事（羽毛球拍）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18350"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18350},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18350";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; background-color: rgb(255, 255, 255);">9月7日下午第二节体育课，有同学在体育馆遗失羽毛球拍一块（蓝色手胶），</span><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; background-color: rgb(255, 255, 255);">如有拾到请交还214班裘文唐同学处。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18348.aspx" target="_self" title="标题：本周六博雅大讲堂活动开始通知&#xD;点击数：176&#xD;发表时间：23年09月07日">本周六博雅大讲堂活动开始通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18352.aspx" target="_self" title="标题：关于大课间做操、升旗仪式的进场、站位及相关要求的通知&#xD;点击数：163&#xD;发表时间：23年09月07日">关于大课间做操、升旗仪式的进场、站位及相关要求的通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
