...
<head>
    ...
    <title>今天下午最后一节课大扫除通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天下午最后一节课大扫除通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7304"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7304},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7304";
     ...
     <P>高二，高三各班同学请注意，由于天气原因，下午最后一节课大扫除重点放在教学楼（如包干区在室外则要求地面基本干净，无塑料瓶等废弃物）。着重打扫教室南边走廊一侧玻璃窗；教室、走廊地面；楼梯；扶栏等，教室内柜台要求无积灰，分类垃圾桶需清理干净。</P>
<P>各班班长劳动委员请及时落实各项任务，望大家积极配合。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7302.aspx" target="_self" title="标题：值周小结及考核评价&#xD;点击数：160&#xD;发表时间：17年09月11日">值周小结及考核评价</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7305.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：81&#xD;发表时间：17年09月11日">表扬与失物招领</a>[ 09-11 ]</div>
                        </div>
                    </div>
