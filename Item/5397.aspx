...
<head>
    ...
    <title>放晚学时间调整通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5397"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5397},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5397";
...
<P>高二、高三：17：00</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5395.aspx" target="_self" title="标题：高一、高二、高三各班劳动委员开会通知&#xD;点击数：212&#xD;发表时间：16年08月08日">高一、高二、高三各班劳动委员开会通知</a>[ 08-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5398.aspx" target="_self" title="标题：2016学年绍兴一中各年级每日包干区划分&#xD;点击数：111&#xD;发表时间：16年08月08日">2016学年绍兴一中各年级每日包干区划分</a>[ 08-08 ]</div>
                        </div>
                    </div>
