...
<head>
    ...
    <title>高三毕业证书校对--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1954"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1954},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1954";
     ...
     <P>  <FONT size=5>  毕业证书已打印好，请班主任发给学生校对信息、并贴好相片，请在今天下午放学前交完成交教学处，<SPAN lang=EN-US>5</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">月</SPAN><SPAN lang=EN-US>31</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">日上午是教育局指定我校敲钢印时间，希望各班主任督促学生务必按时完成。</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1953.aspx" target="_self" title="标题：高二物理课改自修&#xD;点击数：340&#xD;发表时间：10年05月27日">高二物理课改自修</a>[ 05-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1958.aspx" target="_self" title="标题：转发浙江省教育技术中心《关于举办全省中小学教师“信息技术与教育创新”征文活动暨组织参加全国中小学教师“信息技术与教育创新”论文大赛的通知》&#xD;点击数：394&#xD;发表时间：10年05月28日">转发浙江省教育技术中心《关于举办全省中小学教师“信息技术与…</a>[ 05-28 ]</div>
                        </div>
                    </div>
