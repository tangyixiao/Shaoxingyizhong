...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8150"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8150},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8150";
     ...
     <P>        今天中午12：30，请高一、高二、高三各班学习委员随带寒假社会实践表和学分表，到阶梯教室4111室开会！</P>
<P>                                                                                                         团委</P>
<P>                                                                                                        2018年3月12日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8143.aspx" target="_self" title="标题：领取树人导报的通知&#xD;点击数：87&#xD;发表时间：18年03月09日">领取树人导报的通知</a>[ 03-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8154.aspx" target="_self" title="标题：关于加强绍兴一中基层团支部建设及团员学生管理的通知&#xD;点击数：339&#xD;发表时间：18年03月12日">关于加强绍兴一中基层团支部建设及团员学生管理的通知</a>[ 03-12 ]</div>
                        </div>
                    </div>
