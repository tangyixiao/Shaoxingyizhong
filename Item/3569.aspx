...
<head>
    ...
    <title>今日大课间操暂停--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今日大课间操暂停</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>今日大课间操暂停</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年03月22日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3569"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3569},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3569";
     ...
     今日天雨，大课间操暂停。各班在教室自习。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3564.aspx" target="_self" title="标题：3月20日（周日）寝室缺席名单&#xD;点击数：468&#xD;发表时间：11年03月21日">3月20日（周日）寝室缺席名单</a>[ 03-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3571.aspx" target="_self" title="标题：2011年大学生助学摸底申请的有关通知&#xD;点击数：421&#xD;发表时间：11年03月22日">2011年大学生助学摸底申请的有关通知</a>[ 03-22 ]</div>
                        </div>
                    </div>
