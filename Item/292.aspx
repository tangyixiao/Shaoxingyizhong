...
<head>
    ...
    <title>关于公布团委、学生会招聘面试结果的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于公布团委、学生会招聘面试结果的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=292"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:292},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=292";
     ...
     <DIV>    下列同学已通过团委、学生会面试，接下来需要参加学生干部培训，通过考核者正式聘用并开展工作。请以下同学关注校园网上有关培训时间、地点的通知。</DIV>
<TABLE cellSpacing=0 cellPadding=0 align=left border=1>
<TBODY>
<TR>
<TD vAlign=top width=96>
<DIV align=center>高一（1）班</DIV></TD>
<TD vAlign=top width=96>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/281.aspx" target="_self" title="标题：关于高一各班设立安检委员、并填写班干部统计表的通知&#xD;点击数：453&#xD;发表时间：09年09月15日">关于高一各班设立安检委员、并填写班干部统计表的通知</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/293.aspx" target="_self" title="标题：关于学生会主席竞选的通知（高一、高二各班班长请注意）&#xD;点击数：380&#xD;发表时间：09年09月17日">关于学生会主席竞选的通知（高一、高二各班班长请注意）</a>[ 09-17 ]</div>
                        </div>
                    </div>
