...
<head>
    ...
    <title>关于体健部、纪检部成员开会的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于体健部、纪检部成员开会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5803"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5803},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5803";
     ...
     请高一、高二体健部、纪检部成员于今天中午12：30准时到升旗台前集中开会。希相互转告。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5797.aspx" target="_self" title="标题：运动会入场式评比组老师注意&#xD;点击数：192&#xD;发表时间：16年10月26日">运动会入场式评比组老师注意</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5805.aspx" target="_self" title="标题：运动会开幕式及运动竞赛项目时间调整通知&#xD;点击数：551&#xD;发表时间：16年10月27日">运动会开幕式及运动竞赛项目时间调整通知</a>[ 10-27 ]</div>
                        </div>
                    </div>
