...
<head>
    ...
    <title>校车时间更改通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">校车时间更改通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>校车时间更改通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年10月08日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7410"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7410},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7410";
     ...
     <P>                             校车时间更改通知</P>
<P>     因为作息时间的更改，校车傍晚时间从今天起更改为下午5:05分，早上时间暂时不变，请大家相互转告，谢谢。</P>
<P> </P>
<P>                                                   校办</P>
<P>                                                      10.8</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7407.aspx" target="_self" title="标题：关于早读早学专项检查反馈的通知（有修改）&#xD;点击数：242&#xD;发表时间：17年10月05日">关于早读早学专项检查反馈的通知（有修改）</a>[ 10-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7411.aspx" target="_self" title="标题：2017学年学生体检通知&#xD;点击数：470&#xD;发表时间：17年10月08日">2017学年学生体检通知</a>[ 10-08 ]</div>
                        </div>
                    </div>
