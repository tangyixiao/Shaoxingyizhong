...
<head>
    ...
    <title>失物招领（有图）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2785"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2785},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2785";
     ...
     <FONT size=4>
<P> </P>
<P>    最近一段时间，德育处收到学生捡到的眼镜、手表、公交卡、钥匙、人民币等物品（附图），请失主及时到德育处认领。</P>
<P><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201011/2010110511121533.jpg" target=_blank><IMG onmousewheel="return bbimg(this)" height=648 src="/Shaoxingyizhong/UploadFiles/UploadFiles/201011/2010110511121533.jpg" width=800 onload=resizepic(this) border=0> </A></P></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2782.aspx" target="_self" title="标题：值周检查情况汇总（11月4日星期四）&#xD;点击数：328&#xD;发表时间：10年11月05日">值周检查情况汇总（11月4日星期四）</a>[ 11-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2786.aspx" target="_self" title="标题：温馨宿舍照片展示&#xD;点击数：562&#xD;发表时间：10年11月05日">温馨宿舍照片展示</a>[ 11-05 ]</div>
                        </div>
                    </div>
