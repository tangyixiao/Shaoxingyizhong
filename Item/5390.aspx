...
<head>
    ...
    <title>高三各备课组长请注意--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三各备课组长请注意</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高三各备课组长请注意</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2016年08月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5390"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5390},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5390";
     ...
     <!--StartFragment -->
<DIV>高三各备课组长请注意，补课期间的限时训练安排如下：星期一英语，星期二物理/政治，星期三化学/历史，星期四生物/地理，星期五数学。请各位出好试卷。 </DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4183.aspx" target="_self" title="标题：高三党支部会议&#xD;点击数：558&#xD;发表时间：11年06月16日">高三党支部会议</a>[ 06-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5454.aspx" target="_self" title="标题：请下列老师于下午1点40分在行政楼三楼会议室开会&#xD;点击数：150&#xD;发表时间：16年09月06日">请下列老师于下午1点40分在行政楼三楼会议室开会</a>[ 09-06 ]</div>
                        </div>
                    </div>
