...
<head>
    ...
    <title>关于选修IB上课地点修改的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于选修IB上课地点修改的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1428"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1428},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1428";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
            ...
            由于实西-201作为本学期竞赛辅导教室，所以高二年级选修IB经济学常识上课地点更改为3-201，请班主任通知相关学生，高二（01）班未选报该模块的学生去图书馆自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1427.aspx" target="_self" title="标题：下周（3.15-3.21）各学科主题研修活动通知&#xD;点击数：428&#xD;发表时间：10年03月11日">下周（3.15-3.21）各学科主题研修活动通知</a>[ 03-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1430.aspx" target="_self" title="标题：关于省学籍管理系统综合实践活动登记培训的通知&#xD;点击数：421&#xD;发表时间：10年03月11日">关于省学籍管理系统综合实践活动登记培训的通知</a>[ 03-11 ]</div>
                        </div>
                    </div>
