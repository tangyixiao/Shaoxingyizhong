...
<head>
    ...
    <title>失物招领＋寻物启事--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16500"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16500},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16500";
     ...
     <p>失物招领：</p><p>4111教室地板上，拾到墨绿色手表一只</p><p>寻物启事：</p><p>10.31下午体测，引体向上器材前10米处，丢失冲锋衣一件，口袋里有20级9班的饭卡</p><p>11.3上午第三节课在操场上丢失一件冲锋衣，口袋内有209班饭卡和纪律岗位牌</p><p>11.3傍晚于操场或体育馆丢失饭卡和纪律岗挂牌一张，饭卡上有“Master the Internet”贴纸，请拾到者送回209班许航</p><p>11.3下午之后丢失128Gu盘一个，主体为金属色，带墨绿色边框，挂在一条金属手链上，可能在体育馆或者楼道丢失，请拾到者送回204班给陈诗怡</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16497.aspx" target="_self" title="标题：关于举行第四届校级家委会会议的通知&#xD;点击数：259&#xD;发表时间：22年11月04日">关于举行第四届校级家委会会议的通知</a>[ 11-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16503.aspx" target="_self" title="标题：11.2班级一日考核&#xD;点击数：63&#xD;发表时间：22年11月04日">11.2班级一日考核</a>[ 11-04 ]</div>
                        </div>
                    </div>
