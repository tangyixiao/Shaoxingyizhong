...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8491"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8491},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8491";
     ...
     <FONT size=4>5月7日至12日体育组全体老师参加越城区中学生体育中考考评，相关班级体育课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8488.aspx" target="_self" title="标题：期中考试试场布置及考试相关要求&#xD;点击数：743&#xD;发表时间：18年05月04日">期中考试试场布置及考试相关要求</a>[ 05-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8509.aspx" target="_self" title="标题：信息技术教研活动通知&#xD;点击数：127&#xD;发表时间：18年05月09日">信息技术教研活动通知</a>[ 05-09 ]</div>
                        </div>
                    </div>
