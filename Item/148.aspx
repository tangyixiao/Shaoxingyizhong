...
<head>
    ...
    <title>关于工作安排的通知（各处室、各年级）--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于工作安排的通知（各处室、各年级）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=148"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:148},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=148";
     ...
     <P><FONT face=楷体_GB2312 size=4>1、本学期的行事历请交办公室。</FONT></P>
<P><FONT face=楷体_GB2312 size=4>2、每周的具体工作安排请在前一周的周六上午交办公室，上交时的基本格式须有：时间、地点、主题、参加人员。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/147.aspx" target="_self" title="标题：校园内不乱停车的通知&#xD;点击数：1327&#xD;发表时间：09年08月27日">校园内不乱停车的通知</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/152.aspx" target="_self" title="标题：关于组织绍兴市区中小学教师专业阅读考试的通知&#xD;点击数：1234&#xD;发表时间：09年08月27日">关于组织绍兴市区中小学教师专业阅读考试的通知</a>[ 08-27 ]</div>
                        </div>
                    </div>
