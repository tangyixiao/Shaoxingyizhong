...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15173"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15173},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15173";
     ...
     <p>3月17日（周四），化学组全体老师参加市直教研活动，当天化学课改自修。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15169.aspx" target="_self" title="标题：历史教研活动通知&#xD;点击数：195&#xD;发表时间：22年03月16日">历史教研活动通知</a>[ 03-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15178.aspx" target="_self" title="标题：周五体育课暂停通知&#xD;点击数：309&#xD;发表时间：22年03月17日">周五体育课暂停通知</a>[ 03-17 ]</div>
                        </div>
                    </div>
