...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9601"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9601},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9601";
     ...
     <P>温馨提醒：</P>
<P>明天（29日）全校按周一课表上课，作息时间按周二作息时间，大课间跑操暂停。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9579.aspx" target="_self" title="标题：部分课程改自修的通知&#xD;点击数：445&#xD;发表时间：18年12月26日">部分课程改自修的通知</a>[ 12-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9606.aspx" target="_self" title="标题：2018学年第一学期期末考试安排&#xD;点击数：1528&#xD;发表时间：18年12月29日">2018学年第一学期期末考试安排</a>[ 12-29 ]</div>
                        </div>
                    </div>
