...
<head>
    ...
    <title>高一第二学期期中成绩分析会通知（更新）--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一第二学期期中成绩分析会通知（更新）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=23138"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23138},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23138";
     ...
     <p style="padding: 0px; margin-top: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background-color: rgb(255, 255, 255); margin-bottom: 20px !important;">各位高一任课老师：</p><p style="padding: 0px; margin-top: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background-color: rgb(255, 255, 255); margin-bottom: 20px !important;">      定于本周四（5月7日）下午 <strong>16:15 </strong>在4112召开高一第二学期期中成绩分析会，请大家安排好工作，提前5分钟到会。请相互转告，谢谢大家！</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/23128.aspx" target="_self" title="标题：高一晚自修（5.5.-5.15）&#xD;点击数：124&#xD;发表时间：26年04月29日">高一晚自修（5.5.-5.15）</a>[ 04-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/23215.aspx" target="_self" title="标题：高一晚自修（5.17-5.31）&#xD;点击数：95&#xD;发表时间：26年05月15日">高一晚自修（5.17-5.31）</a>[ 05-15 ]</div>
                        </div>
                    </div>
