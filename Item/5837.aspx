...
<head>
    ...
    <title>晚间安全检查记录2016.11.1--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2016.11.1</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5837"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5837},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5837";
     ...
     11月1日晚，高一（11）班前门未关。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5825.aspx" target="_self" title="标题：每日晨检表未交情况通报10.31&#xD;点击数：81&#xD;发表时间：16年10月31日">每日晨检表未交情况通报10.31</a>[ 10-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5850.aspx" target="_self" title="标题：每日晨检表未交情况通报11.4&#xD;点击数：111&#xD;发表时间：16年11月04日">每日晨检表未交情况通报11.4</a>[ 11-04 ]</div>
                        </div>
                    </div>
