...
<head>
    ...
    <title>关于本周校本课程暂停的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于本周校本课程暂停的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=538"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:538},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=538";
     ...
     <P>      <FONT size=3>由于“甲流”原因，<FONT face=Verdana>本周校本课程暂停。希各班主任及时通知本班学生。</FONT></FONT></P>
<P><FONT size=3>                    &n
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/536.aspx" target="_self" title="标题：关于召开原虚拟十七班任课教师座谈会的通知&#xD;点击数：309&#xD;发表时间：09年11月10日">关于召开原虚拟十七班任课教师座谈会的通知</a>[ 11-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/541.aspx" target="_self" title="标题：通知二则&#xD;点击数：379&#xD;发表时间：09年11月10日">通知二则</a>[ 11-10 ]</div>
                        </div>
                    </div>
