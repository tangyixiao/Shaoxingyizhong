...
<head>
    ...
    <title>关于针对未完成安全平台、禁毒平台作业的学生开放机房的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于针对未完成安全平台、禁毒平台作业的学生开放机房的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9500"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9500},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9500";
     ...
     <P>各位同学：</P>
<P>学校将于13号（周四）、14号（周五）中午开放机房，以方便未完成安全平台、禁毒平台学生完成相关作业。请各位同学相互通知，准时完成。</P>
<P>如有同学忘记账号、密码可在机房向孟德超老师询问。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9483.aspx" target="_self" title="标题：关于组织参加2018年全国青少年禁毒知识竞赛活动的通知&#xD;点击数：16588&#xD;发表时间：18年12月10日">关于组织参加2018年全国青少年禁毒知识竞赛活动的通知</a>[ 12-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9509.aspx" target="_self" title="标题：关于禁毒平台以及安全平台的作业要求通知&#xD;点击数：90156&#xD;发表时间：18年12月13日">关于禁毒平台以及安全平台的作业要求通知</a>[ 12-13 ]</div>
                        </div>
                    </div>
