...
<head>
    ...
    <title>体育、艺术组外出考察通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">体育、艺术组外出考察通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9436"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9436},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9436";
     ...
     <FONT size=4>今天体育、美术、音乐组外出考察，相关班级体育课、美术课、音乐课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9422.aspx" target="_self" title="标题：体育课改自修通知&#xD;点击数：338&#xD;发表时间：18年11月28日">体育课改自修通知</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9437.aspx" target="_self" title="标题：高考报名广播培训通知&#xD;点击数：372&#xD;发表时间：18年11月30日">高考报名广播培训通知</a>[ 11-30 ]</div>
                        </div>
                    </div>
