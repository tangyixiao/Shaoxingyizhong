...
<head>
    ...
    <title>高二、高三班主任(有关会考报名）：--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二、高三班主任(有关会考报名）：</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=504"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:504},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=504";
     ...
     <DIV>高二、高三班主任：</DIV>
<DIV>我省2010年普通高中会考报名时间和考试日期已经确定。根据安排，普通高中会考报名日期为2009年11月2日至6日，学生在就读学校集体报名。考试时间为2010年1月13日至14日。高二考试科目为：物理、化学、英语（含听力）。高三考试科目为：语文、数学、自选综合。其中“自选综合”作为选考科目，学生可以自由选择参加或不参加该科目会考；试卷分“人文与社会领域”（文科选修1A）和“科学领域” （理科选修1A），学生可以自由选择一类参加考试；该科目会考成绩记入学生综
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/502.aspx" target="_self" title="标题：2009学年第一学期高三期中考试场安排&#xD;点击数：260&#xD;发表时间：09年11月03日">2009学年第一学期高三期中考试场安排</a>[ 11-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/506.aspx" target="_self" title="标题：关于参加2009年市属中学田径运动会的通知&#xD;点击数：357&#xD;发表时间：09年11月04日">关于参加2009年市属中学田径运动会的通知</a>[ 11-04 ]</div>
                        </div>
                    </div>
