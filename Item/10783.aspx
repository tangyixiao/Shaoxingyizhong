...
<head>
    ...
    <title>关于艺术节现场书画比赛延期的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于艺术节现场书画比赛延期的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>关于现场书画比赛延期的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2019年10月25日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10783"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10783},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10783";
     ...
     <P>现场书画比赛延期至11月11日举行，细则另行通知，请参赛同学及时关注。<BR></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10781.aspx" target="_self" title="标题：失物招领&#xD;点击数：161&#xD;发表时间：19年10月24日">失物招领</a>[ 10-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10786.aspx" target="_self" title="标题：10月25日跑操比赛情况反馈&#xD;点击数：264&#xD;发表时间：19年10月25日">10月25日跑操比赛情况反馈</a>[ 10-25 ]</div>
                        </div>
                    </div>
