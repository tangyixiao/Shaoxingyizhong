...
<head>
    ...
    <title>高一年级今天下午第三节调课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一年级今天下午第三节调课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=218"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:218},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=218";
     ...
     <P>    <FONT size=4>由于高一年级<FONT face=Verdana>今天下午</FONT>军训会操排练，下午第三节不能上课。有课老师请在其它自修课补上。</FONT></P>
<P>                       
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/215.aspx" target="_self" title="标题：各竞赛指导老师&#xD;点击数：768&#xD;发表时间：09年09月07日">各竞赛指导老师</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/221.aspx" target="_self" title="标题：9月12日英语听力高考播放组、监听组、领队组名单&#xD;点击数：535&#xD;发表时间：09年09月07日">9月12日英语听力高考播放组、监听组、领队组名单</a>[ 09-07 ]</div>
                        </div>
                    </div>
