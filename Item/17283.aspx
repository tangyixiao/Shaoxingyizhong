...
<head>
    ...
    <title>高三首考及名校协作体分析会--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三首考及名校协作体分析会</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17283"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17283},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17283";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 20px; background-color: rgb(255, 255, 255);">今天（2月14日）下午第8节课在树兰楼三楼会议室二召开高三首考及名校协作体考试分析会，请各位高三相关任课老师准时参加。<span style="font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 20px; background-color: rgb(255, 255, 255); color: rgb(255, 0, 0);">请各备课组长准备好3-5分钟的交流发言。第8节课有课老师请上完课后赴会。</span></span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17280.aspx" target="_self" title="标题：2月14日高二通用技术停课通知&#xD;点击数：159&#xD;发表时间：23年02月13日">2月14日高二通用技术停课通知</a>[ 02-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17295.aspx" target="_self" title="标题：高二名校协作体分析会&#xD;点击数：245&#xD;发表时间：23年02月15日">高二名校协作体分析会</a>[ 02-15 ]</div>
                        </div>
                    </div>
