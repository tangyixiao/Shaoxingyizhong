...
<head>
    ...
    <title>请交述职报告的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2041"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2041},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2041";
     ...
     <P>       还有下列领导没交述职报告：王柏根、陈银伟、俞渭鑫、陈连原、张宗旺、桑美娟、邱静娥、何珠芳、胡唯亚。请速上传。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2039.aspx" target="_self" title="标题：提醒&#xD;点击数：884&#xD;发表时间：10年06月12日">提醒</a>[ 06-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2042.aspx" target="_self" title="标题：2010年申报高级职称的老师论文公示&#xD;点击数：700&#xD;发表时间：10年06月13日">2010年申报高级职称的老师论文公示</a>[ 06-13 ]</div>
                        </div>
                    </div>
