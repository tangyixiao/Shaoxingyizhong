...
<head>
    ...
    <title>大扫除的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18492"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18492},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18492";
     ...
     <p>各班级：</p><p style="text-indent:28px">高二、高三的周一的大扫除，高一的周二大扫除照常进行，时间是劳动课时间。大家尤其注意桌内的垃圾清理，门口雨伞的整理，台面杂物，长期不用的多余试卷的清除，桌面不文明的涂画的清除，垃圾桶的清洗等，干干净净迎接即将到来的国庆日。</p><p style="text-indent:28px"> </p><p style="text-indent:504px">德育处</p><p><span style="font-size:14px;font-family: 等线">                                                                                                                            2023</span><span style="font-size:14px;font-family:等线">年9月25日</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18488.aspx" target="_self" title="标题：9月22、23日班级一日考核&#xD;点击数：95&#xD;发表时间：23年09月25日">9月22、23日班级一日考核</a>[ 09-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18502.aspx" target="_self" title="标题：9.25班级一日考核&#xD;点击数：102&#xD;发表时间：23年09月26日">9.25班级一日考核</a>[ 09-26 ]</div>
                        </div>
                    </div>
