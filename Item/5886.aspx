...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5886"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5886},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5886";
     ...
     高一（14）班祝嘉君同学在操场捡到运动裤一条，特此表扬，并望失主能及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5885.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：76&#xD;发表时间：16年11月10日">表扬与失物招领</a>[ 11-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5891.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：80&#xD;发表时间：16年11月11日">表扬与失物招领</a>[ 11-11 ]</div>
                        </div>
                    </div>
