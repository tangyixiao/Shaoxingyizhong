...
<head>
    ...
    <title>关于学科特色课程群开发交流会议（续）的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于学科特色课程群开发交流会议（续）的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>关于学科特色课程群开发交流会议（续）的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年01月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6299"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6299},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6299";
     ...
     <P> </P>
<P>定于今天下午在行政楼三楼会议室召开学科特色课程群开发交流会议（续），第6节课开始交流，请尚未进行交流的课程开发负责老师准时到场。有课的老师请提早安排好。具体名单如下：</P>
<P>王晶晶、谢静超、顾向晖、黄金裕、叶建映、王姗姗、朱时妙、张叶、苏卫军、王一行、生物学科组课程开发团队</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6268.aspx" target="_self" title="标题：关于师训平台项目评价的通知&#xD;点击数：317&#xD;发表时间：17年01月04日">关于师训平台项目评价的通知</a>[ 01-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6315.aspx" target="_self" title="标题：关于本学期青年教师考评的通知&#xD;点击数：355&#xD;发表时间：17年01月11日">关于本学期青年教师考评的通知</a>[ 01-11 ]</div>
                        </div>
                    </div>
