...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14996"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14996},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14996";
     ...
     <p>兹定于本周三下午第三节课召开高三年级名校协作体成绩分析会，会议地点在树兰楼三楼会议室二，请高三高考科目教师准时参加。
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14985.aspx" target="_self" title="标题：高三技术走班停课通知&#xD;点击数：149&#xD;发表时间：22年02月22日">高三技术走班停课通知</a>[ 02-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15008.aspx" target="_self" title="标题：“北斗杯”组长会议通知&#xD;点击数：180&#xD;发表时间：22年02月24日">“北斗杯”组长会议通知</a>[ 02-24 ]</div>
                        </div>
                    </div>
