...
<head>
    ...
    <title>关于大课间与课外活动的纪律--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于大课间与课外活动的纪律</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3111"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3111},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3111";
...
<P><FONT size=4>     近来发现大课间和课外活动长跑时，有许多同学不认真参加，严重影响锻炼效果，为严肃纪律，望班主任加强教育、督促、管理，班主任可以请各班长做好点名工作，及时向班主任汇报出操情况，确保活动的有效开展。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3110.aspx" target="_self" title="标题：值周检查情况汇总（12月21日星期二）&#xD;点击数：306&#xD;发表时间：10年12月22日">值周检查情况汇总（12月21日星期二）</a>[ 12-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3118.aspx" target="_self" title="标题：“青春与梦想”舞蹈比赛结果&#xD;点击数：667&#xD;发表时间：10年12月22日">“青春与梦想”舞蹈比赛结果</a>[ 12-22 ]</div>
                        </div>
                    </div>
