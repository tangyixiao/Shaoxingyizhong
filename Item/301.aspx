...
<head>
    ...
    <title>修订电话号码本的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">修订电话号码本的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月18日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=301"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:301},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=301";
     ...
     <P><FONT size=5>各位教职工：</FONT></P>
<P><FONT size=5>     由于本学期人员的变化，需要修订电话号码簿，请处室长与年级长负责督促老师把电话号码改正确，并希望在下周三之前完成。</FONT></P>
<P>      电话号码修改处,注意修改后保存：<IMG src="/Shaoxingyizhong/UploadFiles/UploadFiles/news/editor/sysimage/file/xls.gif" border=0><A href
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/296.aspx" target="_self" title="标题：运动兴趣小组招生&#xD;点击数：729&#xD;发表时间：09年09月17日">运动兴趣小组招生</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/305.aspx" target="_self" title="标题：关于教工会议的通知&#xD;点击数：548&#xD;发表时间：09年09月21日">关于教工会议的通知</a>[ 09-21 ]</div>
                        </div>
                    </div>
