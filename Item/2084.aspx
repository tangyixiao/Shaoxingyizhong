...
<head>
    ...
    <title>高二班主任：拿三项考试报名确认表--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二班主任：拿三项考试报名确认表</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2084"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2084},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2084";
     ...
     <P>高二班主任：请在今天中午到教学处拿三项考试报名确认表，因为要核对班级学生（有个别报名时选错班级）请班主任亲自到教学处拿。拿到后请马上发给学生校对，确认签名。如有错误或漏报到教学处吴老师处改正。校对单19日中午放学前各班收齐后交教学处。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2081.aspx" target="_self" title="标题：关于高一高二模块成绩录入的通知&#xD;点击数：423&#xD;发表时间：10年06月18日">关于高一高二模块成绩录入的通知</a>[ 06-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2088.aspx" target="_self" title="标题：高三班主任：明天（19日）发资料的地点&#xD;点击数：373&#xD;发表时间：10年06月18日">高三班主任：明天（19日）发资料的地点</a>[ 06-18 ]</div>
                        </div>
                    </div>
