...
<head>
    ...
    <title>请高一、高二班长今天下午领取“思想品德考核表”--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">请高一、高二班长今天下午领取“思想品德考核表”</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4097"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4097},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4097";
...
<P><FONT size=4>请通知高一、高二各班班长今天下午第三、四节课来音美办公室领取“思想品德考核表”。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4096.aspx" target="_self" title="标题：高一、高二校级“文明中学生”、“三好学生”、“优秀学生干部”评选工作的通知&#xD;点击数：838&#xD;发表时间：11年06月01日">高一、高二校级“文明中学生”、“三好学生”、“优秀学生干部…</a>[ 06-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4102.aspx" target="_self" title="标题：高一、高二红十字救护知识培训的通知&#xD;点击数：666&#xD;发表时间：11年06月02日">高一、高二红十字救护知识培训的通知</a>[ 06-02 ]</div>
                        </div>
                    </div>
