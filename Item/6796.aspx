...
<head>
    ...
    <title>重点高校三位一体、自主招生面试培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">重点高校三位一体、自主招生面试培训通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年04月22日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6796"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6796},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6796";
     ...
     <P><FONT size=4>各位高三同学：为保证培训质量及师资水平，清华 紫光与学校协商，决定重点高校三位一体、自主招生面试培训课程，在4月30日、5月1日、5月13日下午及晚上开展。请相关同学作好准备。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6795.aspx" target="_self" title="标题：“中学生标准学术能力测试”校荐通知&#xD;点击数：201&#xD;发表时间：17年04月21日">“中学生标准学术能力测试”校荐通知</a>[ 04-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6799.aspx" target="_self" title="标题：历史教研活动开课通知&#xD;点击数：168&#xD;发表时间：17年04月24日">历史教研活动开课通知</a>[ 04-24 ]</div>
                        </div>
                    </div>
