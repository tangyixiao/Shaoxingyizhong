...
<head>
    ...
    <title>关于2009年度绍兴市教育学会优秀教科研论文评比的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于2009年度绍兴市教育学会优秀教科研论文评比的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=325"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:325},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=325";
...
<DIV><FONT size=4>     为进一步深化群众性的教育教学研究，展示和交流广大教师、会员的研究成果，绍兴市教育学会定于11月份举行2009年度优秀教科研论文评比。现将有关要求传达如下：</FONT></DIV>
<DIV><FONT size=4>1、参加评奖的论文必须是教师个人自己独立撰写，且符合本次论文评比的主题。论文字数限在5000字以内。</FONT></DIV>
<D
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/324.aspx" target="_self" title="标题：关于“高考征文”和“优秀经验总结报告评选”的补充通知&#xD;点击数：403&#xD;发表时间：09年09月25日">关于“高考征文”和“优秀经验总结报告评选”的补充通知</a>[ 09-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/331.aspx" target="_self" title="标题：关于申报2010年省级规划课题的通知&#xD;点击数：403&#xD;发表时间：09年09月26日">关于申报2010年省级规划课题的通知</a>[ 09-26 ]</div>
                        </div>
                    </div>
