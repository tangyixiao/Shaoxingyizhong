...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8178"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8178},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8178";
     ...
     <P>因天气原因，今日升旗仪式暂停。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8163.aspx" target="_self" title="标题：大扫除通知&#xD;点击数：165&#xD;发表时间：18年03月14日">大扫除通知</a>[ 03-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8181.aspx" target="_self" title="标题：通知两则&#xD;点击数：506&#xD;发表时间：18年03月19日">通知两则</a>[ 03-19 ]</div>
                        </div>
                    </div>
