...
<head>
    ...
    <title>高一晚自修（3.4-3.13）--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一晚自修（3.4-3.13）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22794"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22794},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22794";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2026/3/202603040925426242.png" style="max-width: 100%; " title="202603040925426242.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22739.aspx" target="_self" title="标题：高一晚自修（2.2-2.4）&#xD;点击数：63&#xD;发表时间：26年01月30日">高一晚自修（2.2-2.4）</a>[ 01-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22798.aspx" target="_self" title="标题：高一3月回头考时间安排及考试范围（3.13-3.14）&#xD;点击数：215&#xD;发表时间：26年03月04日">高一3月回头考时间安排及考试范围（3.13-3.14）</a>[ 03-04 ]</div>
                        </div>
                    </div>
