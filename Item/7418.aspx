...
<head>
    ...
    <title>高三任课教师会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7418"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7418},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7418";
     ...
     <P><FONT size=4>10月9日（明天）下午第3、4节在行政楼三楼会议室二，召开全体高三任课教师会议，请互相通知，准时与会。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7417.aspx" target="_self" title="标题：关于进行美术基础课训练的通知&#xD;点击数：238&#xD;发表时间：17年10月08日">关于进行美术基础课训练的通知</a>[ 10-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7420.aspx" target="_self" title="标题：10.9早学早读抽检情况（第2次）&#xD;点击数：455&#xD;发表时间：17年10月09日">10.9早学早读抽检情况（第2次）</a>[ 10-09 ]</div>
                        </div>
                    </div>
