...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8335"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8335},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8335";
     ...
     <FONT size=4>4月11日高一政治组全体老师参加优质课评比活动，相关班级政治课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8333.aspx" target="_self" title="标题：心理教研活动通知&#xD;点击数：164&#xD;发表时间：18年04月10日">心理教研活动通知</a>[ 04-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8336.aspx" target="_self" title="标题：关于高三学生停止借书的通知&#xD;点击数：308&#xD;发表时间：18年04月11日">关于高三学生停止借书的通知</a>[ 04-11 ]</div>
                        </div>
                    </div>
