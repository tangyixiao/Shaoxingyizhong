...
<head>
    ...
    <title>学校H1N1预防工作分工与措施要求--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">学校H1N1预防工作分工与措施要求</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年08月27日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=157"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:157},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=157";
     ...
     <DIV align=center><B>学校</B><B>H1N1</B><B>预防工作分工与措施要求</B><B></B></DIV>
<DIV align=center> </DIV>
<DIV>为加强学校甲型H1N1流感防控工作，防范秋季开学后甲型H1N1流感在学校内的暴发流行，维护正常教学秩序，保障广大师生员工的身体健康和生命安全，特提出以下职责分工和措施要求：</DIV>
<DIV>一、医务室：</DIV>
<DIV>积极参加业务培训与自我学习，提高甲型H1N1流感防控能力；</DI
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/152.aspx" target="_self" title="标题：关于组织绍兴市区中小学教师专业阅读考试的通知&#xD;点击数：1234&#xD;发表时间：09年08月27日">关于组织绍兴市区中小学教师专业阅读考试的通知</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/162.aspx" target="_self" title="标题：关于教师参加心理健康教育自考报考、领证的通知&#xD;点击数：669&#xD;发表时间：09年08月28日">关于教师参加心理健康教育自考报考、领证的通知</a>[ 08-28 ]</div>
                        </div>
                    </div>
