...
<head>
    ...
    <title>温馨教室、寝室布置与今天下午大扫除的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">温馨教室、寝室布置与今天下午大扫除的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>温馨教室、寝室布置与今天下午大扫除的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年02月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3400"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3400},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3400";
...
<P><FONT size=4>1．温馨教室：请各班在上学期的基础上，组织学生重新布置一下本班教室，下周将进行检查评比。</FONT></P>
<P><FONT size=4>2．温馨寝室：请通知本班住校生利用一周的时间对寝室进行美化，德育处择时进行评比。</FONT></P>
<P><FONT size=4>3．因雨，今天下午大扫除重点搞好教室内的卫生（如：黑板报下的台面、讲台电脑、清理教室门上的考试座位表等）。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3399.aspx" target="_self" title="标题：卫生委员会议的通知&#xD;点击数：473&#xD;发表时间：11年02月28日">卫生委员会议的通知</a>[ 02-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3405.aspx" target="_self" title="标题：全校班主任会议&#xD;点击数：495&#xD;发表时间：11年03月01日">全校班主任会议</a>[ 03-01 ]</div>
                        </div>
                    </div>
