...
<head>
    ...
    <title>高一高二住校生注意--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6364"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6364},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6364";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
            ...
            据住管处老师反映，高一高二住校生前天离校后寝室阳台上还有不少学生衣服（有一些新校服）没有收回去，因寒假举办信息学冬令营寝室全部要用，希望住校生今天中午把阳台上的衣服全部收回去（遗失后果自负）。烦请班主任帮忙说一下，谢谢！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6357.aspx" target="_self" title="标题：关于高一高二班主任工作的通知&#xD;点击数：117&#xD;发表时间：17年01月19日">关于高一高二班主任工作的通知</a>[ 01-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6368.aspx" target="_self" title="标题：关于高三班主任期末工作的通知&#xD;点击数：119&#xD;发表时间：17年01月20日">关于高三班主任期末工作的通知</a>[ 01-20 ]</div>
                        </div>
                    </div>
