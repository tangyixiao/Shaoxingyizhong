...
<head>
    ...
    <title>【模拟政协社】社团课通知--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17746"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17746},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17746";
     ...
     <p style="padding: 0px; margin-top: 0px; margin-bottom: 20px !important;">时间：4月26日（周三）中午12:30</p><p style="padding: 0px; margin-top: 0px; margin-bottom: 20px !important;">地点：2110教室</p><p style="padding: 0px; margin-top: 0px; margin-bottom: 20px !important;">要求：请各位社员务必与班主任请好假，携带纸笔，准备好提案内容，准时参加。</p><p style="padding: 0px; margin-top: 0px; margin-bottom: 20px !important;">                                                                                               2023年4月24日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17688.aspx" target="_self" title="标题：【模拟联合国】社团活动通知&#xD;点击数：61&#xD;发表时间：23年04月16日">【模拟联合国】社团活动通知</a>[ 04-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17771.aspx" target="_self" title="标题：【求真实验室】社团活动通知&#xD;点击数：80&#xD;发表时间：23年04月27日">【求真实验室】社团活动通知</a>[ 04-27 ]</div>
                        </div>
                    </div>
