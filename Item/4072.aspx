...
<head>
    ...
    <title>绍兴一中话剧社汇报演出预告--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中话剧社汇报演出预告</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：tw</span> <span>发布时间：2011年05月31日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4072"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4072},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4072";
     ...
     <P><SPAN style="FONT-FAMILY: 黑体; FONT-SIZE: 15pt; mso-hansi-font-family: 'Times New Roman'; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA"><FONT face=宋体><FONT size=3>    一中话剧社汇报演出《凰上枝头错成凤》即将上演。演出时间：6月1日下午第四节课，演出地点：报告厅。欢迎同学们观看！</FONT></FONT></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4050.aspx" target="_self" title="标题：检查通报&#xD;点击数：605&#xD;发表时间：11年05月27日">检查通报</a>[ 05-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4104.aspx" target="_self" title="标题：关于表彰2010学年优秀社团的通知&#xD;点击数：651&#xD;发表时间：11年06月02日">关于表彰2010学年优秀社团的通知</a>[ 06-02 ]</div>
                        </div>
                    </div>
