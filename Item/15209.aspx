...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15209"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15209},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15209";
     ...
     <p>请各班安全委员明天（周二）中午12:30分到4110阶梯教室开个短会，望相互通知，准时参加。
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15200.aspx" target="_self" title="标题：关于组织我校师生员工参加核酸抽检的通知&#xD;点击数：283&#xD;发表时间：22年03月21日">关于组织我校师生员工参加核酸抽检的通知</a>[ 03-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15222.aspx" target="_self" title="标题：关于各班安全委员递交晨、午、晚检表的提醒&#xD;点击数：106&#xD;发表时间：22年03月23日">关于各班安全委员递交晨、午、晚检表的提醒</a>[ 03-23 ]</div>
                        </div>
                    </div>
