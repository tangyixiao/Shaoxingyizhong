...
<head>
    ...
    <title>高三班主任请注意--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2248"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2248},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2248";
     ...
     <P>1.请各班今天下午组织学生对教室与每天的保干区进行一次大扫除;</P>
<P>2.今天开始值日班(高三(5)班)开始对"一日常规"进行检查,重点检查:卫生、纪律、自行车停放和胸卡佩戴等情况。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2231.aspx" target="_self" title="标题：关于新高一衔接教育综合考试的补充说明&#xD;点击数：436&#xD;发表时间：10年07月08日">关于新高一衔接教育综合考试的补充说明</a>[ 07-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2265.aspx" target="_self" title="标题：德育处三点提示&#xD;点击数：394&#xD;发表时间：10年08月23日">德育处三点提示</a>[ 08-23 ]</div>
                        </div>
                    </div>
