...
<head>
    ...
    <title>高中化学青年教师研究者联盟活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高中化学青年教师研究者联盟活动通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1172"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1172},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1172";
     ...
     <P>   1月8日9：00—16：00，在鲁迅中学举行高中化学青年教师研究者联盟活动，参加对象为全体高中化学研究者联盟成员，请相关老师安排好学校的教育教学工作，按时参加。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1166.aspx" target="_self" title="标题：1月5日（周二）高二物理会考模拟监考安排&#xD;点击数：582&#xD;发表时间：10年01月05日">1月5日（周二）高二物理会考模拟监考安排</a>[ 01-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1174.aspx" target="_self" title="标题：关于举办《语言、文化和未来世界》讲座的通知&#xD;点击数：543&#xD;发表时间：10年01月05日">关于举办《语言、文化和未来世界》讲座的通知</a>[ 01-05 ]</div>
                        </div>
                    </div>
