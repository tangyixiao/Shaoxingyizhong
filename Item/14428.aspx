...
<head>
    ...
    <title>【权益部】干事会议通知--团学动态-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14428"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14428},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14428";
     ...
     <p>请学生权益部高一成员（隔离班级除外）于11月17日（周三）中午12:25至行政楼3楼会议室（二）开膳管会议，随带纸笔，并提前向班级做好请假说明。</p><p style="text-align: right;">总务处 团委 学生权益部
2021年11月16日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14412.aspx" target="_self" title="标题：【宣传部】全体干事会议通知&#xD;点击数：35&#xD;发表时间：21年11月15日">【宣传部】全体干事会议通知</a>[ 11-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14507.aspx" target="_self" title="标题：【纪检部】干事会议通知&#xD;点击数：63&#xD;发表时间：21年11月25日">【纪检部】干事会议通知</a>[ 11-25 ]</div>
                        </div>
                    </div>
