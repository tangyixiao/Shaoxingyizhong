...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5836"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5836},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5836";
     ...
     有老师捡到饭卡一张，请失主及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5835.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：207&#xD;发表时间：16年11月01日">表扬与失物招领</a>[ 11-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5838.aspx" target="_self" title="标题：关于期中考试考风考纪要求&#xD;点击数：296&#xD;发表时间：16年11月02日">关于期中考试考风考纪要求</a>[ 11-02 ]</div>
                        </div>
                    </div>
