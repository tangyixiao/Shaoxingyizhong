...
<head>
    ...
    <title>关于运动会闭幕式的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10664"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10664},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10664";
     ...
     <P>  全校师生：         </P>
<P>         下午所有运动项目结束后，请高一高二全体学生把看台上所有东西整理好搬回教室，做好相关场地的卫生清洁工作。</P>
<P>          定于三点半准时举行运动会闭幕式。请全体班主任做好纪律、卫生、安全等组织工作，并组织本班学生提前15分钟入场，按照开幕式顺序站位。</P>
<P>            另外，请各班班长站在队伍前面，准备闭幕式领奖。</P>
<P>                                                                                   德育处、体育组</P>
<P>                                                                                     2019.10.7</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10662.aspx" target="_self" title="标题：9月“美丽教室”评比结果通告&#xD;点击数：308&#xD;发表时间：19年10月07日">9月“美丽教室”评比结果通告</a>[ 10-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10666.aspx" target="_self" title="标题：五校联考考风考纪要求&#xD;点击数：196&#xD;发表时间：19年10月07日">五校联考考风考纪要求</a>[ 10-07 ]</div>
                        </div>
                    </div>
