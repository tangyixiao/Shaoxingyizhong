...
<head>
    ...
    <title>关于认真学习“居民基本卫生防病知识”的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于认真学习“居民基本卫生防病知识”的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3916"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3916},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3916";
     ...
     <P><B style="mso-bidi-font-weight: normal"><SPAN style="FONT-SIZE: 16pt; FONT-FAMILY: 宋体"></SPAN></B> </P>
<P><SPAN style="FONT-SIZE: 16pt; FONT-FAMILY: 宋体"><FONT size=4>高一高二各班：</FONT></SPAN></P>
<P><SPAN style="FONT-SIZE: 16pt; FONT-FAMILY: 宋体"><FONT size=4>   “浙江省居民基本卫生防病知识考核题库”已经下发到各班，请各班组织学生</FONT></SPAN><FONT size=4>认真学习，下周德育处将组织相关考试。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3911.aspx" target="_self" title="标题：关于在高一高二开展“血脉同源，爱心共享”征文比赛活动的通知&#xD;点击数：629&#xD;发表时间：11年05月09日">关于在高一高二开展“血脉同源，爱心共享”征文比赛活动的通知</a>[ 05-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3921.aspx" target="_self" title="标题：5月10日学生校牌、迟到检查结果公布（四十九）&#xD;点击数：577&#xD;发表时间：11年05月10日">5月10日学生校牌、迟到检查结果公布（四十九）</a>[ 05-10 ]</div>
                        </div>
                    </div>
