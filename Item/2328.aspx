...
<head>
    ...
    <title>有关通知三则（紧急）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2328"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2328},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2328";
     ...
     <P>高一、高二、高三各班：</P>
<P>         1.还未上传校讯通电子汇总表的班级请抓紧时间，在明天放学前上传完毕，并把回执上交到德育处。</P>
<P>        2.还未领取<FONT size=4>贫困生的申请表的班级，请到德育处领取贫困生情况登记表。</FONT></P>
<P>        <FONT size=4>3.还未办理<SPAN style="FONT-FAMILY: 宋体; mso-bidi-font-size: 10.5pt; mso-ascii-font-family: &#718;&#805;; mso-hansi-font-family: &#718;&#805;">爱国主义教育卡的班级，请抓紧时间办理。</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2326.aspx" target="_self" title="标题：德育处通知&#xD;点击数：681&#xD;发表时间：10年09月01日">德育处通知</a>[ 09-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2338.aspx" target="_self" title="标题：教室卫生和课间操检查情况反馈&#xD;点击数：440&#xD;发表时间：10年09月02日">教室卫生和课间操检查情况反馈</a>[ 09-02 ]</div>
                        </div>
                    </div>
