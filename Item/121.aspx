...
<head>
    ...
    <title>中华赞诗词歌赋创作大赛--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">中华赞诗词歌赋创作大赛</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年08月19日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=121"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:121},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=121";
     ...
     <DIV>全校各班：</DIV>
<DIV>      为庆祝建国60周年，弘扬中华民族优秀文化，建设中华中族共有精神家园，推进社会主义核心价值体系建设，根据《绍兴市语言文字工作委员会  绍兴市教育局关于举办中华赞诗词歌赋创作大赛的通知》文件精神，学校决定举办中华赞诗词歌赋创作大赛。现将有关事项通知如下：</DIV>
<DIV>一．参赛对象</DIV>
<DIV>      全校学生</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/116.aspx" target="_self" title="标题：国旗下讲话主持人、宣讲员招聘启事&#xD;点击数：592&#xD;发表时间：09年08月18日">国旗下讲话主持人、宣讲员招聘启事</a>[ 08-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/123.aspx" target="_self" title="标题：各班主任请注意（关于安全等问题）&#xD;点击数：547&#xD;发表时间：09年08月20日">各班主任请注意（关于安全等问题）</a>[ 08-20 ]</div>
                        </div>
                    </div>
