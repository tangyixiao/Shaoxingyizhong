...
<head>
    ...
    <title>高一、高二各班--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=189"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:189},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=189";
     ...
     今天下午第四节班会课时间，在教室观看《用知识守护生命》，各班自行从公共文件夹——政教处下载。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/187.aspx" target="_self" title="标题：2009.9.1大扫除检查情况公布  &#xD;点击数：437&#xD;发表时间：09年09月02日">2009.9.1大扫除检查情况公布  </a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/190.aspx" target="_self" title="标题：各班主任请注意（大课间入场路线）&#xD;点击数：537&#xD;发表时间：09年09月02日">各班主任请注意（大课间入场路线）</a>[ 09-02 ]</div>
                        </div>
                    </div>
