...
<head>
    ...
    <title>6.4班级一日考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21592"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21592},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21592";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/6/202506111454191089.png" style="max-width: 100%; " title="202506111454191089.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21588.aspx" target="_self" title="标题：寻物启事二则（手串/手表）&#xD;点击数：142&#xD;发表时间：25年06月05日">寻物启事二则（手串/手表）</a>[ 06-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21593.aspx" target="_self" title="标题：6.5班级一日考核&#xD;点击数：36&#xD;发表时间：25年06月11日">6.5班级一日考核</a>[ 06-11 ]</div>
                        </div>
                    </div>
