...
<head>
    ...
    <title>高三英语课做练习--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=399"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:399},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=399";
     ...
     <P><FONT size=3>    10月14日（星期三），由于高三英语备课组参加教研活动，上午英语课做练习。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/398.aspx" target="_self" title="标题：部分语文课改自修&#xD;点击数：380&#xD;发表时间：09年10月13日">部分语文课改自修</a>[ 10-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/402.aspx" target="_self" title="标题：关于高一年级校本课程上课的通知&#xD;点击数：382&#xD;发表时间：09年10月14日">关于高一年级校本课程上课的通知</a>[ 10-14 ]</div>
                        </div>
                    </div>
