...
<head>
    ...
    <title>高三停课复习期间安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10202"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10202},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10202";
     ...
     <P><FONT size=4>各位高三老师：</FONT></P>
<P><FONT size=4>6月3日、4日停课复习期间，各任课老师按课表下班答疑，读背课、限时训练、小练习暂停，由学生自主复习。</FONT></P>
<P><FONT size=4>6月5日上午按课表正常上课。</FONT></P>
<P><FONT size=4>6月6日上午停课复习，各任课老师按周三课表下班答疑。下午学生按要求熟悉试场。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10192.aspx" target="_self" title="标题：2019年高考期间有关工作安排&#xD;点击数：737&#xD;发表时间：19年05月31日">2019年高考期间有关工作安排</a>[ 05-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10212.aspx" target="_self" title="标题：高三班主任会议通知&#xD;点击数：262&#xD;发表时间：19年06月04日">高三班主任会议通知</a>[ 06-04 ]</div>
                        </div>
                    </div>
