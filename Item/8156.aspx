...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8156"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8156},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8156";
     ...
     <P>有同学于昨天在体育馆器材处捡到圆通卡一张，请失主到德育处办公室（2114）领取。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8155.aspx" target="_self" title="标题：上周值周小结&#xD;点击数：164&#xD;发表时间：18年03月12日">上周值周小结</a>[ 03-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8158.aspx" target="_self" title="标题：班长、体育委员、劳动委员开会通知（有修改）&#xD;点击数：737&#xD;发表时间：18年03月13日">班长、体育委员、劳动委员开会通知（有修改）</a>[ 03-13 ]</div>
                        </div>
                    </div>
