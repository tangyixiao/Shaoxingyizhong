...
<head>
    ...
    <title>关于交住校生登记表的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于交住校生登记表的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3271"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3271},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3271";
     ...
     <P> </P>
<P><FONT size=4>还有下列班级没有交住校生登记表：</FONT></P>
<P><FONT size=4>高一（1）、（3）、（5）、（9）、（11）</FONT></P>
<P><FONT size=4>高三（2）、（8）</FONT></P>
<P><FONT size=4>请速交到德育处，谢谢配合。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3267.aspx" target="_self" title="标题：期末德育处主要工作安排&#xD;点击数：711&#xD;发表时间：11年01月18日">期末德育处主要工作安排</a>[ 01-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3272.aspx" target="_self" title="标题：关于做好期末考前教育与卫生工作的通知&#xD;点击数：503&#xD;发表时间：11年01月19日">关于做好期末考前教育与卫生工作的通知</a>[ 01-19 ]</div>
                        </div>
                    </div>
