...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7943"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7943},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7943";
...
<TBODY>
<TR>
<TD><FONT size=4><!--插入广告JS代码--></FONT></TD></TR></TBODY></TABLE><FONT size=4>蒋明老师<SPAN style="FONT-SIZE: 15pt; FONT-FAMILY: 宋体; COLOR: rgb(0,0,0); mso-spacerun: 'yes'; mso-font-kerning: 0.0000pt">捡到园通卡一张，请失主</SPAN><SPAN style="FONT-SIZE: 15pt; FONT-FAMILY: 宋体; COLOR: rgb(0,0,0); mso-spacerun: 'yes'; mso-font-kerning: 0.0000pt"><FONT face=宋体>及时来德育团委办公室（</FONT>2114）认领。</SPAN></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7942.aspx" target="_self" title="标题：三个年段同时跑操通知&#xD;点击数：331&#xD;发表时间：18年01月10日">三个年段同时跑操通知</a>[ 01-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7944.aspx" target="_self" title="标题：1月11号跑操情况反馈&#xD;点击数：250&#xD;发表时间：18年01月11日">1月11号跑操情况反馈</a>[ 01-11 ]</div>
                        </div>
                    </div>
