...
<head>
    ...
    <title>高一10月教学检测成绩分析会通知--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一10月教学检测成绩分析会通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22092"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22092},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22092";
     ...
     <p style="padding: 0px; margin-top: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background-color: rgb(255, 255, 255); margin-bottom: 20px !important;">各位高一任课老师：</p><p style="padding: 0px; margin-top: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background-color: rgb(255, 255, 255); margin-bottom: 20px !important;">      定于今天（10月20日）下午16:15在行政楼会议室（二）召开高一10月教学检测成绩分析会，请大家安排好工作，提前5分钟到会。请相互转告，谢谢大家！</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22033.aspx" target="_self" title="标题：高一晚自修值班（10.9-10.17）&#xD;点击数：109&#xD;发表时间：25年10月08日">高一晚自修值班（10.9-10.17）</a>[ 10-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22093.aspx" target="_self" title="标题：高一晚自修值班（10.19-10.24）&#xD;点击数：87&#xD;发表时间：25年10月20日">高一晚自修值班（10.19-10.24）</a>[ 10-20 ]</div>
                        </div>
                    </div>
