...
<head>
    ...
    <title>召开行政会议的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=826"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:826},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=826";
     ...
     <P><FONT face=楷体_GB2312 size=4><STRONG>各位行政会议成员：</STRONG></FONT></P>
<P><FONT face=楷体_GB2312 size=4><STRONG>    明天（周五）第三、四节课，在行政三楼，召开行政会议，请教学处、德学处、总务处、安全处、信息处、团委、各年级长等作好发言准备，发言时间控制在不超过4-6分钟。</STRONG></FONT></P>
<P><STRONG><FONT face=楷体_GB2312 size=4>                                   </FONT></STRONG></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/525.aspx" target="_self" title="标题：关于教代会的通知&#xD;点击数：540&#xD;发表时间：09年11月09日">关于教代会的通知</a>[ 11-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/835.aspx" target="_self" title="标题：关于教工会议的通知&#xD;点击数：537&#xD;发表时间：09年12月03日">关于教工会议的通知</a>[ 12-03 ]</div>
                        </div>
                    </div>
