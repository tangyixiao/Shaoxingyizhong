...
<head>
    ...
    <title>关于市直班主任培训日期调整的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于市直班主任培训日期调整的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12004"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12004},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12004";
     ...
     <P style="MARGIN: 0pt" class=MsoNormal><SPAN style="FONT-FAMILY: 微软雅黑; BACKGROUND: rgb(255,255,255); COLOR: rgb(17,31,44); FONT-SIZE: 10.5pt; mso-spacerun: 'yes'; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0000pt; mso-shading: rgb(255,255,255)"><FONT face=微软雅黑>各位市直班主任培训参训老师，原定于</FONT>10月20-21日（周二、三）的市直班主任培训，因故调整为10月21—22日（周三、四）举行，培训地点由阳明中学行政楼五楼会议室改为阳明中学多功能厅（体育馆南面三楼），请于21日上午8：30前报到。由此带来的不便，请谅解。</SPAN><SPAN style="FONT-FAMILY: Calibri; FONT-SIZE: 10.5pt; mso-spacerun: 'yes'; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0000pt; mso-fareast-font-family: 宋体"><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12001.aspx" target="_self" title="标题：关于重申规范穿着校服的通告&#xD;点击数：3148&#xD;发表时间：20年10月20日">关于重申规范穿着校服的通告</a>[ 10-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12006.aspx" target="_self" title="标题：博雅大讲堂（高一）&#xD;点击数：400&#xD;发表时间：20年10月21日">博雅大讲堂（高一）</a>[ 10-21 ]</div>
                        </div>
                    </div>
