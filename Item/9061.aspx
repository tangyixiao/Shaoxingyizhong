...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9061"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9061},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9061";
...
<P><FONT color=#ff0000 size=4>提醒：<STRONG>教室南边窗户积灰</STRONG>、教室内开关、墙面上的白漆请清理干净。</FONT></P>
<P align=right><FONT size=4>德育处</FONT></P>
<P align=right><FONT size=4>2018.09.17</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9060.aspx" target="_self" title="标题：高一各班文娱委员开会通知&#xD;点击数：167&#xD;发表时间：18年09月17日">高一各班文娱委员开会通知</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9067.aspx" target="_self" title="标题：大扫除通知&#xD;点击数：122&#xD;发表时间：18年09月18日">大扫除通知</a>[ 09-18 ]</div>
                        </div>
                    </div>
