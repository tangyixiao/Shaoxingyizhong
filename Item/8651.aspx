...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8651"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8651},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8651";
     ...
     高一年段各班请注意，周三（今天）下午第四节劳动课大扫除照常进行，值周班于下课前10分钟即时检查，请大家按要求打扫
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8650.aspx" target="_self" title="标题：高三毕业典礼筹备协调会议&#xD;点击数：491&#xD;发表时间：18年05月30日">高三毕业典礼筹备协调会议</a>[ 05-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8653.aspx" target="_self" title="标题：“文明寝室”表彰公告&#xD;点击数：395&#xD;发表时间：18年05月31日">“文明寝室”表彰公告</a>[ 05-31 ]</div>
                        </div>
                    </div>
