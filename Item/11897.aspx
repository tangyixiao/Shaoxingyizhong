...
<head>
    ...
    <title>【求真实验室】关于参加入社考试的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">【求真实验室】关于参加入社考试的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11897"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11897},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11897";
     ...
     <P>请全体报名加入求真实验室的同学于<FONT color=#ff0000>9月28日（周一）12:10</FONT>至<FONT color=#ff0000>亚泉楼（实验楼）一楼</FONT>（根据现场指引至具体教室）参加考试。</P>
<P>    注：高一实行开卷考，请高一同学带好必修一化学书。</P>
<P>    求真实验室将以本次考试成绩为依据，择优录取。</P>
<P align=right>校团委<BR>求真实验室<BR>2020年9月25日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11896.aspx" target="_self" title="标题：关于团学联干事招新面试的通知&#xD;点击数：294&#xD;发表时间：20年09月25日">关于团学联干事招新面试的通知</a>[ 09-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11910.aspx" target="_self" title="标题：广电部全体成员会议通知&#xD;点击数：201&#xD;发表时间：20年09月26日">广电部全体成员会议通知</a>[ 09-26 ]</div>
                        </div>
                    </div>
