...
<head>
    ...
    <title>女教工＂3.8＂节春游通知--工会-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_32/Index.aspx" target="_self">工会</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">女教工＂3.8＂节春游通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15081"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15081},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15081";
     ...
     <p>     学校决定3月12日(星期六)组织女教工去平水玫瑰山庄踏青过＂3.8＂节，有意愿参加的女教工向工会小组长报名，要求写上：姓名、身份证号码、联系电话，工会组长下星期二放学前（报名截止）把报名表交给朱玛莉老师（本次活动领队）。
     上车第一站9：30学校西门，第二站10：00阳明中学门口，下午3：30返回，高三有课女教师自行调好课。
              绍兴一中工会  2022／3／3</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14781.aspx" target="_self" title="标题：文明办公室检查通知&#xD;点击数：178&#xD;发表时间：21年12月29日">文明办公室检查通知</a>[ 12-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15180.aspx" target="_self" title="标题：工会医疗保险报销提醒&#xD;点击数：111&#xD;发表时间：22年03月17日">工会医疗保险报销提醒</a>[ 03-17 ]</div>
                        </div>
                    </div>
