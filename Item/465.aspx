...
<head>
    ...
    <title>关于各处室报刊订阅的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于各处室报刊订阅的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=465"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:465},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=465";
     ...
     <DIV align=center>关于各处室报刊订阅的通知</DIV>
<DIV>    2010年已征订了下列报刊，放于图书馆，需要时可到图书馆借阅，不再另行征订，有特殊需要请向校长申请。</DIV>
<TABLE cellSpacing=0 cellPadding=0 width=228 align=left border=0>
<TBODY>
<TR>
<TD vAlign=bottom width=72>
<DIV align=center><B>代号</B></D
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/464.aspx" target="_self" title="标题：2009年参加市属中学田径运动会名单公示&#xD;点击数：559&#xD;发表时间：09年10月27日">2009年参加市属中学田径运动会名单公示</a>[ 10-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/473.aspx" target="_self" title="标题：关于开展爱心助残捐赠活动的通知&#xD;点击数：538&#xD;发表时间：09年10月28日">关于开展爱心助残捐赠活动的通知</a>[ 10-28 ]</div>
                        </div>
                    </div>
