...
<head>
    ...
    <title>高三回头考试要求与日程安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三回头考试要求与日程安排</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年02月14日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3316"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3316},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3316";
     ...
     <P>                                  高三年级回头考试要求与日程安排</P>
<P>一、试题形式、分值、考试用时同高考；</P>
<P>二、备课组长负责出好试卷，要求质量高，无差错，难度系数0.7左右。自选考试各备课组长把自己学科的两个题目交给张小娟老师组卷，文综（政、史、地）交给王法新老师组卷，理综（物、化、生）交给黄伟中老师组卷。试卷模板在教学处公共文件夹中，2月21日前把试卷交给章其炎老师；</P>
<P>三、考试时间安排在2月24、25、26日，具体时间与监考安排另行通知。</P>
<P>                                                            教学处  2011/02/14</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3313.aspx" target="_self" title="标题：高三IB选修走班课程通知：&#xD;点击数：551&#xD;发表时间：11年02月12日">高三IB选修走班课程通知：</a>[ 02-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3317.aspx" target="_self" title="标题：作业文印通知&#xD;点击数：489&#xD;发表时间：11年02月16日">作业文印通知</a>[ 02-16 ]</div>
                        </div>
                    </div>
