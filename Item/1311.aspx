...
<head>
    ...
    <title>各班主任请注意（有关自行车停放）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班主任请注意（有关自行车停放）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>各班主任请注意（有关自行车停放）</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年02月01日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1311"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1311},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1311";
     ...
     <P>全校各班主任：</P>
<P>     由于建造宿舍需要，自行车棚必须移位至网球场，请各位告知本班学生把自行车停入网球场内。由于改造工作还没有竣工，所以暂时可以不按照班级顺序停放，但是必须做到停放整齐、有序，同时提醒学生注意进出安全。</P>
<P>                                                                                 德育处</P>
<P>                                                                                  2010.2.1</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1310.aspx" target="_self" title="标题：关于试场卫生的通知&#xD;点击数：1369&#xD;发表时间：10年01月30日">关于试场卫生的通知</a>[ 01-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1322.aspx" target="_self" title="标题：休业式座位安排&#xD;点击数：527&#xD;发表时间：10年02月03日">休业式座位安排</a>[ 02-03 ]</div>
                        </div>
                    </div>
