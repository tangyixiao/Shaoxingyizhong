...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6123"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6123},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6123";
     ...
     <P>         今天中午12：30在三号教学楼（高三）101教室召开各班班长会议，布置有关综合素质评价事项，请各班班长务必准时参加。</P>
<P>                                                                         德育处、教学处</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6122.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：70&#xD;发表时间：16年12月14日">大课间操暂停通知</a>[ 12-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6124.aspx" target="_self" title="标题：关于校园文化艺术节开幕式通知（有修改）&#xD;点击数：869&#xD;发表时间：16年12月14日">关于校园文化艺术节开幕式通知（有修改）</a>[ 12-14 ]</div>
                        </div>
                    </div>
