...
<head>
    ...
    <title>“学生校长助理”决选名单及面试通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">“学生校长助理”决选名单及面试通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7963"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7963},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7963";
     ...
     <P>经各方推荐和团委审核，下列同学进入“学生校长助理”决选名单：</P>
<P>110方泽权<BR>114陈  亮<BR>118张泽宇<BR>118宋锦涛<BR>205汪书楠</P>
<P>请上述同学做好决选准备，于17日（周三）中午12:35至教学楼2112参加面试考核。校团委将邀请教师代表、学生干部代表、普通学生代表组成评委团，并根据候选人综合表现打分排名确定最终的“学生校长助理”人选。</P>
<P align=right>校团委<BR>1月16日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7962.aspx" target="_self" title="标题：团学联、社团干部“工作之星”推荐名单公示（有修改）&#xD;点击数：351&#xD;发表时间：18年01月16日">团学联、社团干部“工作之星”推荐名单公示（有修改）</a>[ 01-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7977.aspx" target="_self" title="标题：关于团校上课及布置结业考试事宜的通知&#xD;点击数：238&#xD;发表时间：18年01月18日">关于团校上课及布置结业考试事宜的通知</a>[ 01-18 ]</div>
                        </div>
                    </div>
