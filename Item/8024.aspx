...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8024"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8024},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8024";
     ...
     <P>高二，高三年段各班请注意，周一（今天）下午第四节劳动课大扫除照常进行，本周为单周，高三自修教室由奇数班级打扫，德育处于下课前10分钟即时检查，请大家按要求打扫（<FONT color=#ff0000>地面清洁，垃圾桶清理干净，按要求分类套好垃圾袋</FONT>）。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8020.aspx" target="_self" title="标题：升旗仪式暂停通知&#xD;点击数：141&#xD;发表时间：18年01月29日">升旗仪式暂停通知</a>[ 01-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8025.aspx" target="_self" title="标题：上周值周小结&#xD;点击数：143&#xD;发表时间：18年01月29日">上周值周小结</a>[ 01-29 ]</div>
                        </div>
                    </div>
