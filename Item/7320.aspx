...
<head>
    ...
    <title>中巴车运行通知二则--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">中巴车运行通知二则</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>中巴车运行通知二则</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年09月15日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7320"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7320},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7320";
     ...
     <P>                            中巴车运行通知二则</P>
<P>     1.由于乘坐人数和司机等的运行成本，学校暂不进行中巴车周六早晚的接送，由此给一些老师带来的不便,敬请谅解。</P>
<P>     2。下星期一（9月18日），城东线中巴车因为高三英语组外出教研活动，暂停接送，星期二照常接送。</P>
<P>   以上二则，请相互转告，谢谢。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7317.aspx" target="_self" title="标题：集体照拍摄注意事项&#xD;点击数：418&#xD;发表时间：17年09月15日">集体照拍摄注意事项</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7325.aspx" target="_self" title="标题：教工大会通知&#xD;点击数：325&#xD;发表时间：17年09月18日">教工大会通知</a>[ 09-18 ]</div>
                        </div>
                    </div>
