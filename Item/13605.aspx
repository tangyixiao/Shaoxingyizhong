...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13605"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13605},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13605";
     ...
     <p>    社团学年考核之总结评比，于<span style="color: rgb(255, 0, 0);">6月11日（周五）中午12:30</span>正式开始，地点<span style="color: rgb(255, 0, 0);">2110</span>教室。请各社团负责人提前将交流PPT/视频等上传至公共文件夹“团委 - 0金笛 - 社团联社团 - 2020学年社团考核交流评比”。</p><p>①12:25到场，抽签确定交流顺序，每个社团领取一张评分表；</p><p>②12:30正式开始，各社团负责人按顺序进行交流分享，并给其他社团的交流分享评分（互评，本社团留空、不打分）；</p><p>③每个社团交流分享时间不超过3分钟；</p><p>④社团联合会成员每人一张评分表；</p><p>⑤要求所有参与评分的人员公正、客观。</p><p>    请各位负责人带笔参加。请社团联合会的干部、干事负责组织好交流评比全程。</p><p style="text-align: right;">校团委
2021年6月11日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13586.aspx" target="_self" title="标题：关于进行2020学年第2学期团支部工作考核的通知&#xD;点击数：231&#xD;发表时间：21年06月04日">关于进行2020学年第2学期团支部工作考核的通知</a>[ 06-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13606.aspx" target="_self" title="标题：团支部学期考核-交流展示通知&#xD;点击数：257&#xD;发表时间：21年06月11日">团支部学期考核-交流展示通知</a>[ 06-11 ]</div>
                        </div>
                    </div>
