...
<head>
    ...
    <title>中科大招生宣讲会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6342"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6342},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6342";
     ...
     <FONT size=4>今天中午12：30中科大招生老师来我校进行招生宣讲，请有兴趣的学生到行政楼5楼会议室参加。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6341.aspx" target="_self" title="标题：期末试卷分析安排（有修改）&#xD;点击数：1273&#xD;发表时间：17年01月16日">期末试卷分析安排（有修改）</a>[ 01-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6344.aspx" target="_self" title="标题：高三期末考试试场编排和监考安排&#xD;点击数：1004&#xD;发表时间：17年01月17日">高三期末考试试场编排和监考安排</a>[ 01-17 ]</div>
                        </div>
                    </div>
