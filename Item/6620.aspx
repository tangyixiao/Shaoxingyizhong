...
<head>
    ...
    <title>免费论文、期刊、图书资源信息--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">免费论文、期刊、图书资源信息</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>免费论文、期刊、图书资源信息</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年03月24日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6620"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6620},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6620";
     ...
     <P> </P>
<P>各位教师：</P>
<P><BR>为了充实资源，市电教馆在原中国知网基础教育资源总库（含电子期刊、博硕论文、报纸）的基础上又新增雅昌艺术图书和CNKI电子工具书二大电子图书资源，欢迎大家访问使用。访问入口：从绍兴教育网网站导航栏“教育资源”下拉菜单链接。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6611.aspx" target="_self" title="标题：关于青年教师二轮比武相关事项的说明&#xD;点击数：217&#xD;发表时间：17年03月22日">关于青年教师二轮比武相关事项的说明</a>[ 03-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6626.aspx" target="_self" title="标题：高一班长领取选课材料及选修课开始选课的通知&#xD;点击数：240&#xD;发表时间：17年03月24日">高一班长领取选课材料及选修课开始选课的通知</a>[ 03-24 ]</div>
                        </div>
                    </div>
