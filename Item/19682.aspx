...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19682"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19682},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19682";
     ...
     <p><span style="font-size: 18px;">明天（ 周二）通用技术组教师全组外出参加市直教研活动，相关通用技术课改自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19681.aspx" target="_self" title="标题：政治教研活动通知&#xD;点击数：166&#xD;发表时间：24年04月22日">政治教研活动通知</a>[ 04-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19683.aspx" target="_self" title="标题：地理教研活动通知&#xD;点击数：164&#xD;发表时间：24年04月22日">地理教研活动通知</a>[ 04-22 ]</div>
                        </div>
                    </div>
