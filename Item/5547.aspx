...
<head>
    ...
    <title>教工（棋类）智力运动会报名通知--工会-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_32/Index.aspx" target="_self">工会</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">教工（棋类）智力运动会报名通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5547"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5547},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5547";
     ...
     <P><A title=报名表 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201609/2016091914305435.doc">报名表</A>      </P>
<P>     为活跃教工课余文化生活，工会决定举行“教工（棋类）智力运动会”，项目有：国际象棋、中国象棋、围棋、跳棋、飞行棋，有兴趣参加的教工，向工会小组长报名，每人限报一项，报名截止时间为9月23日，报名表交给刘夏进老师，比赛时间为9月27、28、29日下午3、4两节，地点：多功能厅。报名人数不足6人的项目取消，每个项目前三分之一者给予奖励。</P>
<P>                                                      工会  2016/09/19</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5542.aspx" target="_self" title="标题：晚间体育场馆开放通知&#xD;点击数：195&#xD;发表时间：16年09月19日">晚间体育场馆开放通知</a>[ 09-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5548.aspx" target="_self" title="标题：教师购房特惠活动咨询通知&#xD;点击数：298&#xD;发表时间：16年09月20日">教师购房特惠活动咨询通知</a>[ 09-20 ]</div>
                        </div>
                    </div>
