...
<head>
    ...
    <title>关于教研组长外出参加培训的补充通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于教研组长外出参加培训的补充通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8564"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8564},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8564";
     ...
     <P> </P>
<P>各位参加教研组长培训（5月17-18日）的组长，请于明天中午12：40分于西门集中乘坐校车，送到文理学院河东校区门口，转乘教研院安排大巴前往苏州，请准时，并随带身份证。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8551.aspx" target="_self" title="标题：关于市第八批普通高中精品（推荐）选修课程评选的通知&#xD;点击数：278&#xD;发表时间：18年05月15日">关于市第八批普通高中精品（推荐）选修课程评选的通知</a>[ 05-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8600.aspx" target="_self" title="标题：英语组教研活动通知&#xD;点击数：324&#xD;发表时间：18年05月22日">英语组教研活动通知</a>[ 05-22 ]</div>
                        </div>
                    </div>
