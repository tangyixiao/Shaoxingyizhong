...
<head>
    ...
    <title>关于开展“优秀经验总结报告”评选活动的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于开展“优秀经验总结报告”评选活动的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=144"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:144},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=144";
     ...
     <DIV><FONT size=4>   为进一步推动基层学校、教师深入开展与实践紧密结合的教育教学研究工作，加强教育教学经验建设，促进办学质量的科学提高，绍兴市教育教学研究院决定在市属中小学、幼儿园开展“优秀经验总结报告”评选及宣讲活动。</FONT></DIV>
<DIV><FONT size=4>一、报告内容</FONT></DIV>
<DIV><FONT size=4>   经验总结报告应当是教师或学校自己经历、思考、探索的产物，主要有：①教育教学经验：学科
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/139.aspx" target="_self" title="标题：关于开展2009年高考征文活动的通知&#xD;点击数：551&#xD;发表时间：09年09月15日">关于开展2009年高考征文活动的通知</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/150.aspx" target="_self" title="标题：高三1B学分考监考安排&#xD;点击数：544&#xD;发表时间：09年08月27日">高三1B学分考监考安排</a>[ 08-27 ]</div>
                        </div>
                    </div>
