    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年11月10日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=537"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:537},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=537";
...
<DIV>◆<B>主题：</B>“立志、修身、博学、报国”<B></B></DIV>
<DIV>◆<B>时间：</B>2009年11月11日下午第四节课</DIV>
<DIV>◆<B>对象：</B>高一、高二各班团支部</DIV>
<DIV>◆<B>方案：</B>以团支部为单位组织学习活动。可分成6个小组，每组推选一名发言人，限时5分钟。可制作PPT以供学习。</DIV>
<DIV>◆<B>总结：</B>会后各班团支书将总结上交年段团总支。</
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/443.aspx" target="_self" title="标题：大合唱比赛的纪律、卫生检查情况通报：&#xD;点击数：283&#xD;发表时间：09年10月23日">大合唱比赛的纪律、卫生检查情况通报：</a>[ 10-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/546.aspx" target="_self" title="标题：第四期黑板报检查成绩公布&#xD;点击数：2252&#xD;发表时间：09年11月11日">第四期黑板报检查成绩公布</a>[ 11-11 ]</div>
                        </div>
                    </div>
