...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9232"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9232},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9232";
     ...
     <FONT size=4>10月23日下午地理组全体老师外出参加教研活动，相关班级地理课改自修</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9231.aspx" target="_self" title="标题：语文教研活动通知&#xD;点击数：219&#xD;发表时间：18年10月22日">语文教研活动通知</a>[ 10-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9236.aspx" target="_self" title="标题：关于海军招收飞行学员报名的通知&#xD;点击数：755&#xD;发表时间：18年10月23日">关于海军招收飞行学员报名的通知</a>[ 10-23 ]</div>
                        </div>
                    </div>
