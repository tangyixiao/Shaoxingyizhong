...
<head>
    ...
    <title>2018年6月学考培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2018年6月学考培训通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8793"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8793},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8793";
     ...
     <STRONG><SPAN lang=EN-US>今天</SPAN>下午<SPAN lang=EN-US>15:30</SPAN>开始学考考务培训，时间约<SPAN lang=EN-US>40</SPAN>分钟</STRONG><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">。地点图书馆<SPAN lang=EN-US>3</SPAN>楼报告厅<SPAN lang=EN-US>2</SPAN>，参加对象全体监考老师（包括本校的监考、预备、流动、视频监考和验卷，到外校的监考、预备）。请老师们随带笔。</SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8778.aspx" target="_self" title="标题：2018年6月学考监考安排（有修改）&#xD;点击数：1070&#xD;发表时间：18年06月26日">2018年6月学考监考安排（有修改）</a>[ 06-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8795.aspx" target="_self" title="标题：2018年6月学考试场布置要求&#xD;点击数：287&#xD;发表时间：18年06月28日">2018年6月学考试场布置要求</a>[ 06-28 ]</div>
                        </div>
                    </div>
