...
<head>
    ...
    <title>历史教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13007"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13007},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13007";
     ...
     <p><span style="color: rgb(23, 26, 29); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI SymbolMyanmar Text", 微软雅黑; font-size: 18px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">本周三（31日）下午全体历史老师外出参加市直历史教研活动，当天下午的历史课改自修，选考走班的同学在相应上课教室自修</span>。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12984.aspx" target="_self" title="标题：绍兴一中2021北斗班开班仪式通知&#xD;点击数：320&#xD;发表时间：21年03月25日">绍兴一中2021北斗班开班仪式通知</a>[ 03-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13038.aspx" target="_self" title="标题：4月2日下午提前上课通知&#xD;点击数：435&#xD;发表时间：21年04月01日">4月2日下午提前上课通知</a>[ 04-01 ]</div>
                        </div>
                    </div>
