...
<head>
    ...
    <title>运动会入场式方法及评比条件--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">运动会入场式方法及评比条件</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年10月10日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=379"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:379},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=379";
     ...
     <DIV><FONT size=3>1、各班参加入场式的人数为（7路×8），指定1人（女生）拿班级牌。</FONT></DIV>
<DIV><FONT size=3>2、排成方块队形，服装统一。<B>拿班级牌的学生必须穿旗袍，黑色皮鞋，白手套</B>，，走在班级队伍前面3米处。<B></B></FONT></DIV>
<DIV><FONT size=3>3、班级队伍选定一名指挥员喊口令。<B></B></FONT></DIV>
<DIV><FONT size=3>4、各班队伍经主席台前30米区域必须目光朝
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/368.aspx" target="_self" title="标题：有关绍兴文理学院学生来我校教育实习的通知&#xD;点击数：368&#xD;发表时间：09年10月08日">有关绍兴文理学院学生来我校教育实习的通知</a>[ 10-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/384.aspx" target="_self" title="标题：英语组教师开设公开课信息&#xD;点击数：406&#xD;发表时间：09年10月12日">英语组教师开设公开课信息</a>[ 10-12 ]</div>
                        </div>
                    </div>
