...
<head>
    ...
    <title>关于品德考核比例超标修改的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于品德考核比例超标修改的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4215"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4215},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4215";
     ...
     <P>高一、高二各班主任：</P>
<P>        学生品德考核比例超标的班级，请抓紧在本周五之前完成修改。注意电子和纸质的都需要改。</P>
<P>两项都未改的班级：</P>
<P>      一（4）</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4197.aspx" target="_self" title="标题：6月17日寝室缺席名单&#xD;点击数：580&#xD;发表时间：11年06月17日">6月17日寝室缺席名单</a>[ 06-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4217.aspx" target="_self" title="标题：关于文明礼仪知识竞赛的通知&#xD;点击数：826&#xD;发表时间：11年06月22日">关于文明礼仪知识竞赛的通知</a>[ 06-22 ]</div>
                        </div>
                    </div>
