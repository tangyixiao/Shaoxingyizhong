...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=642"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:642},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=642";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 23.5pt; LINE-HEIGHT: 18pt; mso-char-indent-count: 1.96; mso-line-height-rule: exactly"><SPAN style="FONT-SIZE: 12pt; COLOR: black; FONT-FAMILY: 宋体; mso-bidi-font-family: Arial">桥牌作为一项益智运动受到全世界知识分子的推崇。通过桥牌的学习与训练，我们可以提升自己的逻辑思维能力、团队合作精神以及面对未知事物的应变能力。</SPAN><B style="mso-bidi-font-weight: normal"><SPAN lang=EN-US style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体; mso-bidi-font-family: 宋体; mso-font-kerning: 0pt"><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></B></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/641.aspx" target="_self" title="标题：合唱团&#xD;点击数：1373&#xD;发表时间：09年11月28日">合唱团</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/643.aspx" target="_self" title="标题：宣传部摄影团&#xD;点击数：1383&#xD;发表时间：09年11月28日">宣传部摄影团</a>[ 11-28 ]</div>
                        </div>
                    </div>
