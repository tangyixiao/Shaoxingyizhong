...
<head>
    ...
    <title>教工体检提醒--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">教工体检提醒</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年10月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=459"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:459},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=459";
     ...
     <DIV><FONT size=3>各位教工：</FONT></DIV>
<DIV><FONT size=3>     我校在职教师的</FONT><FONT size=3>体检工作将在</FONT><FONT size=3>10月28日至10月31日期间举行,请</FONT><FONT size=3>全体教工安排好时间自行前往.</FONT></DIV>
<DIV><FONT size=3>    体检地点：城东博爱医院体检
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/456.aspx" target="_self" title="标题：党员大会通知&#xD;点击数：535&#xD;发表时间：09年10月26日">党员大会通知</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/460.aspx" target="_self" title="标题：绍兴一中学生（家长）教学等投诉处理办法&#xD;点击数：515&#xD;发表时间：09年10月26日">绍兴一中学生（家长）教学等投诉处理办法</a>[ 10-26 ]</div>
                        </div>
                    </div>
