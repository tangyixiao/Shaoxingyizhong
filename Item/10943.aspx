...
<head>
    ...
    <title>高三学生参加物理讲座通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三学生参加物理讲座通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2019年11月30日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10943"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10943},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10943";
     ...
     <P><FONT size=4>时间:今天下午（周六）16:00-17:30<BR>地点:图书馆报告厅一<BR>主讲:浙江省教研室高中物理教研员梁旭</FONT></P>
<P><FONT size=4>请全体高三选考物理的同学及高二（1~3）班选考物理的同学，带好笔记本，准时参加，按座位安排就座，并严守会场纪律，体现一中学子风貌。</FONT></P>
<P><FONT size=4>具体座位安排如下：</FONT></P>
<P><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201911/2019113008112202.png" target=_blank><IMG onload=resizepic(this) onmousewheel="return bbimg(this)" border=0 src="/Shaoxingyizhong/UploadFiles/UploadFiles/201911/2019113008112202.png" width=1119 height=633> </A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10941.aspx" target="_self" title="标题：本周六高三物理历史限时训练时间和座位安排&#xD;点击数：487&#xD;发表时间：19年11月29日">本周六高三物理历史限时训练时间和座位安排</a>[ 11-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10957.aspx" target="_self" title="标题：智慧校园综合评价获奖录入说明&#xD;点击数：10533&#xD;发表时间：19年12月03日">智慧校园综合评价获奖录入说明</a>[ 12-03 ]</div>
                        </div>
                    </div>
