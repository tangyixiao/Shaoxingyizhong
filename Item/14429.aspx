...
<head>
    ...
    <title>高一部分班级生活委员及学生权益部会议通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一部分班级生活委员及学生权益部会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14429"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14429},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14429";
     ...
     <p style="padding: 0px; margin-top: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background-color: rgb(255, 255, 255); margin-bottom: 20px !important;">请高一9-16班的生活委员（或班长），以及学生权益部高一成员（隔离班级除外）于11月17日（周三）中午12:25至行政楼3楼会议室（二）开膳管会议，随带纸笔，并提前向班级做好请假说明。</p><p style="padding: 0px; margin-top: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; background-color: rgb(255, 255, 255); text-align: right; margin-bottom: 20px !important;">总务处 团委 学生权益部
2021年11月16日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14426.aspx" target="_self" title="标题：树人导报领取通知&#xD;点击数：87&#xD;发表时间：21年11月16日">树人导报领取通知</a>[ 11-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14442.aspx" target="_self" title="标题：“群青之梦”一中漫画大赛（时间调整）&#xD;点击数：457&#xD;发表时间：21年11月18日">“群青之梦”一中漫画大赛（时间调整）</a>[ 11-18 ]</div>
                        </div>
                    </div>
