...
<head>
    ...
    <title>关于高一班长会议的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一班长会议的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年08月18日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=119"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:119},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=119";
     ...
     <DIV>    <FONT size=4>请高一各班班长（代班长）明天（8月19日）中午12：20到行政楼三楼会议室开会。请相互转告，勿迟到。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/95.aspx" target="_self" title="标题：关于高三毕业生转接团组织关系的通知(补充)&#xD;点击数：42&#xD;发表时间：09年08月04日">关于高三毕业生转接团组织关系的通知(补充)</a>[ 08-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/122.aspx" target="_self" title="标题：关于检查仪容仪表的通知&#xD;点击数：1154&#xD;发表时间：09年08月19日">关于检查仪容仪表的通知</a>[ 08-19 ]</div>
                        </div>
                    </div>
