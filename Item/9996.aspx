...
<head>
    ...
    <title>瑞丰银行办卡优惠活动--工会-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_32/Index.aspx" target="_self">工会</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">瑞丰银行办卡优惠活动</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>瑞丰银行办卡优惠活动</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2019年04月18日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9996"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9996},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9996";
     ...
     <P>                 瑞丰银行办卡优惠活动</P><!--StartFragment -->
<DIV>各位老师：瑞丰银行针对我校教职工推出一款优惠的信用贷款产品（随借随还，最低1万元每日利息1.6元），仅身份证一张就可办理，将于本周五（4月19日）及下周一下周二（4月22-23日）中午在我校教工食堂设摊办理，有需要的老师可前往咨询，现场办理即送礼品，也可电话咨询：邵经理 13656858768</DIV>
<DIV> </DIV>
<DIV> </DIV>
<DIV>                                                      绍兴一中工会</DIV>
<DIV>                                                         2019.4.18<BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9987.aspx" target="_self" title="标题：工会迎&amp;quot;五一&amp;quot;气排球活动的通知&#xD;点击数：628&#xD;发表时间：19年04月16日">工会迎"五一"气排球活动的通知</a>[ 04-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10239.aspx" target="_self" title="标题：绍兴市第三届青年教师技能竞赛&#xD;点击数：314&#xD;发表时间：19年06月11日">绍兴市第三届青年教师技能竞赛</a>[ 06-11 ]</div>
                        </div>
                    </div>
