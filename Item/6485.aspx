...
<head>
    ...
    <title>失物招领公交IC卡--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6485"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6485},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6485";
     ...
     阮老师在田径场捡到公交专用卡一张，望失主及时到体育组办公室阮老师处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6476.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：76&#xD;发表时间：17年02月27日">表扬与失物招领</a>[ 02-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6487.aspx" target="_self" title="标题：失物招领&#xD;点击数：138&#xD;发表时间：17年03月01日">失物招领</a>[ 03-01 ]</div>
                        </div>
                    </div>
