...
<head>
    ...
    <title>各竞赛指导老师--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=156"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:156},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=156";
     ...
     <DIV>请把08学年（08年9月-09年8月）的获奖文件的复印件交章其炎处，便于统计奖金。复印件上要标明获奖学生的班级、指导老师。</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/155.aspx" target="_self" title="标题：高三1B现代诗歌考试时间、地点变动&#xD;点击数：544&#xD;发表时间：09年08月27日">高三1B现代诗歌考试时间、地点变动</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/158.aspx" target="_self" title="标题：备课纸领取通知&#xD;点击数：538&#xD;发表时间：09年09月07日">备课纸领取通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
