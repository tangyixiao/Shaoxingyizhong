...
<head>
    ...
    <title>高三培优班面试讲座通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6729"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6729},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6729";
     ...
     学校特别邀请面试专家来校做面试讲座，请高三培优班学生于明天（周六）下午2：00到行政楼5楼会议室参加。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6728.aspx" target="_self" title="标题：错时用餐提醒&#xD;点击数：439&#xD;发表时间：17年04月14日">错时用餐提醒</a>[ 04-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6733.aspx" target="_self" title="标题：高一部分选修课改自修通知&#xD;点击数：147&#xD;发表时间：17年04月17日">高一部分选修课改自修通知</a>[ 04-17 ]</div>
                        </div>
                    </div>
