...
<head>
    ...
    <title>高一高二物理课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1814"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1814},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1814";
     ...
     <P>5月6日（星期四）高一高二物理老师参加市属优质课评比，所任课班级物理课改自修。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1813.aspx" target="_self" title="标题：关于高三各学科备课组长赴学军中学教研活动的通知&#xD;点击数：410&#xD;发表时间：10年05月05日">关于高三各学科备课组长赴学军中学教研活动的通知</a>[ 05-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1817.aspx" target="_self" title="标题：关于市高中数学学科教研大组成员研修活动的通知&#xD;点击数：423&#xD;发表时间：10年05月06日">关于市高中数学学科教研大组成员研修活动的通知</a>[ 05-06 ]</div>
                        </div>
                    </div>
