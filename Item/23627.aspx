...
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23627},success:function(s) {
     ...
     <p style="text-align: center;"><img src="/UploadFiles/xwzx/2026/9/202609141529165667.png" style="max-width: 100%; " title="202609141529165667.png" /></p>
                        ...
                        <div class="others">
                            ...
                            <div class="next"><span>下一篇：</span><a href="/Item/23630.aspx" target="_self" title="标题：今天（周五）中午跑操考核员会议通知&#xD;点击数：81&#xD;发表时间：26年09月11日">今天（周五）中午跑操考核员会议通知</a>[ 09-11 ]</div>
                        </div>
                    </div>
