...
<head>
    ...
    <title>参加第25个教师节晚会的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">参加第25个教师节晚会的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=232"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:232},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=232";
     ...
     <DIV>        <FONT size=5>9月9日晚7：30时市教育局在绍兴大剧院举行庆祝第25个教师节晚会。晚会凭票、对号入座。请下列老师准时参加，不能缺席！</FONT></DIV>
<DIV><FONT size=5></FONT> </DIV>
<DIV>
<TABLE style="WIDTH: 223pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadd
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/229.aspx" target="_self" title="标题：第一周值周小结&#xD;点击数：1169&#xD;发表时间：09年09月08日">第一周值周小结</a>[ 09-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/235.aspx" target="_self" title="标题：通知&#xD;点击数：526&#xD;发表时间：09年09月09日">通知</a>[ 09-09 ]</div>
                        </div>
                    </div>
