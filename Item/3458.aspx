...
<head>
    ...
    <title>温馨教室、寝室布置的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">温馨教室、寝室布置的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>温馨教室、寝室布置的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年03月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3458"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3458},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3458";
...
<P><FONT size=4>    根据今天检查，有些班级已动手进行温馨教室、寝室布置，但大多数班级还没有动手进行，望能在本周完成布置，班主任也要督促住校生对寝室时行布置，下周二进行检查评比。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3457.aspx" target="_self" title="标题：大扫除通知&#xD;点击数：386&#xD;发表时间：11年03月07日">大扫除通知</a>[ 03-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3459.aspx" target="_self" title="标题：高三年级“高考总动员”励志演讲通知&#xD;点击数：558&#xD;发表时间：11年03月07日">高三年级“高考总动员”励志演讲通知</a>[ 03-07 ]</div>
                        </div>
                    </div>
