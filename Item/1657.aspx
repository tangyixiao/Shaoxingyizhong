...
<head>
    ...
    <title>高三周二与周六上午课程对换--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三周二与周六上午课程对换</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1657"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1657},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1657";
     ...
     高三本周4月13日（周二）与4月17日（周六）上午课程全部互换。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1650.aspx" target="_self" title="标题：高三班主任：通知有关学生警校报名开始了&#xD;点击数：770&#xD;发表时间：10年04月09日">高三班主任：通知有关学生警校报名开始了</a>[ 04-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1660.aspx" target="_self" title="标题：高一、高二缴会考报名费&#xD;点击数：414&#xD;发表时间：10年04月12日">高一、高二缴会考报名费</a>[ 04-12 ]</div>
                        </div>
                    </div>
