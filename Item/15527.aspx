...
<head>
    ...
    <title>本周六上课及错时放学通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">本周六上课及错时放学通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15527"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15527},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15527";
     ...
     <p>按学校工作安排，本周六（5月7日）高一高二按周四课表上课，下午错时放学时间如下：高一年级下午第七节课后放学，高二年级下午第八节课后放学。放学时请不要大声喧哗，以免打扰高三考试。
</p><p>高三年级参加五校联考，下午第一场结束时没有地理考试任务的学生放学，其余学生最后一场考试结束后放学。
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15526.aspx" target="_self" title="标题：高二年级期中成绩分析会通知&#xD;点击数：289&#xD;发表时间：22年05月06日">高二年级期中成绩分析会通知</a>[ 05-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15530.aspx" target="_self" title="标题：学术节 | 数学竞赛系列活动&#xD;点击数：361&#xD;发表时间：22年05月06日">学术节 | 数学竞赛系列活动</a>[ 05-06 ]</div>
                        </div>
                    </div>
