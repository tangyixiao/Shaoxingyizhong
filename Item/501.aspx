...
<head>
    ...
    <title>关于实行冬令时间的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于实行冬令时间的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年11月03日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=501"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:501},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=501";
     ...
     <P><FONT size=3>各位教工：</FONT></P>
<P><FONT size=3>     我校从11月5日起，实行冬令时间表，希各照知。（晚自修时间照旧）</FONT></P>
<P><FONT size=3>附冬令时间表</FONT></P>
<P>
<TABLE style="WIDTH: 265pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=353 border
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/500.aspx" target="_self" title="标题：09高三期中考试安排&#xD;点击数：350&#xD;发表时间：09年11月03日">09高三期中考试安排</a>[ 11-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/502.aspx" target="_self" title="标题：2009学年第一学期高三期中考试场安排&#xD;点击数：260&#xD;发表时间：09年11月03日">2009学年第一学期高三期中考试场安排</a>[ 11-03 ]</div>
                        </div>
                    </div>
