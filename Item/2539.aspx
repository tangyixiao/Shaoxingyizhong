...
<head>
    ...
    <title>华嵒《红白芍药图》--艺术教育-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_103/Index.aspx" target="_self">艺术教育</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">华嵒《红白芍药图》</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：中国美术馆</span> <span>作者：佚名</span> <span>发布时间：2010年09月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2539"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2539},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2539";
     ...
     <P><A href="/Shaoxingyizhong/UploadFiles/UploadFiles_9649/201009/2010092616173478.jpg" target=_blank><IMG onmousewheel="return bbimg(this)" height=602 src="/Shaoxingyizhong/UploadFiles/UploadFiles_9649/201009/2010092616173478.jpg" width=628 onload=resizepic(this) border=0></A></P>
<P>
...
<TR class=bj4>
<TD height=22></TD>
<TD class=lv12 align=left colSpan=2></TD></TR>
<TR class=bj4>
<TD width=49> </TD>
<TD class=lv12 style="TABLE-LAYOUT: fixed; WORD-WRAP: break-word" align=left>
<DIV id=content_div>
<P><FONT face=宋体>    华嵒（1682-1756），字秋岳，号新罗山人，又号布衣生，福建上杭人。出身于造纸工匠家庭，据说他青年时曾为景德镇绘过瓷画。长期居住扬州，以卖画为生。他工人物、山水、花鸟、草虫，写生动物尤佳。画法远师马和之，近受陈洪绶、恽寿平影响。重视写生，创造力强，构思新颖，喜用粗笔、渴笔，半工半写，线条含蓄，如棉里针，画面简练，形象生动，风格清新、俊逸。诗书亦佳，有“三绝”之称。著有《离垢集》等。</FONT></P>
<P>    此图以工笔绘红白芍药两株，刻画细致入微。先以墨笔勾勒轮廓，后用色渲染，着重表现叶的阴阳相背、变化多端和芍药花开的不同形态，或盛放，或半放，或昂首，或低头，皆生意盎然。设色细洁光润，雅致清丽，精巧传神，有自然之态，又似仕女般仪态万千，娴雅有度。 </P></DIV></TD></TR></TBODY></TABLE></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2446.aspx" target="_self" title="标题：摄影师拍摄水中倒影&amp;nbsp;效果犹如印象派油画&#xD;点击数：2099&#xD;发表时间：10年09月13日">摄影师拍摄水中倒影 效果犹如印象派油画</a>[ 09-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2609.aspx" target="_self" title="标题：我校隆重举行迎国庆系列活动&#xD;点击数：1601&#xD;发表时间：10年10月09日">我校隆重举行迎国庆系列活动</a>[ 10-09 ]</div>
                        </div>
                    </div>
