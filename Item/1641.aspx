...
<head>
    ...
    <title>有关香港大学&amp;nbsp;招生事项--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1641"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1641},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1641";
     ...
     <P>      <FONT size=5>今有香港大学2010年内地本科生入学计划申请表及相关招生宣传资料，我校成绩特优并有意向报考的同学，可以到教学处领取申请表及相关宣传资料。</FONT></P>
<P><FONT size=5>                                           教学处</FONT></P>
<P><FONT size=5>                                           2010.4.8</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1640.aspx" target="_self" title="标题：关于公布2010年市属级规划课题（教改项目）的通知&#xD;点击数：341&#xD;发表时间：10年04月07日">关于公布2010年市属级规划课题（教改项目）的通知</a>[ 04-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1643.aspx" target="_self" title="标题：关于上交教师继续教育结业证书的通知&#xD;点击数：915&#xD;发表时间：10年04月08日">关于上交教师继续教育结业证书的通知</a>[ 04-08 ]</div>
                        </div>
                    </div>
