...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15367"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15367},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15367";
     ...
     <p><span style="color: rgb(17, 31, 44); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI SymbolMyanmar Text", 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);"> 4月15日（周五）上午第2节，在高一（1）班教室，由物理组王成老师执教汇报课。欢迎老师们莅临指导。</span></p><p>
</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15309.aspx" target="_self" title="标题：关于举行2022年绍兴市中小学生研究性学习活动成果评比的通知&#xD;点击数：233&#xD;发表时间：22年04月06日">关于举行2022年绍兴市中小学生研究性学习活动成果评比的通知</a>[ 04-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15512.aspx" target="_self" title="标题：化学组汇报课通知&#xD;点击数：212&#xD;发表时间：22年05月04日">化学组汇报课通知</a>[ 05-04 ]</div>
                        </div>
                    </div>
