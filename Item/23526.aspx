...
<head>
    ...
    <title>祝贺！绍兴一中信奥队在43届全国信奥竞赛摘金夺银，再创佳绩！--信息学竞赛-绍兴市第一中学</title>
...
<li class="li7 last"><a href="/Category_378/Index.aspx">其他竞赛</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23526"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23526},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23526";
     ...
     <p style="font-family: 宋体; font-size: 12pt; line-height: 108%; margin: 0px 0px 0.001pt; text-align: left; text-indent: 2em;"><a style="text-decoration: none;"></a>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/22912.aspx" target="_self" title="标题：绍兴一中陈奕帆以全省总分第一名的成绩进入浙江省队&#xD;点击数：30&#xD;发表时间：26年03月23日">绍兴一中陈奕帆以全省总分第一名的成绩进入浙江省队</a>[ 03-23 ]</div>
