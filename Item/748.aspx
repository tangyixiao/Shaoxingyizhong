...
<head>
    ...
    <title>符合条件的学生，都有机会成为推荐生！--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">符合条件的学生，都有机会成为推荐生！</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：绍兴晚报</span> <span>作者：佚名</span> <span>发布时间：2009年12月01日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=748"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:748},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=748";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/747.aspx" target="_self" title="标题：参加航模兴趣小组　按照成绩择优录取&#xD;点击数：517&#xD;发表时间：09年12月01日">参加航模兴趣小组　按照成绩择优录取</a>[ 12-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/749.aspx" target="_self" title="标题：参加兴趣小组，兴趣第一还得学有余力&#xD;点击数：546&#xD;发表时间：09年12月01日">参加兴趣小组，兴趣第一还得学有余力</a>[ 12-01 ]</div>
                        </div>
                    </div>
