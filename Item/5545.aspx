...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5545"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5545},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5545";
     ...
     <P style="TEXT-INDENT: 21pt; MARGIN: 0cm 0cm 0pt; mso-char-indent-count: 2.0" class=MsoNormal><SPAN style="FONT-FAMILY: 宋体; COLOR: black; mso-ascii-font-family: &#718;&#805;; mso-hansi-font-family: &#718;&#805;; mso-bidi-font-family: 宋体; mso-font-kerning: 0pt; mso-bidi-font-size: 10.5pt"><FONT size=3>今天下午第四节课高一、高二各班进行大扫除，请劳动委员组织好本班同学，认真、仔细的做好教室、每日包干区和每周包干区卫生工作，特别是包干区的一些卫生死角（花坛、垃圾桶旁边的废弃垃圾等）。德育处将进行检查考核。</FONT></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5539.aspx" target="_self" title="标题：周一升旗仪式&#xD;点击数：145&#xD;发表时间：16年09月18日">周一升旗仪式</a>[ 09-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5549.aspx" target="_self" title="标题：表扬&#xD;点击数：218&#xD;发表时间：16年09月20日">表扬</a>[ 09-20 ]</div>
                        </div>
                    </div>
