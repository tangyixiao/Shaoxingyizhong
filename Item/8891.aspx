...
<head>
    ...
    <title>2018学年第一学期早读安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2018学年第一学期早读安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8891"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8891},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8891";
     ...
     <P><FONT size=4>2018学年第一学期早读安排如下：</FONT></P>
<P>高一、高二：语文  周一、周三、周五    英语 周二、周四、周六</P>
<P>高三：语文 周二、周三、周五   英语 周一、周四、周六</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8867.aspx" target="_self" title="标题：高三回头考试场布置要求&#xD;点击数：219&#xD;发表时间：18年08月15日">高三回头考试场布置要求</a>[ 08-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8893.aspx" target="_self" title="标题：体育课改自修通知&#xD;点击数：221&#xD;发表时间：18年08月27日">体育课改自修通知</a>[ 08-27 ]</div>
                        </div>
                    </div>
