...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21144"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21144},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21144";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/3/202503310850015247.png" style="max-width: 100%; " title="202503310850015247.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21143.aspx" target="_self" title="标题：绍兴一中教育集团组织规程、跑操方案及评分细则&#xD;点击数：180&#xD;发表时间：25年03月25日">绍兴一中教育集团组织规程、跑操方案及评分细则</a>[ 03-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21145.aspx" target="_self" title="标题：3.25跑操量化考核反馈&#xD;点击数：66&#xD;发表时间：25年03月25日">3.25跑操量化考核反馈</a>[ 03-25 ]</div>
                        </div>
                    </div>
