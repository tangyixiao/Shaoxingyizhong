...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9579"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9579},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9579";
     ...
     <P><FONT size=4>因市文艺汇演须要下列老师明天（周四）的课改自修。</FONT></P>
<P><FONT size=4>相关老师名单：舒凤、王宁、吴丽娟、何伟丹、俞笑程、孟德超、陈炳炉、何隽豪</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9573.aspx" target="_self" title="标题：地理教研活动通知&#xD;点击数：282&#xD;发表时间：18年12月25日">地理教研活动通知</a>[ 12-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9601.aspx" target="_self" title="标题：温馨提醒&#xD;点击数：619&#xD;发表时间：18年12月28日">温馨提醒</a>[ 12-28 ]</div>
                        </div>
                    </div>
