...
<head>
    ...
    <title>关于大课间改为做操及入场路线的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于大课间改为做操及入场路线的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7288"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7288},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7288";
     ...
     <P>全校各班：<BR></P>
<P>    考虑到天气炎热等实际情况，现拟将大课间跑步改为做操，从9月7日（周四）起实行。入场路线安排如下，请各班按照路线，慢跑入场，避免拥堵。</P>
<P><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201709/2017090617053965.jpg" target=_blank><IMG onload=resizepic(this) onmousewheel="return bbimg(this)" border=0 src="/Shaoxingyizhong/UploadFiles/UploadFiles/201709/2017090617053965.jpg" width=922 height=525> </A></P>
<P align=right>德育处</P>
<P align=right>9月6日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7283.aspx" target="_self" title="标题：关于评选“军训积极分子“通知&#xD;点击数：347&#xD;发表时间：17年09月06日">关于评选“军训积极分子“通知</a>[ 09-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7290.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：139&#xD;发表时间：17年09月07日">大课间操暂停通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
