...
<head>
    ...
    <title>关于高一新生军训会操的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一新生军训会操的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=192"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:192},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=192";
     ...
     <P>各班主任：</P>
<P>定于9月8日在学校操场进行新生军训会操，具体要求如下：</P>
<DIV>1、本次军训会操形式：以班级为单位，形成方阵队形，在统一口令指挥下完成动作。按动作要求进行操练，并做到动作规范整齐。</DIV>
<DIV>2、会操地点：田径场</DIV>
<DIV>3、各班出场顺序按照班级序号</DIV>
<DIV>4、评分标准</DIV>
<DIV>（1）服装统一，队伍整齐</DIV>
<DIV>（2）动作正确，步伐一致</DIV>
<DIV>（3）精神饱满 ，口令响亮</DIV
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/190.aspx" target="_self" title="标题：各班主任请注意（大课间入场路线）&#xD;点击数：537&#xD;发表时间：09年09月02日">各班主任请注意（大课间入场路线）</a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/195.aspx" target="_self" title="标题：各班主任请注意（近期有关事项）&#xD;点击数：498&#xD;发表时间：09年09月03日">各班主任请注意（近期有关事项）</a>[ 09-03 ]</div>
                        </div>
                    </div>
