...
<head>
    ...
    <title>关于网站下载资料的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于网站下载资料的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年10月29日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=481"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:481},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=481";
     ...
     <DIV><STRONG>各位老师，现有以下</STRONG><STRONG>5</STRONG><STRONG>个网站可供下载资料。(金太阳新课标资源网需要在最近10天内下载登陆器,具体见以下金太阳新课标资源网用户登陆说明)</STRONG><B></B></DIV>
<DIV><B>1</B><B>、高考资源网</B><B></B></DIV>
<DIV>网址：<A href="http://www.ks5u.com/">www.ks5u.com</A></DIV>
<DIV>用户名：zjsxyz&n
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/474.aspx" target="_self" title="标题：高一校本课程《唐宋词鉴赏 》上课地点更改&#xD;点击数：346&#xD;发表时间：09年10月28日">高一校本课程《唐宋词鉴赏 》上课地点更改</a>[ 10-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/484.aspx" target="_self" title="标题：高一、高二期中考试场布置要求&#xD;点击数：335&#xD;发表时间：09年10月30日">高一、高二期中考试场布置要求</a>[ 10-30 ]</div>
                        </div>
                    </div>
