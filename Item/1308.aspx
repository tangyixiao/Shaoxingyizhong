...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1308"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1308},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1308";
     ...
     高三备课组长：2010年高考考试说明已到，请备课组长到教学处来领取。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1304.aspx" target="_self" title="标题：关于寒假各兴趣小组活动计划统计的通知&#xD;点击数：632&#xD;发表时间：10年01月29日">关于寒假各兴趣小组活动计划统计的通知</a>[ 01-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1309.aspx" target="_self" title="标题：关于研究性学习课题报告书写的几点说明&#xD;点击数：566&#xD;发表时间：10年01月30日">关于研究性学习课题报告书写的几点说明</a>[ 01-30 ]</div>
                        </div>
                    </div>
