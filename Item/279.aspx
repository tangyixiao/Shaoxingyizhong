...
<head>
    ...
    <title>2009年暑期社会实践活动评选结果--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2009年暑期社会实践活动评选结果</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=279"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:279},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=279";
     ...
     <DIV><B></B><B></B> </DIV>
<DIV align=left>    2009年暑期社会实践活动已经结束，各班根据学校的统一部署，紧紧围绕“我参与，我文明，我健康，我快乐，庆建国六十周年，促文明和谐生活”的主题，开展了丰富的社会实践活动。</DIV>
<DIV align=left>    经各班团支部整理上报，德育处、团委仔细审核，2009年度暑期社会实践先进集体评比结果如下（无先后顺序）：</DIV>
<DI
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/248.aspx" target="_self" title="标题：关于学生会干部招聘面试的通知&#xD;点击数：524&#xD;发表时间：09年09月11日">关于学生会干部招聘面试的通知</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/281.aspx" target="_self" title="标题：关于高一各班设立安检委员、并填写班干部统计表的通知&#xD;点击数：453&#xD;发表时间：09年09月15日">关于高一各班设立安检委员、并填写班干部统计表的通知</a>[ 09-15 ]</div>
                        </div>
                    </div>
