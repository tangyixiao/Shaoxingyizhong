...
<head>
    ...
    <title>省师德楷模候选人推荐通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">省师德楷模候选人推荐通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18277"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18277},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18277";
     ...
     <p>全体教工：</p><p>    接上级通知，现有省师德楷模候选人推荐事宜，具体情况如下。
1.我市共有省师德楷模名额5名，我校可推荐１名候选人。
2.推荐要求：
    ①近5年内担任班主任工作至少3年；
    ②无师德师风问题；
    ③有市级以上荣誉或德育先进等荣誉的优先考虑。
3.本次申报依托全国教师信息管理系统上的评优评先模块。
    请符合条件的教师将近5年的工作简历和所获荣誉整理成一个word文档，电子版发给党政办金笛，截止时间：8月23日中午12:30。</p><p style="text-align: right;"><span style="text-align: right;">党政办
</span>2023年8月22日</p><p>
</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18264.aspx" target="_self" title="标题：绍兴市第一中学2023年选拔任用中层干部工作方案&#xD;点击数：215&#xD;发表时间：23年08月10日">绍兴市第一中学2023年选拔任用中层干部工作方案</a>[ 08-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18281.aspx" target="_self" title="标题：关于推荐申报浙江省任教三十年教师荣誉证书对象的公示&#xD;点击数：111&#xD;发表时间：23年08月23日">关于推荐申报浙江省任教三十年教师荣誉证书对象的公示</a>[ 08-23 ]</div>
                        </div>
                    </div>
