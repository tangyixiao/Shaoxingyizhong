...
<head>
    ...
    <title>2022年度教工体检通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2022年度教工体检通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2022年07月02日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15923"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15923},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15923";
     ...
     <p><span style="color: rgb(23, 26, 29); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI Symbol", "Myanmar Text", 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">各位教职员工：</span>
<span style="color: rgb(23, 26, 29); font-family: "Microsoft YaHei", "Segoe UI", system-ui, Roboto, "Droid Sans", "Helvetica Neue", sans-serif, Tahoma, "Segoe UI Symbol", "Myanmar Text", 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">       根据绍市干保办[2022]2号文件通知，2022年度市级机关干部健康体检已经开始。为了进一步做好学校教职工的预防保健工作，满足大家的不同需求，今年我校的教职工体检将由绍兴市人民医院体检中心、绍兴美兆门诊医疗有限公司及绍兴妇保医院体检中心负责实施。每位教职工均可在上述3家体检机构中任选一家进行健康体检。现将相关事宜告知，近期将下发选择套餐，请各位教职工选择好体检单位，下周二（7月5日）3点之前上报给各组的学科组长，谢谢大家的配合！</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15912.aspx" target="_self" title="标题：关于教职员工车辆校内行驶的温馨提醒&#xD;点击数：150&#xD;发表时间：22年06月30日">关于教职员工车辆校内行驶的温馨提醒</a>[ 06-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15927.aspx" target="_self" title="标题：转发：教基司函【2022】20号关于组织收看预防学生溺水专题节目的通知&#xD;点击数：92&#xD;发表时间：22年07月04日">转发：教基司函【2022】20号关于组织收看预防学生溺水专题节目…</a>[ 07-04 ]</div>
                        </div>
                    </div>
