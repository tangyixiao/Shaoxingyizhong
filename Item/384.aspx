...
<head>
    ...
    <title>英语组教师开设公开课信息--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">英语组教师开设公开课信息</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=384"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:384},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=384";
...
<DIV> </DIV>
<DIV>各位老师：  </DIV>
<DIV>    本周英语组有以下四位教师开设公开课，欢迎领导和老师们莅临指导！</DIV>
<DIV> </DIV>
<TABLE border=1 cellSpacing=0 cellPadding=0>
<TBODY>
<TR>
<TD vAlign=top width=175 colSpan=3>
<DIV align=center>时  间</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/379.aspx" target="_self" title="标题：运动会入场式方法及评比条件&#xD;点击数：414&#xD;发表时间：09年10月10日">运动会入场式方法及评比条件</a>[ 10-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/385.aspx" target="_self" title="标题：关于高二校本课程上课安排的通知&#xD;点击数：369&#xD;发表时间：09年10月12日">关于高二校本课程上课安排的通知</a>[ 10-12 ]</div>
                        </div>
                    </div>
