    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年10月31日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=489"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:489},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=489";
...
<DIV align=left><FONT size=4>      随着期中考的临近，学习气氛更浓，早读、午休、自修以及晚自修整体情况良好。主要存在的问题如下：</FONT></DIV>
<DIV align=left><FONT size=4>1．学生打手机、听MP3的现象时有发生，请相关班主任做好教育工作。</FONT></DIV>
<DIV align=left><FONT size=4
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/482.aspx" target="_self" title="标题：通知&#xD;点击数：417&#xD;发表时间：09年10月29日">通知</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/496.aspx" target="_self" title="标题：祝教工生日快乐&#xD;点击数：519&#xD;发表时间：09年11月03日">祝教工生日快乐</a>[ 11-03 ]</div>
                        </div>
                    </div>
