...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6571"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6571},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6571";
     ...
     高二（8）同学在操场跑道上捡到蓝色校牌一块，特此表扬，并望失主及时到德育处来认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6570.aspx" target="_self" title="标题：失物招领&#xD;点击数：87&#xD;发表时间：17年03月15日">失物招领</a>[ 03-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6572.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：100&#xD;发表时间：17年03月16日">大课间操暂停通知</a>[ 03-16 ]</div>
                        </div>
                    </div>
