...
<head>
    ...
    <title>因为喜欢，所以坚持！--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4482"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4482},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4482";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4481.aspx" target="_self" title="标题：两所台湾公立大学&amp;nbsp;今年面向大陆招生&#xD;点击数：831&#xD;发表时间：12年05月23日">两所台湾公立大学 今年面向大陆招生</a>[ 05-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4485.aspx" target="_self" title="标题：远离毒品&amp;nbsp;&amp;nbsp;珍爱生命&#xD;点击数：2094&#xD;发表时间：12年05月25日">远离毒品  珍爱生命</a>[ 05-25 ]</div>
                        </div>
                    </div>
