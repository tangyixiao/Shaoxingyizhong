...
<head>
    ...
    <title>关于早自修情况检查的几点说明--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于早自修情况检查的几点说明</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4034"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4034},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4034";
     ...
     <P>　　近段时间来，根据学校值周老师检查情况看，早自修存在以下几点问题：１、学生迟到现象比较严重；2、语文、英语教师下班指导大部份教师做得很好，但也有少部份老师不及时，个别教师还有缺岗现象；3、有的班主任也没按时到位。希望大家引起注意，尽心尽力做好本职工作。</P>
<P>                                                                         教学处</P>
<P>                                                                               2011/05/26</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4025.aspx" target="_self" title="标题：2011年5月高三校二模试场、监考安排&#xD;点击数：1585&#xD;发表时间：11年05月25日">2011年5月高三校二模试场、监考安排</a>[ 05-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4037.aspx" target="_self" title="标题：高二班主任：会考准考证补办&#xD;点击数：467&#xD;发表时间：11年05月26日">高二班主任：会考准考证补办</a>[ 05-26 ]</div>
                        </div>
                    </div>
