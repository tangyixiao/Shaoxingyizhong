...
<head>
    ...
    <title>寻物启事（紫色手表）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17464"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17464},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17464";
     ...
     <p>今天中午遗失手表一只，紫色表带，指针上有字母“J”，请拾到同学送到215班陈贾炜一同学处。谢谢！！</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17458.aspx" target="_self" title="标题：3.14跑操量化考核反馈&#xD;点击数：124&#xD;发表时间：23年03月14日">3.14跑操量化考核反馈</a>[ 03-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17466.aspx" target="_self" title="标题：3.13班级一日考核&#xD;点击数：62&#xD;发表时间：23年03月15日">3.13班级一日考核</a>[ 03-15 ]</div>
                        </div>
                    </div>
