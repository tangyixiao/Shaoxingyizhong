...
<head>
    ...
    <title>关于领取头盔的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10069"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10069},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10069";
     ...
     请骑电瓶车上下班的教工明天上午凭购车发票（另上交一份教师签名的复印件，）到西门传达室领取头盔一个，数量有限，每人限领一个，先到先得！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10062.aspx" target="_self" title="标题：请以下同学于今天（5月4日）下午5:00之前完成安全平台作业&#xD;点击数：609&#xD;发表时间：19年04月29日">请以下同学于今天（5月4日）下午5:00之前完成安全平台作业</a>[ 04-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10096.aspx" target="_self" title="标题：关于组织开展绍兴市中小学生（幼儿）“512防灾减灾”知识答题活动的通知&#xD;点击数：180&#xD;发表时间：19年05月08日">关于组织开展绍兴市中小学生（幼儿）“512防灾减灾”知识答题…</a>[ 05-08 ]</div>
                        </div>
                    </div>
