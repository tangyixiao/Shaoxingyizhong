...
<head>
    ...
    <title>校对期中试卷--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=471"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:471},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=471";
     ...
     <FONT face=Verdana>     高一、高二期中考各课负责命题的老师：如果还没有对试卷进行一稿校对的，请速到卢卫红处校对。 </FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/468.aspx" target="_self" title="标题：期中考试时间安排&#xD;点击数：362&#xD;发表时间：09年10月27日">期中考试时间安排</a>[ 10-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/474.aspx" target="_self" title="标题：高一校本课程《唐宋词鉴赏 》上课地点更改&#xD;点击数：346&#xD;发表时间：09年10月28日">高一校本课程《唐宋词鉴赏 》上课地点更改</a>[ 10-28 ]</div>
                        </div>
                    </div>
