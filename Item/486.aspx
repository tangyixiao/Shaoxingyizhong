...
<head>
    ...
    <title>高二期中考试试场、监考安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二期中考试试场、监考安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=486"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:486},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=486";
     ...
     <P>1、试场安排：</P>
<P>文：<IMG src="/Shaoxingyizhong/UploadFiles/UploadFiles/news/editor/sysimage/file/xls.gif" border=0><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/news/uploadimg/200910308109585.xls" target=_blank>二年级文科#各班级排号.xls</A>       <IMG src="/Shaoxingyizhong/UploadFiles/UploadFiles/news/editor/sysimage/file/xls.gif" border=0><A href="
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/485.aspx" target="_self" title="标题：高一期中考试试场、监考安排&#xD;点击数：396&#xD;发表时间：09年10月30日">高一期中考试试场、监考安排</a>[ 10-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/488.aspx" target="_self" title="标题：关于各班试场布置情况检查的通知&#xD;点击数：327&#xD;发表时间：09年10月31日">关于各班试场布置情况检查的通知</a>[ 10-31 ]</div>
                        </div>
                    </div>
