...
<head>
    ...
    <title>学科组（备课组）校本教研活动通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">学科组（备课组）校本教研活动通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9215"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9215},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9215";
     ...
     <P> </P>
<P>根据学校校本教研活动计划，请各学科组（备课组）于今天下午第三节课开始教研活动，本次活动主题是依照教师基本功大比武的要求积极准备。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9213.aspx" target="_self" title="标题：符合“三名奖励”方案教师速交材料的通知&#xD;点击数：407&#xD;发表时间：18年10月17日">符合“三名奖励”方案教师速交材料的通知</a>[ 10-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9286.aspx" target="_self" title="标题：2018校级优秀精品课程公示&#xD;点击数：255&#xD;发表时间：18年11月05日">2018校级优秀精品课程公示</a>[ 11-05 ]</div>
                        </div>
                    </div>
