...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22401"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22401},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22401";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/12/202512031436486274.png" style="max-width: 100%; " title="202512031436486274.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22398.aspx" target="_self" title="标题：博雅大讲堂第九期活动通知（本周六）&#xD;点击数：168&#xD;发表时间：25年12月03日">博雅大讲堂第九期活动通知（本周六）</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22403.aspx" target="_self" title="标题：寻物启事（饭卡）&#xD;点击数：33&#xD;发表时间：25年12月03日">寻物启事（饭卡）</a>[ 12-03 ]</div>
                        </div>
                    </div>
