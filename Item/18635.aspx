...
<head>
    ...
    <title>今天高一劳动课暂停的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天高一劳动课暂停的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18635"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18635},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18635";
     ...
     <p style="margin-right:64px;text-indent:64px">
</p><p style="margin-right:64px;text-indent:16px"><span style="font-size:16px">为更好的备练本次运动会，今天高一下午的劳动课暂停，各班可利用此时间练习广播操，团队项目等，练习时注意安全。</span></p><p style="margin-right:64px;text-indent:400px"><span style="font-size:16px"> </span></p><p style="margin-right:64px;text-align:right;text-indent:400px"><span style="font-size:16px">德育处</span></p><p style="text-align:right;text-indent:416px"><span style="font-size:16px">2023</span><span style="font-size:16px">年10月17日</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18634.aspx" target="_self" title="标题：关于仪仗队、国旗队、会徽队成员参加彩排的通知&#xD;点击数：204&#xD;发表时间：23年10月17日">关于仪仗队、国旗队、会徽队成员参加彩排的通知</a>[ 10-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18636.aspx" target="_self" title="标题：学生会议通知&#xD;点击数：232&#xD;发表时间：23年10月18日">学生会议通知</a>[ 10-18 ]</div>
                        </div>
                    </div>
