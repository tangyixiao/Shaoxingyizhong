...
<head>
    ...
    <title>研究性学习课程上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2371"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2371},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2371";
     ...
     <P>                             </P>
<P>                                   研究性学习课程上课通知</P>
<P>      高一全体学生于周二（9月7日）下午第三、第四节课到报告厅参加研究性学习课程的培训。</P>
<P>      高二全体学生于周三（9月8日）下午第三、第四节课到报告厅参加研究性学习课程的培训。</P>
<P>请各位学生携带研究性学习教材和笔记，同时希望班主任老师协助做好入场秩序维护工作。</P>
<P>    座位表如下：（请高一（3）班自带凳子，高二（4）班自带凳子）</P>
<P>    <A title=高一座位表 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201009/2010090617032638.xls">高一座位表</A>、<A title=高二座位表 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201009/2010090617040986.xls">高二座位表</A></P>
<P> </P>
<P>                                                                          教学处</P>
<P>                                                                             9.6</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2359.aspx" target="_self" title="标题：9月11日三项考试监考安排&#xD;点击数：585&#xD;发表时间：10年09月06日">9月11日三项考试监考安排</a>[ 09-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2374.aspx" target="_self" title="标题：三项考试考点组织机构&#xD;点击数：368&#xD;发表时间：10年09月07日">三项考试考点组织机构</a>[ 09-07 ]</div>
                        </div>
                    </div>
