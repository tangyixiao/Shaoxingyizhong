...
<head>
    ...
    <title>大课间及时出操的提醒--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18520"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18520},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18520";
     ...
     <p style="text-indent:196px"> 
</p><p>各班级：</p><p style="text-indent:28px">大课间锻炼是学生锻炼放松的一个重要途径。按照目前学校的作息安排大课间锻炼只有二十五分钟的时间，它包括进场、做操/跑操、退场三个环节，时间比较紧凑，第二节下课稍迟些就会影响整体锻炼效果，影响下一节课的上课。望各班主任能再次向学生强调第二节一结束马上下楼，上午上第二节课的老师能准时结束教学任务，避免出现像昨天高一某班出操时间迟到约五分钟的现象。</p><p style="text-indent:28px"> </p><p style="text-indent:250px">                                     德育处</p><p style="text-indent:250px">                                    2023年9月28日星期四</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18518.aspx" target="_self" title="标题：德育检查反馈&#xD;点击数：143&#xD;发表时间：23年09月28日">德育检查反馈</a>[ 09-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18521.aspx" target="_self" title="标题：9.27班级一日考核&#xD;点击数：64&#xD;发表时间：23年09月28日">9.27班级一日考核</a>[ 09-28 ]</div>
                        </div>
                    </div>
