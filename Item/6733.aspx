...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6733"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6733},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6733";
     ...
     <FONT size=4>因孙彩凤老师有事外出，今天下午高一《协商民主与模拟政协活动课程》选修课改自修，请选报该课程的学生在相应教室自修，教学处将进行点名。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6729.aspx" target="_self" title="标题：高三培优班面试讲座通知&#xD;点击数：325&#xD;发表时间：17年04月14日">高三培优班面试讲座通知</a>[ 04-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6737.aspx" target="_self" title="标题：高三模拟考试场编排和监考安排&#xD;点击数：860&#xD;发表时间：17年04月17日">高三模拟考试场编排和监考安排</a>[ 04-17 ]</div>
                        </div>
                    </div>
