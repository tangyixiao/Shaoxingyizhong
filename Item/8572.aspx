...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8572"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8572},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8572";
     ...
     <!--StartFragment -->
<DIV><FONT size=4>5月18日（周五），高一语文教师和唐海燕老师（高三）外出参加教研活动（优质课评比），相关班级语文课改自修。</FONT><BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8559.aspx" target="_self" title="标题：高三精英班上课通知&#xD;点击数：293&#xD;发表时间：18年05月16日">高三精英班上课通知</a>[ 05-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8584.aspx" target="_self" title="标题：高二英语+七选三模拟考试通知&#xD;点击数：495&#xD;发表时间：18年05月18日">高二英语+七选三模拟考试通知</a>[ 05-18 ]</div>
                        </div>
                    </div>
