...
<head>
    ...
    <title>关于上交竞赛奖状奖牌的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于上交竞赛奖状奖牌的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5422"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5422},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5422";
     ...
     请数学、信息学、物理、化学、生物、天文竞赛的指导老师，将2015学年度获得浙江赛区一等奖以上的学生的奖状或奖牌在本周四放学前交给周文龙，开学典礼颁奖用。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5412.aspx" target="_self" title="标题：“中华资源库”试用通知&#xD;点击数：187&#xD;发表时间：16年08月12日">“中华资源库”试用通知</a>[ 08-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5425.aspx" target="_self" title="标题：目前可以使用的下载资源网账号和密码&#xD;点击数：281&#xD;发表时间：16年08月16日">目前可以使用的下载资源网账号和密码</a>[ 08-16 ]</div>
                        </div>
                    </div>
