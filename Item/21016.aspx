...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21016"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21016},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21016";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/3/202503111033093179.png" style="max-width: 100%; " title="202503111033093179.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21011.aspx" target="_self" title="标题：寻物启事（饭卡）&#xD;点击数：51&#xD;发表时间：25年03月04日">寻物启事（饭卡）</a>[ 03-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21021.aspx" target="_self" title="标题：博雅大讲堂活动通知（本周六）&#xD;点击数：180&#xD;发表时间：25年03月05日">博雅大讲堂活动通知（本周六）</a>[ 03-05 ]</div>
                        </div>
                    </div>
