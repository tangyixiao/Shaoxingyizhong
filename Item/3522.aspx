...
<head>
    ...
    <title>高三党员会议通知--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三党员会议通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高三党员会议通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年03月15日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3522"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3522},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3522";
     ...
     <P>高三党员会议通知</P>
<P>时间：3月16日下午第四节课开始</P>
<P>地点：3-309（高三8班边上的答疑室）</P>
<P>希高三支部全体党员准时例会</P>
<P>          高三党支部</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3487.aspx" target="_self" title="标题：失物招领(公交IC卡)&#xD;点击数：603&#xD;发表时间：11年03月10日">失物招领(公交IC卡)</a>[ 03-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3813.aspx" target="_self" title="标题：高三近期工作安排&#xD;点击数：1089&#xD;发表时间：11年04月25日">高三近期工作安排</a>[ 04-25 ]</div>
                        </div>
                    </div>
