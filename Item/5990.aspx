...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5990"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5990},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5990";
     ...
     <P><FONT size=4>1、因数学组全体老师外出参加教研活动，今天下午高一年级《数学培优》、《数学能力提升》选修课改自修，请选报该课程的学生在相应教室自修，教学处将进行点名。</FONT></P>
<P><FONT size=4>2、因余真、王佩金老师外出参加心理健康教师专业技能大赛，今天下午高一年级《心理学与生活》、《团体心理素质拓展》选修课改自修，请选报该课程的学生在相应教室自修，教学处将进行点名。(选报《团体心理素质拓展》的学生在高一（1）班教室自修）</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5986.aspx" target="_self" title="标题：数学教研活动通知&#xD;点击数：273&#xD;发表时间：16年11月23日">数学教研活动通知</a>[ 11-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5995.aspx" target="_self" title="标题：2016学年学生体检通知&#xD;点击数：445&#xD;发表时间：16年11月24日">2016学年学生体检通知</a>[ 11-24 ]</div>
                        </div>
                    </div>
