...
<head>
    ...
    <title>关于及时上报疫情的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于及时上报疫情的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：安全</span> <span>发布时间：2009年09月18日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=299"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:299},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=299";
     ...
     <DIV><FONT size=3>各班主任:</FONT></DIV>
<DIV><FONT size=3>       针对当前我校发生疫情的实际情况,按照教育局和疾控部门的要求,我校在进一步采取预防、隔离等积极措施的同时，还须认真做好疫情上报的工作，现提出以下要求：</FONT></DIV>
<DIV><FONT size=3>1. 每天三检（晨检、午检、晚检），如发现学生体温不正常，立即劝其上医院就诊或到医务室进一步检查，并在第一时间把情
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/294.aspx" target="_self" title="标题：关于进一步加强体温测量工作的通知&#xD;点击数：401&#xD;发表时间：09年09月17日">关于进一步加强体温测量工作的通知</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/312.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.13-9.19）&#xD;点击数：338&#xD;发表时间：09年09月23日">绍兴一中校园晚间安全检查公告(2009.13-9.19）</a>[ 09-23 ]</div>
                        </div>
                    </div>
