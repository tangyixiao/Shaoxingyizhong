...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1704"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1704},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1704";
     ...
     <P>                      工会通知</P>
<P>      今天下午第四节课在行政楼三楼会议室召开工会委员和工会小组长会议，请有关各位按时参加。</P>
<P>                                                        绍兴一中工会</P>
<P>                                                           2010.4.16</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1703.aspx" target="_self" title="标题：文明办公室检查&#xD;点击数：529&#xD;发表时间：10年04月16日">文明办公室检查</a>[ 04-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1735.aspx" target="_self" title="标题：工会通知&#xD;点击数：669&#xD;发表时间：10年04月21日">工会通知</a>[ 04-21 ]</div>
                        </div>
                    </div>
