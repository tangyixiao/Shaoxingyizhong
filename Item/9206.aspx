...
<head>
    ...
    <title>音乐课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9206"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9206},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9206";
     ...
     <FONT size=4>因音乐组王海燕、童莉芳老师外出参加2018年全省中小学生艺术节，10月15日至19日音乐课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9195.aspx" target="_self" title="标题：10月13日高三试卷分析安排&#xD;点击数：400&#xD;发表时间：18年10月12日">10月13日高三试卷分析安排</a>[ 10-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9208.aspx" target="_self" title="标题：今天下午高三数学学考模拟考安排&#xD;点击数：361&#xD;发表时间：18年10月15日">今天下午高三数学学考模拟考安排</a>[ 10-15 ]</div>
                        </div>
                    </div>
