...
<head>
    ...
    <title>党员大会通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=456"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:456},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=456";
     ...
     <P><FONT size=3>     定于今天下午3:30开始在行政楼五楼会议室举行全体党员大会,请全体党员准时出席,同时请随带笔.有课的老师请改自修.</FONT></P>
<P><FONT size=3>     本周有下列老师生日,在此诚祝这些老师生日快乐!(因今天的教工大会改党员大会,故不在会上另行祝贺)</FONT></P>
<P><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/453.aspx" target="_self" title="标题：未成年人医保参保学生交费有关问题（班主任）&#xD;点击数：450&#xD;发表时间：09年10月26日">未成年人医保参保学生交费有关问题（班主任）</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/459.aspx" target="_self" title="标题：教工体检提醒&#xD;点击数：512&#xD;发表时间：09年10月26日">教工体检提醒</a>[ 10-26 ]</div>
                        </div>
                    </div>
