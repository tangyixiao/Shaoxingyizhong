...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10563"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10563},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10563";
     ...
     <FONT size=4>今天（周三）下午体育老师外出教研活动，相关班级体育课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10561.aspx" target="_self" title="标题：学生证领取与注册通知&#xD;点击数：288&#xD;发表时间：19年09月17日">学生证领取与注册通知</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10576.aspx" target="_self" title="标题：高三部分课程改自修通知&#xD;点击数：375&#xD;发表时间：19年09月19日">高三部分课程改自修通知</a>[ 09-19 ]</div>
                        </div>
                    </div>
