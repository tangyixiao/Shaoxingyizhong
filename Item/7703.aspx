...
<head>
    ...
    <title>关于规范停车的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于规范停车的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：安全处</span> <span>发布时间：2017年11月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7703"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7703},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7703";
...
<P><FONT size=4>    地下车库和地面教职工停车场目前已经施工完成，请全校教工明日起，将汽车、电瓶车有序停入地下或地面车位。谢谢大家配合！</FONT></P>
<P><FONT size=4>安全处</FONT></P>
<P><FONT size=4>2017.11.28</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7683.aspx" target="_self" title="标题：各班安全委员到医务室领取健康资料通知&#xD;点击数：102&#xD;发表时间：17年11月27日">各班安全委员到医务室领取健康资料通知</a>[ 11-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7717.aspx" target="_self" title="标题：近期安全警示&#xD;点击数：337&#xD;发表时间：17年11月30日">近期安全警示</a>[ 11-30 ]</div>
                        </div>
                    </div>
