...
<head>
    ...
    <title>高三音乐课、体育课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三音乐课、体育课改自修</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2759"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2759},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2759";
     ...
     <FONT size=5>11月1日至11月3日，高三音乐课、体育课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2750.aspx" target="_self" title="标题：高一、高二期中考试场布置要求&#xD;点击数：668&#xD;发表时间：10年10月29日">高一、高二期中考试场布置要求</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2770.aspx" target="_self" title="标题：高一、高二班主任：中科大少年班招生&#xD;点击数：481&#xD;发表时间：10年11月03日">高一、高二班主任：中科大少年班招生</a>[ 11-03 ]</div>
                        </div>
                    </div>
