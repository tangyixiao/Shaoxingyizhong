...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2039"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2039},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2039";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
            ...
            各位需要提交述职报告的同志，今天是提交日期的最后一天，请不要忘记上传。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2033.aspx" target="_self" title="标题：上午第四节课下课有关的通知&#xD;点击数：726&#xD;发表时间：10年06月11日">上午第四节课下课有关的通知</a>[ 06-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2041.aspx" target="_self" title="标题：请交述职报告的通知&#xD;点击数：592&#xD;发表时间：10年06月13日">请交述职报告的通知</a>[ 06-13 ]</div>
                        </div>
                    </div>
