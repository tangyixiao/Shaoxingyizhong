...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18441"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18441},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18441";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2023/9/202309190849042909.png" style="max-width: 100%; " title="202309190849042909.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18439.aspx" target="_self" title="标题：失物招领（钥匙）&#xD;点击数：44&#xD;发表时间：23年09月18日">失物招领（钥匙）</a>[ 09-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18442.aspx" target="_self" title="标题：关于高一、高二、高三三个年段进行大扫除的通知&#xD;点击数：143&#xD;发表时间：23年09月18日">关于高一、高二、高三三个年段进行大扫除的通知</a>[ 09-18 ]</div>
                        </div>
                    </div>
