...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9297"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9297},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9297";
     ...
     <FONT size=4>周三历史组全体老师外出参加教研活动，相关班级历史课改自修，历史走班学生在相应上课教室自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9291.aspx" target="_self" title="标题：高三周三上午临时课表&#xD;点击数：296&#xD;发表时间：18年11月06日">高三周三上午临时课表</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9298.aspx" target="_self" title="标题：高一、高二学习委员会议通知&#xD;点击数：221&#xD;发表时间：18年11月07日">高一、高二学习委员会议通知</a>[ 11-07 ]</div>
                        </div>
                    </div>
