...
<head>
    ...
    <title>温馨提示：德育考评--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3254"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3254},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3254";
     ...
     <FONT size=6>    </FONT><FONT size=5>请各班尽快将德育考评结果上交。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3251.aspx" target="_self" title="标题：值周检查情况汇总（1月13日星期四）&#xD;点击数：352&#xD;发表时间：11年01月14日">值周检查情况汇总（1月13日星期四）</a>[ 01-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3255.aspx" target="_self" title="标题：绍兴一中2010年国庆美术作品展结果（更正）&#xD;点击数：450&#xD;发表时间：11年01月15日">绍兴一中2010年国庆美术作品展结果（更正）</a>[ 01-15 ]</div>
                        </div>
                    </div>
