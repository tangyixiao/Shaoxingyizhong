...
<head>
    ...
    <title>感谢原高一（7）班、（10）班、（11）班三个团支部--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">感谢原高一（7）班、（10）班、（11）班三个团支部</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年09月10日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=239"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:239},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=239";
     ...
     <FONT size=5><STRONG>    原高一（7）班、（10）班、（11）班三个团支部心系贫困学生，把义卖所得的款项全部捐献给了本校的贫困学生。所捐款项共计3075元，其中原高一（7）班捐2275元，（10）（11）班捐800元。按照这些班级团支部的意愿，这笔款项已送到了原高三一贫困学生手中，解了这个学生的燃眉之急。在此，向上述班级的学生深表感谢。</STRONG></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/234.aspx" target="_self" title="标题：我最喜欢的校服式样推荐&#xD;点击数：607&#xD;发表时间：09年09月09日">我最喜欢的校服式样推荐</a>[ 09-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/240.aspx" target="_self" title="标题：2009年高一军训会操结果&#xD;点击数：471&#xD;发表时间：09年09月10日">2009年高一军训会操结果</a>[ 09-10 ]</div>
                        </div>
                    </div>
