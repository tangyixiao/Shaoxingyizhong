    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：安全</span> <span>发布时间：2009年09月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=224"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:224},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=224";
     ...
     <DIV><FONT face=仿宋_GB2312 size=3>各位班主任：</FONT></DIV>
<DIV><FONT face=仿宋_GB2312 size=3>   目前甲型H1N1流感防控形势日益严峻，为了进一步加强我校甲型H1N1流感的预防工作，再次要求班主任做好如下工作：</FONT></DIV>
<DIV><FONT face=仿宋_GB2312 size=3>   1.晨检工作。要求每位学生每天必须进行早晚两次的体温测</FONT><
                        ...
                        <div class="others">
                            ...
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/250.aspx" target="_self" title="标题：甲型H1N1流感预防措施&#xD;点击数：406&#xD;发表时间：09年09月11日">甲型H1N1流感预防措施</a>[ 09-11 ]</div>
                        </div>
                    </div>
