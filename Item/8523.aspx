...
<head>
    ...
    <title>高三精英班英语上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8523"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8523},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8523";
     ...
     <P><FONT size=4>主题：高考作文</FONT></P>
<P><FONT size=4>主讲：戴军熔（浙江省特级教师；绍兴市高中英语教研员）</FONT></P>
<P><FONT size=4>时间：5月11日（星期五）下午三、四节</FONT></P>
<P><FONT size=4>地点：3106</FONT></P>
<P><FONT size=4>请听课同学提早五分钟到上课教室！</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8515.aspx" target="_self" title="标题：数学教研活动通知&#xD;点击数：284&#xD;发表时间：18年05月09日">数学教研活动通知</a>[ 05-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8526.aspx" target="_self" title="标题：高一学生指纹采集安排&#xD;点击数：553&#xD;发表时间：18年05月11日">高一学生指纹采集安排</a>[ 05-11 ]</div>
                        </div>
                    </div>
