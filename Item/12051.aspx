...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12051"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12051},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12051";
     ...
     <FONT size=4>明天（周四）下午历史组全体老师外出参加教研活动，相关班级历史课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12045.aspx" target="_self" title="标题：补做心电图通知&#xD;点击数：256&#xD;发表时间：20年10月28日">补做心电图通知</a>[ 10-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12052.aspx" target="_self" title="标题：高一选修课开始上课通知&#xD;点击数：490&#xD;发表时间：20年10月28日">高一选修课开始上课通知</a>[ 10-28 ]</div>
                        </div>
                    </div>
