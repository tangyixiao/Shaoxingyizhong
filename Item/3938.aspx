...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3938"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3938},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3938";
     ...
     <P>                                   文明办公室检查</P>
<P>   今天下午第四节课进行文明办公室检查,请各年级今天白天值班的老师下午第四节课到卓校助办公室集中.</P>
<P> </P>
<P>                                   校文明办公室检查小组</P>
<P>                                          2011.5.12</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3901.aspx" target="_self" title="标题：工会会议通知&#xD;点击数：512&#xD;发表时间：11年05月09日">工会会议通知</a>[ 05-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3947.aspx" target="_self" title="标题：强调工会锻炼时间&#xD;点击数：637&#xD;发表时间：11年05月13日">强调工会锻炼时间</a>[ 05-13 ]</div>
                        </div>
                    </div>
