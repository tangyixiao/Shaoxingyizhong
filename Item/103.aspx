...
<head>
    ...
    <title>关于全体住校生会议通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=103"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:103},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=103";
     ...
     <P>各班主任：</P>
<P>请指定好本班住校生负责人1—2名，并通知本班住校生今天下午四点整在学校报告厅集中开会，按照指定位置就座，由指定负责人点名。</P>
                        ...
                        <div class="others">
                            ...
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/104.aspx" target="_self" title="标题：2008学年第二学期优秀寝室，优秀寝室长，优秀楼层长名单&#xD;点击数：28&#xD;发表时间：09年08月16日">2008学年第二学期优秀寝室，优秀寝室长，优秀楼层长名单</a>[ 08-16 ]</div>
                        </div>
                    </div>
