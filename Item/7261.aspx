...
<head>
    ...
    <title>本周四下午考试结束后高二各班同学参与拔草通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">本周四下午考试结束后高二各班同学参与拔草通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7261"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7261},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7261";
     ...
     <P>高二各班班长，劳动委员请注意：本周四下午最后一场考试结束后（15:30），请组织本班同学下楼拔草（清除花坛，绿化带等处的杂草），请大家互相转告，积极参与。</P>
<P>具体各班除草划分区域见下图<A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201708/2017083019525272.png" target=_blank><IMG onmousewheel="return bbimg(this)" border=0 src="/Shaoxingyizhong/UploadFiles/UploadFiles/201708/2017083019525272.png" width=897 onload=resizepic(this) height=600> </A></P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7257.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：175&#xD;发表时间：17年08月30日">表扬与失物招领</a>[ 08-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7262.aspx" target="_self" title="标题：开学典礼颁奖彩排通知&#xD;点击数：440&#xD;发表时间：17年08月31日">开学典礼颁奖彩排通知</a>[ 08-31 ]</div>
                        </div>
                    </div>
