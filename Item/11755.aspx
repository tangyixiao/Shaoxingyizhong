...
<head>
    ...
    <title>关于师训平台学评教的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于师训平台学评教的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11755"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11755},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11755";
     ...
     <P>各位老师：</P>
<P>上学期培训项目现在可以进行评价，请于9月5日前登录师训平台进行评价，否则无法获得培训学分，影响下一轮选课。</P>
<P>（温馨提醒：部分老师目前尚未完成选课，请抓紧时间于9月5日前完成选课，逾期无法补报！）</P>
<P> </P>
<P>学评教具体操作如下：</P>
<P>1.登录师训管理平台。如忘记密码，请使用“忘记密码”功能找回。部分老师登录时可能提示为保证信息安全要重新修改密码，请修改密码后重新登录。</P>
<P>2.点击“自主选课”——“培训记录查询”</P>
<P>3.点击培训项目，点击评价，然后提交评价意见</P>
<P><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/202009/2020090210165020.png" target=_blank><IMG onload=resizepic(this) onmousewheel="return bbimg(this)" border=0 src="/Shaoxingyizhong/UploadFiles/UploadFiles/202009/2020090210165020.png" width=2306 height=946> </A></P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11747.aspx" target="_self" title="标题：教研组长会议通知&#xD;点击数：263&#xD;发表时间：20年09月01日">教研组长会议通知</a>[ 09-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11760.aspx" target="_self" title="标题：9月份市直教研活动安排&#xD;点击数：336&#xD;发表时间：20年09月03日">9月份市直教研活动安排</a>[ 09-03 ]</div>
                        </div>
                    </div>
