...
<head>
    ...
    <title>高三大课间操结束通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7071"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7071},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7071";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
              ...
              高三学生从明天开始大课间操暂停，高一、高二照常进行。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7057.aspx" target="_self" title="标题：大扫除暂停通知&#xD;点击数：156&#xD;发表时间：17年05月31日">大扫除暂停通知</a>[ 05-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7072.aspx" target="_self" title="标题：绍兴一中2017级推荐生报到仪式&#xD;点击数：448&#xD;发表时间：17年06月02日">绍兴一中2017级推荐生报到仪式</a>[ 06-02 ]</div>
                        </div>
                    </div>
