...
<head>
    ...
    <title>关于传达室东侧非机动车停车通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于传达室东侧非机动车停车通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1238"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1238},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1238";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3>   </FONT><STRONG><FONT size=4>传达室东侧的汽车停车处，有许多电动车、自行车，部分是门卫师傅从车棚拉过来的车，因为没有上锁。其余的车辆请大家自学地停回自行车棚去。校门前的整洁人人有责。</FONT></STRONG></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1237.aspx" target="_self" title="标题：关于行政工会小组代表分组讨论会议更改地点的通知&#xD;点击数：803&#xD;发表时间：10年01月19日">关于行政工会小组代表分组讨论会议更改地点的通知</a>[ 01-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1239.aspx" target="_self" title="标题：高二教代会代表讨论时间改变的通知&#xD;点击数：633&#xD;发表时间：10年01月19日">高二教代会代表讨论时间改变的通知</a>[ 01-19 ]</div>
                        </div>
                    </div>
