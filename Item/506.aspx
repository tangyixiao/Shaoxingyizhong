...
<head>
    ...
    <title>关于参加2009年市属中学田径运动会的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于参加2009年市属中学田径运动会的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年11月04日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=506"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:506},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=506";
     ...
     <DIV align=left><FONT size=4>     2009年11月5日-7日将举行市属中学田径运动会，学校选派下列同学参加，希望相关班级的班主任能继续给予关心和支持。学校运动队由王柏根、阮国华、方大林、周国才等老师带队。在运动会期间，以上老师所带学生的体育课改为教室自修，请高一高二班主任及时通知本班学生。在此，我们也预祝学校运动队在本次运动会上取得辉煌成绩。</FONT></DIV>
<DIV align=left><FONT size=4></F
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/504.aspx" target="_self" title="标题：高二、高三班主任(有关会考报名）：&#xD;点击数：386&#xD;发表时间：09年11月04日">高二、高三班主任(有关会考报名）：</a>[ 11-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/507.aspx" target="_self" title="标题：关于推荐参加绍兴市第六届中小学学科带头人评选活动的通知&#xD;点击数：249&#xD;发表时间：09年11月04日">关于推荐参加绍兴市第六届中小学学科带头人评选活动的通知</a>[ 11-04 ]</div>
                        </div>
                    </div>
