...
<head>
    ...
    <title>关于督促勤开门窗防控甲型流感的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于督促勤开门窗防控甲型流感的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=822"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:822},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=822";
     ...
     <DIV>
<DIV><FONT color=#000000 size=3>各位老师：</FONT></DIV>
<DIV><FONT color=#000000 size=3>    几次巡视，发现有部分班级没有养成勤开门窗的习惯。教室里不开门窗，空气不易流通，这不利于甲型流感的有效防控。为了进一步有效防控甲型流感，学校要求各班班主任具体落实专门人员负责勤开门窗的工作，至少做到教室南面的门窗一律打开，同时也要求全体任课老师在正式上课前负责督查上课班级的开门窗情况，各年段值班人员具体负责检查，行政值周领导负责抽查。事实已经证明，在如此晴好的天气勤开门窗可以有效遏制流感的蔓延。</FONT></DIV></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/757.aspx" target="_self" title="标题：自行车上锁情况检查通报&#xD;点击数：348&#xD;发表时间：09年12月02日">自行车上锁情况检查通报</a>[ 12-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/836.aspx" target="_self" title="标题：麻疹疫苗接种注意事项&#xD;点击数：249&#xD;发表时间：09年12月03日">麻疹疫苗接种注意事项</a>[ 12-03 ]</div>
                        </div>
                    </div>
