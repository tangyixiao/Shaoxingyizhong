...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3901"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3901},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3901";
     ...
     <P>                                            工会会议通知</P>
<P>     定于明天下午第四节课在行政楼三楼会议室召开工会委员和工会小组长会议，请各安排好工作，准时参加。</P>
<P>                                </P>
<P>                                                            绍兴一中工会</P>
<P>                                                              2011.5.9</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3900.aspx" target="_self" title="标题：关于远足活动的通知&#xD;点击数：608&#xD;发表时间：11年05月09日">关于远足活动的通知</a>[ 05-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3938.aspx" target="_self" title="标题：文明办公室检查&#xD;点击数：589&#xD;发表时间：11年05月12日">文明办公室检查</a>[ 05-12 ]</div>
                        </div>
                    </div>
