...
<head>
    ...
    <title>今天下午考务培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5710"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5710},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5710";
     ...
     <P><STRONG><FONT size=3>今天</FONT></STRONG><B style="mso-bidi-font-weight: normal"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">下午第<SPAN lang=EN-US>4</SPAN>节学考选考考务培训 </SPAN></B><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">。</SPAN></P>
<P><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">地点行政<SPAN lang=EN-US>5</SPAN>楼会议室，参加对象全体监考老师（包括本校的监考、预备、流动、视频监考和验卷，到外校的监考、预备）。</SPAN></P>
<P><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">请老师们相互转告，准时参加。</SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5705.aspx" target="_self" title="标题：2016年10月学考选考考点组织机构&#xD;点击数：258&#xD;发表时间：16年10月11日">2016年10月学考选考考点组织机构</a>[ 10-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5717.aspx" target="_self" title="标题：2016年10月13日学考选考试场布置要求&#xD;点击数：271&#xD;发表时间：16年10月13日">2016年10月13日学考选考试场布置要求</a>[ 10-13 ]</div>
                        </div>
                    </div>
