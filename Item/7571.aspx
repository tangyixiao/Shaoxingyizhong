...
<head>
    ...
    <title>关于包干区划分和打扫时间的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于包干区划分和打扫时间的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7571"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7571},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7571";
     ...
     <P>全校师生请注意：</P>
<P>        自本周开始，各班级包干区卫生按新划分区域打扫（详见附件），高一年段打扫时间为周三下午劳动课，周四上午检查；高二高三年段打扫时间为周一下午劳动课，周二上午检查，请相互转告。</P>
<P><A title=附件：包干区划分 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201711/2017110613453050.doc"><FONT color=#ff0000>附件：包干区划分</FONT></A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7568.aspx" target="_self" title="标题：高二（8）班值周小结&#xD;点击数：89&#xD;发表时间：17年11月06日">高二（8）班值周小结</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7579.aspx" target="_self" title="标题：关于规范学生自修纪律的通知&#xD;点击数：253&#xD;发表时间：17年11月07日">关于规范学生自修纪律的通知</a>[ 11-07 ]</div>
                        </div>
                    </div>
