...
<head>
    ...
    <title>通知：团学联工作例会--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7923"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7923},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7923";
     ...
     <P>  今天中午<STRONG>12:20</STRONG>在<STRONG>行政楼三楼课余党校教室</STRONG>举行团学联主要干部工作例会，请团学联主席团、各部门部长副部长、高一高二年级团总支准时参加，随带纸笔；组织部安排签到。</P>
<P>        请相关同学向班主任做好请假工作。</P>
<P align=right>校团委<BR>2018年1月8日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7912.aspx" target="_self" title="标题：树人导报领取通知&#xD;点击数：122&#xD;发表时间：18年01月05日">树人导报领取通知</a>[ 01-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7945.aspx" target="_self" title="标题：通知：领取树人导报&#xD;点击数：102&#xD;发表时间：18年01月12日">通知：领取树人导报</a>[ 01-12 ]</div>
                        </div>
                    </div>
