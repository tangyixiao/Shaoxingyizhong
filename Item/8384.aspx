...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8384"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8384},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8384";
     ...
     <FONT size=4>明天（周四）下午生物组全体老师外出参加教研活动，相关班级生物课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8379.aspx" target="_self" title="标题：高三年级参加竞赛学生名单公示&#xD;点击数：447&#xD;发表时间：18年04月17日">高三年级参加竞赛学生名单公示</a>[ 04-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8387.aspx" target="_self" title="标题：物理教研活动通知&#xD;点击数：233&#xD;发表时间：18年04月18日">物理教研活动通知</a>[ 04-18 ]</div>
                        </div>
                    </div>
