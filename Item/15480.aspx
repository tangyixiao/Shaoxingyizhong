...
<head>
    ...
    <title>大课间室内操通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15480"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15480},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15480";
     ...
     <p>各班同学请注意，今、明两天大课间跑操暂停，改为室内操。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15479.aspx" target="_self" title="标题：4.26班级一日考核&#xD;点击数：43&#xD;发表时间：22年04月27日">4.26班级一日考核</a>[ 04-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15484.aspx" target="_self" title="标题：4.27班级一日考核&#xD;点击数：32&#xD;发表时间：22年04月28日">4.27班级一日考核</a>[ 04-28 ]</div>
                        </div>
                    </div>
