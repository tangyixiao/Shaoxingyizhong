...
<head>
    ...
    <title>通用技术课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1560"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1560},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1560";
     ...
     3月30日（星期二）下午通用技术老师参加教研活动，所任课班级相应课程改自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1559.aspx" target="_self" title="标题：温馨提示&#xD;点击数：675&#xD;发表时间：10年03月30日">温馨提示</a>[ 03-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1561.aspx" target="_self" title="标题：3月30日（周二）高一地理学分考监考安排&#xD;点击数：530&#xD;发表时间：10年03月30日">3月30日（周二）高一地理学分考监考安排</a>[ 03-30 ]</div>
                        </div>
                    </div>
