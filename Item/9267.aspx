...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9267"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9267},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9267";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
              ...
              有同学于上周丢失一块罗西尼手表（银白色机械表），请拾到者归还至德育处2114。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9265.aspx" target="_self" title="标题：“文明寝室”表彰公告&#xD;点击数：219&#xD;发表时间：18年10月29日">“文明寝室”表彰公告</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9284.aspx" target="_self" title="标题：关于“美丽教室”审核、检查的通知&#xD;点击数：164&#xD;发表时间：18年11月05日">关于“美丽教室”审核、检查的通知</a>[ 11-05 ]</div>
                        </div>
                    </div>
