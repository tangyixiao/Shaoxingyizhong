...
<head>
    ...
    <title>今天下午温馨教室布置情况检查--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天下午温馨教室布置情况检查</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1014"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1014},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1014";
     ...
     <P><FONT color=#000000 size=3><STRONG>各班主任：</STRONG></FONT></P>
<P><FONT color=#000000 size=3><STRONG>     按照计划安排，今天下午第四节课对各班温馨教室的布置情况进行检查。</STRONG></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1004.aspx" target="_self" title="标题：关于采用新课间操提示音乐的通知&#xD;点击数：332&#xD;发表时间：09年12月14日">关于采用新课间操提示音乐的通知</a>[ 12-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1017.aspx" target="_self" title="标题：关于对学生日常行为规范进行检查的通知&#xD;点击数：390&#xD;发表时间：09年12月14日">关于对学生日常行为规范进行检查的通知</a>[ 12-14 ]</div>
                        </div>
                    </div>
