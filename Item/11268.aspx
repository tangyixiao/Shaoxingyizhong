...
<head>
    ...
    <title>关于高三各班处理废旧报纸书籍的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高三各班处理废旧报纸书籍的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11268"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11268},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11268";
     ...
     <P><BR>        请高三各班利用今天课间和中午时间归整教室内的物品，将自己不再需要但仍有较大使用价值的学习资料（可留给高一高二）统一放至阶梯教室4112排放整齐；将其他报纸等可回收物，以班级为单位放在教室门口，下午两点将有师傅上门回收。<BR><BR>                                                                                                德育处 团委</P>
<P>                                                                                               2020年4月13日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11266.aspx" target="_self" title="标题：关于2019学年第二学期开学第一课的通知&#xD;点击数：128&#xD;发表时间：20年04月10日">关于2019学年第二学期开学第一课的通知</a>[ 04-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11278.aspx" target="_self" title="标题：高一、高二班主任会议通知（有修改）&#xD;点击数：122&#xD;发表时间：20年04月14日">高一、高二班主任会议通知（有修改）</a>[ 04-14 ]</div>
                        </div>
                    </div>
