...
<head>
    ...
    <title>钱叶粲同学在“走进西澳——浙江省高中英语口语大赛”中荣获一等奖--学校新闻-绍兴市第一中学</title>
...
<li class="li2 last"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_37/Index.aspx" target="_self">学校新闻</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">钱叶粲同学在“走进西澳——浙江省高中英语口语大赛”中荣获一等奖</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校园报道</span> <span>发布时间：2009年08月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=166"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:166},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=166";
...
<TR>
<TD width="90%">
<DIV><FONT color=#000000 size=3>        在由浙江省教育厅、省教研室、省外办、澳大利亚西澳州教育部等部门联合举办的2009年“走进西澳——浙江省高中英语口语大赛”中，我校钱叶粲同学以扎实的英语基本功，娴熟的英语表达能力及敏捷的思维，在全省105名决赛选手中脱颖而出，获得一等奖，为学校争得了荣誉，同时她本人也取得了八月份“西澳之行”的机会。另外一名参赛选手金可慰获得二等奖。特此祝贺!</FONT></DIV>
<DIV><FONT size=4></FONT> </DIV>
<DIV><FONT size=4></FONT> </DIV>
<DIV><IMG src="/Shaoxingyizhong/UploadFiles/UploadFiles/200912/20091208081520583.jpg" border=0></DIV>
<DIV><FONT size=4></FONT> </DIV>
<DIV><FONT size=4></FONT></DIV>
<DIV><FONT size=4></FONT> </DIV></TD>
...
<P><BR></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/143.aspx" target="_self" title="标题：“大学新生&amp;nbsp;结伴同行”北区沙龙在绍兴一中举行&#xD;点击数：861&#xD;发表时间：09年08月26日">“大学新生 结伴同行”北区沙龙在绍兴一中举行</a>[ 08-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/194.aspx" target="_self" title="标题：我校隆重举行新学期开学典礼&#xD;点击数：852&#xD;发表时间：09年09月02日">我校隆重举行新学期开学典礼</a>[ 09-02 ]</div>
                        </div>
                    </div>
