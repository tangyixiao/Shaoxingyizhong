...
<head>
    ...
    <title>关于市直高中调研访谈的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于市直高中调研访谈的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7508"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7508},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7508";
     ...
     <P><FONT size=4>一、今天中午12:30请以下老师到树兰楼（行政楼）三楼会议室三参加调研。</FONT></P>
<P><FONT size=4>具体老师名单如下：</FONT></P>
<P><FONT size=4>王月琴、陈丹燕、张叠、谢澹、陈连原、桑美娟、杨国平、金建忠、沈初见、叶佩莉、何珠芳、王燕、何隽豪、王海燕、邓倬霖、陈义兵、王佩金</FONT></P>
<P><FONT size=4>二、今天中午12:30请高一、高二、高三各班班长到树兰楼（行政楼）三楼会议室一参加调研。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7507.aspx" target="_self" title="标题：10.23早学早读抽检情况（第13次）&#xD;点击数：274&#xD;发表时间：17年10月23日">10.23早学早读抽检情况（第13次）</a>[ 10-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7511.aspx" target="_self" title="标题：语文教研活动通知&#xD;点击数：258&#xD;发表时间：17年10月23日">语文教研活动通知</a>[ 10-23 ]</div>
                        </div>
                    </div>
