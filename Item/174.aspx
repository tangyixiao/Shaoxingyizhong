...
<head>
    ...
    <title>绍兴一中考勤和请假制度征求意见稿--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中考勤和请假制度征求意见稿</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月04日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=174"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:174},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=174";
     ...
     <DIV align=center><FONT size=4>绍兴一中考勤和请假制度</FONT></DIV>
<DIV><FONT size=4>一、考勤</FONT></DIV>
<DIV><FONT size=4>    实行每天考勤的制度。全校教工的考勤分别由年级组长、处室主任负责，考勤时做到严格把关，每天一考，缺勤人员一周一报。</FONT></DIV>
<DIV><FONT size=4>政治学习考勤以座位排位为准，由办公室负责考勤。非特殊情况政治学习（升旗、开学
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/171.aspx" target="_self" title="标题：校园内不乱停车的通知&#xD;点击数：732&#xD;发表时间：09年08月31日">校园内不乱停车的通知</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/179.aspx" target="_self" title="标题：班主任：09年未成年人医疗保障相关通知&#xD;点击数：674&#xD;发表时间：09年08月31日">班主任：09年未成年人医疗保障相关通知</a>[ 08-31 ]</div>
                        </div>
                    </div>
