...
<head>
    ...
    <title>关于组织高三警校体能测试模拟考的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于组织高三警校体能测试模拟考的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17733"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17733},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17733";
     ...
     <p>定于4.25日16:20组织高三警校体能测试模拟考，请要参加的同学于今明两天到器材室登记信息。裁判员：沈祥土  吴丽娟   郑祥霖  王冰洁   陈炳炉   王斌</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17722.aspx" target="_self" title="标题：高三4-5月限时训练安排&#xD;点击数：496&#xD;发表时间：23年04月21日">高三4-5月限时训练安排</a>[ 04-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17740.aspx" target="_self" title="标题：高一期中考成绩分析会议通知&#xD;点击数：293&#xD;发表时间：23年04月24日">高一期中考成绩分析会议通知</a>[ 04-24 ]</div>
                        </div>
                    </div>
