...
<head>
    ...
    <title>重申监考纪律--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3817"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3817},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3817";
     ...
     <P>        今天学校领导在巡视高一、高二期中考试与高三五校联考考场情况时，发现有的监考老师离岗，也有个别监考老师在做与监考工作无关的事，请大家引起注意，认真执行《绍兴一中监考规程》，努力做好监考工作。</P>
<P>                                                                                      教学处</P>
<P>                                                                                                2011/04/26</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3814.aspx" target="_self" title="标题：高三高考体检复检时间再提醒&#xD;点击数：528&#xD;发表时间：11年04月25日">高三高考体检复检时间再提醒</a>[ 04-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3819.aspx" target="_self" title="标题：高三综合素质评价表签名与上交&#xD;点击数：434&#xD;发表时间：11年04月26日">高三综合素质评价表签名与上交</a>[ 04-26 ]</div>
                        </div>
                    </div>
