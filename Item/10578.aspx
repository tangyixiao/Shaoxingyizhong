...
<head>
    ...
    <title>关于高二召开名校协作体考试分析会议的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高二召开名校协作体考试分析会议的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10578"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10578},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10578";
     ...
     <FONT size=4>请全体高二老师于今天下午第4节课到树兰楼三楼会议室二开会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10576.aspx" target="_self" title="标题：高三部分课程改自修通知&#xD;点击数：375&#xD;发表时间：19年09月19日">高三部分课程改自修通知</a>[ 09-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10585.aspx" target="_self" title="标题：关于高三召开名校协作体考试分析会议的通知&#xD;点击数：303&#xD;发表时间：19年09月20日">关于高三召开名校协作体考试分析会议的通知</a>[ 09-20 ]</div>
                        </div>
                    </div>
