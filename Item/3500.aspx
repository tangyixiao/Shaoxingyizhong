...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3500"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3500},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3500";
...
<P><FONT size=4>     根据学校要求，每位班主任在一学年中要对班级每位学生至少进行一次家访，所以班级工作量化考核该项内容以年为单位进行考核。由于推荐先进班级的需要，在四月中旬要进行一次班级工作量化考核，所以近来有新家访记录的，请班主任于四月上旬将“绍兴一中家访回执单”交到德育处，以便统计考核。</FONT></P>
<P><FONT size=4></FONT> </P>
<P><FONT size=4>附件：<A title=绍兴一中班主任家访回执单 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201103/2011031113545323.doc"><STRONG>绍兴一中班主任家访回执单</STRONG></A></FONT></P>
<P><FONT size=4></FONT> </P>
<P><FONT size=4></FONT> </P>
<P><FONT size=4></FONT> </P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3499.aspx" target="_self" title="标题：2011年市属级及以上三好学生、优秀学生干部评比办法&#xD;点击数：755&#xD;发表时间：11年03月11日">2011年市属级及以上三好学生、优秀学生干部评比办法</a>[ 03-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3503.aspx" target="_self" title="标题：值周检查情况汇总（3月11日星期五）&#xD;点击数：428&#xD;发表时间：11年03月12日">值周检查情况汇总（3月11日星期五）</a>[ 03-12 ]</div>
                        </div>
                    </div>
