...
<head>
    ...
    <title>上学期文印室印刷费结算第四次通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">上学期文印室印刷费结算第四次通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3853"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3853},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3853";
     ...
     <P>      上学期文印室印刷费，还有以下班级没有结算，务必在本星期内结算清楚。还没结算班级如下：</P>
<P>高一（2）、（4）、（7）、（9）、（10）班</P>
<P>高二（4）、（11）班</P>
<P>高三（5）、（7）、（8）、（14）、（16）班</P>
<P>                                                            教学处</P>
<P>                                                                  2011/05/03</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3852.aspx" target="_self" title="标题：高三备课组长会议通知&#xD;点击数：376&#xD;发表时间：11年05月03日">高三备课组长会议通知</a>[ 05-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3861.aspx" target="_self" title="标题：2011春师生远足活动提前上课&#xD;点击数：485&#xD;发表时间：11年05月04日">2011春师生远足活动提前上课</a>[ 05-04 ]</div>
                        </div>
                    </div>
