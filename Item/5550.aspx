...
<head>
    ...
    <title>关于领取24字核心价值观展板通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于领取24字核心价值观展板通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5550"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5550},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5550";
     ...
     <P>各位班主任：</P>
<P>    24字社会主义核心价值观展板已做好，还没有上墙的班级请到安全处李峰红老师处领。并要求张贴在教室空调旁边或者教室后贮物柜旁边。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5549.aspx" target="_self" title="标题：表扬&#xD;点击数：218&#xD;发表时间：16年09月20日">表扬</a>[ 09-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5554.aspx" target="_self" title="标题：表扬&#xD;点击数：231&#xD;发表时间：16年09月20日">表扬</a>[ 09-20 ]</div>
                        </div>
                    </div>
