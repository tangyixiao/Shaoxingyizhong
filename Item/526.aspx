...
<head>
    ...
    <title>重申流感隔离要求--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=526"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:526},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=526";
     ...
     <DIV align=center><FONT size=3>                                     &n
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/518.aspx" target="_self" title="标题：重申流感预防措施&#xD;点击数：381&#xD;发表时间：09年11月06日">重申流感预防措施</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/530.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.11.1-11.7）&#xD;点击数：240&#xD;发表时间：09年11月09日">绍兴一中校园晚间安全检查公告(2009.11.1-11.7）</a>[ 11-09 ]</div>
                        </div>
                    </div>
