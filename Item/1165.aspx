...
<head>
    ...
    <title>关于在教室里禁止使用暖手袋的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于在教室里禁止使用暖手袋的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1165"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1165},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1165";
     ...
     <P class=MsoNormal style="BACKGROUND: #f3f7fb; MARGIN: 15pt 0cm 0pt; LINE-HEIGHT: 150%; mso-margin-bottom-alt: auto"><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3>全校师生：</FONT></SPAN></P>
<P class=MsoNormal style="BACKGROUND: #f3f7fb; MARGIN: 15pt 0cm 0pt; TEXT-INDENT: 21pt; LINE-HEIGHT: 150%; mso-margin-bottom-alt: auto; mso-char-indent-count: 2.0"><FONT size=3><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">近来，在检查中发现有少数学生随带暖手袋在教室里取暖或充电的现象。由于</SPAN><SPAN style="LINE-HEIGHT: 150%; FONT-FAMILY: 宋体; mso-bidi-font-size: 10.5pt; mso-bidi-font-family: 宋体; mso-font-kerning: 0pt">我国还没有暖手袋的相关安全认证标准（企业采用的都是自己的标准），市场上销售的暖手袋质量良莠不齐，许多产品潜藏着安全隐患。为了消除这一安全隐患，学校要求学生在教室里禁止使用暖手袋，并请班主任做好检查落实工作。<SPAN lang=EN-US><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1139.aspx" target="_self" title="标题：关于做好防盗防窃工作的通知&#xD;点击数：644&#xD;发表时间：09年12月30日">关于做好防盗防窃工作的通知</a>[ 12-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1170.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.12.28-2010.1.4）&#xD;点击数：320&#xD;发表时间：10年01月05日">绍兴一中校园晚间安全检查公告(2009.12.28-2010.1.4）</a>[ 01-05 ]</div>
                        </div>
                    </div>
