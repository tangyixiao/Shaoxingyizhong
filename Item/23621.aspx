...
<head>
    ...
    <title>9.8班级一日考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23621"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23621},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23621";
     ...
     <p style="text-align: center;"><img src="/UploadFiles/xwzx/2026/9/202609091503335241.png" style="max-width: 100%; " title="202609091503335241.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23620.aspx" target="_self" title="标题：大课间跑操考核员招募通知&#xD;点击数：71&#xD;发表时间：26年09月09日">大课间跑操考核员招募通知</a>[ 09-09 ]</div>
