...
<head>
    ...
    <title>高三本学期文印室文印费结算通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三本学期文印室文印费结算通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4099"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4099},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4099";
     ...
     <P>　　　高三班主任，本学期文印室文印费请于６月４日前到文印室核对清楚后交费．</P>
<P>　　　　　　　　　　　　　　　　　　　　　　教学处</P>
<P>　　　　　　　　　　　　　　　　　　　　　　　　2011/06/01</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4081.aspx" target="_self" title="标题：高一（1）、（2）、（3）、（4）班历史课改自修&#xD;点击数：481&#xD;发表时间：11年05月31日">高一（1）、（2）、（3）、（4）班历史课改自修</a>[ 05-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4100.aspx" target="_self" title="标题：高二三项考试报名拍照&#xD;点击数：610&#xD;发表时间：11年06月01日">高二三项考试报名拍照</a>[ 06-01 ]</div>
                        </div>
                    </div>
