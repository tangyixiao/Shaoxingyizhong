...
<head>
    ...
    <title>高三学生自修安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7581"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7581},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7581";
     ...
     <P><FONT size=4>高三技术走班本周起改自修，请技术1班、技术2班学生到4112阶梯教室自修，技术3班学生到3106教室自修。请相关学生按时到指定教室自修并注意自修教室卫生，教学处将进行点名并会将情况及时反馈给班主任。</FONT></P>
<P><FONT size=4>其他自修学生可到3110教室自修，但不得到其他场所自修，教学处会安排纪律管理，情况会及时反馈给班主任。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7565.aspx" target="_self" title="标题：2017年绍兴一中秋季运动会组委会、裁判员、工作人员名单&#xD;点击数：530&#xD;发表时间：17年11月06日">2017年绍兴一中秋季运动会组委会、裁判员、工作人员名单</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7582.aspx" target="_self" title="标题：运动会彩排通知&#xD;点击数：498&#xD;发表时间：17年11月07日">运动会彩排通知</a>[ 11-07 ]</div>
                        </div>
                    </div>
