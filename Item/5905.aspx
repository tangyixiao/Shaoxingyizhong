...
<head>
    ...
    <title>英语口语竞赛入围学生开会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">英语口语竞赛入围学生开会通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5905"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5905},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5905";
     ...
     <FONT size=4>请参加英语口语竞赛入围的高一高二同学今天下午第四节课到实南301进行培训。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5899.aspx" target="_self" title="标题：信息技术教研活动通知&#xD;点击数：129&#xD;发表时间：16年11月11日">信息技术教研活动通知</a>[ 11-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5906.aspx" target="_self" title="标题：高三期中考试时间调整通知&#xD;点击数：392&#xD;发表时间：16年11月14日">高三期中考试时间调整通知</a>[ 11-14 ]</div>
                        </div>
                    </div>
