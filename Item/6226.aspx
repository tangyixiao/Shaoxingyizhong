...
<head>
    ...
    <title>高二历史走班课上课地点变更通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二历史走班课上课地点变更通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6226"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6226},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6226";
     ...
     因与高三年级考试试场冲突，高二平建树老师历史走班课上课地点改为实南301，请相关同学互相转告，按时到场上课。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6216.aspx" target="_self" title="标题：高三数学、物理培优课暂停通知&#xD;点击数：157&#xD;发表时间：16年12月26日">高三数学、物理培优课暂停通知</a>[ 12-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6231.aspx" target="_self" title="标题：2016学年第一学期期末考试安排&#xD;点击数：813&#xD;发表时间：16年12月27日">2016学年第一学期期末考试安排</a>[ 12-27 ]</div>
                        </div>
                    </div>
