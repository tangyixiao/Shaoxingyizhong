...
<head>
    ...
    <title>甲型H1N1流感预防措施--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">甲型H1N1流感预防措施</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：安全</span> <span>发布时间：2009年09月11日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=250"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:250},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=250";
     ...
     <FONT size=4>1．避免接触流感样症状（发热，咳嗽，流涕等）或肺炎等呼吸道病人。<BR>2．注意个人卫生，经常使用肥皂和清水洗手，尤其在咳嗽或打喷嚏后。<BR>3．避免前往人群拥挤场所。<BR>4．咳嗽或打喷嚏时用纸巾遮住口鼻，然后将纸巾丢进垃圾桶。<BR>5．尽可能频繁开窗，增进居住空间的空气流动。<BR>6．如果戴口罩，必须正确使用和处置，以确保其效力，避免因不正确使用口罩增加传播风险。正确做法：用口罩仔细遮盖嘴和鼻子并系牢，尽可能减少面部与口罩之间的空隙;在口罩受潮或沾染湿气后，换上新的洁
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/224.aspx" target="_self" title="标题：关于进一步加强甲型H1N1流感预防工作的通知&#xD;点击数：616&#xD;发表时间：09年09月07日">关于进一步加强甲型H1N1流感预防工作的通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/256.aspx" target="_self" title="标题：关于学生体检的通知&#xD;点击数：574&#xD;发表时间：09年09月11日">关于学生体检的通知</a>[ 09-11 ]</div>
                        </div>
                    </div>
