...
<head>
    ...
    <title>高一年级值周(白天)工作安排--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一年级值周(白天)工作安排</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高一</span> <span>发布时间：2009年09月01日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=183"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:183},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=183";
     ...
     <DIV><FONT face=Verdana>高一年级值周(白天)工作</FONT>说明：</DIV>
<DIV>1．每日检查早自修、课间操、中午与下午自修情况，记录年级活动，填写值日记录，发现情况及时处理并记录，（自己下载表格，表格在公共文件夹/蒋卫江）。</DIV>
<DIV>2．每人值周3天，写好半周小结。值日记录和半周小结分别在星期四、星期六上午第三节课时上交年级长，年级长当天上交值周领导。</DIV>
<DIV>3．按时传递值日记录本。</DIV>
<DIV>值周安排：</DIV>
<DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/177.aspx" target="_self" title="标题：高一今天（8.31）下午有关事项&#xD;点击数：475&#xD;发表时间：09年08月31日">高一今天（8.31）下午有关事项</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/223.aspx" target="_self" title="标题：高一值周检查反馈&#xD;点击数：420&#xD;发表时间：09年09月07日">高一值周检查反馈</a>[ 09-07 ]</div>
                        </div>
                    </div>
