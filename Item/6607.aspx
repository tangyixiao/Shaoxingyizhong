...
<head>
    ...
    <title>关于创新班老师会议通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6607"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6607},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6607";
     ...
     <P>       各年级创新班老师注意：</P>
<P>        今天下午第四节课在行政楼五楼会议室召开创新班各学科任课老师会议，请相互告知，准时参加，谢谢！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6606.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：83&#xD;发表时间：17年03月22日">表扬与失物招领</a>[ 03-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6608.aspx" target="_self" title="标题：关于“爱水护水礼水”公益观影活动的通知&#xD;点击数：325&#xD;发表时间：17年03月22日">关于“爱水护水礼水”公益观影活动的通知</a>[ 03-22 ]</div>
                        </div>
                    </div>
