...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14199"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14199},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14199";
     ...
     <p>    有同学在高三教学楼丢失白色casio手表一只，若有捡到请上交到德育处。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14198.aspx" target="_self" title="标题：升旗仪式通知&#xD;点击数：284&#xD;发表时间：21年10月18日">升旗仪式通知</a>[ 10-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14204.aspx" target="_self" title="标题：高一大扫除通知&#xD;点击数：55&#xD;发表时间：21年10月19日">高一大扫除通知</a>[ 10-19 ]</div>
                        </div>
                    </div>
