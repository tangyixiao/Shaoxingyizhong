...
<head>
    ...
    <title>全校物理组90学时培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">全校物理组90学时培训通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19967"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19967},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19967";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap: wrap; background-color: rgb(255, 255, 255);">6月13日-14日（本周四、五）</span><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap: wrap; background-color: rgb(255, 255, 255);">全体物理教师参加市直90学时培训，物理课改自修（走班学生在相关教室自修）。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19966.aspx" target="_self" title="标题：音体美、生涯规划及心理健康停课通知&#xD;点击数：221&#xD;发表时间：24年06月12日">音体美、生涯规划及心理健康停课通知</a>[ 06-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19971.aspx" target="_self" title="标题：6.15高二学考模拟考试学生考场安排和监考安排&#xD;点击数：364&#xD;发表时间：24年06月12日">6.15高二学考模拟考试学生考场安排和监考安排</a>[ 06-12 ]</div>
                        </div>
                    </div>
