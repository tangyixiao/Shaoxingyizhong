...
<head>
    ...
    <title>有关期中期末考试的几个规定--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">有关期中期末考试的几个规定</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=466"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:466},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=466";
     ...
     <DIV><B>1</B><B>、<STRONG>考场巡视员、</STRONG></B><B>主考教师和监考人员具体</B><STRONG>职责如下</STRONG><STRONG>：</STRONG><B></B></DIV>
<DIV align=center><STRONG>绍兴一中考场巡视员职责</STRONG></DIV>
<DIV><FONT face=楷体_GB2312>期中、期末考试设考场巡视员，考场巡视员由学校领导担任。主要负责考场秩序的监督责任。其主要职责如下：<BR> &n
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/457.aspx" target="_self" title="标题：温馨提示&#xD;点击数：366&#xD;发表时间：09年10月26日">温馨提示</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/468.aspx" target="_self" title="标题：期中考试时间安排&#xD;点击数：362&#xD;发表时间：09年10月27日">期中考试时间安排</a>[ 10-27 ]</div>
                        </div>
                    </div>
