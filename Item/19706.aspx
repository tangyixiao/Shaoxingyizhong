...
<head>
    ...
    <title>关于高一高二安全委员开会的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一高二安全委员开会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19706"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19706},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19706";
     ...
     <p> 高一、高二各班安全委员：</p><p>         绍兴地铁一号线支线 绍兴一中站 日前已经开通。为倡导文明健康，绿色低碳的生活方式，让交通出行更便捷，请于<strong>4</strong><strong>月28日（周日）中午12：30</strong>到阶梯教室<strong>4106</strong>开会（经常乘坐地铁的同学可一同参加）。请相互转告，准时参会。</p><p>                                                                                            安全处</p><p>                                                                                         2024.04.24</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19696.aspx" target="_self" title="标题：健康教育资料领取通知&#xD;点击数：94&#xD;发表时间：24年04月23日">健康教育资料领取通知</a>[ 04-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19765.aspx" target="_self" title="标题：关于开展防灾减灾宣传作品征集展播活动的通知&#xD;点击数：104&#xD;发表时间：24年05月07日">关于开展防灾减灾宣传作品征集展播活动的通知</a>[ 05-07 ]</div>
                        </div>
                    </div>
