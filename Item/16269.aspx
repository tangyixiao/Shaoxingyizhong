...
<head>
    ...
    <title>团学联纪检部、广电部干事招新通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">团学联纪检部、广电部干事招新通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16269"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16269},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16269";
     ...
     <p>请有意向加入纪检部、广电部（包括已交表和未交表）的同学于9月30日（周五）中午12:00至4104阶梯教室（纪检部），2112、2110教室（广电部）参加面试。请互相转告。
...
2022年9月29日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16265.aspx" target="_self" title="标题：第二十三届团学联主席团选举结果公示&#xD;点击数：346&#xD;发表时间：22年09月29日">第二十三届团学联主席团选举结果公示</a>[ 09-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16270.aspx" target="_self" title="标题：辩论赛会议通知&#xD;点击数：167&#xD;发表时间：22年09月30日">辩论赛会议通知</a>[ 09-30 ]</div>
                        </div>
                    </div>
