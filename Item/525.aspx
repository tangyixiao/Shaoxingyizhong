...
<head>
    ...
    <title>关于教代会的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于教代会的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年11月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=525"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:525},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=525";
     ...
     <DIV>        <FONT size=4>定于今天下午第四节课在行政楼五楼会议室召开八届三次教代会，届时市教育局陈国阳局长、市教育工会范国安主席莅临指导，请各位代表务必于第三节课后迅速集中，准时出席！</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/523.aspx" target="_self" title="标题：通知&#xD;点击数：430&#xD;发表时间：09年11月07日">通知</a>[ 11-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/826.aspx" target="_self" title="标题：召开行政会议的通知&#xD;点击数：517&#xD;发表时间：09年12月03日">召开行政会议的通知</a>[ 12-03 ]</div>
                        </div>
                    </div>
