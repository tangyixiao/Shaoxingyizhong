...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13435"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13435},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13435";
     ...
     <p><span style="FONT-SIZE: 20px">本周三（19日）英语组全体老师外出参加教研活动（高一、高二老师全天参加，高三老师下午参加），相关班级英语课改自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13382.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：194&#xD;发表时间：21年05月13日">化学教研活动通知</a>[ 05-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13436.aspx" target="_self" title="标题：美术教研活动通知&#xD;点击数：159&#xD;发表时间：21年05月18日">美术教研活动通知</a>[ 05-18 ]</div>
                        </div>
                    </div>
