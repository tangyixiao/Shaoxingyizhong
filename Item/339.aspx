    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年09月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=339"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:339},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=339";
     ...
     <P><FONT size=5>    在今天的升旗仪式中，值得表扬的是：第一个跑步到达操场的高一(11)班，第二个到达操场并且队伍很整齐的高一（15）；应该批评的是：高一（9）班，门、窗、电扇都没有关。希望其他班级在做操时关好门窗，关掉电器，集队时都能做到迅速、整齐。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/321.aspx" target="_self" title="标题：关于调整家长学校、家长委员会成员的通知&#xD;点击数：766&#xD;发表时间：09年09月24日">关于调整家长学校、家长委员会成员的通知</a>[ 09-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/343.aspx" target="_self" title="标题：关于校服评选&#xD;点击数：474&#xD;发表时间：09年09月28日">关于校服评选</a>[ 09-28 ]</div>
                        </div>
                    </div>
