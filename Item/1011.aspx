...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1011"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1011},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1011";
     ...
     <FONT size=3><FONT color=#000000><FONT face=Verdana>高三班主任：请通知艺术类考生到教学处来领取报考证</FONT> </FONT></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1006.aspx" target="_self" title="标题：关于高三虚拟17班语文课上课内容的通知&#xD;点击数：282&#xD;发表时间：09年12月14日">关于高三虚拟17班语文课上课内容的通知</a>[ 12-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1063.aspx" target="_self" title="标题：浙江省2010届高三第一次高考调研考试试题（6科7份）&#xD;点击数：531&#xD;发表时间：09年12月19日">浙江省2010届高三第一次高考调研考试试题（6科7份）</a>[ 12-19 ]</div>
                        </div>
                    </div>
