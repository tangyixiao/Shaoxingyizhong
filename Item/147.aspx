...
<head>
    ...
    <title>校园内不乱停车的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=147"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:147},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=147";
     ...
     <P><FONT size=5>     快开学了，全体教职工要以主人翁姿态为整洁校园作自己的贡献。在校园内不乱停自行车、汽车，停到指定的停车处，汽车不进教学区。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/146.aspx" target="_self" title="标题：招收啦啦操学员通知 &#xD;点击数：627&#xD;发表时间：09年08月26日">招收啦啦操学员通知 </a>[ 08-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/148.aspx" target="_self" title="标题：关于工作安排的通知（各处室、各年级）&#xD;点击数：740&#xD;发表时间：09年08月27日">关于工作安排的通知（各处室、各年级）</a>[ 08-27 ]</div>
                        </div>
                    </div>
