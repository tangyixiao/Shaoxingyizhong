...
<head>
    ...
    <title>升旗仪式和大课间操暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">升旗仪式和大课间操暂停通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6209"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6209},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6209";
         ...
         因下周一到周三高三进行“超级全能生”考试，下周一升旗仪式及周二、周三的大课间操暂停，请相互告知，谢谢！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6204.aspx" target="_self" title="标题：失物招领&#xD;点击数：114&#xD;发表时间：16年12月23日">失物招领</a>[ 12-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6211.aspx" target="_self" title="标题：升旗仪式暂停通知&#xD;点击数：62&#xD;发表时间：16年12月26日">升旗仪式暂停通知</a>[ 12-26 ]</div>
                        </div>
                    </div>
