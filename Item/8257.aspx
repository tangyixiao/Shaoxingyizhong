...
<head>
    ...
    <title>2018年4月学考选考考务培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2018年4月学考选考考务培训通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8257"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8257},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8257";
     ...
     <STRONG>今天下午<SPAN lang=EN-US>16:15</SPAN>开始学考选考考务培训</STRONG><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">。地点图书馆<SPAN lang=EN-US>3</SPAN>楼报告厅<SPAN lang=EN-US>2</SPAN>，参加对象全体监考老师（包括本校的监考、预备、流动、视频监考和验卷，到外校的监考、预备），具体名单见相应通知。</SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8256.aspx" target="_self" title="标题：2018年4月学考选考绍兴一中考点组织机构&#xD;点击数：1438&#xD;发表时间：18年04月02日">2018年4月学考选考绍兴一中考点组织机构</a>[ 04-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8269.aspx" target="_self" title="标题：2018年4月学考选考考场编排表&#xD;点击数：494&#xD;发表时间：18年04月04日">2018年4月学考选考考场编排表</a>[ 04-04 ]</div>
                        </div>
                    </div>
