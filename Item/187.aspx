...
<head>
    ...
    <title>2009.9.1大扫除检查情况公布  --德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2009.9.1大扫除检查情况公布  </h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=187"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:187},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=187";
     ...
     <TABLE style="WIDTH: 478pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=637 border=0 x:str>
<COLGROUP>
...
<COL st
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/182.aspx" target="_self" title="标题：各班主任请注意（关于住校生）&#xD;点击数：435&#xD;发表时间：09年09月01日">各班主任请注意（关于住校生）</a>[ 09-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/189.aspx" target="_self" title="标题：高一、高二各班&#xD;点击数：523&#xD;发表时间：09年09月02日">高一、高二各班</a>[ 09-02 ]</div>
                        </div>
                    </div>
