...
<head>
    ...
    <title>关于学生会主席竞选的通知（高一、高二各班班长请注意）--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于学生会主席竞选的通知（高一、高二各班班长请注意）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年09月17日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=293"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:293},success:function(s) {
     ...
     <DIV><FONT size=4>高一、高二各班班长：</FONT></DIV>
<DIV><FONT size=4>    为了进一步促进我校学生会工作，以便更好地服务全校同学，经校团委研究决定，于9月23日下午第四节课，在行政楼五楼会议室，举行2009学年学生会主席竞选大会，现将有关事宜通知如下：</FONT></DIV>
<DIV><FONT size=4>    1.请高一、高二各班推选5名同学（必须包括班长和团支部书记,<FONT c
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/292.aspx" target="_self" title="标题：关于公布团委、学生会招聘面试结果的通知&#xD;点击数：506&#xD;发表时间：09年09月17日">关于公布团委、学生会招聘面试结果的通知</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/303.aspx" target="_self" title="标题：关于大合唱比赛延期举行的通知&#xD;点击数：455&#xD;发表时间：09年09月21日">关于大合唱比赛延期举行的通知</a>[ 09-21 ]</div>
                        </div>
                    </div>
