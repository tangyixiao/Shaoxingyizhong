...
<head>
    ...
    <title>本周技术精英班上课调整通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">本周技术精英班上课调整通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9212"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9212},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9212";
     ...
     <!--StartFragment -->
<DIV><FONT size=4>因本周六要进行模拟考试，安排在本周六的技术精英班提前至周三晚上六点，地点3106。主题：电控破题思路指导</FONT><BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9208.aspx" target="_self" title="标题：今天下午高三数学学考模拟考安排&#xD;点击数：361&#xD;发表时间：18年10月15日">今天下午高三数学学考模拟考安排</a>[ 10-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9214.aspx" target="_self" title="标题：生物教研活动通知&#xD;点击数：307&#xD;发表时间：18年10月18日">生物教研活动通知</a>[ 10-18 ]</div>
                        </div>
                    </div>
