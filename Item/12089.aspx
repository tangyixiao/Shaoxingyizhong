...
<head>
    ...
    <title>关于全校学科教室（创新实验室）和社团活动室进行环境卫生专项检查通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于全校学科教室（创新实验室）和社团活动室进行环境卫生专项检查通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12089"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12089},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12089";
     ...
     <FONT size=4>各学科组并相关负责人：<BR>为迎接省现代化学校评审专家组本周五来校评估检查，切实做好评审的各项准备工作，学校将于今明两天对全校所有学科教室、创新实验室和艺术、心理、天文、机房等实验楼、行政楼、图书馆等场所内的所有学科教室、创新实验室、社团活动室等进行环境卫生专项检查，请各教研组长（社团活动室由团委负责）务必牵头按时落实本学科组内相关教室的环境卫生整治工作。具体要求如下：<BR>1.教学实验设施设备摆放整齐有序，无灰尘，功能使用正常；<BR>2.桌椅、讲台干净、整洁，无杂物、书包、资料、讲义等存放；<BR>3.墙面、桌面无张贴、无涂写；<BR>4.地面干净，无垃圾。<BR>                                                     教学处、信息处<BR>                                                    2020年11月4日</FONT><BR>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12082.aspx" target="_self" title="标题：关于组织学生参加全国体测抽查的通知&#xD;点击数：497&#xD;发表时间：20年11月03日">关于组织学生参加全国体测抽查的通知</a>[ 11-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12092.aspx" target="_self" title="标题：高二选修课开始上课通知&#xD;点击数：439&#xD;发表时间：20年11月04日">高二选修课开始上课通知</a>[ 11-04 ]</div>
                        </div>
                    </div>
