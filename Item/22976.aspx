...
<head>
    ...
    <title>4.2跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22976"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22976},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22976";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2026/4/202604021510578080.png" style="max-width: 100%; " title="202604021510578080.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22975.aspx" target="_self" title="标题：4.1班级一日考核&#xD;点击数：35&#xD;发表时间：26年04月02日">4.1班级一日考核</a>[ 04-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22981.aspx" target="_self" title="标题：关于清明假期返校仪容仪表检查的通知&#xD;点击数：80&#xD;发表时间：26年04月03日">关于清明假期返校仪容仪表检查的通知</a>[ 04-03 ]</div>
                        </div>
                    </div>
