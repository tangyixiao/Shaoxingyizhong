...
<head>
    ...
    <title>关于进一步加强体温测量工作的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于进一步加强体温测量工作的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：安全</span> <span>发布时间：2009年09月17日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=294"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:294},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=294";
     ...
     <DIV><FONT size=3>各位班主任：</FONT></DIV>
<DIV><FONT size=3>     为了进一步预防流感，确保全校师生的身体健康，现就体温测量工作特提出如下要求：</FONT></DIV>
<DIV><FONT size=3>1．  每个班必须扎实开展晨检、午检工作，每位学生每天必须至少两次认真测量自己的体温。</FONT></DIV>
<DIV><FONT size=3>2．  要求每个学生随带体温
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/282.aspx" target="_self" title="标题：重申《学校甲型H1N1流感预防工作分工与措施要求》&#xD;点击数：443&#xD;发表时间：09年09月15日">重申《学校甲型H1N1流感预防工作分工与措施要求》</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/299.aspx" target="_self" title="标题：关于及时上报疫情的通知&#xD;点击数：325&#xD;发表时间：09年09月18日">关于及时上报疫情的通知</a>[ 09-18 ]</div>
                        </div>
                    </div>
