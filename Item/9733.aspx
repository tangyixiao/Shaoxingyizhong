...
<head>
    ...
    <title>请各班安全委员今天中午到安全处办公室领取教室安全检查表--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">请各班安全委员今天中午到安全处办公室领取教室安全检查表</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9733"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9733},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9733";
     ...
     <P>请各班（高一、高二、高三）安全委员今天中午到安全处办公室领取教室安全检查表，检查、填写完毕后于今天下午放学前交到安全处办公室。请各班安全委员相互通知，及时领取、上交。谢谢！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9729.aspx" target="_self" title="标题：寒假安全提醒&#xD;点击数：205&#xD;发表时间：19年01月25日">寒假安全提醒</a>[ 01-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9754.aspx" target="_self" title="标题：开学安全检查通知&#xD;点击数：215&#xD;发表时间：19年02月20日">开学安全检查通知</a>[ 02-20 ]</div>
                        </div>
                    </div>
