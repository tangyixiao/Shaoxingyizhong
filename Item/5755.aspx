...
<head>
    ...
    <title>关于上交运动会介绍词的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于上交运动会介绍词的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5755"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5755},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5755";
     ...
     请各班于下周一（24日）前把“运动会介绍词”以电子稿的形式上交到校园网上的“公共文件夹---德育处-----运动会介绍词”文件夹中。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5749.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：37&#xD;发表时间：16年10月22日">大课间操暂停通知</a>[ 10-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5756.aspx" target="_self" title="标题：关于垃圾分类工作检查要求&#xD;点击数：87&#xD;发表时间：16年10月22日">关于垃圾分类工作检查要求</a>[ 10-22 ]</div>
                        </div>
                    </div>
