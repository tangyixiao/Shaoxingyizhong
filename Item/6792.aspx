...
<head>
    ...
    <title>晚间安全检查记录2017.4.14--18--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2017.4.14--18</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6792"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6792},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6792";
     ...
     高一（16）班前后门未关，高一（13）班前后门未关。<BR>高一（11）班前后门未关。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6788.aspx" target="_self" title="标题：每日晨检表未交情况通报4.21&#xD;点击数：39&#xD;发表时间：17年04月21日">每日晨检表未交情况通报4.21</a>[ 04-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6801.aspx" target="_self" title="标题：安全教育日活动(更新到25日16点半)&#xD;点击数：222&#xD;发表时间：17年04月18日">安全教育日活动(更新到25日16点半)</a>[ 04-18 ]</div>
                        </div>
                    </div>
