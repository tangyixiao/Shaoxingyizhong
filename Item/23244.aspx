...
<head>
    ...
    <title>物理组青年教师展示课--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=23244"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23244},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23244";
     ...
     <p><span style="font-size: 18px; font-family: 宋体; color: rgb(51, 51, 51); letter-spacing: 0px; background: rgb(255, 255, 255);">   近期，物理组开设青年教师展示课，欢迎组内老师及其他组老师现场观摩。具体安排如下：</span></p><p style="text-align:center"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2026/5/202605191306194864.png" style="max-width: 100%; " title="202605191306194864.png" /></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/23224.aspx" target="_self" title="标题：数学组青年教师展示课&#xD;点击数：176&#xD;发表时间：26年05月18日">数学组青年教师展示课</a>[ 05-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/23264.aspx" target="_self" title="标题：英语组青年教师展示课&#xD;点击数：107&#xD;发表时间：26年05月25日">英语组青年教师展示课</a>[ 05-25 ]</div>
                        </div>
                    </div>
