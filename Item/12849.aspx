...
<head>
    ...
    <title>【修改】团学联主要干部会议通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">【修改】团学联主要干部会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12849"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12849},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12849";
     ...
     <p>由于时间冲突，团学联主要干部会议改至周三第9节，其他不变。请相互转告。</p><p style="text-align: center;">----------------------------原通知--------------------------</p><p>    请团学联主席团、社团联主席团、各部门部长副部长于3月9日（周二）第9节课（16:15）至2112教室开会，并准备好学期工作计划大纲。
...
2021年3月8日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12821.aspx" target="_self" title="标题：社会实践表提交、学分认定通知&#xD;点击数：392&#xD;发表时间：21年03月03日">社会实践表提交、学分认定通知</a>[ 03-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12889.aspx" target="_self" title="标题：树人导报领取通知&#xD;点击数：83&#xD;发表时间：21年03月15日">树人导报领取通知</a>[ 03-15 ]</div>
                        </div>
                    </div>
