...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20559"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20559},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20559";
     ...
     <p><span style="font-size: 18px;">今天（周一）下午，生物组全体老师外出参加教研活动，相关班级生物课改自修。生物走班学生在相应上课教室自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20547.aspx" target="_self" title="标题：历史教研活动通知&#xD;点击数：119&#xD;发表时间：24年11月15日">历史教研活动通知</a>[ 11-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20583.aspx" target="_self" title="标题：通用技术组外出教研通知&#xD;点击数：130&#xD;发表时间：24年11月20日">通用技术组外出教研通知</a>[ 11-20 ]</div>
                        </div>
                    </div>
