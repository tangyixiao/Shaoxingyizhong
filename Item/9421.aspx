...
<head>
    ...
    <title>本周日市直教师基本功比武通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">本周日市直教师基本功比武通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9421"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9421},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9421";
     ...
     <P> </P>
<P>各位老师：</P>
<P>本周日将举行市直教师基本功比武活动，请参加比武的老师抓紧时间，积极准备。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9382.aspx" target="_self" title="标题：（最新修改）绍兴一中教师模拟基本功比武测试通知&#xD;点击数：651&#xD;发表时间：18年11月21日">（最新修改）绍兴一中教师模拟基本功比武测试通知</a>[ 11-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9433.aspx" target="_self" title="标题：关于市直普通高中教师基本功比武及阅卷的通知&#xD;点击数：428&#xD;发表时间：18年11月29日">关于市直普通高中教师基本功比武及阅卷的通知</a>[ 11-29 ]</div>
                        </div>
                    </div>
