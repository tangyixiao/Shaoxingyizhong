...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6043"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6043},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6043";
     ...
     高一（13）班周傅毅楠在操场上捡到手表一只，特此表扬，并希望失主及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6042.aspx" target="_self" title="标题：表扬&#xD;点击数：134&#xD;发表时间：16年12月02日">表扬</a>[ 12-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6049.aspx" target="_self" title="标题：高二年级十佳歌手预赛通知&#xD;点击数：691&#xD;发表时间：16年12月05日">高二年级十佳歌手预赛通知</a>[ 12-05 ]</div>
                        </div>
                    </div>
