...
<head>
    ...
    <title>麻疹疫苗强化免疫摸底(班主任）--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">麻疹疫苗强化免疫摸底(班主任）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=519"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:519},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=519";
     ...
     <DIV>     浙江省2009年麻疹疫苗强化免疫摸底与接种记录表在校办—医务室的文件夹，请高二、高三各班在11月10日中午前必须登记好。</DIV>
<DIV>   
<DIV><B>浙江省</B><B>2009</B><B>年麻疹疫苗强化免疫摸底与接种记录表</B><B></B></DIV>
<DIV><B>-----</B><B>市</B><B>-----</B><B>县（市、区）</B><B>--------</B><B>学校</B><
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/517.aspx" target="_self" title="标题：今天是订报的最后半天&#xD;点击数：518&#xD;发表时间：09年11月06日">今天是订报的最后半天</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/523.aspx" target="_self" title="标题：通知&#xD;点击数：430&#xD;发表时间：09年11月07日">通知</a>[ 11-07 ]</div>
                        </div>
                    </div>
