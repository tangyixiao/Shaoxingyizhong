...
<head>
    ...
    <title>第十六期课余党校开课通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">第十六期课余党校开课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=400"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:400},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=400";
     ...
     <DIV><FONT size=3>    请绍兴一中第十六期课余党校学员，于星期五（10月16日）下午第四节课，到行政楼五楼会议室上课。全体学员务必准时参加，并请各班学员组长做好点名工作。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/387.aspx" target="_self" title="标题：关于大合唱比赛举行时间以及相应事宜的通知&#xD;点击数：297&#xD;发表时间：09年10月12日">关于大合唱比赛举行时间以及相应事宜的通知</a>[ 10-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/401.aspx" target="_self" title="标题：关于高一、高二文艺委员会议通知&#xD;点击数：408&#xD;发表时间：09年10月14日">关于高一、高二文艺委员会议通知</a>[ 10-14 ]</div>
                        </div>
                    </div>
