...
<head>
    ...
    <title>高三1B学分考监考安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三1B学分考监考安排</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年08月27日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=150"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:150},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=150";
     ...
     <TABLE style="WIDTH: 418pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=557 border=0 x:str>
<COLGROUP>
...
<COL style="WIDTH: 36pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/144.aspx" target="_self" title="标题：关于开展“优秀经验总结报告”评选活动的通知&#xD;点击数：463&#xD;发表时间：09年09月15日">关于开展“优秀经验总结报告”评选活动的通知</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/154.aspx" target="_self" title="标题：高三生物课改自修&#xD;点击数：584&#xD;发表时间：09年08月27日">高三生物课改自修</a>[ 08-27 ]</div>
                        </div>
                    </div>
