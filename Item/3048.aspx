...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3048"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3048},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3048";
...
<P><FONT size=4>请提醒本班学生：</FONT></P>
<P><FONT size=4>1．注意教学楼卫生间的保洁，自觉做到＂来也冲冲，去也冲冲＂。</FONT></P>
<P><FONT size=4>2．高二学生校牌新的贴片已下发，请及时更换，以便检查。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3047.aspx" target="_self" title="标题：值周检查情况汇总（12月13日星期一）&#xD;点击数：372&#xD;发表时间：10年12月14日">值周检查情况汇总（12月13日星期一）</a>[ 12-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3053.aspx" target="_self" title="标题：校艺术节开幕式体育馆座位安排&#xD;点击数：617&#xD;发表时间：10年12月15日">校艺术节开幕式体育馆座位安排</a>[ 12-15 ]</div>
                        </div>
                    </div>
