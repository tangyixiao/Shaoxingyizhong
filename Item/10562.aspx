...
<head>
    ...
    <title>相关老师开会的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10562"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10562},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10562";
     ...
     <P>下列老师明天下午第四节课在树兰楼三楼会议室二开个短会，请安排好工作，准时出席。</P>
<P>谢澹、言利水、王维、杨国平、侯磊、赵正瑜、闫彦彦、韩陈萍、张伟丰、祝建强、舒凤、张帆、陈忆宁。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10559.aspx" target="_self" title="标题：关于召开部分高一、高二、高三学生召开座谈会的通知&#xD;点击数：354&#xD;发表时间：19年09月17日">关于召开部分高一、高二、高三学生召开座谈会的通知</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10565.aspx" target="_self" title="标题：关于暑期专业阅读作业提交的通知&#xD;点击数：310&#xD;发表时间：19年09月18日">关于暑期专业阅读作业提交的通知</a>[ 09-18 ]</div>
                        </div>
                    </div>
