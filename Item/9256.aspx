...
<head>
    ...
    <title>今明两天跑操暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9256"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9256},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9256";
     ...
     <P>    今明两天跑操暂停，请全校师生关注。</P>
<P align=right>德育处</P>
<P align=right>2018.10.25</P>
<P> </P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9234.aspx" target="_self" title="标题：高一、高二跑操正常进行通知&#xD;点击数：167&#xD;发表时间：18年10月23日">高一、高二跑操正常进行通知</a>[ 10-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9261.aspx" target="_self" title="标题：失物招领、寻物启事几则&#xD;点击数：219&#xD;发表时间：18年10月26日">失物招领、寻物启事几则</a>[ 10-26 ]</div>
                        </div>
                    </div>
