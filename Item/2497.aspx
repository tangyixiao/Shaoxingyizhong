...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2497"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2497},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2497";
...
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><FONT size=3><SPAN lang=EN-US><SPAN style="mso-spacerun: yes">    </SPAN></SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">今天下午的教工会议不再集中，请全体教工自学！</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2489.aspx" target="_self" title="标题：关于通报错时用餐执行情况的通知（二）&#xD;点击数：1107&#xD;发表时间：10年09月17日">关于通报错时用餐执行情况的通知（二）</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2502.aspx" target="_self" title="标题：关于公布市属中学2010年高级评审对象符合免上课、考试人员名单的通知&#xD;点击数：1309&#xD;发表时间：10年09月20日">关于公布市属中学2010年高级评审对象符合免上课、考试人员名单…</a>[ 09-20 ]</div>
                        </div>
                    </div>
