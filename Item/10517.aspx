...
<head>
    ...
    <title>关于高一、高二美术生开会的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一、高二美术生开会的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10517"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10517},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10517";
     ...
     <FONT size=4>请高一美术特长生及有意向美术专业发展的高一、高二学生，于明天（周三）中午一点到行政楼四楼美术教室2（4023）集中</FONT>。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10501.aspx" target="_self" title="标题：关于周六安排的通知&#xD;点击数：1085&#xD;发表时间：19年09月06日">关于周六安排的通知</a>[ 09-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10520.aspx" target="_self" title="标题：高一天文课上课通知&#xD;点击数：164&#xD;发表时间：19年09月10日">高一天文课上课通知</a>[ 09-10 ]</div>
                        </div>
                    </div>
