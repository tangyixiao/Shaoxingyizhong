...
<head>
    ...
    <title>高一期中考试分析会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14469"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14469},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14469";
     ...
     <p><span style="FONT-SIZE: 20px; FONT-FAMILY: 宋体,SimSun">请高一任课老师于今天下午第9节课到树兰楼三楼会议室二参加期中考试分析会，务必准时参加。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14444.aspx" target="_self" title="标题：关于延期举行绍兴市首届中学生田径运动会的通知&#xD;点击数：258&#xD;发表时间：21年11月18日">关于延期举行绍兴市首届中学生田径运动会的通知</a>[ 11-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14473.aspx" target="_self" title="标题：信息技教研活动通知&#xD;点击数：122&#xD;发表时间：21年11月22日">信息技教研活动通知</a>[ 11-22 ]</div>
                        </div>
                    </div>
