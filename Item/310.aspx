...
<head>
    ...
    <title>关于领取《教育新视野》的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于领取《教育新视野》的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=310"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:310},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=310";
     ...
     <DIV><FONT face=Verdana>                               <FONT size=4>关于领取《教育新视野》的通知</FONT></FONT></DIV>
<D
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/309.aspx" target="_self" title="标题：高三生物1B学分考延期通知（急）&#xD;点击数：421&#xD;发表时间：09年09月21日">高三生物1B学分考延期通知（急）</a>[ 09-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/314.aspx" target="_self" title="标题：关于转发市教育教学研究院《在教师研修网申请继续教育学分的几点说明》的通知&#xD;点击数：542&#xD;发表时间：09年09月22日">关于转发市教育教学研究院《在教师研修网申请继续教育学分的几…</a>[ 09-22 ]</div>
                        </div>
                    </div>
