...
<head>
    ...
    <title>高二年级长、班主任和备课组长会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二年级长、班主任和备课组长会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6416"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6416},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6416";
     ...
     <FONT size=4>请高二年级长、班主任和备课组长于今天下午第4节课到行政楼三楼会议室开会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6410.aspx" target="_self" title="标题：高二选考走班安排&#xD;点击数：148&#xD;发表时间：17年02月14日">高二选考走班安排</a>[ 02-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6419.aspx" target="_self" title="标题：高二部分走班自修教室调换通知&#xD;点击数：124&#xD;发表时间：17年02月16日">高二部分走班自修教室调换通知</a>[ 02-16 ]</div>
                        </div>
                    </div>
