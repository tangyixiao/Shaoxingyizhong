...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3719"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3719},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3719";
     ...
     <P>                                       文明办公室检查</P>
<P>      今天下午第四节课进行文明办公室检查,请各办公室务必认真彻底打扫,做到资料、物品摆放整齐有序。</P>
<P>     请各今天白天值班的老师下午第四节课到朱国强老师处集中。</P>
<P>                                               校文明办公室检查小组</P>
<P>                                                            4.14</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3682.aspx" target="_self" title="标题：文明办公室检查&#xD;点击数：497&#xD;发表时间：11年04月08日">文明办公室检查</a>[ 04-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3900.aspx" target="_self" title="标题：关于远足活动的通知&#xD;点击数：608&#xD;发表时间：11年05月09日">关于远足活动的通知</a>[ 05-09 ]</div>
                        </div>
                    </div>
