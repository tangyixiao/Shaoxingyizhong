...
<head>
    ...
    <title>政治课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=533"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:533},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=533";
     ...
     <P><FONT size=3>11月8日—11月11日，下列老师参加教研活动，所任课班级课改自修。 </FONT></P>
<P><FONT size=3>陈银伟   邱静娥   叶佩莉  许琪枚  胡桂兰</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/532.aspx" target="_self" title="标题：关于第八期《求真》校刊征稿的通知&#xD;点击数：359&#xD;发表时间：09年11月09日">关于第八期《求真》校刊征稿的通知</a>[ 11-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/536.aspx" target="_self" title="标题：关于召开原虚拟十七班任课教师座谈会的通知&#xD;点击数：309&#xD;发表时间：09年11月10日">关于召开原虚拟十七班任课教师座谈会的通知</a>[ 11-10 ]</div>
                        </div>
                    </div>
