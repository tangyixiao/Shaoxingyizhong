...
<head>
    ...
    <title>橡皮网试用通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7473"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7473},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7473";
     ...
     <FONT size=4>橡皮网为组卷系统，欢迎各位老师试用。网址：</FONT><A href="http://www.xiangpi.com"><FONT size=4>www.xiangpi.com</FONT></A><FONT size=4>，账户名：zjsxyz  密码：zjsxyz。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7472.aspx" target="_self" title="标题：市属篮球比赛通知&#xD;点击数：377&#xD;发表时间：17年10月18日">市属篮球比赛通知</a>[ 10-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7474.aspx" target="_self" title="标题：周四生物教研活动通知（有修改）&#xD;点击数：241&#xD;发表时间：17年10月18日">周四生物教研活动通知（有修改）</a>[ 10-18 ]</div>
                        </div>
                    </div>
