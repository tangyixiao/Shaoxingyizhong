...
<head>
    ...
    <title>安全提示(2011.4.20)--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">安全提示(2011.4.20)</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3757"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3757},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3757";
...
<P style="TEXT-INDENT: 21pt; MARGIN: 0cm 0cm 0pt; mso-char-indent-count: 2.0" class=MsoNormal><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=5>近几周发生的失窃现象都有个共同特性，办公室或都室门没关好，让小偷很方便地进去行窃了。近二次小偷行窃的时间是：刚要吃中饭，部分人已走了；学校举行大型活动期间。来行窃的是二个女的，其中一人在行窃时拉好了窗帘后蹲着进行。我们提示：教室、办公室等最后一个人走时一定要关上门与窗，并拉开窗帘。去参加大型活动，要求有人值班，安全管理员留下。</FONT></SPAN></P>
<P style="MARGIN: 0cm 0cm 0pt" class=MsoNormal><SPAN lang=EN-US><o:p><FONT size=5> </FONT></o:p></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3741.aspx" target="_self" title="标题：校园晚间安全检查记录（未关项目）2011.4.11--16&#xD;点击数：355&#xD;发表时间：11年04月18日">校园晚间安全检查记录（未关项目）2011.4.11--16</a>[ 04-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3807.aspx" target="_self" title="标题：晚间安全检查记录（未关项目）2011.4.17--22&#xD;点击数：356&#xD;发表时间：11年04月25日">晚间安全检查记录（未关项目）2011.4.17--22</a>[ 04-25 ]</div>
                        </div>
                    </div>
