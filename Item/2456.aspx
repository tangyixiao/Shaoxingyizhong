...
<head>
    ...
    <title>学科竞赛奖金核对--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2456"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2456},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2456";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><FONT size=3><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">各学科竞赛指导老师：</SPAN><SPAN lang=EN-US>09</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">学年的学科竞赛奖金已经统计完毕，请信息、语文、数学、英语、物理、化学、生物、体育这些学科的有关竞赛指导老师</SPAN> <SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">，到教学处章其炎处核对竞赛奖金统计，截止时间本周五。</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2449.aspx" target="_self" title="标题：原高三班主任&#xD;点击数：400&#xD;发表时间：10年09月14日">原高三班主任</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2457.aspx" target="_self" title="标题：高二研究性学习改自修&#xD;点击数：312&#xD;发表时间：10年09月15日">高二研究性学习改自修</a>[ 09-15 ]</div>
                        </div>
                    </div>
