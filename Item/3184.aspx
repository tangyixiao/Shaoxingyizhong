...
<head>
    ...
    <title>关于高三会考模拟考监考的通知--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高三会考模拟考监考的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3184"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3184},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3184";
     ...
     <P> </P>
<P>关于高三会考模拟考监考的通知</P>
<P>请相关监考教师提前10分钟(3:15分)到高三数学组办公室拿试卷。</P>
<P> </P>
<P>高三年级组</P>
<P>二○一○年十二月三十日</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3054.aspx" target="_self" title="标题：本周六(12月18日)高三综合测试安排&#xD;点击数：803&#xD;发表时间：10年12月15日">本周六(12月18日)高三综合测试安排</a>[ 12-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3219.aspx" target="_self" title="标题：高三（2）年终考核会议&#xD;点击数：633&#xD;发表时间：11年01月06日">高三（2）年终考核会议</a>[ 01-06 ]</div>
                        </div>
                    </div>
