...
<head>
    ...
    <title>高三求真讲坛座位安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2888"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2888},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2888";
     ...
     <P>11月19日下午第四节高三理科求真讲坛座位安排如下，请班主任通知学生按照指定位置就坐，并引导学生注意卫生、纪律、礼貌和文明。</P>
<P><A title=高三求真讲坛座位分布图 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201011/2010111909123944.xls">高三求真讲坛座位分布图</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2882.aspx" target="_self" title="标题：通知两则&#xD;点击数：791&#xD;发表时间：10年11月17日">通知两则</a>[ 11-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2892.aspx" target="_self" title="标题：高三班主任：普通高校艺术类专业考试报名&#xD;点击数：1375&#xD;发表时间：10年11月19日">高三班主任：普通高校艺术类专业考试报名</a>[ 11-19 ]</div>
                        </div>
                    </div>
