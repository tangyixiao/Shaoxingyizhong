...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23707"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23707},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23707";
     ...
     <p style="text-align:center">
</p><p><span style=";font-family:仿宋;font-size:19px">各位教工</span><span style=";font-family:仿宋;font-size:19px">：</span></p><p style="text-indent:37px;text-autospace:ideograph-numeric"><span style=";font-family:仿宋;font-size:19px">根据市公积金管理中心</span><span style=";font-family:仿宋;font-size:19px">有关文件精神</span><span style=";font-family:仿宋;font-size:19px">，现将公积金调</span><span style=";font-family:仿宋;font-size:19px">整</span><span style=";font-family:仿宋;font-size:19px">事项</span><span style=";font-family:仿宋;font-size:19px">做</span><span style=";font-family:仿宋;font-size:19px">如下通知：</span></p><p style="margin-left:19px;text-indent:37px;text-autospace:ideograph-numeric"><span style="font-family: 仿宋;font-size: 19px">一、</span><span style=";font-family:仿宋;font-size:19px">本次公积金调整基数以</span><span style=";font-family:仿宋;font-size:19px">2025年基本工资+国家规定的特殊岗位津补贴+绩效工资+绩效考核奖为计算依据</span><span style=";font-family:仿宋;font-size:19px">。</span><span style=";font-family:仿宋;font-size:19px">不含三名奖、人才奖、夜餐补贴等。</span></p><p style="margin-left:19px;text-indent:37px;text-autospace:ideograph-numeric"><span style="font-family: 仿宋;font-size: 19px">二、</span><span style=";font-family:仿宋;font-size:19px">本次调整新基数执行时间为</span><span style=";font-family:仿宋;font-size:19px">2026年7月1日-2027年6月30日。</span></p><p style="margin-left:19px;text-indent:37px;text-autospace:ideograph-numeric"><span style="font-family: 仿宋;font-size: 19px">三、</span><span style=";font-family:仿宋;font-size:19px">学校将在</span><span style=";font-family:仿宋;font-size:19px">9月按照新基数对公积金进行补退缴，补退缴7、8、9三个月（本次不调整购房补贴）。</span></p><p style="text-indent:56px;text-autospace:ideograph-numeric"><span style=";font-family:仿宋;font-size:19px">四、财务室将把调整内容以钉钉形式发送给各位老师。不明之处可咨询财务室</span><span style=";font-family:仿宋;font-size:19px">。</span></p><p style="margin-left:56px"><strong><span style="font-family: 仿宋;font-size: 19px">                                        </span></strong><strong><span style="font-family: 仿宋;font-size: 19px">  </span></strong><span style=";font-family:仿宋;font-size:19px">财务室</span></p><p style="margin-left:56px"><span style=";font-family:仿宋;font-size:19px">                                     <span style="font-family:仿宋">202</span></span><span style=";font-family:仿宋;font-size:19px">6</span><span style=";font-family:仿宋;font-size:19px">年</span><span style=";font-family:仿宋;font-size:19px">9</span><span style=";font-family:仿宋;font-size:19px">月</span><span style=";font-family:仿宋;font-size:19px">22</span><span style=";font-family:仿宋;font-size:19px">日</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23654.aspx" target="_self" title="标题：绍兴一中教育集团2026年中层选拔任用公告&#xD;点击数：328&#xD;发表时间：26年09月15日">绍兴一中教育集团2026年中层选拔任用公告</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Item/23712.aspx" target="_self" title="标题：考察预告&#xD;点击数：43&#xD;发表时间：26年09月23日">考察预告</a>[ 09-23 ]</div>
                        </div>
                    </div>
