...
<head>
    ...
    <title>关于政治教研活动的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21099"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21099},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21099";
     ...
     <article><p>      本周三（3月19日）全体政治老师外出教研培训，所有政治课改自修。</p></article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21093.aspx" target="_self" title="标题：关于历史教研活动的通知&#xD;点击数：118&#xD;发表时间：25年03月18日">关于历史教研活动的通知</a>[ 03-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21123.aspx" target="_self" title="标题：关于地理教研活动的通知&#xD;点击数：164&#xD;发表时间：25年03月24日">关于地理教研活动的通知</a>[ 03-24 ]</div>
                        </div>
                    </div>
