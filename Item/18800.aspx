...
<head>
    ...
    <title>关于下周一研学，教学安排的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于下周一研学，教学安排的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18800"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18800},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18800";
     ...
     <p> 
</p><p>全校各班级：</p><p>     因天气原因，本定于周六的研学活动改在下周一。下周一的研学活动仍然为高三一天；高一为上午；高二为下午；高一，高二的其他半天时间按照周一课表上课，望各位知晓。</p><p> </p><p>                                                                                      教学处、德育处</p><p style="text-indent:336px">               2023年11月10日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18799.aspx" target="_self" title="标题：寻物启事（水杯）&#xD;点击数：91&#xD;发表时间：23年11月10日">寻物启事（水杯）</a>[ 11-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18804.aspx" target="_self" title="标题：高一秋季研学活动具体安排&#xD;点击数：308&#xD;发表时间：23年11月10日">高一秋季研学活动具体安排</a>[ 11-10 ]</div>
                        </div>
                    </div>
