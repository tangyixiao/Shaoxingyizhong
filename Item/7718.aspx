...
<head>
    ...
    <title>高一备课组长及部分班主任会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一备课组长及部分班主任会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7718"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7718},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7718";
     ...
     <FONT size=4>请各位高一备课组长和17、18班班主任于今天下午第4节课到树兰树三楼会议室三开会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7715.aspx" target="_self" title="标题：心理教研活动通知&#xD;点击数：126&#xD;发表时间：17年11月29日">心理教研活动通知</a>[ 11-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7720.aspx" target="_self" title="标题：中学生标准学术能力测试推荐名单公示&#xD;点击数：411&#xD;发表时间：17年11月30日">中学生标准学术能力测试推荐名单公示</a>[ 11-30 ]</div>
                        </div>
                    </div>
