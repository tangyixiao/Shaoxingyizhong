...
<head>
    ...
    <title>“爱在一中”｜朱雯：那些走过的日子——我与我的母校（2）--校友之家-绍兴市第一中学</title>
...
<li class="li2 last"><a href="/Category_391/Index.aspx">校友动态</a></li>
    ...
    <a href="/Category_389/Index.aspx" target="_self">校友之家</a></div>
                    <h3>校友之家</h3>
                </div>
                <div class="mBd">
                    <!-- 正文内容 S -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23510"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23510},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23510";
