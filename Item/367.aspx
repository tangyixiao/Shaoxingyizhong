...
<head>
    ...
    <title>关于高一、高二校本课程补报的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一、高二校本课程补报的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年10月08日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=367"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:367},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=367";
     ...
     <DIV><FONT size=3>高一、高二班主任：</FONT></DIV>
<DIV><FONT size=3>根据校本课程选修报名数据统计情况看：</FONT></DIV>
<DIV><FONT size=3>1、  高一有28名同学漏报，高二有11名同学漏报，这些学生需要补报。</FONT></DIV>
<DIV><FONT size=3>2、某些课程报名人数不足，按照规定需要重新报名。（高一：我国传统民俗与自然环境</FONT><FONT size=3>、数学史；高二：走近中国文化名
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/364.aspx" target="_self" title="标题：通知二则&#xD;点击数：278&#xD;发表时间：09年10月08日">通知二则</a>[ 10-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/368.aspx" target="_self" title="标题：有关绍兴文理学院学生来我校教育实习的通知&#xD;点击数：368&#xD;发表时间：09年10月08日">有关绍兴文理学院学生来我校教育实习的通知</a>[ 10-08 ]</div>
                        </div>
                    </div>
...
<li class="spe">|</li>
<li class="li3 on"><a target="_blank" href="http://www.sxyz.net/">学校外网</a></li>
<li class="spe">|</li>
