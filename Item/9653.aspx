...
<head>
    ...
    <title>2019年1月学考考务培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2019年1月学考考务培训通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9653"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9653},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9653";
     ...
     <STRONG><SPAN lang=EN-US>今天</SPAN>下午<SPAN lang=EN-US>16:15</SPAN>开始学考考务培训</STRONG><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">。地点图书馆<SPAN lang=EN-US>3</SPAN>楼报告厅<SPAN lang=EN-US>2</SPAN>，参加对象全体监考老师（包括本校的监考、预备、流动、视频监考和验卷，到外校的监考、预备）。<STRONG>请随带笔。</STRONG></SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9651.aspx" target="_self" title="标题：2019年1月学考绍兴一中考点考场编排&#xD;点击数：781&#xD;发表时间：19年01月10日">2019年1月学考绍兴一中考点考场编排</a>[ 01-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9654.aspx" target="_self" title="标题：2019年1月学考试场布置要求&#xD;点击数：331&#xD;发表时间：19年01月11日">2019年1月学考试场布置要求</a>[ 01-11 ]</div>
                        </div>
                    </div>
