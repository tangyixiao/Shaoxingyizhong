...
<head>
    ...
    <title>团学联部分干事参与校内志愿服务通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">团学联部分干事参与校内志愿服务通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11012"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11012},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11012";
     ...
     <P>请团委<FONT color=#ff0000>实践部</FONT>、学生会<FONT color=#ff0000>秘书部</FONT>全体干部、干事于<FONT color=#ff0000>今天下午最后一节课</FONT>至树兰楼（行政楼）二楼<FONT color=#ff0000>支部活动室</FONT>完成校报装袋等相关工作。请部长通知到位。</P>
<P align=right>校团委<BR>2019年12月13日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10997.aspx" target="_self" title="标题：通知：本学期团学活动截止时间&#xD;点击数：217&#xD;发表时间：19年12月11日">通知：本学期团学活动截止时间</a>[ 12-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11016.aspx" target="_self" title="标题：关于进行团支部学期工作考核的通知&#xD;点击数：321&#xD;发表时间：19年12月13日">关于进行团支部学期工作考核的通知</a>[ 12-13 ]</div>
                        </div>
                    </div>
