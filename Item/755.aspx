...
<head>
    ...
    <title>高三班主任：有关艺术类考试报名--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三班主任：有关艺术类考试报名</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=755"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:755},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=755";
     ...
     <DIV><FONT face=宋体 color=#000000 size=4>高三班主任：</FONT></DIV>
<DIV><FONT face=宋体><FONT size=4><FONT color=#000000>    本班如果有其它艺术类专业（如音乐、传媒等）的考生，也要在浙江教育考试网上报名、现场信息确认。在2009年12月1日9：00-12月2日22：00登陆浙江教育考试网（<A href="http://www.zjzs.net">www.zjzs.net</A>），按规定如实输入各项报名信息，于12月6日-7日本人到教学处现场办理报名信息确认手续。逾期不再办理。请班主任通知有关学生。</FONT></FONT></FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/754.aspx" target="_self" title="标题：校本课程暂停&#xD;点击数：392&#xD;发表时间：09年12月02日">校本课程暂停</a>[ 12-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/821.aspx" target="_self" title="标题：关于绍兴一中航模兴趣小组招生的预报名通知&#xD;点击数：698&#xD;发表时间：09年12月03日">关于绍兴一中航模兴趣小组招生的预报名通知</a>[ 12-03 ]</div>
                        </div>
                    </div>
