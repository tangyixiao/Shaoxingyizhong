...
<head>
    ...
    <title>关于树人导报领取的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于树人导报领取的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年02月22日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6453"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6453},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6453";
     ...
     <!--StartFragment -->
<DIV>各班团支书：请于明天（2月23日）放学前至行政楼一楼演播厅门口领取树人导报。（注：请在表格上签名确认） </DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6448.aspx" target="_self" title="标题：关于社团部开会的通知&#xD;点击数：194&#xD;发表时间：17年02月21日">关于社团部开会的通知</a>[ 02-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6457.aspx" target="_self" title="标题：杭州高中生商业模拟挑战赛绍兴一中预选赛通知&#xD;点击数：480&#xD;发表时间：17年02月23日">杭州高中生商业模拟挑战赛绍兴一中预选赛通知</a>[ 02-23 ]</div>
                        </div>
                    </div>
