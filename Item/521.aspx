...
<head>
    ...
    <title>2010年招飞报名通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2010年招飞报名通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年11月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=521"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:521},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=521";
     ...
     <DIV>高三各班主任：</DIV>
<DIV>接市招办通知，我市2010年招飞报名工作已经开始。飞行员是空军战斗力的主体，是国防建设的精英。根据飞行职业的特殊要求，报考空军飞行学员的考生，都要经过严格的身体检查、心理选拔、政治审查并参加普通高等学校招生统一考试。空军在各项达标考生中择优录取。</DIV>
<DIV>今年的招飞报名工作学校决定分以下几步进行：</DIV>
<DIV>（1）各班做好宣传发动工作。张贴有关招飞的宣传资料，教学处在11月7日下发决心书，各班让男同学签名并上交教学处。</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/520.aspx" target="_self" title="标题：关于复旦大学第六届博雅杯人文知识大奖赛征文启事&#xD;点击数：383&#xD;发表时间：09年11月06日">关于复旦大学第六届博雅杯人文知识大奖赛征文启事</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/522.aspx" target="_self" title="标题：复旦大学2010年直推保送生选拔测试方案&#xD;点击数：568&#xD;发表时间：09年11月07日">复旦大学2010年直推保送生选拔测试方案</a>[ 11-07 ]</div>
                        </div>
                    </div>
