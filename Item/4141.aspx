...
<head>
    ...
    <title>6月9日寝室缺席名单--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4141"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4141},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4141";
...
<P>B612    梁一奇    二（9）</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4127.aspx" target="_self" title="标题：关于高三毕业典礼的通知（有座位表）&#xD;点击数：726&#xD;发表时间：11年06月08日">关于高三毕业典礼的通知（有座位表）</a>[ 06-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4143.aspx" target="_self" title="标题：6月9日住校生未打卡名单&#xD;点击数：787&#xD;发表时间：11年06月10日">6月9日住校生未打卡名单</a>[ 06-10 ]</div>
                        </div>
                    </div>
