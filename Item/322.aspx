...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高三</span> <span>发布时间：2009年09月24日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=322"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:322},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=322";
     ...
     <DIV align=center>内部情况参考</DIV>
<DIV align=center> </DIV>
<DIV>    1、各班主任对H1N1防范工作非常重视，各班防范H1N1工作处置及时，措施得力，情况基本稳定。明天起下午第四节自修课照常。由于疫情并没有消除，希各班进一步做好H1N1防范工作，并且要求高三学生静下心来，努力学习，认真学习，减少由于这一天灾带来的损失。各班可以把这次H1N1危机事件作为契机，对本班学生进行珍惜时间的教育。</DIV>
<D
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/253.aspx" target="_self" title="标题：高三&#xD;点击数：549&#xD;发表时间：09年09月11日">高三</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/365.aspx" target="_self" title="标题：高三班主任请关注&#xD;点击数：402&#xD;发表时间：09年10月08日">高三班主任请关注</a>[ 10-08 ]</div>
                        </div>
                    </div>
