...
<head>
    ...
    <title>高一选修课暂停通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6755"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6755},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6755";
     ...
     <P><FONT size=4>各位高一选修课老师：</FONT></P>
<P><FONT size=4>因高一学生参加绍兴一中120周年校庆发布会活动，周四下午高一年级选修课暂停。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6750.aspx" target="_self" title="标题：高三部分学生会议通知&#xD;点击数：307&#xD;发表时间：17年04月18日">高三部分学生会议通知</a>[ 04-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6757.aspx" target="_self" title="标题：高一心理课改自修通知&#xD;点击数：114&#xD;发表时间：17年04月19日">高一心理课改自修通知</a>[ 04-19 ]</div>
                        </div>
                    </div>
