...
<head>
    ...
    <title>高二协作体考试分析会--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18399"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18399},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18399";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 20px; background-color: rgb(255, 255, 255);">兹定于今天下午第9节课在树兰楼三楼会议室一召开高二协作体考试分析会，请各位高二任课老师准时参加。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18388.aspx" target="_self" title="标题：高三协作体考试分析会&#xD;点击数：196&#xD;发表时间：23年09月12日">高三协作体考试分析会</a>[ 09-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18410.aspx" target="_self" title="标题：本周六（9月16日）信息学考试考试安排&#xD;点击数：353&#xD;发表时间：23年09月14日">本周六（9月16日）信息学考试考试安排</a>[ 09-14 ]</div>
                        </div>
                    </div>
