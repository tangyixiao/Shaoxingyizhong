...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=482"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:482},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=482";
     ...
     <P>全校教师:</P>
<P>      明天下午和后天上午分别有安徽省马鞍山市教育局领导<SPAN style="FONT-SIZE: 12pt; COLOR: black; FONT-FAMILY: 宋体; mso-ascii-font-family: ''Times New Roman''; mso-hansi-font-family: ''Times New Roman''; mso-bidi-font-family: ''Times New R
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/480.aspx" target="_self" title="标题：转发绍兴市教育局关于印发《市属学校（单位）招投标管理实施细则（试行）》的通知&#xD;点击数：504&#xD;发表时间：09年10月29日">转发绍兴市教育局关于印发《市属学校（单位）招投标管理实施细…</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/489.aspx" target="_self" title="标题：值周小结&#xD;点击数：507&#xD;发表时间：09年10月31日">值周小结</a>[ 10-31 ]</div>
                        </div>
                    </div>
