...
<head>
    ...
    <title>关于教工车辆停放的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2272"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2272},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2272";
...
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><FONT size=3><SPAN lang=EN-US><SPAN style="mso-spacerun: yes">    </SPAN></SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">为创建一个整洁、和谐、温馨的校园环境，请各位教工自觉整齐地停放好自己的车辆，自行车、电瓶车停放在指定车棚，汽车停放在指定停放区域，在一些通道（如体育馆乒乓球室边上的通道等）、出入口禁止停车，谢谢合作！</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2264.aspx" target="_self" title="标题：关于公布《绍兴一中各类工作领导小组名单》的通知&#xD;点击数：1335&#xD;发表时间：10年08月23日">关于公布《绍兴一中各类工作领导小组名单》的通知</a>[ 08-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2286.aspx" target="_self" title="标题：关于教职工考勤的通知&#xD;点击数：780&#xD;发表时间：10年08月25日">关于教职工考勤的通知</a>[ 08-25 ]</div>
                        </div>
                    </div>
