...
<head>
    ...
    <title>周五下午高三培优安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6140"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6140},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6140";
     ...
     <P><FONT size=4>学校邀请到两位面试专家，将于周五下午来我校做关于自主招生、三位一体面试的专题讲座，请高三培优班学生于周五下午第2节课（14：30）到行政楼五楼会议室听讲座。</FONT></P>
<P><FONT size=4>讲座内容简介：</FONT></P>
<P><FONT size=4>1、如何发现发掘面试环节中自己的个人特长。</FONT></P>
<P><FONT size=4>2、面对最难报考年，如何通过高校三位一体、自主招生获得先机？</FONT></P>
<P><FONT size=4>3、针对自主招生、三位一体面试关，我们该做什么？</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6139.aspx" target="_self" title="标题：无锡一中政治、历史老师来访通知&#xD;点击数：256&#xD;发表时间：16年12月15日">无锡一中政治、历史老师来访通知</a>[ 12-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6143.aspx" target="_self" title="标题：本周六高三省考试院语文数学模拟统测安排&#xD;点击数：1292&#xD;发表时间：16年12月16日">本周六高三省考试院语文数学模拟统测安排</a>[ 12-16 ]</div>
                        </div>
                    </div>
