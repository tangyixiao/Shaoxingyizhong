...
<head>
    ...
    <title>学术节 | 历史剧本写作比赛--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">学术节 | 历史剧本写作比赛</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17812"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17812},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17812";
     ...
     <p>一、创作主题：</p><p>人类历史记忆的留存与书写</p><p>(解题：布克哈特曾言：“所谓历史，就是一个时代从另一个时代发现的值得关注的东西”。人类历史记忆就是那些“值得关注的东西”。于是，究竟什么是“值得关注的东西”就是剧本创作者先要思考的问题。)</p><p> </p><p>二、历史剧剧本具体写作要求：</p><p> </p><p>1.题材选择</p><p>(1)题材选择以真实的历史人物或历史事件为基础，有合理的戏剧冲突，并适宜舞台演出。建议选取绍兴一中百年校史中的人物或典型事件，也可以选取绍兴地方史上的名人或故事。</p><p>(2)具备对所选历史人物、历史事件透彻全面的认识，并在尊重历史的基础上作合理创作。</p><p>(3)所选题材内容积极、健康向上，具有一定社会意义。</p><p>2.人物塑造</p><p>(1)通过塑造丰富而细致的人物行动线，层次深入地揭示人物思想性格的本质特征，刻画鲜明生动的舞台形象。</p><p>(2)着力揭示人物内心世界，赋予人物浓厚的情感色彩。</p><p>3.结构设置</p><p>(1)具备结构意识，情节完整，叙事完备，精心安排戏剧矛盾冲突的发展进程。</p><p>(2)运用合适的情节结构技巧完善故事情节，使得情节生动丰富，具备故事性。</p><p>(3)合理安排场幕，明确上下场时间节点与明暗场幕设置，使得结构合理不凌乱。</p><p>4.语言表达</p><p>(1)语言表述清晰，有文学性，能生动形</p><p>(2)台词设置具备动作性、历史性，符合历史情境，贴合人物性格特点。</p><p>(3)舞台指示具备客观性、剧场性，简洁明了描述舞台设置与转换。</p><p>5.字数要求</p><p>5000字左右</p><p>6.完稿时间</p><p>5月25日前请交到历史组张叠老师处</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17799.aspx" target="_self" title="标题：第十二期团校结业考试通知&#xD;点击数：249&#xD;发表时间：23年05月03日">第十二期团校结业考试通知</a>[ 05-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17852.aspx" target="_self" title="标题：学术节 | 蓝晒体验&#xD;点击数：532&#xD;发表时间：23年05月08日">学术节 | 蓝晒体验</a>[ 05-08 ]</div>
                        </div>
                    </div>
