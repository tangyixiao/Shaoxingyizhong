...
<head>
    ...
    <title>关于领取暑假相关材料的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于领取暑假相关材料的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2200"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2200},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2200";
...
<P><FONT size=4>    请到校团委办公室领取暑期相关的材料，以便明天发给学生。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2195.aspx" target="_self" title="标题：通知&#xD;点击数：465&#xD;发表时间：10年07月03日">通知</a>[ 07-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2201.aspx" target="_self" title="标题：高一高二休业式座位安排&#xD;点击数：399&#xD;发表时间：10年07月03日">高一高二休业式座位安排</a>[ 07-03 ]</div>
                        </div>
                    </div>
