...
<head>
    ...
    <title>高三回头考监考安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=161"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:161},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=161";
     ...
     <p style="display:none;">1、学生试场安排：</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/160.aspx" target="_self" title="标题：高二回头考监考安排（8月31日）&#xD;点击数：566&#xD;发表时间：09年08月28日">高二回头考监考安排（8月31日）</a>[ 08-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/165.aspx" target="_self" title="标题：高三回头考安排调整&#xD;点击数：581&#xD;发表时间：09年08月30日">高三回头考安排调整</a>[ 08-30 ]</div>
                        </div>
                    </div>
