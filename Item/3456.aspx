...
<head>
    ...
    <title>高二备课组长--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二备课组长</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高二备课组长</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年03月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3456"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3456},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3456";
     ...
     请高二备课组长到教学处领取2011年高考考试说明。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3450.aspx" target="_self" title="标题：周一虞金龙、邢婷课改自修&#xD;点击数：495&#xD;发表时间：11年03月07日">周一虞金龙、邢婷课改自修</a>[ 03-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3488.aspx" target="_self" title="标题：高三班主任通知&#xD;点击数：943&#xD;发表时间：11年03月10日">高三班主任通知</a>[ 03-10 ]</div>
                        </div>
                    </div>
