...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6191"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6191},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6191";
     ...
     参加明天下午高三语文培优班的同学，请随带《标点符号用法国家标准》（年段里统一印制的）。<BR>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6186.aspx" target="_self" title="标题：市区英语口语竞赛参加学生&#xD;点击数：317&#xD;发表时间：16年12月22日">市区英语口语竞赛参加学生</a>[ 12-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6193.aspx" target="_self" title="标题：2017年4月学考选考报名和考试时间&#xD;点击数：338&#xD;发表时间：16年12月22日">2017年4月学考选考报名和考试时间</a>[ 12-22 ]</div>
                        </div>
                    </div>
