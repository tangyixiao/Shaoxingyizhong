...
<head>
    ...
    <title>干干净净迎国庆--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=344"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:344},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=344";
...
<P><FONT size=4>      今天大扫除照常进行，各班要严格按照相关要求，认真打扫教室和包干区卫生。干干净净，喜迎国庆！</FONT></P>
...
<P><FONT size=4>           &n
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/343.aspx" target="_self" title="标题：关于校服评选&#xD;点击数：474&#xD;发表时间：09年09月28日">关于校服评选</a>[ 09-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/346.aspx" target="_self" title="标题：表扬&#xD;点击数：404&#xD;发表时间：09年09月29日">表扬</a>[ 09-29 ]</div>
                        </div>
                    </div>
