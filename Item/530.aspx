...
<head>
    ...
    <title>绍兴一中校园晚间安全检查公告(2009.11.1-11.7）--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中校园晚间安全检查公告(2009.11.1-11.7）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=530"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:530},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=530";
...
<TD vAl
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/526.aspx" target="_self" title="标题：重申流感隔离要求&#xD;点击数：266&#xD;发表时间：09年11月09日">重申流感隔离要求</a>[ 11-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/531.aspx" target="_self" title="标题： 自行车上锁情况检查通报&#xD;点击数：231&#xD;发表时间：09年11月09日"> 自行车上锁情况检查通报</a>[ 11-09 ]</div>
                        </div>
                    </div>
