...
<head>
    ...
    <title>求真实验室招新考核通告（有修改）--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">求真实验室招新考核通告（有修改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9101"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9101},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9101";
     ...
     <P>  求真实验室将于<FONT color=#ff0000><STRONG>9月21日12:30-13:45</STRONG></FONT>对高一新生进行笔试考核，75分钟笔试。<FONT color=#ff0000><STRONG>实验考试将择笔试优者进行</STRONG></FONT>。（平行班化竞将统一考试，并在考试后统一讲解试卷；创新班化竞同学将与平行班化竞分卷考试，可以迟一节课参加考试；创新班非化竞同学若报名，将与平行班化竞同学同卷。）</P>
<P align=right>    求真实验室<BR>2018年9月20日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9098.aspx" target="_self" title="标题：关于学代会选举结果及第十九届主席团成员产生的公示&#xD;点击数：354&#xD;发表时间：18年09月20日">关于学代会选举结果及第十九届主席团成员产生的公示</a>[ 09-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9102.aspx" target="_self" title="标题：关于延期举行校园定向越野比赛的再通知&#xD;点击数：159&#xD;发表时间：18年09月12日">关于延期举行校园定向越野比赛的再通知</a>[ 09-12 ]</div>
                        </div>
                    </div>
