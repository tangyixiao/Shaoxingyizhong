...
<head>
    ...
    <title>关于选拔优秀学生参加中央电视台《三星智力快车》节目的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于选拔优秀学生参加中央电视台《三星智力快车》节目的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年09月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=228"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:228},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=228";
     ...
     <DIV><FONT size=3>高一、高二各班：</FONT></DIV>
<DIV><FONT size=3>    我校是绍兴市唯一的一所与中央电视台《三星智力快车》栏目合作的学校。合作四年来，通过选派优秀学生参加节目，已取得了显著的成绩和赢得了良好的社会声誉。根据中央电视台的总体部署，今年的选拔推荐工作又将开始。现将有关要求通知如下：</FONT></DIV>
<DIV><FONT size=3>    1．选拔范围：高一、高二年级学生
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/225.aspx" target="_self" title="标题：关于举行2009年迎国庆大合唱比赛的通知&#xD;点击数：459&#xD;发表时间：09年09月07日">关于举行2009年迎国庆大合唱比赛的通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/231.aspx" target="_self" title="标题：关于参加《三星智力快车》节目的补充说明&#xD;点击数：497&#xD;发表时间：09年09月09日">关于参加《三星智力快车》节目的补充说明</a>[ 09-09 ]</div>
                        </div>
                    </div>
