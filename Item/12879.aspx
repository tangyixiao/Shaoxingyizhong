...
<head>
    ...
    <title>高二名校协作体考试分析会--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二名校协作体考试分析会</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12879"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12879},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12879";
     ...
     <p>定于明天（3月11日）下午第9节课在树兰楼3楼会议室2召开高二名校协作体考试分析会，请各位高二任课老师准时参加。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12851.aspx" target="_self" title="标题：高三名校协作体考试分析会&#xD;点击数：227&#xD;发表时间：21年03月09日">高三名校协作体考试分析会</a>[ 03-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12883.aspx" target="_self" title="标题：高三体检工作安排&#xD;点击数：346&#xD;发表时间：21年03月11日">高三体检工作安排</a>[ 03-11 ]</div>
                        </div>
                    </div>
