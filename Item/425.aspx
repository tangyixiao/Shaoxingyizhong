...
<head>
    ...
    <title>各班主任请把《校讯通》的回执交德育处--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班主任请把《校讯通》的回执交德育处</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=425"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:425},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=425";
...
<P><FONT size=5><STRONG>    请迅速把《校讯通》的回执收齐交给德育处，以便接下来的工作的开展。</STRONG></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/422.aspx" target="_self" title="标题：一周检查情况公布(2009.10.8-10.17)&#xD;点击数：249&#xD;发表时间：09年10月19日">一周检查情况公布(2009.10.8-10.17)</a>[ 10-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/426.aspx" target="_self" title="标题：大合唱比赛座位安排&#xD;点击数：348&#xD;发表时间：09年10月20日">大合唱比赛座位安排</a>[ 10-20 ]</div>
                        </div>
                    </div>
