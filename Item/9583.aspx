...
<head>
    ...
    <title>通知：本学期学生活动截止时间--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">通知：本学期学生活动截止时间</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9583"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9583},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9583";
     ...
     <P>团学联主席团、各部门、各学生社团：</P>
<P>    本学期团学联、社团活动截止时间为1月5日（总结、考核工作除外），请各类活动及时收尾。若有大型活动请安排至期末考后。</P>
<P align=right>校团委<BR>2018年12月27日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9562.aspx" target="_self" title="标题：团报团刊订阅费用收缴通知&#xD;点击数：370&#xD;发表时间：18年12月24日">团报团刊订阅费用收缴通知</a>[ 12-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9584.aspx" target="_self" title="标题：2018“瀚辰杯”辩论赛半决赛安排&#xD;点击数：275&#xD;发表时间：18年12月27日">2018“瀚辰杯”辩论赛半决赛安排</a>[ 12-27 ]</div>
                        </div>
                    </div>
