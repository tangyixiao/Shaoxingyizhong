...
<head>
    ...
    <title>2008学年第二学期优秀寝室，优秀寝室长，优秀楼层长名单--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2008学年第二学期优秀寝室，优秀寝室长，优秀楼层长名单</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年08月16日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=104"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:104},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=104";
     ...
     <DIV><B></B> </DIV>
<DIV><B>经学校德育处考核、审定，下列寝室、寝室长、楼层长被评为优秀，特此表扬。</B></DIV>
<DIV>优秀寝室：</DIV>
<DIV><B>A</B><B>楼</B><B></B></DIV>
<DIV>A303  二（7）金晶 二（7）金竹雨 二(7) 钟瑜涛</DIV>
<DIV>A 109 一（2）王明良 一（2）罗炎良 一（4）金建 一（4）傅凌峰 </DIV>
<DIV>一（4）鲁海洋 一（10）沈凯</DIV>
<D
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/103.aspx" target="_self" title="标题：关于全体住校生会议通知&#xD;点击数：13&#xD;发表时间：09年08月16日">关于全体住校生会议通知</a>[ 08-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/109.aspx" target="_self" title="标题：关于军训动员预备会议的通知&#xD;点击数：950&#xD;发表时间：09年08月17日">关于军训动员预备会议的通知</a>[ 08-17 ]</div>
                        </div>
                    </div>
