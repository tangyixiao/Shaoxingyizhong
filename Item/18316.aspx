...
<head>
    ...
    <title>绍兴市第十一批普通高中精品（推荐）选修课程名单--教研成果-绍兴市第一中学</title>
...
<li class="li4 last"><a href="/Shaoxingyizhong/Category_380/Index.aspx">校际交流</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_77/Index.aspx" target="_self">教研成果</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴市第十一批普通高中精品（推荐）选修课程名单</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18316"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18316},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18316";
     ...
     <p>      <span style="font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);">根据绍兴市教研院公示，我校以下课程获评第十一批市精品（推荐）选修课程，向课程开发及参与老师表示祝贺。</span></p><p><span style="font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);">      《</span><span style="background-color: rgb(255, 255, 255); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 14px;">北斗创玩﹣ STEM 课程</span><span style="background-color: rgb(255, 255, 255); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 14px;">》  开发者：</span><span style="background-color: rgb(255, 255, 255); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 14px;">余栋材   参与者：</span><span style="background-color: rgb(255, 255, 255); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 14px;">白宗刚、施卡祥、马作菁、何凯</span></p><p><span style="background-color: rgb(255, 255, 255); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 14px;">      《食品安全与检疫》  开发者：郑晴晴
</span></p><p><span style="background-color: rgb(255, 255, 255); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 14px;">      《野性的呼唤》整本书阅读   开发者：蔡红    参与者：施芳芳、王晶晶、盛婷婷、马红蕾</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18203.aspx" target="_self" title="标题：我校2022年绍兴市教科规划课题优秀成果获奖名录&#xD;点击数：163&#xD;发表时间：23年06月28日">我校2022年绍兴市教科规划课题优秀成果获奖名录</a>[ 06-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18615.aspx" target="_self" title="标题：我校骆永明等3位教师入围首届绍兴市中小学教育科研骨干教师研学共同体成员&#xD;点击数：265&#xD;发表时间：23年10月16日">我校骆永明等3位教师入围首届绍兴市中小学教育科研骨干教师研…</a>[ 10-16 ]</div>
                        </div>
                    </div>
