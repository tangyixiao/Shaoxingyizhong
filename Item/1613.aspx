...
<head>
    ...
    <title>关于绍兴市属2010年教学论文评比征稿的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于绍兴市属2010年教学论文评比征稿的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1613"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1613},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1613";
     ...
     <P align=left>老师们： 
<P></P>
<P align=left>        绍兴市属2010年教学评比活动定于4月份举行，评优项目为教学论文、课堂教学（优质课）两类。 
<P></P>
<P align=left>        对于教学论文，各校选送的数额上限及时间为：高中语文、数学、英语，各校可分别选送10篇，其它学科各校可分别选送7篇；每人限送1篇。送交截止时间为4月10日（市级评比将在6月份以后）。参评教学论文字数一般不超过6000字。已在市级及以上报刊公开发表或各类征文竞赛中获奖的论文不再参评；以课题报告、调研报告形式撰写的，不予评奖。教学论文用A4纸打印，<STRONG>一式5份（其中2份在文章标题下行注明作者单位、姓名、联系电话，其余3份不必注明上述内容），</STRONG>打印采用word文档，正文字体为小4号宋体。 
<P></P>
<P align=left>        请前期参加校级教学论文评比的老师及其他有参评意向的老师在4月9日前将参评论文<STRONG>按要求</STRONG>送交教学处。 
<P></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1611.aspx" target="_self" title="标题：周五体育课改自修&#xD;点击数：433&#xD;发表时间：10年04月06日">周五体育课改自修</a>[ 04-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1627.aspx" target="_self" title="标题：高一、高二班主任&#xD;点击数：452&#xD;发表时间：10年04月06日">高一、高二班主任</a>[ 04-06 ]</div>
                        </div>
                    </div>
