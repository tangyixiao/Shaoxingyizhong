...
<head>
    ...
    <title>各班主任请注意（大课间入场路线）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班主任请注意（大课间入场路线）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年09月02日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=190"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:190},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=190";
     ...
     <DIV align=center><B>各班级紧急疏散（做操、升旗）进出场路线</B></DIV>
<DIV> </DIV>
<DIV><B>高一年级：在田径场中间草地从南——北1——16班</B></DIV>
<DIV>（4）、（7）、（10）班：从东侧楼梯下，经一楼连接长廊——经体操房跑步进入操场；</DIV>
<DIV>（1）、（2）、（3）班：由二楼连接走廊跑步经体育馆南台阶入场。</DIV>
<DIV>（5）、（6）班：由三楼西侧楼梯下，经一楼连接走廊西侧校门跑步入场。</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/189.aspx" target="_self" title="标题：高一、高二各班&#xD;点击数：523&#xD;发表时间：09年09月02日">高一、高二各班</a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/192.aspx" target="_self" title="标题：关于高一新生军训会操的通知&#xD;点击数：524&#xD;发表时间：09年09月02日">关于高一新生军训会操的通知</a>[ 09-02 ]</div>
                        </div>
                    </div>
