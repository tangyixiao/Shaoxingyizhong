...
<head>
    ...
    <title>招收啦啦操学员通知 --党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">招收啦啦操学员通知 </h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年08月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=146"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:146},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=146";
     ...
     <BR><FONT size=4>09级高一新生： <BR>为普及、推广啦啦操运动，学校体育俱乐部准备组建啦啦操运动队，在现高一新生中招收学员，要求身体健康，有团队合作精神，身高1.65米以上，有一定的舞蹈基础，音乐节奏感好，表现力强的女生。有兴趣的学生，到体育组（一楼何老师）报名，截止时间，2009-8-30。 <BR>          <BR><BR>     
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/145.aspx" target="_self" title="标题：关于行政会议的通知&#xD;点击数：692&#xD;发表时间：09年08月26日">关于行政会议的通知</a>[ 08-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/147.aspx" target="_self" title="标题：校园内不乱停车的通知&#xD;点击数：1327&#xD;发表时间：09年08月27日">校园内不乱停车的通知</a>[ 08-27 ]</div>
                        </div>
                    </div>
