...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2661"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2661},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2661";
     ...
     10月19日（星期二）下午第三节多功能厅召开教研组长、备课组长会议，讨论期中考试等事项，请准时参加。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2656.aspx" target="_self" title="标题：通知&#xD;点击数：731&#xD;发表时间：10年10月15日">通知</a>[ 10-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2666.aspx" target="_self" title="标题：各班学习委员会议通知&#xD;点击数：1183&#xD;发表时间：10年10月18日">各班学习委员会议通知</a>[ 10-18 ]</div>
                        </div>
                    </div>
