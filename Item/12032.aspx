...
<head>
    ...
    <title>高考监控设备安装通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12032"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12032},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12032";
     ...
     <P><FONT size=4>各位老师、各位班主任：</FONT></P>
<P><FONT size=4>因学校高考监控设备安装，可能会造成教室部分位置产生灰尘，请各位班主任谅解。施工期间，因高考监控设备调整，教室前摄像头暂停使用，设备调整完成后将恢复使用。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12019.aspx" target="_self" title="标题：高一选修课选课通知&#xD;点击数：457&#xD;发表时间：20年10月23日">高一选修课选课通知</a>[ 10-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12034.aspx" target="_self" title="标题：2019学年奖学金领取通知&#xD;点击数：327&#xD;发表时间：20年10月26日">2019学年奖学金领取通知</a>[ 10-26 ]</div>
                        </div>
                    </div>
