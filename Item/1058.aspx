...
<head>
    ...
    <title>元旦文艺会演节目预审通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">元旦文艺会演节目预审通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1058"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1058},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1058";
     ...
     <P>高一、高二各班：</P>
<P>        定于下周进行元旦文艺会演节目预审，请各班抓紧时间排练，准时参加。具体安排如下：</P>
<P>       高一：下周二（12月22日）下午第三、四节</P>
<P>       高二：下周三（12月23日）下午第三、四节</P>
<P>       地点：报告厅</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1031.aspx" target="_self" title="标题：大扫除停做通知&#xD;点击数：400&#xD;发表时间：09年12月14日">大扫除停做通知</a>[ 12-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1066.aspx" target="_self" title="标题：一周检查情况公布(2009.12.14-12.19)&#xD;点击数：275&#xD;发表时间：09年12月21日">一周检查情况公布(2009.12.14-12.19)</a>[ 12-21 ]</div>
                        </div>
                    </div>
