...
<head>
    ...
    <title>领取补办的会考准考证--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3195"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3195},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3195";
     ...
     <P>高二、高三班主任，请通知补办会考准考证的同学，今天中午到教学处领取准考证。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3182.aspx" target="_self" title="标题：高一、高二调课通知&#xD;点击数：526&#xD;发表时间：10年12月30日">高一、高二调课通知</a>[ 12-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3196.aspx" target="_self" title="标题：1月10-11日（周一、周二）会考监考安排(个别有变动）&#xD;点击数：806&#xD;发表时间：11年01月04日">1月10-11日（周一、周二）会考监考安排(个别有变动）</a>[ 01-04 ]</div>
                        </div>
                    </div>
