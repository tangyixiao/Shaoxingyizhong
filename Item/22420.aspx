...
<head>
    ...
    <title>生物教研活动--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22420"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22420},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22420";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 18px; text-wrap-mode: wrap; background-color: rgb(255, 255, 255);">      12月10日(本周三)下午全体生物教师参加教研活动，相关班级生物课改自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22418.aspx" target="_self" title="标题：绍兴一中教育集团第四届教科节课堂教学比武结果&#xD;点击数：180&#xD;发表时间：25年12月06日">绍兴一中教育集团第四届教科节课堂教学比武结果</a>[ 12-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22454.aspx" target="_self" title="标题：数学组汇报课通知&#xD;点击数：139&#xD;发表时间：25年12月11日">数学组汇报课通知</a>[ 12-11 ]</div>
                        </div>
                    </div>
