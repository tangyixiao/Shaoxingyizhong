...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=214"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:214},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=214";
     ...
     <DIV align=center><FONT size=4><B>关于召开教研组长会议的通知</B><B></B></FONT></DIV>
<DIV align=left> </DIV>
<DIV align=left>     <FONT size=4>为进一步落实2009学年第一学期学校工作思路中有关教学教研工作的要求，强化学科教研，促进教学质量的提高，教学处定于9月7日（星期一）下午第三节课在行政楼三楼会议室召开教研组长会议。会议主要内
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/211.aspx" target="_self" title="标题：高二体育选项课选班&#xD;点击数：536&#xD;发表时间：09年09月07日">高二体育选项课选班</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/215.aspx" target="_self" title="标题：各竞赛指导老师&#xD;点击数：768&#xD;发表时间：09年09月07日">各竞赛指导老师</a>[ 09-07 ]</div>
                        </div>
                    </div>
