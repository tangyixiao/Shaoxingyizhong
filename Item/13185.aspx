...
<head>
    ...
    <title>高三适应性考试分析会--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13185"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13185},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13185";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; font-size: 20px; background-color: rgb(255, 255, 255);">兹定于明天（4月16日）上午第5节课在树兰楼三楼会议室二召开高三适应性考试分析会，请各位高三任课老师准时参加。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13180.aspx" target="_self" title="标题：“21世纪杯”英语演讲比赛晋级名单及网上自主报名通知&#xD;点击数：398&#xD;发表时间：21年04月14日">“21世纪杯”英语演讲比赛晋级名单及网上自主报名通知</a>[ 04-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13193.aspx" target="_self" title="标题：化学课自修通知&#xD;点击数：252&#xD;发表时间：21年04月16日">化学课自修通知</a>[ 04-16 ]</div>
                        </div>
                    </div>
