...
<head>
    ...
    <title>心理组教学研讨通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15962"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15962},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15962";
     ...
     <p style="white-space: normal;">今天（11月2日）下午第九节课在行政楼四楼心理团辅室进行心理课程研讨，请心理组教师准时参加，欢迎各位老师莅临指导。</p><p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15961.aspx" target="_self" title="标题：心理组教学研讨通知&#xD;点击数：296&#xD;发表时间：21年10月12日">心理组教学研讨通知</a>[ 10-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15964.aspx" target="_self" title="标题：7.04班级一日考核&#xD;点击数：20&#xD;发表时间：22年07月05日">7.04班级一日考核</a>[ 07-05 ]</div>
                        </div>
                    </div>
