...
<head>
    ...
    <title>大合唱比赛座位安排--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">大合唱比赛座位安排</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年10月20日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=426"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:426},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=426";
     ...
     <P>      定于本周三下午2：35分在体育馆举行“重温光辉历程，传唱红色经典”大合唱比赛。请高一、高二各班在第二节下课后迅速到体育馆集中，按照指定位置就座。</P>
<P>      座位安排如下：</P>
<P><IMG src="/Shaoxingyizhong/UploadFiles/UploadFiles/news/editor/sysimage/file/xls.gif" border=0><A href="/Shaoxingyizhong/news/uploadimg/200910208273422
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/425.aspx" target="_self" title="标题：各班主任请把《校讯通》的回执交德育处&#xD;点击数：312&#xD;发表时间：09年10月20日">各班主任请把《校讯通》的回执交德育处</a>[ 10-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/427.aspx" target="_self" title="标题：批评&#xD;点击数：243&#xD;发表时间：09年10月20日">批评</a>[ 10-20 ]</div>
                        </div>
                    </div>
