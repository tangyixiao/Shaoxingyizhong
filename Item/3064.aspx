...
<head>
    ...
    <title>通知三则(修改)--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3064"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3064},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3064";
     ...
     <P>1、高一、高二研究性学习通知：定于下周周二（高一）、周三（高二）下午第三、四两节课进行研究性学习的开题活动，<FONT color=#f73809>请各班学习委员及各课题组长于本周五下午第三节课结束后到实南-201开会</FONT>，请相互转告。另请各课题指导老师做好开题指导工作。</P>
<P>2、12月17日星期五历史教研活动，相应班级历史课改自修。</P>
<P>3、下周高一、高二校本课程暂停。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3062.aspx" target="_self" title="标题：明天下午第三节高三体育课改自修&#xD;点击数：376&#xD;发表时间：10年12月15日">明天下午第三节高三体育课改自修</a>[ 12-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3065.aspx" target="_self" title="标题：高三班主任&#xD;点击数：405&#xD;发表时间：10年12月15日">高三班主任</a>[ 12-15 ]</div>
                        </div>
                    </div>
