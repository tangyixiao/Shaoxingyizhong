...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8559"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8559},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8559";
     ...
     <FONT size=4>今天下午高三精英班物理、历史、数学正常上课，请相关学生准时上课。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8557.aspx" target="_self" title="标题：部分老师外出培训通知&#xD;点击数：426&#xD;发表时间：18年05月16日">部分老师外出培训通知</a>[ 05-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8572.aspx" target="_self" title="标题：语文教研活动通知&#xD;点击数：412&#xD;发表时间：18年05月17日">语文教研活动通知</a>[ 05-17 ]</div>
                        </div>
                    </div>
