...
<head>
    ...
    <title>转发关于2009年中学高级教师申报对象业务考核的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">转发关于2009年中学高级教师申报对象业务考核的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=330"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:330},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=330";
     ...
     <DIV>
<DIV align=center><B>关于2009年中学高级教师申报对象业务考核的通知</B></DIV>
<DIV>各县（市、区）教育局、市属学校：</DIV>
<DIV>为提高2009年全市中学高级教师任职资格的评审质量，加强对评审对象掌握学科专业知识和实际教育教学能力和水平的考察，根据绍市教〔2009〕34号文件要求，经研究，今年继续对中小学教师申报中学高级教师人员进行教学业务水平考核，现将有关事项通知如下：</DIV>
<DIV><B>一、考核对象：</B></DIV>
<DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/323.aspx" target="_self" title="标题：9.17-23值周报道&#xD;点击数：537&#xD;发表时间：09年09月24日">9.17-23值周报道</a>[ 09-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/334.aspx" target="_self" title="标题：关于举办摄影培训讲座的通知&#xD;点击数：678&#xD;发表时间：09年09月27日">关于举办摄影培训讲座的通知</a>[ 09-27 ]</div>
                        </div>
                    </div>
