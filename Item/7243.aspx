...
<head>
    ...
    <title>高一年级学生填写身份证号信息的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一年级学生填写身份证号信息的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2017年08月25日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7243"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7243},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7243";
     ...
     因生成安全教育平台账号的需要，请高一年级各班在8月31日前完成身份证号信息表填写工作。原表格请到公共文件夹/校办/蒋抗力/高一身份证号统计中下载，完成后将表格放到已完成班级文件夹中。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7237.aspx" target="_self" title="标题：安全教育平台暑期作业未完成名单更新到28日&#xD;点击数：1539&#xD;发表时间：17年08月21日">安全教育平台暑期作业未完成名单更新到28日</a>[ 08-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7280.aspx" target="_self" title="标题：温馨提醒&#xD;点击数：1359&#xD;发表时间：17年09月05日">温馨提醒</a>[ 09-05 ]</div>
                        </div>
                    </div>
