...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5778"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5778},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5778";
     ...
     <P>全校各班注意：</P>
<P>      今天下午第四节课（16：25）进行运动会入场式彩排，请各班级准时到指定地点集中（在篮球场由南向北依次为高一、高二、高三年段），按统一指挥进行。谢谢！<BR></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5777.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：64&#xD;发表时间：16年10月25日">表扬与失物招领</a>[ 10-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5781.aspx" target="_self" title="标题：失物招领&#xD;点击数：108&#xD;发表时间：16年10月25日">失物招领</a>[ 10-25 ]</div>
                        </div>
                    </div>
