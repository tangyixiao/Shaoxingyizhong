...
<head>
    ...
    <title>请高三同学明天（30号）中午12:30分到实验楼机房完成安全平台作业--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">请高三同学明天（30号）中午12:30分到实验楼机房完成安全平台作业</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9162"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9162},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9162";
     ...
     <P>请高三同学明天（30号）中午12:30分到实验楼机房完成“秋季开学第一课”安全平台作业（已完成的同学忽略此通知）。忘记账号的同学可下载附件进行查询，初始密码：123456。</P>
<P>附件：<A title=高三学生安全平台账号 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201809/2018092916460271.xls">高三学生安全平台账号</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9085.aspx" target="_self" title="标题：关于我校“自动体外除颤器（AED）”使用说明&#xD;点击数：264&#xD;发表时间：18年09月19日">关于我校“自动体外除颤器（AED）”使用说明</a>[ 09-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9168.aspx" target="_self" title="标题：运动会期间安全提示&#xD;点击数：335&#xD;发表时间：18年10月06日">运动会期间安全提示</a>[ 10-06 ]</div>
                        </div>
                    </div>
