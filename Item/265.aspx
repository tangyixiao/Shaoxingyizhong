...
<head>
    ...
    <title>关于举行的“尖子生培养和班风建设”座谈会--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于举行的“尖子生培养和班风建设”座谈会</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=265"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:265},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=265";
     ...
     <DIV>       <FONT size=5><STRONG>经学校研究决定，于本星期五下午第三、四节课在行政楼三楼会议室举行“尖子生培养和班风建设”座谈会，请下列老师参加并积极提供建设性意见。</STRONG></FONT></DIV>
<DIV><FONT size=5><STRONG>    张  江    黄伟中    蒋 
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/264.aspx" target="_self" title="标题：关于开展温馨寝室评比活动的通知&#xD;点击数：643&#xD;发表时间：09年09月14日">关于开展温馨寝室评比活动的通知</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/266.aspx" target="_self" title="标题：一周检查情况公布 (2009.9.7-9.11) &#xD;点击数：553&#xD;发表时间：09年09月14日">一周检查情况公布 (2009.9.7-9.11) </a>[ 09-14 ]</div>
                        </div>
                    </div>
