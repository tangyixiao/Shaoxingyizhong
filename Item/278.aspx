...
<head>
    ...
    <title>关于进一步加强甲型H1N1流感预防工作的通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于进一步加强甲型H1N1流感预防工作的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=278"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:278},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=278";
...
<P style="TEXT-INDENT: 27pt; mso-char-indent-count: 2.0"><SPAN style="FONT-SIZE: 13.5pt; COLOR: black; mso-ascii-font-family: ''&#718;&#805;,Verdana,Arial''; mso-hansi-font-family: ''&#718;&#805;,Verdana,Arial''">为了进一步加强对甲型</SPAN><SPAN lang=EN-US
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/269.aspx" target="_self" title="标题：自行车未上锁情况通报(第二周)&#xD;点击数：528&#xD;发表时间：09年09月14日">自行车未上锁情况通报(第二周)</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/280.aspx" target="_self" title="标题：关于学生体检延期的通知&#xD;点击数：503&#xD;发表时间：09年09月15日">关于学生体检延期的通知</a>[ 09-15 ]</div>
                        </div>
                    </div>
