...
<head>
    ...
    <title>数学组外出教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22455"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22455},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22455";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap-mode: wrap; background-color: rgb(255, 255, 255);">今天（12月11日）数学组外出90学时培训，全校数学课改自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22449.aspx" target="_self" title="标题：美术教研活动通知&#xD;点击数：77&#xD;发表时间：25年12月10日">美术教研活动通知</a>[ 12-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22486.aspx" target="_self" title="标题：高三七校联考时间安排&#xD;点击数：147&#xD;发表时间：25年12月15日">高三七校联考时间安排</a>[ 12-15 ]</div>
                        </div>
                    </div>
