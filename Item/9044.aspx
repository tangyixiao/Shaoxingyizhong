...
<head>
    ...
    <title>求真实验室（化学）招新考核通告--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">求真实验室（化学）招新考核通告</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9044"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9044},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9044";
     ...
     <P>  求真实验室将于<FONT color=#ff0000><STRONG>9月22日13:55-15:40</STRONG></FONT>对高一新生进行笔试考核，75分钟笔试+30分钟实验。（平行班化竞将统一考试，并在考试后统一讲解试卷；创新班化竞同学将与平行班化竞分卷考试，可以迟一节课参加考试；创新班非化竞同学若报名，将与平行班化竞同学同卷。）</P>
<P>    请有意加入求真实验室的同学于<STRONG>9月18日晚自修放学前</STRONG>至206傅有为（社长）、202赵骏晖（副社长）报名，<STRONG>未报名的同学若参加考试，成绩无效。</STRONG></P>
<P align=right>求真实验室<BR>2018年9月13日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9038.aspx" target="_self" title="标题：关于各班上报学生代表名单的通知&#xD;点击数：441&#xD;发表时间：18年09月12日">关于各班上报学生代表名单的通知</a>[ 09-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9045.aspx" target="_self" title="标题：养新文学社开会及招新写作选拔通告（有修改）&#xD;点击数：228&#xD;发表时间：18年09月13日">养新文学社开会及招新写作选拔通告（有修改）</a>[ 09-13 ]</div>
                        </div>
                    </div>
