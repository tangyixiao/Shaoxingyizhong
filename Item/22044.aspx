...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22044"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22044},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22044";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/10/202510091609326505.bmp" style="max-width: 100%; " title="202510091609326505.bmp" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22034.aspx" target="_self" title="标题：失物招领（公交卡）&#xD;点击数：48&#xD;发表时间：25年10月09日">失物招领（公交卡）</a>[ 10-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22048.aspx" target="_self" title="标题：运动会彩排通知&#xD;点击数：342&#xD;发表时间：25年10月10日">运动会彩排通知</a>[ 10-10 ]</div>
                        </div>
                    </div>
