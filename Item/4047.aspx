...
<head>
    ...
    <title>5月26日寝室缺席名单--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4047"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4047},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4047";
...
<P>     C305       谢安琦      三（11）</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4046.aspx" target="_self" title="标题：5月26日住校生未打卡名单&#xD;点击数：4621&#xD;发表时间：11年05月27日">5月26日住校生未打卡名单</a>[ 05-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4048.aspx" target="_self" title="标题：值周检查情况汇总（5月26日星期四）&#xD;点击数：591&#xD;发表时间：11年05月27日">值周检查情况汇总（5月26日星期四）</a>[ 05-27 ]</div>
                        </div>
                    </div>
