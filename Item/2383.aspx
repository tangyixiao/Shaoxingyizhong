...
<head>
    ...
    <title>今天广播操情况通报--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2383"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2383},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2383";
     ...
     <P> </P>
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 24pt; mso-char-indent-count: 2.0"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=4>由于绝大多数班主任老师能够到场督促，所以高一、高二学生做操质量比以前大有提高，但还是有个别班级迟到。望各班在下楼后进入操场的时候能跑步前进。</FONT></SPAN><SPAN lang=EN-US style="FONT-SIZE: 12pt"><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2382.aspx" target="_self" title="标题：高一寝室内务评比优胜寝室&#xD;点击数：321&#xD;发表时间：10年09月07日">高一寝室内务评比优胜寝室</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2390.aspx" target="_self" title="标题：关于举行高一年级迎国庆大合唱比赛的通知&#xD;点击数：334&#xD;发表时间：10年09月08日">关于举行高一年级迎国庆大合唱比赛的通知</a>[ 09-08 ]</div>
                        </div>
                    </div>
