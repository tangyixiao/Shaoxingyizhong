...
<head>
    ...
    <title>参加航模兴趣小组　按照成绩择优录取--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">参加航模兴趣小组　按照成绩择优录取</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：天天商报</span> <span>作者：佚名</span> <span>发布时间：2009年12月01日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=747"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:747},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=747";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/625.aspx" target="_self" title="标题：绍兴一中校友陈曦首问奥巴马&#xD;点击数：1783&#xD;发表时间：09年11月25日">绍兴一中校友陈曦首问奥巴马</a>[ 11-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/748.aspx" target="_self" title="标题：符合条件的学生，都有机会成为推荐生！&#xD;点击数：520&#xD;发表时间：09年12月01日">符合条件的学生，都有机会成为推荐生！</a>[ 12-01 ]</div>
                        </div>
                    </div>
