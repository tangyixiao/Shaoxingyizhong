...
<head>
    ...
    <title>2011年高考政策加分名单公示--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2011年高考政策加分名单公示</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3625"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3625},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3625";
     ...
     2011年高考政策加分名单公示在1号教学楼前面教学处的橱窗内，公示时间3月29日--8月底。如有疑问可打举报电话。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3624.aspx" target="_self" title="标题：高三政策加分原件、复印件上交今天截止&#xD;点击数：382&#xD;发表时间：11年03月29日">高三政策加分原件、复印件上交今天截止</a>[ 03-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3631.aspx" target="_self" title="标题：文印室结算通知（上学期）&#xD;点击数：444&#xD;发表时间：11年03月29日">文印室结算通知（上学期）</a>[ 03-29 ]</div>
                        </div>
                    </div>
