...
<head>
    ...
    <title>高一生活委员、权益部成员开会通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一生活委员、权益部成员开会通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15594"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15594},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15594";
     ...
     <p>请高一各班生活委员、团学联学生权益部高一成员，于5月13日（周五）中午12:30至树兰楼（行政楼）3楼会议室（二）参加校服满意度调研会议。</p><p style="text-align: right;">总务处 德育处 团委
2022年5月12日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15588.aspx" target="_self" title="标题：学术节 | 5月14日（周六）活动安排&#xD;点击数：505&#xD;发表时间：22年05月12日">学术节 | 5月14日（周六）活动安排</a>[ 05-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15595.aspx" target="_self" title="标题：博雅模拟联合国大会校内会参会通知&#xD;点击数：201&#xD;发表时间：22年05月13日">博雅模拟联合国大会校内会参会通知</a>[ 05-13 ]</div>
                        </div>
                    </div>
