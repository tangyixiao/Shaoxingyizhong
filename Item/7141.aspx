...
<head>
    ...
    <title>错时用餐取消--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7141"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7141},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7141";
     ...
     <P>高三学生已经离校，中午食堂就餐压力减小，高一、高二学生错时用餐取消，统一用餐时间为11：55。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7127.aspx" target="_self" title="标题：音乐教研活动通知&#xD;点击数：124&#xD;发表时间：17年06月13日">音乐教研活动通知</a>[ 06-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7146.aspx" target="_self" title="标题：心理教研活动通知&#xD;点击数：124&#xD;发表时间：17年06月15日">心理教研活动通知</a>[ 06-15 ]</div>
                        </div>
                    </div>
