...
<head>
    ...
    <title>关于各班试场布置情况检查的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于各班试场布置情况检查的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年10月31日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=488"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:488},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=488";
     ...
     <P>
<TABLE style="WIDTH: 523pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=695 border=0 x:str>
<COLGROUP>
<COL style="WIDTH: 82pt; mso-width-source: userset; mso-width-alt: 3488" width=109>
<COL style="WIDTH: 34pt; mso-width-source: user
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/486.aspx" target="_self" title="标题：高二期中考试试场、监考安排&#xD;点击数：358&#xD;发表时间：09年10月30日">高二期中考试试场、监考安排</a>[ 10-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/491.aspx" target="_self" title="标题：09学年第一学期期中考试阅卷&#xD;点击数：336&#xD;发表时间：09年11月02日">09学年第一学期期中考试阅卷</a>[ 11-02 ]</div>
                        </div>
                    </div>
