...
<head>
    ...
    <title>晚间安全检查记录2017.5.27---30--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2017.5.27---30</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7064"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7064},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7064";
     ...
     <P>1.5月27日高一（10）班灯未关。</P>
<P>2.5月30日高一（1）班和（2）班门未关。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7056.aspx" target="_self" title="标题：每日晨检表未交情况通报5.31&#xD;点击数：46&#xD;发表时间：17年05月31日">每日晨检表未交情况通报5.31</a>[ 05-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7082.aspx" target="_self" title="标题：高一高二各班主任请提醒学生&#xD;点击数：307&#xD;发表时间：17年06月03日">高一高二各班主任请提醒学生</a>[ 06-03 ]</div>
                        </div>
                    </div>
