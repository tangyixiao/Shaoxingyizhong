...
<head>
    ...
    <title>班长、劳动委员会议通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8945"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8945},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8945";
     ...
     <P>    请各班班长、劳动委员于今天中午12：30在阶梯教室4106参加会议，并随带纸笔，相互告知。</P>
<P align=right>德育处</P>
<P align=right>2018.09.03</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8943.aspx" target="_self" title="标题：今日大扫除通知&#xD;点击数：150&#xD;发表时间：18年09月03日">今日大扫除通知</a>[ 09-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8957.aspx" target="_self" title="标题：失物招领&#xD;点击数：152&#xD;发表时间：18年09月03日">失物招领</a>[ 09-03 ]</div>
                        </div>
                    </div>
