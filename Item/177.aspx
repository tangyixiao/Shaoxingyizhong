...
<head>
    ...
    <title>高一今天（8.31）下午有关事项--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一今天（8.31）下午有关事项</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高一</span> <span>发布时间：2009年08月31日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=177"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:177},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=177";
     ...
     <P>1.下午第二节按课表上课（由任课老师管理），若体育课则有班主任管理。</P>
<P>2.下午大扫除按计划进行（要求高点，严点）</P>
<P>3.明天早上高一学生7：15到教室，7：25按要求坐好。</P>
<P>高一年级   2009.8.31</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/128.aspx" target="_self" title="标题：高一班主任关注&#xD;点击数：702&#xD;发表时间：09年08月21日">高一班主任关注</a>[ 08-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/183.aspx" target="_self" title="标题：高一年级值周(白天)工作安排&#xD;点击数：470&#xD;发表时间：09年09月01日">高一年级值周(白天)工作安排</a>[ 09-01 ]</div>
                        </div>
                    </div>
