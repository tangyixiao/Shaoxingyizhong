...
<head>
    ...
    <title>本周大扫除暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8493"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8493},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8493";
     ...
     <P>本周大扫除暂停，请相互告知</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8492.aspx" target="_self" title="标题：年轻班主任会议通知（有修改）&#xD;点击数：324&#xD;发表时间：18年05月07日">年轻班主任会议通知（有修改）</a>[ 05-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8495.aspx" target="_self" title="标题：失物招领&#xD;点击数：163&#xD;发表时间：18年05月07日">失物招领</a>[ 05-07 ]</div>
                        </div>
                    </div>
