...
<head>
    ...
    <title>明天（周一）升旗仪式暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">明天（周一）升旗仪式暂停通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7274"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7274},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7274";
     ...
     明天（周一）升旗仪式暂停，作息时间按周二进行。课间操时间各班进行课间操排练。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7273.aspx" target="_self" title="标题：失物招领&#xD;点击数：1207&#xD;发表时间：17年09月03日">失物招领</a>[ 09-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7275.aspx" target="_self" title="标题：各班包干区划分情况及值周班日常各项工作检查要求（暂定）&#xD;点击数：293&#xD;发表时间：17年09月03日">各班包干区划分情况及值周班日常各项工作检查要求（暂定）</a>[ 09-03 ]</div>
                        </div>
                    </div>
