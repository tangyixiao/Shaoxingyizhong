...
<head>
    ...
    <title>绍兴一中航模兴趣小组招生和组队参赛办法--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中航模兴趣小组招生和组队参赛办法</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：&lt;a href=http://www.sxyz.net&gt;绍兴一中&lt;/a&gt;</span> <span>作者：校办</span> <span>发布时间：2009年10月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=461"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:461},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=461";
     ...
     <DIV align=center><B>绍兴一中航模兴趣小组招生和组队参赛办法</B><B></B></DIV>
<DIV align=center> </DIV>
<DIV align=left><B>一、招生和组队原则</B></DIV>
<DIV align=left>严格按照“公平、公正、公开”原则，坚持标准，选拔学有余力，思想品德优良，身体素质、心理素质良好，有航模运动兴趣和特长的高一、高二学生参加航模兴趣小组活动；并从中选拔运动成绩优秀的学生参加各级各类比赛。</DIV>
<DIV
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/460.aspx" target="_self" title="标题：绍兴一中学生（家长）教学等投诉处理办法&#xD;点击数：515&#xD;发表时间：09年10月26日">绍兴一中学生（家长）教学等投诉处理办法</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/464.aspx" target="_self" title="标题：2009年参加市属中学田径运动会名单公示&#xD;点击数：559&#xD;发表时间：09年10月27日">2009年参加市属中学田径运动会名单公示</a>[ 10-27 ]</div>
                        </div>
                    </div>
