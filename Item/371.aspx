...
<head>
    ...
    <title>年度预算会议通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">年度预算会议通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年10月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=371"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:371},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=371";
     ...
     <P>定于今天下午第三节课在行政楼三楼会议室举行2010年度预算工作会议,请下列人员准时出席:</P>
<P>各处室负责人   各年级长   傅韶松   张蕾   阮国华   朱玛莉  吴军芳   王幼青</P>
<P>             &n
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/370.aspx" target="_self" title="标题：行政支部会议通知&#xD;点击数：510&#xD;发表时间：09年10月09日">行政支部会议通知</a>[ 10-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/375.aspx" target="_self" title="标题：转发从业人员普通话培训与水平测试的通知&#xD;点击数：548&#xD;发表时间：09年10月10日">转发从业人员普通话培训与水平测试的通知</a>[ 10-10 ]</div>
                        </div>
                    </div>
