...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=427"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:427},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=427";
     ...
     <P><FONT face=Verdana size=4>昨天升旗仪式，以下班级集合用时超过5分钟：</FONT></P>
<P><FONT size=4></FONT> </P>
<P><FONT size=4>   高二（1）班  <FONT size=4>高二（3）班  <FONT size=4>高二（6）班  <FONT size=4>高二（13）班</FONT></FONT></FONT></FONT></P>
<P><FONT siz
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/426.aspx" target="_self" title="标题：大合唱比赛座位安排&#xD;点击数：348&#xD;发表时间：09年10月20日">大合唱比赛座位安排</a>[ 10-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/432.aspx" target="_self" title="标题：通知两则&#xD;点击数：357&#xD;发表时间：09年10月21日">通知两则</a>[ 10-21 ]</div>
                        </div>
                    </div>
