...
<head>
    ...
    <title>德育处两点提示--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2290"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2290},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2290";
...
<P><FONT size=4>   1.近几天早上，部分接送新高一学生的车辆在校门口随意停放和掉头现象比较严重，请新高一各班主任提醒学生及家长，为了维护校门口交通秩序，确保安全，接送车辆不要在校门口停放和掉头。</FONT></P>
<P><FONT size=4>   2.有部分学生自行车停放在体育馆北侧，请班主任提醒学生停到网球场班级指定的停车位置。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2279.aspx" target="_self" title="标题：关于报“军训积极分子“通知&#xD;点击数：328&#xD;发表时间：10年08月25日">关于报“军训积极分子“通知</a>[ 08-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2292.aspx" target="_self" title="标题：关于贫困生调查摸底的通知&#xD;点击数：379&#xD;发表时间：10年08月26日">关于贫困生调查摸底的通知</a>[ 08-26 ]</div>
                        </div>
                    </div>
