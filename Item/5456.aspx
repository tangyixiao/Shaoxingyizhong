...
<head>
    ...
    <title>全校教工办公室安排表（有修改）--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">全校教工办公室安排表（有修改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5456"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5456},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5456";
     ...
     <P><A title=教师办公室 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201609/2016090909091895.xls">教师办公室</A></P>
<P>备注：如有错误与遗漏请与年级长联系。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5452.aspx" target="_self" title="标题：教工大会通知&#xD;点击数：68&#xD;发表时间：16年09月05日">教工大会通知</a>[ 09-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5459.aspx" target="_self" title="标题：关于全校教师参加开学典礼的通知&#xD;点击数：234&#xD;发表时间：16年09月07日">关于全校教师参加开学典礼的通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
