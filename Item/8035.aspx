...
<head>
    ...
    <title>期末教学安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8035"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8035},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8035";
     ...
     <P><FONT size=4>期末教学安排如下：<BR>1.2月4-6日，高一、高二期末考试；</FONT></P>
<P><FONT size=4>2.2月7日，高一、高二学生在家休息；</FONT></P>
<P><FONT size=4>3.2月6-8日，高三期末考试；</FONT></P>
<P><FONT size=4>4.2月8日，高一、高二试卷分析（按临时课表及临时作息时间表上课）、休业式、领取成绩单、布置寒假作业；</FONT></P>
<P><FONT size=4>5.2月8日，高二、高三4月份学考选考报名确认；</FONT></P>
<P><FONT size=4><FONT size=4>6.2月9日，2018级创新班招生考试。</FONT><BR></P></FONT>
<P><BR> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8027.aspx" target="_self" title="标题：关于再次催还高二高三学生老校区所借图书的通知&#xD;点击数：488&#xD;发表时间：18年01月29日">关于再次催还高二高三学生老校区所借图书的通知</a>[ 01-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8041.aspx" target="_self" title="标题：本周六、周日上课安排&#xD;点击数：228&#xD;发表时间：18年01月31日">本周六、周日上课安排</a>[ 01-31 ]</div>
                        </div>
                    </div>
