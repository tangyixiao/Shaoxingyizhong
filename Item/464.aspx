...
<head>
    ...
    <title>2009年参加市属中学田径运动会名单公示--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2009年参加市属中学田径运动会名单公示</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年10月27日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=464"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:464},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=464";
     ...
     <DIV align=center><B>2009</B><B>年参加市属中学田径运动会名单</B></DIV>
<DIV> </DIV>
<DIV>根据校运动会选拔以及日常训练，学校选派下列同学代表学校参加09市属中学田径运动会，现予以公示，如有优秀队员可以到体育组报名，公示时间三天。</DIV>
<DIV>二（5）沈王刚、二（9）陈琪能、三（14）吴剑锋、孙凯杰、三（12）章豪臻、三（11）吴林峰、陶  棋、一（5）王竹盈、一（7）包佳宁、三（11）俞霞楠、一（13）邢羽南、邢丝琦
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/461.aspx" target="_self" title="标题：绍兴一中航模兴趣小组招生和组队参赛办法&#xD;点击数：557&#xD;发表时间：09年10月26日">绍兴一中航模兴趣小组招生和组队参赛办法</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/465.aspx" target="_self" title="标题：关于各处室报刊订阅的通知&#xD;点击数：515&#xD;发表时间：09年10月27日">关于各处室报刊订阅的通知</a>[ 10-27 ]</div>
                        </div>
                    </div>
