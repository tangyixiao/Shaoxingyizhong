...
<head>
    ...
    <title>下周一进行应急演练的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">下周一进行应急演练的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3688"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3688},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3688";
     ...
     <P> </P>
<P><FONT size=4>全体师生请注意：</FONT></P>
<P><FONT size=4>   定于下周一早上升旗仪式前进行全校应急演练，请班主任做好本班学生组织工作，全体师生准时参加。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3686.aspx" target="_self" title="标题：值周检查情况汇总（4月7日星期四）&#xD;点击数：341&#xD;发表时间：11年04月08日">值周检查情况汇总（4月7日星期四）</a>[ 04-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3690.aspx" target="_self" title="标题：关于严查学生迟到及课桌整洁的通知&#xD;点击数：500&#xD;发表时间：11年04月09日">关于严查学生迟到及课桌整洁的通知</a>[ 04-09 ]</div>
                        </div>
                    </div>
