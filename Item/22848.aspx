...
<head>
    ...
    <title>高一晚自修（3.15-3.27）--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一晚自修（3.15-3.27）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22848"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22848},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22848";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2026/3/202603131324037282.png" style="max-width: 100%; " title="202603131324037282.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22842.aspx" target="_self" title="标题：高一3月回头考检测监考安排和学生考场安排（3.13-3.14）&#xD;点击数：254&#xD;发表时间：26年03月12日">高一3月回头考检测监考安排和学生考场安排（3.13-3.14）</a>[ 03-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22952.aspx" target="_self" title="标题：高一晚自修值班（3.29-4.3）&#xD;点击数：84&#xD;发表时间：26年03月27日">高一晚自修值班（3.29-4.3）</a>[ 03-27 ]</div>
                        </div>
                    </div>
