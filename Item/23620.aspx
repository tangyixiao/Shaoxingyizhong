    ...
    <a href="/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2026年09月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23620"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23620},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23620";
     ...
     <p style="margin-top: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 20px;">高一、高二各班级：</span></p><p style="margin-top: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); text-indent: 37px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 20px;">  为规范大课间跑操秩序，现招募跑操考核员，具体事宜通知如下：</span></p><p style="margin-top: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); text-indent: 37px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 20px;">  1、推荐人数：高一每班推荐 2人，高二每班推荐1人；</span></p><p style="margin-top: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); text-indent: 37px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 20px;">  2、基本要求：责任心强、时间观念好、公平公正、自身纪律良好；</span></p><p style="margin-top: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); text-indent: 37px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 20px;">  3、工作内容：考核各班跑操出勤率、整齐度等，记录结果并上报，协助维持秩序；</span></p><p style="margin-top: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); text-indent: 37px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 20px;">  4、荣誉激励：工作优秀者将评为 “校荐工作之星”；</span></p><p style="margin-top: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); text-indent: 37px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 20px;">  5、报名方式：请于本周四（9月10日）17:00 前向班主任报名。</span></p><p style="text-align: right;">
</p><p style="text-align: right;"><span style="font-family: 宋体; font-size: 20px;">德育处</span></p><p style="text-align: right;"><span style="font-family: 宋体; font-size: 20px;">2026年9月9日</span></p><p style="text-align: right;"><span style="font-family: 宋体; font-size: 14px;"> </span></p><p style="margin-top: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); text-indent: 37px; margin-bottom: 20px !important;"><span style="font-family: 宋体; font-size: 19px;"></span>
</p><p>
</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23619.aspx" target="_self" title="标题：大课间跑操考核员招募通知&#xD;点击数：87&#xD;发表时间：26年03月06日">大课间跑操考核员招募通知</a>[ 03-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Item/23621.aspx" target="_self" title="标题：9.8班级一日考核&#xD;点击数：21&#xD;发表时间：26年09月09日">9.8班级一日考核</a>[ 09-09 ]</div>
                        </div>
                    </div>
