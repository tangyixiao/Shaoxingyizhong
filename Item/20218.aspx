...
<head>
    ...
    <title>棒垒球体验选拔活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20218"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20218},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20218";
     ...
     <p style="text-indent:32px"><span style="font-family: 宋体; font-size: 16px;">为加强我校棒球（男生）、垒球（女生）训练队伍建设，将于今天下午第三节体锻课进行棒球、垒球项目的体验选拔活动，请有意向的同学准时到学校田径场参与活动。</span></p><p><span style="font-family: 宋体; font-size: 16px;"> </span></p><p><span style="font-family: 宋体; font-size: 16px;">时间：今天（<span style="font-size: 18px; font-family: Calibri;">12</span><span style="font-size: 18px; font-family: 宋体;">日</span>）下午第三节课</span></p><p><span style="font-family: 宋体; font-size: 16px;">地点：学校田径场</span></p><p><span style="font-family: 宋体; font-size: 16px;">对象：高一所有学生</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20207.aspx" target="_self" title="标题：高三名校协作体考试分析会通知&#xD;点击数：223&#xD;发表时间：24年09月11日">高三名校协作体考试分析会通知</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20227.aspx" target="_self" title="标题：关于高一学生中秋假期完成浙江省高校招生考试信息管理系统注册的通知&#xD;点击数：122&#xD;发表时间：24年09月13日">关于高一学生中秋假期完成浙江省高校招生考试信息管理系统注册…</a>[ 09-13 ]</div>
                        </div>
                    </div>
