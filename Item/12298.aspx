...
<head>
    ...
    <title>跨年门设计稿图片及数据上交通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">跨年门设计稿图片及数据上交通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12298"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12298},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12298";
     ...
     请各班负责跨年门设计的同学在12月2日放学前将设计稿图片及数据发送到音美公共文件夹，自建文件夹（请注明班级）。谢谢！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12294.aspx" target="_self" title="标题：第十三周早上迟到学生统计&#xD;点击数：3937&#xD;发表时间：20年12月01日">第十三周早上迟到学生统计</a>[ 12-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12301.aspx" target="_self" title="标题：失物招领&#xD;点击数：184&#xD;发表时间：20年12月02日">失物招领</a>[ 12-02 ]</div>
                        </div>
                    </div>
