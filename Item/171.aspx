...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=171"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:171},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=171";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
               ...
               <FONT size=5>全体教职工要以主人翁姿态为整洁校园作自己的贡献。在校园内不乱停自行车、电动车、汽车，停到指定的停车处，汽车不进教学区。乱停车将就地扣车半周。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/169.aspx" target="_self" title="标题：教工会议通知&#xD;点击数：681&#xD;发表时间：09年08月31日">教工会议通知</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/174.aspx" target="_self" title="标题：绍兴一中考勤和请假制度征求意见稿&#xD;点击数：720&#xD;发表时间：09年09月04日">绍兴一中考勤和请假制度征求意见稿</a>[ 09-04 ]</div>
                        </div>
                    </div>
