...
<head>
    ...
    <title>文明检查反馈--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4011"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4011},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4011";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 21pt; mso-char-indent-count: 2.0"><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3>今天上午，北海街道有关部门对我校“一创双查”</FONT></SPAN><SPAN style="FONT-SIZE: 10pt; COLOR: black; FONT-FAMILY: 宋体; mso-ascii-font-family: Arial; mso-hansi-font-family: Arial; mso-bidi-font-family: Arial">（创建全国文明城市、迎接国家卫生城市及环保城市复查）</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><FONT size=3>工作进行了预查，认为工作开展有明显进步，但也存在着一些不足，主要是教师办公室的卫生问题，尤其是在少数教师的办公桌抽屉中检查出了蟑螂屎等敏感不洁物。希望全体教师认真自查，彻底打扫卫生死角，坚决清除不洁残留物。</FONT></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4010.aspx" target="_self" title="标题：通知&#xD;点击数：1012&#xD;发表时间：11年05月23日">通知</a>[ 05-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4063.aspx" target="_self" title="标题：关于教工会议改期的通知&#xD;点击数：920&#xD;发表时间：11年05月30日">关于教工会议改期的通知</a>[ 05-30 ]</div>
                        </div>
                    </div>
