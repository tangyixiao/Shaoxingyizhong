...
<head>
    ...
    <title>各班主任请注意（关于收看国庆阅兵式）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班主任请注意（关于收看国庆阅兵式）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年09月29日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=349"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:349},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=349";
...
<P><FONT size=5><STRONG>      根据教育局文件精神和学校《告家长书》要求，请各位告知本班学生认真收看国庆阅兵式。国庆庆典将于10月1日10时开始，届时请收看。</STRONG></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/346.aspx" target="_self" title="标题：表扬&#xD;点击数：404&#xD;发表时间：09年09月29日">表扬</a>[ 09-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/352.aspx" target="_self" title="标题：各班主任请注意(关于今天的班会课)&#xD;点击数：421&#xD;发表时间：09年09月30日">各班主任请注意(关于今天的班会课)</a>[ 09-30 ]</div>
                        </div>
                    </div>
