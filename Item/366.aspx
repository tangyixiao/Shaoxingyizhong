...
<head>
    ...
    <title>关于校团委、学生会成员培训的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于校团委、学生会成员培训的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年10月08日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=366"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:366},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=366";
...
<DIV>    <FONT size=3>请全体新一届团委、学生会成员于10月10日中午12：20到实验楼南-205室参加团学干部培训，随带笔记本，勿迟到。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/327.aspx" target="_self" title="标题：第二期黑板报检查成绩公布&#xD;点击数：472&#xD;发表时间：09年09月28日">第二期黑板报检查成绩公布</a>[ 09-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/386.aspx" target="_self" title="标题：关于2009学年第一期“求真讲坛”的预告&#xD;点击数：419&#xD;发表时间：09年10月12日">关于2009学年第一期“求真讲坛”的预告</a>[ 10-12 ]</div>
                        </div>
                    </div>
