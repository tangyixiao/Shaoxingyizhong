...
<head>
    ...
    <title>高三班主任请关注--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三班主任请关注</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高三</span> <span>发布时间：2009年10月08日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=365"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:365},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=365";
     ...
     <FONT size=4>      定于今天下午第四节课在教Ⅱ-209室召开高三各班班长、学习委员会议。请各班主任通知本班班长、学习委员4：25分准时到会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/322.aspx" target="_self" title="标题：高三&#xD;点击数：487&#xD;发表时间：09年09月24日">高三</a>[ 09-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/374.aspx" target="_self" title="标题：高三党支部会议&#xD;点击数：451&#xD;发表时间：09年10月09日">高三党支部会议</a>[ 10-09 ]</div>
                        </div>
                    </div>
