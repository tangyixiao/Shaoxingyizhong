...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7433"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7433},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7433";
     ...
     请各年段各班团支书，于今天中午至教学楼阶梯教室4107门内领取树人导报，共三期，并在窗台上的表格内签字确认。注意不要把废纸等遗留在现场。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7423.aspx" target="_self" title="标题：模拟联合国社团招新面试通知&#xD;点击数：184&#xD;发表时间：17年10月10日">模拟联合国社团招新面试通知</a>[ 10-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7440.aspx" target="_self" title="标题：演讲社、心理沙龙社招新面试通知&#xD;点击数：216&#xD;发表时间：17年10月12日">演讲社、心理沙龙社招新面试通知</a>[ 10-12 ]</div>
                        </div>
                    </div>
