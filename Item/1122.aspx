...
<head>
    ...
    <title>元旦文艺会演音乐上交通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">元旦文艺会演音乐上交通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>元旦文艺会演音乐上交通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2009年12月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1122"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1122},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1122";
     ...
     <P>参加元旦文艺会演节目表演的班级：</P>
<P>        请务必在今天放晚学之前把音乐上传到“校公共文件夹”——“德育处”——“2010校元旦文艺汇演音乐”文件夹，以班级、节目名为文件夹名，并注明主演姓名、所需无线话筒、耳麦、立杆数量。</P>
<P>        </P>
<P>       </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1101.aspx" target="_self" title="标题：2010年元旦节目预审结果&#xD;点击数：1017&#xD;发表时间：09年12月24日">2010年元旦节目预审结果</a>[ 12-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1123.aspx" target="_self" title="标题：各班住校生就寝纪律、寝室卫生情况统计表(第17周）&#xD;点击数：423&#xD;发表时间：09年12月28日">各班住校生就寝纪律、寝室卫生情况统计表(第17周）</a>[ 12-28 ]</div>
                        </div>
                    </div>
