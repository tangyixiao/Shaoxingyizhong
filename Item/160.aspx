    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年08月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=160"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:160},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=160";
     ...
     <TABLE style="WIDTH: 357pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=474 border=0 x:str>
<COLGROUP>
...
<COL style="WIDTH: 49pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/159.aspx" target="_self" title="标题：高一回头考监考安排（8月31日）&#xD;点击数：462&#xD;发表时间：09年08月28日">高一回头考监考安排（8月31日）</a>[ 08-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/161.aspx" target="_self" title="标题：高三回头考监考安排&#xD;点击数：603&#xD;发表时间：09年08月28日">高三回头考监考安排</a>[ 08-28 ]</div>
                        </div>
                    </div>
