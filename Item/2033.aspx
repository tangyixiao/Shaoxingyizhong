...
<head>
    ...
    <title>上午第四节课下课有关的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">上午第四节课下课有关的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2033"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2033},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2033";
     ...
     <P>       高一、高二的老师们</P>
<P>      由于高三的结束，原上午第四节课下课管理学生的时间作改动，高二上午第四节课后准时放，高一迟5分钟放。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2025.aspx" target="_self" title="标题：关于干部学年考核评价的通知&#xD;点击数：1008&#xD;发表时间：10年06月10日">关于干部学年考核评价的通知</a>[ 06-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2039.aspx" target="_self" title="标题：提醒&#xD;点击数：884&#xD;发表时间：10年06月12日">提醒</a>[ 06-12 ]</div>
                        </div>
                    </div>
