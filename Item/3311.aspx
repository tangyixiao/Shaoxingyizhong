...
<head>
    ...
    <title>50余位顶尖毕业生回母校传授经验--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">50余位顶尖毕业生回母校传授经验</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3311"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3311},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3311";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3310.aspx" target="_self" title="标题：本科读什么，老外想法不一样&#xD;点击数：643&#xD;发表时间：11年02月12日">本科读什么，老外想法不一样</a>[ 02-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3312.aspx" target="_self" title="标题：立足学校内涵发展　构建精品校园文化&#xD;点击数：487&#xD;发表时间：11年02月12日">立足学校内涵发展　构建精品校园文化</a>[ 02-12 ]</div>
                        </div>
                    </div>
