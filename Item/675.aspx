...
<head>
    ...
    <title>我的名字叫做红--读书推荐-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=675"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:675},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=675";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 24pt; LINE-HEIGHT: 18pt; mso-char-indent-count: 2.0; mso-line-height-rule: exactly"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体"><FONT color=#000000>这是<SPAN lang=EN-US>06</SPAN>年诺贝尔文学奖得主帕慕克的成名作。它的叙事方式有些特别，通篇读下来，甚至觉得“我”是一个置身故事之外的人。作者用一个历史悬疑故事打开了世界。融合了无限的想象，处处透出了作者的哲思和对爱情的理解。文中频频出现的细密画师总是有些神秘，文中蕴意就在这平平淡淡的叙述中被挖掘，让人回味无穷。<SPAN lang=EN-US><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></FONT></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/674.aspx" target="_self" title="标题：在细雨中呼喊&#xD;点击数：1869&#xD;发表时间：09年11月28日">在细雨中呼喊</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/676.aspx" target="_self" title="标题：中国知青终结&#xD;点击数：826&#xD;发表时间：09年11月28日">中国知青终结</a>[ 11-28 ]</div>
                        </div>
                    </div>
