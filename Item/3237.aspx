...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3237"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3237},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3237";
     ...
     <P>　　高三“重点工程”、“名牌工作”今天开始暂停。</P>
<P>       下星期一开始，体育、音乐、美术、校本课程、劳技等课程改自修，相关老师做好结束工作；广播操、课外体育锻炼暂停。</P>
<P>        下星期三开始，高二文科物理、化学课改自修。</P>
<P>                                                            教学处 2011/1/8</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3224.aspx" target="_self" title="标题：会考考务培训通知&#xD;点击数：496&#xD;发表时间：11年01月07日">会考考务培训通知</a>[ 01-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3241.aspx" target="_self" title="标题：高三“五校联考”分析会议&#xD;点击数：638&#xD;发表时间：11年01月11日">高三“五校联考”分析会议</a>[ 01-11 ]</div>
                        </div>
                    </div>
