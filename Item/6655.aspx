...
<head>
    ...
    <title>广播讲话通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6655"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6655},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6655";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
            ...
            今天下午第四节课，高一活动课（雨天暂停）、高二班会课、高三班会课统一改成广播讲话，烦请班主任做好组织工作，谢谢！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6654.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：88&#xD;发表时间：17年03月30日">表扬与失物招领</a>[ 03-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6656.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：97&#xD;发表时间：17年03月31日">大课间操暂停通知</a>[ 03-31 ]</div>
                        </div>
                    </div>
