...
<head>
    ...
    <title>今天大课间进行室内操--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14829"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14829},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14829";
     ...
     <p>今天（1月9日）大课间进行室内操。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14824.aspx" target="_self" title="标题：1.04班级一日考核.&#xD;点击数：22&#xD;发表时间：22年01月05日">1.04班级一日考核.</a>[ 01-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14832.aspx" target="_self" title="标题：室内升旗仪式通知&#xD;点击数：75&#xD;发表时间：22年01月10日">室内升旗仪式通知</a>[ 01-10 ]</div>
                        </div>
                    </div>
