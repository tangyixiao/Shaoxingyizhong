...
<head>
    ...
    <title>通知：本学期团学活动截止时间--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">通知：本学期团学活动截止时间</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12373"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12373},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12373";
     ...
     <P>团学联主席团、各部门，社团联、各学生社团：</P>
<P>    本学期团学联、社团活动截止时间为12月19日（总结考核工作及主席团日常工作通知除外），若还有活动，请安排至期末考后。</P>
<P>    感谢大家在本学期的付出与成果！</P>
<P align=right>校团委<BR>2020年12月14日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12366.aspx" target="_self" title="标题：关于进行团支部工作考核的通知&#xD;点击数：341&#xD;发表时间：20年12月11日">关于进行团支部工作考核的通知</a>[ 12-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12374.aspx" target="_self" title="标题：今天下午团支书会议地点变更通知&#xD;点击数：133&#xD;发表时间：20年12月14日">今天下午团支书会议地点变更通知</a>[ 12-14 ]</div>
                        </div>
                    </div>
