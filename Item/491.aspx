...
<head>
    ...
    <title>09学年第一学期期中考试阅卷--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">09学年第一学期期中考试阅卷</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年11月02日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=491"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:491},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=491";
     ...
     <TABLE style="WIDTH: 478pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=638 border=0 x:str>
<COLGROUP>
<COL style="WIDTH: 39pt; mso-width-source: userset; mso-width-alt: 1664" width=52>
<COL style="WIDTH: 125pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/488.aspx" target="_self" title="标题：关于各班试场布置情况检查的通知&#xD;点击数：327&#xD;发表时间：09年10月31日">关于各班试场布置情况检查的通知</a>[ 10-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/499.aspx" target="_self" title="标题：高三期中考试场布置要求&#xD;点击数：350&#xD;发表时间：09年11月03日">高三期中考试场布置要求</a>[ 11-03 ]</div>
                        </div>
                    </div>
