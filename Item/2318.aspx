...
<head>
    ...
    <title>关于开学典礼的几点提示--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2318"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2318},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2318";
     ...
     <P> </P>
<P><FONT size=4>   1.为确保明天早上开学典礼准时开幕，请各班班主任组织好本班学生有秩序地入场，避免拥挤；</FONT></P>
<P><FONT size=4>   2.由于体育馆内的地板暑期刚做过油漆，请班主任提醒带凳子的同学一定要轻拿轻放，以免损坏地板漆面；</FONT></P>
<P><FONT size=4>   3.值周班级各派4名同学在体育场入口处维持入场秩序；</FONT></P>
<P><FONT size=4>   4.德育处将对各班入场秩序和会场纪律进行检查。</FONT></P>
...
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2317.aspx" target="_self" title="标题：2010学年绍兴一中开学典礼方案及座位安排&#xD;点击数：547&#xD;发表时间：10年08月31日">2010学年绍兴一中开学典礼方案及座位安排</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2322.aspx" target="_self" title="标题：课间操通知&#xD;点击数：421&#xD;发表时间：10年09月01日">课间操通知</a>[ 09-01 ]</div>
                        </div>
                    </div>
