...
<head>
    ...
    <title>关于信息能力提升工程最后阶段培训的提醒--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于信息能力提升工程最后阶段培训的提醒</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7748"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7748},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7748";
     ...
     <P> </P>
<P>各位老师：</P>
<P>信息能力提升工程培训已过大半，老师们学习辛苦了！现就最后阶段相关事项提醒如下：</P>
<P>（1）截止时间：12月20号。请务必于截止日期前完成各项培训任务。</P>
<P>（2）最后阶段的培训任务包括：观看至少900分钟专题课程视频、参与主题讨论至少2次、完成工作坊作业（提交5份佐证材料）。</P>
<P>（3）尚未完成900分钟专题课程视频学习的老师请抓紧时间，已经完成的老师请参与主题讨论并完成工作坊作业。</P>
<P>（4）参与主题讨论的操作类似于贴吧回复，点击主题讨论1或主题讨论2，进入讨论界面，拉到底，在文本框内输入至少20字，点击回复即可。若想查看自己的回复，点击末页，最后一条就是。</P>
<P>（5）工作坊作业需提交5份材料：个人研修计划以及配套的教学设计、ppt、教学实录、教学反思。请仔细阅读每份作业的要求，依照模板完成相关作业，分别上传（每个栏目只要上传一个作业，即教学设计作业只交教学设计、ppt只交ppt，不要一起交）。点击上传附件，提交即可。其中教学实录要求至少10分钟，有过录像课的老师可上传之前的上课视频，没有录像课的老师可使用手机拍摄10分钟以上的教学录像即可。提交作业完成后7个工作日内可查看批改情况，界面上有“优秀”、“良好”等字样</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7747.aspx" target="_self" title="标题：市教育教学研究院2017年12月份市直活动安排&#xD;点击数：236&#xD;发表时间：17年12月05日">市教育教学研究院2017年12月份市直活动安排</a>[ 12-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7758.aspx" target="_self" title="标题：美术组公开课通知&#xD;点击数：232&#xD;发表时间：17年12月06日">美术组公开课通知</a>[ 12-06 ]</div>
                        </div>
                    </div>
