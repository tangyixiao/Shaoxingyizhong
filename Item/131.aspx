...
<head>
    ...
    <title>关于开学初教学检查和高三IB模块考试的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于开学初教学检查和高三IB模块考试的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年08月24日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=131"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:131},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=131";
     ...
     <TABLE style="WIDTH: 519pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=692 border=0 x:str>
<COLGROUP>
<COL style="WIDTH: 54pt" width=72>
<COL style="WIDTH: 54pt" span=2 width=72>
<COL style="WIDTH: 47pt; mso-width-source: userset; mso-wi
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/125.aspx" target="_self" title="标题：高三部分选修IB上课安排&#xD;点击数：688&#xD;发表时间：09年08月20日">高三部分选修IB上课安排</a>[ 08-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/134.aspx" target="_self" title="标题：关于2008学年获奖论文纸质稿及荣誉证书复印件的征集通知&#xD;点击数：659&#xD;发表时间：09年09月07日">关于2008学年获奖论文纸质稿及荣誉证书复印件的征集通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
