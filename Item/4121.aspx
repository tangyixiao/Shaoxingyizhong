...
<head>
    ...
    <title>高三班主任请注意--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4121"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4121},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4121";
     ...
     高三班主任：接市招办通知，今年高考中自选模块的题号顺序只要用铅笔描就行，不需要再用黑色签字笔描一边。其他用铅笔作图在确认无误情况下要再用黑色签字笔描一边。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4118.aspx" target="_self" title="标题：6月5日高一、高二下午提前上课通知&#xD;点击数：728&#xD;发表时间：11年06月04日">6月5日高一、高二下午提前上课通知</a>[ 06-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4124.aspx" target="_self" title="标题：2011高考考务培训会议通知&#xD;点击数：688&#xD;发表时间：11年06月05日">2011高考考务培训会议通知</a>[ 06-05 ]</div>
                        </div>
                    </div>
