...
<head>
    ...
    <title>关于新学期教学楼办公室调整的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于新学期教学楼办公室调整的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8865"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8865},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8865";
...
<P><FONT size=4>    关于新学期教学楼办公室的安排，班主任按照班级号由年段长统一安排，任课老师按照年级任课由学科主任统一安排，分备课组坐定。相关学科新招聘和调入教师由课程处联系学科组落实。</FONT></P>
<P><FONT size=4>    感谢大家的配合！</FONT></P>
<P><FONT size=4>                                                                      党政办<BR></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8843.aspx" target="_self" title="标题：暑假放假值班安排&#xD;点击数：239&#xD;发表时间：18年07月05日">暑假放假值班安排</a>[ 07-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8887.aspx" target="_self" title="标题：关于差旅费报销的通知&#xD;点击数：238&#xD;发表时间：18年08月24日">关于差旅费报销的通知</a>[ 08-24 ]</div>
                        </div>
                    </div>
