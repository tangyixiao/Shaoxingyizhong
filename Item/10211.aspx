...
<head>
    ...
    <title>2019学年教师任课任职意向表上交的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2019学年教师任课任职意向表上交的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10211"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10211},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10211";
...
<P><SPAN style='FONT-SIZE: 14px; TEXT-DECORATION: none; FONT-FAMILY: "宋体"; FONT-VARIANT: normal; WHITE-SPACE: normal; WORD-SPACING: 0px; TEXT-TRANSFORM: none; FLOAT: none; FONT-WEIGHT: 400; COLOR: rgb(0,0,0); FONT-STYLE: normal; TEXT-ALIGN: left; ORPHANS: 2; DISPLAY: inline !important; LETTER-SPACING: normal; BACKGROUND-COLOR: rgb(255,255,255); TEXT-INDENT: 0px; -webkit-text-stroke-width: 0px'>2019学年教师任课任职意向表已经下发到学科主任（还没有拿到的组请学科主任或派代表到课程处领取表格），请老师们抓紧填好，交到学科主任处，由学科主任在6月5日下班前统一交到教科室。</SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10206.aspx" target="_self" title="标题：6月市直教研活动安排&#xD;点击数：256&#xD;发表时间：19年06月03日">6月市直教研活动安排</a>[ 06-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10236.aspx" target="_self" title="标题：数学英语学科外校来访通知&#xD;点击数：330&#xD;发表时间：19年06月10日">数学英语学科外校来访通知</a>[ 06-10 ]</div>
                        </div>
                    </div>
