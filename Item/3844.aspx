...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3844"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3844},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3844";
     ...
     <P>　　定于今天下午第三节课，在行政楼三楼召开高三备课组长会议，</P>
<P>布置下一阶段复习工作安排及校模拟考试事项．</P>
<P>　　　　　　　　　　　　　　　　　　　　　　　教学处</P>
<P>　　　　　　　　　　　　　　　　　　　　　　　　2011/05/03</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3840.aspx" target="_self" title="标题：高一年级春季负重接力比赛成绩&#xD;点击数：419&#xD;发表时间：11年04月30日">高一年级春季负重接力比赛成绩</a>[ 04-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3847.aspx" target="_self" title="标题：上学期文印室印刷费结算第四次通知&#xD;点击数：346&#xD;发表时间：11年05月03日">上学期文印室印刷费结算第四次通知</a>[ 05-03 ]</div>
                        </div>
                    </div>
