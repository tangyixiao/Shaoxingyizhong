...
<head>
    ...
    <title>高三部分教师会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6326"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6326},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6326";
     ...
     <P>今天下午第三节课召开高三的年级长、班主任、各学科备课组长会议，地点行政楼3楼会议室，请相关老师准时与会。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6325.aspx" target="_self" title="标题：高一高二期末考试场布置要求&#xD;点击数：294&#xD;发表时间：17年01月13日">高一高二期末考试场布置要求</a>[ 01-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6328.aspx" target="_self" title="标题：高三培优课结束通知&#xD;点击数：204&#xD;发表时间：17年01月13日">高三培优课结束通知</a>[ 01-13 ]</div>
                        </div>
                    </div>
