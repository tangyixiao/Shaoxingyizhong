...
<head>
    ...
    <title>关于领取爱国主义通用卡的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于领取爱国主义通用卡的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2527"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2527},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2527";
     ...
     学生爱国主义通用卡已做好，请相关各班到德育处领取。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2525.aspx" target="_self" title="标题：通知&#xD;点击数：558&#xD;发表时间：10年09月25日">通知</a>[ 09-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2533.aspx" target="_self" title="标题：关于回收家长满意度评测表的通知&#xD;点击数：472&#xD;发表时间：10年09月26日">关于回收家长满意度评测表的通知</a>[ 09-26 ]</div>
                        </div>
                    </div>
