...
<head>
    ...
    <title>班主任：09年未成年人医疗保障相关通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">班主任：09年未成年人医疗保障相关通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年08月31日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=179"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:179},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=179";
     ...
     <DIV align=center>09年未成年人医疗保障相关通知</DIV>
<DIV>09年未成年人医保录入表格已置于“校内公共文件夹”—“校办”—“财务室”—“相关资料及录入表格”中，请各班复制录入表，由学生自行录入，完成后<B>以班级重命名文件</B>后重置于文件夹内。电子表上报时间<B>截止至</B><B>9</B><B>月</B><B>7</B><B>日（下周一）。费用暂不缴纳，</B>待和社保局核对好数据后再行通知。另：其他有关未成年人医保的信息同时置于该文件夹内，有兴趣的可同时查阅。谢谢配
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/174.aspx" target="_self" title="标题：绍兴一中考勤和请假制度征求意见稿&#xD;点击数：720&#xD;发表时间：09年09月04日">绍兴一中考勤和请假制度征求意见稿</a>[ 09-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/180.aspx" target="_self" title="标题：绍兴一中2009学年工作思路（初稿）&#xD;点击数：803&#xD;发表时间：09年09月01日">绍兴一中2009学年工作思路（初稿）</a>[ 09-01 ]</div>
                        </div>
                    </div>
