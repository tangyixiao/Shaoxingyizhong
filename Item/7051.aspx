...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7051"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7051},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7051";
     ...
     <FONT size=4>今天下午体育组全体老师外出参加教研活动，相关班级体育课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7050.aspx" target="_self" title="标题：高一选修课暂停通知&#xD;点击数：180&#xD;发表时间：17年05月31日">高一选修课暂停通知</a>[ 05-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7055.aspx" target="_self" title="标题：高二选修走班上课地点调整通知&#xD;点击数：214&#xD;发表时间：17年05月31日">高二选修走班上课地点调整通知</a>[ 05-31 ]</div>
                        </div>
                    </div>
