    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年11月11日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=542"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:542},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=542";
     ...
     <P><FONT face=楷体_GB2312 size=4>各位教工：</FONT></P>
<P><FONT face=楷体_GB2312 size=4>      本周三、周四智品文化传播有限公司在本校图书馆举行免费赠书及优惠售书宣传活动，有兴趣的教工凭请柬到活动现场免费领取图书一份，高一、高二学生凭书目介绍领取（每天前100位）图书一册。</FONT></P>
<P><FONT face=楷体_GB2312 size=4>      请柬以年级为单位到德育处领。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/534.aspx" target="_self" title="标题：大扫除停做通知&#xD;点击数：281&#xD;发表时间：09年11月09日">大扫除停做通知</a>[ 11-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/547.aspx" target="_self" title="标题：今天早晨下列车子违章&#xD;点击数：270&#xD;发表时间：09年11月12日">今天早晨下列车子违章</a>[ 11-12 ]</div>
                        </div>
                    </div>
