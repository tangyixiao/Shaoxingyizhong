...
<head>
    ...
    <title>寻物启事（暗红色篮球）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21073"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21073},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21073";
     ...
     <p>
</p><p class="MsoListParagraph" style="margin-left:24px;text-indent:32px;line-height:25px"><span style="color: rgb(0, 0, 0); font-size: 18px;"><strong><span style="color: rgb(0, 0, 0); font-family: 华文宋体;">昨天（本周三）体锻课，有老师在体育馆篮球架下丢失暗红色篮球一只，有拾到者麻烦送到德育处办公室，谢谢！</span></strong></span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21071.aspx" target="_self" title="标题：寻物启事三则（校服和饭卡）&#xD;点击数：66&#xD;发表时间：25年03月13日">寻物启事三则（校服和饭卡）</a>[ 03-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21075.aspx" target="_self" title="标题：3.12班级一日考核&#xD;点击数：58&#xD;发表时间：25年03月13日">3.12班级一日考核</a>[ 03-13 ]</div>
                        </div>
                    </div>
