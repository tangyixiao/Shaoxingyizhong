...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9231"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9231},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9231";
     ...
     <!--StartFragment -->
<DIV>10月24日（周三），语文老师参加绍兴市直、柯桥区联合举办的“特级教师谢澹、彭玉华语文教学专场活动”，高一、高三参加一天，当天语文课改自修。高二下午参加。<BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9229.aspx" target="_self" title="标题：英语教研活动通知&#xD;点击数：289&#xD;发表时间：18年10月22日">英语教研活动通知</a>[ 10-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9232.aspx" target="_self" title="标题：地理教研活动通知&#xD;点击数：198&#xD;发表时间：18年10月22日">地理教研活动通知</a>[ 10-22 ]</div>
                        </div>
                    </div>
