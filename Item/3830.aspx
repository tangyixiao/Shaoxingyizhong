...
<head>
    ...
    <title>历史老师教研活动课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">历史老师教研活动课改自修</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3830"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3830},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3830";
     ...
     <P>明天（星期五）历史组全体老师外出教研活动，所任班级科目改自修。</P>
<P>                                                                                   4.28</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3829.aspx" target="_self" title="标题：2011年6月全省普通高中会考日程安排&#xD;点击数：709&#xD;发表时间：11年04月28日">2011年6月全省普通高中会考日程安排</a>[ 04-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3831.aspx" target="_self" title="标题：高二年级春季负重接力比赛成绩&#xD;点击数：497&#xD;发表时间：11年04月29日">高二年级春季负重接力比赛成绩</a>[ 04-29 ]</div>
                        </div>
                    </div>
