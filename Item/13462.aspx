...
<head>
    ...
    <title>学生权益相关会议通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13462"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13462},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13462";
     ...
     <p>今天（5月21日）中午12:30将举行学生权益会议，请学生会权益部全体同学准时参加。</p><p>同时，邀请其他有意向的同学参会。欢迎大家积极参与！</p><p>地点：树兰楼（行政楼）3楼会议室（二）</p><p style="text-align: right;">校团委、总务处
2021年5月21日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13460.aspx" target="_self" title="标题：团员代表大会预通知&#xD;点击数：341&#xD;发表时间：21年05月21日">团员代表大会预通知</a>[ 05-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13466.aspx" target="_self" title="标题：部分社团、部门参加团代会筹备会的通知&#xD;点击数：291&#xD;发表时间：21年05月21日">部分社团、部门参加团代会筹备会的通知</a>[ 05-21 ]</div>
                        </div>
                    </div>
