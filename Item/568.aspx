...
<head>
    ...
    <title>绍兴一中推行新式课间操--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=568"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:568},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=568";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/567.aspx" target="_self" title="标题：敬爱的老师，你们辛苦了！&#xD;点击数：448&#xD;发表时间：09年11月13日">敬爱的老师，你们辛苦了！</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/569.aspx" target="_self" title="标题：省特级教师协会学术年会开幕&#xD;点击数：376&#xD;发表时间：09年11月13日">省特级教师协会学术年会开幕</a>[ 11-13 ]</div>
                        </div>
                    </div>
