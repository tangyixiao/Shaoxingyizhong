...
<head>
    ...
    <title>值周小结及考核评价--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7302"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7302},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7302";
     ...
     <P>上周值周班高二（1）班同学表现良好，认真负责，能及时反馈，沟通值周工作中遇到的各方面问题，值得表扬。</P>
<P>校园新建伊始，各方面工作都有待完善，希望在以后的值周工作中，各班同学能再接再厉，共建新一中。</P>
<P>附：<A title=值周小结 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201709/2017091113474940.doc">值周小结</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7300.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：136&#xD;发表时间：17年09月11日">表扬与失物招领</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7304.aspx" target="_self" title="标题：今天下午最后一节课大扫除通知&#xD;点击数：179&#xD;发表时间：17年09月11日">今天下午最后一节课大扫除通知</a>[ 09-11 ]</div>
                        </div>
                    </div>
