...
<head>
    ...
    <title>【书画社、创意设计社】写生通知--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">【书画社、创意设计社】写生通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14574"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14574},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14574";
     ...
     <p>请采一书画社、创意设计社高一社员于12月4日（周六）下午第一节课至行政楼下花园集合，进行校园写生，自备材料及绘画用具，并提前向班级做好请假说明。</p><p style="text-align: right;">采一书画社、创意设计社
2021年12月3日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14571.aspx" target="_self" title="标题：【话剧社】校史剧排练通知&#xD;点击数：57&#xD;发表时间：21年12月02日">【话剧社】校史剧排练通知</a>[ 12-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14622.aspx" target="_self" title="标题：【象棋社】社员活动通知（地点变更）&#xD;点击数：64&#xD;发表时间：21年12月09日">【象棋社】社员活动通知（地点变更）</a>[ 12-09 ]</div>
                        </div>
                    </div>
