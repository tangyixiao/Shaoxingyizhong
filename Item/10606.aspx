...
<head>
    ...
    <title>关于高一（4）班任课老师会议的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一（4）班任课老师会议的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10606"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10606},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10606";
     ...
     <FONT size=4>请高一（4）班全体任课老师（包括体育、音乐老师）于今天下午第4节课到树兰楼三楼会议室三开会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10601.aspx" target="_self" title="标题：美术生上课通知&#xD;点击数：201&#xD;发表时间：19年09月23日">美术生上课通知</a>[ 09-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10607.aspx" target="_self" title="标题：关于物理、化学教研活动的通知&#xD;点击数：375&#xD;发表时间：19年09月24日">关于物理、化学教研活动的通知</a>[ 09-24 ]</div>
                        </div>
                    </div>
