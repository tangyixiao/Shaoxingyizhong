...
<head>
    ...
    <title>高一、高二研究性学习的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二研究性学习的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高一、高二研究性学习的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年02月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3404"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3404},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3404";
     ...
     请高一、高二研究性学习的小组长，抓紧时间完成结题报告，3月15日前上交。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3392.aspx" target="_self" title="标题：高三、高二班主任：有关“三项考试”报名信息确认要求&#xD;点击数：421&#xD;发表时间：11年02月28日">高三、高二班主任：有关“三项考试”报名信息确认要求</a>[ 02-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3418.aspx" target="_self" title="标题：高三全体任课教师会议&#xD;点击数：398&#xD;发表时间：11年03月02日">高三全体任课教师会议</a>[ 03-02 ]</div>
                        </div>
                    </div>
