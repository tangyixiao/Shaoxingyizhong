...
<head>
    ...
    <title>通知：领取校园文化明信片征集活动纪念品--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">通知：领取校园文化明信片征集活动纪念品</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8367"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8367},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8367";
     ...
     <!--StartFragment -->
<DIV>    在校园文化明信片素材征集活动中作品被录用的同学，以及在本明信片制作中有突出贡献的同学，请至2114团委办公室领取活动奖励。</DIV>
<DIV><BR>    以下同学领取“承风漱芳”明信片一套：</DIV>
<DIV>109谢洁瑜、113金奕驰、118邵一川、204祝欣妍、210何晨泽、216金雨丰、216田婧、312章钟鼎</DIV>
<DIV><BR>    以下同学领取“博雅一中人”明信片一套：</DIV>
<DIV>111顾杰锐、113李晨、116程王正远、117易澍渲、206李笑笑、216金雨丰、216田婧、216郭杨杰</DIV>
<DIV><BR>    感谢全体同学在本活动中的积极参与以及对学生会宣传部工作的大力支持！</DIV>
<DIV> </DIV>
<DIV align=right>校团委 学生会宣传部<BR>2018年4月16日<BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8366.aspx" target="_self" title="标题：关于推荐优秀团员参加第二十五期课余党校学习的通知&#xD;点击数：327&#xD;发表时间：18年04月16日">关于推荐优秀团员参加第二十五期课余党校学习的通知</a>[ 04-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8370.aspx" target="_self" title="标题：求真实验室：醋氨己酸合成及含量分析、氨基苯磺酸合成及提纯&#xD;点击数：378&#xD;发表时间：18年04月17日">求真实验室：醋氨己酸合成及含量分析、氨基苯磺酸合成及提纯</a>[ 04-17 ]</div>
                        </div>
                    </div>
