...
<head>
    ...
    <title>全校各班主任请注意（关于下发假期材料）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">全校各班主任请注意（关于下发假期材料）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3279"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3279},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3279";
...
<P><FONT size=4>    请通知本班班长于今天中午12:00准时到文印室（校食堂背后，宿舍楼住管处楼下一楼），领取学期末各种下发材料，包括《寒假情况调查表》、《社会实践情况表》、《寒假告家长书》、《爱心倡议书》等，并在放假前下发给本班同学。望相互转告！</FONT></P>
...
<P>                                                                     </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3272.aspx" target="_self" title="标题：关于做好期末考前教育与卫生工作的通知&#xD;点击数：503&#xD;发表时间：11年01月19日">关于做好期末考前教育与卫生工作的通知</a>[ 01-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3285.aspx" target="_self" title="标题：表扬&#xD;点击数：532&#xD;发表时间：11年01月21日">表扬</a>[ 01-21 ]</div>
                        </div>
                    </div>
