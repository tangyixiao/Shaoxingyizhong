...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=534"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:534},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=534";
     ...
     <P>因天气原因，今日大扫除暂停。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/528.aspx" target="_self" title="标题：绍兴一中各班住校生就寝纪律、寝室卫生情况统计表（ 2009.11.1-2009.11.6）&#xD;点击数：258&#xD;发表时间：09年11月09日">绍兴一中各班住校生就寝纪律、寝室卫生情况统计表（ 2009.11.1…</a>[ 11-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/542.aspx" target="_self" title="标题：通知&#xD;点击数：245&#xD;发表时间：09年11月11日">通知</a>[ 11-11 ]</div>
                        </div>
                    </div>
