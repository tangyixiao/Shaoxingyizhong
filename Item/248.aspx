...
<head>
    ...
    <title>关于学生会干部招聘面试的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于学生会干部招聘面试的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年09月11日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=248"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:248},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=248";
...
<DIV align=left><FONT size=3>    请下列同学于9月16日（星期三）中午12：10到实验楼南203室参加面试，面试依照表格上的名单顺序逐个进行，其余同学在实验楼南205室等候。过时不候，请相互转告。</FONT></DIV>
...
<TD vAlign=top width=14
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/247.aspx" target="_self" title="标题：关于团委干部招聘面试的通知&#xD;点击数：457&#xD;发表时间：09年09月11日">关于团委干部招聘面试的通知</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/279.aspx" target="_self" title="标题：2009年暑期社会实践活动评选结果&#xD;点击数：482&#xD;发表时间：09年09月15日">2009年暑期社会实践活动评选结果</a>[ 09-15 ]</div>
                        </div>
                    </div>
