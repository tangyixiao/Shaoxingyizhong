...
<head>
    ...
    <title>关于学生品德考核公示的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于学生品德考核公示的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3265"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3265},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3265";
...
<P><FONT size=4>      经过前段时间班主任的积极工作，本学期学生品德考核工作完成了大部分程序，现经德育处审核，最后请各班将考核结果在班级中进行公示，公示后再输入学生的学籍管理系统。谢谢。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3262.aspx" target="_self" title="标题：通知&#xD;点击数：623&#xD;发表时间：11年01月18日">通知</a>[ 01-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3267.aspx" target="_self" title="标题：期末德育处主要工作安排&#xD;点击数：711&#xD;发表时间：11年01月18日">期末德育处主要工作安排</a>[ 01-18 ]</div>
                        </div>
                    </div>
