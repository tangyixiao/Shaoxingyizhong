...
<head>
    ...
    <title>关于明天大课间跑操改为篮球场集中讲话的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于明天大课间跑操改为篮球场集中讲话的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19228"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19228},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19228";
     ...
     <p style="text-indent:140px">
</p><p> </p><p>各年段、各班级：</p><p>       明天大课间跑操暂停，改为篮球场集中讲话，请各班按照升旗仪式的队伍站位，特通知。</p><p> </p><p>
</p><p style="text-indent: 406px; text-align: right;">德育处、体育组</p><p style="text-indent: 406px; text-align: right;">2024年1月9日</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19225.aspx" target="_self" title="标题：1.5班级一日考核&#xD;点击数：44&#xD;发表时间：24年01月09日">1.5班级一日考核</a>[ 01-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19229.aspx" target="_self" title="标题：1.9跑操量化考核反馈&#xD;点击数：94&#xD;发表时间：24年01月09日">1.9跑操量化考核反馈</a>[ 01-09 ]</div>
                        </div>
                    </div>
