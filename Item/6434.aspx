...
<head>
    ...
    <title>高三年级部分学生会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三年级部分学生会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6434"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6434},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6434";
     ...
     <FONT size=4>请高三年级参加过竞赛的学生，于今天中午12：30到行政楼五楼会议室开会，望准时参加。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6427.aspx" target="_self" title="标题：阳明中学创新班招生考试监考及阅卷安排&#xD;点击数：1554&#xD;发表时间：17年02月17日">阳明中学创新班招生考试监考及阅卷安排</a>[ 02-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6436.aspx" target="_self" title="标题：学生证注册及补办通知&#xD;点击数：354&#xD;发表时间：17年02月20日">学生证注册及补办通知</a>[ 02-20 ]</div>
                        </div>
                    </div>
