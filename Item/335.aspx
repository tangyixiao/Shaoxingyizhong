...
<head>
    ...
    <title>关于高一、高二校本课程选报的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一、高二校本课程选报的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=335"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:335},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=335";
...
<DIV align=left><FONT size=4><FONT face=Verdana>                   关于高一、高二校本课程选报的通知</FONT></FONT></DIV>
<DIV align=l
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/332.aspx" target="_self" title="标题：高一部分学生相片重拍通知&#xD;点击数：390&#xD;发表时间：09年09月26日">高一部分学生相片重拍通知</a>[ 09-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/337.aspx" target="_self" title="标题：高三国庆后阶段性测试监考安排&#xD;点击数：293&#xD;发表时间：09年09月28日">高三国庆后阶段性测试监考安排</a>[ 09-28 ]</div>
                        </div>
                    </div>
