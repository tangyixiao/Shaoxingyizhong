...
<head>
    ...
    <title>关于高三各班文印费结帐的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高三各班文印费结帐的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1940"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1940},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1940";
...
<P>        因学期即将结束,请各班班主任通知本班生活委员于近期到学校文印室结清文印费用,请相互转告!</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1938.aspx" target="_self" title="标题：推荐两篇阅读文章&#xD;点击数：776&#xD;发表时间：10年05月25日">推荐两篇阅读文章</a>[ 05-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1948.aspx" target="_self" title="标题：召开高二班主任会的通知&#xD;点击数：575&#xD;发表时间：10年05月26日">召开高二班主任会的通知</a>[ 05-26 ]</div>
                        </div>
                    </div>
