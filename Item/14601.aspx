...
<head>
    ...
    <title>12.07跑操量化考核反馈--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">12.07跑操量化考核反馈</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=14601"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:14601},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=14601";
     ...
     <p style="line-height: 16px;">
</p><p style="line-height: 16px;"><img style="vertical-align: middle; margin-right: 2px; width: 15px; height: 16px;" src="http://10.176.17.2/UEditor/dialogs/attachment/fileTypeImages/icon_xls.gif" width="15" height="16" /><a style="font-size:12px; color:#0066cc;" href="/Shaoxingyizhong/UploadFiles/xwzx/2021/12/202112071043249665.xlsx" title="202112071043249665.xlsx">12.07跑操量化考核.xlsx</a></p><p><span style="font-family: 楷体, 楷体_GB2312, SimKai;">（注：班级当天临时请假人数如超过3人，则取消加分。）</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/14600.aspx" target="_self" title="标题：失物招领&#xD;点击数：139&#xD;发表时间：21年12月07日">失物招领</a>[ 12-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/14603.aspx" target="_self" title="标题：体锻课器材借用提醒&#xD;点击数：194&#xD;发表时间：21年12月07日">体锻课器材借用提醒</a>[ 12-07 ]</div>
                        </div>
                    </div>
