...
<head>
    ...
    <title>周一虞金龙、邢婷课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">周一虞金龙、邢婷课改自修</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3450"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3450},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3450";
     ...
     3月7日（星期一），因会考补考阅卷，虞金龙、邢婷所任课班级相应课程改自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3445.aspx" target="_self" title="标题：通知&#xD;点击数：503&#xD;发表时间：11年03月04日">通知</a>[ 03-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3456.aspx" target="_self" title="标题：高二备课组长&#xD;点击数：424&#xD;发表时间：11年03月07日">高二备课组长</a>[ 03-07 ]</div>
                        </div>
                    </div>
