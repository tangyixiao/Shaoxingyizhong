...
<head>
    ...
    <title>体锻课暂停通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7713"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7713},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7713";
     ...
     <P><FONT size=4>因体育老师参加教研活动，今天下午体锻课暂停。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7711.aspx" target="_self" title="标题：高三任课教师会议通知&#xD;点击数：243&#xD;发表时间：17年11月29日">高三任课教师会议通知</a>[ 11-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7715.aspx" target="_self" title="标题：心理教研活动通知&#xD;点击数：126&#xD;发表时间：17年11月29日">心理教研活动通知</a>[ 11-29 ]</div>
                        </div>
                    </div>
