...
<head>
    ...
    <title>关于第二次申报2009学年绍兴市中小学教师学术主题报告的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于第二次申报2009学年绍兴市中小学教师学术主题报告的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=193"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:193},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=193";
     ...
     <FONT size=4>    根据绍市教研字[2005]81号文件精神，市教育教学研究院每年二次（2月28日前和9月15日前）接受“市中小学教师学术主题报告”申请。这将作为申报市学科带头人的必要条件。 <BR>    老师们可以把前期学术研究成果撰写成“学术主题报告”,按要求填写表格及时申报。请于9月15日前把申报材料纸质稿送交教学处，并将电子稿发送到校内公共文件夹/教学处/傅丽娜/学术主题报告一栏中。 <BR>具体要求详见：<IM
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/191.aspx" target="_self" title="标题：回头考成绩和高三IB成绩录入方法&#xD;点击数：555&#xD;发表时间：09年09月02日">回头考成绩和高三IB成绩录入方法</a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/201.aspx" target="_self" title="标题：关于校本课程申报的通知&#xD;点击数：570&#xD;发表时间：09年09月04日">关于校本课程申报的通知</a>[ 09-04 ]</div>
                        </div>
                    </div>
