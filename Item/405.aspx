...
<head>
    ...
    <title>转发：高级教师申报对象进行课堂教学能力考核的预备通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">转发：高级教师申报对象进行课堂教学能力考核的预备通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年10月14日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=405"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:405},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=405";
     ...
     <DIV align=center><B>关于对市直中学高级教师申报对象进行课堂教学能力</B></DIV>
<DIV align=center><B>考核的预备通知</B></DIV>
<DIV>各市属学校（单位）：</DIV>
<DIV>为提高2009年全市中学高级教师任职资格的评审质量，加强对评审对象实际课堂教学能力的考察，根据绍市教〔2009〕34号文件要求，经研究，决定在近期对市直中学教师申报中学高级教师人员进行课堂教学能力的考核，现将有关事项通知如下：</DIV>
<DIV>一、考核对象</D
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/403.aspx" target="_self" title="标题：关于教工体检的通知&#xD;点击数：509&#xD;发表时间：09年10月14日">关于教工体检的通知</a>[ 10-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/414.aspx" target="_self" title="标题：值周提示&#xD;点击数：522&#xD;发表时间：09年10月17日">值周提示</a>[ 10-17 ]</div>
                        </div>
                    </div>
