...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=135"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:135},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=135";
     ...
     <DIV><FONT size=5>各处室、各教研组</FONT></DIV>
<DIV><FONT size=5>     在开学典礼中要举行发奖仪式，请各处室、各教研组把有省级及以上获奖者报德育处，报德育处时须有：学生姓名、班级、获奖名称、获奖证件的原件，时间在8月30日前。</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/108.aspx" target="_self" title="标题：通知两则&#xD;点击数：7&#xD;发表时间：09年08月17日">通知两则</a>[ 08-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/137.aspx" target="_self" title="标题：关于补交07、08年度个人所得税的通知&#xD;点击数：717&#xD;发表时间：09年08月25日">关于补交07、08年度个人所得税的通知</a>[ 08-25 ]</div>
                        </div>
                    </div>
