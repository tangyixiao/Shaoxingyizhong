...
<head>
    ...
    <title>关于校服评选--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=318"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:318},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=318";
     ...
     <FONT size=5>    <STRONG>在全校师生的大力支持下，校服式样评选第一阶段工作已经顺利结束。在众多的校服式样中，我们挑选了部分比较可行的服装式样，放在公共文件夹/德育处，欢迎全校师生点评并提供宝贵意见，我们将于下星期进行公开投票。由于冬装所选的式样比较单薄，请全校师生积极提供，以便参阅。</STRONG></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/315.aspx" target="_self" title="标题：班主任会议通知&#xD;点击数：436&#xD;发表时间：09年09月23日">班主任会议通知</a>[ 09-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/321.aspx" target="_self" title="标题：关于调整家长学校、家长委员会成员的通知&#xD;点击数：766&#xD;发表时间：09年09月24日">关于调整家长学校、家长委员会成员的通知</a>[ 09-24 ]</div>
                        </div>
                    </div>
