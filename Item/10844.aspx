...
<head>
    ...
    <title>关于原动漫社、樱语日文社合并重组的通知--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于原动漫社、樱语日文社合并重组的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2019年10月19日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10844"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10844},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10844";
     ...
     <P>各学生社团：</P>
<P>    原动漫社、樱语日文社经过资源整合、内容完善，现合并重组，更名为鹤屋日研社。特此通告！</P>
<P align=right>社团联合会<BR>2019年10月19日</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10790.aspx" target="_self" title="标题：2019，如约而至的暑期，与众不同的辩论&#xD;点击数：526&#xD;发表时间：19年09月02日">2019，如约而至的暑期，与众不同的辩论</a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11602.aspx" target="_self" title="标题：2019学年社团考核结果&#xD;点击数：604&#xD;发表时间：20年06月28日">2019学年社团考核结果</a>[ 06-28 ]</div>
                        </div>
                    </div>
