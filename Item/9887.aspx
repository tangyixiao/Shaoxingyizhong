...
<head>
    ...
    <title>高一、高二各班学习委员会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二各班学习委员会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9887"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9887},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9887";
...
<TBODY>
<TR>
<TD><!--插入广告JS代码--></TD></TR></TBODY></TABLE><FONT size=4>请高一、高二年级各班学习委员于明天（周四）中午13:00在4104阶梯教室开会。请互相通知，准时与会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9885.aspx" target="_self" title="标题：体育教研活动通知&#xD;点击数：401&#xD;发表时间：19年03月20日">体育教研活动通知</a>[ 03-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9891.aspx" target="_self" title="标题：市直羽毛球比赛通知&#xD;点击数：472&#xD;发表时间：19年03月21日">市直羽毛球比赛通知</a>[ 03-21 ]</div>
                        </div>
                    </div>
