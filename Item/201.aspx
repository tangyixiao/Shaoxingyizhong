...
<head>
    ...
    <title>关于校本课程申报的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于校本课程申报的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月04日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=201"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:201},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=201";
     ...
     <DIV align=center><B>关于校本课程申报的通知</B><B></B></DIV>
<DIV>  各位老师：</DIV>
<DIV>     根据国家课程纲要中有关校本课程的规定，为促进学生的个性健康成长和教师的专业发展，创新体现学校“重人本，强能力，塑文化，显特色”的办学理念。本学期我校将结合学校实际，继续推动校本课程的开发和实施。敬请各位结合自己的专长、爱好和学生的需要，思考有关校本课程的内容，现将我校校本课程开发的有关思路公布如下，供
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/193.aspx" target="_self" title="标题：关于第二次申报2009学年绍兴市中小学教师学术主题报告的通知&#xD;点击数：458&#xD;发表时间：09年09月15日">关于第二次申报2009学年绍兴市中小学教师学术主题报告的通知</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/204.aspx" target="_self" title="标题：9月12日高考三项考试监考名单&#xD;点击数：543&#xD;发表时间：09年09月05日">9月12日高考三项考试监考名单</a>[ 09-05 ]</div>
                        </div>
                    </div>
