...
<head>
    ...
    <title>我校新高一录取分数线揭晓--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">我校新高一录取分数线揭晓</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2105"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2105},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2105";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
            ...
            接教育局通知,市属学校中考录取分数线已经揭晓,我校新高一录取分数线为:并轨生678分,择校生671分。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2101.aspx" target="_self" title="标题：关于中层班子组建工作的通知（3）&#xD;点击数：900&#xD;发表时间：10年06月21日">关于中层班子组建工作的通知（3）</a>[ 06-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2106.aspx" target="_self" title="标题：关于中层班子组建工作的通知（4）&#xD;点击数：777&#xD;发表时间：10年06月23日">关于中层班子组建工作的通知（4）</a>[ 06-23 ]</div>
                        </div>
                    </div>
