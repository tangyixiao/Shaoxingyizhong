...
<head>
    ...
    <title>期末工作行事历--工作安排-绍兴市第一中学</title>
    ...
    <a href="/Shaoxingyizhong/Category_22/Index.aspx" target="_self">工作安排</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>期末工作行事历</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2020年06月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11596"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11596},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11596";
     ...
     <A title=期末及暑假工作行事历 href="/Shaoxingyizhong/UploadFiles/UploadFiles/202006/2020062811264721.xls">期末及暑假工作行事历</A>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11542.aspx" target="_self" title="标题：第十周学校主要工作安排表&#xD;点击数：283&#xD;发表时间：20年06月15日">第十周学校主要工作安排表</a>[ 06-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11739.aspx" target="_self" title="标题：开学预备周及第一周学校主要工作安排表&#xD;点击数：240&#xD;发表时间：20年08月28日">开学预备周及第一周学校主要工作安排表</a>[ 08-28 ]</div>
                        </div>
                    </div>
