...
<head>
    ...
    <title>关于学生办理爱国主义教育卡的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于学生办理爱国主义教育卡的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=277"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:277},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=277";
          ...
          根据市教育局通知，学生爱国主义教育卡办理工作已经开始，请各班做好发动工作，需要办理的学生交一寸照一张，办卡工本费10元，以班级为单位交德育处。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/272.aspx" target="_self" title="标题：关于高一高二学生信息录入的通知（急）&#xD;点击数：588&#xD;发表时间：09年09月15日">关于高一高二学生信息录入的通知（急）</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/286.aspx" target="_self" title="标题：重发关于高一高二学生信息录入的通知（急）&#xD;点击数：580&#xD;发表时间：09年09月16日">重发关于高一高二学生信息录入的通知（急）</a>[ 09-16 ]</div>
                        </div>
                    </div>
