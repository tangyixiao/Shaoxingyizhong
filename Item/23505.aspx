...
<head>
    ...
    <title>关于2026年“名师激励”岗位考核激励人员名单及结果公示--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于2026年“名师激励”岗位考核激励人员名单及结果公示</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2026年08月15日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23505"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23505},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23505";
     ...
     <p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">根据市教育局关于</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px"><span style="font-family:楷体">《市直学校争创</span><span style="font-family:楷体">“名师名科名校”激励办法（修订）》，现将符合名师激励条件的我校教师及考核结果公示如下：</span></span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">一类：正高级教师、特级教师</span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">蔡红、谢澹、叶望尧</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">、</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">虞金龙、</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">张叠</span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">其中考核优秀者：</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">蔡红</span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">二类：省级及以上优质课一等奖获得者、省级教坛新秀、绍兴名师</span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">范捷</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">、</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">王淑会</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">、</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">黎小琴</span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">其中考核优秀者：</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">黎小琴</span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px"> </span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px"><span style="font-family:楷体">公示时间：</span><span style="font-family:楷体">202</span></span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">6</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">年</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">8</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px"><span style="font-family:楷体">月</span><span style="font-family:楷体">1</span></span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">5</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">日至</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">8</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">月</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">21</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">日</span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">在公示期限内，可通过来信、来电、来访等形式，反映公示对象不符合的有关问题。反映问题要坚持实事求是的原则，不得借机诽谤诬告。学校将严格按有关规定为反映问题者保密，并调查落实，作出处理。</span></p><p style=";text-indent: 32px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 微软雅黑;line-height: 120%;letter-spacing: 0;font-size: 14px"> </span></p><p style=";text-indent: 41px;padding: 0;line-height: 120%;background: rgb(255, 255, 255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">联系人：冯王亮</span><span style="font-family: Calibri;letter-spacing: 0;font-size: 16px">  </span><span style="font-family: 微软雅黑;letter-spacing: 0;font-size: 16px">   </span><span style="font-family: Calibri;letter-spacing: 0;font-size: 16px"> </span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px"><span style="font-family:楷体">联系电话：</span><span style="font-family:楷体">18906858205</span></span></p><p style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;text-indent:41px;padding:0 0 0 0 ;text-autospace:ideograph-numeric;text-align:center;line-height:120%;background:rgb(255,255,255)"><span style="font-family: Calibri;letter-spacing: 0;font-size: 16px"> </span></p><p style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;text-indent:41px;padding:0 0 0 0 ;text-autospace:ideograph-numeric;text-align:right;line-height:120%;background:rgb(255,255,255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">                                                                              绍兴一中</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">教育集团    </span></p><p style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;text-indent:41px;padding:0 0 0 0 ;text-autospace:ideograph-numeric;text-align:right;line-height:120%;background:rgb(255,255,255)"><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">  202</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">6</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">年</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">8</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px"><span style="font-family:楷体">月</span><span style="font-family:楷体">1</span></span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">5</span><span style="font-family: 楷体;letter-spacing: 0;font-size: 16px">日</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23488.aspx" target="_self" title="标题：2026 年全市高中学校教师学科综合素养比武方案（转发）&#xD;点击数：178&#xD;发表时间：26年07月07日">2026 年全市高中学校教师学科综合素养比武方案（转发）</a>[ 07-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Item/23506.aspx" target="_self" title="标题：关于2026年“名师激励”岗位考核激励资深班主任人员名单及结果公示&#xD;点击数：150&#xD;发表时间：26年08月18日">关于2026年“名师激励”岗位考核激励资深班主任人员名单及结果…</a>[ 08-18 ]</div>
                        </div>
                    </div>
