    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高二班主任：会考准考证补办</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年05月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4037"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4037},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4037";
     ...
     高二班主任：请检查本班会考准考证缺失情况，如需要补办，以班级为单位统计好，在5月30日前将补办名单报教学处。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4034.aspx" target="_self" title="标题：关于早自修情况检查的几点说明&#xD;点击数：567&#xD;发表时间：11年05月26日">关于早自修情况检查的几点说明</a>[ 05-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4045.aspx" target="_self" title="标题：高三校二模成绩录入、IB阅卷安排&#xD;点击数：627&#xD;发表时间：11年05月27日">高三校二模成绩录入、IB阅卷安排</a>[ 05-27 ]</div>
                        </div>
                    </div>
