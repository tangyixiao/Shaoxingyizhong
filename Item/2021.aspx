...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2021"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2021},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2021";
         ...
         高三班主任请通知本班党员发展对象于10日下午4：30到行政楼三楼会议室开会。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1991.aspx" target="_self" title="标题：高三近期安排(2)&#xD;点击数：701&#xD;发表时间：10年06月03日">高三近期安排(2)</a>[ 06-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2032.aspx" target="_self" title="标题：高三支部会议通知&#xD;点击数：476&#xD;发表时间：10年06月11日">高三支部会议通知</a>[ 06-11 ]</div>
                        </div>
                    </div>
