    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：安全</span> <span>发布时间：2009年10月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=452"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:452},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=452";
     ...
     <DIV><FONT size=3>早上出操时，有下列班级没有关好门窗，特此通报。</FONT></DIV>
<DIV><FONT size=3>一（4）、一（11）（灯也未关）、三（7）、三（8）（灯也未关）、三（15）</FONT></DIV>
<DIV><FONT size=3>另外,发现许多班级有学生逗留在教室里,有的是因为运动会上受了伤,有的是借故不出操,请班主任特别留意!</FONT></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/450.aspx" target="_self" title="标题：自行车上锁情况检查记录表(10.18-10.24)&#xD;点击数：402&#xD;发表时间：09年10月25日">自行车上锁情况检查记录表(10.18-10.24)</a>[ 10-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/454.aspx" target="_self" title="标题：通知&#xD;点击数：262&#xD;发表时间：09年10月26日">通知</a>[ 10-26 ]</div>
                        </div>
                    </div>
