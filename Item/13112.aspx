...
<head>
    ...
    <title>周五高二部分班级通用技术课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">周五高二部分班级通用技术课改自修通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13112"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13112},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13112";
     ...
     <p><span style="FONT-SIZE: 20px">明天（周五）上午高三老师外出集中阅卷，通用技术组陈义兵、徐建光、白宗刚老师外出改卷。高二相关班级通用技术课改自修，技术走班学生在相应上课教室自修。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13111.aspx" target="_self" title="标题：关于排球比赛请假通知&#xD;点击数：350&#xD;发表时间：21年04月08日">关于排球比赛请假通知</a>[ 04-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13113.aspx" target="_self" title="标题：今天图书馆暂停借书通知&#xD;点击数：297&#xD;发表时间：21年04月08日">今天图书馆暂停借书通知</a>[ 04-08 ]</div>
                        </div>
                    </div>
