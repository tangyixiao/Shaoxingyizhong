...
<head>
    ...
    <title>高一数学补课通知--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一数学补课通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：高一</span> <span>发布时间：2009年11月12日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=548"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:548},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=548";
     ...
     <P>     <FONT face=楷体_GB2312 size=4>因有一部分同学生病原因，今天（11.12周四）下午第三节，在高一（2）班教室补习《三角函数》第一节，请班主任通知有关学生，并欢迎这块内容有问题的同学参加。</FONT></P>
<P><FONT face=楷体_GB2312 size=4></FONT> </P>
<P><FONT face=楷体_GB2312 size=4>另：期中考试成绩分析材料已经放在公共文件夹/数学/蒋卫江/，请各位老师认真分析。</FONT></P>
<P><FONT face=楷体_GB2312 size=4></FONT> </P>
<P align=right><FONT face=楷体_GB2312 size=4>高一   11.12</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/487.aspx" target="_self" title="标题：高一期中考试期间安排&#xD;点击数：275&#xD;发表时间：09年10月30日">高一期中考试期间安排</a>[ 10-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/849.aspx" target="_self" title="标题：高一“我爱背单词”词汇竞赛结果揭晓&#xD;点击数：304&#xD;发表时间：09年12月03日">高一“我爱背单词”词汇竞赛结果揭晓</a>[ 12-03 ]</div>
                        </div>
                    </div>
