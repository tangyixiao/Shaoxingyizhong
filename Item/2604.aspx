...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2604"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2604},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2604";
...
<P><FONT size=4>全体班主任及年级长：</FONT></P>
<P><FONT size=4>    今天下午第四节课，在行政楼五楼会议室召开班主任、年级长会议，布置运动会入场式有关事项。望安排好工作，准时参加。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2603.aspx" target="_self" title="标题：值周检查情况汇总（10月8日星期五）&#xD;点击数：357&#xD;发表时间：10年10月09日">值周检查情况汇总（10月8日星期五）</a>[ 10-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2610.aspx" target="_self" title="标题：关于下周一升旗仪式暨应急疏散演练的通知&#xD;点击数：449&#xD;发表时间：10年10月09日">关于下周一升旗仪式暨应急疏散演练的通知</a>[ 10-09 ]</div>
                        </div>
                    </div>
