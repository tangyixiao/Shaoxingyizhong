...
<head>
    ...
    <title>已有二宝的男女教工的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">已有二宝的男女教工的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>已有二宝的男女教工的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2016年12月08日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6080"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6080},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6080";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><FONT size=3><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">至目前为止已有二宝的男女教职员工请于本周五前将名单报至财务室，电话</SPAN><SPAN lang=EN-US>9293881</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">。</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6076.aspx" target="_self" title="标题：党员大会通知&#xD;点击数：275&#xD;发表时间：16年12月07日">党员大会通知</a>[ 12-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6082.aspx" target="_self" title="标题：关于公布“2017年信息学奥赛冬令营各工作小组名单与职责”的通知(有修改)&#xD;点击数：1381&#xD;发表时间：16年12月08日">关于公布“2017年信息学奥赛冬令营各工作小组名单与职责”的通…</a>[ 12-08 ]</div>
                        </div>
                    </div>
