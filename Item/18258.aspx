...
<head>
    ...
    <title>9月协作体改期通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18258"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18258},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18258";
     ...
     <p>因物理联赛（9月2日）和化学联赛（9月3日）现在需要将名校协作体考试时间更改为9月4日（周一）、5日（周二）。各科考试顺序、起止时间不变。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18242.aspx" target="_self" title="标题：2023学年第1学期协作体高二、高三联考考试范围&#xD;点击数：374&#xD;发表时间：23年07月04日">2023学年第1学期协作体高二、高三联考考试范围</a>[ 07-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18266.aspx" target="_self" title="标题：青少年垒球锦标赛通知&#xD;点击数：80&#xD;发表时间：23年08月15日">青少年垒球锦标赛通知</a>[ 08-15 ]</div>
                        </div>
                    </div>
