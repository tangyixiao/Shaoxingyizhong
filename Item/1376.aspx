...
<head>
    ...
    <title>关于自行车问题--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于自行车问题</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>关于自行车问题</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年03月02日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1376"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1376},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1376";
     ...
     <P><STRONG><FONT size=4>全校各班主任：</FONT></STRONG></P>
<P><STRONG><FONT size=4>     今天早晨在检查时发现学生在自行车问题上还存在以下情况：1.没有按照指定位置停放；2.校内骑车现象屡有发生；3.部分学生的车子没有上锁。</FONT></STRONG></P>
<P><STRONG><FONT size=4>     为了安全，请各位要求学生一律把自行车停进网球场，并重申学校有关规定，希望学生们自觉遵守。</FONT></STRONG></P>
<P align=right><STRONG><FONT size=4>德育处</FONT></STRONG></P>
<P align=right><STRONG><FONT size=4>2010.3.2</FONT></STRONG></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1372.aspx" target="_self" title="标题：大扫除停做通知&#xD;点击数：306&#xD;发表时间：10年03月01日">大扫除停做通知</a>[ 03-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1379.aspx" target="_self" title="标题：关于做好贫困学生工作&#xD;点击数：462&#xD;发表时间：10年03月02日">关于做好贫困学生工作</a>[ 03-02 ]</div>
                        </div>
                    </div>
