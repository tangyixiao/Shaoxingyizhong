...
<head>
    ...
    <title>本周六上课安排通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8930"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8930},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8930";
     ...
     <P><FONT size=4>明天上午因开学典礼，高一、高二、高三的课按课表往下顺延两节，即第一节顺延到第三节，第二节顺延到第四节，依次类推。高三上午仅上4节课，第5节按原课表答疑。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8919.aspx" target="_self" title="标题：2017学年各项奖学金获得者名单公示&#xD;点击数：714&#xD;发表时间：18年08月30日">2017学年各项奖学金获得者名单公示</a>[ 08-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8946.aspx" target="_self" title="标题：高一、高二有意向参加美术高考学生会议通知&#xD;点击数：155&#xD;发表时间：18年09月03日">高一、高二有意向参加美术高考学生会议通知</a>[ 09-03 ]</div>
                        </div>
                    </div>
