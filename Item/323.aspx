...
<head>
    ...
    <title>9.17-23值周报道--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9.17-23值周报道</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月24日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=323"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:323},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=323";
     ...
     <DIV align=center><B>9.17-23</B><B>值周记录</B><B></B></DIV>
<DIV>一、要事：</DIV>
<DIV>9.16日，高三（15）班发烧5人，中午采取班级紧急隔离。措施：第一、关闭图书馆、暂停课间操等容易交叉感染的公共场所与公共活动；第二、食堂送饭，隔离班级不得到食堂就餐；第三，隔离班级住校生不得住校，不得来校晚自习；每节课测体温。</DIV>
<DIV>9.17日，高三（15）班发烧12人，全班发烧学生达到18人，学校立即上报教育局请示，下午第3节开始
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/320.aspx" target="_self" title="标题：国庆中秋放假值班安排&#xD;点击数：650&#xD;发表时间：09年09月24日">国庆中秋放假值班安排</a>[ 09-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/330.aspx" target="_self" title="标题：转发关于2009年中学高级教师申报对象业务考核的通知&#xD;点击数：585&#xD;发表时间：09年09月26日">转发关于2009年中学高级教师申报对象业务考核的通知</a>[ 09-26 ]</div>
                        </div>
                    </div>
