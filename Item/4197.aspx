...
<head>
    ...
    <title>6月17日寝室缺席名单--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4197"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4197},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4197";
...
<P>A506    金永斌      一（3）</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4196.aspx" target="_self" title="标题：高一（1—8班）音乐补考安排&#xD;点击数：748&#xD;发表时间：11年06月17日">高一（1—8班）音乐补考安排</a>[ 06-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4215.aspx" target="_self" title="标题：关于品德考核比例超标修改的通知&#xD;点击数：822&#xD;发表时间：11年06月22日">关于品德考核比例超标修改的通知</a>[ 06-22 ]</div>
                        </div>
                    </div>
