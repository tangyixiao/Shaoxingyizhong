...
<head>
    ...
    <title>各班主任请注意(关于今天的班会课)--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班主任请注意(关于今天的班会课)</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=352"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:352},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=352";
...
<P><FONT size=5><STRONG>    今天下午班会课活动的主要内容是对学生的放假前教育。明确告知学生：在放假期间要按照《国庆告家长书》的要求去做，尤其要强调安全问题，提醒学生认真收看国庆阅兵式，不要错过收看时间。</STRONG></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/349.aspx" target="_self" title="标题：各班主任请注意（关于收看国庆阅兵式）&#xD;点击数：411&#xD;发表时间：09年09月29日">各班主任请注意（关于收看国庆阅兵式）</a>[ 09-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/353.aspx" target="_self" title="标题：9月30日未上锁的自行车通报&#xD;点击数：283&#xD;发表时间：09年09月30日">9月30日未上锁的自行车通报</a>[ 09-30 ]</div>
                        </div>
                    </div>
