...
<head>
    ...
    <title>高三“三八节给妈妈一封信”上交通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三“三八节给妈妈一封信”上交通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3415"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3415},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3415";
     ...
     <P>高三各班：</P>
<P>        还未上交“三八节给妈妈一封信”的班级，请于今天放晚学前将信件收缴到德育处/音美办。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3411.aspx" target="_self" title="标题：值周检查情况汇总（2月28日星期一）&#xD;点击数：349&#xD;发表时间：11年03月01日">值周检查情况汇总（2月28日星期一）</a>[ 03-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3416.aspx" target="_self" title="标题：3月2日校牌检查结果公布（五）&#xD;点击数：475&#xD;发表时间：11年03月02日">3月2日校牌检查结果公布（五）</a>[ 03-02 ]</div>
                        </div>
                    </div>
