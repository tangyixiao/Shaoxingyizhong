...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3246"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3246},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3246";
     ...
     <P>                                工会会议通知</P>
<P>   定于明天下午第四节课召开工会委员和工会小组长会议,地点在行政楼三楼会议室,请各安排好工作,准时参加.</P>
<P>                                                           绍兴一中工会</P>
<P>                                                              2010.1.12</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3244.aspx" target="_self" title="标题：文明办公室检查评比结果&#xD;点击数：1044&#xD;发表时间：11年01月12日">文明办公室检查评比结果</a>[ 01-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3409.aspx" target="_self" title="标题：工会公告&#xD;点击数：543&#xD;发表时间：11年03月01日">工会公告</a>[ 03-01 ]</div>
                        </div>
                    </div>
