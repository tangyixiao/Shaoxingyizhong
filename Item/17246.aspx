...
<head>
    ...
    <title>2023年1月学考选考成绩复核通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2023年1月学考选考成绩复核通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=17246"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:17246},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=17246";
     ...
     <p><span style="FONT-FAMILY: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; COLOR: rgb(51,51,51); BACKGROUND-COLOR: rgb(255,255,255)">2023年1月学考选考成绩复核工作即将开始，考生如对本人成绩有疑问，可于2023年2月7日17:00前持本人身份证、准考证到教学处</span><strong style="FONT-FAMILY: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; WHITE-SPACE: normal; COLOR: rgb(51,51,51); BACKGROUND-COLOR: rgb(255,255,255)">（家贤楼1114）</strong><span style="FONT-FAMILY: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; COLOR: rgb(51,51,51); BACKGROUND-COLOR: rgb(255,255,255)">登记办理复核手续，逾期不予受理。注意：每名考生限查一科（一科有误，可续查其他学科）。复核结果将在2月20日前统一回复（无误不回复），考生也可于2月20日起登录浙江教育考试网查询复核结果。</span></p><p></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/17240.aspx" target="_self" title="标题：2023年2月高二高三名校协作体考试时间安排&#xD;点击数：246&#xD;发表时间：23年02月05日">2023年2月高二高三名校协作体考试时间安排</a>[ 02-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/17247.aspx" target="_self" title="标题：分类评价分层走班考试考务会议通知&#xD;点击数：444&#xD;发表时间：23年02月06日">分类评价分层走班考试考务会议通知</a>[ 02-06 ]</div>
                        </div>
                    </div>
