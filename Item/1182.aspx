...
<head>
    ...
    <title>关于高一校本课程上课的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一校本课程上课的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：教学处</span> <span>作者：佚名</span> <span>发布时间：2010年01月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1182"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1182},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1182";
        ...
        今天下午第三节课，高一校本课程照常进行，请相关老师做好安排。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1180.aspx" target="_self" title="标题：关于南京大学2010年外国语言文学类（非英语）(小语种)专业自主招生的通知&#xD;点击数：548&#xD;发表时间：10年01月06日">关于南京大学2010年外国语言文学类（非英语）(小语种)专业自主…</a>[ 01-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1185.aspx" target="_self" title="标题：关于五校联考学生填涂机读卡、自选综合题号错误的信息反馈&#xD;点击数：664&#xD;发表时间：10年01月07日">关于五校联考学生填涂机读卡、自选综合题号错误的信息反馈</a>[ 01-07 ]</div>
                        </div>
                    </div>
