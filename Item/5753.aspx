...
<head>
    ...
    <title>10月份黑板报检查取消的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">10月份黑板报检查取消的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5753"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5753},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5753";
     ...
     <P> </P>
<P><FONT size=4>各班宣传委员：</FONT></P>
<P><FONT size=4>    由于10月份考试较多，原定黑板报检查一再延期，且接下来成人高考布置试场也要求黑板不能有字。因故，取消10月份黑板报检查，11月份按正常安排检查，出报主题按11月份的规定主题出（如果已经按10份主题出好了的，则不用更换，评分不受影响）。请各班宣传委员、团学联检查人员及相关老师相互转告。谢谢！</FONT></P>
<P><FONT size=4>                                                                                         校团委</FONT></P>
<P><FONT size=4>                                                                                          10月22日</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5752.aspx" target="_self" title="标题：团学联学生干部（事）招聘启事&#xD;点击数：125&#xD;发表时间：16年10月22日">团学联学生干部（事）招聘启事</a>[ 10-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5766.aspx" target="_self" title="标题：关于今天中午团学联干部面试的通知&#xD;点击数：175&#xD;发表时间：16年10月24日">关于今天中午团学联干部面试的通知</a>[ 10-24 ]</div>
                        </div>
                    </div>
