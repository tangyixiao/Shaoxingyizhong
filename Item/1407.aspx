...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1407"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1407},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1407";
     ...
     <P>  高三班主任请协同班级任课教师分析本班学情，把协商后的名单周三报给年级汇总。会议地址可以安排在小办公室。</P>
<P>  </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1398.aspx" target="_self" title="标题：高三班主任会议通知&#xD;点击数：1278&#xD;发表时间：10年03月08日">高三班主任会议通知</a>[ 03-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1431.aspx" target="_self" title="标题：高三自选综合&#xD;点击数：1321&#xD;发表时间：10年03月11日">高三自选综合</a>[ 03-11 ]</div>
                        </div>
                    </div>
