...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5810"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5810},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5810";
     ...
     高一（6）班凌栋钦在5号篮球场捡到校服一件，特此表扬，并望失主及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5806.aspx" target="_self" title="标题：运动会入场式评比组老师注意&#xD;点击数：202&#xD;发表时间：16年10月27日">运动会入场式评比组老师注意</a>[ 10-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5811.aspx" target="_self" title="标题：寻物启事&#xD;点击数：104&#xD;发表时间：16年10月28日">寻物启事</a>[ 10-28 ]</div>
                        </div>
                    </div>
