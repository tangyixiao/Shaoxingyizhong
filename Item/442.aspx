...
<head>
    ...
    <title>“重温光辉历程，传唱红色经典”大合唱比赛结果--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">“重温光辉历程，传唱红色经典”大合唱比赛结果</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年10月22日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=442"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:442},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=442";
     ...
     <P><FONT face=Verdana size=3>“重温光辉历程，传唱红色经典”大合唱比赛结果：</FONT></P>
<P>一等奖：高一(12)  、高二（5）、高一（2）、高二（15)</P>
<P>二等奖：高二（13）、高一（8）、高一（7）、高一（15）、高一（9）</P>
<P>        高二（10）、高二（6）、高二（4)、 高二（14）、</P>
<P>三等奖：高一（3）、高二（
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/424.aspx" target="_self" title="标题：第三期黑板报成绩公布&#xD;点击数：276&#xD;发表时间：09年10月19日">第三期黑板报成绩公布</a>[ 10-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/443.aspx" target="_self" title="标题：大合唱比赛的纪律、卫生检查情况通报：&#xD;点击数：283&#xD;发表时间：09年10月23日">大合唱比赛的纪律、卫生检查情况通报：</a>[ 10-23 ]</div>
                        </div>
                    </div>
