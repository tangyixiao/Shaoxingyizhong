...
<head>
    ...
    <title>高三班主任：自主选拔合格、艺术特长测试生合格的志愿表要自己网上打印--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三班主任：自主选拔合格、艺术特长测试生合格的志愿表要自己网上打印</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1866"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1866},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1866";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体; mso-ascii-font-family: Arial; mso-hansi-font-family: Arial; mso-bidi-font-family: Arial"><STRONG></STRONG> </P>
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN><STRONG>高三班主任：</STRONG>请通知自主选拔合格、艺术特长生测试合格（注：艺术特长生不是艺术类考生）取得高校入选资格的考生，在网上<SPAN style="mso-bidi-font-weight: bold">填报高校志愿后，要<SPAN style="COLOR: red">自己在网上直接打印志愿表格，空白表用钢笔填的表格不可以。家里不能打的可到教学处章老师处打印。</SPAN></SPAN></SPAN></P></SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1865.aspx" target="_self" title="标题：关于高一高二校本课程报名的通知&#xD;点击数：611&#xD;发表时间：10年05月13日">关于高一高二校本课程报名的通知</a>[ 05-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1871.aspx" target="_self" title="标题：高三需填报高校志愿的自主选拔考生、艺术特长生名单&#xD;点击数：420&#xD;发表时间：10年05月13日">高三需填报高校志愿的自主选拔考生、艺术特长生名单</a>[ 05-13 ]</div>
                        </div>
                    </div>
