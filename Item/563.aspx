...
<head>
    ...
    <title>绍兴女孩应宇捷成为省党代会最年轻的代表--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴女孩应宇捷成为省党代会最年轻的代表</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=563"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:563},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=563";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/562.aspx" target="_self" title="标题：院士细讲科学魅力&#xD;点击数：418&#xD;发表时间：09年11月13日">院士细讲科学魅力</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/564.aspx" target="_self" title="标题：斐然的成绩非偶然,教学的理念很关键&#xD;点击数：437&#xD;发表时间：09年11月13日">斐然的成绩非偶然,教学的理念很关键</a>[ 11-13 ]</div>
                        </div>
                    </div>
