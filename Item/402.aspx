...
<head>
    ...
    <title>关于高一年级校本课程上课的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一年级校本课程上课的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=402"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:402},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=402";
     ...
     <P>  高一班主任： </P>
<P>高一校本课程将于本周开始正常上课。根据学校课时安排，高一为每周四下午第三节课。请班主任及时通知学生在指定时间到地点上课。具体安排如下：</P>
<P style="TEXT-INDENT: 30pt; mso-char-indent-count: 2.5">
<TABLE style="WIDTH: 585pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=780 border=
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/399.aspx" target="_self" title="标题：高三英语课做练习&#xD;点击数：389&#xD;发表时间：09年10月13日">高三英语课做练习</a>[ 10-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/404.aspx" target="_self" title="标题：关于组织参加市属语文研修活动的通知&#xD;点击数：305&#xD;发表时间：09年10月14日">关于组织参加市属语文研修活动的通知</a>[ 10-14 ]</div>
                        </div>
                    </div>
