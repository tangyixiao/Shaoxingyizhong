...
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23666},success:function(s) {
     ...
     <p>明日（9.17）起，跑操正式纳入班级日常量化考核。</p><p style="text-align: center;"><img src="/UploadFiles/xwzx/2026/9/202609161555367511.png" style="max-width: 100%; " title="202609161555367511.png" /></p>
