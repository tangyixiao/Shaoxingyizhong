...
<head>
    ...
    <title>9.16跑操量化考核--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23666"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23666},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23666";
     ...
     <p>明日（9.17）起，跑操正式纳入班级日常量化考核。</p><p style="text-align: center;"><img src="/UploadFiles/xwzx/2026/9/202609161636571087.png" style="max-width: 100%; " title="202609161636571087.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23659.aspx" target="_self" title="标题：9.14班级一日考核&#xD;点击数：68&#xD;发表时间：26年09月15日">9.14班级一日考核</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Item/23667.aspx" target="_self" title="标题：9.15班级一日考核&#xD;点击数：63&#xD;发表时间：26年09月16日">9.15班级一日考核</a>[ 09-16 ]</div>
                        </div>
                    </div>
