...
<head>
    ...
    <title>高三“五校联考”分析会议--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三“五校联考”分析会议</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年01月11日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3241"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3241},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3241";
     ...
     <P>      定于明天（星期三）下午三、四两节课，在多功能厅召开高三年级“五校联考”分析会议，各备课组长准备好“联考成功经验、有待改进之处与下一步复习计划”讲话，时间每人3到5分钟，全体高三教师参加会议。（下午第三节有课的老师，看看前面有没有自修课，有的话提前去上了）</P>
<P>                                                   教学处   2011/01/11</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3237.aspx" target="_self" title="标题：部分课程改自修的通知&#xD;点击数：574&#xD;发表时间：11年01月08日">部分课程改自修的通知</a>[ 01-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3242.aspx" target="_self" title="标题：高二：12日（周三）通用技术学分考监考安排&#xD;点击数：516&#xD;发表时间：11年01月12日">高二：12日（周三）通用技术学分考监考安排</a>[ 01-12 ]</div>
                        </div>
                    </div>
