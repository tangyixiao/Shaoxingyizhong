...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23683"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23683},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23683";
     ...
     <p style="text-indent:37px"><span style="font-size: 14px; font-family: 宋体;">市教育教学研究院分别将于</span><span style="font-size: 14px; font-family: 宋体, SimSun;">9月22日（周二）、9月23</span><span style="font-size: 14px; font-family: 宋体;"><span style="font-family: 宋体;">日（周三）</span>对绍兴一中、龙山书院的教育教学工作开展调研指导。本次调研采用听取学校领导介绍、随堂听课、查阅资料、问卷调查、教师访谈等多种</span><span style="font-size: 14px; font-family: 宋体;">形式相结合的方</span><span style="font-size: 14px; font-family: 宋体;">式。</span></p><p style="text-indent:37px"><span style="font-family: 宋体; font-size: 14px; text-indent: 56px;">请各教研组、备课组</span><span style="font-family: 宋体; font-size: 14px; text-indent: 56px;">认真对待本次调研，</span><span style="font-family: 宋体; font-size: 14px; text-indent: 56px;">提前做好相应准备。</span></p><p style="text-indent:37px"><span style="font-family: 宋体; font-size: 14px;">调研安排：</span></p><p style="text-indent:37px"><span style=";font-family:'Times New Roman';font-size:19px"><span style="font-family:宋体"><img src="/UploadFiles/xwzx/2026/9/202609181012233884.png" style="max-width: 100%; width: 466px; height: 181px;" title="202609181012233884.png" width="466" height="181" /></span></span></p><p style="text-indent:37px"><span style="font-size: 14px;"><span style="font-family: 宋体;">
</span></span></p><p>
</p>
