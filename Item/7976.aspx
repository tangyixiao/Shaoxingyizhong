...
<head>
    ...
    <title>通用技术组汇报课通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7976"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7976},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7976";
     ...
     <P> </P>
<P>本周五有通用技术组白宗刚老师开设汇报课，欢迎组内老师及其他老师现场观摩。具体信息如下：</P><!--StartFragment -->
<DIV>时间：星期五上午第四节  </DIV>
<DIV>内容：数字信号 </DIV>
<DIV>班级:   高二10班 </DIV>
<DIV>地点:   高二10班教室<BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7975.aspx" target="_self" title="标题：数学组汇报课通知&#xD;点击数：220&#xD;发表时间：18年01月18日">数学组汇报课通知</a>[ 01-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7980.aspx" target="_self" title="标题：历史组汇报课通知&#xD;点击数：190&#xD;发表时间：18年01月18日">历史组汇报课通知</a>[ 01-18 ]</div>
                        </div>
                    </div>
