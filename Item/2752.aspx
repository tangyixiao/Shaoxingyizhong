...
<head>
    ...
    <title>高一、高二各班班长：--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二各班班长：</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高一、高二各班班长：</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年10月29日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2752"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2752},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2752";
...
<P><FONT size=4>高一、高二各班班长：</FONT></P>
<P><FONT size=4>今天中午12:20来德育处领取期中考试“告家长书”及其它资料，请相互转告。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2751.aspx" target="_self" title="标题：值周检查情况汇总（10月28日星期四）&#xD;点击数：243&#xD;发表时间：10年10月29日">值周检查情况汇总（10月28日星期四）</a>[ 10-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2753.aspx" target="_self" title="标题：关于收看“中小学生素质教育与考试心理”专题节目的通知&#xD;点击数：408&#xD;发表时间：10年10月29日">关于收看“中小学生素质教育与考试心理”专题节目的通知</a>[ 10-29 ]</div>
                        </div>
                    </div>
