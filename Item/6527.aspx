...
<head>
    ...
    <title>安全委员领取测试卷通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6527"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6527},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6527";
     ...
     请各班安全委员在交晨检表处领取消防测试卷,测试完后交5份到安全处.本周内完成。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6521.aspx" target="_self" title="标题：每日晨检表未交情况通报3.7&#xD;点击数：42&#xD;发表时间：17年03月07日">每日晨检表未交情况通报3.7</a>[ 03-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6544.aspx" target="_self" title="标题：每日晨检表未交情况通报3.10&#xD;点击数：35&#xD;发表时间：17年03月10日">每日晨检表未交情况通报3.10</a>[ 03-10 ]</div>
                        </div>
                    </div>
