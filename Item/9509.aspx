...
<head>
    ...
    <title>关于禁毒平台以及安全平台的作业要求通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于禁毒平台以及安全平台的作业要求通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9509"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9509},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9509";
     ...
     <P>高一、高二全体学生：<BR>    禁毒平台的作业希望引起每位学生的重视，因为上级对学校的这块内容的完成率是明确要求的，对落实不力的学校将进行批评与处罚。为此，我们特意安排今天、明天中午开放机房进行学习。但从今天中午开放机房后的统计情况来看，高一、高二的完成率还不足50%，可见很多同学对此项作业极不重视。</P>
<P>     明天中午我们将再开放一次机房给大家完成此项作业。截至明天下午17：00，我们将对高一、高二所有班级的完成情况进行统计，对没有完成该项作业的学生，我们也将按没有完成安全平台作业进行相应的批评与处罚。相关要求见：<A href="/Shaoxingyizhong/UploadFiles/UploadFiles/[InstallDir_ChannelDir]ShowArticle.asp?ArticleID=13357">[InstallDir_ChannelDir]ShowArticle.asp?ArticleID=13357</A><BR>    希望每一位同学对此项作业引起重视，务必按要求及时完成。<BR><BR>                                                                      安全处<BR>                                                                  2018.12.13 </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9500.aspx" target="_self" title="标题：关于针对未完成安全平台、禁毒平台作业的学生开放机房的通知&#xD;点击数：354&#xD;发表时间：18年12月12日">关于针对未完成安全平台、禁毒平台作业的学生开放机房的通知</a>[ 12-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9610.aspx" target="_self" title="标题：元旦假期安全提醒&#xD;点击数：321&#xD;发表时间：18年12月29日">元旦假期安全提醒</a>[ 12-29 ]</div>
                        </div>
                    </div>
