...
<head>
    ...
    <title>关于提交社会实践报告、领取树人导报的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于提交社会实践报告、领取树人导报的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8171"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8171},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8171";
     ...
     <P>1.请全校各班团支书至2114领取树人导报并签名。</P>
<P>2.寒假社会实践报告（还有5个班级）、十九大精神学习报告（还有1个班级）未提交的团支部请于<FONT color=#ff0000>明天（3月16日）中午12:00前</FONT>提交，否则该项目分数（社会实践报告15分，十九大学习报告5分）将记为零分。</P>
<P>    感谢各班团支部的配合！</P>
<P align=right>校团委<BR>2018年3月15日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8154.aspx" target="_self" title="标题：关于加强绍兴一中基层团支部建设及团员学生管理的通知&#xD;点击数：339&#xD;发表时间：18年03月12日">关于加强绍兴一中基层团支部建设及团员学生管理的通知</a>[ 03-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8177.aspx" target="_self" title="标题：2017学年寒假社会实践团体评优结果&#xD;点击数：1376&#xD;发表时间：18年03月16日">2017学年寒假社会实践团体评优结果</a>[ 03-16 ]</div>
                        </div>
                    </div>
