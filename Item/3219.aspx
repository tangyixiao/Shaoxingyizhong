...
<head>
    ...
    <title>高三（2）年终考核会议--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三（2）年终考核会议</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高三（2）年终考核会议</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年01月06日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3219"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3219},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3219";
     ...
     <P>      高三（2）年终考核会议</P>
<P>学校核定的高三（2）的全体老师：</P>
<P>请于今天下午第四节时间进行年终评议和考核，</P>
<P>地点：高三（8）班教室西边的小教室</P>
<P>   请各位相关老师准时例会</P>
<P>                   高三年级组</P>
<P>                2011、01、6</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3184.aspx" target="_self" title="标题：关于高三会考模拟考监考的通知&#xD;点击数：431&#xD;发表时间：10年12月30日">关于高三会考模拟考监考的通知</a>[ 12-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3288.aspx" target="_self" title="标题：高三几则通知&#xD;点击数：2783&#xD;发表时间：11年01月22日">高三几则通知</a>[ 01-22 ]</div>
                        </div>
                    </div>
