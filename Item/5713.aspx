...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5713"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5713},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5713";
     ...
     高一（14）班主任何凯老师在操场上捡到运动手环1个，特此表扬，并望失主及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5707.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：77&#xD;发表时间：16年10月11日">表扬与失物招领</a>[ 10-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5716.aspx" target="_self" title="标题：大课间活动调整通知（附：要求与路线）&#xD;点击数：186&#xD;发表时间：16年10月12日">大课间活动调整通知（附：要求与路线）</a>[ 10-12 ]</div>
                        </div>
                    </div>
