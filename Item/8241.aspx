...
<head>
    ...
    <title>高三数学教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8241"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8241},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8241";
     ...
     <FONT size=4>明天（30日）高三数学组外出参加教研活动，高三年级数学课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8240.aspx" target="_self" title="标题：中科大“三位一体”综合评价招生校荐报名通知&#xD;点击数：386&#xD;发表时间：18年03月29日">中科大“三位一体”综合评价招生校荐报名通知</a>[ 03-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8243.aspx" target="_self" title="标题：高二明天课程安排调整通知&#xD;点击数：412&#xD;发表时间：18年03月30日">高二明天课程安排调整通知</a>[ 03-30 ]</div>
                        </div>
                    </div>
