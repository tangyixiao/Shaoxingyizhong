...
<head>
    ...
    <title>关于行政会议的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=145"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:145},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=145";
     ...
     <DIV>各位中层以上领导干部：</DIV>
<DIV>   现定于8月28日上午第三、四节在三楼会议室召开行政会议，主要内容是各处室汇报新学期工作思路，并写好初稿打印7份。</DIV>
<DIV>   请处室及年级长做好充分准备，准时出席。</DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/137.aspx" target="_self" title="标题：关于补交07、08年度个人所得税的通知&#xD;点击数：717&#xD;发表时间：09年08月25日">关于补交07、08年度个人所得税的通知</a>[ 08-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/146.aspx" target="_self" title="标题：招收啦啦操学员通知 &#xD;点击数：627&#xD;发表时间：09年08月26日">招收啦啦操学员通知 </a>[ 08-26 ]</div>
                        </div>
                    </div>
