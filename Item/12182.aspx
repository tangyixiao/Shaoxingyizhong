...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12182"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12182},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12182";
     ...
     <FONT size=4>11月18日（周三）下午信息技术组外出参加教研活动，相关班级信息技术课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12181.aspx" target="_self" title="标题：高三诊断性考试成绩分析会通知&#xD;点击数：316&#xD;发表时间：20年11月17日">高三诊断性考试成绩分析会通知</a>[ 11-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12193.aspx" target="_self" title="标题：超脑、智学网使用培训通知&#xD;点击数：374&#xD;发表时间：20年11月18日">超脑、智学网使用培训通知</a>[ 11-18 ]</div>
                        </div>
                    </div>
