...
<head>
    ...
    <title>教代会会议通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9484"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9484},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9484";
     ...
     <!--StartFragment -->
<DIV>    兹定于今天下午第四节开始（16：15），在树兰楼三楼会议室四举行教代会代表会议，请各位代表准时参加！<BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9469.aspx" target="_self" title="标题：紧急通知&#xD;点击数：42459&#xD;发表时间：18年12月06日">紧急通知</a>[ 12-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9493.aspx" target="_self" title="标题：教代会主席团会议通知&#xD;点击数：386&#xD;发表时间：18年12月12日">教代会主席团会议通知</a>[ 12-12 ]</div>
                        </div>
                    </div>
