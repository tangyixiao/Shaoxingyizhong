...
<head>
    ...
    <title>绍兴一中校园晚间安全检查公告(2009.6-9.12）--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中校园晚间安全检查公告(2009.6-9.12）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=268"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:268},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=268";
...
<TD vAl
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/256.aspx" target="_self" title="标题：关于学生体检的通知&#xD;点击数：574&#xD;发表时间：09年09月11日">关于学生体检的通知</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/269.aspx" target="_self" title="标题：自行车未上锁情况通报(第二周)&#xD;点击数：528&#xD;发表时间：09年09月14日">自行车未上锁情况通报(第二周)</a>[ 09-14 ]</div>
                        </div>
                    </div>
