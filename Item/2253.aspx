...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2253"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2253},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2253";
...
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-SIZE: 15pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">    明天（</SPAN><SPAN lang=EN-US style="FONT-SIZE: 15pt">8</SPAN><SPAN style="FONT-SIZE: 15pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">月</SPAN><SPAN lang=EN-US style="FONT-SIZE: 15pt">22</SPAN><SPAN style="FONT-SIZE: 15pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">日）的教工会议，希望各位教工能够提早一点到会场，重新排了座位，请找到自己的位置对名入座。基本上按处室或学科组顺序排列的，有带来不便的地方请谅解！</SPAN><SPAN lang=EN-US style="FONT-SIZE: 15pt"><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2252.aspx" target="_self" title="标题：绍兴一中2010学年工作思路（征求意见稿）&#xD;点击数：730&#xD;发表时间：10年08月21日">绍兴一中2010学年工作思路（征求意见稿）</a>[ 08-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2254.aspx" target="_self" title="标题：教工会议通知&#xD;点击数：497&#xD;发表时间：10年08月21日">教工会议通知</a>[ 08-21 ]</div>
                        </div>
                    </div>
