    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年08月17日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=110"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:110},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=110";
     ...
     <P><FONT size=3>1、高三补课期间上选修IB，固定班仍按上学期补课的科目进行。</FONT></P>
<P><FONT size=3>2、下午《现代诗歌欣赏》和《旅游地理》的走班继续，但是第七节、第八节连上两节，上课地点不变。</FONT></P>
                        ...
                        <div class="others">
                            ...
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/115.aspx" target="_self" title="标题：教研组（备课）组长会议的通知&#xD;点击数：637&#xD;发表时间：09年09月07日">教研组（备课）组长会议的通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
