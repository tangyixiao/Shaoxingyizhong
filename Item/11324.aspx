...
<head>
    ...
    <title>请各班安全委员到医务室领取健康教育资料--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">请各班安全委员到医务室领取健康教育资料</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：安全处</span> <span>发布时间：2020年04月23日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11324"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11324},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11324";
     ...
     <SPAN style="TEXT-ALIGN: left; WIDOWS: 2; TEXT-TRANSFORM: none; BACKGROUND-COLOR: rgb(255,255,255); FONT-STYLE: normal; TEXT-INDENT: 0px; DISPLAY: inline !important; FONT-FAMILY: 'Microsoft YaHei', 'Segoe UI', system-ui, Roboto, 'Droid Sans', 'Helvetica Neue', sans-serif, Tahoma, 'Segoe UI SymbolMyanmar Text', 微软雅黑; WHITE-SPACE: pre-wrap; ORPHANS: 2; FLOAT: none; LETTER-SPACING: normal; COLOR: rgb(17,31,44); FONT-SIZE: 14px; FONT-WEIGHT: 400; WORD-SPACING: 0px; font-variant-ligatures: normal; font-variant-caps: normal; -webkit-text-stroke-width: 0px; text-decoration-style: initial; text-decoration-color: initial">请各班安全委员到医务室领取健康教育资料，望相互通知，及时领取！</SPAN>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11323.aspx" target="_self" title="标题：安全预警&#xD;点击数：387&#xD;发表时间：20年04月23日">安全预警</a>[ 04-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11331.aspx" target="_self" title="标题：疫情防控提示&#xD;点击数：238&#xD;发表时间：20年04月24日">疫情防控提示</a>[ 04-24 ]</div>
                        </div>
                    </div>
