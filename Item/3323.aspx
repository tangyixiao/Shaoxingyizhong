...
<head>
    ...
    <title>通知(有修改)--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3323"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3323},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3323";
     ...
     <P>通知：</P>
<P>1、本周上星期五、六的课，星期六下午和星期天高一、高二学生在家学习、休息，高三学生星期六下午在校自修。</P>
<P>2、本学期高一、高三按照原课程表上课，高二按调整后的新课表上课。</P>
<P>3、高三星期四、五的体育课取消，星期三下午第四节课外活动课调整到星期五下午第三节。 <FONT color=#ee3d11>(高三年级的音乐课暂时改自修)</FONT></P>
<P>                                                                             教学处</P>
<P>                                                                                2.17</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3322.aspx" target="_self" title="标题：高二、高三会考成绩&#xD;点击数：556&#xD;发表时间：11年02月17日">高二、高三会考成绩</a>[ 02-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3325.aspx" target="_self" title="标题：高三、高二会考补考通知&#xD;点击数：495&#xD;发表时间：11年02月17日">高三、高二会考补考通知</a>[ 02-17 ]</div>
                        </div>
                    </div>
