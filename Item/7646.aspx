...
<head>
    ...
    <title>高一、高二部分课程改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二部分课程改自修通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7646"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7646},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7646";
     ...
     <FONT size=4>周五技术组白宗刚、邓倬霖、余栋材老师，体育组王琼娜老师赴宁波镇海中学访问交流，方大林老师外出教研活动，高二相关班级技术课、高一相关班级体育课改自修。高二技术走班班级在上课教室自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7644.aspx" target="_self" title="标题：11.16早学早读抽检情况&#xD;点击数：211&#xD;发表时间：17年11月16日">11.16早学早读抽检情况</a>[ 11-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7648.aspx" target="_self" title="标题：高一期中考试安排&#xD;点击数：744&#xD;发表时间：17年11月17日">高一期中考试安排</a>[ 11-17 ]</div>
                        </div>
                    </div>
