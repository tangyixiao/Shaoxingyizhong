...
<head>
    ...
    <title>绍兴一中教师课堂教学能力比武通知三--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中教师课堂教学能力比武通知三</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9998"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9998},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9998";
     ...
     <P> </P>
<P>因下周有期中考试等安排，为保证活动质量，课堂教学能力比武活动推迟到5月4日-7日举行。</P>
<P>另外，请参加比武的老师今天下午4：25分到行政楼三楼会议室二开个短会。</P>
<P>参会人员名单：</P>
<P class=MsoNormal style="WORD-BREAK: break-all; TEXT-ALIGN: left; MARGIN: 0cm 0cm 0pt; LINE-HEIGHT: 170%; mso-pagination: widow-orphan" align=left><SPAN style="FONT-FAMILY: 宋体; mso-hansi-font-family: Cambria; mso-ascii-font-family: Cambria"><FONT size=3>陈忆宁、鲁豪然、顾秀芳，王维、金笛、邵张彬、张超、王琼娜、胡红燕、陈华、顾飞飞、秦黎，施卡祥、冯莹、谢君樑、陈依、余栋材</FONT></SPAN><SPAN lang=EN-US><?xml:namespace prefix = "o" ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9995.aspx" target="_self" title="标题：绍兴一中教师课堂教学能力比武通知二&#xD;点击数：538&#xD;发表时间：19年04月18日">绍兴一中教师课堂教学能力比武通知二</a>[ 04-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10000.aspx" target="_self" title="标题：关于浙江省教坛新秀推荐评选的通知&#xD;点击数：225&#xD;发表时间：19年04月19日">关于浙江省教坛新秀推荐评选的通知</a>[ 04-19 ]</div>
                        </div>
                    </div>
