...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16908"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16908},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16908";
     ...
     <p><span style="FONT-SIZE: 20px">11月25日（周五），全体化学教师参加市直教研活动，化学课改自修（走班学生在相关教室自修）。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16907.aspx" target="_self" title="标题：物理教研活动通知&#xD;点击数：306&#xD;发表时间：22年11月23日">物理教研活动通知</a>[ 11-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16932.aspx" target="_self" title="标题：语文组参加教研活动通知&#xD;点击数：235&#xD;发表时间：22年11月28日">语文组参加教研活动通知</a>[ 11-28 ]</div>
                        </div>
                    </div>
