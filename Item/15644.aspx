...
<head>
    ...
    <title>第三届市直田径运动会出征仪式--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">第三届市直田径运动会出征仪式</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15644"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15644},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15644";
     ...
     <p>今天（5月19日）下午第四节请参加市直运动会的运动员（包括替补）到图书馆三楼报告厅二参加运动会出征仪式</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15635.aspx" target="_self" title="标题：化学教研活动通知&#xD;点击数：225&#xD;发表时间：22年05月18日">化学教研活动通知</a>[ 05-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15653.aspx" target="_self" title="标题：学术节 | 数学系列活动之数学竞赛获奖情况&#xD;点击数：383&#xD;发表时间：22年05月19日">学术节 | 数学系列活动之数学竞赛获奖情况</a>[ 05-19 ]</div>
                        </div>
                    </div>
