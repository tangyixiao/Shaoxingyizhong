...
<head>
    ...
    <title>教研组长、备课组长、年段长会议--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">教研组长、备课组长、年段长会议</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3200"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3200},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3200";
     ...
     <P>      明天1月5日（星期三）下午第三节，在行政楼三楼会议室召开教研组长、备课组长及年段长会议，会议主要内容布置有关期末工作，请各位安排好其他教育教学工作，准时出席。</P>
<P>                                                  教学处  、教科室  </P>
<P>                                                                   2011年1月4日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3198.aspx" target="_self" title="标题：高校自主招生校荐名额（第五批）&#xD;点击数：773&#xD;发表时间：11年01月04日">高校自主招生校荐名额（第五批）</a>[ 01-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3203.aspx" target="_self" title="标题：“健康&amp;#8226;向上”2010校迎新春长跑接力比赛的通知&#xD;点击数：662&#xD;发表时间：11年01月04日">“健康&amp;#8226;向上”2010校迎新春长跑接力比赛的通知</a>[ 01-04 ]</div>
                        </div>
                    </div>
