...
<head>
    ...
    <title>一周检查情况公布 (2009.9.21-9.30)--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">一周检查情况公布 (2009.9.21-9.30)</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年10月10日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=376"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:376},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=376";
     ...
     <TABLE style="WIDTH: 412pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=544 border=0 x:str>
<COLGROUP>
...
<COL style="WIDTH: 32pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/369.aspx" target="_self" title="标题：国旗下讲话主持人、宣讲员名单公布&#xD;点击数：382&#xD;发表时间：09年10月10日">国旗下讲话主持人、宣讲员名单公布</a>[ 10-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/390.aspx" target="_self" title="标题：推荐给班主任和全体学生的两篇文章&#xD;点击数：407&#xD;发表时间：09年10月13日">推荐给班主任和全体学生的两篇文章</a>[ 10-13 ]</div>
                        </div>
                    </div>
