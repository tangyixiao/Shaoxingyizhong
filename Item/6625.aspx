...
<head>
    ...
    <title>生物竞赛试场安排通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6625"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6625},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6625";
     ...
     本周日高一（1～12）班教室、高二（1～16）班教室将用作生物竞赛试场，请各班同学生带走贵重物品，桌面上清理干净，打扫好教室卫生。<BR>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6623.aspx" target="_self" title="标题：周六（25日）高二、高三学考选考模拟考安排&#xD;点击数：950&#xD;发表时间：17年03月24日">周六（25日）高二、高三学考选考模拟考安排</a>[ 03-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6628.aspx" target="_self" title="标题：数字平台个人成绩和排名查询方法&#xD;点击数：470&#xD;发表时间：17年03月24日">数字平台个人成绩和排名查询方法</a>[ 03-24 ]</div>
                        </div>
                    </div>
