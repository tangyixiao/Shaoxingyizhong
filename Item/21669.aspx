...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21669"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21669},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21669";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/6/202506251645298818.png" style="max-width: 100%; " title="202506251645298818.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21668.aspx" target="_self" title="标题：绍兴一中新高三（2026届）启动仪式方案及工作安排&#xD;点击数：244&#xD;发表时间：25年06月25日">绍兴一中新高三（2026届）启动仪式方案及工作安排</a>[ 06-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21674.aspx" target="_self" title="标题：寻物启事（政治课本）&#xD;点击数：53&#xD;发表时间：25年06月26日">寻物启事（政治课本）</a>[ 06-26 ]</div>
                        </div>
                    </div>
