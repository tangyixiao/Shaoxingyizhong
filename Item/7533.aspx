...
<head>
    ...
    <title>各班劳动委员开会通知（有修改）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">各班劳动委员开会通知（有修改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7533"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7533},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7533";
     ...
     请各班劳动委员明天（10月27日）中午12:30在2号教学楼1楼2112教室开会，随带笔记本，望相互转告！
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7532.aspx" target="_self" title="标题：2017年秋季运动会工作安排（有修改）&#xD;点击数：828&#xD;发表时间：17年10月26日">2017年秋季运动会工作安排（有修改）</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7537.aspx" target="_self" title="标题：关于进一步规范垃圾分类工作的建议&#xD;点击数：99&#xD;发表时间：17年10月27日">关于进一步规范垃圾分类工作的建议</a>[ 10-27 ]</div>
                        </div>
                    </div>
