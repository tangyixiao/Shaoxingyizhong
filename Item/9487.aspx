...
<head>
    ...
    <title>十佳歌手决赛选手上交节目串词的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">十佳歌手决赛选手上交节目串词的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9487"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9487},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9487";
     ...
     <P>      各位十佳歌手决赛选手：请于明天（12月11日）中午12：40分前上交各自节目的串词（要求：50字以内，语言通顺，情感真挚）。高一选手请上交至106袁艺，高二选手请上交至213宣钰骐。谢谢！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9482.aspx" target="_self" title="标题：寻物启事&#xD;点击数：351&#xD;发表时间：18年12月10日">寻物启事</a>[ 12-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9489.aspx" target="_self" title="标题：失物招领&#xD;点击数：202&#xD;发表时间：18年12月11日">失物招领</a>[ 12-11 ]</div>
                        </div>
                    </div>
