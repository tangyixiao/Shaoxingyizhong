...
<head>
    ...
    <title>高一音乐课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=834"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:834},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=834";
...
<TBODY>
<TR>
<TD width="90%"><FONT color=#000000><FONT size=3>由于王海燕、童莉芳老师参加省课堂教学评比大赛观摩，11月30日（星期一）—12月3日（星期四）所任课班级课改自修。</FONT> </FONT></TD></TR></TBODY></TABLE></TD>
...
<P><FONT color=#000000><BR></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/833.aspx" target="_self" title="标题：绍兴一中高校自主招生分配名额公布(第三批)&#xD;点击数：409&#xD;发表时间：09年12月03日">绍兴一中高校自主招生分配名额公布(第三批)</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/837.aspx" target="_self" title="标题：关于举行校课堂教学评比活动的通知&#xD;点击数：259&#xD;发表时间：09年12月03日">关于举行校课堂教学评比活动的通知</a>[ 12-03 ]</div>
                        </div>
                    </div>
