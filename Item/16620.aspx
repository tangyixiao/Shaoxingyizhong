...
<head>
    ...
    <title>（信息公示）学校食品安全工作领导小组(2021年9月)--校园安全-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16620"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16620},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16620";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2022/4/202204241629524502.jpg" style="max-width: 100%; " title="202204241629524502.jpg" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16619.aspx" target="_self" title="标题：（信息公示）食品安全承诺书(2022.3-2023.2)&#xD;点击数：1&#xD;发表时间：22年03月01日">（信息公示）食品安全承诺书(2022.3-2023.2)</a>[ 03-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16621.aspx" target="_self" title="标题：（信息公示）食品安全管理处室和食堂安全管理员名单（2021年9月）&#xD;点击数：3&#xD;发表时间：21年09月01日">（信息公示）食品安全管理处室和食堂安全管理员名单（2021年9…</a>[ 09-01 ]</div>
                        </div>
                    </div>
