...
<head>
    ...
    <title>升旗仪式及大课间操暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">升旗仪式及大课间操暂停通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6547"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6547},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6547";
     ...
     <P>全校师生注意;</P>
<P>     因下周一到周三高二、高三进行学考选考适应性考试，周一升旗仪式及周二、周三大课间跑操暂停进行，其中周一高一作息时间按照周二时间进行（即第一节课7：45开始）。同时，高二、高三各班在考试期间继续做好包干区和教室卫生工作，值周班值周考核工作照常。请全校师生相互告知，谢谢！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6533.aspx" target="_self" title="标题：寻物启事&#xD;点击数：167&#xD;发表时间：17年03月09日">寻物启事</a>[ 03-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6552.aspx" target="_self" title="标题：大扫除暂停通知&#xD;点击数：111&#xD;发表时间：17年03月13日">大扫除暂停通知</a>[ 03-13 ]</div>
                        </div>
                    </div>
