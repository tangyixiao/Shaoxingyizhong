...
<head>
    ...
    <title>高二明天课程安排调整通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二明天课程安排调整通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8243"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8243},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8243";
     ...
     <!--StartFragment -->
<DIV><FONT size=4>结合高二实际情况，经和高二年段协商，明天高二的课调整为按周一课表上课，请相关任课老师互相转告。</FONT><BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8241.aspx" target="_self" title="标题：高三数学教研活动通知&#xD;点击数：211&#xD;发表时间：18年03月29日">高三数学教研活动通知</a>[ 03-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8250.aspx" target="_self" title="标题：2018年4月学考选考监考安排&#xD;点击数：1544&#xD;发表时间：18年03月31日">2018年4月学考选考监考安排</a>[ 03-31 ]</div>
                        </div>
                    </div>
