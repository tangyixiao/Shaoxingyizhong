...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1213"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1213},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1213";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-SIZE: 16pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">高二、高三班主任：在本年级学生会考时要做为班级学生的领队到校，主要负责学生点名和会考准证的发收。</SPAN><SPAN lang=EN-US style="FONT-SIZE: 16pt"><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1212.aspx" target="_self" title="标题：关于高三备课组长外出交流的通知&#xD;点击数：508&#xD;发表时间：10年01月12日">关于高三备课组长外出交流的通知</a>[ 01-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1218.aspx" target="_self" title="标题：高三班主任：美术类省统考查分&#xD;点击数：462&#xD;发表时间：10年01月12日">高三班主任：美术类省统考查分</a>[ 01-12 ]</div>
                        </div>
                    </div>
