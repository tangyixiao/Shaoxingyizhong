...
<head>
    ...
    <title>校本课程和高二年级IB上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">校本课程和高二年级IB上课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2103"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2103},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2103";
     ...
     高一、高二校本课程和高二年级的选修IB本周照常上课，下周停课,其中生物老师参加会考阅卷，本周校本课程暂停，请班主任及时通知学生，本班教室不能自修的学生，可到图书馆自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2098.aspx" target="_self" title="标题：模块成绩录入情况再次统计&#xD;点击数：399&#xD;发表时间：10年06月21日">模块成绩录入情况再次统计</a>[ 06-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2104.aspx" target="_self" title="标题：关于高一文理分班的通知&#xD;点击数：535&#xD;发表时间：10年06月22日">关于高一文理分班的通知</a>[ 06-22 ]</div>
                        </div>
                    </div>
