...
<head>
    ...
    <title>关于开放学校心理咨询室的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于开放学校心理咨询室的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=198"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:198},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=198";
     ...
     <DIV align=center><FONT size=6><STRONG>关于开放学校心理咨询室的通知</STRONG></FONT></DIV>
<DIV align=center><B></B> </DIV>
<DIV>       <FONT size=5><STRONG>为了更好地维护学生的心理健康，促进学生身心和谐发展，学校心理咨询室从9月7日起面向全校学生无偿开放。本咨询实施预约制，有需求的学生请拨打预约电话或
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/195.aspx" target="_self" title="标题：各班主任请注意（近期有关事项）&#xD;点击数：498&#xD;发表时间：09年09月03日">各班主任请注意（近期有关事项）</a>[ 09-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/207.aspx" target="_self" title="标题：升旗仪式通知&#xD;点击数：511&#xD;发表时间：09年09月07日">升旗仪式通知</a>[ 09-07 ]</div>
                        </div>
                    </div>
