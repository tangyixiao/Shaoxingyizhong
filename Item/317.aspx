...
<head>
    ...
    <title>关于完善浙江省电子学籍管理系统的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于完善浙江省电子学籍管理系统的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月23日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=317"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:317},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=317";
     ...
     <DIV>原高一高二班主任及相关老师：</DIV>
<DIV>     浙江省电子学籍管理系统在本月底需要升级，经查询发现部分学生信息不完整，为了对学生负责，请原班主任和相关老师务必将信息补录完整。查询结果见下表。请班主任和相关老师在9月27日（星期日）前完成此项工作，过期系统将无法补录上一学年信息。</DIV>
<DIV>
<TABLE style="WIDTH: 516pt; BORDER-COLLAPSE: collapse" cellSpacing=0 ce
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/314.aspx" target="_self" title="标题：关于转发市教育教学研究院《在教师研修网申请继续教育学分的几点说明》的通知&#xD;点击数：542&#xD;发表时间：09年09月22日">关于转发市教育教学研究院《在教师研修网申请继续教育学分的几…</a>[ 09-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/324.aspx" target="_self" title="标题：关于“高考征文”和“优秀经验总结报告评选”的补充通知&#xD;点击数：403&#xD;发表时间：09年09月25日">关于“高考征文”和“优秀经验总结报告评选”的补充通知</a>[ 09-25 ]</div>
                        </div>
                    </div>
