...
<head>
    ...
    <title>下雪啦，来领树人导报啦！--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8015"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8015},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8015";
     ...
     <P>请各班团支书于今天放学前至2114团委领取树人导报。雨雪天气路面湿滑，请大家上下楼梯注意安全~</P>
<P align=right>校团委<BR>2018年1月26日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8008.aspx" target="_self" title="标题：少年作家冬令营集训报名开始了！&#xD;点击数：235&#xD;发表时间：18年01月24日">少年作家冬令营集训报名开始了！</a>[ 01-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8030.aspx" target="_self" title="标题：2017学年第一学期团支部考核结果公示&#xD;点击数：382&#xD;发表时间：18年01月30日">2017学年第一学期团支部考核结果公示</a>[ 01-30 ]</div>
                        </div>
                    </div>
