...
<head>
    ...
    <title>超脑、智学网使用培训通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">超脑、智学网使用培训通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12193"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12193},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12193";
     ...
     各位老师:今天下午8,9两节课，科大讯飞工作人员培训超脑和智学网使用方法，40岁（含）以下的老师必须参加培训。40岁以上的老师，有兴趣也可参加。高二高三没课的老师第8节参加，高一和高二高三第8节有课的老师第9节参加，培训地点，树兰楼5楼录播教室
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12182.aspx" target="_self" title="标题：信息技术教研活动通知&#xD;点击数：194&#xD;发表时间：20年11月17日">信息技术教研活动通知</a>[ 11-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12198.aspx" target="_self" title="标题：高二期中考试成绩分析会通知（地点有修改）&#xD;点击数：378&#xD;发表时间：20年11月18日">高二期中考试成绩分析会通知（地点有修改）</a>[ 11-18 ]</div>
                        </div>
                    </div>
