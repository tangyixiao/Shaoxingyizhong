...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22075"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22075},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22075";
     ...
     <article>       本周四（16日）数学组全体外出参加教研活动，数学课改自修。</article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22055.aspx" target="_self" title="标题：关于开展2025年教师资格定期注册工作的通知&#xD;点击数：161&#xD;发表时间：25年10月11日">关于开展2025年教师资格定期注册工作的通知</a>[ 10-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22115.aspx" target="_self" title="标题：生物组外出参加教研活动通知&#xD;点击数：145&#xD;发表时间：25年10月22日">生物组外出参加教研活动通知</a>[ 10-22 ]</div>
                        </div>
                    </div>
