...
<head>
    ...
    <title>关于开展2009年高考征文活动的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于开展2009年高考征文活动的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=139"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:139},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=139";
     ...
     <DIV>     <FONT size=4>2009年是浙江省新课程高考方案实施的第一年，为了推动广大教师研究新课程、新高考，准确把握新课程高考的基本要求，提升课堂教学效率，绍兴市教育教学研究院、绍兴市特级教师协会定于9月份在全市普通高中中开展以“新课程·新高考·新策略”为主题的征文活动。</FONT></DIV>
<DIV><FONT size=4>一、征文内容</FONT></DIV>
<DIV><FONT size=4>1．新课程高考试题研究。对高
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/138.aspx" target="_self" title="标题：原高三班主任注意&#xD;点击数：588&#xD;发表时间：09年08月25日">原高三班主任注意</a>[ 08-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/144.aspx" target="_self" title="标题：关于开展“优秀经验总结报告”评选活动的通知&#xD;点击数：463&#xD;发表时间：09年09月15日">关于开展“优秀经验总结报告”评选活动的通知</a>[ 09-15 ]</div>
                        </div>
                    </div>
