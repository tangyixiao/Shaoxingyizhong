...
<head>
    ...
    <title>有关高一、高二期中成绩发放的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">有关高一、高二期中成绩发放的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1849"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1849},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1849";
     ...
     <P>高一、高二班主任：</P>
<P>本次期中考试成绩，如果需要通过校讯通发给学生家长的，请在今天下午5点前与教学处联系。</P>
<P>                                                                                     教学处</P>
<P>                                                                                   2010.5.12</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1847.aspx" target="_self" title="标题：下周（5.17-5.23）市属优质课评比及学科主题研修活动通知&#xD;点击数：786&#xD;发表时间：10年05月12日">下周（5.17-5.23）市属优质课评比及学科主题研修活动通知</a>[ 05-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1850.aspx" target="_self" title="标题：关于今天下午高二年级IB上课暂停的通知（急）&#xD;点击数：348&#xD;发表时间：10年05月12日">关于今天下午高二年级IB上课暂停的通知（急）</a>[ 05-12 ]</div>
                        </div>
                    </div>
