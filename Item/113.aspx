...
<head>
    ...
    <title>班主任培训通知--德育处-绍兴市第一中学</title>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本校</span> <span>作者：德育</span> <span>发布时间：2009年08月17日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=113"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:113},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=113";
     ...
     下列班主任请于八月十九日—二十日（周三—周四）两天到绍兴市高级中学参加班主任工作培训。 
<DIV><B>   参加培训班主任名单：（共17人）</B></DIV>
<DIV><B>高一：谢澹、俞霞、刘明玉、陈雪萍、陈锋、陈丹燕、胡勇、丁泾芳</B></DIV>
<DIV><STRONG>高二：叶建红、楼开颜、唐海燕</STRONG></DIV>
<DIV><STRONG>高三：金华元、胡桂兰、裘红萍、刘淑芳、邢秀英、杨晶晶</STRONG></DIV>
<DIV><B></B>&nb
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/109.aspx" target="_self" title="标题：关于军训动员预备会议的通知&#xD;点击数：950&#xD;发表时间：09年08月17日">关于军训动员预备会议的通知</a>[ 08-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/114.aspx" target="_self" title="标题：2009新生衔接教育“日常行为规范及校史知识”测试优秀奖（个人）名单&#xD;点击数：719&#xD;发表时间：09年08月18日">2009新生衔接教育“日常行为规范及校史知识”测试优秀奖（个人…</a>[ 08-18 ]</div>
                        </div>
                    </div>
