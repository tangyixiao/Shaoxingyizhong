...
<head>
    ...
    <title>大课间跑操暂停通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">大课间跑操暂停通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>大课间跑操暂停通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2021年03月17日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12914"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12914},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12914";
     ...
     <p style="margin: 0 0 120px;padding: 0"><span style="font-family: 微软雅黑;color: rgb(51, 51, 51);letter-spacing: 0;font-size: 16px;background: rgb(255, 255, 255)"><span style="font-family:微软雅黑">今天（</span><span style="font-family:微软雅黑">3月1</span></span><span style="font-family: 微软雅黑;color: rgb(51, 51, 51);letter-spacing: 0;font-size: 16px;background: rgb(255, 255, 255)"><span style="font-family:微软雅黑">7</span></span><span style="font-family: 微软雅黑;color: rgb(51, 51, 51);letter-spacing: 0;font-size: 16px;background: rgb(255, 255, 255)"><span style="font-family:微软雅黑">日）因场地积水，大课间跑操暂停。</span></span></p><p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12908.aspx" target="_self" title="标题：失物招领&#xD;点击数：168&#xD;发表时间：21年03月16日">失物招领</a>[ 03-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12915.aspx" target="_self" title="标题：3月16日高一年级卫生大扫除检查情况通报&#xD;点击数：67&#xD;发表时间：21年03月17日">3月16日高一年级卫生大扫除检查情况通报</a>[ 03-17 ]</div>
                        </div>
                    </div>
