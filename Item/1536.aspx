...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1536"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1536},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1536";
     ...
     <P>高一各班主任：</P>
<P>        明天下午高一（6）——（16）班全体学生参加信息学颁奖仪式。请上述各班学生在12：30分先到1号教学楼2、3楼体检，1：40分无论体检是否结束，都必须准时到达报告厅按指定位置就座。高一(1)——(5)班体检在2点后进行，请勿提前。<A title=座位安排 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201003/2010032820220662.xls">座位安排</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1530.aspx" target="_self" title="标题：高一、高二班主任请注意&#xD;点击数：823&#xD;发表时间：10年03月25日">高一、高二班主任请注意</a>[ 03-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1547.aspx" target="_self" title="标题：一周检查情况公布(2010.3.22-3.27)&#xD;点击数：350&#xD;发表时间：10年03月29日">一周检查情况公布(2010.3.22-3.27)</a>[ 03-29 ]</div>
                        </div>
                    </div>
