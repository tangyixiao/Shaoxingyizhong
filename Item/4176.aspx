...
<head>
    ...
    <title>行政党支部会议通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4176"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4176},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4176";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 26.25pt; mso-char-indent-count: 2.5"><FONT size=3><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">定于今天下午第二节课（</SPAN><SPAN lang=EN-US>14</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">：</SPAN><SPAN lang=EN-US>35</SPAN><SPAN style="FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">）在行政楼三楼会议室召开支部会议，请支部全体党员准时参加！</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4168.aspx" target="_self" title="标题：中共绍兴市第一中学委员会关于开展纪念建党九十周年系列活动——党的知识竞赛活动的通知&#xD;点击数：2456&#xD;发表时间：11年06月14日">中共绍兴市第一中学委员会关于开展纪念建党九十周年系列活动—…</a>[ 06-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4185.aspx" target="_self" title="标题：绍兴一中学生（家长）教学等投诉处理办法&#xD;点击数：1285&#xD;发表时间：11年06月16日">绍兴一中学生（家长）教学等投诉处理办法</a>[ 06-16 ]</div>
                        </div>
                    </div>
