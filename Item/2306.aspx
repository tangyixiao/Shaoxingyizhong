...
<head>
    ...
    <title>高三党支部会议--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_35/Index.aspx" target="_self">高三</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三党支部会议</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>高三党支部会议</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年08月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2306"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2306},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2306";
...
<P>                   2010、8、28</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2032.aspx" target="_self" title="标题：高三支部会议通知&#xD;点击数：476&#xD;发表时间：10年06月11日">高三支部会议通知</a>[ 06-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2308.aspx" target="_self" title="标题：高三党支部会议因故取消&#xD;点击数：208&#xD;发表时间：10年08月28日">高三党支部会议因故取消</a>[ 08-28 ]</div>
                        </div>
                    </div>
