...
<head>
    ...
    <title>关于周三（今天）下午第四节课大扫除的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于周三（今天）下午第四节课大扫除的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7631"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7631},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7631";
           ...
           高一年段各班请注意，周三（今天）下午第四节劳动课大扫除照常进行，请大家按要求打扫。
<P>  </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7627.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：46&#xD;发表时间：17年11月15日">大课间操暂停通知</a>[ 11-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7639.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：47&#xD;发表时间：17年11月16日">大课间操暂停通知</a>[ 11-16 ]</div>
                        </div>
                    </div>
