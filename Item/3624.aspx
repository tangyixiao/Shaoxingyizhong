...
<head>
    ...
    <title>高三政策加分原件、复印件上交今天截止--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三政策加分原件、复印件上交今天截止</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3624"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3624},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3624";
     ...
     高三政策加分原件、复印件上交今天（29日）下午3：00截止。过时不再受理。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3609.aspx" target="_self" title="标题：高三学科竞赛、少数民族、华侨加分学生是否有漏报&#xD;点击数：626&#xD;发表时间：11年03月28日">高三学科竞赛、少数民族、华侨加分学生是否有漏报</a>[ 03-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3625.aspx" target="_self" title="标题：2011年高考政策加分名单公示&#xD;点击数：611&#xD;发表时间：11年03月29日">2011年高考政策加分名单公示</a>[ 03-29 ]</div>
                        </div>
                    </div>
