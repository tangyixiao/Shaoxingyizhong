...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=835"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:835},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=835";
...
<TR>
<TD width="90%">
<P><FONT size=3><FONT color=#000000>定于今天下午第四节课在行政楼五楼会议室召开教工会议,</FONT><STRONG><FONT color=#ff0033>请全体教工准时出席!</FONT></STRONG></FONT></P></TD>
<TD width="5%"><FONT size=3> </FONT></TD></TR></TBODY></TABLE>
<P><FONT size=3><BR></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/826.aspx" target="_self" title="标题：召开行政会议的通知&#xD;点击数：517&#xD;发表时间：09年12月03日">召开行政会议的通知</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/850.aspx" target="_self" title="标题：有关校讯通学生卡的通知&#xD;点击数：2249&#xD;发表时间：09年12月03日">有关校讯通学生卡的通知</a>[ 12-03 ]</div>
                        </div>
                    </div>
