...
<head>
    ...
    <title>高二通用技术改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1907"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1907},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1907";
     ...
     5月20日（星期四）至5月21日（星期五），焦大伟、许婷老师参加教研活动，所任课班级通用技术课改自修。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1906.aspx" target="_self" title="标题：市属高中生物优质课评比听课安排&#xD;点击数：559&#xD;发表时间：10年05月19日">市属高中生物优质课评比听课安排</a>[ 05-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1908.aspx" target="_self" title="标题：高三毕业证书信息确认&#xD;点击数：364&#xD;发表时间：10年05月19日">高三毕业证书信息确认</a>[ 05-19 ]</div>
                        </div>
                    </div>
