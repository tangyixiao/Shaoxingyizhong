...
<head>
    ...
    <title>关于教坛新秀报名的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6968"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6968},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6968";
     ...
     <P> </P>
<P>各位老师：</P>
<P>市直、市级、省级教坛新秀的评选即日开始，请符合相关条件的老师于今天下午5：00前向课程处报名。学校将依照省市文件要求，择优推荐。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6962.aspx" target="_self" title="标题：关于2017市直教坛新秀申报的通知&#xD;点击数：191&#xD;发表时间：17年05月17日">关于2017市直教坛新秀申报的通知</a>[ 05-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6975.aspx" target="_self" title="标题：高一各班班长领取七选三调查材料的通知&#xD;点击数：253&#xD;发表时间：17年05月18日">高一各班班长领取七选三调查材料的通知</a>[ 05-18 ]</div>
                        </div>
                    </div>
