...
<head>
    ...
    <title>各班主任注意--德育处-绍兴市第一中学</title>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>各班主任注意</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年03月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3603"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3603},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3603";
...
<P><FONT size=4>1.今天中午放学前（高一、高二）请全校各班主任督促学生对教室及每日包干区进行一次认真打扫，确保校园整洁，德育处将在中午进行检查。</FONT></P>
<P><FONT size=4>2.高一（9）到（16）班的班主任要对本班学生进行一次集会的</FONT><FONT size=4>纪律教育，要求学生不做作业、看书等与会议无关的事，维护一中的良好形象，下午1：40开始进场，班主任要随班到会，管理好班级学生，确保下午信息学颁奖大会的顺利进行。</FONT></P>
<P>                                                                        谢谢！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3600.aspx" target="_self" title="标题：值周检查情况汇总（3月24日星期四）&#xD;点击数：404&#xD;发表时间：11年03月25日">值周检查情况汇总（3月24日星期四）</a>[ 03-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3606.aspx" target="_self" title="标题：值周检查情况汇总（3月25日星期五）&#xD;点击数：281&#xD;发表时间：11年03月26日">值周检查情况汇总（3月25日星期五）</a>[ 03-26 ]</div>
                        </div>
                    </div>
