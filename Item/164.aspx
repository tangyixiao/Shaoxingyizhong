...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=164"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:164},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=164";
     ...
     <P>    <FONT size=5>  全体师生：</FONT></P>
<P><FONT size=5>     本周周六与周日休息。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/162.aspx" target="_self" title="标题：关于教师参加心理健康教育自考报考、领证的通知&#xD;点击数：669&#xD;发表时间：09年08月28日">关于教师参加心理健康教育自考报考、领证的通知</a>[ 08-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/169.aspx" target="_self" title="标题：教工会议通知&#xD;点击数：681&#xD;发表时间：09年08月31日">教工会议通知</a>[ 08-31 ]</div>
                        </div>
                    </div>
