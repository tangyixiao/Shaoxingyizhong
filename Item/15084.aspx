...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15084"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15084},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15084";
     ...
     <p>今天（3月4日）场地湿滑，大课间进行室内操。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15077.aspx" target="_self" title="标题：3.02班级一日考核&#xD;点击数：62&#xD;发表时间：22年03月03日">3.02班级一日考核</a>[ 03-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15085.aspx" target="_self" title="标题：3.03班级一日考核&#xD;点击数：54&#xD;发表时间：22年03月04日">3.03班级一日考核</a>[ 03-04 ]</div>
                        </div>
                    </div>
