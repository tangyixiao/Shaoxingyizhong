...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5911"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5911},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5911";
     ...
     <P>       <FONT size=4> 因执行冬令作息时间，从今天傍晚放学开始公交专线发车时间相应作如下调整：早上<SPAN style="COLOR: black; FONT-SIZE: 14pt" lang=EN-US>6:30（早上发车时间不变）</SPAN><SPAN style="FONT-FAMILY: 宋体; COLOR: black; FONT-SIZE: 14pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">、傍晚</SPAN><SPAN style="COLOR: black; FONT-SIZE: 14pt" lang=EN-US>17:10（傍晚发车时间提前15分钟）。请相关同学相互告知，烦请班主任也提醒一下，谢谢！</SPAN></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5908.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：77&#xD;发表时间：16年11月14日">表扬与失物招领</a>[ 11-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5914.aspx" target="_self" title="标题：大扫除暂停通知&#xD;点击数：76&#xD;发表时间：16年11月14日">大扫除暂停通知</a>[ 11-14 ]</div>
                        </div>
                    </div>
