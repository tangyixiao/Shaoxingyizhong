...
<head>
    ...
    <title>有关全国体测相关上课安排的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">有关全国体测相关上课安排的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=12130"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:12130},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=12130";
     ...
     <!--StartFragment -->
<DIV>1.因参加全国体测，部分班级明天（12日）的课改自修，抽测到的学生由班主任带队提前10分钟到场地集中。高一（7）、（14）班9:30开始，上午第三、第四、第五节的课改自修；高二（2）、（3）班13:30开始，六、七两节课改自修；高三（7）、（11）班15:15开始，八、九两节课改自修。与全国体测相冲突的课请相关任课老师想办法在自修课补上。<BR>2.为准备周六军体运动会体测比赛，周四周五的体育、体锻课改自修。<BR></DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/12117.aspx" target="_self" title="标题：高一高二期中考试监考和阅卷安排&#xD;点击数：1009&#xD;发表时间：20年11月07日">高一高二期中考试监考和阅卷安排</a>[ 11-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/12137.aspx" target="_self" title="标题：高一高二选修课暂停通知&#xD;点击数：406&#xD;发表时间：20年11月12日">高一高二选修课暂停通知</a>[ 11-12 ]</div>
                        </div>
                    </div>
