...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6147"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6147},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6147";
         ...
         各班团支书在下午放学前到行政楼演播厅门口领取树人导报。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6142.aspx" target="_self" title="标题：关于今天中午求真讲坛的通知&#xD;点击数：349&#xD;发表时间：16年12月16日">关于今天中午求真讲坛的通知</a>[ 12-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6165.aspx" target="_self" title="标题：会议通知&#xD;点击数：275&#xD;发表时间：16年12月20日">会议通知</a>[ 12-20 ]</div>
                        </div>
                    </div>
