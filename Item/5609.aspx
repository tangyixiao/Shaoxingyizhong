...
<head>
    ...
    <title>晚间安全检查记录2016.9.26--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2016.9.26</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5609"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5609},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5609";
     ...
     9月26日晚，高二（13）班走廊灯未关，高二（16）班教室门未关。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5599.aspx" target="_self" title="标题：全校安全委员开会通知&#xD;点击数：126&#xD;发表时间：16年09月26日">全校安全委员开会通知</a>[ 09-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5611.aspx" target="_self" title="标题：每日晨检表未交情况通报&#xD;点击数：163&#xD;发表时间：16年09月27日">每日晨检表未交情况通报</a>[ 09-27 ]</div>
                        </div>
                    </div>
