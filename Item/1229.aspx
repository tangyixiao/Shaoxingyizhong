...
<head>
    ...
    <title>召开绍兴一中九届教代会通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">召开绍兴一中九届教代会通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1229"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1229},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1229";
           ...
           <STRONG>今天下午3：30时开始，在行政五楼会议室，召开绍兴一中九届教代会，请全体教职工准时出席大会。<BR>       全校下午第三节统一改自修课，这一节有课的教师请去其它时间的自修课（部分已结束的课）自行补上。<BR></STRONG>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1208.aspx" target="_self" title="标题：绍兴一中冬季长跑接力比赛成绩&#xD;点击数：1007&#xD;发表时间：10年01月11日">绍兴一中冬季长跑接力比赛成绩</a>[ 01-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1237.aspx" target="_self" title="标题：关于行政工会小组代表分组讨论会议更改地点的通知&#xD;点击数：803&#xD;发表时间：10年01月19日">关于行政工会小组代表分组讨论会议更改地点的通知</a>[ 01-19 ]</div>
                        </div>
                    </div>
