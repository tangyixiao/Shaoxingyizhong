...
<head>
    ...
    <title>【合唱社、知音社】社团课通知--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">【合唱社、知音社】社团课通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=23203"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23203},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23203";
     ...
     <p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; margin-bottom: 20px !important;">时间:周六（5月16号）中午12:20   </p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; margin-bottom: 20px !important;">地点:<span style="font-family: 宋体; text-align: justify; text-indent: 32px; background-color: rgb(255, 255, 255);">实验楼五楼音乐教室</span></p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; margin-bottom: 20px !important;">内容:社团团建活动   </p><p style="padding: 0px; margin-top: 0px; caret-color: rgb(51, 51, 51); color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; white-space: normal; margin-bottom: 20px !important;">务必向班主任做好请假工作！！</p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/23016.aspx" target="_self" title="标题：【鹤屋日研社】社团课通知&#xD;点击数：43&#xD;发表时间：26年04月11日">【鹤屋日研社】社团课通知</a>[ 04-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/23204.aspx" target="_self" title="标题：【校电】社团课通知&#xD;点击数：10&#xD;发表时间：26年05月15日">【校电】社团课通知</a>[ 05-15 ]</div>
                        </div>
                    </div>
