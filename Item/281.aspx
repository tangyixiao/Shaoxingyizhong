...
<head>
    ...
    <title>关于高一各班设立安检委员、并填写班干部统计表的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一各班设立安检委员、并填写班干部统计表的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：团委</span> <span>发布时间：2009年09月15日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=281"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:281},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=281";
...
<DIV><FONT size=3>高一各班主任：</FONT></DIV>
<DIV><FONT size=3>    1．为了加强学校安全工作管理，请各班设立安全检查委员（班委）一名，具体负责班级安全检查与管理工作。请各班在本星期做好安检委员推选工作。</FONT></DIV>
<DIV><FONT size=3>    2．请高一各班填写班干部统计表格。请于公共文件夹→团委→班干
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/279.aspx" target="_self" title="标题：2009年暑期社会实践活动评选结果&#xD;点击数：482&#xD;发表时间：09年09月15日">2009年暑期社会实践活动评选结果</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/292.aspx" target="_self" title="标题：关于公布团委、学生会招聘面试结果的通知&#xD;点击数：506&#xD;发表时间：09年09月17日">关于公布团委、学生会招聘面试结果的通知</a>[ 09-17 ]</div>
                        </div>
                    </div>
