...
<head>
    ...
    <title>关于补交07、08年度个人所得税的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于补交07、08年度个人所得税的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年08月25日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=137"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:137},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=137";
     ...
     <DIV align=center>关于补交07、08年度个人所得税的通知</DIV>
<DIV>      由于校属求知文化培训中心受税务稽查，需补交07、08年度个人所得税。所有07、08年度在求知文化培训中心发放的款项均需对月并入绍兴一中发放的款项中合并纳税。补交的个税将在9月8日发放的工资中扣除。个人扣税明细单请至财务室领取。有任何不明事项请咨询财务室。</DIV>
<DIV> </DIV>
<DIV>   
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/135.aspx" target="_self" title="标题：通知&#xD;点击数：894&#xD;发表时间：09年08月25日">通知</a>[ 08-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/145.aspx" target="_self" title="标题：关于行政会议的通知&#xD;点击数：692&#xD;发表时间：09年08月26日">关于行政会议的通知</a>[ 08-26 ]</div>
                        </div>
                    </div>
