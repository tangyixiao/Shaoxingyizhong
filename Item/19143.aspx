...
<head>
    ...
    <title>今天大课间跑操继续暂停--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19143"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19143},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19143";
     ...
     <p>各班级：</p><p>       因天冷地冻，大课间跑操继续暂停。</p><p>    </p><p>                                                       德育处、安全处、体育组</p><p>                                                       2023年12月22日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19142.aspx" target="_self" title="标题：寻物启事（政治课本）&#xD;点击数：155&#xD;发表时间：23年12月21日">寻物启事（政治课本）</a>[ 12-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19144.aspx" target="_self" title="标题：周六放学的通知&#xD;点击数：327&#xD;发表时间：23年12月22日">周六放学的通知</a>[ 12-22 ]</div>
                        </div>
                    </div>
