...
<head>
    ...
    <title>佚名之画作招领--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3177"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3177},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3177";
     ...
     <P>      现有一幅“百年电力”创作展参赛画作一幅，没有姓名班级信息。望同学相互转告，请创作者于今天放学前到音美办公室处填完相关信息。</P>
<P><A href="/Shaoxingyizhong/UploadFiles/UploadFiles/201012/2010122914354729.jpg" target=_blank><IMG onmousewheel="return bbimg(this)" style="WIDTH: 471px; HEIGHT: 360px" height=914 src="/Shaoxingyizhong/UploadFiles/UploadFiles/201012/2010122914354729.jpg" width=1340 onload=resizepic(this) border=0> </A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3176.aspx" target="_self" title="标题：12月29日大课间各班参加人数&#xD;点击数：321&#xD;发表时间：10年12月29日">12月29日大课间各班参加人数</a>[ 12-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3178.aspx" target="_self" title="标题：各班主任注意（关于告家长书）&#xD;点击数：469&#xD;发表时间：10年12月29日">各班主任注意（关于告家长书）</a>[ 12-29 ]</div>
                        </div>
                    </div>
