...
<head>
    ...
    <title>高一、高三各班班长会议--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=127"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:127},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=127";
     ...
     <P><FONT size=4>    今天中午12点整，在行政楼三楼会议室召开高一、高三各班班长会议。望各班主任通知班长准时参加会议。</FONT></P>
<P><FONT size=4>                        
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/123.aspx" target="_self" title="标题：各班主任请注意（关于安全等问题）&#xD;点击数：547&#xD;发表时间：09年08月20日">各班主任请注意（关于安全等问题）</a>[ 08-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/129.aspx" target="_self" title="标题：关于贫困生调查摸底的通知&#xD;点击数：707&#xD;发表时间：09年08月21日">关于贫困生调查摸底的通知</a>[ 08-21 ]</div>
                        </div>
                    </div>
