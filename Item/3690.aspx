...
<head>
    ...
    <title>关于严查学生迟到及课桌整洁的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于严查学生迟到及课桌整洁的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3690"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3690},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3690";
     ...
     <P> </P>
<P><FONT size=4>1．长期以来早上上学学生迟到现象较多，为严肃学校纪律，教育学生养成守纪及良好的学习习惯，从下周一起德育处将对迟到学生进行暴光批评，此项违纪记录将与其它违纪记录一样作为班级考核及学生评优的依据，请班主任做好宣传教育工作<FONT color=#f70968><FONT color=#000000>。</FONT><STRONG><FONT color=#f70968>（</FONT>根据学校作息时间表，考虑到从校门到教室的时间，所以7：30以后进校的学生视作迟到）</STRONG></FONT></FONT></P>
<P><FONT size=4>2．学生课桌乱涂乱画的现象较多，请班主任组织学生在下周一进行自查自纠，认真清理，德育处在下周进行检查评比。</FONT></P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3688.aspx" target="_self" title="标题：下周一进行应急演练的通知&#xD;点击数：363&#xD;发表时间：11年04月09日">下周一进行应急演练的通知</a>[ 04-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3692.aspx" target="_self" title="标题：值周检查情况汇总（4月8日星期五）&#xD;点击数：304&#xD;发表时间：11年04月09日">值周检查情况汇总（4月8日星期五）</a>[ 04-09 ]</div>
                        </div>
                    </div>
