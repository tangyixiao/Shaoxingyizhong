...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5643"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5643},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5643";
     ...
     <P>                                                    <STRONG> <FONT size=4 face=楷体_GB2312>（一）</FONT></STRONG></P>
<P><FONT size=4>  <FONT face=宋体>今天中午12：40，在行政楼五楼会议室举行入团仪式，请入团积极分子准时到场。名单如下：</FONT></FONT></P>
<P><FONT size=4 face=宋体>二（5）徐宇植 、王勇强    二（6）徐存易、章靖钰、黄映辰   </FONT></P>
<P><FONT size=4 face=宋体>二（12）周一澜            二（14）毛煜东、梁宸雨</FONT></P>
<P><FONT size=4><FONT face=宋体>                                         </FONT><FONT face=楷体_GB2312><STRONG>  （二）</STRONG></FONT></FONT></P>
<P><FONT size=4 face=宋体>  今天中午12:40，高一至高三团支书到行政楼一楼演播厅领取各班《树人导报》，每人一份。</FONT></P>
<P><FONT size=4 face=宋体>                                    <STRONG><FONT size=5 face=楷体_GB2312>          <FONT size=4>团委</FONT></FONT></STRONG></FONT></P>
<P><STRONG><FONT size=4 face=宋体>                                                2016.9.30</FONT></STRONG></P>
<P><STRONG></STRONG> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5639.aspx" target="_self" title="标题：关于组织青年教师观影活动的通知&#xD;点击数：154&#xD;发表时间：16年09月29日">关于组织青年教师观影活动的通知</a>[ 09-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5653.aspx" target="_self" title="标题：9月份黑板报成绩公布&#xD;点击数：302&#xD;发表时间：16年09月30日">9月份黑板报成绩公布</a>[ 09-30 ]</div>
                        </div>
                    </div>
