...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=23145"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23145},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23145";
     ...
     <article><span style="font-size: 18px;">5月8日（周五）语文组全体老师外出教研活动，所有语文课改自修。</span></article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/23122.aspx" target="_self" title="标题：学生证注册通知&#xD;点击数：131&#xD;发表时间：26年04月29日">学生证注册通知</a>[ 04-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/23146.aspx" target="_self" title="标题：物理教研活动通知&#xD;点击数：122&#xD;发表时间：26年05月06日">物理教研活动通知</a>[ 05-06 ]</div>
                        </div>
                    </div>
