...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1501"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1501},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1501";
...
<TD><!--插入广告JS代码--></TD></TR></TBODY></TABLE>定于今天下午第四节课在行政楼五楼会议室召开教工会议,请全体教工准时参加!
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1489.aspx" target="_self" title="标题：公&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;示&#xD;点击数：824&#xD;发表时间：10年03月19日">公    示</a>[ 03-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1515.aspx" target="_self" title="标题：关于换发高级证书相关注意事项的通知&#xD;点击数：977&#xD;发表时间：10年03月23日">关于换发高级证书相关注意事项的通知</a>[ 03-23 ]</div>
                        </div>
                    </div>
