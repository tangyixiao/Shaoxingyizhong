...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8455"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8455},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8455";
     ...
     <FONT size=4>本周五通用技术全体教师外出参加教研活动，相关班级通用技术课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8454.aspx" target="_self" title="标题：本周高三模拟考试场编排及监考安排&#xD;点击数：582&#xD;发表时间：18年04月27日">本周高三模拟考试场编排及监考安排</a>[ 04-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8459.aspx" target="_self" title="标题：清华紫光三位一体和自主招生面试培训通知&#xD;点击数：547&#xD;发表时间：18年04月28日">清华紫光三位一体和自主招生面试培训通知</a>[ 04-28 ]</div>
                        </div>
                    </div>
