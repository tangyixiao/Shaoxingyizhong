...
<head>
    ...
    <title>校讯一卡通更新或升级的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">校讯一卡通更新或升级的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>校讯一卡通更新或升级的通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年05月10日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3922"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3922},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3922";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 36pt; mso-char-indent-count: 2.0"><SPAN style="FONT-SIZE: 18pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">去年分校回本校和重新办理及不能刷的校讯一卡通的教工，请在今天下午</SPAN><SPAN lang=EN-US style="FONT-SIZE: 18pt">4</SPAN><SPAN style="FONT-SIZE: 18pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">：</SPAN><SPAN lang=EN-US style="FONT-SIZE: 18pt">30</SPAN><SPAN style="FONT-SIZE: 18pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">之前到</SPAN><SPAN lang=EN-US style="FONT-SIZE: 18pt">IC</SPAN><SPAN style="FONT-SIZE: 18pt; FONT-FAMILY: 宋体; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">卡室的沈老师处，帮助你更新或升级一下，到时都应该有刷卡记录显示和记载的。否则不刷卡的应先书面说明情况。</SPAN><SPAN lang=EN-US style="FONT-SIZE: 18pt"><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3919.aspx" target="_self" title="标题：关于向学生和家长公布马校长电子邮箱的通知&#xD;点击数：1002&#xD;发表时间：11年05月10日">关于向学生和家长公布马校长电子邮箱的通知</a>[ 05-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3929.aspx" target="_self" title="标题：关于召开奥赛情况交流会的通知&#xD;点击数：935&#xD;发表时间：11年05月10日">关于召开奥赛情况交流会的通知</a>[ 05-10 ]</div>
                        </div>
                    </div>
