...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=460"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:460},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=460";
...
<DIV align=center>绍兴一中学生（家长）教学等投诉处理办法</DIV>
<DIV>一、投诉方式</DIV>
<DIV>1.各种投诉均以书面形式寄（交）学校办公室，由学校办公室登记后交校长和相关分管副校长。</DIV>
<DIV>2.如接到学生（家长）的电话投诉，一般要求其改为来信投诉，以便有根有据，有理有节，也便于沟通回复。</DIV>
<DIV>二、投诉处理程序</DIV>
<DIV>3.接到投诉后，由分管副校长根据不同内容马
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/459.aspx" target="_self" title="标题：教工体检提醒&#xD;点击数：512&#xD;发表时间：09年10月26日">教工体检提醒</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/461.aspx" target="_self" title="标题：绍兴一中航模兴趣小组招生和组队参赛办法&#xD;点击数：557&#xD;发表时间：09年10月26日">绍兴一中航模兴趣小组招生和组队参赛办法</a>[ 10-26 ]</div>
                        </div>
                    </div>
