...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7512"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7512},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7512";
     ...
     <P align=center><FONT size=3 face=宋体>今天下午大扫除照常进行，请相互告知，谢谢！ </FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7509.aspx" target="_self" title="标题：上周值周小结&#xD;点击数：175&#xD;发表时间：17年10月23日">上周值周小结</a>[ 10-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7531.aspx" target="_self" title="标题：运动会优秀组织奖评比办法（有修改）&#xD;点击数：425&#xD;发表时间：17年10月26日">运动会优秀组织奖评比办法（有修改）</a>[ 10-26 ]</div>
                        </div>
                    </div>
