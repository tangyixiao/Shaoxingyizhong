    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        ...
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：tw</span> <span>发布时间：2016年09月26日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5606"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5606},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5606";
     ...
     <P> </P>
<P>    <FONT size=4>定于今天（26日周一）下午第四节课在实南205召开团学联工作例会。请团学联主席团、各部部长副部长、年级团总支、各部门后备骨干参加会议。请主席团做好会议筹备。请相互转告，参会请向班主任做好请假说明。</FONT></P>
<P><FONT size=4>                                                                                       校团委</FONT></P>
<P><FONT size=4>                                                                                       9月26日</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5603.aspx" target="_self" title="标题：关于今天中午领取冬衣募捐专用袋的通知（时间修改）&#xD;点击数：244&#xD;发表时间：16年09月26日">关于今天中午领取冬衣募捐专用袋的通知（时间修改）</a>[ 09-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5613.aspx" target="_self" title="标题：关于冬衣捐赠的时间、地点通知&#xD;点击数：128&#xD;发表时间：16年09月27日">关于冬衣捐赠的时间、地点通知</a>[ 09-27 ]</div>
                        </div>
                    </div>
