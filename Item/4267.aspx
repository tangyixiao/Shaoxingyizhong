...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4267"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4267},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4267";
...
<P><FONT size=4>新高一各班主任：</FONT></P>
<P><FONT size=4><STRONG>    </STRONG>今天下午学习的视频材料已经放在校内公共文件夹—德育处，文件名为“高一观看的视频材料 滕矢初《读书与人生》”，时间约为1个半小时。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4266.aspx" target="_self" title="标题：早上迟到、仪容仪表检查安排&#xD;点击数：898&#xD;发表时间：11年07月03日">早上迟到、仪容仪表检查安排</a>[ 07-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4268.aspx" target="_self" title="标题：7月3日新高一报告厅座位安排(有修改)&#xD;点击数：666&#xD;发表时间：11年07月02日">7月3日新高一报告厅座位安排(有修改)</a>[ 07-02 ]</div>
                        </div>
                    </div>
