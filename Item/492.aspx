...
<head>
    ...
    <title>绍兴一中各班住校生就寝纪律、寝室卫生情况统计表(2009.10.23-2009.10.30)--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中各班住校生就寝纪律、寝室卫生情况统计表(2009.10.23-2009.10.30)</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=492"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:492},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=492";
     ...
     <TABLE style="WIDTH: 391pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=520 border=0 x:str>
<COLGROUP>
...
<COL style="WIDTH: 57pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/490.aspx" target="_self" title="标题：一周检查情况公布(2009.10.26-10.31)&#xD;点击数：335&#xD;发表时间：09年11月02日">一周检查情况公布(2009.10.26-10.31)</a>[ 11-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/512.aspx" target="_self" title="标题：高一、高二班主任紧急会议&#xD;点击数：383&#xD;发表时间：09年11月05日">高一、高二班主任紧急会议</a>[ 11-05 ]</div>
                        </div>
                    </div>
