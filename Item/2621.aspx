...
<head>
    ...
    <title>研究性课程继续上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2621"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2621},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2621";
     ...
     <P>                                     研究性课程继续上课通知</P>
<P>    本周二下午第三、四节高一研究性课程和周三下午第三、四节高二研究性课程继续在报告厅上课。希望班主任老师通知学生带上笔记和作业本，准时集合，同时注意上课纪律。</P>
<P>                                                                           10.11</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2607.aspx" target="_self" title="标题：高一计算机课在教室上&#xD;点击数：340&#xD;发表时间：10年10月09日">高一计算机课在教室上</a>[ 10-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2625.aspx" target="_self" title="标题：市属初高中心理健康教育教学活动安排&#xD;点击数：395&#xD;发表时间：10年10月12日">市属初高中心理健康教育教学活动安排</a>[ 10-12 ]</div>
                        </div>
                    </div>
