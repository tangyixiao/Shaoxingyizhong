...
<head>
    ...
    <title>关于参加绍兴市“品质课堂”深化行动暨“人工智能赋能教学”主题研讨活动的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于参加绍兴市“品质课堂”深化行动暨“人工智能赋能教学”主题研讨活动的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22495"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22495},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22495";
     ...
     <p>        以下教师将参加绍兴市“品质课堂”深化行动暨“人工智能赋能教学”主题研讨活动。本次活动时间为 12 月 18 日（周四）一天，地点为柯桥区华舍小学（柯桥区育才路东门入）。</p><p>        虞金龙、金杰、徐汉奇、俞定、余栋材、孟玲燕、翁天东、<span style="text-wrap-mode: wrap;">马作菁、</span>赵正瑜、冯莹。</p><p>        <span style="color: rgba(0, 0, 0, 0.9); font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, -apple-system, "Segoe UI", Roboto, Ubuntu, Cantarell, "Noto Sans", sans-serif, Arial, "PingFang SC", "Source Han Sans SC", "Microsoft YaHei UI", "Microsoft YaHei", "Noto Sans CJK SC", sans-serif; white-space: pre-wrap; background-color: rgb(255, 255, 255);">请参会老师提前协调好课务，往返途中注意交通安全，准时参会。</span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22484.aspx" target="_self" title="标题：浙江省普通高中命题大赛（初赛）通知&#xD;点击数：214&#xD;发表时间：25年12月15日">浙江省普通高中命题大赛（初赛）通知</a>[ 12-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22588.aspx" target="_self" title="标题：研究院2026年1月份市直活动安排&#xD;点击数：209&#xD;发表时间：25年12月31日">研究院2026年1月份市直活动安排</a>[ 12-31 ]</div>
                        </div>
                    </div>
