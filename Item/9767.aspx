...
<head>
    ...
    <title>关于提交高一“改革开放在身边”实践调研报告的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于提交高一“改革开放在身边”实践调研报告的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9767"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9767},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9767";
     ...
     <P>高一各班：</P>
<P>    “改革开放在身边”寒假社会实践成果提交要求如下：</P>
<P>    以<STRONG>小组</STRONG>为单位，提交调查报告（电子版）至公共文件夹“团委 - 社会实践志愿服务 - 2019寒假社会实践 - 改革开放 - 所有报告”，命名为班级序号+姓名（如101张三）；</P>
<P>    以<STRONG>班级</STRONG>为单位，评选出<STRONG>1篇</STRONG>优秀的调查报告（请班主任、历史任课教师把关），并将电子版上传至公共文件夹“团委 - 社会实践志愿服务 - 2019寒假社会实践 - 改革开放 - 择优报告”，命名为班级序号（如101）。</P>
<P>    截止时间：<FONT color=#ff0000><STRONG>3月2日（周六）</STRONG></FONT>放学前</P>
<P>    校级评选方式：由历史教师担任主要评委（高一担任班主任的历史教师回避），评选出校级优秀调查报告。<BR></P>
<P align=right>德育处 团委 历史组<BR>2019年2月21日</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9738.aspx" target="_self" title="标题：活动提醒：北外、上外宣讲&#xD;点击数：196&#xD;发表时间：19年01月28日">活动提醒：北外、上外宣讲</a>[ 01-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9768.aspx" target="_self" title="标题：关于公开遴选第三届“学生校长助理”的通知&#xD;点击数：2248&#xD;发表时间：19年02月21日">关于公开遴选第三届“学生校长助理”的通知</a>[ 02-21 ]</div>
                        </div>
                    </div>
