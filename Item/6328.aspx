...
<head>
    ...
    <title>高三培优课结束通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6328"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6328},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6328";
     ...
     本学期高三培优班课程全部结束，请相关学生互相告知。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6326.aspx" target="_self" title="标题：高三部分教师会议通知&#xD;点击数：283&#xD;发表时间：17年01月13日">高三部分教师会议通知</a>[ 01-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6340.aspx" target="_self" title="标题：高一期末市属统一阅卷安排&#xD;点击数：346&#xD;发表时间：17年01月16日">高一期末市属统一阅卷安排</a>[ 01-16 ]</div>
                        </div>
                    </div>
