...
<head>
    ...
    <title>高一回头考监考安排（8月31日）--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一回头考监考安排（8月31日）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=159"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:159},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=159";
     ...
     <TABLE style="WIDTH: 327pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=435 border=0 x:str>
<COLGROUP>
...
<COL style
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/158.aspx" target="_self" title="标题：备课纸领取通知&#xD;点击数：538&#xD;发表时间：09年09月07日">备课纸领取通知</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/160.aspx" target="_self" title="标题：高二回头考监考安排（8月31日）&#xD;点击数：566&#xD;发表时间：09年08月28日">高二回头考监考安排（8月31日）</a>[ 08-28 ]</div>
                        </div>
                    </div>
