...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5739"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5739},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5739";
     ...
     <P>因天雨地湿，今日大课间操暂停。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5738.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：71&#xD;发表时间：16年10月20日">表扬与失物招领</a>[ 10-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5740.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：106&#xD;发表时间：16年10月21日">表扬与失物招领</a>[ 10-21 ]</div>
                        </div>
                    </div>
