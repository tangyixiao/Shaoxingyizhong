...
<head>
    ...
    <title>高二党支部会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2557"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2557},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2557";
     ...
     <P>                                     高二党支部会议通知</P>
<P>      高二支部党员：</P>
<P>      定于今天（星期二）下午第四节课在行政三楼会议室召开支部会议，希望党员同志安排好工作，准时出席。</P>
<P>                                                                              9.28</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2553.aspx" target="_self" title="标题：高一高二提前上课通知&#xD;点击数：620&#xD;发表时间：10年09月27日">高一高二提前上课通知</a>[ 09-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2560.aspx" target="_self" title="标题：关于高一高二校本课程报名的通知&#xD;点击数：709&#xD;发表时间：10年09月28日">关于高一高二校本课程报名的通知</a>[ 09-28 ]</div>
                        </div>
                    </div>
