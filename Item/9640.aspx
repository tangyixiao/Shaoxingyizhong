...
<head>
    ...
    <title>地下车库出口施工通知--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9640"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9640},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9640";
     ...
     <P>各位教工：</P>
<P>     地下车库出口处因为施工需要，所有车辆暂时禁止通行，相关教工的车辆请从入口处驶出，望相关老师谨慎驾驶，注意安全！感谢各位教工的理解与支持！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9620.aspx" target="_self" title="标题：关于禁止使用大功率电器的通知&#xD;点击数：1541&#xD;发表时间：19年01月03日">关于禁止使用大功率电器的通知</a>[ 01-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9661.aspx" target="_self" title="标题：关于组织开展&amp;nbsp;“平安寒假”安全教育专项活动的通知&#xD;点击数：597&#xD;发表时间：19年01月15日">关于组织开展 “平安寒假”安全教育专项活动的通知</a>[ 01-15 ]</div>
                        </div>
                    </div>
