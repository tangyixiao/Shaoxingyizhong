...
<head>
    ...
    <title>武汉学生来绍聚首缅怀一中毕业生杭州悼恩师--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">武汉学生来绍聚首缅怀一中毕业生杭州悼恩师</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=577"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:577},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=577";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/576.aspx" target="_self" title="标题：国税教育基地设到绍兴一中&#xD;点击数：407&#xD;发表时间：09年11月13日">国税教育基地设到绍兴一中</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/578.aspx" target="_self" title="标题：绍兴高三学生唐文斌闯入世界顶级编程决赛&#xD;点击数：392&#xD;发表时间：09年11月13日">绍兴高三学生唐文斌闯入世界顶级编程决赛</a>[ 11-13 ]</div>
                        </div>
                    </div>
