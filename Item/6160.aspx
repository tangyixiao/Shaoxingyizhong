...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6160"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6160},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6160";
     ...
     高一（14）班姚嘉程捡到饭卡一张，特此表扬，并望失主及时到德育处认领。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6158.aspx" target="_self" title="标题：寻物启事&#xD;点击数：58&#xD;发表时间：16年12月19日">寻物启事</a>[ 12-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6164.aspx" target="_self" title="标题：大课间操暂停通知&#xD;点击数：54&#xD;发表时间：16年12月20日">大课间操暂停通知</a>[ 12-20 ]</div>
                        </div>
                    </div>
