...
<head>
    ...
    <title>关于召开班主任会议的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于召开班主任会议的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2346"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2346},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2346";
     ...
     <P>各位班主任:</P>
<P>       定于9月3日(周五)下午第四节课在学校行政楼五楼会议室召开班主任会议,请全体班主任准时出席!</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2340.aspx" target="_self" title="标题：关于教工捐款的通知&#xD;点击数：779&#xD;发表时间：10年09月02日">关于教工捐款的通知</a>[ 09-02 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2351.aspx" target="_self" title="标题：关于核对身份证号码通知&#xD;点击数：802&#xD;发表时间：10年09月03日">关于核对身份证号码通知</a>[ 09-03 ]</div>
                        </div>
                    </div>
