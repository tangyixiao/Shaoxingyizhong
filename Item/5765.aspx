...
<head>
    ...
    <title>关于组织参加中小学生“爱我绍兴、共建水城”漫画、微视频评选活动的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于组织参加中小学生“爱我绍兴、共建水城”漫画、微视频评选活动的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5765"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5765},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5765";
     ...
     <P>时    间：2016年11月—11月30日<BR>参与单位：各区、县（市）宣传（文明）、教育部门<BR>主要内容：中小学生在家长或教师指导下，围绕“爱我绍兴、共建水城”主题，用漫画(A3纸大小)、微视频（大小不超过10M）等形式，演绎爱家爱乡、爱水护水、重礼仪、讲文明等元素，相关作品在市级教育类媒体（网站）刊登；引导学生发挥创意才能，角色扮演卡通人物、自编才艺节目，参与市区综合类文化活动，增强校园行主题活动的贴近性、互动性。</P>
<P>    请有专长的同学踊跃参加，完成后把视频和漫画作品上交到对外交流中心—舒凤老师处。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5764.aspx" target="_self" title="标题：运动会组委会、裁判员、工作人员名单&#xD;点击数：458&#xD;发表时间：16年10月24日">运动会组委会、裁判员、工作人员名单</a>[ 10-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5769.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：32&#xD;发表时间：16年10月24日">表扬与失物招领</a>[ 10-24 ]</div>
                        </div>
                    </div>
