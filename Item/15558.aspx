...
<head>
    ...
    <title>高一年级期中成绩分析会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一年级期中成绩分析会通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15558"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15558},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15558";
     ...
     <p>兹定于今天下午第四节课召开高一年级期中成绩分析会，会议地点在树兰楼三楼会议室二，请高一高考科目教师准时参加。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15541.aspx" target="_self" title="标题：市直中学生田径运动会训练通知&#xD;点击数：263&#xD;发表时间：22年05月07日">市直中学生田径运动会训练通知</a>[ 05-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15561.aspx" target="_self" title="标题：英语教研活动通知&#xD;点击数：301&#xD;发表时间：22年05月10日">英语教研活动通知</a>[ 05-10 ]</div>
                        </div>
                    </div>
