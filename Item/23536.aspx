...
<head>
    ...
    <title>关于2026学年第一学期师训平台选课开始的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于2026学年第一学期师训平台选课开始的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Common/GetHits.aspx?id=23536"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:23536},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=23536";
     ...
     <p><span style="font-family: 宋体;font-size: 16px">各位老师：</span></p><p style="text-indent:32px"><span style="font-family: 宋体;font-size: 16px">2026下半年教师第一轮选课时间为<span style="font-family: 宋体; font-size: 16px; color: rgb(255, 0, 0);">8月21日-8月29日</span>，请大家于<span style="font-family: 宋体; font-size: 16px; color: rgb(255, 0, 0);">8月29日前</span>完成选课（第一轮不选以后没机会再选课）。有几个事项提醒一下：</span></p><p><strong><span style="font-family: 微软雅黑;color: rgb(51, 51, 51);letter-spacing: 0;font-size: 16px;background: rgb(255, 255, 255)"><span style="font-family:微软雅黑">1. 选课科目</span></span></strong><span style="font-family: 宋体;font-size: 16px">：</span></p><p style="text-indent: 32px"><span style="font-family: 宋体;font-size: 16px">①学科类培训16学时，选教师自己的任教学科(见下图)；</span></p><p style="text-indent: 32px"><span style="font-family: 宋体;font-size: 16px">②本学期90学时培训科目有：音乐、美术、综合实践、体育、信息技术、通用技术(见下图)</span></p><p><strong><span style="font-family: 微软雅黑;color: rgb(51, 51, 51);letter-spacing: 0;font-size: 16px;background: rgb(255, 255, 255)">2. </span></strong><strong><span style="font-family: 微软雅黑;color: rgb(51, 51, 51);letter-spacing: 0;font-size: 16px;background: rgb(255, 255, 255)"><span style="font-family:微软雅黑">选课注意事项</span></span></strong></p><p style="text-indent: 32px"><span style=";font-family:宋体;color:rgb(255,0,0);font-size:16px">请注意培训层次匹配度尽量做到无误差</span><span style="font-family: 宋体;font-size: 16px">(见下图)，以免培训机构审核不通过(若学科没有初级班，初级层次老师报中级班</span><span style="font-family: 宋体; font-size: 16px; color: rgb(0, 0, 0);">，</span><span style=";font-family:宋体;color:rgb(255,0,0);font-size:16px">某些学科若只开设一个班级则忽略</span><span style="font-family: 宋体;font-size: 16px">)</span></p><p style="text-indent:32px;text-align:center"><img src="/UploadFiles/xwzx/2026/8/202608211445169953.jpg" style="max-width: 100%; " title="202608211445169953.jpg" /><span style="font-family: 宋体;font-size: 16px"> </span></p><p style="margin: 0 0 20px;text-indent: 0;padding: 0;background: rgb(255, 255, 255)"><strong><span style="font-family: 微软雅黑;color: rgb(51, 51, 51);letter-spacing: 0;font-size: 16px">3. 师训平台选课具体操作</span></strong></p><p style="margin-top:0;margin-right:0;margin-bottom:20px;margin-left:0;padding:0 0 0 0 "><span style="font-family: 宋体;font-size: 16px">（1</span><span style="font-family: 宋体;font-size: 16px">）登录省师训管理平台（ http://pxglpt.zjedu.gov.cn ）。忘记密码的老师请通过“忘记密码”功能找回。还可以使用钉钉扫码登陆（钉钉的手机号码需要与师评平台的手机号码一致才行）。登录后，进入“自主选课——自主选课报名”页面 。</span></p><p style="margin-top:0;margin-right:0;margin-bottom:20px;margin-left:0;padding:0 0 0 0 "><span style="font-family: 宋体;font-size: 16px">（2）选课：以学科类主题研修培训为例。点击更多培训筛选，住宿选否，面向学段选高中，培训学科选所在学科（默认），培训机构选013绍兴市教研院，点击查询，即出现班级列表。请选择对应16学分项目，务必做好培训层次匹配度审核。操作范例如下：</span></p><p style="text-align:center"><img src="/UploadFiles/xwzx/2026/8/202608211446282145.png" style="max-width: 100%; " title="202608211446282145.png" /></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Item/23533.aspx" target="_self" title="标题：关于2026年“名师激励”先进荣誉激励人员名单及所获荣誉公示&#xD;点击数：98&#xD;发表时间：26年08月20日">关于2026年“名师激励”先进荣誉激励人员名单及所获荣誉公示</a>[ 08-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Item/23539.aspx" target="_self" title="标题：关于举办2026年下半年浙江省中小学心理健康教育教师上岗资格证书续期培训班的通知&#xD;点击数：97&#xD;发表时间：26年08月21日">关于举办2026年下半年浙江省中小学心理健康教育教师上岗资格证…</a>[ 08-21 ]</div>
                        </div>
                    </div>
