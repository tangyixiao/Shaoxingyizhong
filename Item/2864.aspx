...
<head>
    ...
    <title>校本课程上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2864"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2864},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2864";
     ...
     <P>高一、高二学生：</P>
<P>今天下午高一、高二的校本课程继续按原来时间和地点上课。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2863.aspx" target="_self" title="标题：高三学生通知&#xD;点击数：519&#xD;发表时间：10年11月16日">高三学生通知</a>[ 11-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2865.aspx" target="_self" title="标题：绍兴市高中政治优质课上课、调课安排&#xD;点击数：727&#xD;发表时间：10年11月16日">绍兴市高中政治优质课上课、调课安排</a>[ 11-16 ]</div>
                        </div>
                    </div>
