...
<head>
    ...
    <title>关于今晚高三英语高考听力模拟测试的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于今晚高三英语高考听力模拟测试的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=233"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:233},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=233";
     ...
     <DIV>   <FONT size=4> 今晚6：00—6：30分，高三晚自修同学将举行英语高考听力模拟测试。考试实行一人一桌，各班学号为偶数的同学，到高二年级对应班级教室参加考试，学号为奇数的同学在自己教室考试。在高三同学考试期间，高二同学可以暂时在宿舍或食堂自学。高三今晚管理晚自修的老师，辛苦你们帮助监考。谢谢了！</FONT></DIV>
<DIV><FONT size=4>       &nbsp
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/226.aspx" target="_self" title="标题：增加体育老师到高级中学监考&#xD;点击数：441&#xD;发表时间：09年09月08日">增加体育老师到高级中学监考</a>[ 09-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/237.aspx" target="_self" title="标题：关于召开“师徒结对”座谈会的通知&#xD;点击数：540&#xD;发表时间：09年09月10日">关于召开“师徒结对”座谈会的通知</a>[ 09-10 ]</div>
                        </div>
                    </div>
