...
<head>
    ...
    <title>高二部分化学走班课改自修通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二部分化学走班课改自修通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7626"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7626},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7626";
     ...
     <FONT size=4>因何凯老师外出培训，周三（明天）下午何凯老师化学走班课（化学走班3包括4、6、7、14班）改到周四下午第9课上课，请相关学生在上课教室自修。<BR></FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7625.aspx" target="_self" title="标题：11.14早学早读抽检情况&#xD;点击数：239&#xD;发表时间：17年11月14日">11.14早学早读抽检情况</a>[ 11-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7628.aspx" target="_self" title="标题：高三部分课程改自修通知&#xD;点击数：214&#xD;发表时间：17年11月15日">高三部分课程改自修通知</a>[ 11-15 ]</div>
                        </div>
                    </div>
