...
<head>
    ...
    <title>关于高二年级部分学生政治模块考试补考的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高二年级部分学生政治模块考试补考的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1917"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1917},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1917";
     ...
     <P><FONT size=5><STRONG>本学期高二年级政治期中考试为模块考试，成绩在58分以下的同学（包括缺考）需要补考及格后，才能获得相应模块的学分。请需要补考的同学，在本周五中午12：40到一楼餐厅参加补考，考试时间45分钟。</STRONG></FONT></P>
<P><FONT size=5><STRONG>附：需要补考学生<A title=名单 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201005/2010052018275135.xls">名单</A></STRONG></FONT></P>
<P><STRONG><FONT size=5>                                      教学处</FONT></STRONG></P>
<P><STRONG><FONT size=5>                                       5.20</FONT></STRONG></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1916.aspx" target="_self" title="标题：高三班主任：转发省考试院通知（急）&#xD;点击数：551&#xD;发表时间：10年05月20日">高三班主任：转发省考试院通知（急）</a>[ 05-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1918.aspx" target="_self" title="标题：5.24—5.31学科主题研修活动通知&#xD;点击数：419&#xD;发表时间：10年05月21日">5.24—5.31学科主题研修活动通知</a>[ 05-21 ]</div>
                        </div>
                    </div>
