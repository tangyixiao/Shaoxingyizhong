...
<head>
    ...
    <title>高一、高二学习委员会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二学习委员会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9298"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9298},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9298";
     ...
     <FONT size=4>请高一、高二年级各班学习委员于今天中午12:40在4106阶梯教室开会。请互相通知，准时与会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9297.aspx" target="_self" title="标题：历史教研活动通知&#xD;点击数：219&#xD;发表时间：18年11月06日">历史教研活动通知</a>[ 11-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9299.aspx" target="_self" title="标题：信息技术教研活动通知&#xD;点击数：257&#xD;发表时间：18年11月07日">信息技术教研活动通知</a>[ 11-07 ]</div>
                        </div>
                    </div>
