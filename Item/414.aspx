...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">值周提示</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年10月17日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=414"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:414},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=414";
     ...
     <DIV>本周值周，着重地说几点需要我们管理者(班主任、值班、值周老师等)去引导的事：</DIV>
<DIV>1、  学生在网上购物，容易引发问题，劝少购最好不去购为好。</DIV>
<DIV>2、  高一、高二夜自修纪律，讲话声多，往往出现在每一节晚自修的开始，管理者如迅速去转一圈，这个不良现象就很快得到改正了。</DIV>
<DIV>3、  住校生，在夜自修结束后去操场打蓝球、跑步，有的学生在晚10：25都还在进行，女生也有。天黑了，视线不好，运动容易发生想不到的事。</
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/405.aspx" target="_self" title="标题：转发：高级教师申报对象进行课堂教学能力考核的预备通知&#xD;点击数：528&#xD;发表时间：09年10月14日">转发：高级教师申报对象进行课堂教学能力考核的预备通知</a>[ 10-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/418.aspx" target="_self" title="标题：教工会议通知&#xD;点击数：540&#xD;发表时间：09年10月19日">教工会议通知</a>[ 10-19 ]</div>
                        </div>
                    </div>
