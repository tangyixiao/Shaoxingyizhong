...
<head>
    ...
    <title>重发关于高一高二学生信息录入的通知（急）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">重发关于高一高二学生信息录入的通知（急）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=286"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:286},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=286";
      ...
      由于学校工作需要，请高一高二各班主任尽快通知学生按要求录入信息，在本周三前以班级为文件名把学生信息上传至“公共文件夹”——“德育处”——“学生信息录入”文件夹。 
<DIV>要求：</DIV>
...
<DIV>   3． 
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/277.aspx" target="_self" title="标题：关于学生办理爱国主义教育卡的通知&#xD;点击数：529&#xD;发表时间：09年09月15日">关于学生办理爱国主义教育卡的通知</a>[ 09-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/289.aspx" target="_self" title="标题：中华赞诗词赋征文比赛优秀组织奖名单&#xD;点击数：481&#xD;发表时间：09年09月16日">中华赞诗词赋征文比赛优秀组织奖名单</a>[ 09-16 ]</div>
                        </div>
                    </div>
