...
<head>
    ...
    <title>高三会考监考老师今天下午3：00参加考务培训--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三会考监考老师今天下午3：00参加考务培训</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2037"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2037},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2037";
     ...
     因高三教师明天外出，会考考务培训提前到今天下午3：00-3：30进行，望相互告知。其他人员的会考考务培训仍然在明天下午进行。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2036.aspx" target="_self" title="标题：会考组织机构和试场分布&#xD;点击数：434&#xD;发表时间：10年06月12日">会考组织机构和试场分布</a>[ 06-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2038.aspx" target="_self" title="标题：高二、高一会考试场编排&#xD;点击数：707&#xD;发表时间：10年06月12日">高二、高一会考试场编排</a>[ 06-12 ]</div>
                        </div>
                    </div>
