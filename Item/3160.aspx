...
<head>
    ...
    <title>高三各备课组长--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3160"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3160},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3160";
     ...
     <P>1、在高三五校联考中，IB试题各备课组都有漏改，请各备课组派一人在下午3:30前到教学处检查、批改。</P>
<P>2、各科必须在下午3:30分前，将成绩录入系统中，明天到嘉兴一中交流要用。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3155.aspx" target="_self" title="标题：音乐课改自修&#xD;点击数：448&#xD;发表时间：10年12月28日">音乐课改自修</a>[ 12-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3161.aspx" target="_self" title="标题：体育等有关课程本学期上课结束的通知&#xD;点击数：650&#xD;发表时间：10年12月28日">体育等有关课程本学期上课结束的通知</a>[ 12-28 ]</div>
                        </div>
                    </div>
