...
<head>
    ...
    <title>高三1B现代诗歌考试时间、地点变动--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三1B现代诗歌考试时间、地点变动</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=155"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:155},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=155";
     ...
     <DIV>监考表中的高三1B现代诗歌考试时间改为第五节课、地点改在高二（3）教室</DIV>
<DIV> </DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/154.aspx" target="_self" title="标题：高三生物课改自修&#xD;点击数：584&#xD;发表时间：09年08月27日">高三生物课改自修</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/156.aspx" target="_self" title="标题：各竞赛指导老师&#xD;点击数：558&#xD;发表时间：09年08月27日">各竞赛指导老师</a>[ 08-27 ]</div>
                        </div>
                    </div>
