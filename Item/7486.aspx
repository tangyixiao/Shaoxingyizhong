...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7486"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7486},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7486";
     ...
     <P>高三（2）姜浥晗同学今天捡到人民币若干，特此表扬，请失主及时来德育团委办公室（2114）认领。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7478.aspx" target="_self" title="标题：上周值周小结&#xD;点击数：197&#xD;发表时间：17年10月19日">上周值周小结</a>[ 10-19 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7509.aspx" target="_self" title="标题：上周值周小结&#xD;点击数：175&#xD;发表时间：17年10月23日">上周值周小结</a>[ 10-23 ]</div>
                        </div>
                    </div>
