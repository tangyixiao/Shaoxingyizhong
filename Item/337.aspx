...
<head>
    ...
    <title>高三国庆后阶段性测试监考安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三国庆后阶段性测试监考安排</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=337"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:337},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=337";
     ...
     <TABLE style="WIDTH: 467pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=623 border=0 x:str>
<COLGROUP>
...
<COL style="WIDTH: 51pt; mso-width-source: userset;
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/335.aspx" target="_self" title="标题：关于高一、高二校本课程选报的通知&#xD;点击数：296&#xD;发表时间：09年09月28日">关于高一、高二校本课程选报的通知</a>[ 09-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/342.aspx" target="_self" title="标题：通知二则&#xD;点击数：412&#xD;发表时间：09年09月28日">通知二则</a>[ 09-28 ]</div>
                        </div>
                    </div>
