...
<head>
    ...
    <title>关于教师参加心理健康教育自考报考、领证的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于教师参加心理健康教育自考报考、领证的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年08月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=162"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:162},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=162";
     ...
     <DIV>
<DIV>各市属学校、越城区属学校：</DIV>
<DIV>现将教师参加心理健康教育自考报考、领证的有关事项通知如下，请即转告老师：</DIV>
<DIV align=left>1、2009年7月考试成绩于9月1—5日发放，列入后附名单的老师请凭准考证前来领取。</DIV>
<DIV align=left>2、已通过两门课程且办理了手续的老师，请于上述时间来我办领取心理健康教育基础知识培训考试合格证书。（名单附后）</DIV>
<DIV align=left>3、2010年4月自考报名时间为9
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/157.aspx" target="_self" title="标题：学校H1N1预防工作分工与措施要求&#xD;点击数：703&#xD;发表时间：09年08月27日">学校H1N1预防工作分工与措施要求</a>[ 08-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/164.aspx" target="_self" title="标题：通知&#xD;点击数：607&#xD;发表时间：09年08月28日">通知</a>[ 08-28 ]</div>
                        </div>
                    </div>
