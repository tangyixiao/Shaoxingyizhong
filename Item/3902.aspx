...
<head>
    ...
    <title>文明城市检查材料准备--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">文明城市检查材料准备</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>文明城市检查材料准备</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年05月09日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3902"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3902},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3902";
     ...
     <P>1、请各备课组长准备：本学年本学科教案一份，要体现情感、态度、价值观。</P>
<P>2、请地方性课程、校本课程相关老师准备本学年教案。</P>
<P>请以上相关老师今天下午放学前将教案上交教学处。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3890.aspx" target="_self" title="标题：高三班主任：请通知高校自主选拔合格、艺术特长生测试合格的学生&#xD;点击数：578&#xD;发表时间：11年05月06日">高三班主任：请通知高校自主选拔合格、艺术特长生测试合格的学生</a>[ 05-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3904.aspx" target="_self" title="标题：高三五校联考分析会议&#xD;点击数：460&#xD;发表时间：11年05月09日">高三五校联考分析会议</a>[ 05-09 ]</div>
                        </div>
                    </div>
