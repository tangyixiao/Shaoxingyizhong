...
<head>
    ...
    <title>运动会期间高三安排--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5794"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5794},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5794";
     ...
     本周四、周五运动会，高三没有运动项目的学生在教室自修，任课老师按课表下班管理、辅导。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5790.aspx" target="_self" title="标题：成人高考考务培训通知&#xD;点击数：194&#xD;发表时间：16年10月26日">成人高考考务培训通知</a>[ 10-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5808.aspx" target="_self" title="标题：10月28日（周五）“成人高考”试场布置要求&#xD;点击数：353&#xD;发表时间：16年10月28日">10月28日（周五）“成人高考”试场布置要求</a>[ 10-28 ]</div>
                        </div>
                    </div>
