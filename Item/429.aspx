...
<head>
    ...
    <title>关于10月21日下午上课时间改动的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于10月21日下午上课时间改动的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=429"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:429},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=429";
     ...
     <P><FONT size=3>10月21日（星期三）下午高一、高二要举行大合唱比赛，故明天下午高一、高二下午第一节课提前至12：45上课（有铃声），高三年级按原时间上课。希望班主任通知到本班学生。</FONT></P>
<P><FONT size=3>                     &n
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/415.aspx" target="_self" title="标题：关于运动会入场式彩排时间的通知(有变动）&#xD;点击数：396&#xD;发表时间：09年10月17日">关于运动会入场式彩排时间的通知(有变动）</a>[ 10-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/430.aspx" target="_self" title="标题：关于2010年报刊征订工作的通知&#xD;点击数：373&#xD;发表时间：09年10月20日">关于2010年报刊征订工作的通知</a>[ 10-20 ]</div>
                        </div>
                    </div>
