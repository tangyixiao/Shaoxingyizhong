...
<head>
    ...
    <title>大课间出操通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13921"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13921},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13921";
     ...
     <p>      篮球场施工完成，今天开始分年段大课间出操，周四（9月16日）为高一年级，周五（9月17日）为高二年级，周六（9月18日）为高三年级。请高二、高三各班体育委员（1人）今天中午12：20到教学楼2112教室开会。</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13918.aspx" target="_self" title="标题：9.14班级一日考核&#xD;点击数：134&#xD;发表时间：21年09月17日">9.14班级一日考核</a>[ 09-17 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13925.aspx" target="_self" title="标题：9.15班级一日考核&#xD;点击数：104&#xD;发表时间：21年09月17日">9.15班级一日考核</a>[ 09-17 ]</div>
                        </div>
                    </div>
