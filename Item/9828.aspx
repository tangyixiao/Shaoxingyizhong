...
<head>
    ...
    <title>本学期学科组长备课组长会议通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">本学期学科组长备课组长会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9828"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9828},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9828";
     ...
     <P> </P>
<P>各学科组长备课组长：</P>
<P>现定于明天（3月7日）下午第三节课在行政楼会议室二召开本学期学科组备课组工作会议，请各位组长准时出席</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9825.aspx" target="_self" title="标题：师训平台二轮补报的通知&#xD;点击数：323&#xD;发表时间：19年03月06日">师训平台二轮补报的通知</a>[ 03-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9840.aspx" target="_self" title="标题：关于普通话水平测试的通知&#xD;点击数：392&#xD;发表时间：19年03月11日">关于普通话水平测试的通知</a>[ 03-11 ]</div>
                        </div>
                    </div>
