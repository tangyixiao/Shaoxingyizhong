...
<head>
    ...
    <title>天气转好长跑比赛举行的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">天气转好长跑比赛举行的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1178"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1178},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1178";
     ...
     <P>      （长跑比赛延期举行，待另行通知。）</P>
<P>因天气转好，现在场地已可使用，下午还继续进行。（12：42发）</P>
<P> </P>
<P> </P>
<P> </P>
<P> </P>
...
<P>9</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1173.aspx" target="_self" title="标题：我校食堂被评为市直学校食堂食品卫生A级单位&#xD;点击数：703&#xD;发表时间：10年01月05日">我校食堂被评为市直学校食堂食品卫生A级单位</a>[ 01-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1183.aspx" target="_self" title="标题：喜报&#xD;点击数：1078&#xD;发表时间：10年01月07日">喜报</a>[ 01-07 ]</div>
                        </div>
                    </div>
