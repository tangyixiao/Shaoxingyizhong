...
<head>
    ...
    <title>一周检查情况公布--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=172"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:172},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=172";
...
<TD class=xl27 style="BORDER-RIGHT: windowtext
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/170.aspx" target="_self" title="标题：2009学年第一学期开学典礼&#xD;点击数：561&#xD;发表时间：09年08月31日">2009学年第一学期开学典礼</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/181.aspx" target="_self" title="标题：高二年级班长会议&#xD;点击数：564&#xD;发表时间：09年09月01日">高二年级班长会议</a>[ 09-01 ]</div>
                        </div>
                    </div>
