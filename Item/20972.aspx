...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20972"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20972},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20972";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/3/202503040921057835.png" style="max-width: 100%; " title="202503040921057835.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20970.aspx" target="_self" title="标题：失物招领（手链）&#xD;点击数：62&#xD;发表时间：25年02月25日">失物招领（手链）</a>[ 02-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20978.aspx" target="_self" title="标题：关于开展学生仪容仪表自查、检查的通知&#xD;点击数：152&#xD;发表时间：25年02月26日">关于开展学生仪容仪表自查、检查的通知</a>[ 02-26 ]</div>
                        </div>
                    </div>
