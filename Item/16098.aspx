...
<head>
    ...
    <title>第二周主要工作安排表（9.5-9.11）--工作安排-绍兴市第一中学</title>
...
<li class="li5 last"><a href="/Shaoxingyizhong/Category_24/Index.aspx">校务公开</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16098"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16098},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16098";
     ...
     <p style="font-family: Calibri;font-size: 18pt;line-height: 108%;margin-bottom: .001pt;margin-left: 0;margin-right: 0;margin-top: 0;text-align: center;">
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15737.aspx" target="_self" title="标题：第十六周主要工作安排表（5.30-6.5）&#xD;点击数：40&#xD;发表时间：22年05月30日">第十六周主要工作安排表（5.30-6.5）</a>[ 05-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16154.aspx" target="_self" title="标题：第三周主要工作安排表（9.12-9.18）&#xD;点击数：13&#xD;发表时间：22年09月15日">第三周主要工作安排表（9.12-9.18）</a>[ 09-15 ]</div>
                        </div>
                    </div>
