...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=19683"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:19683},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=19683";
     ...
     <p><span style="font-size: 18px;">明天（周二）地理组全组教师参加继续教育培训，地理课改自习。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/19682.aspx" target="_self" title="标题：通用技术教研活动通知&#xD;点击数：125&#xD;发表时间：24年04月22日">通用技术教研活动通知</a>[ 04-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/19699.aspx" target="_self" title="标题：关于近期教学调整安排的通知&#xD;点击数：454&#xD;发表时间：24年04月23日">关于近期教学调整安排的通知</a>[ 04-23 ]</div>
                        </div>
                    </div>
