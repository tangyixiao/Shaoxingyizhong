...
<head>
    ...
    <title>清华紫光自主招生、三位一体面试课程缴费通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">清华紫光自主招生、三位一体面试课程缴费通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7936"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7936},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7936";
     ...
     <FONT size=4>报名参加清华紫光自主招生、三位一体面试课程的学生，若还未在网上缴费，清华紫光培训机构将于明天中午到建功楼2108教室现场收费。请参加的同学互相转告。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7933.aspx" target="_self" title="标题：关于催还高二高三学生老校区所借图书的通知&#xD;点击数：379&#xD;发表时间：18年01月09日">关于催还高二高三学生老校区所借图书的通知</a>[ 01-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7947.aspx" target="_self" title="标题：下周高一17/18班月考考场及监考安排&#xD;点击数：361&#xD;发表时间：18年01月12日">下周高一17/18班月考考场及监考安排</a>[ 01-12 ]</div>
                        </div>
                    </div>
