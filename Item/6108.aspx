...
<head>
    ...
    <title>关于11月黑板报检查的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于11月黑板报检查的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6108"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6108},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6108";
     ...
     <P>12月15日（本周四）中午将进行黑板报检查。请高一（1）——（8）班宣传委员及高一、高二宣传部干事于中午12点35分在风雨走廊集合。</P>
<P align=right>宣传部</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6106.aspx" target="_self" title="标题：关于本周三举办“冬日暖阳”义卖活动的通知&#xD;点击数：1174&#xD;发表时间：16年12月12日">关于本周三举办“冬日暖阳”义卖活动的通知</a>[ 12-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6117.aspx" target="_self" title="标题：高一志愿者开会的通知&#xD;点击数：160&#xD;发表时间：16年12月13日">高一志愿者开会的通知</a>[ 12-13 ]</div>
                        </div>
                    </div>
