...
<head>
    ...
    <title>渊泉文学社采风活动--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">渊泉文学社采风活动</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>渊泉文学社采风活动</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2011年02月23日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3365"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3365},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3365";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; LAYOUT-GRID-MODE: char"><SPAN lang=EN-US style="FONT-SIZE: 22pt; FONT-FAMILY: 仿宋_GB2312"><STRONG> </STRONG><FONT size=3><STRONG>   </STRONG></P>
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; LAYOUT-GRID-MODE: char; TEXT-INDENT: 24pt; LINE-HEIGHT: 150%; mso-char-indent-count: 2.0"><SPAN lang=EN-US style="FONT-SIZE: 12pt; LINE-HEIGHT: 150%; FONT-FAMILY: 宋体; mso-bidi-font-weight: bold">2011</SPAN><SPAN style="FONT-SIZE: 12pt; LINE-HEIGHT: 150%; FONT-FAMILY: 宋体; mso-bidi-font-weight: bold">年<SPAN lang=EN-US>2</SPAN>月<SPAN lang=EN-US>20</SPAN>日渊泉文学社现代主义文学、日本文学研究小组在城西草莓园开展采风活动。在这春寒料峭的日子里，我们在品尝草莓、观赏着田村风光的同时，以文会友，对文学进行了深入的探讨。本次活动同学们通过户外的采风，陶冶情操，同时增进了社员之间的彼此交流，增强了文学社内部的凝聚力。<SPAN lang=EN-US> <?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></SPAN></P>
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; LAYOUT-GRID-MODE: char"></FONT></SPAN><B><SPAN lang=EN-US style="FONT-SIZE: 15pt; mso-ascii-font-family: 仿宋_GB2312; mso-fareast-font-family: 仿宋_GB2312"><A href="/Shaoxingyizhong/UploadFiles/UploadFiles_9649/201102/2011022316575552.jpg" target=_blank><IMG onmousewheel="return bbimg(this)" style="WIDTH: 527px; HEIGHT: 413px" height=2523 src="/Shaoxingyizhong/UploadFiles/UploadFiles_9649/201102/2011022316575552.jpg" width=3497 onload=resizepic(this) border=0> </A></SPAN></B><B><SPAN lang=EN-US style="FONT-SIZE: 15pt; FONT-FAMILY: 仿宋_GB2312"><o:p></o:p></SPAN></B></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2921.aspx" target="_self" title="标题：丹青迎国庆&#xD;点击数：1735&#xD;发表时间：10年11月25日">丹青迎国庆</a>[ 11-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3510.aspx" target="_self" title="标题：绿色联盟植树节活动纪实&#xD;点击数：2972&#xD;发表时间：11年03月14日">绿色联盟植树节活动纪实</a>[ 03-14 ]</div>
                        </div>
                    </div>
