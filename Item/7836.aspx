...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7836"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7836},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7836";
     ...
     <P>高一年段各班请注意，周三（今天）下午第四节劳动课大扫除照常进行，值周班于下课前10分钟即时检查，请大家按要求打扫。</P>
<CENTER></CENTER>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7831.aspx" target="_self" title="标题：关于开展第二轮“文明寝室”评比的通知&#xD;点击数：675&#xD;发表时间：21年12月06日">关于开展第二轮“文明寝室”评比的通知</a>[ 12-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7838.aspx" target="_self" title="标题：艺术节闭幕式入选节目公告&#xD;点击数：40366&#xD;发表时间：17年12月20日">艺术节闭幕式入选节目公告</a>[ 12-20 ]</div>
                        </div>
                    </div>
