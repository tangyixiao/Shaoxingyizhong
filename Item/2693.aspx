...
<head>
    ...
    <title>运动会评比组成员注意--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">运动会评比组成员注意</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>运动会评比组成员注意</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年10月21日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2693"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2693},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2693";
     ...
     <P> </P>
<P><FONT size=4>请运动会评比组成员随带笔在明天上午7：25以前到主席台进行入场式和广播操评比工作，谢谢！</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2691.aspx" target="_self" title="标题：关于运动会开幕式的通知&#xD;点击数：629&#xD;发表时间：10年10月21日">关于运动会开幕式的通知</a>[ 10-21 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2697.aspx" target="_self" title="标题：9月1日至10月20日各班使用校讯通情况统计：&#xD;点击数：583&#xD;发表时间：10年10月21日">9月1日至10月20日各班使用校讯通情况统计：</a>[ 10-21 ]</div>
                        </div>
                    </div>
