...
<head>
    ...
    <title>关于今天下午定向赛的通知--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于今天下午定向赛的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6918"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6918},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6918";
     ...
     <P>今天下午活动课有高二学生定向赛，社外同学也现场观摩参与，有意向的同学请于活动课上课前在升旗台集合。</P>
<P align=right> 一中定向越野社</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6917.aspx" target="_self" title="标题：寻物启事&#xD;点击数：224&#xD;发表时间：17年05月10日">寻物启事</a>[ 05-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6925.aspx" target="_self" title="标题：关于今天中午鲜花义卖通知&#xD;点击数：372&#xD;发表时间：17年05月12日">关于今天中午鲜花义卖通知</a>[ 05-12 ]</div>
                        </div>
                    </div>
