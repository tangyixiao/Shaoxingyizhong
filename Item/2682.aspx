...
<head>
    ...
    <title>运动会入场式彩排通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">运动会入场式彩排通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span>运动会入场式彩排通知</span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本站原创</span> <span>作者：佚名</span> <span>发布时间：2010年10月20日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2682"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2682},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2682";
     ...
     <P> </P>
<P><FONT size=4>   各班主任、年级长：</FONT></P>
<P><FONT size=4>        今天下午第三节课为高一年级彩排时间，下午第四节课全校三个年级一起彩排，望各班主任、年级长组织好学生，准时参加。</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2680.aspx" target="_self" title="标题：值周检查情况汇总（10月19日星期二）&#xD;点击数：320&#xD;发表时间：10年10月20日">值周检查情况汇总（10月19日星期二）</a>[ 10-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2683.aspx" target="_self" title="标题：德育处通知两则&#xD;点击数：595&#xD;发表时间：10年10月20日">德育处通知两则</a>[ 10-20 ]</div>
                        </div>
                    </div>
