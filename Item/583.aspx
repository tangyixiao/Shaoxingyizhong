...
<head>
    ...
    <title>绍兴市高级专家风采⑤陈合力--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_38/Index.aspx" target="_self">媒体一中</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴市高级专家风采⑤陈合力</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=583"></script>
    ...
    $.pe.ajax('admineditcheck',{params:{itemId:583},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
           ...
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/582.aspx" target="_self" title="标题：突出贡献专家受表彰&#xD;点击数：365&#xD;发表时间：09年11月13日">突出贡献专家受表彰</a>[ 11-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/584.aspx" target="_self" title="标题：名师解读省高考《考试说明》&#xD;点击数：361&#xD;发表时间：09年11月13日">名师解读省高考《考试说明》</a>[ 11-13 ]</div>
                        </div>
                    </div>
