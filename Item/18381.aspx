...
<head>
    ...
    <title>校女子篮球队招新--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18381"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18381},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18381";
     ...
     <p><span style="font-size: 18px;">请校女子篮球队及高一女子有意愿参加校篮球队的同学，于本周三下午高二体锻课在体育馆东边二楼形体房集合开会。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18365.aspx" target="_self" title="标题：部分高三任课老师参加网络问卷通知&#xD;点击数：156&#xD;发表时间：23年09月11日">部分高三任课老师参加网络问卷通知</a>[ 09-11 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18386.aspx" target="_self" title="标题：9月高三限时训练安排&#xD;点击数：512&#xD;发表时间：23年09月12日">9月高三限时训练安排</a>[ 09-12 ]</div>
                        </div>
                    </div>
