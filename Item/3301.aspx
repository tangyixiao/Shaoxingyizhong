...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3301"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3301},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3301";
     ...
     <P>全体教工:</P>
<P>       定于1月27日(明天)上午9点钟在行政楼五楼会议室召开教工会议，请全体教工相互转告,准时出席!</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3270.aspx" target="_self" title="标题：关于下雪天的温馨提示&#xD;点击数：1519&#xD;发表时间：11年01月18日">关于下雪天的温馨提示</a>[ 01-18 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3302.aspx" target="_self" title="标题：2011年寒假教师值班安排&#xD;点击数：1154&#xD;发表时间：11年01月26日">2011年寒假教师值班安排</a>[ 01-26 ]</div>
                        </div>
                    </div>
