...
<head>
    ...
    <title>高一晚自修（2.2-2.4）--高一-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_33/Index.aspx" target="_self">高一</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一晚自修（2.2-2.4）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22739"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22739},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22739";
     ...
     <p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2026/1/202601301512456777.png" style="max-width: 100%; " title="202601301512456777.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22623.aspx" target="_self" title="标题：高一晚自修值班（1.11-2.1）&#xD;点击数：139&#xD;发表时间：26年01月09日">高一晚自修值班（1.11-2.1）</a>[ 01-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22794.aspx" target="_self" title="标题：高一晚自修（3.4-3.13）&#xD;点击数：104&#xD;发表时间：26年03月04日">高一晚自修（3.4-3.13）</a>[ 03-04 ]</div>
                        </div>
                    </div>
