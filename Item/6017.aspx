...
<head>
    ...
    <title>晚间安全检查记录(11.25~11.27)--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录(11.25~11.27)</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6017"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6017},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6017";
     ...
     <P>11月25日，高一（16）班灯，前门未关； 团学活动室门未关。</P>
<P>11月27日，图书馆内有数盏灯未关。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6002.aspx" target="_self" title="标题：每日晨检表未交情况通报11.25&#xD;点击数：1047&#xD;发表时间：16年11月25日">每日晨检表未交情况通报11.25</a>[ 11-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6018.aspx" target="_self" title="标题：每日晨检表未交情况通报11.28&#xD;点击数：60&#xD;发表时间：16年11月28日">每日晨检表未交情况通报11.28</a>[ 11-28 ]</div>
                        </div>
                    </div>
