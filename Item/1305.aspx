...
<head>
    ...
    <title>最勤奋的&amp;quot;排球宝贝&amp;quot;--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1305"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1305},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1305";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1296.aspx" target="_self" title="标题：太阳一照,乌蓬就跑&#xD;点击数：614&#xD;发表时间：10年01月27日">太阳一照,乌蓬就跑</a>[ 01-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1306.aspx" target="_self" title="标题：绍兴两留澳学生拍电影家门口取景&#xD;点击数：806&#xD;发表时间：10年01月29日">绍兴两留澳学生拍电影家门口取景</a>[ 01-29 ]</div>
                        </div>
                    </div>
