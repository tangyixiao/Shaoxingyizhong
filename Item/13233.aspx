...
<head>
    ...
    <title>五一期间公交专线运行时间调整通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">五一期间公交专线运行时间调整通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13233"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13233},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13233";
     ...
     <p>根据学校五一节放假安排，公交专线运行时间调整如下：
（1）本周运行到4月23日（周五）早上；
（2）4月25日（周日）——4月30日（周五）早上，正常运行；
（3）5月1日（周六）——2日（周日）停止运行；
（4）5月3日（周一）起恢复正常运行。</p><p>请同学们互相告知。</p><p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13231.aspx" target="_self" title="标题：寻物启事两则&#xD;点击数：179&#xD;发表时间：21年04月22日">寻物启事两则</a>[ 04-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13237.aspx" target="_self" title="标题：4.22大课间跑操考勤情况公示&#xD;点击数：109&#xD;发表时间：21年04月22日">4.22大课间跑操考勤情况公示</a>[ 04-22 ]</div>
                        </div>
                    </div>
