...
<head>
    ...
    <title>通知：社会实践交流评比、团籍档案管理时间地点--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">通知：社会实践交流评比、团籍档案管理时间地点</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=13860"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:13860},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=13860";
     ...
     <p>高一：9月6日（周一）中午12:25-13:40</p><p>高二：9月7日（周二）中午12:25-13:40</p><p>请各班团支书及另两名团干部<strong>带好纸、笔</strong><span style="text-decoration: underline;">提前五分钟</span>至<strong>2112</strong><strong>教室</strong>参会。团支书请按预先通知要求，携带班级<span style="color: rgb(51, 51, 51); font-family: 宋体; text-indent: 32px; background-color: rgb(255, 255, 255);">全体团员的入团志愿书、团员证</span>（高一），以及班级团员名单（高一、高二）至会场。</p><p style="text-align: right;">校团委
2021年9月6日</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/13817.aspx" target="_self" title="标题：关于高一、高二团籍注册和档案整理的通知&#xD;点击数：210&#xD;发表时间：21年08月31日">关于高一、高二团籍注册和档案整理的通知</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/13861.aspx" target="_self" title="标题：团学联后备干部会议通知&#xD;点击数：125&#xD;发表时间：21年09月06日">团学联后备干部会议通知</a>[ 09-06 ]</div>
                        </div>
                    </div>
