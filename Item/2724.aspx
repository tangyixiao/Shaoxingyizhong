...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2724"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2724},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2724";
     ...
     <P>文明办公室检查</P>
<P>    今天下午第四节课进行文明办公室检查,请各年级今天白天值班的老师在下午第四节课到教学处(2)集中.</P>
<P>                    </P>
<P>                                                       文明办公室检查小组</P>
<P>                                                             2010.10.27</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2652.aspx" target="_self" title="标题：文明办公室检查&#xD;点击数：671&#xD;发表时间：10年10月15日">文明办公室检查</a>[ 10-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2743.aspx" target="_self" title="标题：工会通知&#xD;点击数：400&#xD;发表时间：10年10月28日">工会通知</a>[ 10-28 ]</div>
                        </div>
                    </div>
