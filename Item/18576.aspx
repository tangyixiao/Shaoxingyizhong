...
<head>
    ...
    <title>寻物启事(冲锋衣)--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18576"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18576},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18576";
     ...
     <p><span style="color: rgb(51, 51, 51); font-family: "Microsoft YaHei", SimSun, Arial, Helvetica, Tahoma, sans-serif; background-color: rgb(255, 255, 255);">今天（10月10日）上午第四节体育课时，有同学在主席台东面台阶遗失一件蓝色冲锋衣，粘有校牌（学号是20221444），口袋中有一张套有粉色硅胶卡套的饭卡，如有拾到请交还204班处。</span></p><p>
</p><p>                                                                                              德育处</p><p>                                                                                            2023.10.10</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18575.aspx" target="_self" title="标题：关于本周四下午开展高一、高二主题班会活动通知&#xD;点击数：250&#xD;发表时间：23年10月10日">关于本周四下午开展高一、高二主题班会活动通知</a>[ 10-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18580.aspx" target="_self" title="标题：会议通知&#xD;点击数：171&#xD;发表时间：23年10月10日">会议通知</a>[ 10-10 ]</div>
                        </div>
                    </div>
