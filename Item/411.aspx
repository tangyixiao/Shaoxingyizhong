...
<head>
    ...
    <title>语文教师外出教研活动课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">语文教师外出教研活动课改自修</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=411"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:411},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=411";
     ...
     <P><FONT size=3>10月17日（星期六）全体语文组老师参加市属中学语文教师继续教育活动，课改自修。</FONT></P>
<P><FONT size=3>提醒：</FONT></P>
<P><FONT size=3>    时间：10月17日（星期六）上午，八点五十分前入场</FONT></P>
<P><FONT size=3>    地点：稽山中学报告厅</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/410.aspx" target="_self" title="标题：关于召开教研组长会议的通知&#xD;点击数：380&#xD;发表时间：09年10月15日">关于召开教研组长会议的通知</a>[ 10-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/415.aspx" target="_self" title="标题：关于运动会入场式彩排时间的通知(有变动）&#xD;点击数：396&#xD;发表时间：09年10月17日">关于运动会入场式彩排时间的通知(有变动）</a>[ 10-17 ]</div>
                        </div>
                    </div>
