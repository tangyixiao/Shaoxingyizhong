...
<head>
    ...
    <title>求真实验室会议通知（时间更改）--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_100/Index.aspx" target="_self">社团风采</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">求真实验室会议通知（时间更改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18570"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18570},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18570";
     ...
     <p><span style="caret-color: rgb(0, 0, 0); font-family: -webkit-standard; font-size: medium; text-wrap: wrap; text-size-adjust: auto;">请全体成员于周五（10月13日）中午12:30，至实验楼1012进行社员大会，请各年段社员准时参与。注:高一同学请携带好知情同意书。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18503.aspx" target="_self" title="标题：辩论社社员大会通知&#xD;点击数：73&#xD;发表时间：23年09月26日">辩论社社员大会通知</a>[ 09-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18577.aspx" target="_self" title="标题：【辩论社】辩论赛事安排&#xD;点击数：128&#xD;发表时间：23年10月10日">【辩论社】辩论赛事安排</a>[ 10-10 ]</div>
                        </div>
                    </div>
