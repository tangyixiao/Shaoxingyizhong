...
<head>
    ...
    <title>作业文印通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=3317"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:3317},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=3317";
     ...
     <P>　　　     本学期开始，学生作业文印规定如下：</P>
<P>        各备课组提前3天把需要文印的作业放入教学处“文印室”文件夹中，指明使用时间、张数，提前1天去拿。</P>
<P>                                                          教学处 2011/02/16</P>
<P> </P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/3316.aspx" target="_self" title="标题：高三回头考试要求与日程安排&#xD;点击数：822&#xD;发表时间：11年02月14日">高三回头考试要求与日程安排</a>[ 02-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/3318.aspx" target="_self" title="标题：绍兴一中作业量与自修课规定&#xD;点击数：637&#xD;发表时间：11年02月16日">绍兴一中作业量与自修课规定</a>[ 02-16 ]</div>
                        </div>
                    </div>
