...
<head>
    ...
    <title>陈桥驿：俯仰山河--媒体一中-绍兴市第一中学</title>
...
<li class="li2 last on"><a href="/Shaoxingyizhong/Category_38/Index.aspx">媒体一中</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=4510"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:4510},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=4510";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/4503.aspx" target="_self" title="标题：专访香港中文大学副校长徐扬生&#xD;点击数：1194&#xD;发表时间：12年07月03日">专访香港中文大学副校长徐扬生</a>[ 07-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/4519.aspx" target="_self" title="标题：居里实验室里的绍兴人&#xD;点击数：831&#xD;发表时间：12年09月03日">居里实验室里的绍兴人</a>[ 09-03 ]</div>
                        </div>
                    </div>
