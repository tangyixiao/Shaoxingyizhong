...
<head>
    ...
    <title>自行车未上锁情况通报--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">自行车未上锁情况通报</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月07日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=217"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:217},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=217";
     ...
     <P>      在上周的检查中,发现挂有以下车牌号码的自行车没有上锁,请相关班主任再次通知该学生,在校内停放自行车必须上锁.</P>
<P>081111     070630     081120    090819    081417    081610  &nbs
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/216.aspx" target="_self" title="标题：绍兴一中校园晚间安全检查公告(2009.1-9.5）&#xD;点击数：1182&#xD;发表时间：09年09月07日">绍兴一中校园晚间安全检查公告(2009.1-9.5）</a>[ 09-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/229.aspx" target="_self" title="标题：第一周值周小结&#xD;点击数：1169&#xD;发表时间：09年09月08日">第一周值周小结</a>[ 09-08 ]</div>
                        </div>
                    </div>
