...
<head>
    ...
    <title>化学组10月校本研修活动通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">化学组10月校本研修活动通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18617"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18617},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18617";
     ...
     <p><span style="color:#333333;background-color:#FFFFFF;font-size:18pt;font-family:微软雅黑, 微软雅黑, 宋体, 微软雅黑">现定于10月16号(周一)下午第九节课在教学楼2楼支部活动室举行化学组10月校本研修活动，请相关老师安排好工作，准时出席。</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18547.aspx" target="_self" title="标题：关于做好省教研立项课题结题工作的通知&#xD;点击数：120&#xD;发表时间：23年10月06日">关于做好省教研立项课题结题工作的通知</a>[ 10-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18639.aspx" target="_self" title="标题：关于做好第二批绍兴市“品质课堂”深化行动项目结项验收与成果评审的通知&#xD;点击数：131&#xD;发表时间：23年10月18日">关于做好第二批绍兴市“品质课堂”深化行动项目结项验收与成果…</a>[ 10-18 ]</div>
                        </div>
                    </div>
