...
<head>
    ...
    <title>晚间安全检查记录2016.9.6---8--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">晚间安全检查记录2016.9.6---8</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5484"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5484},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5484";
     ...
     <P>9月8日实南201室，高二（4）班和高一（11）班门都未关。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5466.aspx" target="_self" title="标题：汽车进出校门温馨提醒&#xD;点击数：168&#xD;发表时间：16年09月08日">汽车进出校门温馨提醒</a>[ 09-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5508.aspx" target="_self" title="标题：晚间安全检查记录2016.9.12&#xD;点击数：85&#xD;发表时间：16年09月13日">晚间安全检查记录2016.9.12</a>[ 09-13 ]</div>
                        </div>
                    </div>
