...
<head>
    ...
    <title>高一、高二美术生开会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一、高二美术生开会通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18364"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18364},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18364";
     ...
     <p><span style="font-size: 18px; font-family: 宋体, SimSun;">请有意向美术高考的学生，于周二（12号）晚上6点到行政楼4022画室集中。</span><span style="font-size: 18px; font-family: 宋体, SimSun;"></span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18355.aspx" target="_self" title="标题：校乒乓球队通知&#xD;点击数：162&#xD;发表时间：23年09月08日">校乒乓球队通知</a>[ 09-08 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18365.aspx" target="_self" title="标题：部分高三任课老师参加网络问卷通知&#xD;点击数：156&#xD;发表时间：23年09月11日">部分高三任课老师参加网络问卷通知</a>[ 09-11 ]</div>
                        </div>
                    </div>
