...
<head>
    ...
    <title>地方性课程上课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2640"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2640},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2640";
           $("#content_AdminEdit").html("【<a href='" + managedir + "' target='_blank'>进入后台编辑</a>】")
                        ...
                        <div class="conTxt"> 
                                   ...
                                   地方性课程上课通知 
<P>     高一全体学生于本周四（10月14日）下午第四节课到报告厅参加地方性课程的学习。</P>
<P>     高二全体学生于周五（10月15日）下午第四节课到报告厅参加地方性课程的学习。</P>
<P>请各位学生携带学习笔记，同时希望班主任老师协助做好入场秩序维护工作。</P>
<P>    座位表如下：（请高一（3）班自带凳子，高二（2）班自带凳子）</P>
<P>    <A title=高一座位表 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201009/2010090617032638.xls">高一座位表</A>、<A title=高二座位表 href="/Shaoxingyizhong/UploadFiles/UploadFiles/201010/2010101315523943.xls">高二座位表</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2628.aspx" target="_self" title="标题：“名牌工程强化班”和&amp;nbsp;“重点工程优化班”会议&#xD;点击数：651&#xD;发表时间：10年10月12日">“名牌工程强化班”和 “重点工程优化班”会议</a>[ 10-12 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2642.aspx" target="_self" title="标题：篮球赛学生停课&#xD;点击数：633&#xD;发表时间：10年10月14日">篮球赛学生停课</a>[ 10-14 ]</div>
                        </div>
                    </div>
