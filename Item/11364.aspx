...
<head>
    ...
    <title>高三适应性考试成绩分析会通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11364"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11364},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11364";
     ...
     <FONT size=4>各位高三老师，今天上午第五节课，在树兰楼三楼会议室一召开高考适应性考试成绩分析会，请大家准时与会。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11348.aspx" target="_self" title="标题：高三第一轮限时训练政生地安排&#xD;点击数：483&#xD;发表时间：20年04月27日">高三第一轮限时训练政生地安排</a>[ 04-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11368.aspx" target="_self" title="标题：高三第一轮语数英限时训练安排&#xD;点击数：1097&#xD;发表时间：20年04月30日">高三第一轮语数英限时训练安排</a>[ 04-30 ]</div>
                        </div>
                    </div>
