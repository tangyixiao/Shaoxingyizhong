...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2221"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2221},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2221";
...
<P><FONT size=4>通知1：</FONT></P>
<P><FONT size=4>    今天下午教工大会结束后，在行政楼三楼会议室召开<STRONG><U>新高一班主任</U></STRONG>会议。</FONT></P>
<P><FONT size=4>通知2：</FONT></P>
<P><FONT size=4>    请<STRONG>高一、高二、高三各班班主任</STRONG>，在下午来开教工大会时，顺便到德育处领取《绍兴一中家访情况登记表》。</FONT></P>
<P><FONT size=4></FONT> </P>
<P><FONT size=4></FONT> </P>
<P><FONT size=4>                                                                                    德育处</FONT></P>
<P><FONT size=4>                                                                                   2010.7.5</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2219.aspx" target="_self" title="标题：温馨提醒&#xD;点击数：506&#xD;发表时间：10年07月06日">温馨提醒</a>[ 07-06 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2222.aspx" target="_self" title="标题：关于新高一校史知识竞赛和衔接教育综合考试的说明&#xD;点击数：458&#xD;发表时间：10年07月06日">关于新高一校史知识竞赛和衔接教育综合考试的说明</a>[ 07-06 ]</div>
                        </div>
                    </div>
