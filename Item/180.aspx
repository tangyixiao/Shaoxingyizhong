...
<head>
    ...
    <title>绍兴一中2009学年工作思路（初稿）--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">绍兴一中2009学年工作思路（初稿）</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年09月01日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=180"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:180},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=180";
     ...
     <DIV align=center><B>绍兴一中2009学年工作思路</B></DIV>
<DIV align=center><B>（初稿）</B></DIV>
<DIV><B></B> </DIV>
<DIV>熔铸名校精神，彰显办学特色，追求精品教育，再创辉煌业绩；以科学发展观为指导，以加强教育内涵建设为重点，传承“求真”育人理念，深化学校内部改革；推进素质教育，使一中教育富有文化影响力；提升办学品质，让百年名校获得新的发展。</DIV>
<DIV align=left><B>一、德育为首：
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/179.aspx" target="_self" title="标题：班主任：09年未成年人医疗保障相关通知&#xD;点击数：674&#xD;发表时间：09年08月31日">班主任：09年未成年人医疗保障相关通知</a>[ 08-31 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/203.aspx" target="_self" title="标题：关于中午实行错时用餐的通知&#xD;点击数：633&#xD;发表时间：09年09月04日">关于中午实行错时用餐的通知</a>[ 09-04 ]</div>
                        </div>
                    </div>
