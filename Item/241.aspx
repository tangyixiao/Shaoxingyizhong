...
<head>
    ...
    <title>高考三项考试试场布置要求及有关事项--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高考三项考试试场布置要求及有关事项</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月10日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=241"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:241},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=241";
     ...
     <DIV align=left>明天(9月11日)下午各年级第一节课提前到1:00开始,两节课后<B>，高一年级</B>搞好卫生大扫除后放学。Ⅱ号教学楼（高三）和Ⅲ号教学楼（高二）设高考试场，<B>高二、高三进行高考试场布置工作</B>。具体要求如下：</DIV>
<DIV align=left><B>一、</B><B>2</B><B>：</B><B>40—3</B><B>：</B><B>20</B><B>高二、高三班主任指导本班学生</B>进行高考试场布置,<B> </B>试场布置要求如下<B>:</B
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/238.aspx" target="_self" title="标题：领取三项考试准考证&#xD;点击数：578&#xD;发表时间：09年09月10日">领取三项考试准考证</a>[ 09-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/242.aspx" target="_self" title="标题：9月12日高考三项考试安排&#xD;点击数：521&#xD;发表时间：09年09月10日">9月12日高考三项考试安排</a>[ 09-10 ]</div>
                        </div>
                    </div>
