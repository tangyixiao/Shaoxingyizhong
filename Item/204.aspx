...
<head>
    ...
    <title>9月12日高考三项考试监考名单--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9月12日高考三项考试监考名单</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：教学</span> <span>发布时间：2009年09月05日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=204"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:204},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=204";
     ...
     <DIV><B>二、监考人员：</B></DIV>
<DIV><B>1</B><B>、本校监考人员</B>（30+2人）：</DIV>
<DIV><B>点名：</B>张小娟</DIV>
<DIV><B>监考：</B>杨佩琼  王法新  洪  波  叶建红  张祖农  楼开颜  言利水  杨国仁唐海燕  施笑程  杨瑞敏  吴颖娟  俞苗锋  陈连源  蒋 
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/201.aspx" target="_self" title="标题：关于校本课程申报的通知&#xD;点击数：570&#xD;发表时间：09年09月04日">关于校本课程申报的通知</a>[ 09-04 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/205.aspx" target="_self" title="标题：转发“绍兴市教育教学研究院关于做好市教育科学2010年度规划课题申报工作的补充通知”&#xD;点击数：585&#xD;发表时间：09年09月15日">转发“绍兴市教育教学研究院关于做好市教育科学2010年度规划课…</a>[ 09-15 ]</div>
                        </div>
                    </div>
