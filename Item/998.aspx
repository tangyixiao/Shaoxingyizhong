...
<head>
    ...
    <title>高三支部会议通知--高三-绍兴市第一中学</title>
...
<li class="li14 last on"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=998"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:998},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=998";
     ...
     <P><FONT color=#000000 size=3>高三支部全体党员：</FONT></P>
<P><FONT color=#000000 size=3>    定于今天下午第三节课在教学楼Ⅱ 209室召开高三支部会议，请支部党员安排好工作，准时出席。</FONT></P>
...
<TR>
<TD width="90%">
<P align=right><FONT color=#000000 size=3>高三党支部</FONT></P></TD></TR></TBODY></TABLE></P>
<P align=right><FONT color=#000000 size=3>12月8日</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/825.aspx" target="_self" title="标题：高三虚拟17班上课通知&#xD;点击数：362&#xD;发表时间：09年12月03日">高三虚拟17班上课通知</a>[ 12-03 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1006.aspx" target="_self" title="标题：关于高三虚拟17班语文课上课内容的通知&#xD;点击数：282&#xD;发表时间：09年12月14日">关于高三虚拟17班语文课上课内容的通知</a>[ 12-14 ]</div>
                        </div>
                    </div>
