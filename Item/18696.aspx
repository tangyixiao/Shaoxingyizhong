...
<head>
    ...
    <title>高三参加体质健康测试学生训练通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三参加体质健康测试学生训练通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=18696"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:18696},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=18696";
     ...
     <p style="text-indent: 32px"><span style=";font-family:宋体;font-size:16px">请参加全市高三体质健康测试的同学，今天下午第九节课继续到田径场进行训练，大家相互转告</span></p><p><span style=";font-family:宋体;font-size:14px"> </span></p><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/18664.aspx" target="_self" title="标题：2023绍兴一中秋季运动会总成绩册&#xD;点击数：344&#xD;发表时间：23年10月23日">2023绍兴一中秋季运动会总成绩册</a>[ 10-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/18707.aspx" target="_self" title="标题：高考报名相关通知（两则）&#xD;点击数：191&#xD;发表时间：23年10月30日">高考报名相关通知（两则）</a>[ 10-30 ]</div>
                        </div>
                    </div>
