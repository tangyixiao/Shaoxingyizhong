...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1372"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1372},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1372";
     ...
     因天气原因，今日大扫除暂停。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1365.aspx" target="_self" title="标题：升旗仪式改为广播讲话&#xD;点击数：329&#xD;发表时间：10年03月01日">升旗仪式改为广播讲话</a>[ 03-01 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1376.aspx" target="_self" title="标题：关于自行车问题&#xD;点击数：391&#xD;发表时间：10年03月02日">关于自行车问题</a>[ 03-02 ]</div>
                        </div>
                    </div>
