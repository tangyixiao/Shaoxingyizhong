...
<head>
    ...
    <title>一周检查情况公布 (2009.9.7-9.11) --德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">一周检查情况公布 (2009.9.7-9.11) </h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=266"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:266},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=266";
...
<TD class=xl28 style="BORDER-RIGHT: #ece9d8; B
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/265.aspx" target="_self" title="标题：关于举行的“尖子生培养和班风建设”座谈会&#xD;点击数：530&#xD;发表时间：09年09月14日">关于举行的“尖子生培养和班风建设”座谈会</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/272.aspx" target="_self" title="标题：关于高一高二学生信息录入的通知（急）&#xD;点击数：588&#xD;发表时间：09年09月15日">关于高一高二学生信息录入的通知（急）</a>[ 09-15 ]</div>
                        </div>
                    </div>
