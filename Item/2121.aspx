...
<head>
    ...
    <title>下列语文老师今天下午到教研室开会--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">下列语文老师今天下午到教研室开会</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2121"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2121},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2121";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-SIZE: 14pt; COLOR: black; FONT-FAMILY: 仿宋; mso-bidi-font-size: 12.0pt">接绍兴市教育教学研究院通知，下列老师今天（24日）下午1：30到</P>
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-SIZE: 14pt; COLOR: black; FONT-FAMILY: 仿宋; mso-bidi-font-size: 12.0pt">绍兴市教育教学研究院三楼会议室集中开会。<SPAN lang=EN-US>(</SPAN>联系人：沈江峰，联系电</SPAN><SPAN style="FONT-SIZE: 14pt; COLOR: black; FONT-FAMILY: 仿宋; mso-bidi-font-size: 12.0pt">话：<SPAN lang=EN-US>889 05959)，如有课冲突，课改自修。</SPAN></SPAN></P>
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"></SPAN> </P>
<P class=MsoNormal style="MARGIN: 0cm 0cm 0pt"><SPAN style="FONT-SIZE: 14pt; COLOR: black; FONT-FAMILY: 仿宋; mso-bidi-font-size: 12.0pt"><SPAN style="FONT-SIZE: 14pt; COLOR: black; FONT-FAMILY: 仿宋; mso-bidi-font-size: 12.0pt; mso-font-kerning: 1.0pt; mso-hansi-font-family: 'Times New Roman'; mso-bidi-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA"><FONT face="宋体, MS Song">宋建伟、傅雅飞、陈雪萍、许<SPAN lang=EN-US><SPAN style="mso-spacerun: yes">  </SPAN></SPAN>敏、吴巍巍</FONT></SPAN><SPAN lang=EN-US><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2120.aspx" target="_self" title="标题：高三班主任会议：下午3：00&amp;nbsp;行政3楼&#xD;点击数：365&#xD;发表时间：10年06月24日">高三班主任会议：下午3：00 行政3楼</a>[ 06-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2124.aspx" target="_self" title="标题：关于信息技术主题研修活动的通知&#xD;点击数：284&#xD;发表时间：10年06月24日">关于信息技术主题研修活动的通知</a>[ 06-24 ]</div>
                        </div>
                    </div>
