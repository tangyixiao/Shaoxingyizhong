...
<head>
    ...
    <title>关于青田中学物理教研组来访的通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_36/Index.aspx" target="_self">教科室</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于青田中学物理教研组来访的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=22205"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:22205},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=22205";
     ...
     <article><p><span style="font-size: 16px; font-family: 宋体, SimSun;">   <span style="font-family: 宋体, SimSun; font-size: 16px;">本周五（11月7日），原省物理教研员梁旭老师携青田中学物理教研组来访，具体听课安排如下：</span></span></p><p><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/11/202511051648202174.PNG" style="max-width: 100%; " title="202511051648202174.PNG" /></p><p><span style="font-size: 16px; font-family: 宋体, SimSun;">   <span style="color: rgb(51, 51, 51); font-family: 宋体; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); font-size: 16px;">本次上课均有证明，请相关老师上课结束后来教科室领取证明。请开课班级前一节上课的老师按时下课。如带来不便，敬请谅解。</span></span></p>
</article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/22202.aspx" target="_self" title="标题：关于山东省普通高中校长任职资格培训班学员来访的通知&#xD;点击数：234&#xD;发表时间：25年11月05日">关于山东省普通高中校长任职资格培训班学员来访的通知</a>[ 11-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/22214.aspx" target="_self" title="标题：关于组织开展2026年全市教育技术（信息化）课题申报的通知&#xD;点击数：95&#xD;发表时间：25年11月06日">关于组织开展2026年全市教育技术（信息化）课题申报的通知</a>[ 11-06 ]</div>
                        </div>
                    </div>
