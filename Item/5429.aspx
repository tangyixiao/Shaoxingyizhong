...
<head>
    ...
    <title>关于测量高一、高二学生身高、体重等数据通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于测量高一、高二学生身高、体重等数据通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5429"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5429},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5429";
     ...
     <P>        高一、高二各班请注意：</P>
<P>        由于制作学生校服的需要，今天中午和下午自修课时间，将对学生的身高、体重、腰围等进行测量，请各班注意要保证班级人员齐整，以免漏测。谢谢！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5426.aspx" target="_self" title="标题：关于统计乘坐绍兴一中学生公交专线的通知&#xD;点击数：231&#xD;发表时间：16年08月16日">关于统计乘坐绍兴一中学生公交专线的通知</a>[ 08-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5435.aspx" target="_self" title="标题：住校生离校通知&#xD;点击数：189&#xD;发表时间：16年08月18日">住校生离校通知</a>[ 08-18 ]</div>
                        </div>
                    </div>
