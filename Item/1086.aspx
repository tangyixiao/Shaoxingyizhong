...
<head>
    ...
    <title>地理课改自修--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=1086"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:1086},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=1086";
     ...
     <FONT size=3>12月23日（星期三），地理组全体老师参加市属教研活动，今天地理课改自修。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/1084.aspx" target="_self" title="标题：高三、高二三项考试网上报名机房安排&#xD;点击数：544&#xD;发表时间：09年12月23日">高三、高二三项考试网上报名机房安排</a>[ 12-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/1089.aspx" target="_self" title="标题：高二班主任（重要）&#xD;点击数：618&#xD;发表时间：09年12月23日">高二班主任（重要）</a>[ 12-23 ]</div>
                        </div>
                    </div>
