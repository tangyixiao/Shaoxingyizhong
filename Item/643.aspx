...
<head>
    ...
    <title>宣传部摄影团--社团风采-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=643"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:643},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=643";
     ...
     <P class=MsoNormal style="MARGIN: 0cm 0cm 0pt; TEXT-INDENT: 24pt; LINE-HEIGHT: 18pt; mso-char-indent-count: 2.0; mso-line-height-rule: exactly"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体"><FONT color=#000000>以记录团学活动精彩画面为宗旨，通过参加讲座、户外采风、举办摄影展等方式，为全校师生送上最新的摄影作品。</FONT></SPAN><SPAN lang=EN-US style="FONT-SIZE: 12pt"><?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/642.aspx" target="_self" title="标题：桥牌社&#xD;点击数：1736&#xD;发表时间：09年11月28日">桥牌社</a>[ 11-28 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/644.aspx" target="_self" title="标题：社团招新活动&#xD;点击数：2248&#xD;发表时间：09年11月28日">社团招新活动</a>[ 11-28 ]</div>
                        </div>
                    </div>
