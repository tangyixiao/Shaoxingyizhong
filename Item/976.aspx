...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=976"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:976},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=976";
     ...
     <FONT face=宋体 color=#000000 size=3>定于今天下午第四节课在行政楼五楼会议室举行教工会议,请全体教工准时出席!</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/924.aspx" target="_self" title="标题：关于教职工持卡刷卡的通知&#xD;点击数：518&#xD;发表时间：09年12月05日">关于教职工持卡刷卡的通知</a>[ 12-05 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/995.aspx" target="_self" title="标题：行政支部会议通知&#xD;点击数：582&#xD;发表时间：09年12月14日">行政支部会议通知</a>[ 12-14 ]</div>
                        </div>
                    </div>
