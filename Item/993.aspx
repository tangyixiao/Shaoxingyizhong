...
<head>
    ...
    <title>高一高二各班文艺委员开会--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高一高二各班文艺委员开会</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=993"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:993},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=993";
...
<TBODY>
<TR>
<TD width="90%"><FONT color=#000000 size=3>今日（周二）中午12点半，高一高二各班文艺委员到音乐教室（实验室南五楼）开会并上报元旦文艺会演节目。 </FONT></TD>
...
<P><FONT size=3><BR><FONT color=#000000></FONT></FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/979.aspx" target="_self" title="标题：纪律一周检查情况公布(2009.11.30-12.5)&#xD;点击数：346&#xD;发表时间：09年12月07日">纪律一周检查情况公布(2009.11.30-12.5)</a>[ 12-07 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/997.aspx" target="_self" title="标题：2009.12.7大扫除检查情况公布&#xD;点击数：337&#xD;发表时间：09年12月14日">2009.12.7大扫除检查情况公布</a>[ 12-14 ]</div>
                        </div>
                    </div>
