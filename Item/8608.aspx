...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8608"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8608},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8608";
     ...
     <FONT size=4>今天下午高三精英班物理、数学正常上课，历史暂停。上课地点：3106教室。请相关学生准时上课。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8605.aspx" target="_self" title="标题：部分老师外出培训通知&#xD;点击数：429&#xD;发表时间：18年05月22日">部分老师外出培训通知</a>[ 05-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8614.aspx" target="_self" title="标题：高三本周模拟考安排&#xD;点击数：753&#xD;发表时间：18年05月24日">高三本周模拟考安排</a>[ 05-24 ]</div>
                        </div>
                    </div>
