...
<head>
    ...
    <title>今天高一部分选修课上课地点变更通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">今天高一部分选修课上课地点变更通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5953"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5953},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5953";
     ...
     <P>因高三期中考试，今天下午部分老师的选修课上课地点变更如下：</P>
<P>陈浩老师的《物理培优乙班》上课地点变更为实南305</P>
<P>陈华老师的《<FONT size=3>数学培优乙班</FONT>》上课地点变更为实南205</P>
<P>由于旁边教室还在进行考试，请同学们进出教室时保持安静。</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5946.aspx" target="_self" title="标题：高二选考走班地点变更通知&#xD;点击数：311&#xD;发表时间：16年11月16日">高二选考走班地点变更通知</a>[ 11-16 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5958.aspx" target="_self" title="标题：本周六省高考数学科目模拟测试工作安排&#xD;点击数：213&#xD;发表时间：16年11月17日">本周六省高考数学科目模拟测试工作安排</a>[ 11-17 ]</div>
                        </div>
                    </div>
