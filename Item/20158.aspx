...
<head>
    ...
    <title>关于9月1日开学典礼各年段入场时间与入场方式的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于9月1日开学典礼各年段入场时间与入场方式的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：</span> <span>作者：</span> <span>发布时间：2024年08月30日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20158"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20158},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20158";
...
<span style="font-size: 18px;">各年段、各班级：</span></p><p><span style="font-size: 18px;">
     开学典礼于9月1日（周日）7：40在校体育馆准时开始，考虑到今年因龙山书院的学生加入，体育馆会比较拥挤。为保证入场安全，学校决定，三个年段实行错时分批入场，各年段、各班级务必严格遵循体育馆入场时间与入场方向。具体为：高一：7：10从体育馆北门入场，要求学生6：50到教室；高二：7：20从体育馆南门入场，要求学生7:00到教室。高三：7：25从体育馆南门入场，要求学生7:05到教室，到达体育馆后按指定位置就坐；请全体学生统一着夏装校服，（上身短袖有领T恤，下身藏青色长裤）。
       </span></p><p><span style="font-size: 18px;">      望大家遵照执行。

                                                                              </span></p><p style="text-align: right;"><span style="font-size: 18px;">                                                                                     党政办、德育处
                                                                            2024年8月30日</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20156.aspx" target="_self" title="标题：2024级新生军训班军训积极分子名单&#xD;点击数：119&#xD;发表时间：24年08月30日">2024级新生军训班军训积极分子名单</a>[ 08-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20168.aspx" target="_self" title="标题：关于新学期心理健康教育中心开放的通知&#xD;点击数：112&#xD;发表时间：24年09月02日">关于新学期心理健康教育中心开放的通知</a>[ 09-02 ]</div>
                        </div>
                    </div>
