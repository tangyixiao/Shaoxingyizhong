...
<head>
    ...
    <title>生物组教研活动通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=21873"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:21873},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=21873";
     ...
     <article><span style="font-size: 18px;">本周四（9.11）全体生物老师参加市直教研活动，相关生物课改自修，走班课的学生在走班教室自修。</span></article><p>
</p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/21872.aspx" target="_self" title="标题：信息技术组教研活动及换课通知&#xD;点击数：106&#xD;发表时间：25年09月09日">信息技术组教研活动及换课通知</a>[ 09-09 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/21881.aspx" target="_self" title="标题：英语组教研活动通知&#xD;点击数：74&#xD;发表时间：25年09月11日">英语组教研活动通知</a>[ 09-11 ]</div>
                        </div>
                    </div>
