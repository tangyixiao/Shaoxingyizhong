...
<head>
    ...
    <title>通知：纪检部、实践部、体育部今天中午开会--团委-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_30/Index.aspx" target="_self">团委</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">通知：纪检部、实践部、体育部今天中午开会</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9169"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9169},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9169";
     ...
     <P>请团委纪检部、实践部、学生会体育部的高一、高二全体干部、干事于今天中午12:40至教学楼2114团委办公室开会。</P>
<P>请互相转告！</P>
<P align=right>校团委<BR>2018年10月6日</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9164.aspx" target="_self" title="标题：关于征集校园照片素材的通知&#xD;点击数：309&#xD;发表时间：18年09月30日">关于征集校园照片素材的通知</a>[ 09-30 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9172.aspx" target="_self" title="标题：关于团学联主要学生干部拍照的通知&#xD;点击数：335&#xD;发表时间：18年10月07日">关于团学联主要学生干部拍照的通知</a>[ 10-07 ]</div>
                        </div>
                    </div>
