...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=6309"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:6309},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=6309";
         ...
         因天气原因，今天大课间操暂停。
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/6307.aspx" target="_self" title="标题：关于期末考试考风考纪要求&#xD;点击数：312&#xD;发表时间：17年01月10日">关于期末考试考风考纪要求</a>[ 01-10 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/6310.aspx" target="_self" title="标题：表扬与失物招领&#xD;点击数：146&#xD;发表时间：17年01月11日">表扬与失物招领</a>[ 01-11 ]</div>
                        </div>
                    </div>
