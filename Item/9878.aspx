...
<head>
    ...
    <title>高三全市适应性考试分析会议通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高三全市适应性考试分析会议通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9878"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9878},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9878";
     ...
     <FONT size=4>请高三年级全体老师于明天（周二）下午第4节课到行政楼三楼会议室二参加市适应性考试分析会议。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9868.aspx" target="_self" title="标题：高二张叠老师历史走班课改自修通知&#xD;点击数：238&#xD;发表时间：19年03月15日">高二张叠老师历史走班课改自修通知</a>[ 03-15 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9881.aspx" target="_self" title="标题：政治教研活动通知&#xD;点击数：250&#xD;发表时间：19年03月19日">政治教研活动通知</a>[ 03-19 ]</div>
                        </div>
                    </div>
