...
<head>
    ...
    <title>（信息公示）食品安全管理处室和食堂安全管理员名单（2021年9月）--校园安全-绍兴市第一中学</title>
...
<li class="li9 last"><a href="/Shaoxingyizhong/Category_382/Index.aspx">校园活动</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=16621"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:16621},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=16621";
     ...
     <p>各处室、各部门：</p><p>现公布我校食品安全管理处室及食品安全管理员名单如下：</p><p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/16620.aspx" target="_self" title="标题：（信息公示）学校食品安全工作领导小组(2021年9月)&#xD;点击数：1&#xD;发表时间：21年09月13日">（信息公示）学校食品安全工作领导小组(2021年9月)</a>[ 09-13 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/16622.aspx" target="_self" title="标题：绍兴一中“五一”假期前校园安全隐患大排查工作通知&#xD;点击数：74&#xD;发表时间：22年04月29日">绍兴一中“五一”假期前校园安全隐患大排查工作通知</a>[ 04-29 ]</div>
                        </div>
                    </div>
