...
<head>
    ...
    <title>端午节安全提示--安全处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_28/Index.aspx" target="_self">安全处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">端午节安全提示</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：安全处</span> <span>作者：安全处</span> <span>发布时间：2020年06月24日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11585"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11585},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11585";
...
<P><FONT size=4>        2020年的“端午节”即将来临，为了度过一个欢乐祥和的端午假期，现就有关事项通知如下：<BR>        1．各班做好放假前安全教育和隐患排查工作。班主任要在学生放假前，集中开展一次安全教育和安全隐患大排查活动，掌握学生思想动态，消除各种安全隐患。要求学生不到没有人身安全保障地方游玩、游泳，防止意外事故发生。提醒家长务必加强对孩子的教育和管理，切实承担起监护责任；<BR>        2．各部门、处室、办公室做好离校前安全隐患排查工作，办公室内勿存放贵重物品，离校时切断电源、关好门窗；<BR>        3．当前疫情处在常态化防控阶段，请大家注意安全，做好防护，减少聚集，如非必需，不要出市出省。出省做好审批，出市做好备案工作。<BR><BR>         祝大家度过一个文明、平安、健康的节日假期！</FONT></P>
<P align=right><FONT size=4>安全处<BR>2020年6月24日</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11584.aspx" target="_self" title="标题：关于调整省外返绍师生员工疫情防控措施&#xD;点击数：241&#xD;发表时间：20年06月24日">关于调整省外返绍师生员工疫情防控措施</a>[ 06-24 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11631.aspx" target="_self" title="标题：关于高考期间暂停使用教学楼北侧地面停车场的通知&#xD;点击数：164&#xD;发表时间：20年07月05日">关于高考期间暂停使用教学楼北侧地面停车场的通知</a>[ 07-05 ]</div>
                        </div>
                    </div>
