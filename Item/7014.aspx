...
<head>
    ...
    <title>高二政治限时训练时间更改通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">高二政治限时训练时间更改通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=7014"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:7014},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=7014";
     ...
     <FONT size=4>因明后天高三将进行模拟考试，原安排在本周四下午的政治限时训练调整到本周六下午第8、9节课进行。请相关学生注意考试时间。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/7011.aspx" target="_self" title="标题：高三心理讲座通知&#xD;点击数：250&#xD;发表时间：17年05月23日">高三心理讲座通知</a>[ 05-23 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/7018.aspx" target="_self" title="标题：本周日推荐生招生考试工作安排&#xD;点击数：810&#xD;发表时间：17年05月24日">本周日推荐生招生考试工作安排</a>[ 05-24 ]</div>
                        </div>
                    </div>
