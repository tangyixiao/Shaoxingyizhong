...
<head>
    ...
    <title>关于开展爱心助残捐赠活动的通知--党政办-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_25/Index.aspx" target="_self">党政办</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于开展爱心助残捐赠活动的通知</h2>
                        <!-- 副标题 -->
                        <h3 class="subTitle"><span></span></h3>
                        <script>
                        $(".Subheading span:empty").parent().hide()
                        </script>
                        <div class="property"> <span>文章来源：本校</span> <span>作者：校办</span> <span>发布时间：2009年10月28日</span> <span>点击数：
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=473"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:473},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=473";
     ...
     <DIV>各位教工：</DIV>
<DIV>      为了响应由浙江省残疾人联合会发起的“关爱残疾孩子，发展特殊教育”爱心助残捐赠活动，我校在行政楼三楼设置募捐箱，欢迎全体教工奉献爱心、踊跃捐款！</DIV>
<DIV> </DIV>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/465.aspx" target="_self" title="标题：关于各处室报刊订阅的通知&#xD;点击数：515&#xD;发表时间：09年10月27日">关于各处室报刊订阅的通知</a>[ 10-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/476.aspx" target="_self" title="标题：2010年报纸订阅通知&#xD;点击数：459&#xD;发表时间：09年10月29日">2010年报纸订阅通知</a>[ 10-29 ]</div>
                        </div>
                    </div>
