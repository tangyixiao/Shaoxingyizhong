...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20880"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20880},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20880";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2025/1/202501141601571308.png" style="max-width: 100%; " title="202501141601571308.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20878.aspx" target="_self" title="标题：高二期末先进名单公布&#xD;点击数：150&#xD;发表时间：25年01月14日">高二期末先进名单公布</a>[ 01-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20883.aspx" target="_self" title="标题：失物招领（高一书本）&#xD;点击数：58&#xD;发表时间：25年01月16日">失物招领（高一书本）</a>[ 01-16 ]</div>
                        </div>
                    </div>
