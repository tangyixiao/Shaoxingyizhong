...
<head>
    ...
    <title>关于高一天文竞赛课上课的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_26/Index.aspx" target="_self">教学处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于高一天文竞赛课上课的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=10639"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:10639},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=10639";
     ...
     <FONT size=4>根据学校国庆节放假课程调整安排，本周日上课（按周二课表上课），故周日晚上天文课也照常上课，请相关同学相互转告。</FONT>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/10638.aspx" target="_self" title="标题：关于高三部分老师会议的通知&#xD;点击数：289&#xD;发表时间：19年09月27日">关于高三部分老师会议的通知</a>[ 09-27 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/10654.aspx" target="_self" title="标题：关于高三年级10月5日至7日停课复习安排的通知&#xD;点击数：683&#xD;发表时间：19年09月30日">关于高三年级10月5日至7日停课复习安排的通知</a>[ 09-30 ]</div>
                        </div>
                    </div>
