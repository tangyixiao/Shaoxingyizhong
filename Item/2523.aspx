...
<head>
    ...
    <title>关于家长开放日的通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=2523"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:2523},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=2523";
     ...
     <P><FONT size=5>  9月26日（星期日）为家长开放日，请所有老师做好精心准备。同时希望上午第1-3节相应时间段没有课的班主任和同一学科的任课教师能陪同家长随班听课。</FONT></P>
<P><FONT size=5>                                                           教学处</FONT></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/2517.aspx" target="_self" title="标题：教研组长通知&#xD;点击数：445&#xD;发表时间：10年09月22日">教研组长通知</a>[ 09-22 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/2526.aspx" target="_self" title="标题：通知&#xD;点击数：634&#xD;发表时间：10年09月25日">通知</a>[ 09-25 ]</div>
                        </div>
                    </div>
