...
<head>
    ...
    <title>2016年秋季运动会开幕式通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">2016年秋季运动会开幕式通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=5791"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:5791},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=5791";
     ...
     <P>全校师生注意：</P>
<P>        明天运动会开幕式7:30开始，请各班务必在7:25前到指定场地集合，提醒学生统一服装，做好各项准备。同时，请相关工作人员和老师做好准备工作。谢谢！</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/5781.aspx" target="_self" title="标题：失物招领&#xD;点击数：108&#xD;发表时间：16年10月25日">失物招领</a>[ 10-25 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/5795.aspx" target="_self" title="标题：运动会期间卫生工作要求&#xD;点击数：177&#xD;发表时间：16年10月26日">运动会期间卫生工作要求</a>[ 10-26 ]</div>
                        </div>
                    </div>
