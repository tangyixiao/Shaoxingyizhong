...
<head>
    ...
    <title>天文竞赛停课通知--教学处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=15508"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:15508},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=15508";
     ...
     <p><span style="FONT-SIZE: 20px">因参加5月7日至8日全国天文知识竞赛决赛，下列4位同学从5月4日至6日停课复习三天。</span></p><p><span style="FONT-SIZE: 20px">高二（2）班：朱毅轩、徐赫</span></p><p><span style="FONT-SIZE: 20px">高二（9）班：陆天浩、屠谢晨</span></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/15492.aspx" target="_self" title="标题：学术节 | 物理创新活动赛&#xD;点击数：186&#xD;发表时间：22年04月29日">学术节 | 物理创新活动赛</a>[ 04-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/15510.aspx" target="_self" title="标题：高三五校联考工作安排&#xD;点击数：780&#xD;发表时间：22年05月04日">高三五校联考工作安排</a>[ 05-04 ]</div>
                        </div>
                    </div>
