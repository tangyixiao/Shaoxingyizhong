...
<head>
    ...
    <title>9月14日早上入校迟到同学反馈（有修改）--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">9月14日早上入校迟到同学反馈（有修改）</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=11832"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:11832},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=11832";
     ...
     <P><A title=2020.9.14（周一）早上入校迟到学生 href="/Shaoxingyizhong/UploadFiles/UploadFiles/202009/2020091413183542.xls">2020.9.14（周一）早上入校迟到学生</A></P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/11830.aspx" target="_self" title="标题：9.11、9.12绍兴一中住校学生表现情况&#xD;点击数：79&#xD;发表时间：20年09月14日">9.11、9.12绍兴一中住校学生表现情况</a>[ 09-14 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/11833.aspx" target="_self" title="标题：关于高二年级包干区调整的通知&#xD;点击数：139&#xD;发表时间：20年09月14日">关于高二年级包干区调整的通知</a>[ 09-14 ]</div>
                        </div>
                    </div>
