...
<head>
    ...
    <title>关于“红船精神”PPT、手抄报上交的通知--德育处-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <a href="/Shaoxingyizhong/Category_27/Index.aspx" target="_self">德育处</a></div>
                ...
                <div class="mBd">
                    ...
                    <div class="printArea">
                        <!-- 标题 -->
                        <h2 class="title">关于“红船精神”PPT、手抄报上交的通知</h2>
                        <!-- 副标题 -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=8916"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:8916},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=8916";
     ...
     <P>    请各班将暑假期间制作的关于“红船精神”的PPT打包成文件夹，以班级命名上交至公共文件夹——德育处——“红船精神”材料处。手抄报直接交到德育处办公室2114。所有材料上交时间截止至9月7日前。（黑板报暂不需要制作）</P>
<P align=right>德育处</P>
<P align=right>2018.08.29</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/8915.aspx" target="_self" title="标题：“优秀升旗手”通知&#xD;点击数：177&#xD;发表时间：18年08月29日">“优秀升旗手”通知</a>[ 08-29 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/8924.aspx" target="_self" title="标题：开学典礼颁奖彩排通知（有修改）&#xD;点击数：551&#xD;发表时间：18年08月31日">开学典礼颁奖彩排通知（有修改）</a>[ 08-31 ]</div>
                        </div>
                    </div>
