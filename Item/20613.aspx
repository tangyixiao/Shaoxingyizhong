...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=20613"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:20613},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=20613";
     ...
     <p style="text-align: center;"><img src="/Shaoxingyizhong/UploadFiles/xwzx/2024/11/202411261605433116.png" style="max-width: 100%; " title="202411261605433116.png" /></p>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/20612.aspx" target="_self" title="标题：十佳歌手入围通知&#xD;点击数：332&#xD;发表时间：24年11月26日">十佳歌手入围通知</a>[ 11-26 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/20614.aspx" target="_self" title="标题：博雅大讲堂活动通知（周五）&#xD;点击数：170&#xD;发表时间：24年11月26日">博雅大讲堂活动通知（周五）</a>[ 11-26 ]</div>
                        </div>
                    </div>
