...
<head>
    ...
    <title>教研活动通知--教科室-绍兴市第一中学</title>
...
<li class="li14 last"><a href="/Shaoxingyizhong/Category_35/Index.aspx">高三</a></li>
    ...
    <script language="JavaScript" type="text/JavaScript" src="/Shaoxingyizhong/Common/GetHits.aspx?id=9888"></script>
    次</span>  <span><span id="content_AdminEdit"></span>
<script type="text/javascript">
$(document).ready(function()
{
    $.pe.ajax('admineditcheck',{params:{itemId:9888},success:function(s) {
        if ($(s).find('status').text() == 'OK') {
            var managedir = "/Common/GetContentEdit.aspx?itemId=9888";
     ...
     <P>各教研组：</P>
<P>  明天（周四）下午第三节课开始各教研组举行学科组内教研活动，布置落实本学期的教研组工作事项。希望各教研组长精心组织，组内老师全员参与，活动后把本次活动的报道材料上交教科室。</P>
<P>                                                                                             2019.3.20</P>
                        ...
                        <div class="others">
                            <div class="prev"><span>上一篇：</span><a href="/Shaoxingyizhong/Item/9886.aspx" target="_self" title="标题：英语组公开课通知&#xD;点击数：468&#xD;发表时间：19年03月20日">英语组公开课通知</a>[ 03-20 ]</div>
                            <div class="next"><span>下一篇：</span><a href="/Shaoxingyizhong/Item/9917.aspx" target="_self" title="标题：市直班主任培训第二次活动通知&#xD;点击数：334&#xD;发表时间：19年03月29日">市直班主任培训第二次活动通知</a>[ 03-29 ]</div>
                        </div>
                    </div>
